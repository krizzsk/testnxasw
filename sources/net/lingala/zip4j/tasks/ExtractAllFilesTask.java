...
public class ExtractAllFilesTask extends AbstractExtractFileTask<ExtractAllFilesTaskParameters> {
    ...
    /* renamed from: b */
    private SplitInputStream f6893b;
    ...
    public void executeTask(net.lingala.zip4j.tasks.ExtractAllFilesTask.ExtractAllFilesTaskParameters r10, net.lingala.zip4j.progress.ProgressMonitor r11) throws java.io.IOException {
        /*
            ...
            net.lingala.zip4j.io.inputstream.ZipInputStream r0 = r9.m6613a((net.lingala.zip4j.model.Zip4jConfig) r0)     // Catch:{ all -> 0x006e }
        ...
        L_0x0016:
            ...
            goto L_0x0016
        L_0x0037:
            net.lingala.zip4j.io.inputstream.SplitInputStream r1 = r9.f6893b     // Catch:{ all -> 0x0060 }
        ...
        L_0x0058:
            net.lingala.zip4j.io.inputstream.SplitInputStream r10 = r9.f6893b
        ...
        L_0x006e:
            r10 = move-exception
            net.lingala.zip4j.io.inputstream.SplitInputStream r11 = r9.f6893b
    ...
    /* renamed from: a */
    private ZipInputStream m6613a(Zip4jConfig zip4jConfig) throws IOException {
        this.f6893b = UnzipUtil.createSplitInputStream(getZipModel());
        FileHeader a = m6614a(getZipModel());
        if (a != null) {
            this.f6893b.prepareExtractionForFileHeader(a);
        }
        return new ZipInputStream((InputStream) this.f6893b, this.f6892a, zip4jConfig);
    }

    /* renamed from: a */
    private FileHeader m6614a(ZipModel zipModel) {
