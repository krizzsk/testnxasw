...
public class HeaderUtil {
    public static FileHeader getFileHeader(ZipModel zipModel, String str) throws ZipException {
        FileHeader a = m6492a(zipModel, str);
        if (a != null) {
            return a;
        }
        String replaceAll = str.replaceAll("\\\\", "/");
        FileHeader a2 = m6492a(zipModel, replaceAll);
        return a2 == null ? m6492a(zipModel, replaceAll.replaceAll("/", "\\\\")) : a2;
    }
    ...
    /* renamed from: a */
    private static FileHeader m6492a(ZipModel zipModel, String str) throws ZipException {
        if (zipModel == null) {
