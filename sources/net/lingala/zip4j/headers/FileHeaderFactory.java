...
public class FileHeaderFactory {
    public FileHeader generateFileHeader(ZipParameters zipParameters, boolean z, int i, Charset charset, RawIO rawIO) throws ZipException {
        ...
        if (!zipParameters.isEncryptFiles() || zipParameters.getEncryptionMethod() != EncryptionMethod.AES) {
            ...
            fileHeader.setAesExtraDataRecord(m6470a(zipParameters));
        ...
        String a = m6469a(zipParameters.getFileNameInZip());
        fileHeader.setFileName(a);
        fileHeader.setFileNameLength(m6468a(a, charset));
        if (!z) {
            i = 0;
        }
        ...
        fileHeader.setGeneralPurposeFlag(m6471a(fileHeader.isEncrypted(), zipParameters, charset));
    ...
    /* renamed from: a */
    private byte[] m6471a(boolean z, ZipParameters zipParameters, Charset charset) {
        byte[] bArr = new byte[2];
        bArr[0] = m6467a(z, zipParameters);
    ...
    /* renamed from: a */
    private byte m6467a(boolean z, ZipParameters zipParameters) {
        byte b = 0;
        if (z) {
    ...
    /* renamed from: a */
    private String m6469a(String str) throws ZipException {
    ...
    /* renamed from: a */
    private AESExtraDataRecord m6470a(ZipParameters zipParameters) throws ZipException {
    ...
    /* renamed from: a */
    private int m6468a(String str, Charset charset) {
