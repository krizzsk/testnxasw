...
public final class CacheStrategy {
    ...
    public static boolean isCacheable(didihttp.Response r3, didihttp.Request r4) {
        /*
            int r0 = r3.code()
        ...
        L_0x0031:
            ...
            didihttp.CacheControl r0 = r3.cacheControl()
        ...
        L_0x0059:
            return r2
        L_0x005a:
            didihttp.CacheControl r3 = r3.cacheControl()
            boolean r3 = r3.noStore()
            if (r3 != 0) goto L_0x006f
            didihttp.CacheControl r3 = r4.cacheControl()
            boolean r3 = r3.noStore()
            if (r3 != 0) goto L_0x006f
            r2 = 1
        L_0x006f:
            return r2
        */
        throw new UnsupportedOperationException("Method not decompiled: didihttp.internal.cache.CacheStrategy.isCacheable(didihttp.Response, didihttp.Request):boolean");
    }
            ...
            if (response != null) {
                ...
                for (int i = 0; i < size; i++) {
                    ...
                    if (HttpHeaders.DATE.equalsIgnoreCase(name)) {
                        ...
                        this.ageSeconds = didihttp.internal.http.HttpHeaders.parseSeconds(value, -1);
                    }
                }
            }
        }
