...
public final class HttpHeaders {
    ...
    /* renamed from: a */
    private static final String f59467a = "([^ \"=]*)";

    /* renamed from: b */
    private static final String f59468b = "\"([^\"]*)\"";

    /* renamed from: c */
    private static final Pattern f59469c = Pattern.compile(" +([^ \"=]*)=(:?\"([^\"]*)\"|([^ \"=]*)) *(:?,|$)");
    ...
    public static long contentLength(Headers headers) {
        return m44824a(headers.get(com.google.common.net.HttpHeaders.CONTENT_LENGTH));
    }

    /* renamed from: a */
    private static long m44824a(String str) {
        if (str == null) {
            return -1;
        }
        try {
    ...
    public static boolean varyMatches(Response response, Headers headers, Request request) {
        for (String next : m44825a(response)) {
            if (!C21750Util.equal(headers.values(next), request.headers(next))) {
                return false;
            }
        }
        return true;
    ...
    /* renamed from: a */
    private static Set<String> m44825a(Response response) {
    ...
    public static List<Challenge> parseChallenges(Headers headers, String str) {
        ...
        for (String next : headers.values(str)) {
            ...
            if (indexOf != -1) {
                Matcher matcher = f59469c.matcher(next);
                int i = indexOf;
                while (true) {
                    if (!matcher.find(i)) {
                        break;
