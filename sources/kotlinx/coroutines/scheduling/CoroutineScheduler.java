...
public final class CoroutineScheduler implements Closeable, Executor {
    ...
    /* renamed from: a */
    static final /* synthetic */ AtomicLongFieldUpdater f6281a;

    /* renamed from: b */
    private static final /* synthetic */ AtomicLongFieldUpdater f6282b;

    /* renamed from: c */
    private static final /* synthetic */ AtomicIntegerFieldUpdater f6283c;

    /* renamed from: d */
    private static final int f6284d = -1;

    /* renamed from: e */
    private static final int f6285e = 0;

    /* renamed from: f */
    private static final int f6286f = 1;

    /* renamed from: g */
    private static final int f6287g = 21;

    /* renamed from: h */
    private static final long f6288h = 2097151;

    /* renamed from: i */
    private static final long f6289i = 4398044413952L;

    /* renamed from: j */
    private static final int f6290j = 42;

    /* renamed from: k */
    private static final long f6291k = 9223367638808264704L;

    /* renamed from: l */
    private static final long f6292l = 2097151;

    /* renamed from: m */
    private static final long f6293m = -2097152;

    /* renamed from: n */
    private static final long f6294n = 2097152;
    ...
    @Metadata(mo148867d1 = {"\u0000\f\n\u0002\u0018\u0002\n\u0002\u0010\u0010\n\u0002\b\u0007\b\u0001\u0018\u00002\b\u0012\u0004\u0012\u00020\u00000\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002j\u0002\b\u0003j\u0002\b\u0004j\u0002\b\u0005j\u0002\b\u0006j\u0002\b\u0007¨\u0006\b"}, mo148868d2 = {"Lkotlinx/coroutines/scheduling/CoroutineScheduler$WorkerState;", "", "(Ljava/lang/String;I)V", "CPU_ACQUIRED", "BLOCKING", "PARKING", "DORMANT", "TERMINATED", "kotlinx-coroutines-core"}, mo148869k = 1, mo148870mv = {1, 5, 1}, mo148872xi = 48)
    /* compiled from: CoroutineScheduler.kt */
    ...
    /* renamed from: a */
    private final int m6224a(long j) {
        return (int) (j & 2097151);
    }

    /* renamed from: b */
    private final int m6232b(long j) {
        return (int) ((j & f6289i) >> 21);
    }

    public final int availableCpuPermits(long j) {
        return (int) ((j & f6291k) >> 42);
    }
    ...
    public final boolean parkedWorkersStackPush(Worker worker) {
        ...
        } while (!f6282b.compareAndSet(this, j, ((long) indexInArray) | j2));
        return true;
    }

    /* renamed from: a */
    private final int m6225a(Worker worker) {
    ...
    /* renamed from: b */
    private final int m6231b() {
        return (int) (this.controlState & 2097151);
    }

    /* renamed from: c */
    private final int m6233c() {
        return (int) ((this.controlState & f6291k) >> 42);
    }

    /* renamed from: d */
    private final int m6235d() {
        return (int) (f6281a.incrementAndGet(this) & 2097151);
    }

    /* renamed from: e */
    private final int m6236e() {
        return (int) (f6281a.getAndDecrement(this) & 2097151);
    }

    /* renamed from: f */
    private final long m6237f() {
        return f6281a.addAndGet(this, 2097152);
    }

    /* renamed from: g */
    private final void m6238g() {
        f6281a.addAndGet(this, f6293m);
    }

    /* renamed from: i */
    private final long m6240i() {
        return f6281a.addAndGet(this, qqqqqy.ba00610061aaa);
    }
    ...
    @Metadata(mo148867d1 = {"\u0000\"\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0010\t\n\u0000\n\u0002\u0010\b\n\u0002\b\u0007\n\u0002\u0018\u0002\n\u0002\b\u0006\b\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002R\u000e\u0010\u0003\u001a\u00020\u0004XT¢\u0006\u0002\n\u0000R\u000e\u0010\u0005\u001a\u00020\u0006XT¢\u0006\u0002\n\u0000R\u000e\u0010\u0007\u001a\u00020\u0006XT¢\u0006\u0002\n\u0000R\u000e\u0010\b\u001a\u00020\u0004XT¢\u0006\u0002\n\u0000R\u000e\u0010\t\u001a\u00020\u0006XT¢\u0006\u0002\n\u0000R\u000e\u0010\n\u001a\u00020\u0004XT¢\u0006\u0002\n\u0000R\u000e\u0010\u000b\u001a\u00020\u0006XT¢\u0006\u0002\n\u0000R\u000e\u0010\f\u001a\u00020\u0006XT¢\u0006\u0002\n\u0000R\u0010\u0010\r\u001a\u00020\u000e8\u0006X\u0004¢\u0006\u0002\n\u0000R\u000e\u0010\u000f\u001a\u00020\u0006XT¢\u0006\u0002\n\u0000R\u000e\u0010\u0010\u001a\u00020\u0004XT¢\u0006\u0002\n\u0000R\u000e\u0010\u0011\u001a\u00020\u0004XT¢\u0006\u0002\n\u0000R\u000e\u0010\u0012\u001a\u00020\u0004XT¢\u0006\u0002\n\u0000R\u000e\u0010\u0013\u001a\u00020\u0006XT¢\u0006\u0002\n\u0000¨\u0006\u0014"}, mo148868d2 = {"Lkotlinx/coroutines/scheduling/CoroutineScheduler$Companion;", "", "()V", "BLOCKING_MASK", "", "BLOCKING_SHIFT", "", "CLAIMED", "CPU_PERMITS_MASK", "CPU_PERMITS_SHIFT", "CREATED_MASK", "MAX_SUPPORTED_POOL_SIZE", "MIN_SUPPORTED_POOL_SIZE", "NOT_IN_STACK", "Lkotlinx/coroutines/internal/Symbol;", "PARKED", "PARKED_INDEX_MASK", "PARKED_VERSION_INC", "PARKED_VERSION_MASK", "TERMINATED", "kotlinx-coroutines-core"}, mo148869k = 1, mo148870mv = {1, 5, 1}, mo148872xi = 48)
    /* compiled from: CoroutineScheduler.kt */
    ...
    static {
        ...
        f6282b = AtomicLongFieldUpdater.newUpdater(cls, "parkedWorkersStack");
        f6281a = AtomicLongFieldUpdater.newUpdater(cls, "controlState");
        f6283c = AtomicIntegerFieldUpdater.newUpdater(cls, "_isTerminated");
    }
    ...
    public final void shutdown(long j) {
        ...
        Task task;
        boolean z = false;
        if (f6283c.compareAndSet(this, 0, 1)) {
            Worker l = m6243l();
            ...
            if (l != null) {
                l.tryReleaseCpu(WorkerState.TERMINATED);
            }
            if (DebugKt.getASSERTIONS_ENABLED()) {
                if (((int) ((this.controlState & f6291k) >> 42)) == this.corePoolSize) {
                    z = true;
                }
                if (!z) {
                    throw new AssertionError();
    ...
    public final void signalCpuWork() {
        if (!m6241j() && !m6229a(this, 0, 1, (Object) null)) {
            m6241j();
        }
    }

    /* renamed from: a */
    static /* synthetic */ boolean m6229a(CoroutineScheduler coroutineScheduler, long j, int i, Object obj) {
        if ((i & 1) != 0) {
            j = coroutineScheduler.controlState;
        }
        return coroutineScheduler.m6234c(j);
    }

    /* renamed from: c */
    private final boolean m6234c(long j) {
        if (RangesKt.coerceAtLeast(((int) (2097151 & j)) - ((int) ((j & f6289i) >> 21)), 0) < this.corePoolSize) {
            int k = m6242k();
            if (k == 1 && this.corePoolSize > 1) {
                m6242k();
            }
            if (k > 0) {
                return true;
    ...
    private final boolean m6241j() {
        ...
        } while (!Worker.workerCtl$FU.compareAndSet(a, -1, 0));
        LockSupport.unpark(a);
        return true;
    }

    /* renamed from: k */
    private final int m6242k() {
        synchronized (this.workers) {
            if (isTerminated()) {
                return -1;
            }
            ...
            int i = (int) (j & 2097151);
            boolean z = false;
            int coerceAtLeast = RangesKt.coerceAtLeast(i - ((int) ((j & f6289i) >> 21)), 0);
            ...
            if (i2 > 0 && this.workers.get(i2) == null) {
                ...
                if (i2 == ((int) (2097151 & f6281a.incrementAndGet(this)))) {
                    z = true;
                }
                if (z) {
                    worker.start();
    ...
    /* renamed from: a */
    private final Task m6227a(Worker worker, Task task, boolean z) {
    ...
    public final class Worker extends Thread {
        ...
        private final boolean tryAcquireCpuPermit() {
            ...
            if (this.state != WorkerState.CPU_ACQUIRED) {
                ...
                while (true) {
                    ...
                    if (((int) ((CoroutineScheduler.f6291k & j) >> 42)) != 0) {
                        if (CoroutineScheduler.f6281a.compareAndSet(coroutineScheduler, j, j - qqqqqy.ba00610061aaa)) {
                            z = true;
                            break;
                        }
                    } else {
        ...
        public final boolean tryReleaseCpu(WorkerState workerState) {
            ...
            if (z) {
                CoroutineScheduler.f6281a.addAndGet(CoroutineScheduler.this, qqqqqy.ba00610061aaa);
            }
        ...
        private final void afterTask(int i) {
            if (i != 0) {
                CoroutineScheduler.f6281a.addAndGet(CoroutineScheduler.this, CoroutineScheduler.f6293m);
                ...
                if (!coroutineScheduler.isTerminated()) {
                    if (((int) (coroutineScheduler.controlState & 2097151)) > coroutineScheduler.corePoolSize) {
                        if (workerCtl$FU.compareAndSet(this, -1, 1)) {
                            ...
                            int andDecrement = (int) (CoroutineScheduler.f6281a.getAndDecrement(coroutineScheduler) & 2097151);
    ...
    /* renamed from: a */
    private final boolean m6230a(Task task) {
        boolean z = true;
    ...
    public final void parkedWorkersStackTopUpdate(Worker worker, int i, int i2) {
        while (true) {
            ...
            long j2 = (2097152 + j) & f6293m;
            if (i3 == i) {
                i3 = i2 == 0 ? m6225a(worker) : i2;
            }
            if (i3 >= 0) {
                if (f6282b.compareAndSet(this, j, j2 | ((long) i3))) {
                    return;
                }
            }
        }
    ...
    private final Worker m6226a() {
        while (true) {
            ...
            int a = m6225a(worker);
            if (a >= 0) {
                if (f6282b.compareAndSet(this, j, ((long) a) | j2)) {
    ...
    /* renamed from: h */
    private final boolean m6239h() {
        long j;
        do {
            j = this.controlState;
            if (((int) ((f6291k & j) >> 42)) == 0) {
                return false;
            }
        } while (!f6281a.compareAndSet(this, j, j - qqqqqy.ba00610061aaa));
        return true;
    }

    /* renamed from: a */
    private final void m6228a(boolean z) {
        long addAndGet = f6281a.addAndGet(this, 2097152);
        if (!z && !m6241j() && !m6234c(addAndGet)) {
            m6241j();
        }
    }
}
