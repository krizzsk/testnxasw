...
public final class DebugCoroutineInfoImpl {
    ...
    public DebugCoroutineInfoImpl(CoroutineContext coroutineContext, StackTraceFrame stackTraceFrame, long j) {
        this.f6131a = stackTraceFrame;
        this.sequenceNumber = j;
        this.f6132b = new WeakReference<>(coroutineContext);
    }
    ...
    public final CoroutineContext getContext() {
        return (CoroutineContext) this.f6132b.get();
    }
    ...
    public final CoroutineStackFrame getLastObservedFrame$kotlinx_coroutines_core() {
        WeakReference<CoroutineStackFrame> weakReference = this.f6134d;
    ...
    public final void setLastObservedFrame$kotlinx_coroutines_core(CoroutineStackFrame coroutineStackFrame) {
        this.f6134d = coroutineStackFrame == null ? null : new WeakReference<>(coroutineStackFrame);
    }
    ...
    /* renamed from: a */
    private final List<StackTraceElement> m5833a() {
        StackTraceFrame stackTraceFrame = this.f6131a;
    ...
    public final java.lang.Object m5832a(kotlin.sequences.SequenceScope<? super java.lang.StackTraceElement> r6, kotlin.coroutines.jvm.internal.CoroutineStackFrame r7, kotlin.coroutines.Continuation<? super kotlin.Unit> r8) {
        /*
            r5 = this;
        ...
        L_0x006a:
            ...
            return r6
        */
        throw new UnsupportedOperationException("Method not decompiled: kotlinx.coroutines.debug.internal.DebugCoroutineInfoImpl.m5832a(kotlin.sequences.SequenceScope, kotlin.coroutines.jvm.internal.CoroutineStackFrame, kotlin.coroutines.Continuation):java.lang.Object");
    }

    public final void updateState$kotlinx_coroutines_core(String str, Continuation<?> continuation) {
        Thread thread;
        if (!Intrinsics.areEqual((Object) this.f6133c, (Object) str) || !Intrinsics.areEqual((Object) str, (Object) DebugCoroutineInfoImplKt.SUSPENDED) || getLastObservedFrame$kotlinx_coroutines_core() == null) {
            this.f6133c = str;
    ...
    public String toString() {
        return "DebugCoroutineInfo(state=" + getState() + ",context=" + getContext() + VersionRange.RIGHT_OPEN;
    }
}
