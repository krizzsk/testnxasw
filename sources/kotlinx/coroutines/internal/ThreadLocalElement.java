...
public final class ThreadLocalElement<T> implements ThreadContextElement<T> {
    ...
    /* renamed from: b */
    private final ThreadLocal<T> f6260b;

    /* renamed from: c */
    private final CoroutineContext.Key<?> f6261c;

    public ThreadLocalElement(T t, ThreadLocal<T> threadLocal) {
        this.f6259a = t;
        this.f6260b = threadLocal;
        this.f6261c = new ThreadLocalKey(threadLocal);
    }
    ...
    public String toString() {
        return "ThreadLocal(value=" + this.f6259a + ", threadLocal = " + this.f6260b + VersionRange.RIGHT_OPEN;
    }
}
