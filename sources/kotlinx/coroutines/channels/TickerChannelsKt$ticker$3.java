...
@Metadata(mo148867d1 = {"\u0000\n\n\u0000\n\u0002\u0010\u0002\n\u0002\u0018\u0002\u0010\u0000\u001a\u00020\u0001*\b\u0012\u0004\u0012\u00020\u00010\u0002H@"}, mo148868d2 = {"<anonymous>", "", "Lkotlinx/coroutines/channels/ProducerScope;"}, mo148869k = 3, mo148870mv = {1, 5, 1}, mo148872xi = 48)
@DebugMetadata(mo23688c = "kotlinx.coroutines.channels.TickerChannelsKt$ticker$3", mo23689f = "TickerChannels.kt", mo23690i = {}, mo23691l = {72, 73}, mo23692m = "invokeSuspend", mo23693n = {}, mo23694s = {})
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            if (i2 == 1) {
                ...
                this.label = 1;
                if (TickerChannelsKt.m5742a(j, j2, channel, this) == coroutine_suspended) {
                    return coroutine_suspended;
                }
            } else if (i2 == 2) {
                this.label = 2;
                if (TickerChannelsKt.m5743b(this.$delayMillis, this.$initialDelayMillis, producerScope.getChannel(), this) == coroutine_suspended) {
                    return coroutine_suspended;
                }
            }
        } else if (i == 1 || i == 2) {
