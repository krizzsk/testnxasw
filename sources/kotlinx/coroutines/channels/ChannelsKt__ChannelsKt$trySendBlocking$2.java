...
@Metadata(mo148867d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0002\u0010\u0002\n\u0000\n\u0002\u0018\u0002\u0010\u0000\u001a\b\u0012\u0004\u0012\u00020\u00020\u0001\"\u0004\b\u0000\u0010\u0003*\u00020\u0004H@"}, mo148868d2 = {"<anonymous>", "Lkotlinx/coroutines/channels/ChannelResult;", "", "E", "Lkotlinx/coroutines/CoroutineScope;"}, mo148869k = 3, mo148870mv = {1, 5, 1}, mo148872xi = 48)
@DebugMetadata(mo23688c = "kotlinx.coroutines.channels.ChannelsKt__ChannelsKt$trySendBlocking$2", mo23689f = "Channels.kt", mo23690i = {}, mo23691l = {92}, mo23692m = "invokeSuspend", mo23693n = {}, mo23694s = {})
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            try {
                ...
                obj2 = Result.m47938constructorimpl(ResultKt.createFailure(th));
            }
        } else {
            throw new IllegalStateException("call to 'resume' before 'invoke' with coroutine");
        }
        obj2 = Result.m47938constructorimpl(Unit.INSTANCE);
        if (Result.m47945isSuccessimpl(obj2)) {
            obj3 = ChannelResult.Companion.m46571successJP2dKIU(Unit.INSTANCE);
        } else {
            obj3 = ChannelResult.Companion.m46569closedJP2dKIU(Result.m47941exceptionOrNullimpl(obj2));
        }
        return ChannelResult.m46556boximpl(obj3);
    }
}
