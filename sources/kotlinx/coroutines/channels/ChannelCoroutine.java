...
public class ChannelCoroutine<E> extends AbstractCoroutine<Unit> implements Channel<E> {
    ...
    public ChannelIterator<E> iterator() {
        return this.f6095a.iterator();
    }

    @Deprecated(level = DeprecationLevel.WARNING, message = "Deprecated in the favour of 'trySend' method", replaceWith = @ReplaceWith(expression = "trySend(element).isSuccess", imports = {}))
    public boolean offer(E e) {
        return this.f6095a.offer(e);
    }

    @Deprecated(level = DeprecationLevel.WARNING, message = "Deprecated in the favour of 'tryReceive'. Please note that the provided replacement does not rethrow channel's close cause as 'poll' did, for the precise replacement please refer to the 'poll' documentation", replaceWith = @ReplaceWith(expression = "tryReceive().getOrNull()", imports = {}))
    public E poll() {
        return this.f6095a.poll();
    }

    public Object receive(Continuation<? super E> continuation) {
        return this.f6095a.receive(continuation);
    }

    /* renamed from: receiveCatching-JP2dKIU  reason: not valid java name */
    public Object m46549receiveCatchingJP2dKIU(Continuation<? super ChannelResult<? extends E>> continuation) {
        Object r2 = this.f6095a.m46574receiveCatchingJP2dKIU(continuation);
    ...
    public Object receiveOrNull(Continuation<? super E> continuation) {
        return this.f6095a.receiveOrNull(continuation);
    }

    public Object send(E e, Continuation<? super Unit> continuation) {
        return this.f6095a.send(e, continuation);
    }

    /* renamed from: tryReceive-PtdJZtk  reason: not valid java name */
    public Object m46550tryReceivePtdJZtk() {
        return this.f6095a.m46575tryReceivePtdJZtk();
    }

    /* renamed from: trySend-JP2dKIU  reason: not valid java name */
    public Object m46551trySendJP2dKIU(E e) {
        return this.f6095a.m46577trySendJP2dKIU(e);
    }
    ...
    public void cancelInternal(Throwable th) {
        ...
        this.f6095a.cancel(cancellationException$default);
