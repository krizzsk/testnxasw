...
public final class Closed<E> extends Send implements ReceiveOrClosed<E> {
    ...
    public String toString() {
        return "Closed@" + DebugStringsKt.getHexAddress(this) + VersionRange.LEFT_CLOSED + this.closeCause + VersionRange.RIGHT_CLOSED;
    }
}
