...
public class ConflatedChannel<E> extends AbstractChannel<E> {
    ...
    public String getBufferDebugString() {
        return "(value=" + this.value + VersionRange.RIGHT_OPEN;
    }
}
