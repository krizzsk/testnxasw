...
public final class AbstractChannelKt {
    ...
    /* renamed from: a */
    private static final <E> Object m5719a(Object obj) {
        return obj instanceof Closed ? ChannelResult.Companion.m46569closedJP2dKIU(((Closed) obj).closeCause) : ChannelResult.Companion.m46571successJP2dKIU(obj);
    }

    /* renamed from: a */
    private static final <E> Object m5720a(Closed<?> closed) {
        return ChannelResult.Companion.m46569closedJP2dKIU(closed.closeCause);
    }
}
