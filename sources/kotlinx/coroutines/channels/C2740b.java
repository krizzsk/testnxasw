...
class C2740b<E> extends AbstractCoroutine<Unit> implements BroadcastChannel<E>, ProducerScope<E> {
    ...
    public void cancelInternal(Throwable th) {
        ...
        this.f6108a.cancel(cancellationException$default);
    ...
    public void onCompleted(Unit unit) {
        SendChannel.DefaultImpls.close$default(this.f6108a, (Throwable) null, 1, (Object) null);
    }

    /* access modifiers changed from: protected */
    public void onCancelled(Throwable th, boolean z) {
        if (!this.f6108a.close(th) && !z) {
            CoroutineExceptionHandlerKt.handleCoroutineException(getContext(), th);
        }
    }

    public boolean close(Throwable th) {
        boolean close = this.f6108a.close(th);
        start();
        return close;
    }
