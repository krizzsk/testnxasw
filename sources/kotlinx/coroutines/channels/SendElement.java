...
public class SendElement<E> extends Send {
    ...
    public void resumeSendClosed(Closed<?> closed) {
        ...
        this.cont.resumeWith(Result.m47938constructorimpl(ResultKt.createFailure(sendException)));
    }

    public String toString() {
        return DebugStringsKt.getClassSimpleName(this) + '@' + DebugStringsKt.getHexAddress(this) + VersionRange.LEFT_OPEN + getPollResult() + VersionRange.RIGHT_OPEN;
    }
}
