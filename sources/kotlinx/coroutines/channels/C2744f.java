...
final class C2744f<E> extends C2739a<E> implements SelectClause2<E, SendChannel<? super E>> {

    /* renamed from: a */
    private Continuation<? super Unit> f6109a;

    public C2744f(CoroutineContext coroutineContext, Channel<E> channel, Function2<? super ActorScope<E>, ? super Continuation<? super Unit>, ? extends Object> function2) {
        super(coroutineContext, channel, false);
        this.f6109a = IntrinsicsKt.createCoroutineUnintercepted(function2, this, this);
    }

    /* access modifiers changed from: protected */
    public void onStart() {
        CancellableKt.startCoroutineCancellable(this.f6109a, (Continuation<?>) this);
    }
    ...
    public Object m46579trySendJP2dKIU(E e) {
        start();
        return super.m46551trySendJP2dKIU(e);
    }
