...
@DebugMetadata(mo23688c = "kotlinx.coroutines.flow.FlowKt__ZipKt$combineTransform$6", mo23689f = "Zip.kt", mo23690i = {}, mo23691l = {251}, mo23692m = "invokeSuspend", mo23693n = {}, mo23694s = {})
...
public final class FlowKt__ZipKt$combineTransform$6 extends SuspendLambda implements Function2<FlowCollector<? super R>, Continuation<? super Unit>, Object> {
    ...
    @DebugMetadata(mo23688c = "kotlinx.coroutines.flow.FlowKt__ZipKt$combineTransform$6$2", mo23689f = "Zip.kt", mo23690i = {}, mo23691l = {251}, mo23692m = "invokeSuspend", mo23693n = {}, mo23694s = {})
    /* renamed from: kotlinx.coroutines.flow.FlowKt__ZipKt$combineTransform$6$2 */
    /* compiled from: Zip.kt */
    public static final class C28322 extends SuspendLambda implements Function3<FlowCollector<? super R>, T[], Continuation<? super Unit>, Object> {
        private /* synthetic */ Object L$0;
        /* synthetic */ Object L$1;
        int label;

        public final Object invoke(FlowCollector<? super R> flowCollector, T[] tArr, Continuation<? super Unit> continuation) {
            C28322 r0 = new C28322(r3, continuation);
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            }, new C28322((Continuation<? super C28322>) null), this) == coroutine_suspended) {
                return coroutine_suspended;
            }
        } else if (i == 1) {
            ResultKt.throwOnFailure(obj);
    ...
    public final Object invokeSuspend$$forInline(Object obj) {
        ...
        }, new C28322((Continuation<? super C28322>) null), this);
        InlineMarker.mark(1);
        return Unit.INSTANCE;
    }
}
