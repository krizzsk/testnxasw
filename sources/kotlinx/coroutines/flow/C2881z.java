...
final class C2881z extends AbstractSharedFlowSlot<SharedFlowImpl<?>> {
    ...
    public boolean allocateLocked(SharedFlowImpl<?> sharedFlowImpl) {
        ...
        this.f6212a = sharedFlowImpl.mo28040a();
        return true;
    }
    ...
    public Continuation<Unit>[] freeLocked(SharedFlowImpl<?> sharedFlowImpl) {
        ...
        this.f6212a = -1;
        this.f6213b = null;
        return sharedFlowImpl.mo28041a(j);
    }
}
