...
@DebugMetadata(mo23688c = "kotlinx.coroutines.flow.FlowKt__LimitKt$transformWhile$1", mo23689f = "Limit.kt", mo23690i = {0}, mo23691l = {154}, mo23692m = "invokeSuspend", mo23693n = {"collector$iv"}, mo23694s = {"L$0"})
...
final class FlowKt__LimitKt$transformWhile$1 extends SuspendLambda implements Function2<FlowCollector<? super R>, Continuation<? super Unit>, Object> {
    ...
    public final Object invokeSuspend(Object obj) {
        C2780xdf1aa1b6 flowKt__LimitKt$transformWhile$1$invokeSuspend$$inlined$collectWhile$1;
        Object coroutine_suspended = IntrinsicsKt.getCOROUTINE_SUSPENDED();
        int i = this.label;
        if (i == 0) {
            ResultKt.throwOnFailure(obj);
            Flow<T> flow = this.$this_transformWhile;
            C2780xdf1aa1b6 flowKt__LimitKt$transformWhile$1$invokeSuspend$$inlined$collectWhile$12 = new C2780xdf1aa1b6(this.$transform, (FlowCollector) this.L$0);
            try {
            ...
            flowKt__LimitKt$transformWhile$1$invokeSuspend$$inlined$collectWhile$1 = (C2780xdf1aa1b6) this.L$0;
            try {
                ResultKt.throwOnFailure(obj);
