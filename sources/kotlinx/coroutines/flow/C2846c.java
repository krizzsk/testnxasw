...
final class C2846c<T> extends ChannelFlow<T> {
    ...
    public /* synthetic */ C2846c(ReceiveChannel receiveChannel, boolean z, CoroutineContext coroutineContext, int i, BufferOverflow bufferOverflow, int i2, DefaultConstructorMarker defaultConstructorMarker) {
    ...
    public C2846c(ReceiveChannel<? extends T> receiveChannel, boolean z, CoroutineContext coroutineContext, int i, BufferOverflow bufferOverflow) {
        super(coroutineContext, i, bufferOverflow);
        this.f6177a = receiveChannel;
        this.f6178b = z;
        this.consumed = 0;
    }

    /* renamed from: a */
    private final void m5926a() {
        if (this.f6178b) {
            boolean z = true;
            if (f6176c.getAndSet(this, 1) != 0) {
                z = false;
            }
            if (!z) {
    ...
    public ChannelFlow<T> create(CoroutineContext coroutineContext, int i, BufferOverflow bufferOverflow) {
        return new C2846c<>(this.f6177a, this.f6178b, coroutineContext, i, bufferOverflow);
    }

    public Flow<T> dropChannelOperators() {
        return new C2846c<>(this.f6177a, this.f6178b, (CoroutineContext) null, 0, (BufferOverflow) null, 28, (DefaultConstructorMarker) null);
    }

    /* access modifiers changed from: protected */
    public Object collectTo(ProducerScope<? super T> producerScope, Continuation<? super Unit> continuation) {
        Object a = FlowKt__ChannelsKt.m5866b(new SendingCollector(producerScope), this.f6177a, this.f6178b, continuation);
    ...
    public Object collect(FlowCollector<? super T> flowCollector, Continuation<? super Unit> continuation) {
        if (this.capacity == -3) {
            m5926a();
            Object a = FlowKt__ChannelsKt.m5866b(flowCollector, this.f6177a, this.f6178b, continuation);
            return a == IntrinsicsKt.getCOROUTINE_SUSPENDED() ? a : Unit.INSTANCE;
        }
    ...
    public String additionalToStringProps() {
        return Intrinsics.stringPlus("channel=", this.f6177a);
    }
}
