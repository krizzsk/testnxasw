...
final /* synthetic */ class C2870o {
    ...
    /* renamed from: a */
    public static /* synthetic */ void m6009a() {
    }

    /* renamed from: a */
    public static /* synthetic */ Flow m6008a(Flow flow, Flow flow2, Function1 function1, int i, Object obj) {
        if ((i & 2) != 0) {
    ...
    /* renamed from: a */
    public static final <T> Flow<T> m6007a(Flow<? extends T> flow, Flow<? extends T> flow2, Function1<? super Throwable, Boolean> function1) {
        return FlowKt.m46581catch(flow, new FlowKt__ErrorsKt$onErrorCollect$2(function1, flow2, (Continuation<? super FlowKt__ErrorsKt$onErrorCollect$2>) null));
    }

    /* renamed from: a */
    public static /* synthetic */ Flow m6004a(Flow flow, long j, Function2 function2, int i, Object obj) {
        if ((i & 1) != 0) {
            j = Long.MAX_VALUE;
        }
        if ((i & 2) != 0) {
    ...
    /* renamed from: a */
    public static final <T> Flow<T> m6003a(Flow<? extends T> flow, long j, Function2<? super Throwable, ? super Continuation<? super Boolean>, ? extends Object> function2) {
        if (j > 0) {
    ...
    /* renamed from: a */
    public static /* synthetic */ Flow m6002a(Flow flow, int i, Function1 function1, int i2, Object obj) {
        if ((i2 & 1) != 0) {
            i = Integer.MAX_VALUE;
        }
        if ((i2 & 2) != 0) {
        ...
        return m6001a(flow, i, function1);
    }

    @Deprecated(level = DeprecationLevel.HIDDEN, message = "binary compatibility with retries: Int preview version")
    /* renamed from: a */
    public static final /* synthetic */ Flow m6001a(Flow flow, int i, Function1 function1) {
        if (i > 0) {
    ...
    public static final <T> java.lang.Object m6000a(kotlinx.coroutines.flow.Flow<? extends T> r4, kotlinx.coroutines.flow.FlowCollector<? super T> r5, kotlin.coroutines.Continuation<? super java.lang.Throwable> r6) {
        /*
        ...
        L_0x0056:
            ...
            boolean r4 = m6010a((java.lang.Throwable) r5, (java.lang.Throwable) r4)
            if (r4 != 0) goto L_0x006b
            kotlin.coroutines.CoroutineContext r4 = r0.getContext()
            boolean r4 = m6011a((java.lang.Throwable) r5, (kotlin.coroutines.CoroutineContext) r4)
            if (r4 != 0) goto L_0x006b
            return r5
        L_0x006b:
            throw r5
        */
        throw new UnsupportedOperationException("Method not decompiled: kotlinx.coroutines.flow.C2870o.m6000a(kotlinx.coroutines.flow.Flow, kotlinx.coroutines.flow.FlowCollector, kotlin.coroutines.Continuation):java.lang.Object");
    }

    /* renamed from: a */
    private static final boolean m6011a(Throwable th, CoroutineContext coroutineContext) {
        Job job = (Job) coroutineContext.get(Job.Key);
        if (job == null || !job.isCancelled()) {
            return false;
        }
        return m6010a(th, (Throwable) job.getCancellationException());
    }

    /* renamed from: a */
    public static final <T> Flow<T> m6005a(Flow<? extends T> flow, Function3<? super FlowCollector<? super T>, ? super Throwable, ? super Continuation<? super Unit>, ? extends Object> function3) {
        return new FlowKt__ErrorsKt$catch$$inlined$unsafeFlow$1(flow, function3);
    }

    /* renamed from: a */
    public static final <T> Flow<T> m6006a(Flow<? extends T> flow, Function4<? super FlowCollector<? super T>, ? super Throwable, ? super Long, ? super Continuation<? super Boolean>, ? extends Object> function4) {
        return new FlowKt__ErrorsKt$retryWhen$$inlined$unsafeFlow$1(flow, function4);
    }

    /* renamed from: a */
    private static final boolean m6010a(Throwable th, Throwable th2) {
        if (th2 != null) {
