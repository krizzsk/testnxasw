...
public abstract class ChannelFlowOperator<S, T> extends ChannelFlow<T> {
    ...
    /* renamed from: a */
    public final Object m5961a(FlowCollector<? super T> flowCollector, CoroutineContext coroutineContext, Continuation<? super Unit> continuation) {
        Object withContextUndispatched$default = ChannelFlowKt.withContextUndispatched$default(coroutineContext, ChannelFlowKt.m5960a(flowCollector, continuation.getContext()), (Object) null, new ChannelFlowOperator$collectWithContextUndispatched$2(this, (Continuation<? super ChannelFlowOperator$collectWithContextUndispatched$2>) null), continuation, 4, (Object) null);
        return withContextUndispatched$default == IntrinsicsKt.getCOROUTINE_SUSPENDED() ? withContextUndispatched$default : Unit.INSTANCE;
    }

    /* renamed from: a */
    static /* synthetic */ Object m5962a(ChannelFlowOperator channelFlowOperator, ProducerScope producerScope, Continuation continuation) {
    ...
    /* renamed from: a */
    static /* synthetic */ Object m5963a(ChannelFlowOperator channelFlowOperator, FlowCollector flowCollector, Continuation continuation) {
        if (channelFlowOperator.capacity == -3) {
            ...
            if (Intrinsics.areEqual((Object) plus, (Object) context)) {
                ...
                Object a = channelFlowOperator.m5961a(flowCollector, plus, (Continuation<? super Unit>) continuation);
