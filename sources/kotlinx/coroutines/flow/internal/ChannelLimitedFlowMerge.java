...
public final class ChannelLimitedFlowMerge<T> extends ChannelFlow<T> {
    ...
    public ChannelFlow<T> create(CoroutineContext coroutineContext, int i, BufferOverflow bufferOverflow) {
        return new ChannelLimitedFlowMerge<>(this.f6191a, coroutineContext, i, bufferOverflow);
    }
    ...
    public Object collectTo(ProducerScope<? super T> producerScope, Continuation<? super Unit> continuation) {
        ...
        for (Flow<T> channelLimitedFlowMerge$collectTo$2$1 : this.f6191a) {
            Job unused = C2746d.m5821a(producerScope, (CoroutineContext) null, (CoroutineStart) null, new ChannelLimitedFlowMerge$collectTo$2$1(channelLimitedFlowMerge$collectTo$2$1, sendingCollector, (Continuation<? super ChannelLimitedFlowMerge$collectTo$2$1>) null), 3, (Object) null);
        }
