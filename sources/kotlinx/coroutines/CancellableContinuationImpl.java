...
public class CancellableContinuationImpl<T> extends DispatchedTask<T> implements CoroutineStackFrame, CancellableContinuation<T> {
    ...
    public final boolean resetStateReusable() {
        ...
        if (DebugKt.getASSERTIONS_ENABLED() && !(!(obj instanceof NotCompleted))) {
            throw new AssertionError();
        } else if (!(obj instanceof C2883h) || ((C2883h) obj).f6217d == null) {
            this._decision = 0;
            this._state = C2728a.f6070a;
            return true;
        } else {
    ...
    public final Object getResult() {
        ...
        if (state$kotlinx_coroutines_core instanceof CompletedExceptionally) {
            ...
            if (DebugKt.getRECOVER_STACK_TRACES()) {
                ...
                if (continuation instanceof CoroutineStackFrame) {
                    th = StackTraceRecoveryKt.m6170a(th, (CoroutineStackFrame) continuation);
                }
            }
            throw th;
            ...
            if (DebugKt.getRECOVER_STACK_TRACES()) {
                ...
                if (continuation2 instanceof CoroutineStackFrame) {
                    cancellationException = StackTraceRecoveryKt.m6170a(cancellationException, (CoroutineStackFrame) continuation2);
                }
            }
            ...
            if (obj instanceof C2728a) {
                ...
                if (z) {
                    ...
                    if (!(makeCancelHandler instanceof BeforeResumeCancelHandler)) {
                        if (hVar.mo28111a()) {
                            callCancelHandler(function1, hVar.f6218e);
                            return;
                        }
                        if (_state$FU.compareAndSet(this, obj, C2883h.m6125a(hVar, (Object) null, makeCancelHandler, (Function1) null, (Object) null, (Throwable) null, 29, (Object) null))) {
                            return;
                        }
                    } else {
                        return;
                    ...
                    if (_state$FU.compareAndSet(this, obj, new C2883h(obj, makeCancelHandler, (Function1) null, (Object) null, (Throwable) null, 28, (DefaultConstructorMarker) null))) {
                        return;
                    }
                } else {
                    return;
    ...
    private final CancelHandler makeCancelHandler(Function1<? super Throwable, Unit> function1) {
        return function1 instanceof CancelHandler ? (CancelHandler) function1 : new C2896o(function1);
    }
    ...
    private final Object resumedState(NotCompleted notCompleted, Object obj, int i, Function1<? super Throwable, Unit> function1, Object obj2) {
        if (obj instanceof CompletedExceptionally) {
            ...
            return new C2883h(obj, notCompleted instanceof CancelHandler ? (CancelHandler) notCompleted : null, function1, obj2, (Throwable) null, 16, (DefaultConstructorMarker) null);
        }
    }
    ...
    public <T> T getSuccessfulResult$kotlinx_coroutines_core(Object obj) {
        return obj instanceof C2883h ? ((C2883h) obj).f6214a : obj;
    }
    ...
    public Throwable getExceptionalResult$kotlinx_coroutines_core(Object obj) {
        ...
        return (!DebugKt.getRECOVER_STACK_TRACES() || !(delegate$kotlinx_coroutines_core instanceof CoroutineStackFrame)) ? exceptionalResult$kotlinx_coroutines_core : StackTraceRecoveryKt.m6170a(exceptionalResult$kotlinx_coroutines_core, (CoroutineStackFrame) delegate$kotlinx_coroutines_core);
    }

    public String toString() {
        return nameString() + VersionRange.LEFT_OPEN + DebugStringsKt.toDebugString(this.delegate) + "){" + getStateDebugRepresentation() + "}@" + DebugStringsKt.getHexAddress(this);
    }
    ...
    public void cancelCompletedResult$kotlinx_coroutines_core(Object obj, Throwable th) {
        while (true) {
            ...
            if (obj2 instanceof NotCompleted) {
                ...
                if (obj2 instanceof C2883h) {
                    C2883h hVar = (C2883h) obj2;
                    if (!hVar.mo28111a()) {
                        if (_state$FU.compareAndSet(this, obj2, C2883h.m6125a(hVar, (Object) null, (CancelHandler) null, (Function1) null, (Object) null, th, 15, (Object) null))) {
                            hVar.mo28110a(this, th);
                            return;
                        }
                    } else {
                        throw new IllegalStateException("Must be called at most once".toString());
                    }
                } else if (_state$FU.compareAndSet(this, obj2, new C2883h(obj2, (CancelHandler) null, (Function1) null, (Object) null, th, 14, (DefaultConstructorMarker) null))) {
                    return;
                }
            } else {
                return;
    ...
    private final Symbol tryResumeImpl(Object obj, Object obj2, Function1<? super Throwable, Unit> function1) {
        ...
        do {
            ...
            } else if (!(obj3 instanceof C2883h)) {
                return null;
            } else {
                if (obj2 != null) {
                    C2883h hVar = (C2883h) obj3;
                    if (hVar.f6217d == obj2) {
                        if (!DebugKt.getASSERTIONS_ENABLED() || Intrinsics.areEqual(hVar.f6214a, obj)) {
