...
public final class TimeoutKt {
    public static final <T> Object withTimeout(long j, Function2<? super CoroutineScope, ? super Continuation<? super T>, ? extends Object> function2, Continuation<? super T> continuation) {
        if (j > 0) {
            Object a = m5707a(new C2734af(j, continuation), function2);
    ...
    public static final <T> Object m46542withTimeoutKLykuaI(long j, Function2<? super CoroutineScope, ? super Continuation<? super T>, ? extends Object> function2, Continuation<? super T> continuation) {
        return withTimeout(DelayKt.m46541toDelayMillisLRDsOJo(j), function2, continuation);
    }
    ...
    public static final <T> java.lang.Object withTimeoutOrNull(long r7, kotlin.jvm.functions.Function2<? super kotlinx.coroutines.CoroutineScope, ? super kotlin.coroutines.Continuation<? super T>, ? extends java.lang.Object> r9, kotlin.coroutines.Continuation<? super T> r10) {
        ...
        L_0x0049:
            ...
            kotlinx.coroutines.af r4 = new kotlinx.coroutines.af     // Catch:{ TimeoutCancellationException -> 0x0074 }
            r4.<init>(r7, r2)     // Catch:{ TimeoutCancellationException -> 0x0074 }
            r10.element = r4     // Catch:{ TimeoutCancellationException -> 0x0074 }
            java.lang.Object r7 = m5707a(r4, r9)     // Catch:{ TimeoutCancellationException -> 0x0074 }
    ...
    public static final <T> Object m46543withTimeoutOrNullKLykuaI(long j, Function2<? super CoroutineScope, ? super Continuation<? super T>, ? extends Object> function2, Continuation<? super T> continuation) {
        return withTimeoutOrNull(DelayKt.m46541toDelayMillisLRDsOJo(j), function2, continuation);
    }

    /* renamed from: a */
    private static final <U, T extends U> Object m5707a(C2734af<U, ? super T> afVar, Function2<? super CoroutineScope, ? super Continuation<? super T>, ? extends Object> function2) {
        JobKt.disposeOnCompletion(afVar, DelayKt.getDelay(afVar.uCont.getContext()).invokeOnTimeout(afVar.f6077a, afVar, afVar.getContext()));
        return UndispatchedKt.startUndispatchedOrReturnIgnoreTimeout(afVar, afVar, function2);
    }
