...
public abstract class AbstractCoroutine<T> extends JobSupport implements Continuation<T>, CoroutineScope, Job {
    ...
    public AbstractCoroutine(CoroutineContext coroutineContext, boolean z, boolean z2) {
        ...
        this.f6005a = coroutineContext.plus(this);
    }
    ...
    public final void handleOnCompletionException$kotlinx_coroutines_core(Throwable th) {
        CoroutineExceptionHandlerKt.handleCoroutineException(this.f6005a, th);
    }

    public String nameString$kotlinx_coroutines_core() {
        String coroutineName = CoroutineContextKt.getCoroutineName(this.f6005a);
