...
/* renamed from: atd.s.a */
public class C1161a implements C1050b {
    /* renamed from: b */
    public Integer mo13780a(Context context) throws C1051c {
        if (Build.VERSION.SDK_INT >= 21) {
            try {
                return Integer.valueOf(Settings.Secure.getInt(context.getContentResolver(), C1172a.m764a(-34579235031726L)));
    ...
    public String mo13781a() {
        return C1172a.m764a(-34557760195246L);
    }
}
