...
/* renamed from: atd.w.i */
public final class C1215i extends C1207a {
    /* renamed from: a */
    public String mo13781a() {
        return C1172a.m764a(-37053136194222L);
    }
    ...
    public Boolean mo13785c(Context context) throws C1051c {
        if (Build.VERSION.SDK_INT >= 21) {
            return Boolean.valueOf(mo13966e(context).isTdlsSupported());
        }
