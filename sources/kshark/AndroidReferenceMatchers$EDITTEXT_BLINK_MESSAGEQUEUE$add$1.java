...
final class AndroidReferenceMatchers$EDITTEXT_BLINK_MESSAGEQUEUE$add$1 extends Lambda implements Function1<AndroidBuildMirror, Boolean> {
    public static final AndroidReferenceMatchers$EDITTEXT_BLINK_MESSAGEQUEUE$add$1 INSTANCE = new AndroidReferenceMatchers$EDITTEXT_BLINK_MESSAGEQUEUE$add$1();

    AndroidReferenceMatchers$EDITTEXT_BLINK_MESSAGEQUEUE$add$1() {
        super(1);
    }
