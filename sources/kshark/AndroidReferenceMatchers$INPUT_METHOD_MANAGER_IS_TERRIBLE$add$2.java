...
final class AndroidReferenceMatchers$INPUT_METHOD_MANAGER_IS_TERRIBLE$add$2 extends Lambda implements Function1<AndroidBuildMirror, Boolean> {
    public static final AndroidReferenceMatchers$INPUT_METHOD_MANAGER_IS_TERRIBLE$add$2 INSTANCE = new AndroidReferenceMatchers$INPUT_METHOD_MANAGER_IS_TERRIBLE$add$2();

    AndroidReferenceMatchers$INPUT_METHOD_MANAGER_IS_TERRIBLE$add$2() {
        super(1);
    }
