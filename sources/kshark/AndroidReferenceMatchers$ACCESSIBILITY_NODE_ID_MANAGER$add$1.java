...
final class AndroidReferenceMatchers$ACCESSIBILITY_NODE_ID_MANAGER$add$1 extends Lambda implements Function1<AndroidBuildMirror, Boolean> {
    public static final AndroidReferenceMatchers$ACCESSIBILITY_NODE_ID_MANAGER$add$1 INSTANCE = new AndroidReferenceMatchers$ACCESSIBILITY_NODE_ID_MANAGER$add$1();

    AndroidReferenceMatchers$ACCESSIBILITY_NODE_ID_MANAGER$add$1() {
        super(1);
    }
