...
final class AndroidReferenceMatchers$ACTIVITY_CHOOSE_MODEL$add$1 extends Lambda implements Function1<AndroidBuildMirror, Boolean> {
    public static final AndroidReferenceMatchers$ACTIVITY_CHOOSE_MODEL$add$1 INSTANCE = new AndroidReferenceMatchers$ACTIVITY_CHOOSE_MODEL$add$1();

    AndroidReferenceMatchers$ACTIVITY_CHOOSE_MODEL$add$1() {
        super(1);
    }
