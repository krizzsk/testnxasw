...
final class AndroidObjectInspectors$ANDROIDX_FRAGMENT$inspect$1 extends Lambda implements Function2<ObjectReporter, HeapObject.HeapInstance, Unit> {
    public static final AndroidObjectInspectors$ANDROIDX_FRAGMENT$inspect$1 INSTANCE = new AndroidObjectInspectors$ANDROIDX_FRAGMENT$inspect$1();

    AndroidObjectInspectors$ANDROIDX_FRAGMENT$inspect$1() {
        super(2);
    }
    ...
    public final void invoke(kshark.ObjectReporter r5, kshark.HeapObject.HeapInstance r6) {
        ...
        L_0x007f:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: kshark.AndroidObjectInspectors$ANDROIDX_FRAGMENT$inspect$1.invoke(kshark.ObjectReporter, kshark.HeapObject$HeapInstance):void");
    }
}
