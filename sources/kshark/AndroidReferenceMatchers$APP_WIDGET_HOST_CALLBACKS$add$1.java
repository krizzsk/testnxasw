...
final class AndroidReferenceMatchers$APP_WIDGET_HOST_CALLBACKS$add$1 extends Lambda implements Function1<AndroidBuildMirror, Boolean> {
    public static final AndroidReferenceMatchers$APP_WIDGET_HOST_CALLBACKS$add$1 INSTANCE = new AndroidReferenceMatchers$APP_WIDGET_HOST_CALLBACKS$add$1();

    AndroidReferenceMatchers$APP_WIDGET_HOST_CALLBACKS$add$1() {
        super(1);
    }
