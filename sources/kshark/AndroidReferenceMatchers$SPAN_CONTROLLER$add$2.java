...
final class AndroidReferenceMatchers$SPAN_CONTROLLER$add$2 extends Lambda implements Function1<AndroidBuildMirror, Boolean> {
    public static final AndroidReferenceMatchers$SPAN_CONTROLLER$add$2 INSTANCE = new AndroidReferenceMatchers$SPAN_CONTROLLER$add$2();

    AndroidReferenceMatchers$SPAN_CONTROLLER$add$2() {
        super(1);
    }
