...
final class AndroidReferenceMatchers$USER_MANAGER__SINSTANCE$add$1 extends Lambda implements Function1<AndroidBuildMirror, Boolean> {
    public static final AndroidReferenceMatchers$USER_MANAGER__SINSTANCE$add$1 INSTANCE = new AndroidReferenceMatchers$USER_MANAGER__SINSTANCE$add$1();

    AndroidReferenceMatchers$USER_MANAGER__SINSTANCE$add$1() {
        super(1);
    }
