...
final class AndroidObjectInspectors$INPUT_METHOD_MANAGER$inspect$1 extends Lambda implements Function2<ObjectReporter, HeapObject.HeapInstance, Unit> {
    public static final AndroidObjectInspectors$INPUT_METHOD_MANAGER$inspect$1 INSTANCE = new AndroidObjectInspectors$INPUT_METHOD_MANAGER$inspect$1();

    AndroidObjectInspectors$INPUT_METHOD_MANAGER$inspect$1() {
        super(2);
    }
