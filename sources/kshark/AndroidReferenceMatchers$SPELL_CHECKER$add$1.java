...
final class AndroidReferenceMatchers$SPELL_CHECKER$add$1 extends Lambda implements Function1<AndroidBuildMirror, Boolean> {
    public static final AndroidReferenceMatchers$SPELL_CHECKER$add$1 INSTANCE = new AndroidReferenceMatchers$SPELL_CHECKER$add$1();

    AndroidReferenceMatchers$SPELL_CHECKER$add$1() {
        super(1);
    }
