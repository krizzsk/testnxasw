...
final class AndroidReferenceMatchers$SPEECH_RECOGNIZER$add$1 extends Lambda implements Function1<AndroidBuildMirror, Boolean> {
    public static final AndroidReferenceMatchers$SPEECH_RECOGNIZER$add$1 INSTANCE = new AndroidReferenceMatchers$SPEECH_RECOGNIZER$add$1();

    AndroidReferenceMatchers$SPEECH_RECOGNIZER$add$1() {
        super(1);
    }
