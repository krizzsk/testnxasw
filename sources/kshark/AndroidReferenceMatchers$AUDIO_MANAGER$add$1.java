...
final class AndroidReferenceMatchers$AUDIO_MANAGER$add$1 extends Lambda implements Function1<AndroidBuildMirror, Boolean> {
    public static final AndroidReferenceMatchers$AUDIO_MANAGER$add$1 INSTANCE = new AndroidReferenceMatchers$AUDIO_MANAGER$add$1();

    AndroidReferenceMatchers$AUDIO_MANAGER$add$1() {
        super(1);
    }
