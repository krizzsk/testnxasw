...
final class AndroidReferenceMatchers$WINDOW_MANAGER_GLOBAL$add$1 extends Lambda implements Function1<AndroidBuildMirror, Boolean> {
    public static final AndroidReferenceMatchers$WINDOW_MANAGER_GLOBAL$add$1 INSTANCE = new AndroidReferenceMatchers$WINDOW_MANAGER_GLOBAL$add$1();

    AndroidReferenceMatchers$WINDOW_MANAGER_GLOBAL$add$1() {
        super(1);
    }
