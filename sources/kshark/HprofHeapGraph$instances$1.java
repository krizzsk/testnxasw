...
@Metadata(mo148866bv = {1, 0, 3}, mo148867d1 = {"\u0000\u0016\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\u0010\t\n\u0002\u0018\u0002\n\u0000\u0010\u0000\u001a\u00020\u00012\u0012\u0010\u0002\u001a\u000e\u0012\u0004\u0012\u00020\u0004\u0012\u0004\u0012\u00020\u00050\u0003H\n¢\u0006\u0002\b\u0006"}, mo148868d2 = {"<anonymous>", "Lkshark/HeapObject$HeapInstance;", "it", "Lkotlin/Pair;", "", "Lkshark/internal/IndexedObject$IndexedInstance;", "invoke"}, mo148869k = 3, mo148870mv = {1, 1, 15})
...
final class HprofHeapGraph$instances$1 extends Lambda implements Function1<Pair<? extends Long, ? extends IndexedObject.IndexedInstance>, HeapObject.HeapInstance> {
    ...
    public final HeapObject.HeapInstance invoke(Pair<Long, IndexedObject.IndexedInstance> pair) {
        ...
        return new HeapObject.HeapInstance(this.this$0, second, longValue, this.this$0.f6408e.getPrimitiveWrapperTypes().contains(Long.valueOf(second.getClassId())));
    }
}
