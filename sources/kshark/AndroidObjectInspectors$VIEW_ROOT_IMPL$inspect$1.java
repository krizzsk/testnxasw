...
final class AndroidObjectInspectors$VIEW_ROOT_IMPL$inspect$1 extends Lambda implements Function2<ObjectReporter, HeapObject.HeapInstance, Unit> {
    public static final AndroidObjectInspectors$VIEW_ROOT_IMPL$inspect$1 INSTANCE = new AndroidObjectInspectors$VIEW_ROOT_IMPL$inspect$1();
    ...
    public final void invoke(ObjectReporter objectReporter, HeapObject.HeapInstance heapInstance) {
        ...
        if (heapField.getValue().isNullReference()) {
            ...
            objectReporter.getNotLeakingReasons().add(AndroidObjectInspectorsKt.m6297a(heapField, "not null"));
        }
    }
}
