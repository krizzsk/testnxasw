...
final class AndroidReferenceMatchers$SPAN_CONTROLLER$add$1 extends Lambda implements Function1<AndroidBuildMirror, Boolean> {
    public static final AndroidReferenceMatchers$SPAN_CONTROLLER$add$1 INSTANCE = new AndroidReferenceMatchers$SPAN_CONTROLLER$add$1();

    AndroidReferenceMatchers$SPAN_CONTROLLER$add$1() {
        super(1);
    }
