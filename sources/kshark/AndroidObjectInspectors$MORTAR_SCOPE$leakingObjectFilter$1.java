...
final class AndroidObjectInspectors$MORTAR_SCOPE$leakingObjectFilter$1 extends Lambda implements Function1<HeapObject, Boolean> {
    public static final AndroidObjectInspectors$MORTAR_SCOPE$leakingObjectFilter$1 INSTANCE = new AndroidObjectInspectors$MORTAR_SCOPE$leakingObjectFilter$1();

    AndroidObjectInspectors$MORTAR_SCOPE$leakingObjectFilter$1() {
        super(1);
    }
