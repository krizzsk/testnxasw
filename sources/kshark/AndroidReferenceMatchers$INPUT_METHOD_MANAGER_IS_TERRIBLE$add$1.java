...
final class AndroidReferenceMatchers$INPUT_METHOD_MANAGER_IS_TERRIBLE$add$1 extends Lambda implements Function1<AndroidBuildMirror, Boolean> {
    public static final AndroidReferenceMatchers$INPUT_METHOD_MANAGER_IS_TERRIBLE$add$1 INSTANCE = new AndroidReferenceMatchers$INPUT_METHOD_MANAGER_IS_TERRIBLE$add$1();

    AndroidReferenceMatchers$INPUT_METHOD_MANAGER_IS_TERRIBLE$add$1() {
        super(1);
    }
