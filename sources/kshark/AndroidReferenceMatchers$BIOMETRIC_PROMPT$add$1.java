...
final class AndroidReferenceMatchers$BIOMETRIC_PROMPT$add$1 extends Lambda implements Function1<AndroidBuildMirror, Boolean> {
    public static final AndroidReferenceMatchers$BIOMETRIC_PROMPT$add$1 INSTANCE = new AndroidReferenceMatchers$BIOMETRIC_PROMPT$add$1();

    AndroidReferenceMatchers$BIOMETRIC_PROMPT$add$1() {
        super(1);
    }
