...
final class AndroidReferenceMatchers$IREQUEST_FINISH_CALLBACK$add$1 extends Lambda implements Function1<AndroidBuildMirror, Boolean> {
    public static final AndroidReferenceMatchers$IREQUEST_FINISH_CALLBACK$add$1 INSTANCE = new AndroidReferenceMatchers$IREQUEST_FINISH_CALLBACK$add$1();

    AndroidReferenceMatchers$IREQUEST_FINISH_CALLBACK$add$1() {
        super(1);
    }
