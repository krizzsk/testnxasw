...
final class AndroidReferenceMatchers$MAGNIFIER$add$1 extends Lambda implements Function1<AndroidBuildMirror, Boolean> {
    public static final AndroidReferenceMatchers$MAGNIFIER$add$1 INSTANCE = new AndroidReferenceMatchers$MAGNIFIER$add$1();

    AndroidReferenceMatchers$MAGNIFIER$add$1() {
        super(1);
    }
