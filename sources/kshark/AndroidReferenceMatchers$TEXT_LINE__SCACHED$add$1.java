...
final class AndroidReferenceMatchers$TEXT_LINE__SCACHED$add$1 extends Lambda implements Function1<AndroidBuildMirror, Boolean> {
    public static final AndroidReferenceMatchers$TEXT_LINE__SCACHED$add$1 INSTANCE = new AndroidReferenceMatchers$TEXT_LINE__SCACHED$add$1();

    AndroidReferenceMatchers$TEXT_LINE__SCACHED$add$1() {
        super(1);
    }
