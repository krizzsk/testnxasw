...
final class AndroidReferenceMatchers$ACCESSIBILITY_ITERATORS$add$1 extends Lambda implements Function1<AndroidBuildMirror, Boolean> {
    public static final AndroidReferenceMatchers$ACCESSIBILITY_ITERATORS$add$1 INSTANCE = new AndroidReferenceMatchers$ACCESSIBILITY_ITERATORS$add$1();

    AndroidReferenceMatchers$ACCESSIBILITY_ITERATORS$add$1() {
        super(1);
    }
