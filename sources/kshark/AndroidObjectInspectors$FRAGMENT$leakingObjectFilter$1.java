...
final class AndroidObjectInspectors$FRAGMENT$leakingObjectFilter$1 extends Lambda implements Function1<HeapObject, Boolean> {
    public static final AndroidObjectInspectors$FRAGMENT$leakingObjectFilter$1 INSTANCE = new AndroidObjectInspectors$FRAGMENT$leakingObjectFilter$1();

    AndroidObjectInspectors$FRAGMENT$leakingObjectFilter$1() {
        super(1);
    }
