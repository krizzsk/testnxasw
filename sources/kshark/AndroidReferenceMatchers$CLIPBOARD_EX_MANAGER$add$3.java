...
final class AndroidReferenceMatchers$CLIPBOARD_EX_MANAGER$add$3 extends Lambda implements Function1<AndroidBuildMirror, Boolean> {
    ...
    AndroidReferenceMatchers$CLIPBOARD_EX_MANAGER$add$3() {
        super(1);
    }
    ...
    public final boolean invoke(AndroidBuildMirror androidBuildMirror) {
        ...
        return Intrinsics.areEqual((Object) androidBuildMirror.getManufacturer(), (Object) "samsung") && androidBuildMirror.getSdkInt() == 22;
    }
}
