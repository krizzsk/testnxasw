...
final class AndroidReferenceMatchers$INPUT_METHOD_MANAGER_IS_TERRIBLE$add$3 extends Lambda implements Function1<AndroidBuildMirror, Boolean> {
    public static final AndroidReferenceMatchers$INPUT_METHOD_MANAGER_IS_TERRIBLE$add$3 INSTANCE = new AndroidReferenceMatchers$INPUT_METHOD_MANAGER_IS_TERRIBLE$add$3();

    AndroidReferenceMatchers$INPUT_METHOD_MANAGER_IS_TERRIBLE$add$3() {
        super(1);
    }
