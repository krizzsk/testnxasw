...
final class AndroidReferenceMatchers$ACCOUNT_MANAGER$add$1 extends Lambda implements Function1<AndroidBuildMirror, Boolean> {
    public static final AndroidReferenceMatchers$ACCOUNT_MANAGER$add$1 INSTANCE = new AndroidReferenceMatchers$ACCOUNT_MANAGER$add$1();

    AndroidReferenceMatchers$ACCOUNT_MANAGER$add$1() {
        super(1);
    }
