...
final class AndroidReferenceMatchers$MEDIA_SCANNER_CONNECTION$add$1 extends Lambda implements Function1<AndroidBuildMirror, Boolean> {
    public static final AndroidReferenceMatchers$MEDIA_SCANNER_CONNECTION$add$1 INSTANCE = new AndroidReferenceMatchers$MEDIA_SCANNER_CONNECTION$add$1();

    AndroidReferenceMatchers$MEDIA_SCANNER_CONNECTION$add$1() {
        super(1);
    }
