...
final class AndroidObjectInspectors$MORTAR_PRESENTER$inspect$1 extends Lambda implements Function2<ObjectReporter, HeapObject.HeapInstance, Unit> {
    public static final AndroidObjectInspectors$MORTAR_PRESENTER$inspect$1 INSTANCE = new AndroidObjectInspectors$MORTAR_PRESENTER$inspect$1();

    AndroidObjectInspectors$MORTAR_PRESENTER$inspect$1() {
        super(2);
    }
    ...
    public final void invoke(ObjectReporter objectReporter, HeapObject.HeapInstance heapInstance) {
        ...
        if (heapField.getValue().isNullReference()) {
            objectReporter.getLeakingReasons().add(AndroidObjectInspectorsKt.m6297a(heapField, "null"));
        } else {
            objectReporter.getLabels().add(AndroidObjectInspectorsKt.m6297a(heapField, GuideParamModel.ACTION_SET));
        }
    }
}
