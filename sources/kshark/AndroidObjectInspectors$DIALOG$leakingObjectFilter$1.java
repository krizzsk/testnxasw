...
final class AndroidObjectInspectors$DIALOG$leakingObjectFilter$1 extends Lambda implements Function1<HeapObject, Boolean> {
    public static final AndroidObjectInspectors$DIALOG$leakingObjectFilter$1 INSTANCE = new AndroidObjectInspectors$DIALOG$leakingObjectFilter$1();

    AndroidObjectInspectors$DIALOG$leakingObjectFilter$1() {
        super(1);
    }
