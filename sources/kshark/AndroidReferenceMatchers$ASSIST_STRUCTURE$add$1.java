...
final class AndroidReferenceMatchers$ASSIST_STRUCTURE$add$1 extends Lambda implements Function1<AndroidBuildMirror, Boolean> {
    public static final AndroidReferenceMatchers$ASSIST_STRUCTURE$add$1 INSTANCE = new AndroidReferenceMatchers$ASSIST_STRUCTURE$add$1();

    AndroidReferenceMatchers$ASSIST_STRUCTURE$add$1() {
        super(1);
    }
