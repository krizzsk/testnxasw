...
final class HprofWriter$write$3 extends Lambda implements Function1<BufferedSink, Unit> {
    ...
    HprofWriter$write$3(HprofWriter hprofWriter, HprofRecord hprofRecord) {
        super(1);
    ...
    public final void invoke(BufferedSink bufferedSink) {
        ...
        bufferedSink.writeInt(((HprofRecord.StackTraceRecord) this.$record).getStackTraceSerialNumber());
        bufferedSink.writeInt(((HprofRecord.StackTraceRecord) this.$record).getThreadSerialNumber());
        bufferedSink.writeInt(((HprofRecord.StackTraceRecord) this.$record).getStackFrameIds().length);
        this.this$0.m6350a(bufferedSink, ((HprofRecord.StackTraceRecord) this.$record).getStackFrameIds());
    }
}
