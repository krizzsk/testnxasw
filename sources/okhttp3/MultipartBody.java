...
public final class MultipartBody extends RequestBody {
    ...
    /* renamed from: a */
    private static final byte[] f7044a = {58, 32};

    /* renamed from: b */
    private static final byte[] f7045b = {Ascii.f55139CR, 10};

    /* renamed from: c */
    private static final byte[] f7046c = {45, 45};

    /* renamed from: d */
    private final ByteString f7047d;

    /* renamed from: e */
    private final MediaType f7048e;

    /* renamed from: f */
    private final MediaType f7049f;

    /* renamed from: g */
    private final List<Part> f7050g;

    /* renamed from: h */
    private long f7051h = -1;

    MultipartBody(ByteString byteString, MediaType mediaType, List<Part> list) {
        this.f7047d = byteString;
        this.f7048e = mediaType;
        this.f7049f = MediaType.get(mediaType + "; boundary=" + byteString.utf8());
        this.f7050g = C3000Util.immutableList(list);
    }
    ...
    public long contentLength() throws IOException {
        ...
        long a = m6760a((BufferedSink) null, true);
        this.f7051h = a;
        return a;
    }

    public void writeTo(BufferedSink bufferedSink) throws IOException {
        m6760a(bufferedSink, false);
    }
    ...
    private long m6760a(@javax.annotation.Nullable okio.BufferedSink r13, boolean r14) throws java.io.IOException {
        /*
            r12 = this;
        ...
        L_0x0009:
            r0 = 0
        L_0x000a:
            java.util.List<okhttp3.MultipartBody$Part> r1 = r12.f7050g
            int r1 = r1.size()
            r2 = 0
            r3 = 0
            r5 = 0
        L_0x0014:
            ...
            java.util.List<okhttp3.MultipartBody$Part> r6 = r12.f7050g
        ...
        L_0x00c4:
            return r3
        */
        throw new UnsupportedOperationException("Method not decompiled: okhttp3.MultipartBody.m6760a(okio.BufferedSink, boolean):long");
    }

    /* renamed from: a */
    static StringBuilder m6761a(StringBuilder sb, String str) {
    ...
    public static final class Part {
        ...
        public static Part createFormData(String str, @Nullable String str2, RequestBody requestBody) {
            if (str != null) {
                ...
                MultipartBody.m6761a(sb, str);
                if (str2 != null) {
                    sb.append("; filename=");
                    MultipartBody.m6761a(sb, str2);
                }
                return create(Headers.m6747of("Content-Disposition", sb.toString()), requestBody);
            }
