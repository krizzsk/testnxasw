...
class Huffman {
    ...
    public void mo30572a(okio.ByteString r8, okio.BufferedSink r9) throws java.io.IOException {
        /*
            r7 = this;
            r0 = 0
            r1 = 0
        ...
        L_0x003b:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: okhttp3.internal.http2.Huffman.mo30572a(okio.ByteString, okio.BufferedSink):void");
    }

    /* access modifiers changed from: package-private */
    /* renamed from: a */
    public int mo30571a(ByteString byteString) {
        long j = 0;
        for (int i = 0; i < byteString.size(); i++) {
            j += (long) f7336b[byteString.getByte(i) & 255];
        }
        return (int) ((j + 7) >> 3);
    }
    ...
    /* access modifiers changed from: package-private */
    /* renamed from: a */
    public byte[] mo30573a(byte[] bArr) {
        ByteArrayOutputStream byteArrayOutputStream = new ByteArrayOutputStream();
        Node node = this.f7338d;
        byte b = 0;
        int i = 0;
        for (byte b2 : bArr) {
            b = (b << 8) | (b2 & 255);
    ...
    /* renamed from: a */
    private void m6898a(int i, int i2, byte b) {
        Node node = new Node(i, b);
        Node node2 = this.f7338d;
        while (b > 8) {
            b = (byte) (b - 8);
            int i3 = (i2 >>> b) & 255;
