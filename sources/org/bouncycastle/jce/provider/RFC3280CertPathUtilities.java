...
class RFC3280CertPathUtilities {
    ...
    protected static void checkCRLs(org.bouncycastle.jcajce.PKIXCertRevocationCheckerParameters r23, org.bouncycastle.jcajce.PKIXExtendedParameters r24, java.util.Date r25, java.util.Date r26, java.security.cert.X509Certificate r27, java.security.cert.X509Certificate r28, java.security.PublicKey r29, java.util.List r30, org.bouncycastle.jcajce.util.JcaJceHelper r31) throws org.bouncycastle.jce.provider.AnnotatedException, org.bouncycastle.jce.provider.RecoverableCertPathValidatorException {
        /*
            java.lang.String r0 = CRL_DISTRIBUTION_POINTS     // Catch:{ Exception -> 0x019c }
            r13 = r27
            org.bouncycastle.asn1.ASN1Primitive r0 = org.bouncycastle.jce.provider.CertPathValidatorUtilities.getExtensionValue(r13, r0)     // Catch:{ Exception -> 0x019c }
            org.bouncycastle.asn1.x509.CRLDistPoint r0 = org.bouncycastle.asn1.x509.CRLDistPoint.getInstance(r0)     // Catch:{ Exception -> 0x019c }
            ...
            java.util.Map r2 = r24.getNamedCRLStoreMap()     // Catch:{ AnnotatedException -> 0x0193 }
            r15 = r26
            r12 = r31
            java.util.List r2 = org.bouncycastle.jce.provider.CertPathValidatorUtilities.getAdditionalStoresFromCRLDistributionPoint(r0, r2, r15, r12)     // Catch:{ AnnotatedException -> 0x0193 }
            java.util.Iterator r2 = r2.iterator()     // Catch:{ AnnotatedException -> 0x0193 }
        L_0x0023:
            boolean r3 = r2.hasNext()     // Catch:{ AnnotatedException -> 0x0193 }
            if (r3 == 0) goto L_0x0033
            java.lang.Object r3 = r2.next()     // Catch:{ AnnotatedException -> 0x0193 }
            org.bouncycastle.jcajce.PKIXCRLStore r3 = (org.bouncycastle.jcajce.PKIXCRLStore) r3     // Catch:{ AnnotatedException -> 0x0193 }
            r1.addCRLStore(r3)     // Catch:{ AnnotatedException -> 0x0193 }
            goto L_0x0023
        L_0x0033:
