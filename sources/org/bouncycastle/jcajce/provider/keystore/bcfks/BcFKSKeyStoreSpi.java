...
import org.bouncycastle.asn1.p075bc.EncryptedObjectStoreData;
import org.bouncycastle.asn1.p075bc.EncryptedPrivateKeyData;
import org.bouncycastle.asn1.p075bc.EncryptedSecretKeyData;
import org.bouncycastle.asn1.p075bc.ObjectData;
import org.bouncycastle.asn1.p075bc.ObjectDataSequence;
import org.bouncycastle.asn1.p075bc.ObjectStore;
import org.bouncycastle.asn1.p075bc.ObjectStoreData;
import org.bouncycastle.asn1.p075bc.ObjectStoreIntegrityCheck;
import org.bouncycastle.asn1.p075bc.PbkdMacIntegrityCheck;
import org.bouncycastle.asn1.p075bc.SecretKeyData;
import org.bouncycastle.asn1.p075bc.SignatureCheck;
...
class BcFKSKeyStoreSpi extends KeyStoreSpi {
    ...
    private static class SharedKeyStoreSpi extends BcFKSKeyStoreSpi implements PKCSObjectIdentifiers, X509ObjectIdentifiers {
        ...
        public SharedKeyStoreSpi(JcaJceHelper jcaJceHelper) {
            ...
            try {
                ...
                jcaJceHelper.createSecureRandom(DCryptoUtils.KEY_IP_BLOCKING_STATUS_DEFAULT).nextBytes(this.seedKey);
    ...
    public java.security.cert.Certificate[] engineGetCertificateChain(java.lang.String r5) {
        /*
            ...
            org.bouncycastle.asn1.bc.ObjectData r5 = (org.bouncycastle.asn1.p075bc.ObjectData) r5
        ...
        L_0x0022:
            byte[] r5 = r5.getData()
            org.bouncycastle.asn1.bc.EncryptedPrivateKeyData r5 = org.bouncycastle.asn1.p075bc.EncryptedPrivateKeyData.getInstance(r5)
