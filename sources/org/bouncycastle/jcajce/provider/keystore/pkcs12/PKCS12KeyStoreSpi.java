...
public class PKCS12KeyStoreSpi extends KeyStoreSpi implements PKCSObjectIdentifiers, X509ObjectIdentifiers, BCKeyStore {
    ...
    private int itCount = Constants.CONN_CHANNEL_RECVBUFFERSIZE;
    ...
    private class CertId {
        ...
        CertId(PublicKey publicKey) {
            this.f8096id = PKCS12KeyStoreSpi.this.createSubjectKeyId(publicKey).getKeyIdentifier();
        }
        ...
        public boolean equals(Object obj) {
            ...
            return Arrays.areEqual(this.f8096id, ((CertId) obj).f8096id);
        }

        public int hashCode() {
            return Arrays.hashCode(this.f8096id);
        }
    }
    ...
    public byte[] cryptData(boolean z, AlgorithmIdentifier algorithmIdentifier, char[] cArr, boolean z2, byte[] bArr) throws IOException {
        ...
        int i = z ? 1 : 2;
        if (algorithm.mo33046on(PKCSObjectIdentifiers.pkcs_12PbeIds)) {
