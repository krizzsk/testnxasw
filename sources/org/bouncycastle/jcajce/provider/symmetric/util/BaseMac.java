            ...
            if (key instanceof PKCS12Key) {
                try {
                    ...
                    try {
                        ...
                        cipherParameters = PBE.C3301Util.makePBEMacParameters(secretKey, 2, i, i2, pBEParameterSpec);
                ...
                if (bCPBEKey.getParam() != null) {
                    ...
                    cipherParameters = PBE.C3301Util.makePBEMacParameters(bCPBEKey, algorithmParameterSpec);
                } else {
