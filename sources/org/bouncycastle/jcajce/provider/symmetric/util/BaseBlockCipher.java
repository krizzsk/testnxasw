...
public class BaseBlockCipher extends BaseWrapCipher implements PBE {
    ...
    /* JADX WARNING: Removed duplicated region for block: B:238:0x04eb A[Catch:{ IllegalArgumentException -> 0x051b, Exception -> 0x0510 }] */
    ...
    public void engineInit(int r21, java.security.Key r22, java.security.spec.AlgorithmParameterSpec r23, java.security.SecureRandom r24) throws java.security.InvalidKeyException, java.security.InvalidAlgorithmParameterException {
        ...
        L_0x008d:
            ...
            r16 = r5
            r18 = r7
            org.bouncycastle.crypto.CipherParameters r5 = org.bouncycastle.jcajce.provider.symmetric.util.PBE.C3301Util.makePBEParameters(r13, r14, r15, r16, r17, r18, r19)
        ...
        L_0x00e0:
            ...
            java.lang.String r7 = r7.getAlgorithmName()
            org.bouncycastle.crypto.CipherParameters r5 = org.bouncycastle.jcajce.provider.symmetric.util.PBE.C3301Util.makePBEParameters(r5, r3, r7)
        L_0x00f7:
            boolean r7 = r5 instanceof org.bouncycastle.crypto.params.ParametersWithIV
            if (r7 == 0) goto L_0x0201
            goto L_0x00ae
        ...
        L_0x0167:
            r5 = r2
            javax.crypto.SecretKey r5 = (javax.crypto.SecretKey) r5     // Catch:{ Exception -> 0x0526 }
            boolean r7 = r3 instanceof javax.crypto.spec.PBEParameterSpec
        ...
        L_0x01b9:
            ...
            r17 = r5
            org.bouncycastle.crypto.CipherParameters r7 = org.bouncycastle.jcajce.provider.symmetric.util.PBE.C3301Util.makePBEParameters(r12, r13, r14, r15, r16, r17, r18)
        L_0x01d6:
            r5 = r7
            goto L_0x01fb
        L_0x01d8:
        ...
        L_0x01e0:
            ...
            java.lang.String r18 = r7.getAlgorithmName()
            r17 = r5
            org.bouncycastle.crypto.CipherParameters r5 = org.bouncycastle.jcajce.provider.symmetric.util.PBE.C3301Util.makePBEParameters(r12, r13, r14, r15, r16, r17, r18)
        L_0x01fb:
            boolean r7 = r5 instanceof org.bouncycastle.crypto.params.ParametersWithIV
            if (r7 == 0) goto L_0x0201
            goto L_0x00ae
        ...
        L_0x04b0:
            ...
            goto L_0x04d5
        L_0x04b9:
            java.security.InvalidParameterException r2 = new java.security.InvalidParameterException     // Catch:{ IllegalArgumentException -> 0x051b, Exception -> 0x0510 }
            java.lang.StringBuilder r3 = new java.lang.StringBuilder     // Catch:{ IllegalArgumentException -> 0x051b, Exception -> 0x0510 }
            r3.<init>()     // Catch:{ IllegalArgumentException -> 0x051b, Exception -> 0x0510 }
            java.lang.String r4 = "unknown opmode "
            r3.append(r4)     // Catch:{ IllegalArgumentException -> 0x051b, Exception -> 0x0510 }
            r3.append(r0)     // Catch:{ IllegalArgumentException -> 0x051b, Exception -> 0x0510 }
            java.lang.String r0 = " passed"
            r3.append(r0)     // Catch:{ IllegalArgumentException -> 0x051b, Exception -> 0x0510 }
            java.lang.String r0 = r3.toString()     // Catch:{ IllegalArgumentException -> 0x051b, Exception -> 0x0510 }
            r2.<init>(r0)     // Catch:{ IllegalArgumentException -> 0x051b, Exception -> 0x0510 }
            throw r2     // Catch:{ IllegalArgumentException -> 0x051b, Exception -> 0x0510 }
        L_0x04d5:
            org.bouncycastle.jcajce.provider.symmetric.util.BaseBlockCipher$GenericBlockCipher r0 = r1.cipher     // Catch:{ IllegalArgumentException -> 0x051b, Exception -> 0x0510 }
            r2 = 0
            r0.init(r2, r5)     // Catch:{ IllegalArgumentException -> 0x051b, Exception -> 0x0510 }
            goto L_0x04e1
        L_0x04dc:
            org.bouncycastle.jcajce.provider.symmetric.util.BaseBlockCipher$GenericBlockCipher r0 = r1.cipher     // Catch:{ IllegalArgumentException -> 0x051b, Exception -> 0x0510 }
            r0.init(r11, r5)     // Catch:{ IllegalArgumentException -> 0x051b, Exception -> 0x0510 }
        L_0x04e1:
            org.bouncycastle.jcajce.provider.symmetric.util.BaseBlockCipher$GenericBlockCipher r0 = r1.cipher     // Catch:{ IllegalArgumentException -> 0x051b, Exception -> 0x0510 }
            boolean r0 = r0 instanceof org.bouncycastle.jcajce.provider.symmetric.util.BaseBlockCipher.AEADGenericBlockCipher     // Catch:{ IllegalArgumentException -> 0x051b, Exception -> 0x0510 }
            if (r0 == 0) goto L_0x050f
            org.bouncycastle.crypto.params.AEADParameters r0 = r1.aeadParams     // Catch:{ IllegalArgumentException -> 0x051b, Exception -> 0x0510 }
            if (r0 != 0) goto L_0x050f
            org.bouncycastle.jcajce.provider.symmetric.util.BaseBlockCipher$GenericBlockCipher r0 = r1.cipher     // Catch:{ IllegalArgumentException -> 0x051b, Exception -> 0x0510 }
            org.bouncycastle.jcajce.provider.symmetric.util.BaseBlockCipher$AEADGenericBlockCipher r0 = (org.bouncycastle.jcajce.provider.symmetric.util.BaseBlockCipher.AEADGenericBlockCipher) r0     // Catch:{ IllegalArgumentException -> 0x051b, Exception -> 0x0510 }
            org.bouncycastle.crypto.modes.AEADCipher r0 = r0.cipher     // Catch:{ IllegalArgumentException -> 0x051b, Exception -> 0x0510 }
            org.bouncycastle.crypto.params.AEADParameters r2 = new org.bouncycastle.crypto.params.AEADParameters     // Catch:{ IllegalArgumentException -> 0x051b, Exception -> 0x0510 }
            org.bouncycastle.crypto.params.ParametersWithIV r3 = r1.ivParam     // Catch:{ IllegalArgumentException -> 0x051b, Exception -> 0x0510 }
            org.bouncycastle.crypto.CipherParameters r3 = r3.getParameters()     // Catch:{ IllegalArgumentException -> 0x051b, Exception -> 0x0510 }
            org.bouncycastle.crypto.params.KeyParameter r3 = (org.bouncycastle.crypto.params.KeyParameter) r3     // Catch:{ IllegalArgumentException -> 0x051b, Exception -> 0x0510 }
            byte[] r0 = r0.getMac()     // Catch:{ IllegalArgumentException -> 0x051b, Exception -> 0x0510 }
            int r0 = r0.length     // Catch:{ IllegalArgumentException -> 0x051b, Exception -> 0x0510 }
            int r0 = r0 * 8
            org.bouncycastle.crypto.params.ParametersWithIV r4 = r1.ivParam     // Catch:{ IllegalArgumentException -> 0x051b, Exception -> 0x0510 }
            byte[] r4 = r4.getIV()     // Catch:{ IllegalArgumentException -> 0x051b, Exception -> 0x0510 }
            r2.<init>(r3, r0, r4)     // Catch:{ IllegalArgumentException -> 0x051b, Exception -> 0x0510 }
            r1.aeadParams = r2     // Catch:{ IllegalArgumentException -> 0x051b, Exception -> 0x0510 }
        L_0x050f:
            return
        L_0x0510:
            r0 = move-exception
            ...
            if (upperCase.equals("ECB")) {
                ...
                if (this.modeName.startsWith("OFB")) {
                    ...
                    if (equals || this.modeName.length() == 6) {
                        this.ivLength = this.baseEngine.getBlockSize();
                        aEADGenericBlockCipher = new BufferedGenericBlockCipher((BlockCipher) new PGPCFBBlockCipher(this.baseEngine, equals));
                    } else {
                    ...
                    if (blockCipher5 instanceof DSTU7624Engine) {
                        this.ivLength = blockCipher5.getBlockSize();
                        aEADGenericBlockCipher2 = new AEADGenericBlockCipher(new KGCMBlockCipher(this.baseEngine));
                    } else {
                        this.ivLength = 12;
                        aEADGenericBlockCipher = new AEADGenericBlockCipher(new GCMBlockCipher(blockCipher5));
                    }
                } else {
                    throw new NoSuchAlgorithmException("can't support mode " + str);
                }
