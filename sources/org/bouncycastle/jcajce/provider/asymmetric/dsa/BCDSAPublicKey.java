...
public class BCDSAPublicKey implements DSAPublicKey {
    ...
    /* renamed from: y */
    private BigInteger f8082y;

    BCDSAPublicKey(DSAPublicKey dSAPublicKey) {
        this.f8082y = dSAPublicKey.getY();
        DSAParams params = dSAPublicKey.getParams();
        this.dsaSpec = params;
        this.lwKeyParams = new DSAPublicKeyParameters(this.f8082y, DSAUtil.toDSAParameters(params));
    }

    BCDSAPublicKey(DSAPublicKeySpec dSAPublicKeySpec) {
        this.f8082y = dSAPublicKeySpec.getY();
        ...
        this.lwKeyParams = new DSAPublicKeyParameters(this.f8082y, DSAUtil.toDSAParameters(dSAParameterSpec));
    }

    public BCDSAPublicKey(SubjectPublicKeyInfo subjectPublicKeyInfo) {
        try {
            this.f8082y = ((ASN1Integer) subjectPublicKeyInfo.parsePublicKey()).getValue();
            ...
            this.lwKeyParams = new DSAPublicKeyParameters(this.f8082y, DSAUtil.toDSAParameters(this.dsaSpec));
    ...
    BCDSAPublicKey(DSAPublicKeyParameters dSAPublicKeyParameters) {
        this.f8082y = dSAPublicKeyParameters.getY();
    ...
    public byte[] getEncoded() {
        ...
        if (this.dsaSpec == null) {
            ...
            aSN1Integer = new ASN1Integer(this.f8082y);
        } else {
    ...
    public String toString() {
        ...
        stringBuffer.append(DSAUtil.generateKeyFingerprint(this.f8082y, getParams()));
