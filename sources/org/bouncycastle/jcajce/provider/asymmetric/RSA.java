...
public class RSA {
    ...
    public static class Mappings extends AsymmetricAlgorithmProvider {
        ...
        public void configure(ConfigurableProvider configurableProvider) {
            ...
            if (configurableProvider2.hasAlgorithm("MessageDigest", MessageDigestAlgorithms.MD2)) {
                str2 = "SHA3-512";
                str = "SHA3-384";
                addDigestSignature(configurableProvider2, MessageDigestAlgorithms.MD2, "org.bouncycastle.jcajce.provider.asymmetric.rsa.DigestSignatureSpi$MD2", PKCSObjectIdentifiers.md2WithRSAEncryption);
            } else {
                str = "SHA3-384";
                str2 = "SHA3-512";
            }
            ...
            if (configurableProvider2.hasAlgorithm("MessageDigest", MessageDigestAlgorithms.MD5)) {
                addDigestSignature(configurableProvider2, MessageDigestAlgorithms.MD5, "org.bouncycastle.jcajce.provider.asymmetric.rsa.DigestSignatureSpi$MD5", PKCSObjectIdentifiers.md5WithRSAEncryption);
                addISO9796Signature(configurableProvider2, MessageDigestAlgorithms.MD5, "org.bouncycastle.jcajce.provider.asymmetric.rsa.ISOSignatureSpi$MD5WithRSAEncryption");
            }
