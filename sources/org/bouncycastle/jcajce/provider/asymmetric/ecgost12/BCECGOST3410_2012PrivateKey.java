...
public class BCECGOST3410_2012PrivateKey implements ECPrivateKey, ECPointEncoder, org.bouncycastle.jce.interfaces.ECPrivateKey, PKCS12BagAttributeCarrier {
    static final long serialVersionUID = 7245981689601667138L;
    private String algorithm = "ECGOST3410-2012";
    private transient PKCS12BagAttributeCarrierImpl attrCarrier = new PKCS12BagAttributeCarrierImpl();

    /* renamed from: d */
    private transient BigInteger f8086d;
    ...
    public BCECGOST3410_2012PrivateKey(String str, ECPrivateKeyParameters eCPrivateKeyParameters) {
        this.algorithm = str;
        this.f8086d = eCPrivateKeyParameters.getD();
        this.ecSpec = null;
    }
    ...
    public BCECGOST3410_2012PrivateKey(ECPrivateKey eCPrivateKey) {
        this.f8086d = eCPrivateKey.getS();
        this.algorithm = eCPrivateKey.getAlgorithm();
        this.ecSpec = eCPrivateKey.getParams();
    }

    public BCECGOST3410_2012PrivateKey(ECPrivateKeySpec eCPrivateKeySpec) {
        this.f8086d = eCPrivateKeySpec.getS();
    ...
    public BCECGOST3410_2012PrivateKey(BCECGOST3410_2012PrivateKey bCECGOST3410_2012PrivateKey) {
        this.f8086d = bCECGOST3410_2012PrivateKey.f8086d;
    ...
    public BCECGOST3410_2012PrivateKey(org.bouncycastle.jce.spec.ECPrivateKeySpec eCPrivateKeySpec) {
        this.f8086d = eCPrivateKeySpec.getD();
    ...
    public byte[] getEncoded() {
        /*
            r12 = this;
            java.math.BigInteger r0 = r12.f8086d
            int r0 = r0.bitLength()
            r1 = 0
        ...
        L_0x007c:
            ...
            org.bouncycastle.math.ec.ECPoint r1 = org.bouncycastle.jcajce.provider.asymmetric.util.EC5Util.convertPoint((org.bouncycastle.math.p085ec.ECCurve) r7, (java.security.spec.ECPoint) r1)
            boolean r3 = r12.withCompression
            r8.<init>((org.bouncycastle.math.p085ec.ECPoint) r1, (boolean) r3)
            java.security.spec.ECParameterSpec r1 = r12.ecSpec
    ...
    public String toString() {
        return ECUtil.privateKeyToString(this.algorithm, this.f8086d, engineGetSpec());
    }
}
