...
public abstract class KeyPairGeneratorSpi extends KeyPairGenerator {
    ...
    public static class C3261EC extends KeyPairGeneratorSpi {
        ...
        public C3261EC(String str, ProviderConfiguration providerConfiguration) {
            super(str);
            this.engine = new ECKeyPairGenerator();
            this.ecParams = null;
            this.strength = 239;
    ...
    public static class ECDH extends C3261EC {
        public ECDH() {
    ...
    public static class ECDHC extends C3261EC {
        public ECDHC() {
    ...
    public static class ECDSA extends C3261EC {
        public ECDSA() {
    ...
    public static class ECMQV extends C3261EC {
        public ECMQV() {
