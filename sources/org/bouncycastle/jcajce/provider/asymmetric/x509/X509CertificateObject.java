...
class X509CertificateObject extends X509CertificateImpl implements PKCS12BagAttributeCarrier {
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:12:0x0015, code lost:
        r11 = null;
        r10 = r12.f8095c.getEncoded(org.bouncycastle.asn1.ASN1Encoding.DER);
     */
    ...
    private org.bouncycastle.jcajce.provider.asymmetric.x509.X509CertificateInternal getInternalCertificate() {
        /*
            ...
            monitor-enter(r0)
            org.bouncycastle.jcajce.provider.asymmetric.x509.X509CertificateInternal r1 = r12.internalCertificateValue     // Catch:{ all -> 0x0042 }
        ...
        L_0x000b:
            monitor-exit(r0)     // Catch:{ all -> 0x0042 }
            r0 = 0
            org.bouncycastle.asn1.x509.Certificate r1 = r12.f8095c     // Catch:{ IOException -> 0x0018 }
        ...
        L_0x0020:
            ...
            org.bouncycastle.asn1.x509.Certificate r5 = r12.f8095c
            ...
            monitor-enter(r1)
            org.bouncycastle.jcajce.provider.asymmetric.x509.X509CertificateInternal r2 = r12.internalCertificateValue     // Catch:{ all -> 0x003f }
            if (r2 != 0) goto L_0x003b
            r12.internalCertificateValue = r0     // Catch:{ all -> 0x003f }
        L_0x003b:
            org.bouncycastle.jcajce.provider.asymmetric.x509.X509CertificateInternal r0 = r12.internalCertificateValue     // Catch:{ all -> 0x003f }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof X509CertificateObject) {
            ...
            if (!this.hashValueSet || !x509CertificateObject.hashValueSet) {
                if ((this.internalCertificateValue == null || x509CertificateObject.internalCertificateValue == null) && (signature = this.f8095c.getSignature()) != null && !signature.equals((ASN1Primitive) x509CertificateObject.f8095c.getSignature())) {
                    return false;
                }
    ...
    public javax.security.auth.x500.X500Principal getIssuerX500Principal() {
        /*
            ...
            monitor-enter(r0)
            javax.security.auth.x500.X500Principal r1 = r3.issuerValue     // Catch:{ all -> 0x0020 }
            if (r1 == 0) goto L_0x000b
            javax.security.auth.x500.X500Principal r1 = r3.issuerValue     // Catch:{ all -> 0x0020 }
        ...
        L_0x000b:
            ...
            monitor-enter(r1)
            javax.security.auth.x500.X500Principal r2 = r3.issuerValue     // Catch:{ all -> 0x001d }
            if (r2 != 0) goto L_0x0019
            r3.issuerValue = r0     // Catch:{ all -> 0x001d }
        L_0x0019:
    ...
    public java.security.PublicKey getPublicKey() {
        /*
            ...
            java.lang.Object r0 = r3.cacheLock
            monitor-enter(r0)
            java.security.PublicKey r1 = r3.publicKeyValue     // Catch:{ all -> 0x0024 }
            if (r1 == 0) goto L_0x000b
            java.security.PublicKey r1 = r3.publicKeyValue     // Catch:{ all -> 0x0024 }
        ...
        L_0x0014:
            java.lang.Object r1 = r3.cacheLock
            monitor-enter(r1)
            java.security.PublicKey r2 = r3.publicKeyValue     // Catch:{ all -> 0x0021 }
            if (r2 != 0) goto L_0x001d
            r3.publicKeyValue = r0     // Catch:{ all -> 0x0021 }
        L_0x001d:
            java.security.PublicKey r0 = r3.publicKeyValue     // Catch:{ all -> 0x0021 }
    ...
    public javax.security.auth.x500.X500Principal getSubjectX500Principal() {
        /*
            ...
            java.lang.Object r0 = r3.cacheLock
            monitor-enter(r0)
            javax.security.auth.x500.X500Principal r1 = r3.subjectValue     // Catch:{ all -> 0x0020 }
            if (r1 == 0) goto L_0x000b
            javax.security.auth.x500.X500Principal r1 = r3.subjectValue     // Catch:{ all -> 0x0020 }
            monitor-exit(r0)     // Catch:{ all -> 0x0020 }
            return r1
        L_0x000b:
            ...
            java.lang.Object r1 = r3.cacheLock
            monitor-enter(r1)
            javax.security.auth.x500.X500Principal r2 = r3.subjectValue     // Catch:{ all -> 0x001d }
            if (r2 != 0) goto L_0x0019
            r3.subjectValue = r0     // Catch:{ all -> 0x001d }
        L_0x0019:
    ...
    public long[] getValidityValues() {
        /*
            ...
            monitor-enter(r0)
            long[] r1 = r4.validityValues     // Catch:{ all -> 0x0035 }
            if (r1 == 0) goto L_0x000b
            long[] r1 = r4.validityValues     // Catch:{ all -> 0x0035 }
        ...
        L_0x000b:
            ...
            monitor-enter(r1)
            long[] r2 = r4.validityValues     // Catch:{ all -> 0x0032 }
            if (r2 != 0) goto L_0x002e
            r4.validityValues = r0     // Catch:{ all -> 0x0032 }
        L_0x002e:
            long[] r0 = r4.validityValues     // Catch:{ all -> 0x0032 }
