...
public class BCGOST3410PublicKey implements GOST3410PublicKey {
    ...
    BCGOST3410PublicKey(SubjectPublicKeyInfo subjectPublicKeyInfo) {
        ...
        try {
            ...
            this.f8091y = new BigInteger(1, bArr);
    ...
    public boolean equals(Object obj) {
        ...
        return this.f8091y.equals(bCGOST3410PublicKey.f8091y) && this.gost3410Spec.equals(bCGOST3410PublicKey.gost3410Spec);
    }
    ...
    public int hashCode() {
        return this.f8091y.hashCode() ^ this.gost3410Spec.hashCode();
    }

    public String toString() {
        try {
            return GOSTUtil.publicKeyToString("GOST3410", this.f8091y, ((GOST3410PublicKeyParameters) GOST3410Util.generatePublicKeyParameter(this)).getParameters());
