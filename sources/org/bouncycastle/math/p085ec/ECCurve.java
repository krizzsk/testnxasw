...
import org.bouncycastle.math.p085ec.endo.ECEndomorphism;
import org.bouncycastle.math.p085ec.endo.GLVEndomorphism;
...
public abstract class ECCurve {
    ...
    /* renamed from: a */
    protected ECFieldElement f8145a;

    /* renamed from: b */
    protected ECFieldElement f8146b;
    ...
    public static abstract class AbstractF2m extends ECCurve {
        ...
        /* renamed from: si */
        private BigInteger[] f8147si = null;
        ...
        public synchronized BigInteger[] getSi() {
            if (this.f8147si == null) {
                this.f8147si = Tnaf.getSi(this);
            }
            return this.f8147si;
        }

        public boolean isKoblitz() {
            return this.order != null && this.cofactor != null && this.f8146b.isOne() && (this.f8145a.isZero() || this.f8145a.isOne());
        }
    ...
    public static abstract class AbstractFp extends ECCurve {
        ...
        public ECPoint decompressPoint(int i, BigInteger bigInteger) {
            ECFieldElement fromBigInteger = fromBigInteger(bigInteger);
            ECFieldElement sqrt = fromBigInteger.square().add(this.f8145a).multiply(fromBigInteger).add(this.f8146b).sqrt();
            if (sqrt != null) {
    ...
    public static class F2m extends AbstractF2m {
        ...
        public F2m(int i, int i2, int i3, int i4, BigInteger bigInteger, BigInteger bigInteger2, BigInteger bigInteger3, BigInteger bigInteger4) {
            ...
            this.f8145a = fromBigInteger(bigInteger);
            this.f8146b = fromBigInteger(bigInteger2);
            this.coord = 6;
        }
        ...
        protected F2m(int i, int i2, int i3, int i4, ECFieldElement eCFieldElement, ECFieldElement eCFieldElement2, BigInteger bigInteger, BigInteger bigInteger2) {
            ...
            this.infinity = new ECPoint.F2m(this, (ECFieldElement) null, (ECFieldElement) null);
            this.f8145a = eCFieldElement;
            this.f8146b = eCFieldElement2;
            this.coord = 6;
        }
        ...
        public ECCurve cloneCurve() {
            return new F2m(this.f8151m, this.f8148k1, this.f8149k2, this.f8150k3, this.f8145a, this.f8146b, this.order, this.cofactor);
        }

        public ECLookupTable createCacheSafeLookupTable(ECPoint[] eCPointArr, int i, int i2) {
            final int i3 = (this.f8151m + 63) >>> 6;
            final int[] iArr = isTrinomial() ? new int[]{this.f8148k1} : new int[]{this.f8148k1, this.f8149k2, this.f8150k3};
            final long[] jArr = new long[(i2 * i3 * 2)];
            int i4 = 0;
            for (int i5 = 0; i5 < i2; i5++) {
                ECPoint eCPoint = eCPointArr[i + i5];
                ((ECFieldElement.F2m) eCPoint.getRawXCoord()).f8156x.copyTo(jArr, i4);
                int i6 = i4 + i3;
                ((ECFieldElement.F2m) eCPoint.getRawYCoord()).f8156x.copyTo(jArr, i6);
                i4 = i6 + i3;
            }
            final int i7 = i2;
            return new AbstractECLookupTable() {
                private ECPoint createPoint(long[] jArr, long[] jArr2) {
                    return F2m.this.createRawPoint(new ECFieldElement.F2m(F2m.this.f8151m, iArr, new LongArray(jArr)), new ECFieldElement.F2m(F2m.this.f8151m, iArr, new LongArray(jArr2)));
                }
        ...
        public ECFieldElement fromBigInteger(BigInteger bigInteger) {
            return new ECFieldElement.F2m(this.f8151m, this.f8148k1, this.f8149k2, this.f8150k3, bigInteger);
        }
        ...
        public boolean isTrinomial() {
            return this.f8149k2 == 0 && this.f8150k3 == 0;
        }
    ...
    public static class C3310Fp extends AbstractFp {
        private static final int FP_DEFAULT_COORDS = 4;
        ECPoint.C3313Fp infinity;
        ...
        public C3310Fp(BigInteger bigInteger, BigInteger bigInteger2, BigInteger bigInteger3) {
            this(bigInteger, bigInteger2, bigInteger3, (BigInteger) null, (BigInteger) null);
        }

        public C3310Fp(BigInteger bigInteger, BigInteger bigInteger2, BigInteger bigInteger3, BigInteger bigInteger4, BigInteger bigInteger5) {
            super(bigInteger);
            this.f8152q = bigInteger;
            this.f8153r = ECFieldElement.C3311Fp.calculateResidue(bigInteger);
            this.infinity = new ECPoint.C3313Fp(this, (ECFieldElement) null, (ECFieldElement) null);
            this.f8145a = fromBigInteger(bigInteger2);
            this.f8146b = fromBigInteger(bigInteger3);
            this.order = bigInteger4;
            this.cofactor = bigInteger5;
            this.coord = 4;
        }

        protected C3310Fp(BigInteger bigInteger, BigInteger bigInteger2, ECFieldElement eCFieldElement, ECFieldElement eCFieldElement2, BigInteger bigInteger3, BigInteger bigInteger4) {
            super(bigInteger);
            this.f8152q = bigInteger;
            this.f8153r = bigInteger2;
            this.infinity = new ECPoint.C3313Fp(this, (ECFieldElement) null, (ECFieldElement) null);
            this.f8145a = eCFieldElement;
            this.f8146b = eCFieldElement2;
            this.order = bigInteger3;
        ...
        /* access modifiers changed from: protected */
        public ECCurve cloneCurve() {
            return new C3310Fp(this.f8152q, this.f8153r, this.f8145a, this.f8146b, this.order, this.cofactor);
        }

        /* access modifiers changed from: protected */
        public ECPoint createRawPoint(ECFieldElement eCFieldElement, ECFieldElement eCFieldElement2) {
            return new ECPoint.C3313Fp(this, eCFieldElement, eCFieldElement2);
        }

        /* access modifiers changed from: protected */
        public ECPoint createRawPoint(ECFieldElement eCFieldElement, ECFieldElement eCFieldElement2, ECFieldElement[] eCFieldElementArr) {
            return new ECPoint.C3313Fp(this, eCFieldElement, eCFieldElement2, eCFieldElementArr);
        }

        public ECFieldElement fromBigInteger(BigInteger bigInteger) {
            return new ECFieldElement.C3311Fp(this.f8152q, this.f8153r, bigInteger);
        }

        public int getFieldSize() {
            return this.f8152q.bitLength();
        }
        ...
        public ECPoint importPoint(ECPoint eCPoint) {
            ...
            return new ECPoint.C3313Fp(this, fromBigInteger(eCPoint.f8160x.toBigInteger()), fromBigInteger(eCPoint.f8161y.toBigInteger()), new ECFieldElement[]{fromBigInteger(eCPoint.f8162zs[0].toBigInteger())});
        }
