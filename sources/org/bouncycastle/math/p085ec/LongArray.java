...
class LongArray implements Cloneable {
    ...
    private static int bitLength(long r3) {
        ...
        L_0x002e:
            ...
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: org.bouncycastle.math.p085ec.LongArray.bitLength(long):int");
    }
    ...
    private static long interleave3_13to65(int i) {
        ...
        return (((long) iArr[i & 127]) & InternalZipConstants.ZIP_64_SIZE_LIMIT) | ((((long) iArr[i >>> 7]) & InternalZipConstants.ZIP_64_SIZE_LIMIT) << 35);
    }
    ...
    private static long interleave3_21to63(int i) {
        ...
        int i2 = iArr[i & 127];
        int i3 = iArr[(i >>> 7) & 127];
        return (((long) i2) & InternalZipConstants.ZIP_64_SIZE_LIMIT) | ((((long) iArr[i >>> 14]) & InternalZipConstants.ZIP_64_SIZE_LIMIT) << 42) | ((((long) i3) & InternalZipConstants.ZIP_64_SIZE_LIMIT) << 21);
    }

    private static long interleave4_16to64(int i) {
        int[] iArr = INTERLEAVE4_TABLE;
        return (((long) iArr[i & 255]) & InternalZipConstants.ZIP_64_SIZE_LIMIT) | ((((long) iArr[i >>> 8]) & InternalZipConstants.ZIP_64_SIZE_LIMIT) << 32);
    }
