...
public class Curve25519Field {
    ...
    /* renamed from: M */
    private static final long f8166M = 4294967295L;

    /* renamed from: P */
    static final int[] f8167P = {-19, -1, -1, -1, -1, -1, -1, Integer.MAX_VALUE};

    /* renamed from: P7 */
    private static final int f8168P7 = Integer.MAX_VALUE;
    ...
    private static int addPTo(int[] iArr) {
        ...
        long j3 = j2 + (4294967295L & ((long) iArr[7])) + qqqqqy.b0065ee006500650065;
        iArr[7] = (int) j3;
        return (int) (j3 >> 32);
    }
    ...
    public static int[] fromBigInteger(BigInteger bigInteger) {
        ...
        while (Nat256.gte(fromBigInteger, f8167P)) {
            Nat256.subFrom(f8167P, fromBigInteger);
        }
    ...
    public static void half(int[] iArr, int[] iArr2) {
        ...
        Nat256.add(iArr, f8167P, iArr2);
        Nat.shiftDownBit(8, iArr2, 0);
    }

    public static void inv(int[] iArr, int[] iArr2) {
        Mod.checkedModOddInverse(f8167P, iArr, iArr2);
    }
    ...
    public static void random(SecureRandom secureRandom, int[] iArr) {
        ...
        } while (Nat.lessThan(8, iArr, f8167P) == 0);
    }
