...
public class SecP224R1FieldElement extends ECFieldElement.AbstractFp {
    ...
    /* renamed from: Q */
    public static final BigInteger f8213Q = new BigInteger(1, Hex.decodeStrict("FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFF000000000000000000000001"));

    /* renamed from: x */
    protected int[] f8214x;

    public SecP224R1FieldElement() {
        this.f8214x = Nat224.create();
    }

    public SecP224R1FieldElement(BigInteger bigInteger) {
        if (bigInteger == null || bigInteger.signum() < 0 || bigInteger.compareTo(f8213Q) >= 0) {
            throw new IllegalArgumentException("x value invalid for SecP224R1FieldElement");
        }
        this.f8214x = SecP224R1Field.fromBigInteger(bigInteger);
    }
    ...
    /* renamed from: RM */
    private static void m7121RM(int[] iArr, int[] iArr2, int[] iArr3, int[] iArr4, int[] iArr5, int[] iArr6, int[] iArr7) {
    ...
    /* renamed from: RP */
    private static void m7122RP(int[] iArr, int[] iArr2, int[] iArr3, int[] iArr4, int[] iArr5) {
        ...
        for (int i = 0; i < 7; i++) {
            ...
            while (true) {
                ...
                m7123RS(iArr2, iArr3, iArr4, iArr5);
            }
            m7121RM(iArr, create, create2, iArr2, iArr3, iArr4, iArr5);
        }
    }

    /* renamed from: RS */
    private static void m7123RS(int[] iArr, int[] iArr2, int[] iArr3, int[] iArr4) {
    ...
    private static boolean trySqrt(int[] iArr, int[] iArr2, int[] iArr3) {
        ...
        m7122RP(iArr, create, create2, create3, iArr3);
        int[] create4 = Nat224.create();
        int[] create5 = Nat224.create();
        for (int i = 1; i < 96; i++) {
            Nat224.copy(create, create4);
            Nat224.copy(create2, create5);
            m7123RS(create, create2, create3, iArr3);
    ...
    public ECFieldElement add(ECFieldElement eCFieldElement) {
        int[] create = Nat224.create();
        SecP224R1Field.add(this.f8214x, ((SecP224R1FieldElement) eCFieldElement).f8214x, create);
        return new SecP224R1FieldElement(create);
    }

    public ECFieldElement addOne() {
        int[] create = Nat224.create();
        SecP224R1Field.addOne(this.f8214x, create);
        return new SecP224R1FieldElement(create);
    }

    public ECFieldElement divide(ECFieldElement eCFieldElement) {
        int[] create = Nat224.create();
        SecP224R1Field.inv(((SecP224R1FieldElement) eCFieldElement).f8214x, create);
        SecP224R1Field.multiply(create, this.f8214x, create);
        return new SecP224R1FieldElement(create);
    }
    ...
    public boolean equals(Object obj) {
        ...
        return Nat224.m7128eq(this.f8214x, ((SecP224R1FieldElement) obj).f8214x);
    }
    ...
    public int getFieldSize() {
        return f8213Q.bitLength();
    }

    public int hashCode() {
        return f8213Q.hashCode() ^ Arrays.hashCode(this.f8214x, 0, 7);
    }

    public ECFieldElement invert() {
        int[] create = Nat224.create();
        SecP224R1Field.inv(this.f8214x, create);
        return new SecP224R1FieldElement(create);
    }

    public boolean isOne() {
        return Nat224.isOne(this.f8214x);
    }

    public boolean isZero() {
        return Nat224.isZero(this.f8214x);
    }

    public ECFieldElement multiply(ECFieldElement eCFieldElement) {
        int[] create = Nat224.create();
        SecP224R1Field.multiply(this.f8214x, ((SecP224R1FieldElement) eCFieldElement).f8214x, create);
        return new SecP224R1FieldElement(create);
    }

    public ECFieldElement negate() {
        int[] create = Nat224.create();
        SecP224R1Field.negate(this.f8214x, create);
        return new SecP224R1FieldElement(create);
    }

    public ECFieldElement sqrt() {
        int[] iArr = this.f8214x;
        if (Nat224.isZero(iArr) || Nat224.isOne(iArr)) {
            return this;
        }
        int[] create = Nat224.create();
        SecP224R1Field.negate(iArr, create);
        int[] random = Mod.random(SecP224R1Field.f8211P);
        int[] create2 = Nat224.create();
        if (!isSquare(iArr)) {
            return null;
        }
    ...
    public ECFieldElement square() {
        int[] create = Nat224.create();
        SecP224R1Field.square(this.f8214x, create);
        return new SecP224R1FieldElement(create);
    }

    public ECFieldElement subtract(ECFieldElement eCFieldElement) {
        int[] create = Nat224.create();
        SecP224R1Field.subtract(this.f8214x, ((SecP224R1FieldElement) eCFieldElement).f8214x, create);
        return new SecP224R1FieldElement(create);
    }

    public boolean testBitZero() {
        return Nat224.getBit(this.f8214x, 0) == 1;
    }

    public BigInteger toBigInteger() {
        return Nat224.toBigInteger(this.f8214x);
    }
}
