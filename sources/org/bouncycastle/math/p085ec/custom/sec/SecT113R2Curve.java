...
public class SecT113R2Curve extends ECCurve.AbstractF2m {
    ...
    public SecT113R2Curve() {
        super(113, 9, 0, 0);
        this.f8145a = fromBigInteger(new BigInteger(1, Hex.decodeStrict("00689918DBEC7E5A0DD6DFC0AA55C7")));
        this.f8146b = fromBigInteger(new BigInteger(1, Hex.decodeStrict("0095E9A9EC9B297BD4BF36E059184F")));
    ...
    public ECLookupTable createCacheSafeLookupTable(ECPoint[] eCPointArr, int i, final int i2) {
        ...
        for (int i4 = 0; i4 < i2; i4++) {
            ...
            Nat128.copy64(((SecT113FieldElement) eCPoint.getRawXCoord()).f8235x, 0, jArr, i3);
            int i5 = i3 + 2;
            Nat128.copy64(((SecT113FieldElement) eCPoint.getRawYCoord()).f8235x, 0, jArr, i5);
            i3 = i5 + 2;
        }
