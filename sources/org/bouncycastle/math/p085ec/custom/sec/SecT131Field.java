...
public class SecT131Field {
    ...
    protected static void implSquare(long[] jArr, long[] jArr2) {
        ...
        jArr2[4] = ((long) Interleave.expand8to16((int) jArr[2])) & InternalZipConstants.ZIP_64_SIZE_LIMIT;
    }
    ...
    public static void sqrt(long[] jArr, long[] jArr2) {
        ...
        long j = unshuffle3 & InternalZipConstants.ZIP_64_SIZE_LIMIT;
        create64[1] = unshuffle3 >>> 32;
        multiply(create64, ROOT_Z, jArr2);
        jArr2[0] = jArr2[0] ^ ((unshuffle & InternalZipConstants.ZIP_64_SIZE_LIMIT) | (unshuffle2 << 32));
        jArr2[1] = jArr2[1] ^ j;
    }
