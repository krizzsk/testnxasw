...
public class SecP192K1Curve extends ECCurve.AbstractFp {
    ...
    /* renamed from: q */
    public static final BigInteger f8193q = SecP192K1FieldElement.f8196Q;
    protected SecP192K1Point infinity = new SecP192K1Point(this, (ECFieldElement) null, (ECFieldElement) null);

    public SecP192K1Curve() {
        super(f8193q);
        this.f8145a = fromBigInteger(ECConstants.ZERO);
        this.f8146b = fromBigInteger(BigInteger.valueOf(3));
    ...
    public ECLookupTable createCacheSafeLookupTable(ECPoint[] eCPointArr, int i, final int i2) {
        ...
        for (int i4 = 0; i4 < i2; i4++) {
            ...
            Nat192.copy(((SecP192K1FieldElement) eCPoint.getRawXCoord()).f8197x, 0, iArr, i3);
            int i5 = i3 + 6;
            Nat192.copy(((SecP192K1FieldElement) eCPoint.getRawYCoord()).f8197x, 0, iArr, i5);
            i3 = i5 + 6;
        }
