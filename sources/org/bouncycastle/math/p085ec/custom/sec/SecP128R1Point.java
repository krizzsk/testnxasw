...
public class SecP128R1Point extends ECPoint.AbstractFp {
    ...
    public ECPoint add(ECPoint eCPoint) {
        ...
        SecP128R1FieldElement secP128R1FieldElement = (SecP128R1FieldElement) this.f8160x;
        SecP128R1FieldElement secP128R1FieldElement2 = (SecP128R1FieldElement) this.f8161y;
        ...
        SecP128R1FieldElement secP128R1FieldElement5 = (SecP128R1FieldElement) this.f8162zs[0];
        ...
        if (isOne) {
            iArr2 = secP128R1FieldElement3.f8180x;
            iArr = secP128R1FieldElement4.f8180x;
        } else {
            SecP128R1Field.square(secP128R1FieldElement5.f8180x, create2);
            SecP128R1Field.multiply(create2, secP128R1FieldElement3.f8180x, create);
            SecP128R1Field.multiply(create2, secP128R1FieldElement5.f8180x, create2);
            SecP128R1Field.multiply(create2, secP128R1FieldElement4.f8180x, create2);
            iArr2 = create;
            iArr = create2;
        }
        boolean isOne2 = secP128R1FieldElement6.isOne();
        if (isOne2) {
            iArr4 = secP128R1FieldElement.f8180x;
            iArr3 = secP128R1FieldElement2.f8180x;
        } else {
            SecP128R1Field.square(secP128R1FieldElement6.f8180x, create3);
            SecP128R1Field.multiply(create3, secP128R1FieldElement.f8180x, createExt);
            SecP128R1Field.multiply(create3, secP128R1FieldElement6.f8180x, create3);
            SecP128R1Field.multiply(create3, secP128R1FieldElement2.f8180x, create3);
            iArr4 = createExt;
            iArr3 = create3;
        }
        ...
        SecP128R1Field.square(create, secP128R1FieldElement7.f8180x);
        SecP128R1Field.subtract(secP128R1FieldElement7.f8180x, create5, secP128R1FieldElement7.f8180x);
        SecP128R1FieldElement secP128R1FieldElement8 = new SecP128R1FieldElement(create5);
        SecP128R1Field.subtract(create2, secP128R1FieldElement7.f8180x, secP128R1FieldElement8.f8180x);
        SecP128R1Field.multiplyAddToExt(secP128R1FieldElement8.f8180x, create, createExt);
        SecP128R1Field.reduce(createExt, secP128R1FieldElement8.f8180x);
        SecP128R1FieldElement secP128R1FieldElement9 = new SecP128R1FieldElement(create4);
        if (!isOne) {
            SecP128R1Field.multiply(secP128R1FieldElement9.f8180x, secP128R1FieldElement5.f8180x, secP128R1FieldElement9.f8180x);
        }
        if (!isOne2) {
            SecP128R1Field.multiply(secP128R1FieldElement9.f8180x, secP128R1FieldElement6.f8180x, secP128R1FieldElement9.f8180x);
        }
    ...
    public ECPoint negate() {
        return isInfinity() ? this : new SecP128R1Point(this.curve, this.f8160x, this.f8161y.negate(), this.f8162zs);
    }
    ...
    public ECPoint twice() {
        ...
        ECCurve curve = getCurve();
        SecP128R1FieldElement secP128R1FieldElement = (SecP128R1FieldElement) this.f8161y;
        if (secP128R1FieldElement.isZero()) {
            return curve.getInfinity();
        }
        SecP128R1FieldElement secP128R1FieldElement2 = (SecP128R1FieldElement) this.f8160x;
        SecP128R1FieldElement secP128R1FieldElement3 = (SecP128R1FieldElement) this.f8162zs[0];
        int[] create = Nat128.create();
        int[] create2 = Nat128.create();
        int[] create3 = Nat128.create();
        SecP128R1Field.square(secP128R1FieldElement.f8180x, create3);
        int[] create4 = Nat128.create();
        SecP128R1Field.square(create3, create4);
        boolean isOne = secP128R1FieldElement3.isOne();
        int[] iArr = secP128R1FieldElement3.f8180x;
        if (!isOne) {
            SecP128R1Field.square(secP128R1FieldElement3.f8180x, create2);
            iArr = create2;
        }
        SecP128R1Field.subtract(secP128R1FieldElement2.f8180x, iArr, create);
        SecP128R1Field.add(secP128R1FieldElement2.f8180x, iArr, create2);
        ...
        SecP128R1Field.square(create2, secP128R1FieldElement4.f8180x);
        SecP128R1Field.subtract(secP128R1FieldElement4.f8180x, create3, secP128R1FieldElement4.f8180x);
        SecP128R1Field.subtract(secP128R1FieldElement4.f8180x, create3, secP128R1FieldElement4.f8180x);
        SecP128R1FieldElement secP128R1FieldElement5 = new SecP128R1FieldElement(create3);
        SecP128R1Field.subtract(create3, secP128R1FieldElement4.f8180x, secP128R1FieldElement5.f8180x);
        SecP128R1Field.multiply(secP128R1FieldElement5.f8180x, create2, secP128R1FieldElement5.f8180x);
        SecP128R1Field.subtract(secP128R1FieldElement5.f8180x, create, secP128R1FieldElement5.f8180x);
        SecP128R1FieldElement secP128R1FieldElement6 = new SecP128R1FieldElement(create2);
        SecP128R1Field.twice(secP128R1FieldElement.f8180x, secP128R1FieldElement6.f8180x);
        if (!isOne) {
            SecP128R1Field.multiply(secP128R1FieldElement6.f8180x, secP128R1FieldElement3.f8180x, secP128R1FieldElement6.f8180x);
        }
