...
public abstract class Nat256 {
    ...
    /* renamed from: M */
    private static final long f8279M = 4294967295L;
    ...
    /* renamed from: eq */
    public static boolean m7129eq(int[] iArr, int[] iArr2) {
        for (int i = 7; i >= 0; i--) {
            if (iArr[i] != iArr2[i]) {
                return false;
            }
    ...
    public static int mulAddTo(int[] iArr, int i, int[] iArr2, int i2, int[] iArr3, int i3) {
        ...
        while (i5 < 8) {
            ...
            iArr3[i14] = (int) j20;
            int i15 = i4 + 8;
            long j21 = (j20 >>> 32) + (((long) iArr3[i15]) & 4294967295L) + j9;
            iArr3[i15] = (int) j21;
            j9 = j21 >>> 32;
            i5 = i6 + 1;
            i4 = i8;
    ...
    public static void square(int[] iArr, int i, int[] iArr2, int i2) {
        ...
        while (true) {
            ...
            if (i6 <= 0) {
                ...
                int i47 = i46 >>> 31;
                int i48 = i2 + 15;
                iArr2[i48] = i47 | ((iArr2[i48] + ((int) (j69 >>> 32))) << 1);
                return;
            }
            i5 = i6;
        }
    ...
    public static void square(int[] iArr, int[] iArr2) {
        ...
        while (true) {
            ...
            if (i4 <= 0) {
                ...
                long j50 = (j39 & 4294967295L) + (j45 * j);
                int i12 = (int) j50;
                iArr2[6] = (i12 << 1) | (i11 >>> 31);
                long j51 = (j40 & 4294967295L) + (j50 >>> 32) + (j45 * j9);
                long j52 = (j41 & 4294967295L) + (j51 >>> 32) + (j45 * j14);
                long j53 = j51 & 4294967295L;
                long j54 = j46 + (j52 >>> 32) + (j45 * j23);
                long j55 = j48 + (j54 >>> 32) + (j45 * j32);
                long j56 = (j47 & 4294967295L) + (j55 >>> 32) + (j45 * j44);
                long j57 = j49 + (j56 >>> 32);
                long j58 = j45;
                long j59 = ((long) iArr[7]) & 4294967295L;
                long j60 = j56 & 4294967295L;
                long j61 = (((long) iArr2[13]) & 4294967295L) + (j57 >>> 32);
                long j62 = 4294967295L & j61;
                long j63 = j53 + (j * j59);
                int i13 = (int) j63;
                iArr2[7] = (i12 >>> 31) | (i13 << 1);
                int i14 = i13 >>> 31;
                long j64 = (j52 & 4294967295L) + (j63 >>> 32) + (j59 * j9);
                long j65 = (j54 & 4294967295L) + (j64 >>> 32) + (j59 * j14);
                long j66 = (j55 & 4294967295L) + (j65 >>> 32) + (j59 * j23);
                long j67 = j60 + (j66 >>> 32) + (j59 * j32);
                long j68 = j67;
                long j69 = (j57 & 4294967295L) + (j67 >>> 32) + (j59 * j44);
                long j70 = j62 + (j69 >>> 32) + (j59 * j58);
                long j71 = (((long) iArr2[14]) & 4294967295L) + (j61 >>> 32) + (j70 >>> 32);
                int i15 = (int) j64;
                iArr2[8] = i14 | (i15 << 1);
                int i16 = (int) j65;
                ...
                int i24 = (int) j71;
                iArr2[14] = i23 | (i24 << 1);
                iArr2[15] = (i24 >>> 31) | ((iArr2[15] + ((int) (j71 >>> 32))) << 1);
                return;
            }
            i2 = i4;
            i3 = i6;
