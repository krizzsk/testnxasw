...
public abstract class Nat192 {
    ...
    /* renamed from: M */
    private static final long f8277M = 4294967295L;
    ...
    /* renamed from: eq */
    public static boolean m7127eq(int[] iArr, int[] iArr2) {
        for (int i = 5; i >= 0; i--) {
            if (iArr[i] != iArr2[i]) {
                return false;
            }
    ...
    public static int mulAddTo(int[] iArr, int i, int[] iArr2, int i2, int[] iArr3, int i3) {
        ...
        while (i5 < 6) {
            ...
            iArr3[i12] = (int) j17;
            int i13 = i4 + 6;
            long j18 = (j17 >>> 32) + (((long) iArr3[i13]) & 4294967295L) + j8;
            iArr3[i13] = (int) j18;
            j8 = j18 >>> 32;
            i5 = i6 + 1;
            i4 = i8;
    ...
    public static void square(int[] iArr, int i, int[] iArr2, int i2) {
        ...
        while (true) {
            ...
            if (i6 <= 0) {
                ...
                int i35 = i34 >>> 31;
                int i36 = i2 + 11;
                iArr2[i36] = i35 | ((iArr2[i36] + ((int) (j42 >>> 32))) << 1);
                return;
            }
            i5 = i6;
        }
