...
public class Salsa20Engine implements SkippingStreamCipher {
    ...
    public void generateKeyStream(byte[] bArr) {
        salsaCore(this.rounds, this.engineState, this.f7855x);
    ...
    public long getCounter() {
        int[] iArr = this.engineState;
        return (((long) iArr[9]) << 32) | (((long) iArr[8]) & InternalZipConstants.ZIP_64_SIZE_LIMIT);
    }
    ...
    public void retreatCounter(long j) {
        ...
        if (i != 0) {
            int[] iArr = this.engineState;
            if ((((long) iArr[9]) & InternalZipConstants.ZIP_64_SIZE_LIMIT) >= (((long) i) & InternalZipConstants.ZIP_64_SIZE_LIMIT)) {
                iArr[9] = iArr[9] - i;
            } else {
                throw new IllegalStateException("attempt to reduce counter past zero.");
            }
        ...
        int[] iArr2 = this.engineState;
        if ((((long) iArr2[8]) & InternalZipConstants.ZIP_64_SIZE_LIMIT) >= (InternalZipConstants.ZIP_64_SIZE_LIMIT & ((long) i2))) {
            iArr2[8] = iArr2[8] - i2;
        } else if (iArr2[9] != 0) {
            iArr2[9] = iArr2[9] - 1;
            iArr2[8] = iArr2[8] - i2;
