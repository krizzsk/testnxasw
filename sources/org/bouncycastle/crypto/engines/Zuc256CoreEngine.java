...
public class Zuc256CoreEngine extends Zuc128CoreEngine {
    ...
    private static int MAKEU31(byte b, byte b2, byte b3, byte b4) {
        return ((b & 255) << Ascii.ETB) | ((b2 & 255) << 16) | ((b3 & 255) << 8) | (b4 & 255);
    }
    ...
    public void setKeyAndIV(int[] iArr, byte[] bArr, byte[] bArr2) {
        ...
        if (bArr3 == null || bArr3.length != 32) {
            ...
            iArr[14] = MAKEU31(bArr3[14], (byte) (this.theD[14] | ((bArr3[31] >>> 4) & Ascii.f55148SI)), bArr4[16], bArr4[9]);
            iArr[15] = MAKEU31(bArr3[15], (byte) (this.theD[15] | (bArr3[31] & Ascii.f55148SI)), bArr3[30], bArr3[29]);
        }
    }
}
