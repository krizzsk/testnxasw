...
public class ChaCha7539Engine extends Salsa20Engine {
    ...
    public void generateKeyStream(byte[] bArr) {
        ChaChaEngine.chachaCore(this.rounds, this.engineState, this.f7855x);
    ...
    public long getCounter() {
        return ((long) this.engineState[12]) & InternalZipConstants.ZIP_64_SIZE_LIMIT;
    }
    ...
    public void retreatCounter(long j) {
        ...
        if (((int) (j >>> 32)) != 0) {
            throw new IllegalStateException("attempt to reduce counter past zero.");
        } else if ((((long) this.engineState[12]) & InternalZipConstants.ZIP_64_SIZE_LIMIT) >= (InternalZipConstants.ZIP_64_SIZE_LIMIT & ((long) i))) {
            int[] iArr = this.engineState;
            iArr[12] = iArr[12] - i;
        } else {
            throw new IllegalStateException("attempt to reduce counter past zero.");
