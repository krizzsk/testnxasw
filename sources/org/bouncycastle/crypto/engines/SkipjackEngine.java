...
public class SkipjackEngine implements BlockCipher {
    ...
    /* renamed from: g */
    private int m7106g(int i, int i2) {
        short s = i2 & 255;
        short[] sArr = ftable;
    ...
    /* renamed from: h */
    private int m7107h(int i, int i2) {
        short s = i2 & 255;
        short s2 = (i2 >> 8) & 255;
        short[] sArr = ftable;
