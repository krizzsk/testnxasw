...
public class DESEngine implements BlockCipher {
    ...
    private static final short[] bytebit = {ClassFileWriter.ACC_TRANSIENT, 64, 32, 16, 8, 4, 2, 1};
    ...
    private static final byte[] pc2 = {Ascii.f55139CR, 16, 10, Ascii.ETB, 0, 4, 2, Ascii.ESC, Ascii.f55149SO, 5, Ascii.DC4, 9, Ascii.SYN, Ascii.DC2, 11, 3, Ascii.f55140EM, 7, Ascii.f55148SI, 6, Ascii.SUB, 19, Ascii.f55141FF, 1, 40, 51, Ascii.f55147RS, 36, 46, 54, Ascii.f55143GS, 39, 50, 44, 32, 47, 43, 48, 38, 55, 33, 52, 45, 41, 49, 35, Ascii.f55142FS, Ascii.f55151US};
    private static final byte[] totrot = {1, 2, 4, 6, 8, 10, Ascii.f55141FF, Ascii.f55149SO, Ascii.f55148SI, 17, 19, Ascii.NAK, Ascii.ETB, Ascii.f55140EM, Ascii.ESC, Ascii.f55142FS};
