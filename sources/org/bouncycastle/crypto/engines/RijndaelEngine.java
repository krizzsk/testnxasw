...
public class RijndaelEngine implements BlockCipher {
    ...
    /* renamed from: A0 */
    private long f7845A0;

    /* renamed from: A1 */
    private long f7846A1;

    /* renamed from: A2 */
    private long f7847A2;

    /* renamed from: A3 */
    private long f7848A3;
    ...
    public RijndaelEngine(int i) {
        if (i == 128) {
            this.f7849BC = 32;
            this.BC_MASK = InternalZipConstants.ZIP_64_SIZE_LIMIT;
    ...
    private void InvMixColumn() {
        ...
        long j3 = 0;
        long j4 = 0;
        for (int i = 0; i < this.f7849BC; i += 8) {
            int i2 = (int) ((this.f7845A0 >> i) & 255);
            int i3 = (int) ((this.f7846A1 >> i) & 255);
            int i4 = (int) ((this.f7847A2 >> i) & 255);
            long j5 = j4;
            int i5 = (int) ((this.f7848A3 >> i) & 255);
            byte b = -1;
    ...
    private void ShiftRow(byte[] bArr) {
        this.f7846A1 = shift(this.f7846A1, bArr[1]);
        this.f7847A2 = shift(this.f7847A2, bArr[2]);
        this.f7848A3 = shift(this.f7848A3, bArr[3]);
    }

    private void Substitution(byte[] bArr) {
        this.f7845A0 = applyS(this.f7845A0, bArr);
        this.f7846A1 = applyS(this.f7846A1, bArr);
        this.f7847A2 = applyS(this.f7847A2, bArr);
        this.f7848A3 = applyS(this.f7848A3, bArr);
    }
    ...
    private long[][] generateWorkingKey(byte[] bArr) {
        ...
        this.ROUNDS = length >= this.blockBits ? i + 6 : (this.f7849BC / 8) + 6;
        char c = 0;
        int i5 = 0;
        int i6 = 0;
        ...
        int i7 = 0;
        int i8 = 0;
        while (i7 < i && i8 < (this.ROUNDS + 1) * (this.f7849BC / 8)) {
            int i9 = 0;
            while (i9 < i4) {
                int i10 = this.f7849BC;
        ...
        int i11 = 0;
        while (i8 < (this.ROUNDS + 1) * (this.f7849BC / i3)) {
            int i12 = 0;
            while (i12 < 4) {
                byte[] bArr4 = bArr3[i12];
                i12++;
                bArr4[c] = (byte) (bArr4[c] ^ f7843S[bArr3[i12 % 4][i - 1] & 255]);
            }
            byte[] bArr5 = bArr3[c];
            int i13 = i11 + 1;
            ...
            if (i <= 6) {
                ...
                for (int i17 = 0; i17 < 4; i17++) {
                    ...
                    bArr8[4] = (byte) (bArr8[4] ^ f7843S[bArr3[i17][3] & 255]);
                }
                int i18 = 5;
                while (i18 < i) {
                    int i19 = 0;
            ...
            int i20 = 0;
            while (i20 < i && i8 < (this.ROUNDS + 1) * (this.f7849BC / i3)) {
                for (int i21 = 0; i21 < 4; i21++) {
                    int i22 = this.f7849BC;
                    long[] jArr3 = jArr[i8 / (i22 / 8)];
                    jArr3[i21] = (((long) (bArr3[i21][i20] & 255)) << ((i8 * 8) % i22)) | jArr3[i21];
                }
                i20++;
                i8++;
                i3 = 8;
    ...
    private byte mul0x2(int i) {
        if (i != 0) {
            return aLogtable[(logtable[i] & 255) + Ascii.f55140EM];
        }
        return 0;
    }
    ...
    private void packBlock(byte[] bArr, int i) {
        for (int i2 = 0; i2 != this.f7849BC; i2 += 8) {
            int i3 = i + 1;
            bArr[i] = (byte) ((int) (this.f7845A0 >> i2));
            int i4 = i3 + 1;
            bArr[i3] = (byte) ((int) (this.f7846A1 >> i2));
            int i5 = i4 + 1;
            bArr[i4] = (byte) ((int) (this.f7847A2 >> i2));
            i = i5 + 1;
            bArr[i5] = (byte) ((int) (this.f7848A3 >> i2));
        }
    }

    private long shift(long j, int i) {
        return ((j << (this.f7849BC - i)) | (j >>> i)) & this.BC_MASK;
    }

    private void unpackBlock(byte[] bArr, int i) {
        int i2 = i + 1;
        this.f7845A0 = (long) (bArr[i] & 255);
        int i3 = i2 + 1;
        this.f7846A1 = (long) (bArr[i2] & 255);
        int i4 = i3 + 1;
        this.f7847A2 = (long) (bArr[i3] & 255);
        int i5 = i4 + 1;
        this.f7848A3 = (long) (bArr[i4] & 255);
        for (int i6 = 8; i6 != this.f7849BC; i6 += 8) {
            int i7 = i5 + 1;
            this.f7845A0 |= ((long) (bArr[i5] & 255)) << i6;
            int i8 = i7 + 1;
            this.f7846A1 |= ((long) (bArr[i7] & 255)) << i6;
            int i9 = i8 + 1;
            this.f7847A2 |= ((long) (bArr[i8] & 255)) << i6;
            i5 = i9 + 1;
            this.f7848A3 |= ((long) (bArr[i9] & 255)) << i6;
        }
    }
