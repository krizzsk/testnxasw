...
public class ChaChaEngine extends Salsa20Engine {
    ...
    public void generateKeyStream(byte[] bArr) {
        chachaCore(this.rounds, this.engineState, this.f7855x);
        Pack.intToLittleEndian(this.f7855x, bArr, 0);
    }
    ...
    public long getCounter() {
        return (((long) this.engineState[13]) << 32) | (((long) this.engineState[12]) & InternalZipConstants.ZIP_64_SIZE_LIMIT);
    }
    ...
    public void retreatCounter(long j) {
        ...
        int i2 = (int) j;
        if (i != 0) {
            if ((((long) this.engineState[13]) & InternalZipConstants.ZIP_64_SIZE_LIMIT) >= (((long) i) & InternalZipConstants.ZIP_64_SIZE_LIMIT)) {
                int[] iArr = this.engineState;
                iArr[13] = iArr[13] - i;
            } else {
                throw new IllegalStateException("attempt to reduce counter past zero.");
        ...
        if ((((long) this.engineState[12]) & InternalZipConstants.ZIP_64_SIZE_LIMIT) >= (((long) i2) & InternalZipConstants.ZIP_64_SIZE_LIMIT)) {
            int[] iArr2 = this.engineState;
            iArr2[12] = iArr2[12] - i2;
