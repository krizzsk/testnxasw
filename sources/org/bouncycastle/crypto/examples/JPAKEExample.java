...
public class JPAKEExample {
    ...
    public static void main(String[] strArr) throws CryptoException {
        ...
        printStream6.println("(Secret passwords used by Alice and Bob: \"" + CashierAction.ACTION_PASSWORD + "\" and \"" + CashierAction.ACTION_PASSWORD + "\")\n");
        SHA256Digest sHA256Digest = new SHA256Digest();
        JPAKEPrimeOrderGroup jPAKEPrimeOrderGroup2 = jPAKEPrimeOrderGroup;
        SHA256Digest sHA256Digest2 = sHA256Digest;
        SecureRandom secureRandom = new SecureRandom();
        JPAKEParticipant jPAKEParticipant = new JPAKEParticipant("alice", CashierAction.ACTION_PASSWORD.toCharArray(), jPAKEPrimeOrderGroup2, sHA256Digest2, secureRandom);
        JPAKEParticipant jPAKEParticipant2 = new JPAKEParticipant("bob", CashierAction.ACTION_PASSWORD.toCharArray(), jPAKEPrimeOrderGroup2, sHA256Digest2, secureRandom);
