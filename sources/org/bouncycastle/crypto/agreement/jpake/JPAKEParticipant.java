...
public class JPAKEParticipant {
    ...
    /* renamed from: b */
    private BigInteger f7577b;
    private final Digest digest;

    /* renamed from: g */
    private final BigInteger f7578g;
    ...
    /* renamed from: p */
    private final BigInteger f7579p;
    private final String participantId;
    private String partnerParticipantId;
    private char[] password;

    /* renamed from: q */
    private final BigInteger f7580q;
    private final SecureRandom random;
    private int state;

    /* renamed from: x1 */
    private BigInteger f7581x1;

    /* renamed from: x2 */
    private BigInteger f7582x2;
    ...
    public JPAKEParticipant(String str, char[] cArr, JPAKEPrimeOrderGroup jPAKEPrimeOrderGroup, Digest digest2, SecureRandom secureRandom) {
        ...
        JPAKEUtil.validateNotNull(cArr, CashierAction.ACTION_PASSWORD);
        JPAKEUtil.validateNotNull(jPAKEPrimeOrderGroup, RavenConfigKey.PHONE);
        JPAKEUtil.validateNotNull(digest2, "digest");
        JPAKEUtil.validateNotNull(secureRandom, "random");
        if (cArr.length != 0) {
            this.participantId = str;
            this.password = Arrays.copyOf(cArr, cArr.length);
            this.f7579p = jPAKEPrimeOrderGroup.getP();
            this.f7580q = jPAKEPrimeOrderGroup.getQ();
            this.f7578g = jPAKEPrimeOrderGroup.getG();
            this.digest = digest2;
    ...
    public BigInteger calculateKeyingMaterial() {
        ...
        if (i >= 50) {
            ...
            this.password = null;
            BigInteger calculateKeyingMaterial = JPAKEUtil.calculateKeyingMaterial(this.f7579p, this.f7580q, this.gx4, this.f7582x2, calculateS, this.f7577b);
            this.f7581x1 = null;
            this.f7582x2 = null;
            this.f7577b = null;
            this.state = 50;
    ...
    public JPAKERound1Payload createRound1PayloadToSend() {
        if (this.state < 10) {
            this.f7581x1 = JPAKEUtil.generateX1(this.f7580q, this.random);
            this.f7582x2 = JPAKEUtil.generateX2(this.f7580q, this.random);
            this.gx1 = JPAKEUtil.calculateGx(this.f7579p, this.f7578g, this.f7581x1);
            this.gx2 = JPAKEUtil.calculateGx(this.f7579p, this.f7578g, this.f7582x2);
            BigInteger[] calculateZeroKnowledgeProof = JPAKEUtil.calculateZeroKnowledgeProof(this.f7579p, this.f7580q, this.f7578g, this.gx1, this.f7581x1, this.participantId, this.digest, this.random);
            BigInteger[] calculateZeroKnowledgeProof2 = JPAKEUtil.calculateZeroKnowledgeProof(this.f7579p, this.f7580q, this.f7578g, this.gx2, this.f7582x2, this.participantId, this.digest, this.random);
            this.state = 10;
    ...
    public JPAKERound2Payload createRound2PayloadToSend() {
        ...
        if (i >= 30) {
            ...
            BigInteger calculateGA = JPAKEUtil.calculateGA(this.f7579p, this.gx1, this.gx3, this.gx4);
            BigInteger calculateX2s = JPAKEUtil.calculateX2s(this.f7580q, this.f7582x2, JPAKEUtil.calculateS(this.password));
            BigInteger calculateA = JPAKEUtil.calculateA(this.f7579p, this.f7580q, calculateGA, calculateX2s);
            BigInteger[] calculateZeroKnowledgeProof = JPAKEUtil.calculateZeroKnowledgeProof(this.f7579p, this.f7580q, calculateGA, calculateA, calculateX2s, this.participantId, this.digest, this.random);
            this.state = 30;
    ...
    public void validateRound1PayloadReceived(JPAKERound1Payload jPAKERound1Payload) throws CryptoException {
        if (this.state < 20) {
            ...
            JPAKEUtil.validateZeroKnowledgeProof(this.f7579p, this.f7580q, this.f7578g, this.gx3, knowledgeProofForX1, jPAKERound1Payload.getParticipantId(), this.digest);
            JPAKEUtil.validateZeroKnowledgeProof(this.f7579p, this.f7580q, this.f7578g, this.gx4, knowledgeProofForX2, jPAKERound1Payload.getParticipantId(), this.digest);
            this.state = 20;
            return;
        }
    ...
    public void validateRound2PayloadReceived(JPAKERound2Payload jPAKERound2Payload) throws CryptoException {
        ...
        if (i >= 40) {
            ...
            BigInteger calculateGA = JPAKEUtil.calculateGA(this.f7579p, this.gx3, this.gx1, this.gx2);
            this.f7577b = jPAKERound2Payload.getA();
            ...
            JPAKEUtil.validateZeroKnowledgeProof(this.f7579p, this.f7580q, calculateGA, this.f7577b, knowledgeProofForX2s, jPAKERound2Payload.getParticipantId(), this.digest);
            this.state = 40;
        } else {
