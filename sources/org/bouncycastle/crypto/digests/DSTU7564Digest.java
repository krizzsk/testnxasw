...
public class DSTU7564Digest implements ExtendedDigest, Memoable {
    ...
    private void processBlock(byte[] bArr, int i) {
        ...
        m7024P(this.tempState1);
        m7025Q(this.tempState2);
    ...
    public int doFinal(byte[] bArr, int i) {
        ...
        long j = (((this.inputBlocks & InternalZipConstants.ZIP_64_SIZE_LIMIT) * ((long) this.blockSize)) + ((long) i4)) << 3;
