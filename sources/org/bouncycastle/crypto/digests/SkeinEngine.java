    ...
    private static class UbiTweak {
        ...
        public void advancePosition(int i) {
            if (this.extendedPosition) {
                ...
                long[] jArr2 = {jArr[0] & InternalZipConstants.ZIP_64_SIZE_LIMIT, (jArr[0] >>> 32) & InternalZipConstants.ZIP_64_SIZE_LIMIT, jArr[1] & InternalZipConstants.ZIP_64_SIZE_LIMIT};
                long j = (long) i;
                ...
                jArr3[0] = ((jArr2[1] & InternalZipConstants.ZIP_64_SIZE_LIMIT) << 32) | (jArr2[0] & InternalZipConstants.ZIP_64_SIZE_LIMIT);
                jArr3[1] = (jArr2[2] & InternalZipConstants.ZIP_64_SIZE_LIMIT) | (jArr3[1] & -4294967296L);
                return;
            }
