...
public class SHA512tDigest extends LongDigest {
    ...
    private static void longToBigEndian(long j, byte[] bArr, int i, int i2) {
        if (i2 > 0) {
            ...
            if (i2 > 4) {
                intToBigEndian((int) (j & InternalZipConstants.ZIP_64_SIZE_LIMIT), bArr, i + 4, i2 - 4);
            }
        }
    }
    ...
    public int doFinal(byte[] bArr, int i) {
        finish();
        longToBigEndian(this.f7652H1, bArr, i, this.digestLength);
        longToBigEndian(this.f7653H2, bArr, i + 8, this.digestLength - 8);
        longToBigEndian(this.f7654H3, bArr, i + 16, this.digestLength - 16);
        longToBigEndian(this.f7655H4, bArr, i + 24, this.digestLength - 24);
        longToBigEndian(this.f7656H5, bArr, i + 32, this.digestLength - 32);
        longToBigEndian(this.f7657H6, bArr, i + 40, this.digestLength - 40);
        longToBigEndian(this.f7658H7, bArr, i + 48, this.digestLength - 48);
        longToBigEndian(this.f7659H8, bArr, i + 56, this.digestLength - 56);
        reset();
    ...
    public void reset() {
        super.reset();
        this.f7652H1 = this.H1t;
        this.f7653H2 = this.H2t;
        this.f7654H3 = this.H3t;
        this.f7655H4 = this.H4t;
        this.f7656H5 = this.H5t;
        this.f7657H6 = this.H6t;
        this.f7658H7 = this.H7t;
        this.f7659H8 = this.H8t;
    }
