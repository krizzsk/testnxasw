...
public class Blake3Digest implements ExtendedDigest, Xof, Memoable {
    ...
    /* renamed from: IV */
    private static final int[] f7622IV = {1779033703, -1150833019, 1013904242, -1521486534, 1359893119, -1694144372, 528734635, 1541459225};
    ...
    private static final byte[] ROTATE = {16, Ascii.f55141FF, 8, 7};
    private static final int ROUNDS = 7;
    private static final byte[] SIGMA = {2, 6, 3, 10, 7, 0, 4, Ascii.f55139CR, 1, 11, Ascii.f55141FF, 5, 9, Ascii.f55149SO, Ascii.f55148SI, 8};
    ...
    private void initChunkBlock(int i, boolean z) {
        ...
        System.arraycopy(f7622IV, 0, this.theV, 8, 4);
        int[] iArr = this.theV;
        long j = this.theCounter;
        iArr[12] = (int) j;
        iArr[13] = (int) (j >> 32);
        iArr[14] = i;
        int i3 = this.theMode + (this.theCurrBytes == 0 ? 1 : 0);
        if (z) {
            i2 = 2;
        }
        iArr[15] = i3 + i2;
        int i4 = this.theCurrBytes + i;
    ...
    private void initNullKey() {
        System.arraycopy(f7622IV, 0, this.theK, 0, 8);
    }
    ...
    private void mixG(int i, int i2, int i3, int i4, int i5) {
        ...
        iArr[i5] = Integers.rotateRight(iArr[i5] ^ iArr[i2], ROTATE[0]);
        int[] iArr2 = this.theV;
        iArr2[i4] = iArr2[i4] + iArr2[i5];
        iArr2[i3] = Integers.rotateRight(iArr2[i3] ^ iArr2[i4], ROTATE[1]);
        int[] iArr3 = this.theV;
        iArr3[i2] = iArr3[i2] + iArr3[i3] + this.theM[this.theIndices[i7]];
        iArr3[i5] = Integers.rotateRight(iArr3[i2] ^ iArr3[i5], ROTATE[2]);
        int[] iArr4 = this.theV;
        iArr4[i4] = iArr4[i4] + iArr4[i5];
        iArr4[i3] = Integers.rotateRight(iArr4[i3] ^ iArr4[i4], ROTATE[3]);
    }
