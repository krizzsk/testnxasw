...
public final class CryptoServicesRegistrar {
    ...
    public static java.security.SecureRandom getSecureRandom() {
        /*
            ...
            monitor-enter(r0)
            java.security.SecureRandom r1 = defaultSecureRandom     // Catch:{ all -> 0x0021 }
        ...
        L_0x000b:
            ...
            r0.<init>()
            java.lang.Object r1 = cacheLock
            monitor-enter(r1)
            java.security.SecureRandom r2 = defaultSecureRandom     // Catch:{ all -> 0x001e }
            if (r2 != 0) goto L_0x001a
            defaultSecureRandom = r0     // Catch:{ all -> 0x001e }
        L_0x001a:
            java.security.SecureRandom r0 = defaultSecureRandom     // Catch:{ all -> 0x001e }
