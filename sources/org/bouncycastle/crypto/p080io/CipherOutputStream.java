package org.bouncycastle.crypto.p080io;
...
public class CipherOutputStream extends FilterOutputStream {
    ...
    public void close() throws java.io.IOException {
        /*
            ...
            org.bouncycastle.crypto.BufferedBlockCipher r1 = r4.bufferedBlockCipher     // Catch:{ InvalidCipherTextException -> 0x0045, Exception -> 0x003c }
            ...
            goto L_0x003a
        L_0x001b:
            org.bouncycastle.crypto.modes.AEADBlockCipher r1 = r4.aeadBlockCipher     // Catch:{ InvalidCipherTextException -> 0x0045, Exception -> 0x003c }
            ...
            goto L_0x003a
        L_0x0031:
            org.bouncycastle.crypto.StreamCipher r0 = r4.streamCipher     // Catch:{ InvalidCipherTextException -> 0x0045, Exception -> 0x003c }
        ...
        L_0x005e:
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: org.bouncycastle.crypto.p080io.CipherOutputStream.close():void");
    }
