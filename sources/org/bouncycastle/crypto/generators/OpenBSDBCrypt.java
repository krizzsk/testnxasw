    ...
    private static void encodeData(StringBuilder sb, byte[] bArr) {
        ...
        if (bArr.length == 24 || bArr.length == 16) {
            ...
            for (int i = 0; i < length; i += 3) {
                ...
                sb.append((char) encodingTable[(b >>> 2) & 63]);
                sb.append((char) encodingTable[((b << 4) | (b2 >>> 4)) & 63]);
                sb.append((char) encodingTable[((b2 << 2) | (b3 >>> 6)) & 63]);
                sb.append((char) encodingTable[b3 & Utf8.REPLACEMENT_BYTE]);
            }
