...
public class X931RNG {
    ...
    /* renamed from: DT */
    private final byte[] f8053DT;

    /* renamed from: I */
    private final byte[] f8054I;

    /* renamed from: R */
    private final byte[] f8055R;
    ...
    public X931RNG(BlockCipher blockCipher, byte[] bArr, EntropySource entropySource2) {
        ...
        this.f8054I = new byte[blockCipher.getBlockSize()];
        this.f8055R = new byte[blockCipher.getBlockSize()];
    }
    ...
    public int generate(byte[] bArr, boolean z) {
        ...
        int length = bArr.length / this.f8055R.length;
        for (int i = 0; i < length; i++) {
            this.engine.processBlock(this.f8053DT, 0, this.f8054I, 0);
            process(this.f8055R, this.f8054I, this.f8056V);
            process(this.f8056V, this.f8055R, this.f8054I);
            byte[] bArr2 = this.f8055R;
            System.arraycopy(bArr2, 0, bArr, bArr2.length * i, bArr2.length);
            increment(this.f8053DT);
        }
        int length2 = bArr.length - (this.f8055R.length * length);
        if (length2 > 0) {
            this.engine.processBlock(this.f8053DT, 0, this.f8054I, 0);
            process(this.f8055R, this.f8054I, this.f8056V);
            process(this.f8056V, this.f8055R, this.f8054I);
