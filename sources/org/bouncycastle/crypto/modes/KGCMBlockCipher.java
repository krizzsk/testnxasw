...
public class KGCMBlockCipher implements AEADBlockCipher {
    ...
    public KGCMBlockCipher(BlockCipher blockCipher) {
        ...
        this.f7962iv = new byte[blockSize2];
        this.multiplier = createDefaultMultiplier(blockSize2);
        this.f7961b = new long[(this.blockSize >>> 3)];
        this.macBlock = null;
    }
    ...
    private void calculateMac(byte[] bArr, int i, int i2, int i3) {
        int i4 = i + i2;
        while (i < i4) {
            xorWithInput(this.f7961b, bArr, i);
            this.multiplier.multiplyH(this.f7961b);
            i += this.blockSize;
        }
        long j = (InternalZipConstants.ZIP_64_SIZE_LIMIT & ((long) i2)) << 3;
        long[] jArr = this.f7961b;
        jArr[0] = ((((long) i3) & InternalZipConstants.ZIP_64_SIZE_LIMIT) << 3) ^ jArr[0];
    ...
    public void init(boolean z, CipherParameters cipherParameters) throws IllegalArgumentException {
        ...
        if (cipherParameters instanceof AEADParameters) {
            ...
            byte[] bArr = this.f7962iv;
            Arrays.fill(bArr, (byte) 0);
            System.arraycopy(nonce, 0, this.f7962iv, bArr.length - nonce.length, nonce.length);
            ...
            byte[] bArr3 = this.f7962iv;
            Arrays.fill(bArr3, (byte) 0);
            System.arraycopy(iv, 0, this.f7962iv, bArr3.length - iv.length, iv.length);
        ...
        this.ctrEngine.init(true, new ParametersWithIV(keyParameter, this.f7962iv));
