...
public final class GoppaCode {
    ...
    public static class MaMaPe {
        ...
        /* renamed from: h */
        private GF2Matrix f8412h;

        /* renamed from: p */
        private Permutation f8413p;

        /* renamed from: s */
        private GF2Matrix f8414s;

        public MaMaPe(GF2Matrix gF2Matrix, GF2Matrix gF2Matrix2, Permutation permutation) {
            this.f8414s = gF2Matrix;
            this.f8412h = gF2Matrix2;
            this.f8413p = permutation;
        }
    ...
    public static class MatrixSet {
        ...
        /* renamed from: g */
        private GF2Matrix f8415g;
        private int[] setJ;

        public MatrixSet(GF2Matrix gF2Matrix, int[] iArr) {
            this.f8415g = gF2Matrix;
            this.setJ = iArr;
        }
        ...
        for (int i5 = 0; i5 < degree2; i5++) {
            for (int i6 = 0; i6 < i; i6++) {
                for (int i7 = 0; i7 <= i5; i7++) {
                    iArr2[i5][i6] = gF2mField2.add(iArr2[i5][i6], gF2mField2.mult(iArr4[i7][i6], polynomialGF2mSmallM2.getCoefficient((degree2 + i7) - i5)));
                }
            }
        }
        int[] iArr5 = new int[2];
