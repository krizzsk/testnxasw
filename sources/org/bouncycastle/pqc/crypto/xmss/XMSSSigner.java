...
public class XMSSSigner implements StateAwareMessageSigner {
    ...
    public org.bouncycastle.crypto.params.AsymmetricKeyParameter getUpdatedPrivateKey() {
        /*
            ...
            monitor-enter(r0)
            boolean r1 = r3.hasGenerated     // Catch:{ all -> 0x001c }
            if (r1 == 0) goto L_0x000e
            org.bouncycastle.pqc.crypto.xmss.XMSSPrivateKeyParameters r1 = r3.privateKey     // Catch:{ all -> 0x001c }
            r2 = 0
            r3.privateKey = r2     // Catch:{ all -> 0x001c }
            monitor-exit(r0)     // Catch:{ all -> 0x001c }
            return r1
        L_0x000e:
            org.bouncycastle.pqc.crypto.xmss.XMSSPrivateKeyParameters r1 = r3.privateKey     // Catch:{ all -> 0x001c }
            if (r1 == 0) goto L_0x001a
            org.bouncycastle.pqc.crypto.xmss.XMSSPrivateKeyParameters r2 = r3.privateKey     // Catch:{ all -> 0x001c }
            org.bouncycastle.pqc.crypto.xmss.XMSSPrivateKeyParameters r2 = r2.getNextKey()     // Catch:{ all -> 0x001c }
            r3.privateKey = r2     // Catch:{ all -> 0x001c }
        L_0x001a:
            monitor-exit(r0)     // Catch:{ all -> 0x001c }
            return r1
