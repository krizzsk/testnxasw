...
public final class XMSSParameters {
    ...
    public XMSSParameters(int i, ASN1ObjectIdentifier aSN1ObjectIdentifier) {
        if (i < 2) {
            ...
            int winternitzParameter2 = this.wotsPlusParams.getWinternitzParameter();
            this.winternitzParameter = winternitzParameter2;
            this.oid = DefaultXMSSOid.lookup(this.treeDigest, this.treeDigestSize, winternitzParameter2, this.wotsPlusParams.getLen(), i);
        } else {
