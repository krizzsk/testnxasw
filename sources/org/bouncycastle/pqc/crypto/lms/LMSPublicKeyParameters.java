...
public class LMSPublicKeyParameters extends LMSKeyParameters implements LMSContextBasedVerifier {
    ...
    /* renamed from: I */
    private final byte[] f8327I;

    /* renamed from: T1 */
    private final byte[] f8328T1;
    ...
    public LMSPublicKeyParameters(LMSigParameters lMSigParameters, LMOtsParameters lMOtsParameters, byte[] bArr, byte[] bArr2) {
        ...
        this.f8327I = Arrays.clone(bArr2);
        this.f8328T1 = Arrays.clone(bArr);
    }
    ...
    public static org.bouncycastle.pqc.crypto.lms.LMSPublicKeyParameters getInstance(java.lang.Object r4) throws java.io.IOException {
        ...
        L_0x0058:
            ...
            byte[] r4 = org.bouncycastle.util.p087io.Streams.readAll(r4)
    ...
    public boolean equals(Object obj) {
        ...
        if (this.parameterSet.equals(lMSPublicKeyParameters.parameterSet) && this.lmOtsType.equals(lMSPublicKeyParameters.lmOtsType) && Arrays.areEqual(this.f8327I, lMSPublicKeyParameters.f8327I)) {
            return Arrays.areEqual(this.f8328T1, lMSPublicKeyParameters.f8328T1);
        }
        return false;
    }
    ...
    public LMSContext generateOtsContext(LMSSignature lMSSignature) {
        ...
        if (lMSSignature.getOtsSignature().getType().getType() == type) {
            return new LMOtsPublicKey(LMOtsParameters.getParametersForType(type), this.f8327I, lMSSignature.getQ(), (byte[]) null).createOtsContext(lMSSignature);
        }
    ...
    public byte[] getI() {
        return Arrays.clone(this.f8327I);
    }
    ...
    public byte[] getT1() {
        return Arrays.clone(this.f8328T1);
    }

    public int hashCode() {
        return (((((this.parameterSet.hashCode() * 31) + this.lmOtsType.hashCode()) * 31) + Arrays.hashCode(this.f8327I)) * 31) + Arrays.hashCode(this.f8328T1);
    }

    /* access modifiers changed from: package-private */
    public boolean matchesT1(byte[] bArr) {
        return Arrays.constantTimeAreEqual(this.f8328T1, bArr);
    }
    ...
    public byte[] toByteArray() {
        return Composer.compose().u32str(this.parameterSet.getType()).u32str(this.lmOtsType.getType()).bytes(this.f8327I).bytes(this.f8328T1).build();
    }
