...
class LMSSignature implements Encodable {
    ...
    public static org.bouncycastle.pqc.crypto.lms.LMSSignature getInstance(java.lang.Object r7) throws java.io.IOException {
        ...
        L_0x0062:
            ...
            byte[] r7 = org.bouncycastle.util.p087io.Streams.readAll(r7)
    ...
    public boolean equals(Object obj) {
        ...
        if (this.f8329q != lMSSignature.f8329q) {
            return false;
        }
        ...
        if (lMSigParameters == null ? lMSSignature.parameter == null : lMSigParameters.equals(lMSSignature.parameter)) {
            return Arrays.deepEquals(this.f8330y, lMSSignature.f8330y);
        }
        return false;
    }

    public byte[] getEncoded() throws IOException {
        return Composer.compose().u32str(this.f8329q).bytes(this.otsSignature.getEncoded()).u32str(this.parameter.getType()).bytes(this.f8330y).build();
    }
    ...
    public int hashCode() {
        ...
        return ((hashCode + i2) * 31) + Arrays.deepHashCode(this.f8330y);
    }
}
