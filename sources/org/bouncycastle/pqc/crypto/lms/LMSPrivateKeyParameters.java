...
public class LMSPrivateKeyParameters extends LMSKeyParameters implements LMSContextBasedSigner {
    ...
    /* renamed from: T1 */
    private static CacheKey f8324T1;
    private static CacheKey[] internedKeys;

    /* renamed from: I */
    private final byte[] f8325I;
    ...
    private LMSPrivateKeyParameters(LMSPrivateKeyParameters lMSPrivateKeyParameters, int i, int i2) {
        ...
        this.f8326q = i;
        this.f8325I = lMSPrivateKeyParameters.f8325I;
        this.maxQ = i2;
    ...
    public static org.bouncycastle.pqc.crypto.lms.LMSPrivateKeyParameters getInstance(java.lang.Object r8) throws java.io.IOException {
        ...
        L_0x009a:
            ...
            byte[] r8 = org.bouncycastle.util.p087io.Streams.readAll(r8)
    ...
    public boolean equals(Object obj) {
        ...
        if (this.f8326q != lMSPrivateKeyParameters.f8326q || this.maxQ != lMSPrivateKeyParameters.maxQ || !Arrays.areEqual(this.f8325I, lMSPrivateKeyParameters.f8325I)) {
            return false;
        }
    ...
    public LMSPrivateKeyParameters extractKeyShard(int i) {
        ...
        synchronized (this) {
            if (this.f8326q + i < this.maxQ) {
                lMSPrivateKeyParameters = new LMSPrivateKeyParameters(this, this.f8326q, this.f8326q + i);
                this.f8326q += i;
            } else {
    ...
    public LMOtsPrivateKey getCurrentOTSKey() {
        ...
        synchronized (this) {
            if (this.f8326q < this.maxQ) {
                lMOtsPrivateKey = new LMOtsPrivateKey(this.otsParameters, this.f8325I, this.f8326q, this.masterSecret);
            } else {
    ...
    public byte[] getEncoded() throws IOException {
        return Composer.compose().u32str(0).u32str(this.parameters.getType()).u32str(this.otsParameters.getType()).bytes(this.f8325I).u32str(this.f8326q).u32str(this.maxQ).u32str(this.masterSecret.length).bytes(this.masterSecret).build();
    }

    public byte[] getI() {
        return Arrays.clone(this.f8325I);
    }
    ...
    public LMSPublicKeyParameters getPublicKey() {
        ...
        synchronized (this) {
            if (this.publicKey == null) {
                this.publicKey = new LMSPublicKeyParameters(this.parameters, this.otsParameters, findT(f8324T1), this.f8325I);
            }
    ...
    public long getUsagesRemaining() {
        return (long) (this.maxQ - this.f8326q);
    }

    public int hashCode() {
        int hashCode = ((this.f8326q * 31) + Arrays.hashCode(this.f8325I)) * 31;
        LMSigParameters lMSigParameters = this.parameters;
        int i = 0;
