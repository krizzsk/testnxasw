...
class LMOtsPublicKey implements Encodable {
    ...
    public LMSContext createOtsContext(LMOtsSignature lMOtsSignature) {
        ...
        LmsUtils.byteArray(this.f8318I, digest);
        LmsUtils.u32str(this.f8320q, digest);
    ...
    public boolean equals(Object obj) {
        ...
        if (this.f8320q != lMOtsPublicKey.f8320q) {
            return false;
        }
        ...
        if (!Arrays.equals(this.f8318I, lMOtsPublicKey.f8318I)) {
            return false;
        }
        return Arrays.equals(this.f8319K, lMOtsPublicKey.f8319K);
    }

    public byte[] getEncoded() throws IOException {
        return Composer.compose().u32str(this.parameter.getType()).bytes(this.f8318I).u32str(this.f8320q).bytes(this.f8319K).build();
    }
    ...
    public int hashCode() {
        LMOtsParameters lMOtsParameters = this.parameter;
        return ((((((lMOtsParameters != null ? lMOtsParameters.hashCode() : 0) * 31) + Arrays.hashCode(this.f8318I)) * 31) + this.f8320q) * 31) + Arrays.hashCode(this.f8319K);
    }
}
