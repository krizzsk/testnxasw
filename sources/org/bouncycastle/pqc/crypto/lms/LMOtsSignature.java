...
class LMOtsSignature implements Encodable {
    ...
    /* renamed from: C */
    private final byte[] f8321C;
    private final LMOtsParameters type;

    /* renamed from: y */
    private final byte[] f8322y;
    ...
    public boolean equals(Object obj) {
        ...
        if (!Arrays.equals(this.f8321C, lMOtsSignature.f8321C)) {
            return false;
        }
        return Arrays.equals(this.f8322y, lMOtsSignature.f8322y);
    }
    ...
    public byte[] getEncoded() throws IOException {
        return Composer.compose().u32str(this.type.getType()).bytes(this.f8321C).bytes(this.f8322y).build();
    }
    ...
    public int hashCode() {
        LMOtsParameters lMOtsParameters = this.type;
        return ((((lMOtsParameters != null ? lMOtsParameters.hashCode() : 0) * 31) + Arrays.hashCode(this.f8321C)) * 31) + Arrays.hashCode(this.f8322y);
    }
}
