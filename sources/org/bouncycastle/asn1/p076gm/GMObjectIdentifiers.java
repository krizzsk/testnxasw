package org.bouncycastle.asn1.p076gm;
...
public interface GMObjectIdentifiers {
    ...
    public static final ASN1ObjectIdentifier id_sm9PublicKey = sm_scheme.branch(DiFaceLogger.EVENT_ID_UPLOAD_PRE_PICTURES);
    ...
    public static final ASN1ObjectIdentifier sm2encrypt_with_md5 = sm2encrypt.branch(IMGD.IM_DATA_VERSION);
    ...
    public static final ASN1ObjectIdentifier sm2p256v1 = sm_scheme.branch(DiFaceLogger.EVENT_ID_SOURCE_PICTURES);
