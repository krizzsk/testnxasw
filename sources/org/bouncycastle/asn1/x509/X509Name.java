...
public class X509Name extends ASN1Object {
    ...
    /* renamed from: C */
    public static final ASN1ObjectIdentifier f7550C = new ASN1ObjectIdentifier("2.5.4.6");

    /* renamed from: CN */
    public static final ASN1ObjectIdentifier f7551CN = new ASN1ObjectIdentifier("2.5.4.3");
    ...
    /* renamed from: DC */
    public static final ASN1ObjectIdentifier f7552DC = new ASN1ObjectIdentifier("0.9.2342.19200300.100.1.25");
    ...
    /* renamed from: E */
    public static final ASN1ObjectIdentifier f7553E = EmailAddress;
    ...
    /* renamed from: L */
    public static final ASN1ObjectIdentifier f7554L = new ASN1ObjectIdentifier("2.5.4.7");
    public static final ASN1ObjectIdentifier NAME = X509ObjectIdentifiers.id_at_name;
    public static final ASN1ObjectIdentifier NAME_AT_BIRTH = new ASN1ObjectIdentifier("1.3.36.8.3.14");

    /* renamed from: O */
    public static final ASN1ObjectIdentifier f7555O = new ASN1ObjectIdentifier("2.5.4.10");
    public static final Hashtable OIDLookUp = DefaultSymbols;

    /* renamed from: OU */
    public static final ASN1ObjectIdentifier f7556OU = new ASN1ObjectIdentifier("2.5.4.11");
    ...
    public static final ASN1ObjectIdentifier SERIALNUMBER = f7557SN;

    /* renamed from: SN */
    public static final ASN1ObjectIdentifier f7557SN = new ASN1ObjectIdentifier("2.5.4.5");

    /* renamed from: ST */
    public static final ASN1ObjectIdentifier f7558ST = new ASN1ObjectIdentifier("2.5.4.8");
    public static final ASN1ObjectIdentifier STREET = new ASN1ObjectIdentifier("2.5.4.9");
    public static final ASN1ObjectIdentifier SURNAME = new ASN1ObjectIdentifier("2.5.4.4");
    public static final Hashtable SymbolLookUp;

    /* renamed from: T */
    public static final ASN1ObjectIdentifier f7559T = new ASN1ObjectIdentifier("2.5.4.12");
    ...
    static {
        ...
        DefaultSymbols.put(f7550C, "C");
        DefaultSymbols.put(f7555O, "O");
        DefaultSymbols.put(f7559T, "T");
        DefaultSymbols.put(f7556OU, "OU");
        DefaultSymbols.put(f7551CN, GlobalCountryCode.CHINA);
        DefaultSymbols.put(f7554L, "L");
        DefaultSymbols.put(f7558ST, "ST");
        DefaultSymbols.put(f7557SN, "SERIALNUMBER");
        DefaultSymbols.put(EmailAddress, ExifInterface.LONGITUDE_EAST);
        DefaultSymbols.put(f7552DC, "DC");
        ...
        RFC2253Symbols.put(f7550C, "C");
        RFC2253Symbols.put(f7555O, "O");
        RFC2253Symbols.put(f7556OU, "OU");
        RFC2253Symbols.put(f7551CN, GlobalCountryCode.CHINA);
        RFC2253Symbols.put(f7554L, "L");
        RFC2253Symbols.put(f7558ST, "ST");
        RFC2253Symbols.put(STREET, "STREET");
        RFC2253Symbols.put(f7552DC, "DC");
        RFC2253Symbols.put(UID, "UID");
        RFC1779Symbols.put(f7550C, "C");
        RFC1779Symbols.put(f7555O, "O");
        RFC1779Symbols.put(f7556OU, "OU");
        RFC1779Symbols.put(f7551CN, GlobalCountryCode.CHINA);
        RFC1779Symbols.put(f7554L, "L");
        RFC1779Symbols.put(f7558ST, "ST");
        RFC1779Symbols.put(STREET, "STREET");
        DefaultLookUp.put("c", f7550C);
        DefaultLookUp.put("o", f7555O);
        DefaultLookUp.put(RavenKey.TYPE, f7559T);
        DefaultLookUp.put("ou", f7556OU);
        DefaultLookUp.put("cn", f7551CN);
        DefaultLookUp.put("l", f7554L);
        DefaultLookUp.put(UserDataStore.STATE, f7558ST);
        DefaultLookUp.put("sn", f7557SN);
        DefaultLookUp.put("serialnumber", f7557SN);
        DefaultLookUp.put("street", STREET);
        DefaultLookUp.put("emailaddress", f7553E);
        DefaultLookUp.put("dc", f7552DC);
        DefaultLookUp.put("e", f7553E);
                ...
                if (i < instance.size()) {
                    ...
                    if (instance2.size() == 2) {
                        ...
                        if (!(objectAt instanceof ASN1String) || (objectAt instanceof DERUniversalString)) {
                            try {
                                this.values.addElement(RConfigConstants.KEYWORD_COLOR_SIGN + bytesToString(Hex.encode(objectAt.toASN1Primitive().getEncoded(ASN1Encoding.DER))));
