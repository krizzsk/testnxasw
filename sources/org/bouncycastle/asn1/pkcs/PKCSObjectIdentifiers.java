...
public interface PKCSObjectIdentifiers {
    ...
    public static final ASN1ObjectIdentifier id_PBES2 = pkcs_5.branch(DiFaceLogger.EVENT_ID_BIOASSAY_ACTION_SUCCESS);
    ...
    public static final ASN1ObjectIdentifier id_aa_asymmDecryptKeyID = id_aa.branch(DiFaceLogger.EVENT_ID_CHECK_MODEL_REQ_CALLBACK);
    ...
    public static final ASN1ObjectIdentifier id_aa_ets_certCRLTimestamp = id_aa.branch(ScarShareReportModel.CHANNEL_LINE);
    ...
    public static final ASN1ObjectIdentifier id_aa_ets_escTimeStamp = id_aa.branch(ScarShareReportModel.CHANNEL_EMAIL);
    public static final ASN1ObjectIdentifier id_aa_ets_otherSigCert = id_aa.branch(DiFaceLogger.EVENT_ID_APPEAL_DIALOG_CANCEL);
    public static final ASN1ObjectIdentifier id_aa_ets_revocationRefs;
    public static final ASN1ObjectIdentifier id_aa_ets_revocationValues = id_aa.branch(ScarShareReportModel.CHANNEL_MESSENGER);
    public static final ASN1ObjectIdentifier id_aa_ets_sigPolicyId;
    public static final ASN1ObjectIdentifier id_aa_ets_signerAttr = id_aa.branch(DiFaceLogger.EVENT_ID_ENTER_APPEAL_DIALOG);
    public static final ASN1ObjectIdentifier id_aa_ets_signerLocation = id_aa.branch(DiFaceLogger.EVENT_ID_BIOASSAY_EXIT);
    public static final ASN1ObjectIdentifier id_aa_implCompressAlgs = id_aa.branch("43");
    public static final ASN1ObjectIdentifier id_aa_implCryptoAlgs = id_aa.branch(AppsFlyerLibCore.f1788);
    ...
    public static final ASN1ObjectIdentifier id_aa_signingCertificateV2 = id_aa.branch(DiFaceLogger.EVENT_ID_SDK_EXIT_DIALOG_CONFIRM);
    public static final ASN1ObjectIdentifier id_alg;
    public static final ASN1ObjectIdentifier id_alg_AEADChaCha20Poly1305 = id_alg.branch(DiFaceLogger.EVENT_ID_ENTER_APPEAL_DIALOG);
    ...
    public static final ASN1ObjectIdentifier id_alg_hkdf_with_sha384 = id_alg.branch(DiFaceLogger.EVENT_ID_APPEAL_DATA_SUBMIT_ENTER_VIDEO_DEMO_CHECK);
    public static final ASN1ObjectIdentifier id_alg_hkdf_with_sha512 = id_alg.branch(DiFaceLogger.EVENT_ID_APPEAL_DATA_SUBMIT_ENTER_PHOTO_DEMO_CHECK);
    public static final ASN1ObjectIdentifier id_alg_hss_lms_hashsig = id_alg.branch(DiFaceLogger.EVENT_ID_BIOASSAY_EXIT);
    ...
    public static final ASN1ObjectIdentifier id_ct_authEnvelopedData = id_ct.branch(ScarShareReportModel.CHANNEL_TWITTER);
    public static final ASN1ObjectIdentifier id_ct_compressedData = id_ct.branch("9");
    public static final ASN1ObjectIdentifier id_ct_timestampedData = id_ct.branch(DiFaceLogger.EVENT_ID_APPEAL_DATA_SUBMIT_ENTER_VIDEO_TAKE);
    ...
    public static final ASN1ObjectIdentifier id_hmacWithSHA512_256 = digestAlgorithm.branch(DiFaceLogger.EVENT_ID_BIOASSAY_ACTION_SUCCESS).intern();
    ...
    public static final ASN1ObjectIdentifier pkcs_9_at_localKeyId = pkcs_9.branch(ScarShareReportModel.CHANNEL_FACEBOOK).intern();
    public static final ASN1ObjectIdentifier pkcs_9_at_messageDigest = pkcs_9.branch("4").intern();
    public static final ASN1ObjectIdentifier pkcs_9_at_signingDescription = pkcs_9.branch(DiFaceLogger.EVENT_ID_BIOASSAY_ACTION_SUCCESS).intern();
    ...
    public static final ASN1ObjectIdentifier sha512WithRSAEncryption = pkcs_1.branch(DiFaceLogger.EVENT_ID_BIOASSAY_ACTION_SUCCESS);
    public static final ASN1ObjectIdentifier sha512_224WithRSAEncryption = pkcs_1.branch(DiFaceLogger.EVENT_ID_COMPARE_REQUEST_LAUNCH);
    ...
    static {
        ...
        sha512_256WithRSAEncryption = aSN1ObjectIdentifier2.branch("16");
        ASN1ObjectIdentifier aSN1ObjectIdentifier3 = new ASN1ObjectIdentifier("1.2.840.113549.1.3");
        pkcs_3 = aSN1ObjectIdentifier3;
        dhKeyAgreement = aSN1ObjectIdentifier3.branch("1");
        ASN1ObjectIdentifier aSN1ObjectIdentifier4 = new ASN1ObjectIdentifier("1.2.840.113549.1.5");
        pkcs_5 = aSN1ObjectIdentifier4;
        pbeWithMD2AndDES_CBC = aSN1ObjectIdentifier4.branch("1");
        ASN1ObjectIdentifier aSN1ObjectIdentifier5 = new ASN1ObjectIdentifier("1.2.840.113549.3");
        encryptionAlgorithm = aSN1ObjectIdentifier5;
        des_EDE3_CBC = aSN1ObjectIdentifier5.branch("7");
        ASN1ObjectIdentifier aSN1ObjectIdentifier6 = new ASN1ObjectIdentifier("1.2.840.113549.2");
        digestAlgorithm = aSN1ObjectIdentifier6;
        md2 = aSN1ObjectIdentifier6.branch("2");
        ASN1ObjectIdentifier aSN1ObjectIdentifier7 = new ASN1ObjectIdentifier("1.2.840.113549.1.9");
        pkcs_9 = aSN1ObjectIdentifier7;
        pkcs_9_at_emailAddress = aSN1ObjectIdentifier7.branch("1").intern();
        String str2 = str;
        pkcs_9_at_smimeCapabilities = pkcs_9.branch(str2).intern();
        String str3 = "16";
        id_smime = pkcs_9.branch(str3).intern();
        ASN1ObjectIdentifier aSN1ObjectIdentifier8 = pkcs_9;
        String str4 = ScarShareReportModel.CHANNEL_FACEBOOK;
        x509certType = aSN1ObjectIdentifier8.branch("22.1");
        ASN1ObjectIdentifier branch = pkcs_9.branch(ScarShareReportModel.CHANNEL_WHATSAPP);
        certTypes = branch;
        x509Certificate = branch.branch("1").intern();
        ASN1ObjectIdentifier aSN1ObjectIdentifier9 = pkcs_9;
        String str5 = ScarShareReportModel.CHANNEL_WHATSAPP;
        ASN1ObjectIdentifier branch2 = aSN1ObjectIdentifier9.branch(ScarShareReportModel.CHANNEL_TWITTER);
        crlTypes = branch2;
        ...
        id_ct = aSN1ObjectIdentifier10;
        id_ct_authData = aSN1ObjectIdentifier10.branch("2");
        ASN1ObjectIdentifier branch3 = id_smime.branch("3");
        id_alg = branch3;
        id_alg_PWRI_KEK = branch3.branch("9");
        ASN1ObjectIdentifier aSN1ObjectIdentifier11 = id_alg;
        String str6 = ScarShareReportModel.CHANNEL_TWITTER;
        id_alg_hkdf_with_sha256 = aSN1ObjectIdentifier11.branch("28");
        ASN1ObjectIdentifier aSN1ObjectIdentifier12 = new ASN1ObjectIdentifier("1.2.840.113549.1.9.16.6");
        id_cti = aSN1ObjectIdentifier12;
        id_cti_ets_proofOfOrigin = aSN1ObjectIdentifier12.branch("1");
        ASN1ObjectIdentifier aSN1ObjectIdentifier13 = new ASN1ObjectIdentifier("1.2.840.113549.1.9.16.2");
        id_aa = aSN1ObjectIdentifier13;
        id_aa_receiptRequest = aSN1ObjectIdentifier13.branch("1");
        id_aa_ets_sigPolicyId = id_aa.branch(str2);
        id_aa_ets_commitmentType = id_aa.branch(str3);
        id_aa_ets_certificateRefs = id_aa.branch(str4);
        id_aa_ets_revocationRefs = id_aa.branch(str5);
        id_aa_ets_certValues = id_aa.branch(str6);
        ASN1ObjectIdentifier aSN1ObjectIdentifier14 = new ASN1ObjectIdentifier("1.2.840.113549.1.12");
        pkcs_12 = aSN1ObjectIdentifier14;
        ASN1ObjectIdentifier branch4 = aSN1ObjectIdentifier14.branch("10.1");
        bagtypes = branch4;
