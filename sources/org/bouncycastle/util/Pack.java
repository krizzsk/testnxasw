...
public abstract class Pack {
    ...
    public static long bigEndianToLong(byte[] bArr, int i) {
        ...
        return (((long) bigEndianToInt(bArr, i + 4)) & InternalZipConstants.ZIP_64_SIZE_LIMIT) | ((((long) bigEndianToInt) & InternalZipConstants.ZIP_64_SIZE_LIMIT) << 32);
    }
    ...
    public static long littleEndianToLong(byte[] bArr, int i) {
        return ((((long) littleEndianToInt(bArr, i + 4)) & InternalZipConstants.ZIP_64_SIZE_LIMIT) << 32) | (((long) littleEndianToInt(bArr, i)) & InternalZipConstants.ZIP_64_SIZE_LIMIT);
    }
    ...
    public static void longToLittleEndian(long j, byte[] bArr, int i) {
        intToLittleEndian((int) (InternalZipConstants.ZIP_64_SIZE_LIMIT & j), bArr, i);
