...
public class JavaPolicySecurity extends SecurityProxy {
    ...
    private static class ContextPermissions extends PermissionCollection {
        ...
        public String toString() {
            return getClass().getName() + '@' + Integer.toHexString(System.identityHashCode(this)) + " (context=" + this._context + ", static_permitions=" + this._statisPermissions + VersionRange.RIGHT_OPEN;
        }
    }
    ...
    public URL getUrlObj(String str) {
        try {
            ...
            String replace = System.getProperty("user.dir").replace(IOUtils.DIR_SEPARATOR_WINDOWS, IOUtils.DIR_SEPARATOR_UNIX);
            if (!replace.endsWith("/")) {
