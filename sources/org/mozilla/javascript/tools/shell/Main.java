...
public class Main {
    ...
    public static Global f62464global = new Global();
    ...
    static {
        f62464global.initQuitAction(new IProxy(3));
    }
    ...
    private static class IProxy implements ContextAction, QuitAction {
        ...
        public Object run(Context context) {
            if (Main.useRequire) {
                Main.require = Main.f62464global.installRequire(context, Main.modulePath, Main.sandboxed);
            }
            int i = this.type;
            if (i == 1) {
    ...
    public static int exec(String[] strArr) {
        ToolErrorReporter toolErrorReporter = new ToolErrorReporter(false, f62464global.getErr());
        ...
        if (!f62464global.initialized) {
            f62464global.init((ContextFactory) shellContextFactory);
        }
    ...
    static void processFiles(Context context, String[] strArr) {
        ...
        f62464global.defineProperty("arguments", (Object) context.newArray((Scriptable) f62464global, objArr), 2);
    ...
    static Scriptable getScope(String str) {
        ...
        return new ModuleScope(f62464global, uri, (URI) null);
    }
    ...
    public static String[] processOptions(String[] strArr) {
        ...
        while (i != strArr.length) {
            ...
            if (str.equals("-version")) {
                ...
                f62464global.getOut().println(ToolErrorReporter.getMessage("msg.shell.invalid", str));
                f62464global.getOut().println(ToolErrorReporter.getMessage("msg.shell.usage", cls.getName()));
                exitCode = 1;
                return null;
                ...
                f62464global.setSealedStdLib(true);
    ...
    public static void processSource(org.mozilla.javascript.Context r12, java.lang.String r13) throws java.io.IOException {
        ...
        L_0x003c:
            org.mozilla.javascript.tools.shell.Global r2 = f62464global
        ...
        L_0x004f:
            ...
            org.mozilla.javascript.tools.shell.Global r6 = f62464global
        ...
        L_0x00c6:
            org.mozilla.javascript.tools.shell.Global r7 = f62464global     // Catch:{ RhinoException -> 0x00e9, VirtualMachineError -> 0x00d4 }
