...
public class JSConsole extends JFrame implements ActionListener {
    ...
    public JSConsole(String[] strArr) {
        ...
        createFileChooser();
        String[] strArr2 = {"Load...", LogData.EVENT_EXIT};
        String[] strArr3 = {"Load", LogData.EVENT_EXIT};
    ...
    public void actionPerformed(ActionEvent actionEvent) {
        ...
        if (actionCommand.equals("Load")) {
            ...
            if (chooseFile != null) {
                String replace = chooseFile.replace(IOUtils.DIR_SEPARATOR_WINDOWS, IOUtils.DIR_SEPARATOR_UNIX);
                ConsoleTextArea consoleTextArea2 = this.consoleTextArea;
                consoleTextArea2.eval("load(\"" + replace + "\");");
            }
        } else if (actionCommand.equals(LogData.EVENT_EXIT)) {
            System.exit(0);
