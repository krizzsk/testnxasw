...
class CodePrinter {
    ...
    /* renamed from: p */
    public void mo40978p(char c) {
        this.buffer[add_area(1)] = c;
    }

    /* renamed from: p */
    public void mo40980p(String str) {
        int length = str.length();
        str.getChars(0, length, this.buffer, add_area(length));
    }

    /* renamed from: p */
    public final void mo40981p(char[] cArr) {
        mo40982p(cArr, 0, cArr.length);
    }

    /* renamed from: p */
    public void mo40982p(char[] cArr, int i, int i2) {
        int i3 = i2 - i;
        System.arraycopy(cArr, i, this.buffer, add_area(i3), i3);
    }

    /* renamed from: p */
    public void mo40979p(int i) {
        mo40980p(Integer.toString(i));
    }
