...
public class Main {
    ...
    public String[] processOptions(String[] strArr) {
        ...
        m7177p(ToolErrorReporter.getMessage("msg.no.file"));
        return null;
    }
    ...
    public void processSource(String[] strArr) {
        ...
        while (i != strArr.length) {
            String str = strArr[i];
            if (!str.endsWith(Constant.LAUNCHER_JS.PAGE_WEB_VIEW_JAVASCRIPT_SUFFIX)) {
    ...
    /* renamed from: p */
    private static void m7177p(String str) {
