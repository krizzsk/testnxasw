...
class VariableModel implements TreeTableModel {
    ...
    public Object getValue(VariableNode variableNode) {
        try {
            return this.debugger.getObjectProperty(variableNode.object, variableNode.f8503id);
    ...
    private static class VariableNode {
        ...
        public String toString() {
            Object obj = this.f8503id;
            if (obj instanceof String) {
                return (String) obj;
            }
            return Const.jaLeft + ((Integer) this.f8503id).intValue() + Const.jaRight;
        }
    }
}
