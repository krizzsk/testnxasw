...
public abstract class ScriptableObject implements Serializable, ConstProperties, Scriptable, DebuggableObject {
    ...
    private static final class GetterSlot extends Slot {
        ...
        public ScriptableObject getPropertyDescriptor(Context context, Scriptable scriptable) {
            ...
            if (obj2 != null) {
                nativeObject.defineProperty(GuideParamModel.ACTION_SET, obj2, 0);
            }
            return nativeObject;
        }
    ...
    public boolean has(int i, Scriptable scriptable) {
        ...
        if (externalArrayData != null) {
            ...
            return false;
        } else if (getSlot((String) null, i, 1) != null) {
            return true;
        } else {
            return false;
        }
    ...
    public void put(int i, Scriptable scriptable, Object obj) {
        ...
        } else if (!putImpl((String) null, i, scriptable, obj)) {
            if (scriptable != this) {
    ...
    private static Method findSetterMethod(Method[] methodArr, String str, String str2) {
        ...
        sb.append(GuideParamModel.ACTION_SET);
    ...
    public void defineOwnProperty(Context context, Object obj, ScriptableObject scriptableObject, boolean z) {
        ...
        if (isAccessorDescriptor) {
            ...
            Object property2 = getProperty((Scriptable) scriptableObject, GuideParamModel.ACTION_SET);
        ...
        if (scriptableObject == null) {
            ...
            if (isTrue(getProperty((Scriptable) scriptableObject2, "configurable"))) {
                ...
                if (!isDataDescriptor || !isDataDescriptor(scriptableObject)) {
                    ...
                    } else if (!sameValue(getProperty((Scriptable) scriptableObject2, GuideParamModel.ACTION_SET), scriptableObject.get(GuideParamModel.ACTION_SET, (Scriptable) scriptableObject))) {
    ...
    public boolean isAccessorDescriptor(ScriptableObject scriptableObject) {
        return hasProperty((Scriptable) scriptableObject, "get") || hasProperty((Scriptable) scriptableObject, GuideParamModel.ACTION_SET);
    }
    ...
    public static Scriptable getClassPrototype(Scriptable scriptable, String str) {
        ...
        if (property instanceof BaseFunction) {
            ...
            if (property instanceof Scriptable) {
                ...
                obj = scriptable2.get(Constants.SCOPE_PROTOTYPE, scriptable2);
            }
            return null;
        }
        if (obj instanceof Scriptable) {
    ...
    public Object[] getIds(boolean z) {
        ...
        while (slot != null) {
            if (z || (slot.getAttributes() & 2) == 0) {
                if (i2 == arrayLength) {
                    Object[] objArr2 = new Object[(slotArr.length + arrayLength)];
                    if (objArr != null) {
