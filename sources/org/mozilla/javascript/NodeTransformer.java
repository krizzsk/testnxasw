...
public class NodeTransformer {
    ...
    /* JADX WARNING: Removed duplicated region for block: B:198:0x039d  */
                    ...
                    if (firstChild3.getType() == i2) {
                        ...
                        if (list != null) {
                            ...
                            for (int i4 = 0; i4 < list.size(); i4++) {
                                node12.addChildToBack(new Node(126, Node.newNumber(0.0d)));
                            }
                        }
