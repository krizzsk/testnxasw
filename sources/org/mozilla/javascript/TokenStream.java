...
class TokenStream {
    ...
    /* JADX WARNING: Removed duplicated region for block: B:321:0x0461 A[LOOP:6: B:321:0x0461->B:323:0x0467, LOOP_START, PHI: r1 
      PHI: (r1v25 int) = (r1v4 int), (r1v26 int) binds: [B:320:0x045f, B:323:0x0467] A[DONT_GENERATE, DONT_INLINE]] */
    /* JADX WARNING: Removed duplicated region for block: B:324:0x046f A[LOOP:7: B:324:0x046f->B:335:0x048d, LOOP_START, PHI: r1 r8 
      PHI: (r1v23 int) = (r1v4 int), (r1v24 int) binds: [B:320:0x045f, B:335:0x048d] A[DONT_GENERATE, DONT_INLINE]
      PHI: (r8v4 int) = (r8v2 int), (r8v5 int) binds: [B:320:0x045f, B:335:0x048d] A[DONT_GENERATE, DONT_INLINE]] */
    /* JADX WARNING: Removed duplicated region for block: B:342:0x04a1 A[LOOP:8: B:342:0x04a1->B:343:0x04ac, LOOP_START, PHI: r1 
      PHI: (r1v21 int) = (r1v5 int), (r1v22 int) binds: [B:341:0x049f, B:343:0x04ac] A[DONT_GENERATE, DONT_INLINE]] */
    /* JADX WARNING: Removed duplicated region for block: B:347:0x04b5 A[PHI: r1 
      PHI: (r1v20 int) = (r1v17 int), (r1v13 int) binds: [B:406:0x04b5, B:346:0x04b2] A[DONT_GENERATE, DONT_INLINE]] */
    /* JADX WARNING: Removed duplicated region for block: B:348:0x04b7  */
    ...
    final int getToken() throws java.io.IOException {
        ...
        L_0x0430:
            ...
            int r1 = r16.getChar()
            if (r1 == r14) goto L_0x0454
            r8 = 88
            if (r1 != r8) goto L_0x0445
            goto L_0x0454
        L_0x0445:
        ...
        L_0x048d:
            ...
            goto L_0x046f
        L_0x0495:
            if (r8 != r4) goto L_0x04e7
            if (r1 == r7) goto L_0x049f
            if (r1 == r10) goto L_0x049f
            r9 = 69
            if (r1 != r9) goto L_0x04e7
        L_0x049f:
            if (r1 != r7) goto L_0x04ae
        L_0x04a1:
            r0.addToString(r1)
            int r1 = r16.getChar()
        ...
        L_0x04b7:
            ...
            int r1 = r16.getChar()
            r5 = 43
            if (r1 == r5) goto L_0x04c4
            if (r1 != r6) goto L_0x04cb
        L_0x04c4:
            r0.addToString(r1)
            int r1 = r16.getChar()
        L_0x04cb:
        ...
        L_0x04e7:
            ...
            java.lang.String r1 = r16.getStringFromBuffer()
            r0.string = r1
            if (r8 != r4) goto L_0x0501
            if (r5 != 0) goto L_0x0501
            double r1 = java.lang.Double.parseDouble(r1)     // Catch:{ NumberFormatException -> 0x04f9 }
            goto L_0x0505
        L_0x04f9:
            org.mozilla.javascript.Parser r1 = r0.parser
