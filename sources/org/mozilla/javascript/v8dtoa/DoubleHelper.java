...
public class DoubleHelper {
    ...
    static void normalizedBoundaries(long j, DiyFp diyFp, DiyFp diyFp2) {
        ...
        boolean z = asDiyFp.mo41160f() == kHiddenBit;
        diyFp2.setF((asDiyFp.mo41160f() << 1) + 1);
        diyFp2.setE(asDiyFp.mo41159e() - 1);
        diyFp2.normalize();
        if (!z || asDiyFp.mo41159e() == kDenormalExponent) {
            diyFp.setF((asDiyFp.mo41160f() << 1) - 1);
            diyFp.setE(asDiyFp.mo41159e() - 1);
        } else {
            diyFp.setF((asDiyFp.mo41160f() << 2) - 1);
            diyFp.setE(asDiyFp.mo41159e() - 2);
        }
        diyFp.setF(diyFp.mo41160f() << (diyFp.mo41159e() - diyFp2.mo41159e()));
        diyFp.setE(diyFp2.mo41159e());
    }
}
