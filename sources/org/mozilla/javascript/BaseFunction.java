...
public class BaseFunction extends IdScriptableObject implements Function {
    ...
    public boolean hasInstance(Scriptable scriptable) {
        Object property = ScriptableObject.getProperty((Scriptable) this, Constants.SCOPE_PROTOTYPE);
        ...
        if (length == 4) {
            ...
            if (length == 9) {
                ...
                if (charAt == 'a') {
                    ...
                    str2 = Constants.SCOPE_PROTOTYPE;
                    i = 4;
                }
            }
            str2 = null;
    ...
    public String getInstanceIdName(int i) {
        ...
        return Constants.SCOPE_PROTOTYPE;
    }
    ...
    public void initPrototypeId(int i) {
        ...
        switch (i) {
            ...
            case 4:
                i2 = 2;
                str = PrepaidConstant.SCENE_APPLY;
                break;
            case 5:
                str = NotificationCompat.CATEGORY_CALL;
                break;
            case 6:
                str = LoginConstants.AUTH_BIND_METHOD;
                break;
            default:
