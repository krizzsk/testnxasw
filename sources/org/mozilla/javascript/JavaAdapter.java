...
public final class JavaAdapter implements IdFunctionCall {
    ...
    public static byte[] createAdapterCode(ObjToIntMap objToIntMap, String str, Class<?> cls, Class<?>[] clsArr, String str2) {
        ...
        classFileWriter.addField("self", "Lorg/mozilla/javascript/Scriptable;", 17);
        if (clsArr2 == null) {
            i = 0;
        } else {
            i = clsArr2.length;
        ...
        for (Constructor constructor : cls.getDeclaredConstructors()) {
            ...
            if (Modifier.isPublic(modifiers) || Modifier.isProtected(modifiers)) {
                generateCtor(classFileWriter, str3, replace, constructor);
            }
        }
    ...
    public static Scriptable runScript(final Script script) {
        return (Scriptable) ContextFactory.getGlobal().call(new ContextAction() {
            public Object run(Context context) {
                ScriptableObject global2 = ScriptRuntime.getGlobal(context);
                script.exec(context, global2);
                return global2;
            }
        });
    }
    ...
    private static void generateCtor(ClassFileWriter classFileWriter, String str, String str2, Constructor<?> constructor) {
        ...
        if (parameterTypes.length == 0) {
            classFileWriter.startMethod("<init>", "(Lorg/mozilla/javascript/Scriptable;Lorg/mozilla/javascript/ContextFactory;)V", 1);
            ...
            sb.append(")V");
            classFileWriter.startMethod("<init>", sb.toString(), 1);
            classFileWriter.add(42);
    ...
    private static void generateSerialCtor(ClassFileWriter classFileWriter, String str, String str2) {
        classFileWriter.startMethod("<init>", "(Lorg/mozilla/javascript/ContextFactory;Lorg/mozilla/javascript/Scriptable;Lorg/mozilla/javascript/Scriptable;)V", 1);
        classFileWriter.add(42);
        classFileWriter.addInvoke(183, str2, "<init>", "()V");
        classFileWriter.add(42);
        classFileWriter.add(43);
