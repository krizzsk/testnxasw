...
class BodyCodegen {
    ...
    public void generateBodyCode() {
        ...
        if (this.isGenerator) {
            ...
            classFileWriter.startMethod(this.codegen.getBodyMethodName(this.scriptOrFn) + "_gen", "(" + this.codegen.mainClassSignature + "Lorg/mozilla/javascript/Context;" + "Lorg/mozilla/javascript/Scriptable;" + "Ljava/lang/Object;" + "Ljava/lang/Object;I)Ljava/lang/Object;", 10);
        } else {
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:62:0x014c, code lost:
        if (r7.compilerEnv.isGenerateObserverCount() == false) goto L_0x0151;
     */
    ...
    private void generateStatement(org.mozilla.javascript.Node r8) {
        ...
        L_0x003f:
            switch(r0) {
                case 128: goto L_0x0238;
                case 129: goto L_0x0238;
                case 130: goto L_0x0238;
                case 131: goto L_0x00a9;
                case 132: goto L_0x0238;
                case 133: goto L_0x005d;
                case 134: goto L_0x0047;
                case 135: goto L_0x0146;
        ...
        L_0x00ca:
            ...
            r1.addALoad(r3)
            org.mozilla.classfile.ClassFileWriter r1 = r7.cfw
            short r3 = r7.variableObjectLocal
            r1.addALoad(r3)
            r1 = 58
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:136:0x0461, code lost:
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:73:0x020a, code lost:
        ...
        addScriptRuntimeInvoke(com.didi.unifylogin.utils.LoginConstants.AUTH_BIND_METHOD, "(Lorg/mozilla/javascript/Context;Lorg/mozilla/javascript/Scriptable;Ljava/lang/String;)Lorg/mozilla/javascript/Scriptable;");
     */
    ...
    private void generateExpression(org.mozilla.javascript.Node r18, org.mozilla.javascript.Node r19) {
        /*
            ...
            if (r3 == r7) goto L_0x054d
            r7 = 109(0x6d, float:1.53E-43)
            r13 = 1
            if (r3 == r7) goto L_0x0525
            ...
            switch(r3) {
                ...
                case 42: goto L_0x027c;
                case 43: goto L_0x0273;
                case 44: goto L_0x026a;
                case 45: goto L_0x0261;
                case 46: goto L_0x0475;
                case 47: goto L_0x0475;
        ...
        L_0x0047:
            switch(r3) {
                ...
                case 54: goto L_0x01f5;
                case 55: goto L_0x01f0;
                case 56: goto L_0x01eb;
        ...
        L_0x004f:
            ...
            switch(r3) {
                case 65: goto L_0x01b9;
                case 66: goto L_0x01b4;
                case 67: goto L_0x01a5;
                case 68: goto L_0x04e0;
                case 69: goto L_0x0194;
        ...
        L_0x0057:
            switch(r3) {
                ...
                case 138: goto L_0x05a9;
                case 139: goto L_0x0303;
                case 140: goto L_0x02cb;
        ...
        L_0x0590:
            ...
            goto L_0x0590
        L_0x05a6:
            r1.generateExpression(r2, r0)     // Catch:{ all -> 0x05aa }
        L_0x05a9:
            return
        L_0x05aa:
            r0 = move-exception
    ...
    private void addLoadPropertyIds(Object[] objArr, int i) {
        ...
        for (int i2 = 0; i2 != i; i2++) {
            ...
            if (str instanceof String) {
                ...
                this.cfw.addPush(((Integer) str).intValue());
    ...
    private void visitOptimizedCall(Node node, OptFunctionNode optFunctionNode, int i, Node node2) {
        ...
        this.cfw.add(89);
        this.cfw.add(180, str, ShareDBHelper.ID_NAME, "I");
