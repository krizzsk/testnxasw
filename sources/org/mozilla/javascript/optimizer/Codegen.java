...
public class Codegen implements Evaluator {
    ...
    private byte[] generateCode(String str) {
        ...
        classFileWriter.addField("_id", "I", 2);
        if (z) {
    ...
    private void generateCallMethod(ClassFileWriter classFileWriter) {
        ...
        if (z) {
            classFileWriter.addLoadThis();
            classFileWriter2.add(180, classFileWriter.getClassName(), "_id", "I");
    ...
    private void generateMain(ClassFileWriter classFileWriter) {
        classFileWriter.startMethod(NachoConstants.NACHO_ENTRYPOINT_NAME, "([Ljava/lang/String;)V", 9);
        ...
        classFileWriter.addInvoke(184, this.mainMethodClass, NachoConstants.NACHO_ENTRYPOINT_NAME, "(Lorg/mozilla/javascript/Script;[Ljava/lang/String;)V");
    ...
    private void generateScriptCtor(ClassFileWriter classFileWriter) {
        classFileWriter.startMethod("<init>", "()V", 1);
        classFileWriter.addLoadThis();
    ...
    private void generateFunctionConstructor(ClassFileWriter classFileWriter) {
        int i;
        boolean z = true;
        classFileWriter.startMethod("<init>", FUNCTION_CONSTRUCTOR_SIGNATURE, 1);
        short s = 0;
        classFileWriter.addALoad(0);
        classFileWriter.addInvoke(183, SUPER_CLASS_NAME, "<init>", "()V");
        classFileWriter.addLoadThis();
            ...
            while (true) {
                ...
                if (i4 != scriptNodeArr2.length) {
                    ...
                    while (i5 != regexpCount) {
                        ...
                        classFileWriter2.addField(compiledRegexpName, "Ljava/lang/Object;", s);
                        classFileWriter2.addALoad(1);
                        ...
                        classFileWriter2.add(179, this.mainClassName, compiledRegexpName, "Ljava/lang/Object;");
                        i5++;
                        i = 0;
                        s = 10;
                    }
    ...
    private void emitConstantDudeInitializers(ClassFileWriter classFileWriter) {
        ...
        if (i != 0) {
            classFileWriter.startMethod("<clinit>", "()V", 24);
