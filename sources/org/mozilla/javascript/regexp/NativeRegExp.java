...
public class NativeRegExp extends IdScriptableObject implements Function {
    ...
    public static void init(Context context, Scriptable scriptable, boolean z) {
        ...
        nativeRegExp.f8491re = compileRE(context, "", (String) null, false);
    ...
    public Scriptable compile(Context context, Scriptable scriptable, Object[] objArr) {
        if (objArr.length <= 0 || !(objArr[0] instanceof NativeRegExp)) {
            this.f8491re = compileRE(context, (objArr.length == 0 || (objArr[0] instanceof Undefined)) ? "" : escapeRegExp(objArr[0]), (objArr.length <= 1 || objArr[1] == Undefined.instance) ? null : ScriptRuntime.toString(objArr[1]), false);
            this.lastIndex = Double.valueOf(0.0d);
            return this;
        } else if (objArr.length <= 1 || objArr[1] == Undefined.instance) {
            NativeRegExp nativeRegExp = objArr[0];
            this.f8491re = nativeRegExp.f8491re;
    ...
    public String toString() {
        ...
        if (this.f8491re.source.length != 0) {
            sb.append(this.f8491re.source);
        } else {
            sb.append("(?:)");
        }
        sb.append(IOUtils.DIR_SEPARATOR_UNIX);
        if ((this.f8491re.flags & 1) != 0) {
            sb.append('g');
        }
        if ((this.f8491re.flags & 2) != 0) {
            sb.append('i');
        }
        if ((this.f8491re.flags & 4) != 0) {
            sb.append('m');
        }
        return sb.toString();
    }
    ...
    private Object execSub(Context context, Scriptable scriptable, Object[] objArr, int i) {
        ...
        String str2 = str;
        double d = 0.0d;
        double integer = (this.f8491re.flags & 1) != 0 ? ScriptRuntime.toInteger(this.lastIndex) : 0.0d;
        if (integer < 0.0d || ((double) str2.length()) < integer) {
            this.lastIndex = Double.valueOf(0.0d);
            return null;
        }
    ...
    static RECompiled compileRE(Context context, String str, String str2, boolean z) {
        ...
        if (b == 2) {
            ...
            if (rENode.kid.f8496op == 2 && rENode.kid2.f8496op == 2) {
                rECompiled.anchorCh = -2;
            }
        }
        return rECompiled;
    ...
    private static boolean parseDisjunction(CompilerState compilerState) {
        ...
        int i = compilerState.f8489cp;
        if (i != cArr.length && cArr[i] == '|') {
            compilerState.f8489cp++;
            ...
            if (rENode.kid.f8496op == 14 && rENode.kid2.f8496op == 14) {
                rENode.f8496op = (compilerState.flags & 2) == 0 ? REOP_ALTPREREQ : REOP_ALTPREREQi;
                rENode.chr = rENode.kid.chr;
                rENode.index = rENode.kid2.chr;
                compilerState.progLength += 13;
            } else if (rENode.kid.f8496op == 22 && rENode.kid.index < 256 && rENode.kid2.f8496op == 14 && (compilerState.flags & 2) == 0) {
                rENode.f8496op = REOP_ALTPREREQ2;
                rENode.chr = rENode.kid2.chr;
                rENode.index = rENode.kid.index;
                compilerState.progLength += 13;
            } else if (rENode.kid.f8496op == 14 && rENode.kid2.f8496op == 22 && rENode.kid2.index < 256 && (compilerState.flags & 2) == 0) {
                rENode.f8496op = REOP_ALTPREREQ2;
                rENode.chr = rENode.kid.chr;
    ...
    private static boolean parseAlternative(CompilerState compilerState) {
        ...
        RENode rENode = null;
        RENode rENode2 = null;
        while (compilerState.f8489cp != compilerState.cpend && cArr[compilerState.f8489cp] != '|' && (compilerState.parenNesting == 0 || cArr[compilerState.f8489cp] != ')')) {
    ...
    private static int getDecimalValue(char c, CompilerState compilerState, int i, String str) {
        int i2 = compilerState.f8489cp;
        char[] cArr = compilerState.cpbegin;
        int i3 = c - '0';
        boolean z = false;
        while (compilerState.f8489cp != compilerState.cpend) {
            char c2 = cArr[compilerState.f8489cp];
            if (!isDigit(c2)) {
                break;
            }
        ...
        if (z) {
            reportError(str, String.valueOf(cArr, i2, compilerState.f8489cp - i2));
        }
        return i3;
    }
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:199:0x017f, code lost:
        r4 = r4;
     */
    /* JADX WARNING: Multi-variable type inference failed */
    /* JADX WARNING: Removed duplicated region for block: B:181:0x03db  */
    /* JADX WARNING: Removed duplicated region for block: B:187:0x0425 A[RETURN] */
    /* JADX WARNING: Removed duplicated region for block: B:188:0x0426  */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    private static boolean parseTerm(org.mozilla.javascript.regexp.CompilerState r16) {
        ...
        L_0x00e8:
            ...
            r8 = 87
            r11 = 10
            if (r2 == r8) goto L_0x027e
            r8 = 102(0x66, float:1.43E-43)
            if (r2 == r8) goto L_0x0277
            r8 = 110(0x6e, float:1.54E-43)
            if (r2 == r8) goto L_0x0272
            r8 = 13
            ...
            switch(r2) {
                ...
                case 55: goto L_0x01e1;
                case 56: goto L_0x01e1;
                case 57: goto L_0x01e1;
                default: goto L_0x0119;
            }
        L_0x0119:
            switch(r2) {
                case 98: goto L_0x01d4;
        ...
        L_0x011c:
            ...
            switch(r2) {
                ...
                case 115: goto L_0x018c;
                case 116: goto L_0x0185;
                case 117: goto L_0x0155;
                case 118: goto L_0x0150;
        ...
        L_0x01e1:
            ...
            int r14 = r0.backReferenceLimit
            if (r9 <= r14) goto L_0x01f3
            org.mozilla.javascript.Context r14 = r0.f8490cx
            reportWarning(r14, r11, r12)
        L_0x01f3:
            int r11 = r0.backReferenceLimit
        ...
        L_0x022d:
            ...
            int r2 = r2 + r5
            r0.progLength = r2
            int r2 = r0.maxBackReference
            if (r2 >= r9) goto L_0x0345
            r0.maxBackReference = r9
            goto L_0x0345
        L_0x0247:
            org.mozilla.javascript.Context r2 = r0.f8490cx
        ...
        L_0x034e:
            ...
            r7 = 25
            r8 = 42
            if (r4 == r8) goto L_0x040c
            r8 = 43
            if (r4 == r8) goto L_0x03f5
            r8 = 63
            if (r4 == r8) goto L_0x03de
            r8 = 123(0x7b, float:1.72E-43)
            if (r4 == r8) goto L_0x0368
            r5 = 0
            goto L_0x0423
        L_0x0368:
            int r4 = r0.f8489cp
    ...
    private static int emitREBytecode(CompilerState compilerState, RECompiled rECompiled, int i, RENode rENode) {
        ...
        while (rENode != null) {
            int i3 = i + 1;
            bArr[i] = rENode.f8496op;
            byte b = rENode.f8496op;
            boolean z = true;
            if (b != 1) {
                if (b != 22) {
                    if (b == 25) {
                        ...
                        if (b != 31) {
                            if (b == 13) {
                                ...
                                if (rENode.flatIndex != -1) {
                                    while (rENode.next != null && rENode.next.f8496op == 14 && rENode.flatIndex + rENode.length == rENode.next.flatIndex) {
    ...
    private static void pushBackTrackState(REGlobalData rEGlobalData, byte b, int i) {
        REProgState rEProgState = rEGlobalData.stateStackTop;
        rEGlobalData.backTrackStackTop = new REBackTrackData(rEGlobalData, b, i, rEGlobalData.f8495cp, rEProgState.continuationOp, rEProgState.continuationPc);
    }
    ...
    private static boolean flatNMatcher(REGlobalData rEGlobalData, int i, int i2, String str, int i3) {
        if (rEGlobalData.f8495cp + i2 > i3) {
            return false;
        }
        for (int i4 = 0; i4 < i2; i4++) {
            if (rEGlobalData.regexp.source[i + i4] != str.charAt(rEGlobalData.f8495cp + i4)) {
                return false;
            }
        }
        rEGlobalData.f8495cp += i2;
        return true;
    }
    ...
    private static boolean flatNIMatcher(REGlobalData rEGlobalData, int i, int i2, String str, int i3) {
        ...
        for (int i4 = 0; i4 < i2; i4++) {
            char c = cArr[i + i4];
            char charAt = str.charAt(rEGlobalData.f8495cp + i4);
    ...
    private static boolean backrefMatcher(REGlobalData rEGlobalData, int i, String str, int i2) {
        ...
        if (rEGlobalData.f8495cp + parensLength > i2) {
            return false;
        }
        if ((rEGlobalData.regexp.flags & 2) != 0) {
            for (int i3 = 0; i3 < parensLength; i3++) {
                char charAt = str.charAt(parensIndex + i3);
                char charAt2 = str.charAt(rEGlobalData.f8495cp + i3);
                if (charAt != charAt2 && upcase(charAt) != upcase(charAt2)) {
                    return false;
                }
            }
        } else if (!str.regionMatches(parensIndex, str, rEGlobalData.f8495cp, parensLength)) {
            return false;
        }
        rEGlobalData.f8495cp += parensLength;
        return true;
    }
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:105:0x01f6, code lost:
        if (isLineTerm(r4.charAt(r3.f8495cp - 1)) == false) goto L_0x01fa;
     */
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:81:0x01a3, code lost:
        if (isWord(r4.charAt(r3.f8495cp)) != false) goto L_0x01cb;
     */
    /* JADX WARNING: Code restructure failed: missing block: B:91:0x01c9, code lost:
        if (isWord(r4.charAt(r3.f8495cp)) != false) goto L_0x01cc;
     */
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:99:0x01e0, code lost:
        if (isLineTerm(r4.charAt(r3.f8495cp)) == false) goto L_0x01fa;
     */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:178:0x03fa, code lost:
        pushProgState(r23, r12, r2, r7.f8495cp, (org.mozilla.javascript.regexp.REBackTrackData) null, r17, r16);
     */
    ...
    public java.lang.Object executeRegExp(org.mozilla.javascript.Context r17, org.mozilla.javascript.Scriptable r18, org.mozilla.javascript.regexp.RegExpImpl r19, java.lang.String r20, int[] r21, int r22) {
        ...
        L_0x0018:
            r13 = r2
        L_0x0019:
            org.mozilla.javascript.regexp.RECompiled r3 = r0.f8491re
        ...
        L_0x0058:
            org.mozilla.javascript.regexp.RECompiled r15 = r0.f8491re
        ...
        L_0x0065:
            ...
            r15 = 0
        L_0x006e:
            org.mozilla.javascript.regexp.RECompiled r11 = r0.f8491re
    ...
    public Object getInstanceIdValue(int i) {
        ...
        if (i == 2) {
            return new String(this.f8491re.source);
        }
        if (i == 3) {
            if ((this.f8491re.flags & 1) == 0) {
                z = false;
