...
public class NativeJavaMethod extends BaseFunction {
    ...
    static String scriptSignature(Object[] objArr) {
        ...
        for (int i = 0; i != objArr.length; i++) {
            ...
            if (wrapper == null) {
                ...
                str = wrapper instanceof Function ? "function" : "object";
            }
            if (i != 0) {
                sb.append(',');
            }
    ...
    public Object call(Context context, Scriptable scriptable, Scriptable scriptable2, Object[] objArr) {
        ...
        if (this.methods.length != 0) {
            ...
            throw Context.reportRuntimeError1("msg.java.no_such_method", declaringClass2.getName() + '.' + getFunctionName() + VersionRange.LEFT_OPEN + scriptSignature(objArr) + VersionRange.RIGHT_OPEN);
        }
