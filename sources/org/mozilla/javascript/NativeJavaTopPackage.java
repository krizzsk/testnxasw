...
public class NativeJavaTopPackage extends NativeJavaPackage implements Function, IdFunctionCall {
    ...
    private static final String[][] commonPackages = {new String[]{StringConst.JAVA, "lang", "reflect"}, new String[]{StringConst.JAVA, "io"}, new String[]{StringConst.JAVA, "math"}, new String[]{StringConst.JAVA, "net"}, new String[]{StringConst.JAVA, "util", DownloadManager.MODULE_DIR_ZIP}, new String[]{StringConst.JAVA, "text", "resources"}, new String[]{StringConst.JAVA, "applet"}, new String[]{"javax", "swing"}};
