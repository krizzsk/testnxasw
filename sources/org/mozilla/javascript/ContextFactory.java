...
public class ContextFactory {
    ...
    public static ContextFactory f62460global = new ContextFactory();
            ...
            if (!hasCustomGlobal) {
                ...
                r1 = new GlobalSetter() {
                    public void setContextFactoryGlobal(ContextFactory contextFactory) {
                        ...
                        ContextFactory unused = ContextFactory.f62460global = contextFactory;
                    }

                    public ContextFactory getContextFactoryGlobal() {
                        return ContextFactory.f62460global;
                    }
                };
            } else {
                throw new IllegalStateException();
