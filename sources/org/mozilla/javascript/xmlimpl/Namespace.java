...
class Namespace extends IdScriptableObject {
    ...
    /* renamed from: ns */
    private XmlNode.Namespace f8519ns;
    ...
    public String uri() {
        return this.f8519ns.getUri();
    }

    public String prefix() {
        return this.f8519ns.getPrefix();
    }
    ...
    public String getInstanceIdName(int i) {
        ...
        if (maxInstanceId != 1) {
            return maxInstanceId != 2 ? super.getInstanceIdName(i) : ShareConstants.MEDIA_URI;
        }
        return "prefix";
    }
    ...
    public Object getInstanceIdValue(int i) {
        ...
        if (maxInstanceId != 1) {
            ...
            return this.f8519ns.getUri();
        } else if (this.f8519ns.getPrefix() == null) {
    ...
    private String js_toSource() {
        ...
        toSourceImpl(this.f8519ns.getPrefix(), this.f8519ns.getUri(), sb);
