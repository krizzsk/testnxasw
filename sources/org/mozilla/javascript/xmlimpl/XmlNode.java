...
class XmlNode implements Serializable {
    ...
    public void removeNamespace(Namespace namespace) {
        if (!namespace.mo41420is(getNodeNamespace())) {
            NamedNodeMap attributes = this.dom.getAttributes();
            int i = 0;
            while (i < attributes.getLength()) {
                if (!namespace.mo41420is(createImpl(attributes.item(i)).getNodeNamespace())) {
                    i++;
                } else {
                    return;
                }
    ...
    static class Namespace implements Serializable {
        ...
        public String toString() {
            if (this.prefix == null) {
                return "XmlNode.Namespace [" + this.uri + Const.jaRight;
            }
            return "XmlNode.Namespace [" + this.prefix + Const.joLeft + this.uri + "}]";
        }
        ...
        public boolean mo41420is(org.mozilla.javascript.xmlimpl.XmlNode.Namespace r3) {
            /*
                r2 = this;
            ...
            L_0x001b:
                return r3
            */
            throw new UnsupportedOperationException("Method not decompiled: org.mozilla.javascript.xmlimpl.XmlNode.Namespace.mo41420is(org.mozilla.javascript.xmlimpl.XmlNode$Namespace):boolean");
        }
    ...
    static class QName implements Serializable {
        ...
        public String toString() {
            return "XmlNode.QName [" + this.localName + "," + this.namespace + Const.jaRight;
        }
