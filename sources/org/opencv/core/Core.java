...
public class Core {
    ...
    public static MinMaxLocResult minMaxLoc(Mat mat, Mat mat2) {
        ...
        minMaxLocResult.minLoc.f8521x = n_minMaxLocManual[2];
        minMaxLocResult.minLoc.f8522y = n_minMaxLocManual[3];
        minMaxLocResult.maxLoc.f8521x = n_minMaxLocManual[4];
        minMaxLocResult.maxLoc.f8522y = n_minMaxLocManual[5];
