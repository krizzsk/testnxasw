...
public class Subdiv2D {
    ...
    public Subdiv2D(Rect rect) {
        this.nativeObj = Subdiv2D_0(rect.f8526x, rect.f8527y, rect.width, rect.height);
    }
    ...
    public int findNearest(Point point, Point point2) {
        double[] dArr = new double[2];
        int findNearest_0 = findNearest_0(this.nativeObj, point.f8521x, point.f8522y, dArr);
        if (point2 != null) {
            point2.f8521x = dArr[0];
            point2.f8522y = dArr[1];
        }
        return findNearest_0;
    }

    public int findNearest(Point point) {
        return findNearest_1(this.nativeObj, point.f8521x, point.f8522y);
    }
    ...
    public int insert(Point point) {
        return insert_0(this.nativeObj, point.f8521x, point.f8522y);
    }

    public int locate(Point point, int[] iArr, int[] iArr2) {
        double[] dArr = new double[1];
        double[] dArr2 = new double[1];
        int locate_0 = locate_0(this.nativeObj, point.f8521x, point.f8522y, dArr, dArr2);
        if (iArr != null) {
            iArr[0] = (int) dArr[0];
        }
        if (iArr2 != null) {
    ...
    public void initDelaunay(Rect rect) {
        initDelaunay_0(this.nativeObj, rect.f8526x, rect.f8527y, rect.width, rect.height);
    }
