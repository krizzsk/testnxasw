...
public class Converters {
    ...
    public static Mat vector_Point_to_Mat(List<Point> list, int i) {
        ...
        if (i == 4) {
            ...
            for (int i3 = 0; i3 < i2; i3++) {
                ...
                int i4 = i3 * 2;
                iArr[i4] = (int) point.f8521x;
                iArr[i4 + 1] = (int) point.f8522y;
            }
            mat.put(0, 0, iArr);
            return mat;
        } else if (i == 5) {
            ...
            for (int i5 = 0; i5 < i2; i5++) {
                ...
                int i6 = i5 * 2;
                fArr[i6] = (float) point2.f8521x;
                fArr[i6 + 1] = (float) point2.f8522y;
            }
            mat2.put(0, 0, fArr);
            return mat2;
        } else if (i == 6) {
            ...
            for (int i7 = 0; i7 < i2; i7++) {
                ...
                int i8 = i7 * 2;
                dArr[i8] = point3.f8521x;
                dArr[i8 + 1] = point3.f8522y;
            }
            mat3.put(0, 0, dArr);
            return mat3;
        } else {
    ...
    public static Mat vector_Point3_to_Mat(List<Point3> list, int i) {
        ...
        if (i == 4) {
            ...
            for (int i3 = 0; i3 < i2; i3++) {
                ...
                int i4 = i3 * 3;
                iArr[i4] = (int) point3.f8523x;
                iArr[i4 + 1] = (int) point3.f8524y;
                iArr[i4 + 2] = (int) point3.f8525z;
            }
            mat.put(0, 0, iArr);
            return mat;
        } else if (i == 5) {
            ...
            for (int i5 = 0; i5 < i2; i5++) {
                ...
                int i6 = i5 * 3;
                fArr[i6] = (float) point32.f8523x;
                fArr[i6 + 1] = (float) point32.f8524y;
                fArr[i6 + 2] = (float) point32.f8525z;
            }
            mat2.put(0, 0, fArr);
            return mat2;
        } else if (i == 6) {
            ...
            for (int i7 = 0; i7 < i2; i7++) {
                ...
                int i8 = i7 * 3;
                dArr[i8] = point33.f8523x;
                dArr[i8 + 1] = point33.f8524y;
                dArr[i8 + 2] = point33.f8525z;
            }
            mat3.put(0, 0, dArr);
            return mat3;
        } else {
        ...
        if (list != null) {
            ...
            if (CvType.CV_32SC2 == mat.type() && mat.cols() == 1) {
                ...
                for (int i = 0; i < rows; i++) {
                    int i2 = i * 2;
                    list.add(new Mat((((long) iArr[i2]) << 32) | (((long) iArr[i2 + 1]) & InternalZipConstants.ZIP_64_SIZE_LIMIT)));
                }
                return;
            }
    ...
    public static Mat vector_Rect2d_to_Mat(List<Rect2d> list) {
        ...
        for (int i = 0; i < size; i++) {
            ...
            int i2 = i * 4;
            dArr[i2] = rect2d.f8528x;
            dArr[i2 + 1] = rect2d.f8529y;
    ...
    public static Mat vector_KeyPoint_to_Mat(List<KeyPoint> list) {
        ...
        for (int i = 0; i < size; i++) {
            ...
            int i2 = i * 7;
            dArr[i2] = keyPoint.f8520pt.f8521x;
            dArr[i2 + 1] = keyPoint.f8520pt.f8522y;
