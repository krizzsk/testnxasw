...
public class EglRenderer implements VideoSink {
    ...
    private static class HandlerWithExceptionCallback extends Handler {
        ...
        public void dispatchMessage(Message message) {
            try {
                ...
                Logging.m7192e(EglRenderer.TAG, "Exception on EglRenderer thread", e);
    ...
    private void logE(String str, Throwable th) {
        Logging.m7192e(TAG, this.name + str, th);
    }

    private void logD(String str) {
        Logging.m7190d(TAG, this.name + str);
    }

    private void logW(String str) {
        Logging.m7194w(TAG, this.name + str);
    }
}
