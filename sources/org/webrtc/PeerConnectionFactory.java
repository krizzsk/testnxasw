...
public class PeerConnectionFactory {
    ...
    public static class Builder {
        ...
        public PeerConnectionFactory createPeerConnectionFactory() {
            ...
            if (mediaTransportFactoryFactory2 != null) {
                j3 = mediaTransportFactoryFactory2.createNativeMediaTransportFactory();
            }
    ...
    public static void initialize(InitializationOptions initializationOptions) {
        ...
        Logging.m7190d(TAG, "PeerConnectionFactory was initialized without an injected Loggable. Any existing Loggable will be deleted.");
    ...
    private static void printStackTrace(ThreadInfo threadInfo, boolean z) {
        if (threadInfo != null) {
            ...
            if (stackTrace.length > 0) {
                Logging.m7194w(TAG, name + " stacktrace:");
                for (StackTraceElement stackTraceElement : stackTrace) {
                    Logging.m7194w(TAG, stackTraceElement.toString());
                }
            }
            if (z) {
                Logging.m7194w(TAG, "*** *** *** *** *** *** *** *** *** *** *** *** *** *** *** ***");
                Logging.m7194w(TAG, "pid: " + Process.myPid() + ", tid: " + threadInfo.tid + ", name: " + name + "  >>> WebRTC <<<");
