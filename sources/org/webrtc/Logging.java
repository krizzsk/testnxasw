...
public class Logging {
    ...
    public static void log(Severity severity, String str, String str2) {
        ...
        if (str == null || str2 == null) {
            ...
            int i = C35261.$SwitchMap$org$webrtc$Logging$Severity[severity.ordinal()];
            if (i == 1) {
                level = Level.SEVERE;
            } else if (i == 2) {
                level = Level.WARNING;
    ...
    static /* synthetic */ class C35261 {
        ...
        static {
            ...
            L_0x0028:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: org.webrtc.Logging.C35261.<clinit>():void");
        }
    }

    /* renamed from: d */
    public static void m7190d(String str, String str2) {
        log(Severity.LS_INFO, str, str2);
    }

    /* renamed from: e */
    public static void m7191e(String str, String str2) {
        log(Severity.LS_ERROR, str, str2);
    }

    /* renamed from: w */
    public static void m7194w(String str, String str2) {
        log(Severity.LS_WARNING, str, str2);
    }

    /* renamed from: e */
    public static void m7192e(String str, String str2, Throwable th) {
        log(Severity.LS_ERROR, str, str2);
    ...
    /* renamed from: w */
    public static void m7195w(String str, String str2, Throwable th) {
        log(Severity.LS_WARNING, str, str2);
    ...
    /* renamed from: v */
    public static void m7193v(String str, String str2) {
