...
public class GlShader {
    ...
    private static int compileShader(int i, String str) {
        ...
        if (glCreateShader != 0) {
            ...
            Logging.m7191e(TAG, "Compile error " + GLES20.glGetShaderInfoLog(glCreateShader) + " in shader:\n" + str);
    ...
    public GlShader(String str, String str2) {
        ...
        if (glCreateProgram != 0) {
            ...
            Logging.m7191e(TAG, "Could not link program: " + GLES20.glGetProgramInfoLog(this.program));
    ...
    public void release() {
        Logging.m7190d(TAG, "Deleting shader.");
        int i = this.program;
        if (i != -1) {
