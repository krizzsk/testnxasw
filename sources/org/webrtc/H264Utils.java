...
class H264Utils {
    public static VideoCodecInfo DEFAULT_H264_BASELINE_PROFILE_CODEC = new VideoCodecInfo(RTCConsts.VIDEO_CODEC_H264, getDefaultH264Params(false));
    public static VideoCodecInfo DEFAULT_H264_HIGH_PROFILE_CODEC = new VideoCodecInfo(RTCConsts.VIDEO_CODEC_H264, getDefaultH264Params(true));
