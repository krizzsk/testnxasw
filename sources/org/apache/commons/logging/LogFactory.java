    ...
    private static Properties getProperties(URL url) {
        return (Properties) AccessController.doPrivileged(new PrivilegedAction(url) {
            ...
            /* JADX WARNING: Code restructure failed: missing block: B:38:0x0082, code lost:
                r2 = new java.lang.StringBuffer();
                r2.append("Unable to close stream for URL ");
                r2.append(r6.val$url);
            ...
            public java.lang.Object run() {
                /*
                    ...
                    r1 = 0
                    java.net.URL r2 = r6.val$url     // Catch:{ IOException -> 0x0045, all -> 0x0040 }
                ...
                L_0x0046:
                    ...
                    java.net.URL r4 = r6.val$url     // Catch:{ all -> 0x0075 }
                    r3.append(r4)     // Catch:{ all -> 0x0075 }
                    java.lang.String r3 = r3.toString()     // Catch:{ all -> 0x0075 }
                    org.apache.commons.logging.LogFactory.access$000(r3)     // Catch:{ all -> 0x0075 }
                L_0x0062:
                    if (r2 == 0) goto L_0x0074
                ...
                L_0x0096:
                    throw r1
                */
                throw new UnsupportedOperationException("Method not decompiled: org.apache.commons.logging.LogFactory.C30845.run():java.lang.Object");
            }
        });
    }
