...
public class MatchRatingApproachEncoder implements StringEncoder {
    private static final String[] DOUBLE_CONSONANT = {"BB", "CC", "DD", "FF", "GG", "HH", "JJ", "KK", "LL", "MM", "NN", "PP", WebConstant.QQ_PLATFORM, "RR", "SS", "TT", "VV", "WW", "XX", "YY", Address.ADDRESS_COUNTRY_NULL_PLACEHOLDER};
    ...
    public String removeVowels(String str) {
        ...
        return String.valueOf(substring) + replaceAll;
    }
}
