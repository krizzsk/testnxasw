...
public class EntityArrays {
    ...
    static {
        ...
        String[][] strArr3 = {new String[]{Const.jsQuote, "&quot;"}, new String[]{ParamKeys.SIGN_AND, "&amp;"}, new String[]{IMTextUtils.STREET_IMAGE_TAG_START, "&lt;"}, new String[]{IMTextUtils.STREET_IMAGE_TAG_END, "&gt;"}};
        BASIC_ESCAPE = strArr3;
        BASIC_UNESCAPE = invert(strArr3);
        String[][] strArr4 = {new String[]{"'", "&apos;"}};
        APOS_ESCAPE = strArr4;
        APOS_UNESCAPE = invert(strArr4);
        String[][] strArr5 = {new String[]{"\b", "\\b"}, new String[]{"\n", "\\n"}, new String[]{"\t", "\\t"}, new String[]{"\f", "\\f"}, new String[]{StringUtils.f7475CR, "\\r"}};
