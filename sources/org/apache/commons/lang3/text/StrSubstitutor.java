...
public class StrSubstitutor {
    ...
    public static final StrMatcher DEFAULT_PREFIX = StrMatcher.stringMatcher(NodeBuilderOld.PROPS_NATIVE_SPLIT_START);
                ...
                while (true) {
                    if (i11 >= i6) {
                        ...
                        if (isMatch3 == 0) {
                            ...
                            strMatcher2 = variableSuffixMatcher;
                            c = escapeChar2;
                            String str2 = new String(cArr, i10, (i11 - i5) - isMatch2);
                            ...
                            list2.add(str2);
                            String resolveVariable = resolveVariable(str2, strBuilder2, i5, i13);
                            if (resolveVariable != null) {
                                str = resolveVariable;
                            }
                            if (str != null) {
                                int length = str.length();
                                strBuilder2.replace(i5, i13, str);
