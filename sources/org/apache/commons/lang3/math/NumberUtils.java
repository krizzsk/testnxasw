...
public class NumberUtils {
    ...
    public static java.lang.Number createNumber(java.lang.String r14) throws java.lang.NumberFormatException {
        ...
        L_0x01dd:
            ...
            r3 = 1
        L_0x01ea:
            java.lang.Float r0 = createFloat(r14)     // Catch:{ NumberFormatException -> 0x0235 }
            java.lang.Double r1 = createDouble(r14)     // Catch:{ NumberFormatException -> 0x0235 }
            boolean r2 = r0.isInfinite()     // Catch:{ NumberFormatException -> 0x0235 }
            if (r2 != 0) goto L_0x0211
            float r2 = r0.floatValue()     // Catch:{ NumberFormatException -> 0x0235 }
            int r2 = (r2 > r11 ? 1 : (r2 == r11 ? 0 : -1))
            if (r2 != 0) goto L_0x0202
            if (r3 == 0) goto L_0x0211
        L_0x0202:
            java.lang.String r2 = r0.toString()     // Catch:{ NumberFormatException -> 0x0235 }
            java.lang.String r4 = r1.toString()     // Catch:{ NumberFormatException -> 0x0235 }
            boolean r2 = r2.equals(r4)     // Catch:{ NumberFormatException -> 0x0235 }
            if (r2 == 0) goto L_0x0211
            return r0
        L_0x0211:
            boolean r0 = r1.isInfinite()     // Catch:{ NumberFormatException -> 0x0235 }
            if (r0 != 0) goto L_0x0235
            double r4 = r1.doubleValue()     // Catch:{ NumberFormatException -> 0x0235 }
            int r0 = (r4 > r12 ? 1 : (r4 == r12 ? 0 : -1))
            if (r0 != 0) goto L_0x0221
            if (r3 == 0) goto L_0x0235
        L_0x0221:
            java.math.BigDecimal r0 = createBigDecimal(r14)     // Catch:{ NumberFormatException -> 0x0235 }
            double r2 = r1.doubleValue()     // Catch:{ NumberFormatException -> 0x0235 }
            java.math.BigDecimal r2 = java.math.BigDecimal.valueOf(r2)     // Catch:{ NumberFormatException -> 0x0235 }
            int r14 = r0.compareTo(r2)     // Catch:{ NumberFormatException -> 0x0235 }
