...
public class FastDateParser implements Serializable, DateParser {
    ...
    static final Locale JAPANESE_IMPERIAL = new Locale(RFLocale.JAPANESE, "JP", "JP");
    ...
    public String toString() {
        return "FastDateParser[" + this.pattern + "," + this.locale + "," + this.timeZone.getID() + Const.jaRight;
    }
    ...
    static class TimeZoneStrategy extends PatternStrategy {
        ...
        /* renamed from: ID */
        private static final int f7487ID = 0;
