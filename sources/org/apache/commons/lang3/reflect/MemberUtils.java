...
abstract class MemberUtils {
    ...
    static int compareConstructorFit(Constructor<?> constructor, Constructor<?> constructor2, Class<?>[] clsArr) {
        return compareParameterTypes(Executable.m7010of(constructor), Executable.m7010of(constructor2), clsArr);
    }

    static int compareMethodFit(Method method, Method method2, Class<?>[] clsArr) {
        return compareParameterTypes(Executable.m7011of(method), Executable.m7011of(method2), clsArr);
    }
    ...
    static boolean isMatchingMethod(Method method, Class<?>[] clsArr) {
        return isMatchingExecutable(Executable.m7011of(method), clsArr);
    }

    static boolean isMatchingConstructor(Constructor<?> constructor, Class<?>[] clsArr) {
        return isMatchingExecutable(Executable.m7010of(constructor), clsArr);
    }
    ...
    private static final class Executable {
        ...
        /* renamed from: of */
        public static Executable m7011of(Method method) {
            return new Executable(method);
        }

        /* access modifiers changed from: private */
        /* renamed from: of */
        public static Executable m7010of(Constructor<?> constructor) {
