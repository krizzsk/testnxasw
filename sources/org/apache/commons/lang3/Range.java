...
public final class Range<T> implements Serializable {
    ...
    /* renamed from: is */
    public static <T extends Comparable<T>> Range<T> m7008is(T t) {
        return between(t, t, (Comparator) null);
    }

    /* renamed from: is */
    public static <T> Range<T> m7009is(T t, Comparator<T> comparator2) {
    ...
    public String toString() {
        if (this.toString == null) {
            this.toString = Const.jaLeft + this.minimum + ".." + this.maximum + Const.jaRight;
        }
