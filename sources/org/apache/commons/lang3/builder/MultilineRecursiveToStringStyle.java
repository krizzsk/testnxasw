...
public class MultilineRecursiveToStringStyle extends RecursiveToStringStyle {
    ...
    private void resetIndent() {
        setArrayStart(Const.joLeft + System.lineSeparator() + spacer(this.spaces));
        setArraySeparator("," + System.lineSeparator() + spacer(this.spaces));
        setArrayEnd(System.lineSeparator() + spacer(this.spaces + -2) + "}");
        setContentStart(Const.jaLeft + System.lineSeparator() + spacer(this.spaces));
        setFieldSeparator("," + System.lineSeparator() + spacer(this.spaces));
        setContentEnd(System.lineSeparator() + spacer(this.spaces + -2) + Const.jaRight);
    }
