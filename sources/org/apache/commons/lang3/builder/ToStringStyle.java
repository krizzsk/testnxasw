...
public abstract class ToStringStyle implements Serializable {
    ...
    private String arrayStart = Const.joLeft;
    private String contentEnd = Const.jaRight;
    private String contentStart = Const.jaLeft;
    ...
    private String sizeEndText = IMTextUtils.STREET_IMAGE_TAG_END;
    private String sizeStartText = "<size=";
    private String summaryObjectEndText = IMTextUtils.STREET_IMAGE_TAG_END;
    private String summaryObjectStartText = IMTextUtils.STREET_IMAGE_TAG_START;
    ...
    private static final class MultiLineToStringStyle extends ToStringStyle {
        ...
        MultiLineToStringStyle() {
            setContentStart(Const.jaLeft);
            setFieldSeparator(System.lineSeparator() + "  ");
            setFieldSeparatorAtStart(true);
            setContentEnd(System.lineSeparator() + Const.jaRight);
        }
    ...
    private static final class JsonToStringStyle extends ToStringStyle {
        ...
        JsonToStringStyle() {
            setUseClassName(false);
            setUseIdentityHashCode(false);
            setContentStart(Const.joLeft);
            setContentEnd("}");
            setArrayStart(Const.jaLeft);
            setArrayEnd(Const.jaRight);
            setFieldSeparator(",");
