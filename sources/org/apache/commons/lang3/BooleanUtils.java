...
public class BooleanUtils {
    ...
    public static String toStringTrueFalse(Boolean bool) {
        return toString(bool, "true", SDKConsts.BOOLEAN_FALSE, (String) null);
    }
    ...
    public static String toStringTrueFalse(boolean z) {
        return toString(z, "true", SDKConsts.BOOLEAN_FALSE);
    }
    ...
    /* renamed from: or */
    public static boolean m7006or(boolean... zArr) {
        if (zArr == null) {
            throw new IllegalArgumentException("The Array must not be null");
        } else if (zArr.length != 0) {
            for (boolean z : zArr) {
    ...
    /* renamed from: or */
    public static Boolean m7005or(Boolean... boolArr) {
        if (boolArr == null) {
            throw new IllegalArgumentException("The Array must not be null");
        } else if (boolArr.length != 0) {
            try {
                return m7006or(ArrayUtils.toPrimitive(boolArr)) ? Boolean.TRUE : Boolean.FALSE;
            } catch (NullPointerException unused) {
                throw new IllegalArgumentException("The array must not contain any null elements");
            }
        } else {
