...
final class QrCodeScanFragment$initListener$2 implements View.OnClickListener {
    ...
    public final void onClick(View view) {
        ...
        if (this.this$0.f53931j) {
            DecoratedBarcodeView access$getBarCodeView$p = this.this$0.f53927f;
        ...
        DecoratedBarcodeView access$getBarCodeView$p2 = this.this$0.f53927f;
