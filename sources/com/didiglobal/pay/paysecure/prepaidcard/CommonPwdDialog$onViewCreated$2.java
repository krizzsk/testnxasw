...
final class CommonPwdDialog$onViewCreated$2 implements View.OnClickListener {
    final /* synthetic */ CommonPwdDialog this$0;

    CommonPwdDialog$onViewCreated$2(CommonPwdDialog commonPwdDialog) {
        this.this$0 = commonPwdDialog;
    }

    public final void onClick(View view) {
        AutoTrackHelper.trackViewOnClick(view);
        this.this$0.f52865b = 3;
        this.this$0.dismiss();
        TrackerManager.Companion.trackInputCardPwdClick("cancel");
    }
}
