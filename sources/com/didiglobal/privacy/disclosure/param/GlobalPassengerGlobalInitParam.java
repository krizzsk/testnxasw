...
public abstract class GlobalPassengerGlobalInitParam extends BasePrivacyDisclosureInitParam {
    ...
    public int getPositiveBtnResInt() {
        return R.drawable.global_privacy_btn_disclosure_positive_passenger_global_selector;
    }
}
