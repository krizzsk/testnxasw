...
/* renamed from: com.didiglobal.sa.biz.util.GsonUtils */
public class GsonUtils {

    /* renamed from: a */
    private static final Gson f53802a;

    /* renamed from: com.didiglobal.sa.biz.util.GsonUtils$OnFromJsonListener */
    ...
    static {
        ...
        f53802a = gsonBuilder.setPrettyPrinting().create();
    }
    ...
    public static <T> T fromJson(String str, Type type) {
        ...
        try {
            return f53802a.fromJson(str, type);
