...
@Metadata(mo148867d1 = {"\u0000,\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0003\n\u0002\u0010\u000e\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\b\u0007\u0018\u0000 \u000e2\n\u0012\u0006\u0012\u0004\u0018\u00010\u00020\u0001:\u0001\u000eB\u0005¢\u0006\u0002\u0010\u0003J\u0010\u0010\u0004\u001a\u00020\u00022\u0006\u0010\u0005\u001a\u00020\u0006H\u0002J\u0012\u0010\u0007\u001a\u0004\u0018\u00010\u00022\u0006\u0010\b\u001a\u00020\tH\u0016J\u001a\u0010\n\u001a\u00020\u000b2\u0006\u0010\f\u001a\u00020\r2\b\u0010\u0005\u001a\u0004\u0018\u00010\u0002H\u0016¨\u0006\u000f"}, mo148868d2 = {"Lcom/didiglobal/ibg_rpc_service/internal/ObjectTypeAdapter;", "Lcom/google/gson/TypeAdapter;", "", "()V", "adaptNumber", "value", "", "read", "source", "Lcom/google/gson/stream/JsonReader;", "write", "", "out", "Lcom/google/gson/stream/JsonWriter;", "Companion", "ibg_rpc_service_release"}, mo148869k = 1, mo148870mv = {1, 5, 1}, mo148872xi = 48)
/* compiled from: ObjectTypeAdapter.kt */
public final class ObjectTypeAdapter extends TypeAdapter<Object> {
    public static final Companion Companion = new Companion((DefaultConstructorMarker) null);

    /* renamed from: a */
    private static final String f52763a = "ObjectTypeAdapter";
    /* access modifiers changed from: private */

    /* renamed from: b */
    public static final Lazy<Gson> f52764b = LazyKt.lazy(ObjectTypeAdapter$Companion$gson$2.INSTANCE);
    /* access modifiers changed from: private */

    /* renamed from: c */
    public static final Lazy<TypeAdapter<Object>> f52765c = LazyKt.lazy(ObjectTypeAdapter$Companion$objectTypeAdapter$2.INSTANCE);
    ...
    public java.lang.Object read(com.google.gson.stream.JsonReader r4) throws java.io.IOException {
        ...
        L_0x002c:
            ...
            java.lang.Object r4 = r3.m39617a(r4)
            goto L_0x0080
        L_0x003a:
            java.lang.String r4 = r4.nextString()
            goto L_0x0080
    ...
    /* renamed from: a */
    private final Object m39617a(String str) {
        long j;
        double d;
        boolean z = false;
        if (StringsKt.contains$default((CharSequence) str, (CharSequence) ".", false, 2, (Object) null)) {
            try {
                ...
                Logger.m39615e(f52763a, "adaptNumber", e);
                d = 0.0d;
            }
            j = Double.valueOf(d);
        } else {
            try {
                ...
                Logger.m39615e(f52763a, "adaptNumber", e2);
                j = 0L;
            }
        }
        Logger.m39616v(f52763a, Intrinsics.stringPlus("adaptNumber return ", j));
        return j;
    }
    ...
    @Metadata(mo148867d1 = {"\u0000\"\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0010\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0005\n\u0002\u0018\u0002\n\u0002\b\u0004\b\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002R\u000e\u0010\u0003\u001a\u00020\u0004XT¢\u0006\u0002\n\u0000R\u001b\u0010\u0005\u001a\u00020\u00068BX\u0002¢\u0006\f\n\u0004\b\t\u0010\n\u001a\u0004\b\u0007\u0010\bR#\u0010\u000b\u001a\n\u0012\u0006\u0012\u0004\u0018\u00010\u00010\f8BX\u0002¢\u0006\f\n\u0004\b\u000f\u0010\n\u001a\u0004\b\r\u0010\u000e¨\u0006\u0010"}, mo148868d2 = {"Lcom/didiglobal/ibg_rpc_service/internal/ObjectTypeAdapter$Companion;", "", "()V", "TAG", "", "gson", "Lcom/google/gson/Gson;", "getGson", "()Lcom/google/gson/Gson;", "gson$delegate", "Lkotlin/Lazy;", "objectTypeAdapter", "Lcom/google/gson/TypeAdapter;", "getObjectTypeAdapter", "()Lcom/google/gson/TypeAdapter;", "objectTypeAdapter$delegate", "ibg_rpc_service_release"}, mo148869k = 1, mo148870mv = {1, 5, 1}, mo148872xi = 48)
    /* compiled from: ObjectTypeAdapter.kt */
    public static final class Companion {
        ...
        public final Gson getGson() {
            return (Gson) ObjectTypeAdapter.f52764b.getValue();
        }

        /* access modifiers changed from: private */
        public final TypeAdapter<Object> getObjectTypeAdapter() {
            Object value = ObjectTypeAdapter.f52765c.getValue();
