package com.didiglobal.navtracker;

import com.taxis99.R;

/* renamed from: com.didiglobal.navtracker.R */
public final class C17734R {

    /* renamed from: com.didiglobal.navtracker.R$attr */
    public static final class attr {
        private attr() {
        }
    }

    /* renamed from: com.didiglobal.navtracker.R$bool */
    public static final class bool {
        private bool() {
        }
    }

    /* renamed from: com.didiglobal.navtracker.R$color */
    public static final class C17735color {
        private C17735color() {
        }
    }

    /* renamed from: com.didiglobal.navtracker.R$dimen */
    public static final class dimen {
        private dimen() {
        }
    }

    /* renamed from: com.didiglobal.navtracker.R$drawable */
    public static final class C17736drawable {
        private C17736drawable() {
        }
    }

    /* renamed from: com.didiglobal.navtracker.R$id */
    public static final class C17737id {
        private C17737id() {
        }
    }

    /* renamed from: com.didiglobal.navtracker.R$integer */
    public static final class integer {
        private integer() {
        }
    }

    /* renamed from: com.didiglobal.navtracker.R$layout */
    public static final class C17738layout {
        private C17738layout() {
        }
    }

    /* renamed from: com.didiglobal.navtracker.R$string */
    public static final class string {
        private string() {
        }
    }

    /* renamed from: com.didiglobal.navtracker.R$style */
    public static final class C17739style {
        private C17739style() {
        }
    }

    /* renamed from: com.didiglobal.navtracker.R$styleable */
