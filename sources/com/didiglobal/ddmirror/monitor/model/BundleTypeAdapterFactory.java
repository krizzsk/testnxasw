...
public class BundleTypeAdapterFactory implements TypeAdapterFactory {
    public <T> TypeAdapter<T> create(final Gson gson, TypeToken<T> typeToken) {
        ...
        return new TypeAdapter<Bundle>() {
            ...
            public Bundle read(JsonReader jsonReader) throws IOException {
                int i = C174952.$SwitchMap$com$google$gson$stream$JsonToken[jsonReader.peek().ordinal()];
                if (i == 1) {
                    jsonReader.nextNull();
                    return null;
                } else if (i == 2) {
    ...
    /* renamed from: com.didiglobal.ddmirror.monitor.model.BundleTypeAdapterFactory$2 */
    static /* synthetic */ class C174952 {
        ...
        static {
            ...
            L_0x0060:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.didiglobal.ddmirror.monitor.model.BundleTypeAdapterFactory.C174952.<clinit>():void");
        }
    }
}
