...
public class DittoLottieView extends LottieAnimationView implements IParser {
    public View getView() {
        return this;
    }

    public DittoLottieView(Context context) {
        super(context);
    }
    ...
    public void parse(java.lang.String r5, java.lang.String r6, com.facebook.yoga.YogaNode r7) {
        ...
        L_0x0060:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.didiglobal.dittoview.view.DittoLottieView.parse(java.lang.String, java.lang.String, com.facebook.yoga.YogaNode):void");
    }
