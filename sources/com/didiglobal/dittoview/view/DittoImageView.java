...
public class DittoImageView extends AppCompatImageView implements IParser {

    /* renamed from: a */
    private Context f52482a;
    ...
    public DittoImageView(Context context) {
    ...
    public DittoImageView(Context context, AttributeSet attributeSet, int i) {
    ...
    public void parse(java.lang.String r5, java.lang.String r6, com.facebook.yoga.YogaNode r7) {
        ...
        L_0x0099:
            boolean r5 = android.text.TextUtils.isEmpty(r6)
            if (r5 != 0) goto L_0x00b4
            android.content.Context r5 = r4.f52482a
            android.content.res.Resources r5 = r5.getResources()
            android.content.Context r7 = r4.f52482a
        ...
        L_0x00b4:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.didiglobal.dittoview.view.DittoImageView.parse(java.lang.String, java.lang.String, com.facebook.yoga.YogaNode):void");
    }
}
