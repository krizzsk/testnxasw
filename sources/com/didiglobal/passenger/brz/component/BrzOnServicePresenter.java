...
public class BrzOnServicePresenter extends OnServicePresenter {
    ...
    /* renamed from: r */
    private static final String f52808r = "1800";
    ...
    public void startCancelTrip(boolean z) {
        String buildUrl = GlobalWebUrl.buildUrl(m39633b(), createURLParams());
    ...
    public void buildInServiceNotification() {
        CarOrder order = CarOrderHelper.getOrder();
        if ((!m39632a(order) || !(order != null)) || order.endAddress == null) {
    ...
    /* renamed from: a */
    private boolean m39632a(CarOrder carOrder) {
        return carOrder != null && f52808r.equals(carOrder.carLevel);
    }
}
