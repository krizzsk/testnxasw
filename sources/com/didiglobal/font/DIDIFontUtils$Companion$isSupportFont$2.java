...
final class DIDIFontUtils$Companion$isSupportFont$2 extends Lambda implements Function0<Boolean> {
    public static final DIDIFontUtils$Companion$isSupportFont$2 INSTANCE = new DIDIFontUtils$Companion$isSupportFont$2();

    DIDIFontUtils$Companion$isSupportFont$2() {
        super(0);
    }
    ...
    public final Boolean invoke() {
        ...
        sb.append(iFontConfig.isSupport());
        SystemUtils.log(3, access$getTAG$cp, sb.toString(), (Throwable) null, "com.didiglobal.font.DIDIFontUtils$Companion$isSupportFont$2", 38);
