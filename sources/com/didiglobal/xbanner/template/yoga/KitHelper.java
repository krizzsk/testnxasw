...
public class KitHelper {
    ...
    /* renamed from: a */
    private static DocumentBuilderFactory f54062a = DocumentBuilderFactory.newInstance();
    ...
    public static Element parseXML(byte[] bArr) {
        try {
            return f54062a.newDocumentBuilder().parse(new ByteArrayInputStream(bArr), "UTF-8").getDocumentElement();
