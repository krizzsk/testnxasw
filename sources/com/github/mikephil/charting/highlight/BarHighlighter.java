...
public class BarHighlighter extends ChartHighlighter<BarDataProvider> {
    ...
    public Highlight getHighlight(float f, float f2) {
        ...
        if (iBarDataSet.isStacked()) {
            return getStackedHighlight(highlight, iBarDataSet, (float) valsForTouch.f55039x, (float) valsForTouch.f55040y);
        }
    ...
    public Highlight getStackedHighlight(Highlight highlight, IBarDataSet iBarDataSet, float f, float f2) {
        ...
        MPPointD pixelForValues = ((BarDataProvider) this.mChart).getTransformer(iBarDataSet.getAxisDependency()).getPixelForValues(highlight.getX(), ranges[closestStackIndex].f54972to);
        Highlight highlight2 = new Highlight(barEntry.getX(), barEntry.getY(), (float) pixelForValues.f55039x, (float) pixelForValues.f55040y, highlight.getDataSetIndex(), closestStackIndex, highlight.getAxis());
