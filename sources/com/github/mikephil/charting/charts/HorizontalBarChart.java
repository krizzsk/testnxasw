...
public class HorizontalBarChart extends BarChart {
    ...
    /* renamed from: a */
    private RectF f54795a = new RectF();
    ...
    public void calculateOffsets() {
        calculateLegendOffsets(this.f54795a);
        float f = this.f54795a.left + 0.0f;
        float f2 = this.f54795a.top + 0.0f;
        float f3 = this.f54795a.right + 0.0f;
        float f4 = this.f54795a.bottom + 0.0f;
        ...
        if (this.mLogEnabled) {
            SystemUtils.log(4, Chart.LOG_TAG, "offsetLeft: " + extraLeftOffset + ", offsetTop: " + extraTopOffset + ", offsetRight: " + extraRightOffset + ", offsetBottom: " + extraBottomOffset, (Throwable) null, "com.github.mikephil.charting.charts.HorizontalBarChart", 118);
            StringBuilder sb = new StringBuilder();
            sb.append("Content: ");
            sb.append(this.mViewPortHandler.getContentRect().toString());
            SystemUtils.log(4, Chart.LOG_TAG, sb.toString(), (Throwable) null, "com.github.mikephil.charting.charts.HorizontalBarChart", 121);
        }
        prepareOffsetMatrix();
    ...
    public Highlight getHighlightByTouchPoint(float f, float f2) {
        ...
        SystemUtils.log(6, Chart.LOG_TAG, "Can't select by touch. No data set.", (Throwable) null, "com.github.mikephil.charting.charts.HorizontalBarChart", 205);
        return null;
    }
    ...
    public float getLowestVisibleX() {
        ...
        return (float) Math.max((double) this.mXAxis.mAxisMinimum, this.posForGetLowestVisibleX.f55040y);
    }
    ...
    public float getHighestVisibleX() {
        ...
        return (float) Math.min((double) this.mXAxis.mAxisMaximum, this.posForGetHighestVisibleX.f55040y);
    }
