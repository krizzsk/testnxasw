...
public abstract class BarLineChartBase<T extends BarLineScatterCandleBubbleData<? extends IBarLineScatterCandleBubbleDataSet<? extends Entry>>> extends Chart<T> implements BarLineScatterCandleBubbleDataProvider {
    ...
    /* renamed from: a */
    private boolean f54772a = true;

    /* renamed from: b */
    private boolean f54773b = true;

    /* renamed from: c */
    private boolean f54774c = true;

    /* renamed from: d */
    private boolean f54775d = true;

    /* renamed from: e */
    private long f54776e = 0;

    /* renamed from: f */
    private long f54777f = 0;

    /* renamed from: g */
    private RectF f54778g = new RectF();

    /* renamed from: h */
    private boolean f54779h = false;
    ...
    public void onDraw(Canvas canvas) {
        ...
        if (this.mData != null) {
            ...
            if (this.mLogEnabled) {
                ...
                long j = this.f54776e + currentTimeMillis2;
                this.f54776e = j;
                long j2 = this.f54777f + 1;
                this.f54777f = j2;
                SystemUtils.log(4, Chart.LOG_TAG, "Drawtime: " + currentTimeMillis2 + " ms, average: " + (j / j2) + " ms, cycles: " + this.f54777f, (Throwable) null, "com.github.mikephil.charting.charts.BarLineChartBase", 292);
            }
        }
    }
    ...
    public void prepareValuePxMatrix() {
        if (this.mLogEnabled) {
            SystemUtils.log(4, Chart.LOG_TAG, "Preparing Value-Px Matrix, xmin: " + this.mXAxis.mAxisMinimum + ", xmax: " + this.mXAxis.mAxisMaximum + ", xdelta: " + this.mXAxis.mAxisRange, (Throwable) null, "com.github.mikephil.charting.charts.BarLineChartBase", 308);
        }
    ...
    public void notifyDataSetChanged() {
        if (this.mData != null) {
            if (this.mLogEnabled) {
                SystemUtils.log(4, Chart.LOG_TAG, "Preparing...", (Throwable) null, "com.github.mikephil.charting.charts.BarLineChartBase", 336);
            }
            ...
            SystemUtils.log(4, Chart.LOG_TAG, "Preparing... DATA NOT SET.", (Throwable) null, "com.github.mikephil.charting.charts.BarLineChartBase", 332);
        }
    }
    ...
    public void calculateLegendOffsets(RectF rectF) {
        ...
        if (this.mLegend != null && this.mLegend.isEnabled() && !this.mLegend.isDrawInsideEnabled()) {
            int i = C186442.f54781x9c9dbef[this.mLegend.getOrientation().ordinal()];
            if (i == 1) {
                int i2 = C186442.f54780x2787f53e[this.mLegend.getHorizontalAlignment().ordinal()];
                if (i2 == 1) {
                    ...
                    int i3 = C186442.f54782xc926f1ec[this.mLegend.getVerticalAlignment().ordinal()];
                    if (i3 == 1) {
                ...
                int i4 = C186442.f54782xc926f1ec[this.mLegend.getVerticalAlignment().ordinal()];
                if (i4 == 1) {
                    rectF.top += Math.min(this.mLegend.mNeededHeight, this.mViewPortHandler.getChartHeight() * this.mLegend.getMaxSizePercent()) + this.mLegend.getYOffset();
                } else if (i4 == 2) {
                    rectF.bottom += Math.min(this.mLegend.mNeededHeight, this.mViewPortHandler.getChartHeight() * this.mLegend.getMaxSizePercent()) + this.mLegend.getYOffset();
    ...
    static /* synthetic */ class C186442 {
        ...
        static {
            ...
            L_0x0012:
                r0 = 2
                int[] r2 = f54781x9c9dbef     // Catch:{ NoSuchFieldError -> 0x001d }
            ...
            L_0x002e:
                int[] r2 = f54780x2787f53e     // Catch:{ NoSuchFieldError -> 0x0038 }
            ...
            L_0x0038:
                int[] r2 = f54780x2787f53e     // Catch:{ NoSuchFieldError -> 0x0043 }
            ...
            L_0x0054:
                int[] r1 = f54782xc926f1ec     // Catch:{ NoSuchFieldError -> 0x005e }
            ...
            L_0x005e:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.github.mikephil.charting.charts.BarLineChartBase.C186442.<clinit>():void");
        }
    }

    public void calculateOffsets() {
        if (!this.f54779h) {
            calculateLegendOffsets(this.f54778g);
            float f = this.f54778g.left + 0.0f;
            float f2 = this.f54778g.top + 0.0f;
            float f3 = this.f54778g.right + 0.0f;
            float f4 = this.f54778g.bottom + 0.0f;
            ...
            if (this.mLogEnabled) {
                SystemUtils.log(4, Chart.LOG_TAG, "offsetLeft: " + extraLeftOffset + ", offsetTop: " + extraTopOffset + ", offsetRight: " + extraRightOffset + ", offsetBottom: " + extraBottomOffset, (Throwable) null, "com.github.mikephil.charting.charts.BarLineChartBase", 521);
                StringBuilder sb = new StringBuilder();
                sb.append("Content: ");
                sb.append(this.mViewPortHandler.getContentRect().toString());
                SystemUtils.log(4, Chart.LOG_TAG, sb.toString(), (Throwable) null, "com.github.mikephil.charting.charts.BarLineChartBase", 523);
            }
        }
        prepareOffsetMatrix();
    ...
    public void zoomIn() {
        ...
        this.mViewPortHandler.zoomIn(contentCenter.f55042x, -contentCenter.f55043y, this.mZoomMatrixBuffer);
    ...
    public void zoomOut() {
        MPPointF contentCenter = this.mViewPortHandler.getContentCenter();
        this.mViewPortHandler.zoomOut(contentCenter.f55042x, -contentCenter.f55043y, this.mZoomMatrixBuffer);
        this.mViewPortHandler.refresh(this.mZoomMatrixBuffer, this, false);
        MPPointF.recycleInstance(contentCenter);
        calculateOffsets();
        postInvalidate();
    ...
    public void zoomToCenter(float f, float f2) {
        ...
        this.mViewPortHandler.zoom(f, f2, centerOffsets.f55042x, -centerOffsets.f55043y, matrix);
    ...
    public void zoomAndCenterAnimated(float f, float f2, float f3, float f4, YAxis.AxisDependency axisDependency, long j) {
        ...
        addViewportJob(AnimatedZoomJob.getInstance(this.mViewPortHandler, this, getTransformer(axisDependency2), getAxis(axisDependency2), this.mXAxis.mAxisRange, f, f2, this.mViewPortHandler.getScaleX(), this.mViewPortHandler.getScaleY(), f3, f4, (float) valuesByTouchPoint.f55039x, (float) valuesByTouchPoint.f55040y, j));
    ...
    public void moveViewToAnimated(float f, float f2, YAxis.AxisDependency axisDependency, long j) {
        ...
        addViewportJob(AnimatedMoveViewJob.getInstance(this.mViewPortHandler, f, f2 + (axisRange / 2.0f), getTransformer(axisDependency), this, (float) valuesByTouchPoint.f55039x, (float) valuesByTouchPoint.f55040y, j));
        MPPointD.recycleInstance(valuesByTouchPoint);
    }
    ...
    public void centerViewToAnimated(float f, float f2, YAxis.AxisDependency axisDependency, long j) {
        ...
        addViewportJob(AnimatedMoveViewJob.getInstance(this.mViewPortHandler, f - (scaleX / 2.0f), f2 + (axisRange / 2.0f), getTransformer(axisDependency), this, (float) valuesByTouchPoint.f55039x, (float) valuesByTouchPoint.f55040y, j));
        MPPointD.recycleInstance(valuesByTouchPoint);
    }
    ...
    public float getLowestVisibleX() {
        ...
        return (float) Math.max((double) this.mXAxis.mAxisMinimum, this.posForGetLowestVisibleX.f55039x);
    }
    ...
    public float getHighestVisibleX() {
        ...
        return (float) Math.min((double) this.mXAxis.mAxisMaximum, this.posForGetHighestVisibleX.f55039x);
    }
