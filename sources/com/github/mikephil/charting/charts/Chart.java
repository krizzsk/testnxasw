...
public abstract class Chart<T extends ChartData<? extends IDataSet<? extends Entry>>> extends ViewGroup implements ChartInterface {
    ...
    /* renamed from: a */
    private boolean f54783a = true;

    /* renamed from: b */
    private float f54784b = 0.9f;

    /* renamed from: c */
    private String f54785c = "No chart data available.";

    /* renamed from: d */
    private OnChartGestureListener f54786d;

    /* renamed from: e */
    private float f54787e = 0.0f;

    /* renamed from: f */
    private float f54788f = 0.0f;
    ...
    /* renamed from: i */
    private boolean f54791i = false;

    /* renamed from: j */
    private boolean f54792j = false;
    ...
    public void init() {
        ...
        if (this.mLogEnabled) {
            SystemUtils.log(4, "", "Chart.init()", (Throwable) null, "com.github.mikephil.charting.charts.Chart", 239);
        }
    }
    ...
    public void setData(T t) {
        ...
        if (t != null) {
            ...
            if (this.mLogEnabled) {
                SystemUtils.log(4, LOG_TAG, "Data is set.", (Throwable) null, "com.github.mikephil.charting.charts.Chart", 303);
            }
        }
    }
    ...
    public void onDraw(Canvas canvas) {
        if (this.mData == null) {
            if (!TextUtils.isEmpty(this.f54785c)) {
                MPPointF center = getCenter();
                canvas.drawText(this.f54785c, center.f55042x, center.f55043y, this.mInfoPaint);
            }
        } else if (!this.f54791i) {
            calculateOffsets();
            this.f54791i = true;
        }
    }
    ...
    public void highlightValue(Highlight highlight, boolean z) {
        ...
        if (highlight == null) {
            ...
            if (this.mLogEnabled) {
                SystemUtils.log(4, LOG_TAG, "Highlighted: " + highlight.toString(), (Throwable) null, "com.github.mikephil.charting.charts.Chart", 629);
            }
    ...
    public Highlight getHighlightByTouchPoint(float f, float f2) {
        ...
        SystemUtils.log(6, LOG_TAG, "Can't select by touch. No data set.", (Throwable) null, "com.github.mikephil.charting.charts.Chart", 672);
        return null;
    }
    ...
    public void setOnChartGestureListener(OnChartGestureListener onChartGestureListener) {
        this.f54786d = onChartGestureListener;
    }
    ...
    public void setExtraTopOffset(float f) {
        this.f54787e = Utils.convertDpToPixel(f);
    }
    ...
    public void setExtraRightOffset(float f) {
        this.f54788f = Utils.convertDpToPixel(f);
    }
    ...
    public void setExtraBottomOffset(float f) {
        this.f54789g = Utils.convertDpToPixel(f);
    }
    ...
    public void setExtraLeftOffset(float f) {
        this.f54790h = Utils.convertDpToPixel(f);
    }
    ...
    public boolean saveToPath(String str, String str2) {
        ...
        try {
            FileOutputStream fileOutputStream = new FileOutputStream(SystemUtils.getExternalStorageDirectory().getPath() + str2 + "/" + str + IMPictureMimeType.PNG);
    ...
    public boolean saveToGallery(String str, String str2, String str3, Bitmap.CompressFormat compressFormat, int i) {
        ...
        int i2 = C186462.$SwitchMap$android$graphics$Bitmap$CompressFormat[compressFormat.ordinal()];
        ...
        } else if (!str.endsWith(IMPictureMimeType.PNG)) {
            str = str + IMPictureMimeType.PNG;
        }
        ...
        try {
            ...
            contentValues.put(OptionsBridge.ORIENTATION_KEY, 0);
    ...
    static /* synthetic */ class C186462 {
        ...
        static {
            ...
            L_0x0028:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.github.mikephil.charting.charts.Chart.C186462.<clinit>():void");
        }
    }
    ...
    public void onSizeChanged(int i, int i2, int i3, int i4) {
        if (this.mLogEnabled) {
            SystemUtils.log(4, LOG_TAG, "OnSizeChanged()", (Throwable) null, "com.github.mikephil.charting.charts.Chart", 1664);
        }
        if (i > 0 && i2 > 0 && i < 10000 && i2 < 10000) {
            if (this.mLogEnabled) {
                SystemUtils.log(4, LOG_TAG, "Setting chart dimens, width: " + i + ", height: " + i2, (Throwable) null, "com.github.mikephil.charting.charts.Chart", 1668);
            }
            this.mViewPortHandler.setChartDimens((float) i, (float) i2);
        } else if (this.mLogEnabled) {
            SystemUtils.log(5, LOG_TAG, "*Avoiding* setting chart dimens! width: " + i + ", height: " + i2, (Throwable) null, "com.github.mikephil.charting.charts.Chart", 1672);
        }
        notifyDataSetChanged();
    ...
    /* renamed from: a */
    private void m40686a(View view) {
        ...
        if (view instanceof ViewGroup) {
            ...
            while (true) {
                ...
                if (i < viewGroup.getChildCount()) {
                    m40686a(viewGroup.getChildAt(i));
                    i++;
                } else {
