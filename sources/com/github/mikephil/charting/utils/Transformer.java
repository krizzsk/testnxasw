...
public class Transformer {
    ...
    /* renamed from: a */
    float[] f55051a = new float[2];

    /* renamed from: b */
    private Matrix f55052b = new Matrix();

    /* renamed from: c */
    private Matrix f55053c = new Matrix();
    ...
    public void getValuesByTouchPoint(float f, float f2, MPPointD mPPointD) {
        float[] fArr = this.f55051a;
        fArr[0] = f;
        fArr[1] = f2;
        pixelsToValue(fArr);
        mPPointD.f55039x = (double) this.f55051a[0];
        mPPointD.f55040y = (double) this.f55051a[1];
    }
    ...
    public Matrix getValueToPixelMatrix() {
        this.f55052b.set(this.mMatrixValueToPx);
        this.f55052b.postConcat(this.mViewPortHandler.mMatrixTouch);
        this.f55052b.postConcat(this.mMatrixOffset);
        return this.f55052b;
    }

    public Matrix getPixelToValueMatrix() {
        getValueToPixelMatrix().invert(this.f55053c);
        return this.f55053c;
    }
}
