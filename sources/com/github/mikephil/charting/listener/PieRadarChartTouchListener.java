...
public class PieRadarChartTouchListener extends ChartTouchListener<PieRadarChartBase<?>> {
    ...
    /* renamed from: a */
    private MPPointF f54991a = MPPointF.getInstance(0.0f, 0.0f);

    /* renamed from: b */
    private float f54992b = 0.0f;

    /* renamed from: c */
    private ArrayList<AngularVelocitySample> f54993c = new ArrayList<>();

    /* renamed from: d */
    private long f54994d = 0;

    /* renamed from: e */
    private float f54995e = 0.0f;
    ...
    public boolean onTouch(View view, MotionEvent motionEvent) {
        if (!this.mGestureDetector.onTouchEvent(motionEvent) && ((PieRadarChartBase) this.mChart).isRotationEnabled()) {
            ...
            if (action == 0) {
                ...
                this.f54991a.f55042x = x;
                this.f54991a.f55043y = y;
            } else if (action == 1) {
                if (((PieRadarChartBase) this.mChart).isDragDecelerationEnabled()) {
                    stopDeceleration();
                    m40707a(x, y);
                    ...
                    this.f54995e = b;
                    if (b != 0.0f) {
                        this.f54994d = AnimationUtils.currentAnimationTimeMillis();
                ...
                if (this.mTouchMode == 0 && distance(x, this.f54991a.f55042x, y, this.f54991a.f55043y) > Utils.convertDpToPixel(8.0f)) {
    ...
    /* renamed from: a */
    private void m40706a() {
        this.f54993c.clear();
    }

    /* renamed from: a */
    private void m40707a(float f, float f2) {
        long currentAnimationTimeMillis = AnimationUtils.currentAnimationTimeMillis();
        this.f54993c.add(new AngularVelocitySample(currentAnimationTimeMillis, ((PieRadarChartBase) this.mChart).getAngleForPoint(f, f2)));
        for (int size = this.f54993c.size(); size - 2 > 0 && currentAnimationTimeMillis - this.f54993c.get(0).time > 1000; size--) {
            this.f54993c.remove(0);
        }
    }

    /* renamed from: b */
    private float m40708b() {
        if (this.f54993c.isEmpty()) {
            return 0.0f;
        }
        boolean z = false;
        AngularVelocitySample angularVelocitySample = this.f54993c.get(0);
        ArrayList<AngularVelocitySample> arrayList = this.f54993c;
        AngularVelocitySample angularVelocitySample2 = arrayList.get(arrayList.size() - 1);
        AngularVelocitySample angularVelocitySample3 = angularVelocitySample;
        for (int size = this.f54993c.size() - 1; size >= 0; size--) {
            angularVelocitySample3 = this.f54993c.get(size);
    ...
    public void setGestureStartAngle(float f, float f2) {
        this.f54992b = ((PieRadarChartBase) this.mChart).getAngleForPoint(f, f2) - ((PieRadarChartBase) this.mChart).getRawRotationAngle();
    }

    public void updateGestureRotation(float f, float f2) {
        ((PieRadarChartBase) this.mChart).setRotationAngle(((PieRadarChartBase) this.mChart).getAngleForPoint(f, f2) - this.f54992b);
    }
    ...
    public void computeScroll() {
        if (this.f54995e != 0.0f) {
            long currentAnimationTimeMillis = AnimationUtils.currentAnimationTimeMillis();
            this.f54995e *= ((PieRadarChartBase) this.mChart).getDragDecelerationFrictionCoef();
            ((PieRadarChartBase) this.mChart).setRotationAngle(((PieRadarChartBase) this.mChart).getRotationAngle() + (this.f54995e * (((float) (currentAnimationTimeMillis - this.f54994d)) / 1000.0f)));
            this.f54994d = currentAnimationTimeMillis;
            if (((double) Math.abs(this.f54995e)) >= 0.001d) {
                Utils.postInvalidateOnAnimation(this.mChart);
            } else {
                stopDeceleration();
            }
