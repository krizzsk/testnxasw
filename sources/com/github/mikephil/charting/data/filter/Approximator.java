...
public class Approximator {
    public float[] reduceWithDouglasPeucker(float[] fArr, float f) {
        ...
        return mo138465a(reduceWithDouglasPeucker, Arrays.copyOfRange(reduceWithDouglasPeucker2, 2, reduceWithDouglasPeucker2.length));
    }

    /* access modifiers changed from: package-private */
    /* renamed from: a */
    public float[] mo138465a(float[]... fArr) {
        int i = 0;
    ...
    private class Line {
        ...
        /* renamed from: dx */
        private float f54950dx;

        /* renamed from: dy */
        private float f54951dy;
        private float exsy;
        ...
        public float distance(float f, float f2) {
            return Math.abs((((this.f54951dy * f) - (this.f54950dx * f2)) + this.sxey) - this.exsy) / this.length;
        }
