...
public class ScatterDataSet extends LineScatterCandleRadarDataSet<Entry> implements IScatterDataSet {
    ...
    /* renamed from: a */
    private float f54946a = 15.0f;

    /* renamed from: b */
    private float f54947b = 0.0f;

    /* renamed from: c */
    private int f54948c = ColorTemplate.COLOR_NONE;
    ...
    public void copy(ScatterDataSet scatterDataSet) {
        ...
        scatterDataSet.f54946a = this.f54946a;
        scatterDataSet.mShapeRenderer = this.mShapeRenderer;
        scatterDataSet.f54947b = this.f54947b;
        scatterDataSet.f54948c = this.f54948c;
    }
    ...
    static /* synthetic */ class C186511 {
        ...
        static {
            ...
            L_0x0012:
                int[] r0 = f54949x9beb7303     // Catch:{ NoSuchFieldError -> 0x001d }
            ...
            L_0x001d:
                int[] r0 = f54949x9beb7303     // Catch:{ NoSuchFieldError -> 0x0028 }
            ...
            L_0x0028:
                int[] r0 = f54949x9beb7303     // Catch:{ NoSuchFieldError -> 0x0033 }
            ...
            L_0x0033:
                int[] r0 = f54949x9beb7303     // Catch:{ NoSuchFieldError -> 0x003e }
                com.github.mikephil.charting.charts.ScatterChart$ScatterShape r1 = com.github.mikephil.charting.charts.ScatterChart.ScatterShape.f54823X     // Catch:{ NoSuchFieldError -> 0x003e }
                int r1 = r1.ordinal()     // Catch:{ NoSuchFieldError -> 0x003e }
                r2 = 5
                r0[r1] = r2     // Catch:{ NoSuchFieldError -> 0x003e }
            L_0x003e:
                int[] r0 = f54949x9beb7303     // Catch:{ NoSuchFieldError -> 0x0049 }
            ...
            L_0x0049:
                int[] r0 = f54949x9beb7303     // Catch:{ NoSuchFieldError -> 0x0054 }
            ...
            L_0x0054:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.github.mikephil.charting.data.ScatterDataSet.C186511.<clinit>():void");
        }
    }

    public static IShapeRenderer getRendererForShape(ScatterChart.ScatterShape scatterShape) {
        switch (C186511.f54949x9beb7303[scatterShape.ordinal()]) {
            case 1:
