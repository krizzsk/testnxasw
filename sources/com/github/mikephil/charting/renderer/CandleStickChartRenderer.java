...
public class CandleStickChartRenderer extends LineScatterCandleRadarRenderer {
    ...
    /* renamed from: a */
    private float[] f55005a = new float[8];

    /* renamed from: b */
    private float[] f55006b = new float[4];

    /* renamed from: c */
    private float[] f55007c = new float[4];

    /* renamed from: d */
    private float[] f55008d = new float[4];

    /* renamed from: e */
    private float[] f55009e = new float[4];
        ...
        for (int i6 = this.mXBounds.min; i6 <= this.mXBounds.range + this.mXBounds.min; i6++) {
            ...
            if (candleEntry == null) {
                ...
                if (showCandleBar) {
                    ...
                    transformer.pointValuesToPixel(this.f55005a);
                    ...
                    canvas.drawLines(this.f55005a, this.mRenderPaint);
                    float[] fArr2 = this.f55006b;
                    ...
                    if (i7 > 0) {
                        ...
                        float[] fArr5 = this.f55006b;
                        canvas.drawLine(fArr5[0], fArr5[1], fArr5[2], fArr5[3], this.mRenderPaint);
                    }
                } else {
                    Canvas canvas3 = canvas;
                    float[] fArr6 = this.f55007c;
                    fArr6[0] = x;
                    fArr6[1] = high * phaseY;
                    fArr6[2] = x;
                    fArr6[3] = low * phaseY;
                    float[] fArr7 = this.f55008d;
                    fArr7[0] = (x - 0.5f) + barSpace;
                    float f = open * phaseY;
                    fArr7[1] = f;
                    fArr7[2] = x;
                    fArr7[3] = f;
                    float[] fArr8 = this.f55009e;
                    ...
                    transformer.pointValuesToPixel(this.f55008d);
                    transformer.pointValuesToPixel(this.f55009e);
                    if (open > close) {
                        if (iCandleDataSet.getDecreasingColor() == 1122867) {
                    ...
                    while (i2 < generateTransformedValuesCandle.length) {
                        ...
                        if (!this.mViewPortHandler.isInBoundsLeft(f2) || !this.mViewPortHandler.isInBoundsY(f3)) {
                            ...
                            if (iCandleDataSet2.isDrawValuesEnabled()) {
                                ...
                                iCandleDataSet = iCandleDataSet2;
                                drawValue(canvas, valueFormatter.getCandleLabel(candleEntry2), f2, f4, iCandleDataSet2.getValueTextColor(i3));
                            } else {
                                candleEntry = candleEntry2;
                                f = f3;
                                iCandleDataSet = iCandleDataSet2;
                            ...
                            if (candleEntry.getIcon() != null && iCandleDataSet.isDrawIconsEnabled()) {
                                ...
                                Utils.drawImage(canvas, icon, (int) (f2 + instance.f55042x), (int) (f + instance.f55043y), icon.getIntrinsicWidth(), icon.getIntrinsicHeight());
                            }
                        }
                        i2 += 2;
        ...
        for (Highlight highlight : highlightArr) {
            ...
            if (iCandleDataSet != null && iCandleDataSet.isHighlightEnabled()) {
                ...
                if (isInBoundsX(candleEntry, iCandleDataSet)) {
                    ...
                    drawHighlightLines(canvas, (float) pixelForValues.f55039x, (float) pixelForValues.f55040y, iCandleDataSet);
                }
            }
        }
    }
