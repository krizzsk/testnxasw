    ...
    public void drawDataSet(Canvas canvas, IScatterDataSet iScatterDataSet) {
        ...
        if (iScatterDataSet.getEntryCount() >= 1) {
            ...
            while (i2 < min) {
                ...
                this.f55030a[0] = entryForIndex.getX();
                this.f55030a[1] = entryForIndex.getY() * phaseY;
                transformer.pointValuesToPixel(this.f55030a);
                if (viewPortHandler.isInBoundsRight(this.f55030a[0])) {
                    if (!viewPortHandler.isInBoundsLeft(this.f55030a[0]) || !viewPortHandler.isInBoundsY(this.f55030a[1])) {
                        i = i2;
                    } else {
                        this.mRenderPaint.setColor(iScatterDataSet2.getColor(i2 / 2));
                        ViewPortHandler viewPortHandler2 = this.mViewPortHandler;
                        float[] fArr = this.f55030a;
                        i = i2;
                        ...
                        if (this.mViewPortHandler.isInBoundsLeft(generateTransformedValuesScatter[i2])) {
                            ...
                            if (this.mViewPortHandler.isInBoundsY(generateTransformedValuesScatter[i3])) {
                                ...
                                if (entry.getIcon() != null && iScatterDataSet.isDrawIconsEnabled()) {
                                    ...
                                    Utils.drawImage(canvas, icon, (int) (generateTransformedValuesScatter[i2] + instance.f55042x), (int) (generateTransformedValuesScatter[i3] + instance.f55043y), icon.getIntrinsicWidth(), icon.getIntrinsicHeight());
                                }
                                i2 += 2;
        ...
        for (Highlight highlight : highlightArr) {
            ...
            if (iScatterDataSet != null && iScatterDataSet.isHighlightEnabled()) {
                ...
                if (isInBoundsX(entryForXValue, iScatterDataSet)) {
                    ...
                    drawHighlightLines(canvas, (float) pixelForValues.f55039x, (float) pixelForValues.f55040y, iScatterDataSet);
                }
            }
        }
    }
