...
public class PieChartRenderer extends DataRenderer {
    ...
    /* renamed from: a */
    private TextPaint f55021a;

    /* renamed from: b */
    private Paint f55022b;

    /* renamed from: c */
    private StaticLayout f55023c;

    /* renamed from: d */
    private CharSequence f55024d;

    /* renamed from: e */
    private RectF f55025e = new RectF();

    /* renamed from: f */
    private RectF[] f55026f = {new RectF(), new RectF(), new RectF()};

    /* renamed from: g */
    private Path f55027g = new Path();

    /* renamed from: h */
    private RectF f55028h = new RectF();

    /* renamed from: i */
    private Path f55029i = new Path();
    ...
    public PieChartRenderer(PieChart pieChart, ChartAnimator chartAnimator, ViewPortHandler viewPortHandler) {
        ...
        this.f55021a = textPaint;
        textPaint.setColor(-16777216);
        this.f55021a.setTextSize(Utils.convertDpToPixel(12.0f));
        ...
        this.f55022b = paint3;
        paint3.setColor(-1);
        this.f55022b.setTextAlign(Paint.Align.CENTER);
        this.f55022b.setTextSize(Utils.convertDpToPixel(13.0f));
    ...
    public float calculateMinimumRadiusForSpacedSlice(MPPointF mPPointF, float f, float f2, float f3, float f4, float f5, float f6) {
        ...
        float cos = mPPointF2.f55042x + (((float) Math.cos(d)) * f);
        float sin = mPPointF2.f55043y + (((float) Math.sin(d)) * f);
        double d2 = (double) ((f5 + (f6 / 2.0f)) * 0.017453292f);
        return (float) (((double) (f - ((float) ((Math.sqrt(Math.pow((double) (cos - f3), 2.0d) + Math.pow((double) (sin - f4), 2.0d)) / 2.0d) * Math.tan(((180.0d - ((double) f2)) / 2.0d) * 0.017453292519943295d))))) - Math.sqrt(Math.pow((double) ((mPPointF2.f55042x + (((float) Math.cos(d2)) * f)) - ((cos + f3) / 2.0f)), 2.0d) + Math.pow((double) ((mPPointF2.f55043y + (((float) Math.sin(d2)) * f)) - ((sin + f4) / 2.0f)), 2.0d)));
    }
    ...
    public void drawDataSet(Canvas canvas, IPieDataSet iPieDataSet) {
        ...
        while (i9 < entryCount) {
            ...
            if (Math.abs(iPieDataSet2.getEntryForIndex(i9).getY()) > Utils.FLOAT_EPSILON && (!pieChartRenderer.mChart.needsHighlight(i9) || z2)) {
                ...
                pieChartRenderer.f55027g.reset();
                if (z2) {
                    ...
                    i = entryCount;
                    fArr = drawAngles;
                    float cos = centerCircleBox.f55042x + (((float) Math.cos(d)) * f16);
                    float sin = centerCircleBox.f55043y + (f16 * ((float) Math.sin(d)));
                ...
                f3 = rotationAngle;
                f2 = phaseX;
                float cos2 = centerCircleBox.f55042x + (((float) Math.cos(d2)) * radius);
                float sin2 = centerCircleBox.f55043y + (((float) Math.sin(d2)) * radius);
                int i10 = (f15 > 360.0f ? 1 : (f15 == 360.0f ? 0 : -1));
                if (i10 < 0 || f15 % 360.0f > Utils.FLOAT_EPSILON) {
                    if (z2) {
                        pieChartRenderer.f55027g.arcTo(rectF7, f14 + 180.0f, -180.0f);
                    }
                    pieChartRenderer.f55027g.arcTo(circleBox, f14, f15);
                } else {
                    pieChartRenderer.f55027g.addCircle(centerCircleBox.f55042x, centerCircleBox.f55043y, radius, Path.Direction.CW);
                }
                float f17 = f15;
                pieChartRenderer.f55028h.set(centerCircleBox.f55042x - holeRadius, centerCircleBox.f55043y - holeRadius, centerCircleBox.f55042x + holeRadius, centerCircleBox.f55043y + holeRadius);
                if (!z) {
                    f8 = holeRadius;
                    f9 = radius;
                    ...
                    if (z3) {
                        ...
                        float calculateMinimumRadiusForSpacedSlice = calculateMinimumRadiusForSpacedSlice(centerCircleBox, radius, f12 * phaseY, cos2, sin2, f18, f10);
                    ...
                    float f19 = (i3 == i6 || holeRadius == 0.0f) ? 0.0f : f / (holeRadius * 0.017453292f);
                    float f20 = f3 + ((f11 + (f19 / 2.0f)) * phaseY);
                    float f21 = (f12 - f19) * phaseY;
                    if (f21 < 0.0f) {
                        f21 = 0.0f;
                    }
                    float f22 = f20 + f21;
                    if (i10 < 0 || f10 % 360.0f > Utils.FLOAT_EPSILON) {
                        pieChartRenderer = this;
                        if (z2) {
                            float f23 = f4 - holeRadius2;
                            double d3 = (double) (f22 * 0.017453292f);
                            float cos3 = mPPointF2.f55042x + (((float) Math.cos(d3)) * f23);
                            float sin3 = mPPointF2.f55043y + (f23 * ((float) Math.sin(d3)));
                            rectF3 = rectF6;
                            rectF3.set(cos3 - holeRadius2, sin3 - holeRadius2, cos3 + holeRadius2, sin3 + holeRadius2);
                            pieChartRenderer.f55027g.arcTo(rectF3, f22, 180.0f);
                        } else {
                            rectF3 = rectF6;
                            double d4 = (double) (f22 * 0.017453292f);
                            pieChartRenderer.f55027g.lineTo(mPPointF2.f55042x + (((float) Math.cos(d4)) * holeRadius), mPPointF2.f55043y + (holeRadius * ((float) Math.sin(d4))));
                        }
                        pieChartRenderer.f55027g.arcTo(pieChartRenderer.f55028h, f22, -f21);
                    } else {
                        pieChartRenderer = this;
                        pieChartRenderer.f55027g.addCircle(mPPointF2.f55042x, mPPointF2.f55043y, holeRadius, Path.Direction.CCW);
                        rectF3 = rectF6;
                    }
                    mPPointF = mPPointF2;
                    rectF2 = rectF3;
                    pieChartRenderer.f55027g.close();
                    pieChartRenderer.mBitmapCanvas.drawPath(pieChartRenderer.f55027g, pieChartRenderer.mRenderPaint);
                    f11 += f12 * f2;
                } else {
                    f8 = holeRadius;
                    f9 = radius;
                ...
                if (f6 % f7 > Utils.FLOAT_EPSILON) {
                    if (z3) {
                        float f24 = f14 + (f6 / 2.0f);
                        float f25 = f14;
                        rectF2 = rectF3;
                        float calculateMinimumRadiusForSpacedSlice2 = calculateMinimumRadiusForSpacedSlice(mPPointF, f4, f12 * phaseY, cos2, sin2, f25, f6);
                        double d5 = (double) (f24 * 0.017453292f);
                        pieChartRenderer.f55027g.lineTo(mPPointF.f55042x + (((float) Math.cos(d5)) * calculateMinimumRadiusForSpacedSlice2), mPPointF.f55043y + (calculateMinimumRadiusForSpacedSlice2 * ((float) Math.sin(d5))));
                    } else {
                        rectF2 = rectF3;
                        pieChartRenderer.f55027g.lineTo(mPPointF.f55042x, mPPointF.f55043y);
                    }
                    pieChartRenderer.f55027g.close();
                    pieChartRenderer.mBitmapCanvas.drawPath(pieChartRenderer.f55027g, pieChartRenderer.mRenderPaint);
                    f11 += f12 * f2;
    ...
    public void drawValues(android.graphics.Canvas r53) {
        ...
        L_0x0226:
            ...
            android.graphics.Paint r2 = r6.f55022b
            android.graphics.Paint$Align r10 = android.graphics.Paint.Align.RIGHT
            r2.setTextAlign(r10)
        L_0x0278:
            float r2 = r0 - r22
        ...
        L_0x027e:
            ...
            android.graphics.Paint r0 = r6.f55022b
            android.graphics.Paint$Align r2 = android.graphics.Paint.Align.LEFT
            r0.setTextAlign(r2)
        L_0x0290:
            float r0 = r43 + r22
        ...
        L_0x0336:
            float r0 = r35 * r46
            r10 = r50
            float r1 = r10.f55042x
            float r12 = r0 + r1
            float r0 = r35 * r29
            float r1 = r10.f55043y
            float r13 = r0 + r1
            android.graphics.Paint r0 = r6.mValuePaint
        ...
        L_0x0393:
            ...
            float r0 = r35 + r0
            float r0 = r0 * r46
            float r2 = r10.f55042x
            float r0 = r0 + r2
            float r2 = r7.f55043y
            float r2 = r35 + r2
            float r2 = r2 * r29
            float r3 = r10.f55043y
            float r2 = r2 + r3
            float r3 = r7.f55042x
            float r2 = r2 + r3
            int r3 = (int) r0
    ...
    public void drawEntryLabel(Canvas canvas, String str, float f, float f2) {
        canvas.drawText(str, f, f2, this.f55022b);
    }
    ...
    public void drawHole(Canvas canvas) {
        if (this.mChart.isDrawHoleEnabled() && this.mBitmapCanvas != null) {
            ...
            if (Color.alpha(this.mHolePaint.getColor()) > 0) {
                this.mBitmapCanvas.drawCircle(centerCircleBox.f55042x, centerCircleBox.f55043y, holeRadius, this.mHolePaint);
            }
            if (Color.alpha(this.mTransparentCirclePaint.getColor()) > 0 && this.mChart.getTransparentCircleRadius() > this.mChart.getHoleRadius()) {
                ...
                this.f55029i.reset();
                this.f55029i.addCircle(centerCircleBox.f55042x, centerCircleBox.f55043y, transparentCircleRadius, Path.Direction.CW);
                this.f55029i.addCircle(centerCircleBox.f55042x, centerCircleBox.f55043y, holeRadius, Path.Direction.CCW);
                this.mBitmapCanvas.drawPath(this.f55029i, this.mTransparentCirclePaint);
    ...
    public void drawCenterText(Canvas canvas) {
        ...
        if (this.mChart.isDrawCenterTextEnabled() && centerText != null) {
            ...
            float f2 = centerCircleBox.f55042x + centerTextOffset.f55042x;
            float f3 = centerCircleBox.f55043y + centerTextOffset.f55043y;
            ...
            RectF rectF = this.f55026f[0];
            rectF.left = f2 - f;
            rectF.top = f3 - f;
            rectF.right = f2 + f;
            rectF.bottom = f3 + f;
            RectF rectF2 = this.f55026f[1];
            rectF2.set(rectF);
            float centerTextRadiusPercent = this.mChart.getCenterTextRadiusPercent() / 100.0f;
            if (((double) centerTextRadiusPercent) > 0.0d) {
                rectF2.inset((rectF2.width() - (rectF2.width() * centerTextRadiusPercent)) / 2.0f, (rectF2.height() - (rectF2.height() * centerTextRadiusPercent)) / 2.0f);
            }
            if (!centerText.equals(this.f55024d) || !rectF2.equals(this.f55025e)) {
                this.f55025e.set(rectF2);
                this.f55024d = centerText;
                mPPointF = centerTextOffset;
                StaticLayout staticLayout = r3;
                StaticLayout staticLayout2 = new StaticLayout(centerText, 0, centerText.length(), this.f55021a, (int) Math.max(Math.ceil((double) this.f55025e.width()), 1.0d), Layout.Alignment.ALIGN_CENTER, 1.0f, 0.0f, false);
                this.f55023c = staticLayout;
            } else {
                mPPointF = centerTextOffset;
            }
            float height = (float) this.f55023c.getHeight();
            canvas.save();
            ...
            while (i4 < highlightArr2.length) {
                ...
                if (x < drawAngles.length && (dataSetByIndex = ((PieData) this.mChart.getData()).getDataSetByIndex(highlightArr2[i4].getDataSetIndex())) != null && dataSetByIndex.isHighlightEnabled()) {
                    ...
                    if (i8 < 0 || f17 % 360.0f > Utils.FLOAT_EPSILON) {
                        ...
                        i3 = i5;
                        z = z2;
                        this.f55027g.moveTo(centerCircleBox.f55042x + (((float) Math.cos(d)) * f10), centerCircleBox.f55043y + (f10 * ((float) Math.sin(d))));
                        this.f55027g.arcTo(rectF2, f18, f19);
                    } else {
                        this.f55027g.addCircle(centerCircleBox.f55042x, centerCircleBox.f55043y, f10, Path.Direction.CW);
                        fArr2 = drawAngles;
                        f6 = f4;
                        i3 = i5;
                        z = z2;
                    ...
                    if (z3) {
                        ...
                        mPPointF = centerCircleBox;
                        fArr = fArr2;
                        f7 = calculateMinimumRadiusForSpacedSlice(centerCircleBox, radius, f9 * phaseY, (((float) Math.cos(d2)) * radius) + centerCircleBox.f55042x, centerCircleBox.f55043y + (((float) Math.sin(d2)) * radius), f15, f17);
                    } else {
                        rectF = rectF2;
                        mPPointF = centerCircleBox;
                        i = i7;
                    ...
                    this.f55028h.set(mPPointF.f55042x - f2, mPPointF.f55043y - f2, mPPointF.f55042x + f2, mPPointF.f55043y + f2);
                    if (!z || (f2 <= 0.0f && !z3)) {
                        f3 = phaseX;
                        f = phaseY;
                        if (f17 % 360.0f > Utils.FLOAT_EPSILON) {
                            if (z3) {
                                ...
                                this.f55027g.lineTo(mPPointF.f55042x + (((float) Math.cos(d3)) * f7), mPPointF.f55043y + (f7 * ((float) Math.sin(d3))));
                            } else {
                                this.f55027g.lineTo(mPPointF.f55042x, mPPointF.f55043y);
                            }
                        }
                    } else {
                        if (z3) {
                        ...
                        if (i8 < 0 || f17 % 360.0f > Utils.FLOAT_EPSILON) {
                            ...
                            f3 = phaseX;
                            f = phaseY;
                            this.f55027g.lineTo(mPPointF.f55042x + (((float) Math.cos(d4)) * f8), mPPointF.f55043y + (f8 * ((float) Math.sin(d4))));
                            this.f55027g.arcTo(this.f55028h, f23, -f22);
                        } else {
                            this.f55027g.addCircle(mPPointF.f55042x, mPPointF.f55043y, f8, Path.Direction.CCW);
                            f3 = phaseX;
                            f = phaseY;
                        }
                    }
                    this.f55027g.close();
                    this.mBitmapCanvas.drawPath(this.f55027g, this.mRenderPaint);
                } else {
                    i = i4;
                    rectF = rectF2;
                    f2 = holeRadius;
            ...
            if (dataSet.isVisible()) {
                ...
                while (i < dataSet.getEntryCount()) {
                    ...
                    if (Math.abs(dataSet.getEntryForIndex(i).getY()) > Utils.FLOAT_EPSILON) {
                        ...
                        fArr = drawAngles;
                        f2 = rotationAngle;
                        float cos = (float) (((double) centerCircleBox.f55042x) + (Math.cos(Math.toRadians(d2)) * d));
                        float sin = (float) ((d * Math.sin(Math.toRadians(d2))) + ((double) centerCircleBox.f55043y));
