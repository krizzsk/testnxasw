...
public class MapSerializeUtil {
    ...
    /* renamed from: a */
    private static final String f58553a = "UTF-16LE";

    /* renamed from: b */
    private ByteArrayOutputStream f58554b = new ByteArrayOutputStream();
    ...
    public void appendByteArray(byte[] bArr) {
        this.f58554b.write(bArr, 0, bArr.length);
    }

    public void appendByte(byte b) {
        this.f58554b.write(b);
    }
