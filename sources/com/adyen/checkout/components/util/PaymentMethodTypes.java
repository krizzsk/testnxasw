...
public final class PaymentMethodTypes {
    ...
    public static final List<String> SUPPORTED_PAYMENT_METHODS = Collections.unmodifiableList(Arrays.asList(new String[]{BCMC, "dotpay", "entercash", "eps", GOOGLE_PAY, GOOGLE_PAY_LEGACY, "ideal", "mbway", MOLPAY_MALAYSIA, MOLPAY_THAILAND, MOLPAY_VIETNAM, "openbanking_UK", "sepadirectdebit", "scheme", "blik", WECHAT_PAY_SDK, PIX}));
