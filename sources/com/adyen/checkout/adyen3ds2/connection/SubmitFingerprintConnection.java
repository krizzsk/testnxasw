...
@Metadata(mo148867d1 = {"\u0000\"\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u000e\n\u0002\b\u0003\u0018\u00002\b\u0012\u0004\u0012\u00020\u00020\u0001B\u001d\u0012\u0006\u0010\u0003\u001a\u00020\u0004\u0012\u0006\u0010\u0005\u001a\u00020\u0006\u0012\u0006\u0010\u0007\u001a\u00020\b¢\u0006\u0002\u0010\tJ\b\u0010\n\u001a\u00020\u0002H\u0016R\u000e\u0010\u0003\u001a\u00020\u0004X\u0004¢\u0006\u0002\n\u0000¨\u0006\u000b"}, mo148868d2 = {"Lcom/adyen/checkout/adyen3ds2/connection/SubmitFingerprintConnection;", "Lcom/adyen/checkout/core/api/Connection;", "Lcom/adyen/checkout/adyen3ds2/model/SubmitFingerprintResponse;", "request", "Lcom/adyen/checkout/adyen3ds2/model/SubmitFingerprintRequest;", "environment", "Lcom/adyen/checkout/core/api/Environment;", "clientKey", "", "(Lcom/adyen/checkout/adyen3ds2/model/SubmitFingerprintRequest;Lcom/adyen/checkout/core/api/Environment;Ljava/lang/String;)V", "call", "3ds2_release"}, mo148869k = 1, mo148870mv = {1, 5, 1}, mo148872xi = 48)
...
public final class SubmitFingerprintConnection extends Connection<SubmitFingerprintResponse> {
    ...
    /* renamed from: a */
    private final SubmitFingerprintRequest f542a;
    ...
    public SubmitFingerprintConnection(SubmitFingerprintRequest submitFingerprintRequest, Environment environment, String str) {
        ...
        this.f542a = submitFingerprintRequest;
    }

    public SubmitFingerprintResponse call() throws IOException, JSONException {
        Logger.m1082v(SubmitFingerprintConnectionKt.f543a, Intrinsics.stringPlus("call - ", getUrl()));
        JSONObject serialize = SubmitFingerprintRequest.Companion.getSERIALIZER().serialize(this.f542a);
        Intrinsics.checkNotNullExpressionValue(serialize, "SubmitFingerprintRequest.SERIALIZER.serialize(request)");
        Logger.m1082v(SubmitFingerprintConnectionKt.f543a, Intrinsics.stringPlus("request - ", JsonUtilsKt.toStringPretty(serialize)));
        ...
        Logger.m1082v(SubmitFingerprintConnectionKt.f543a, Intrinsics.stringPlus("response: ", JsonUtilsKt.toStringPretty(jSONObject2)));
