...
/* renamed from: com.rider.rlab_im_map_plugin.R */
public final class C21388R {

    /* renamed from: com.rider.rlab_im_map_plugin.R$anim */
    public static final class C21389anim {
        private C21389anim() {
        }
    }

    /* renamed from: com.rider.rlab_im_map_plugin.R$animator */
    public static final class C21390animator {
        private C21390animator() {
        }
    }

    /* renamed from: com.rider.rlab_im_map_plugin.R$array */
    public static final class array {
        private array() {
        }
    }

    /* renamed from: com.rider.rlab_im_map_plugin.R$attr */
    public static final class attr {
        private attr() {
        }
    }

    /* renamed from: com.rider.rlab_im_map_plugin.R$bool */
    public static final class bool {
        private bool() {
        }
    }

    /* renamed from: com.rider.rlab_im_map_plugin.R$color */
    public static final class C21391color {
        private C21391color() {
        }
    }

    /* renamed from: com.rider.rlab_im_map_plugin.R$dimen */
    public static final class dimen {
        private dimen() {
        }
    }

    /* renamed from: com.rider.rlab_im_map_plugin.R$drawable */
    public static final class C21392drawable {
        private C21392drawable() {
        }
    }

    /* renamed from: com.rider.rlab_im_map_plugin.R$id */
    public static final class C21393id {
        private C21393id() {
        }
    }

    /* renamed from: com.rider.rlab_im_map_plugin.R$integer */
    public static final class integer {
        private integer() {
        }
    }

    /* renamed from: com.rider.rlab_im_map_plugin.R$interpolator */
    public static final class C21394interpolator {
        private C21394interpolator() {
        }
    }

    /* renamed from: com.rider.rlab_im_map_plugin.R$layout */
    public static final class C21395layout {
        private C21395layout() {
        }
    }

    /* renamed from: com.rider.rlab_im_map_plugin.R$plurals */
    public static final class plurals {
        private plurals() {
        }
    }

    /* renamed from: com.rider.rlab_im_map_plugin.R$string */
    public static final class string {
        private string() {
        }
    }

    /* renamed from: com.rider.rlab_im_map_plugin.R$style */
    public static final class C21396style {
        private C21396style() {
        }
    }

    /* renamed from: com.rider.rlab_im_map_plugin.R$styleable */
    public static final class styleable {
        static {
            ...
            RUIActionPicker = new int[]{R.attr.rui_ap_optionType};
            RUIBottomAlert = new int[]{R.attr.rui_ba_buttonType, R.attr.rui_ba_contentType, R.attr.rui_ba_showCloseButton};
            RUIButton = new int[]{R.attr.rui_button_maxTextLength};
            RUICenterAlert = new int[]{R.attr.rui_ca_buttonType, R.attr.rui_ca_contentStyle};
            RUICheckableText = new int[]{R.attr.rui_ct_checkBoxDrawable, R.attr.rui_ct_checkBoxLocation, R.attr.rui_ct_checkBoxSize, R.attr.rui_ct_text, R.attr.rui_ct_textColor, R.attr.rui_ct_textMaxLine, R.attr.rui_ct_textMaxLines, R.attr.rui_ct_textSize, R.attr.rui_ct_viewMargin};
            RUICheckableTextGroup = new int[]{R.attr.rui_ctg_singleChoice, R.attr.rui_ctg_textMaxLines};
            RUICircleCountDown = new int[]{R.attr.rui_ccd_antiAlias, R.attr.rui_ccd_bgProgressColor, R.attr.rui_ccd_fgProgressColor, R.attr.rui_ccd_progressWidth, R.attr.rui_ccd_startAngle, R.attr.rui_ccd_sweepAngle, R.attr.rui_ccd_textVerticalMargin, R.attr.rui_ccd_timeColor, R.attr.rui_ccd_timeSize, R.attr.rui_ccd_unitColor, R.attr.rui_ccd_unitSize};
            RUICombineButton = new int[]{R.attr.rui_cb_primaryButtonStyle, R.attr.rui_cb_primaryButtonText, R.attr.rui_cb_secondaryButtonText};
            RUICounter = new int[]{R.attr.rui_counter_addButtonBackground, R.attr.rui_counter_buttonSize, R.attr.rui_counter_protrudeNumber, R.attr.rui_counter_subtractButtonBackground, R.attr.rui_counter_textColor, R.attr.rui_counter_textMinWidth, R.attr.rui_counter_textSize, R.attr.rui_counter_viewMargin};
            RUIDisplayNumberEditText = new int[]{R.attr.rui_dnet_currentNumberTextColor, R.attr.rui_dnet_maxNumberTextColor, R.attr.rui_dnet_numberMarginBottom, R.attr.rui_dnet_numberMarginRight, R.attr.rui_dnet_numberTextSize};
            RUIEditText = new int[]{R.attr.rui_editText_maxTextLength};
            RUIIndicatorText = new int[]{R.attr.rui_it_currentPageTextColor, R.attr.rui_it_currentPageTextSize, R.attr.rui_it_totalPageTextColor, R.attr.rui_it_totalPageTextSize};
            RUIInputBox = new int[]{R.attr.rui_lb_editTextGravity, R.attr.rui_lb_inputBoxType, R.attr.rui_lb_maxTextLength};
            RUILoadingButton = new int[]{R.attr.rui_lb_enlargeEndBubbleColor};
            RUILoopView = new int[]{R.attr.rui_lp_centerTextColor, R.attr.rui_lp_dividerTextColor, R.attr.rui_lp_initialPosition, R.attr.rui_lp_isLoop, R.attr.rui_lp_itemsVisibleCount, R.attr.rui_lp_lineSpace, R.attr.rui_lp_outerTextColor, R.attr.rui_lp_scaleX, R.attr.rui_lp_textSize};
            RUIProgressButton = new int[]{R.attr.rui_pb_progressBackgroundColor, R.attr.rui_pb_progressColor, R.attr.rui_pb_progressCornerRadius};
            RUIScrollView = new int[]{R.attr.rui_scrollView_maxHeight};
            RUISelection = new int[]{R.attr.rui_selection_choiceTextSize, R.attr.rui_selection_titleTextSize};
            RUISlideButton = new int[]{R.attr.rui_sb_loading_button_style, R.attr.rui_sb_operate_button_style};
            RUIStrikeThroughText = new int[]{R.attr.rui_stt_strike_through_line_color, R.attr.rui_stt_strike_through_line_corner_radius_size, R.attr.rui_stt_strike_through_line_extra_width, R.attr.rui_stt_strike_through_line_height};
            RUISwitch = new int[]{R.attr.rui_switch_animationDuration, R.attr.rui_switch_borderWidth, R.attr.rui_switch_buttonBorderColor, R.attr.rui_switch_buttonBorderWidth, R.attr.rui_switch_disabledButtonColor, R.attr.rui_switch_disabledCheckedBorderColor, R.attr.rui_switch_disabledCheckedColor, R.attr.rui_switch_disabledUncheckedBorderColor, R.attr.rui_switch_disabledUncheckedColor, R.attr.rui_switch_enableAnimation, R.attr.rui_switch_enabledButtonColor, R.attr.rui_switch_enabledCheckedBorderColor, R.attr.rui_switch_enabledCheckedColor, R.attr.rui_switch_enabledUncheckedBorderColor, R.attr.rui_switch_enabledUncheckedColor};
            RUITagButton = new int[]{R.attr.rui_tb_boldTextWhenSelected};
            RUITagButtonGroup = new int[]{R.attr.rui_tbg_tagButtonStyle};
            RUIText = new int[]{R.attr.rui_text_maxTextLength, R.attr.rui_text_typefaceType};
            RUITextChainButton = new int[]{R.attr.rui_tcb_showUnderline};
            RUIToastView = new int[]{R.attr.rui_tv_show_progress_bar};
    ...
    /* renamed from: com.rider.rlab_im_map_plugin.R$xml */
    public static final class C21397xml {
        private C21397xml() {
        }
    }
