...
public final class C1676ae {

    /* renamed from: ɩ */
    private static String f1896;

    C1676ae() {
    }

    /* renamed from: Ι */
    public static synchronized String m1619(WeakReference<Context> weakReference) {
        synchronized (C1676ae.class) {
            ...
            if (f1896 == null) {
                ...
                if (f1896 != null) {
                    AppsFlyerProperties.getInstance().set("uid", f1896);
                }
            }
            String str4 = f1896;
            return str4;
    ...
    private static java.lang.String m1618(java.io.File r6) {
        /*
        ...
        L_0x0052:
            throw r6
        */
        throw new UnsupportedOperationException("Method not decompiled: com.appsflyer.internal.C1676ae.m1618(java.io.File):java.lang.String");
    }
}
