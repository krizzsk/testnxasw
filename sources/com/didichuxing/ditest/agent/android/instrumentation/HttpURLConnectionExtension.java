...
public class HttpURLConnectionExtension extends HttpURLConnection {
    ...
    public HttpURLConnectionExtension(HttpURLConnection httpURLConnection) {
        ...
        if (!Agent.isEnvSwitchEnable()) {
            ...
            this.impl = EnvSwitchManager.getInstance().replaceHttpURLConnection(httpURLConnection);
        }
    }
    ...
    public void setRequestProperty(String str, String str2) {
        if (!(str == null || str2 == null)) {
            try {
                if (this.impl.getRequestProperty(str) != null) {
                    getTransactionState();
                    this.transactionState.setBytesHeaderSent(this.transactionState.getBytesHeaderSent() + ((long) str.length()) + 1 + ((long) str2.length()) + 1);
                }
            } catch (IllegalStateException e) {
                log.error("http url connection already connected when set Request Property");
                throw e;
