...
public abstract class MediaEncoder implements Runnable {
    ...
    /* renamed from: a */
    private static final boolean f51385a = true;

    /* renamed from: b */
    private static final String f51386b = "MediaEncoder";

    /* renamed from: c */
    private int f51387c;

    /* renamed from: d */
    private MediaCodec.BufferInfo f51388d;

    /* renamed from: e */
    private long f51389e = 0;
    ...
    public MediaEncoder(com.didichuxing.sdk.alphaface.video_capture.MediaMuxerWrapper r3, com.didichuxing.sdk.alphaface.video_capture.MediaEncoder.MediaEncoderListener r4) {
        /*
            r2 = this;
            r2.<init>()
            ...
            r0.<init>(r3)
            r2.mWeakMuxer = r0
            r3.mo127214a((com.didichuxing.sdk.alphaface.video_capture.MediaEncoder) r2)
            r2.mListener = r4
            ...
            r2.f51388d = r4     // Catch:{ all -> 0x003f }
        ...
        L_0x004a:
            ...
            throw r3
        */
        throw new UnsupportedOperationException("Method not decompiled: com.didichuxing.sdk.alphaface.video_capture.MediaEncoder.<init>(com.didichuxing.sdk.alphaface.video_capture.MediaMuxerWrapper, com.didichuxing.sdk.alphaface.video_capture.MediaEncoder$MediaEncoderListener):void");
    }
    ...
    public void run() {
        /*
            ...
            r10.f51387c = r1     // Catch:{ all -> 0x0081 }
        ...
        L_0x000e:
            ...
            int r4 = r10.f51387c     // Catch:{ all -> 0x0048 }
        ...
        L_0x001b:
            ...
            int r5 = r10.f51387c     // Catch:{ all -> 0x0048 }
            int r5 = r5 - r0
            r10.f51387c = r5     // Catch:{ all -> 0x0048 }
        L_0x0022:
        ...
        L_0x004b:
            r2 = move-exception
            com.didichuxing.sdk.alphaface.video_capture.MediaEncoder$MediaEncoderListener r3 = r10.mListener
        ...
        L_0x0068:
            ...
            r4 = 3
            r7 = 0
            java.lang.String r8 = "com.didichuxing.sdk.alphaface.video_capture.MediaEncoder"
        ...
        L_0x0081:
            ...
            throw r1
        */
        throw new UnsupportedOperationException("Method not decompiled: com.didichuxing.sdk.alphaface.video_capture.MediaEncoder.run():void");
    }

    /* access modifiers changed from: package-private */
    public void startRecording() {
        SystemUtils.log(2, f51386b, "startRecording", (Throwable) null, "com.didichuxing.sdk.alphaface.video_capture.MediaEncoder", 172);
        synchronized (this.mSync) {
    ...
    /* renamed from: b */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public void mo127204b() {
        /*
            r6 = this;
            java.lang.String r1 = "MediaEncoder"
            java.lang.String r2 = "stopRecording"
            java.lang.String r4 = "com.didichuxing.sdk.alphaface.video_capture.MediaEncoder"
            r0 = 2
            r3 = 0
        ...
        L_0x0025:
            ...
            throw r1
        */
        throw new UnsupportedOperationException("Method not decompiled: com.didichuxing.sdk.alphaface.video_capture.MediaEncoder.mo127204b():void");
    }

    /* access modifiers changed from: protected */
    public void release() {
        SystemUtils.log(3, f51386b, "release:", (Throwable) null, "com.didichuxing.sdk.alphaface.video_capture.MediaEncoder", 203);
        try {
            this.mListener.onStopped(this);
        } catch (Exception e) {
            SystemUtils.log(6, f51386b, "failed onStopped", e, "com.didichuxing.sdk.alphaface.video_capture.MediaEncoder", 207);
        ...
        if (mediaCodec != null) {
            try {
                ...
                SystemUtils.log(6, f51386b, "failed releasing MediaCodec", e2, "com.didichuxing.sdk.alphaface.video_capture.MediaEncoder", 219);
        ...
        if (this.mMuxerStarted) {
            ...
            if (mediaMuxerWrapper != null) {
                try {
                    mediaMuxerWrapper.mo127216b();
                } catch (Exception e3) {
                    SystemUtils.log(6, f51386b, "failed stopping muxer", e3, "com.didichuxing.sdk.alphaface.video_capture.MediaEncoder", 231);
    ...
    public void signalEndOfInputStream() {
        SystemUtils.log(3, f51386b, "sending EOS to encoder", (Throwable) null, "com.didichuxing.sdk.alphaface.video_capture.MediaEncoder", 242);
        ...
        if (this.mIsCapturing) {
            ...
            while (this.mIsCapturing) {
                ...
                if (dequeueInputBuffer >= 0) {
                    ...
                    if (i <= 0) {
                        this.mIsEOS = true;
                        SystemUtils.log(4, f51386b, "send BUFFER_FLAG_END_OF_STREAM", (Throwable) null, "com.didichuxing.sdk.alphaface.video_capture.MediaEncoder", 271);
    ...
    public void drain() {
        ...
        L_0x0005:
            ...
            java.lang.ref.WeakReference<com.didichuxing.sdk.alphaface.video_capture.MediaMuxerWrapper> r1 = r13.mWeakMuxer     // Catch:{ Exception -> 0x0130 }
            java.lang.Object r1 = r1.get()     // Catch:{ Exception -> 0x0130 }
            com.didichuxing.sdk.alphaface.video_capture.MediaMuxerWrapper r1 = (com.didichuxing.sdk.alphaface.video_capture.MediaMuxerWrapper) r1     // Catch:{ Exception -> 0x0130 }
            if (r1 != 0) goto L_0x0023
            java.lang.String r3 = "MediaEncoder"
            java.lang.String r4 = "muxer is unexpectedly null"
            r2 = 5
            r5 = 0
            java.lang.String r6 = "com.didichuxing.sdk.alphaface.video_capture.MediaEncoder"
        ...
        L_0x0025:
            ...
            android.media.MediaCodec$BufferInfo r5 = r13.f51388d     // Catch:{ Exception -> 0x0130 }
        ...
        L_0x0041:
            ...
            r6 = 2
            r9 = 0
            java.lang.String r10 = "com.didichuxing.sdk.alphaface.video_capture.MediaEncoder"
        ...
        L_0x0058:
            ...
            int r4 = r1.mo127212a((android.media.MediaFormat) r4)     // Catch:{ Exception -> 0x0130 }
            r13.mTrackIndex = r4     // Catch:{ Exception -> 0x0130 }
            r4 = 1
            r13.mMuxerStarted = r4     // Catch:{ Exception -> 0x0130 }
            boolean r4 = r1.mo127215a()     // Catch:{ Exception -> 0x0130 }
            if (r4 != 0) goto L_0x0025
        ...
        L_0x00be:
            ...
            android.media.MediaCodec$BufferInfo r6 = r13.f51388d     // Catch:{ Exception -> 0x0130 }
            ...
            r7 = 3
            r10 = 0
            java.lang.String r11 = "com.didichuxing.sdk.alphaface.video_capture.MediaEncoder"
        ...
        L_0x00db:
            ...
            android.media.MediaCodec$BufferInfo r3 = r13.f51388d     // Catch:{ Exception -> 0x0130 }
            ...
            android.media.MediaCodec$BufferInfo r6 = r13.f51388d     // Catch:{ Exception -> 0x0130 }
            r1.mo127213a(r3, r5, r6)     // Catch:{ Exception -> 0x0130 }
            android.media.MediaCodec$BufferInfo r3 = r13.f51388d     // Catch:{ Exception -> 0x0130 }
            long r5 = r3.presentationTimeUs     // Catch:{ Exception -> 0x0130 }
            r13.f51389e = r5     // Catch:{ Exception -> 0x0130 }
            r3 = 0
            goto L_0x0104
        L_0x00fc:
            java.lang.RuntimeException r0 = new java.lang.RuntimeException     // Catch:{ Exception -> 0x0130 }
        ...
        L_0x0104:
            ...
            android.media.MediaCodec$BufferInfo r4 = r13.f51388d     // Catch:{ Exception -> 0x0130 }
        ...
        L_0x0130:
            r0 = move-exception
            com.didichuxing.sdk.alphaface.video_capture.MediaEncoder$MediaEncoderListener r1 = r13.mListener
        ...
        L_0x014d:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.didichuxing.sdk.alphaface.video_capture.MediaEncoder.drain():void");
    }
