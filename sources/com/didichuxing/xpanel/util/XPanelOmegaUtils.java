...
public class XPanelOmegaUtils {
    ...
    /* renamed from: a */
    private static final String f52160a = "XPanelOmegaUtils";

    /* renamed from: b */
    private static boolean f52161b = true;

    /* renamed from: c */
    private static IXPanelOmegaListener f52162c;

    public static void initXPanelOmega() {
        f52161b = XPanelApolloUtil.isXPanelOmegaEnable();
    }
    ...
    public static void trackEvent(String str, Map<String, Object> map) {
        if (f52161b) {
            IXPanelOmegaListener iXPanelOmegaListener = f52162c;
