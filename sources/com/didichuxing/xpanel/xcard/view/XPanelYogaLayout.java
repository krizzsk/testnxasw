...
public class XPanelYogaLayout extends YogaLayout implements IParser, IView {
    ...
    /* renamed from: b */
    private YogaNode f52256b;

    /* renamed from: c */
    private boolean f52257c;

    /* renamed from: d */
    private Path f52258d;

    /* renamed from: e */
    private Paint f52259e;

    /* renamed from: f */
    private RectF f52260f;

    /* renamed from: g */
    private float f52261g;

    /* renamed from: h */
    private float[] f52262h;
    ...
    public XPanelYogaLayout(Context context, AttributeSet attributeSet, int i) {
        ...
        this.f52262h = new float[8];
        this.f52255a = context;
        this.f52256b = getYogaNode();
        this.f52260f = new RectF();
        this.f52258d = new Path();
        Paint paint = new Paint();
        this.f52259e = paint;
        paint.setAntiAlias(true);
        this.f52259e.setColor(0);
        this.f52259e.setStyle(Paint.Style.STROKE);
    }
    ...
    public void parse(XmlPullParser xmlPullParser) {
        ...
        if (!TextUtils.isEmpty(attributeValue)) {
            this.f52256b.setFlexDirection(getFlexDirection(attributeValue));
        }
        if (!TextUtils.isEmpty(attributeValue2)) {
            this.f52256b.setWrap(getFlexWrap(attributeValue2));
        }
        if (!TextUtils.isEmpty(attributeValue3)) {
            this.f52256b.setJustifyContent(getJustifyContent(attributeValue3));
        }
        if (!TextUtils.isEmpty(attributeValue4)) {
            this.f52256b.setAlignItems(getAlignItems(attributeValue4));
        }
        if (!TextUtils.isEmpty(attributeValue5)) {
            this.f52256b.setAlignContent(getAlignContent(attributeValue5));
        }
    }
    ...
    public void parse(java.lang.String r2, java.lang.String r3, com.facebook.yoga.YogaNode r4) {
        ...
        L_0x0052:
            ...
            throw r3
        L_0x0069:
            com.facebook.yoga.YogaNode r2 = r1.f52256b
        ...
        L_0x009a:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.didichuxing.xpanel.xcard.view.XPanelYogaLayout.parse(java.lang.String, java.lang.String, com.facebook.yoga.YogaNode):void");
    }
    ...
    public com.facebook.yoga.YogaWrap getFlexWrap(java.lang.String r5) {
        ...
        L_0x0058:
            ...
            return r5
        */
        throw new UnsupportedOperationException("Method not decompiled: com.didichuxing.xpanel.xcard.view.XPanelYogaLayout.getFlexWrap(java.lang.String):com.facebook.yoga.YogaWrap");
    }
    ...
    public com.facebook.yoga.YogaFlexDirection getFlexDirection(java.lang.String r5) {
        ...
        L_0x005c:
            ...
            return r5
        */
        throw new UnsupportedOperationException("Method not decompiled: com.didichuxing.xpanel.xcard.view.XPanelYogaLayout.getFlexDirection(java.lang.String):com.facebook.yoga.YogaFlexDirection");
    }
    ...
    public com.facebook.yoga.YogaJustify getJustifyContent(java.lang.String r6) {
        ...
        L_0x006c:
            ...
            return r6
        */
        throw new UnsupportedOperationException("Method not decompiled: com.didichuxing.xpanel.xcard.view.XPanelYogaLayout.getJustifyContent(java.lang.String):com.facebook.yoga.YogaJustify");
    }
    ...
    public com.facebook.yoga.YogaAlign getAlignItems(java.lang.String r4) {
        ...
        L_0x0088:
            ...
            return r4
        */
        throw new UnsupportedOperationException("Method not decompiled: com.didichuxing.xpanel.xcard.view.XPanelYogaLayout.getAlignItems(java.lang.String):com.facebook.yoga.YogaAlign");
    }
    ...
    public void setBorder(Border border) {
        ...
        this.f52261g = borderWidth;
        this.f52259e.setStrokeWidth(borderWidth);
        this.f52259e.setColor(border.getBorderColor());
    }
    ...
    public void dispatchDraw(Canvas canvas) {
        ...
        if (this.f52257c) {
            this.f52258d.reset();
            this.f52260f.left = this.f52261g / 2.0f;
            this.f52260f.top = this.f52261g / 2.0f;
            this.f52260f.right = ((float) getMeasuredWidth()) - (this.f52261g / 2.0f);
            this.f52260f.bottom = ((float) getMeasuredHeight()) - (this.f52261g / 2.0f);
            this.f52258d.addRoundRect(this.f52260f, this.f52262h, Path.Direction.CW);
            canvas.drawPath(this.f52258d, this.f52259e);
        }
    }

    public void setCorner(Corner corner) {
        float[] fArr = this.f52262h;
        float leftTopCorner = corner.getLeftTopCorner();
        fArr[1] = leftTopCorner;
        fArr[0] = leftTopCorner;
        float[] fArr2 = this.f52262h;
        float rightTopCorner = corner.getRightTopCorner();
        fArr2[3] = rightTopCorner;
        fArr2[2] = rightTopCorner;
        float[] fArr3 = this.f52262h;
        float rightBottomCorner = corner.getRightBottomCorner();
        fArr3[5] = rightBottomCorner;
        fArr3[4] = rightBottomCorner;
        float[] fArr4 = this.f52262h;
