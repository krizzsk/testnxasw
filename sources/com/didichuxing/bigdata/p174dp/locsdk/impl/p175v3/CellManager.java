...
public class CellManager implements ICellManager {
    ...
    /* renamed from: m */
    private static final int f48440m = Integer.MAX_VALUE;

    /* renamed from: a */
    private Context f48441a;

    /* renamed from: b */
    private boolean f48442b;
    ...
    /* renamed from: d */
    private volatile List<Cgi> f48444d;

    /* renamed from: e */
    private volatile Cgi f48445e;

    /* renamed from: f */
    private int f48446f;

    /* renamed from: g */
    private TelephonyManager f48447g;

    /* renamed from: h */
    private Object f48448h;

    /* renamed from: i */
    private long f48449i;

    /* renamed from: j */
    private PhoneStateListener f48450j;
    /* access modifiers changed from: private */

    /* renamed from: k */
    public CellLocation f48451k;

    /* renamed from: l */
    private String f48452l;
    ...
    private CellManager() {
        ...
        this.f48445e = null;
        this.f48446f = Const.iDefCgiSig;
        this.f48449i = 0;
        this.f48452l = "CellManager";
    }
    ...
    public synchronized void init(Context context) {
        if (!this.f48442b) {
            ...
            this.f48447g = telephonyManager;
            try {
                this.f48443c = Utils.getCellLocT(telephonyManager.getCellLocation(), this.f48441a);
                m36294f();
    ...
    public List<Cgi> getDetectedCgiList() {
        return this.f48444d != null ? new ArrayList(this.f48444d) : new ArrayList();
    }
    ...
    public CellLocation getCellLocation() {
        TelephonyManager telephonyManager = this.f48447g;
        CellLocation cellLocation = null;
        if (telephonyManager != null) {
            try {
                cellLocation = telephonyManager.getCellLocation();
                if (cgiUseful(cellLocation)) {
                    this.f48451k = cellLocation;
                }
            } catch (Exception unused) {
            }
        }
    ...
    public synchronized void destroy() {
        if (this.f48442b) {
            if (!(this.f48447g == null || this.f48450j == null)) {
                try {
                    DLog.m36225d("cell unregister listener");
                    this.f48447g.listen(this.f48450j, 0);
                } catch (Exception e) {
                    DLog.m36225d(e.toString());
                }
            }
            if (this.f48444d != null) {
                this.f48444d.clear();
            }
            this.f48446f = Const.iDefCgiSig;
            this.f48445e = null;
    ...
    public void refineCellT() {
        int i = this.f48443c;
        if (i != 1) {
            if (i == 2 && this.f48444d != null && this.f48444d.isEmpty()) {
                DLog.m36225d("refine cell cdma2def");
                this.f48443c = 0;
            }
        } else if (this.f48444d != null && this.f48444d.isEmpty()) {
    ...
    public boolean cgiNeedUpdate(boolean z) {
        if (z || this.f48449i == 0 || Utils.getTimeBoot() - this.f48449i < 10000) {
            return false;
        }
        return true;
    }
    ...
    public boolean isCellValid() {
        CellLocation cellLocation = this.f48451k;
        return cellLocation != null && cgiUseful(cellLocation) && Utils.getTimeBoot() - this.f48449i <= 10000;
    }
    ...
    public boolean cgiUseful(android.telephony.CellLocation r6) {
        /*
            ...
            return r0
        L_0x0004:
            android.content.Context r1 = r5.f48441a
            int r1 = com.didichuxing.bigdata.p174dp.locsdk.utils.Utils.getCellLocT(r6, r1)
            r2 = 1
        ...
        L_0x002f:
            ...
            com.didichuxing.bigdata.p174dp.locsdk.utils.OmegaUtils.trackReflectError(r6, r1)
            java.lang.StringBuilder r1 = new java.lang.StringBuilder
            r1.<init>()
            java.lang.String r3 = r5.f48452l
            r1.append(r3)
        ...
        L_0x00a3:
            return r2
        */
        throw new UnsupportedOperationException("Method not decompiled: com.didichuxing.bigdata.p174dp.locsdk.impl.p175v3.CellManager.cgiUseful(android.telephony.CellLocation):boolean");
    }
    ...
    /* renamed from: a */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    private synchronized void m36277a() {
        /*
            r5 = this;
            monitor-enter(r5)
            android.content.Context r0 = r5.f48441a     // Catch:{ all -> 0x00d5 }
            boolean r0 = com.didichuxing.bigdata.p174dp.locsdk.utils.Utils.airPlaneModeOn(r0)     // Catch:{ all -> 0x00d5 }
            if (r0 != 0) goto L_0x00d3
            android.telephony.TelephonyManager r0 = r5.f48447g     // Catch:{ all -> 0x00d5 }
            if (r0 == 0) goto L_0x00d3
            r0 = 0
            java.util.List<com.didichuxing.bigdata.dp.locsdk.Cgi> r1 = r5.f48444d     // Catch:{ all -> 0x00d5 }
            r2 = 0
            if (r1 == 0) goto L_0x0023
            java.util.List<com.didichuxing.bigdata.dp.locsdk.Cgi> r1 = r5.f48444d     // Catch:{ all -> 0x00d5 }
            boolean r1 = r1.isEmpty()     // Catch:{ all -> 0x00d5 }
            if (r1 != 0) goto L_0x0023
            java.util.List<com.didichuxing.bigdata.dp.locsdk.Cgi> r0 = r5.f48444d     // Catch:{ all -> 0x00d5 }
        ...
        L_0x0023:
            java.util.List r1 = r5.m36283b()     // Catch:{ all -> 0x00d5 }
            r5.f48444d = r1     // Catch:{ all -> 0x00d5 }
            java.util.List<com.didichuxing.bigdata.dp.locsdk.Cgi> r1 = r5.f48444d     // Catch:{ all -> 0x00d5 }
        ...
        L_0x0035:
            ...
            java.util.List r1 = r5.m36287c()     // Catch:{ all -> 0x00d5 }
            r5.f48444d = r1     // Catch:{ all -> 0x00d5 }
        L_0x0040:
            java.util.List<com.didichuxing.bigdata.dp.locsdk.Cgi> r1 = r5.f48444d     // Catch:{ all -> 0x00d5 }
        ...
        L_0x004c:
            ...
            com.didichuxing.bigdata.p174dp.locsdk.DLog.m36225d(r1)     // Catch:{ all -> 0x00d5 }
        L_0x0051:
            android.telephony.CellLocation r1 = r5.f48451k     // Catch:{ all -> 0x00d5 }
        ...
        L_0x006b:
            android.telephony.CellLocation r1 = r5.f48451k     // Catch:{ all -> 0x00d5 }
            android.content.Context r3 = r5.f48441a     // Catch:{ all -> 0x00d5 }
            int r1 = com.didichuxing.bigdata.p174dp.locsdk.utils.Utils.getCellLocT(r1, r3)     // Catch:{ all -> 0x00d5 }
            r3 = 1
        ...
        L_0x008e:
            android.telephony.CellLocation r1 = r5.f48451k     // Catch:{ all -> 0x00d5 }
            r5.m36284b((android.telephony.CellLocation) r1)     // Catch:{ all -> 0x00d5 }
            goto L_0x00a1
        L_0x0094:
            java.util.List<com.didichuxing.bigdata.dp.locsdk.Cgi> r1 = r5.f48444d     // Catch:{ all -> 0x00d5 }
            int r1 = r1.size()     // Catch:{ all -> 0x00d5 }
            ...
            android.telephony.CellLocation r1 = r5.f48451k     // Catch:{ all -> 0x00d5 }
            r5.m36279a((android.telephony.CellLocation) r1)     // Catch:{ all -> 0x00d5 }
        L_0x00a1:
            java.util.List<com.didichuxing.bigdata.dp.locsdk.Cgi> r1 = r5.f48444d     // Catch:{ all -> 0x00d5 }
            int r1 = r1.size()     // Catch:{ all -> 0x00d5 }
            ...
            r5.f48443c = r1     // Catch:{ all -> 0x00d5 }
        L_0x00b5:
            java.util.List<com.didichuxing.bigdata.dp.locsdk.Cgi> r1 = r5.f48444d     // Catch:{ all -> 0x00d5 }
            ...
            if (r1 != 0) goto L_0x00d3
            r5.f48445e = r0     // Catch:{ all -> 0x00d5 }
        L_0x00d3:
            monitor-exit(r5)
            return
        L_0x00d5:
            ...
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.didichuxing.bigdata.p174dp.locsdk.impl.p175v3.CellManager.m36277a():void");
    }

    /* renamed from: a */
    private void m36279a(CellLocation cellLocation) {
        Cgi a;
        if (cellLocation != null && this.f48447g != null && cgiUseful(cellLocation)) {
            if (this.f48444d != null) {
                this.f48444d.add(0, m36273a(cellLocation, 5));
            }
            if (this.f48444d != null && this.f48444d.size() == 1) {
                List<NeighboringCellInfo> list = null;
                try {
                    list = this.f48447g.getNeighboringCellInfo();
                ...
                for (NeighboringCellInfo neighboringCellInfo : list) {
                    if (cgiUseful(neighboringCellInfo) && (a = m36274a(neighboringCellInfo)) != null && !this.f48444d.contains(a)) {
                        this.f48444d.add(a);
                    }
                }
            }
    ...
    /* renamed from: b */
    private void m36284b(CellLocation cellLocation) {
        Cgi a;
        if (cellLocation != null) {
            ...
            try {
                if (this.f48448h != null) {
                    ...
                    try {
                        ...
                        if (gsmCellLocation != null && cgiUseful((CellLocation) gsmCellLocation)) {
                            ...
                            this.f48451k = gsmCellLocation;
                            if (this.f48444d != null && this.f48444d.size() > 0) {
                                this.f48444d.remove(0);
                            }
                            m36279a((CellLocation) gsmCellLocation);
                            z = true;
                        }
                    } catch (Exception unused) {
                ...
                if (cgiUseful(cellLocation) && (a = m36275a((Object) cellLocation, 2)) != null && this.f48444d.size() == 0) {
                    this.f48444d.add(a);
                }
            } catch (Exception e) {
                DLog.m36225d(e.toString());
    ...
    /* renamed from: a */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    private com.didichuxing.bigdata.p174dp.locsdk.Cgi m36275a(java.lang.Object r7, int r8) {
        /*
            r6 = this;
            android.telephony.TelephonyManager r0 = r6.f48447g
            java.lang.String[] r0 = com.didichuxing.bigdata.p174dp.locsdk.utils.Utils.getMccMnc(r0)
            ...
            int r0 = r6.f48446f     // Catch:{ Exception -> 0x0090 }
        ...
        L_0x0090:
            ...
            com.didichuxing.bigdata.p174dp.locsdk.utils.OmegaUtils.trackReflectError(r7, r8)
            r1 = 0
        L_0x0097:
            return r1
        */
        throw new UnsupportedOperationException("Method not decompiled: com.didichuxing.bigdata.p174dp.locsdk.impl.p175v3.CellManager.m36275a(java.lang.Object, int):com.didichuxing.bigdata.dp.locsdk.Cgi");
    }
    ...
    /* renamed from: b */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    private java.util.List<com.didichuxing.bigdata.p174dp.locsdk.Cgi> m36283b() {
        /*
            r11 = this;
            ...
            android.telephony.TelephonyManager r4 = r11.f48447g
            r5 = 0
            if (r4 != 0) goto L_0x000e
            return r5
        L_0x000e:
            android.content.Context r6 = r11.f48441a     // Catch:{ Exception -> 0x0030 }
            boolean r6 = com.didichuxing.bigdata.p174dp.locsdk.utils.Utils.isLocationPermissionGranted(r6)     // Catch:{ Exception -> 0x0030 }
            ...
            com.didichuxing.bigdata.p174dp.locsdk.DLog.m36225d(r2)     // Catch:{ Exception -> 0x0030 }
            java.lang.Throwable r7 = new java.lang.Throwable     // Catch:{ Exception -> 0x0030 }
            r7.<init>(r2)     // Catch:{ Exception -> 0x0030 }
            com.didichuxing.bigdata.p174dp.locsdk.utils.OmegaUtils.trackReflectError(r7, r3)     // Catch:{ Exception -> 0x0030 }
        L_0x002b:
            java.util.List r2 = r11.m36276a((java.util.List<?>) r6)     // Catch:{ Exception -> 0x0030 }
            goto L_0x003c
        L_0x0030:
            r2 = move-exception
            com.didichuxing.bigdata.p174dp.locsdk.utils.OmegaUtils.trackReflectError(r2, r3)
        ...
        L_0x003c:
            ...
            com.didichuxing.bigdata.p174dp.locsdk.utils.OmegaUtils.trackGetSimCgi(r7, r6, r0)
            return r2
        L_0x0052:
        ...
        L_0x005d:
            ...
            r11.f48451k = r5
            r11.m36280a((android.telephony.CellLocation) r5, (java.util.List<com.didichuxing.bigdata.p174dp.locsdk.Cgi>) r2)
        ...
        L_0x0073:
            ...
            java.lang.Object r9 = com.didichuxing.bigdata.p174dp.locsdk.Reflect.invokeMethod(r4, r1, r9)     // Catch:{ NoSuchMethodException -> 0x0088, Exception -> 0x0086 }
        ...
        L_0x0088:
            ...
            goto L_0x0095
        L_0x008a:
            com.didichuxing.bigdata.p174dp.locsdk.utils.OmegaUtils.trackReflectError(r9, r3)
        ...
        L_0x009d:
            ...
            r11.f48451k = r5
            r11.m36280a((android.telephony.CellLocation) r5, (java.util.List<com.didichuxing.bigdata.p174dp.locsdk.Cgi>) r2)
            com.didichuxing.bigdata.p174dp.locsdk.utils.OmegaUtils.trackGetSimCgi(r7, r6, r1)
            return r2
        L_0x00b1:
            ...
            java.lang.Object r1 = com.didichuxing.bigdata.p174dp.locsdk.Reflect.invokeMethod(r4, r0, r1)     // Catch:{ NoSuchMethodException -> 0x00c5, Exception -> 0x00c3 }
        ...
        L_0x00c5:
            ...
            goto L_0x00d2
        L_0x00c7:
            com.didichuxing.bigdata.p174dp.locsdk.utils.OmegaUtils.trackReflectError(r1, r3)
        ...
        L_0x00ee:
            ...
            com.didichuxing.bigdata.p174dp.locsdk.utils.OmegaUtils.trackGetSimCgi(r8, r6, r0)     // Catch:{ Exception -> 0x00f9 }
        L_0x00f9:
            return r2
        */
        throw new UnsupportedOperationException("Method not decompiled: com.didichuxing.bigdata.p174dp.locsdk.impl.p175v3.CellManager.m36283b():java.util.List");
    }

    /* renamed from: a */
    private void m36280a(CellLocation cellLocation, List<Cgi> list) {
        Cgi a;
        int cellLocT = Utils.getCellLocT(cellLocation, this.f48441a);
        if (cellLocT == 1) {
            list.add(m36273a(cellLocation, 5));
        } else if (cellLocT == 2 && (a = m36275a((Object) cellLocation, cellLocT)) != null) {
            list.add(a);
        }
    }
    ...
    /* renamed from: c */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    private java.util.List<com.didichuxing.bigdata.p174dp.locsdk.Cgi> m36287c() {
        /*
            r12 = this;
            java.lang.String r0 = "sim2 NoSuchMethodException: getCellLocationGemini"
            java.lang.String r1 = "getSim2Cgis"
            java.lang.Object r2 = r12.f48448h
            java.lang.String r3 = "sim2"
            r4 = 0
            r5 = 0
            if (r2 != 0) goto L_0x0012
            java.lang.String r0 = "tm2==null"
            com.didichuxing.bigdata.p174dp.locsdk.utils.OmegaUtils.trackGetSimCgi(r5, r3, r0)
            return r4
        L_0x0012:
            java.lang.Class r6 = r12.m36290d()     // Catch:{ Exception -> 0x010d }
        ...
        L_0x002b:
            r6 = move-exception
            com.didichuxing.bigdata.p174dp.locsdk.utils.OmegaUtils.trackReflectError(r6, r1)     // Catch:{ Exception -> 0x010d }
        ...
        L_0x004f:
            r6 = r4
        L_0x0050:
            java.util.List r6 = r12.m36276a((java.util.List<?>) r6)     // Catch:{ Exception -> 0x010d }
        ...
        L_0x006b:
            r8 = move-exception
            com.didichuxing.bigdata.p174dp.locsdk.utils.OmegaUtils.trackReflectError(r8, r1)     // Catch:{ Exception -> 0x010a }
        ...
        L_0x00a1:
            r9 = move-exception
            com.didichuxing.bigdata.p174dp.locsdk.utils.OmegaUtils.trackReflectError(r9, r1)     // Catch:{ Exception -> 0x010a }
        ...
        L_0x00d8:
            r0 = move-exception
            com.didichuxing.bigdata.p174dp.locsdk.utils.OmegaUtils.trackReflectError(r0, r1)     // Catch:{ Exception -> 0x010a }
        ...
        L_0x00f5:
            r2 = move-exception
            com.didichuxing.bigdata.p174dp.locsdk.utils.OmegaUtils.trackReflectError(r2, r1)     // Catch:{ Exception -> 0x010a }
            com.didichuxing.bigdata.p174dp.locsdk.DLog.m36225d(r0)     // Catch:{ Exception -> 0x010a }
        L_0x00fc:
            if (r4 == 0) goto L_0x0108
            android.telephony.CellLocation r4 = (android.telephony.CellLocation) r4     // Catch:{ Exception -> 0x010a }
            r12.f48451k = r4     // Catch:{ Exception -> 0x010a }
            r12.m36280a((android.telephony.CellLocation) r4, (java.util.List<com.didichuxing.bigdata.p174dp.locsdk.Cgi>) r6)     // Catch:{ Exception -> 0x010a }
            com.didichuxing.bigdata.p174dp.locsdk.utils.OmegaUtils.trackGetSimCgi(r8, r3, r7)     // Catch:{ Exception -> 0x010a }
        L_0x0108:
            r4 = r6
            goto L_0x0115
        L_0x010a:
        ...
        L_0x0122:
            return r4
        */
        throw new UnsupportedOperationException("Method not decompiled: com.didichuxing.bigdata.p174dp.locsdk.impl.p175v3.CellManager.m36287c():java.util.List");
    }

    /* renamed from: d */
    private Class<?> m36290d() {
    ...
    /* renamed from: a */
    private List<Cgi> m36276a(List<?> list) {
        int i;
                    ...
                    if (!(i == 0 || cellSignalStrength == null)) {
                        ...
                        if (i == 2) {
                            if (cgiUseful((CellLocation) cdmaCellLocation)) {
                                if (arrayList.size() == 0) {
                                    this.f48451k = cdmaCellLocation;
                                }
                                Cgi a = m36275a((Object) cdmaCellLocation, i);
                                if (dbm > -113 && dbm < 0) {
                                    a.sig = dbm;
                                }
                                if (a != null) {
                                    DLog.m36225d(this.f48452l + "cdma" + a.toString());
                                    arrayList.add(a);
                                }
                            }
                        } else if (cgiUseful((CellLocation) gsmCellLocation2)) {
                            if (arrayList.size() == 0) {
                                this.f48451k = gsmCellLocation2;
                            }
                            Cgi a2 = m36273a((CellLocation) gsmCellLocation2, i);
                            if (a2 != null) {
                                if (dbm > -113 && dbm < 0) {
                                    try {
                                        a2.sig = dbm;
                                ...
                                DLog.m36225d(this.f48452l + "other" + a2.toString());
                                arrayList.add(a2);
                            }
                        }
                    }
    ...
    /* renamed from: a */
    private Cgi m36273a(CellLocation cellLocation, int i) {
        GsmCellLocation gsmCellLocation = (GsmCellLocation) cellLocation;
        Cgi cgi = new Cgi();
        String[] mccMnc = Utils.getMccMnc(this.f48447g);
        cgi.mcc = mccMnc[0];
        cgi.mnc_sid = mccMnc[1];
        cgi.lac_nid = gsmCellLocation.getLac();
        cgi.cid_bid = gsmCellLocation.getCid();
        cgi.sig = this.f48446f;
        cgi.type = i;
    ...
    /* renamed from: a */
    private Cgi m36274a(NeighboringCellInfo neighboringCellInfo) {
        if (Utils.getSdk() < 5) {
    ...
    public void m36291e() {
        ...
        this.f48449i = Utils.getTimeBoot();
    }
    ...
    private void m36294f() {
        ...
        L_0x0019:
            r0 = move-exception
            com.didichuxing.bigdata.p174dp.locsdk.utils.OmegaUtils.trackReflectError(r0, r1)
            java.lang.String r0 = r0.toString()
            com.didichuxing.bigdata.p174dp.locsdk.DLog.m36225d(r0)
            goto L_0x0037
        L_0x0025:
        ...
        L_0x0038:
            ...
            android.telephony.TelephonyManager r0 = r4.f48447g
            android.telephony.PhoneStateListener r2 = r4.f48450j
            r0.listen(r2, r1)
            goto L_0x0055
        L_0x0044:
            android.telephony.TelephonyManager r2 = r4.f48447g     // Catch:{ Exception -> 0x004d }
            android.telephony.PhoneStateListener r3 = r4.f48450j     // Catch:{ Exception -> 0x004d }
            r0 = r0 | r1
        ...
        L_0x0055:
            ...
            goto L_0x0089
        L_0x0064:
            android.content.Context r0 = r4.f48441a     // Catch:{ all -> 0x0081 }
            java.lang.Object r0 = com.didichuxing.bigdata.p174dp.locsdk.utils.Utils.getServ(r0, r1)     // Catch:{ all -> 0x0081 }
            r4.f48448h = r0     // Catch:{ all -> 0x0081 }
            goto L_0x0089
        L_0x006d:
            android.content.Context r0 = r4.f48441a     // Catch:{ all -> 0x0081 }
        ...
        L_0x00b1:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.didichuxing.bigdata.p174dp.locsdk.impl.p175v3.CellManager.m36294f():void");
    }

    /* access modifiers changed from: private */
    /* renamed from: a */
    public void m36278a(int i) {
        if (i == -113) {
            this.f48446f = Const.iDefCgiSig;
            return;
        }
        this.f48446f = i;
        int i2 = this.f48443c;
        if ((i2 == 1 || i2 == 2 || i2 == 3 || i2 == 4) && this.f48444d != null && !this.f48444d.isEmpty()) {
            try {
                this.f48444d.get(0).sig = this.f48446f;
            } catch (Exception e) {
                DLog.m36225d(e.toString());
            }
        }
    ...
    /* access modifiers changed from: private */
    /* renamed from: a */
    public int m36269a(SignalStrength signalStrength) {
        if (signalStrength.isGsm()) {
            int c = m36286c(signalStrength);
            if (c != Integer.MAX_VALUE) {
                return c;
            }
            if (!m36292e(signalStrength)) {
                return m36293f(signalStrength);
            }
            if (m36282b(signalStrength) == Integer.MAX_VALUE) {
                return m36289d(signalStrength);
            }
            return m36282b(signalStrength);
        }
    ...
    /* renamed from: d */
    private int m36289d(SignalStrength signalStrength) {
    ...
    /* renamed from: e */
    private boolean m36292e(SignalStrength signalStrength) {
        int f = m36293f(signalStrength);
        return f == Integer.MAX_VALUE || f > -25 || f < -110;
    }

    /* renamed from: f */
    private int m36293f(SignalStrength signalStrength) {
