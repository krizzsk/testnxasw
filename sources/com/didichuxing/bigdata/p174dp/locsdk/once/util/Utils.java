...
/* renamed from: com.didichuxing.bigdata.dp.locsdk.once.util.Utils */
public class Utils {

    /* renamed from: a */
    private static int f48816a = 0;

    /* renamed from: b */
    private static int f48817b = 1;

    /* renamed from: c */
    private static boolean f48818c = false;

    /* renamed from: d */
    private static boolean f48819d = false;

    /* renamed from: e */
    private static volatile String f48820e;

    /* renamed from: f */
    private static String[] f48821f;
    ...
    public static String[] getMccMnc(TelephonyManager telephonyManager) {
        ...
        if (!strArr2[0].equals("0") && !strArr2[1].equals("0")) {
            f48821f = strArr2;
            return strArr2;
        } else if (!strArr2[0].equals("0") || !strArr2[1].equals("0") || (strArr = f48821f) == null) {
            return strArr2;
        } else {
    ...
    /* renamed from: com.didichuxing.bigdata.dp.locsdk.once.util.Utils$1 */
    static /* synthetic */ class C159881 {

        /* renamed from: $SwitchMap$com$didichuxing$bigdata$dp$locsdk$Config$LocatePermissonStrategy */
        static final /* synthetic */ int[] f48822xbd3682fa;
        ...
        static {
            ...
            L_0x0012:
                int[] r0 = f48822xbd3682fa     // Catch:{ NoSuchFieldError -> 0x001d }
            ...
            L_0x001d:
                int[] r0 = f48822xbd3682fa     // Catch:{ NoSuchFieldError -> 0x0028 }
            ...
            L_0x0028:
                int[] r0 = f48822xbd3682fa     // Catch:{ NoSuchFieldError -> 0x0033 }
            ...
            L_0x0033:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.didichuxing.bigdata.p174dp.locsdk.once.util.Utils.C159881.<clinit>():void");
        }
    }

    public static boolean isPermissionStrategyAllowed(Context context) {
        int i = C159881.f48822xbd3682fa[Config.sPermissionStrategy.ordinal()];
        if (i == 1) {
            return true;
        }
        if (i == 2) {
    ...
    /* renamed from: a */
    static boolean m36638a(Location location) {
    ...
    public static String getChipInfo() {
        if (f48820e == null) {
            f48820e = executeShell("getprop", "ro.board.platform");
        }
        return f48820e;
    }
