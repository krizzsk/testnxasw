...
/* renamed from: com.didichuxing.bigdata.dp.locsdk.once.Utils */
public class Utils {

    /* renamed from: a */
    private static int f48782a = 0;

    /* renamed from: b */
    private static int f48783b = 1;

    /* renamed from: c */
    private static boolean f48784c = false;

    /* renamed from: d */
    private static boolean f48785d = false;

    /* renamed from: e */
    private static volatile String f48786e;

    /* renamed from: f */
    private static String[] f48787f;
    ...
    public static boolean isLocatePermissionGrantedForWifiScan(Context context) {
        return isLocateAllTheTimePermissionGranted(context);
    }
    ...
    public static String[] getMccMnc(TelephonyManager telephonyManager) {
        ...
        if (!strArr2[0].equals("0") && !strArr2[1].equals("0")) {
            f48787f = strArr2;
            return strArr2;
        } else if (!strArr2[0].equals("0") || !strArr2[1].equals("0") || (strArr = f48787f) == null) {
            return strArr2;
        } else {
    ...
    public static int checkSystemPermission(Context context, String str) {
        try {
            ...
            DLog.m36225d("checkSystemPermission-->nlp" + (System.currentTimeMillis() - currentTimeMillis));
    ...
    /* renamed from: com.didichuxing.bigdata.dp.locsdk.once.Utils$1 */
    static /* synthetic */ class C159851 {

        /* renamed from: $SwitchMap$com$didichuxing$bigdata$dp$locsdk$Config$LocatePermissonStrategy */
        static final /* synthetic */ int[] f48788xbd3682fa;
        ...
        static {
            ...
            L_0x0012:
                int[] r0 = f48788xbd3682fa     // Catch:{ NoSuchFieldError -> 0x001d }
            ...
            L_0x001d:
                int[] r0 = f48788xbd3682fa     // Catch:{ NoSuchFieldError -> 0x0028 }
            ...
            L_0x0028:
                int[] r0 = f48788xbd3682fa     // Catch:{ NoSuchFieldError -> 0x0033 }
            ...
            L_0x0033:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.didichuxing.bigdata.p174dp.locsdk.once.Utils.C159851.<clinit>():void");
        }
    }

    public static boolean isPermissionStrategyAllowed(Context context) {
        int i = C159851.f48788xbd3682fa[Config.sPermissionStrategy.ordinal()];
        if (i == 1) {
            return true;
        }
        if (i == 2) {
    ...
    /* renamed from: a */
    static boolean m36617a(Location location) {
    ...
    public static String getChipInfo() {
        if (f48786e == null) {
            f48786e = executeShell("getprop", "ro.board.platform");
        }
        return f48786e;
    }
