...
/* renamed from: com.didichuxing.bigdata.dp.locsdk.Utils */
public class Utils {

    /* renamed from: a */
    private static int f48394a = 0;

    /* renamed from: b */
    private static int f48395b = 1;

    /* renamed from: c */
    private static boolean f48396c = false;

    /* renamed from: d */
    private static boolean f48397d = false;

    /* renamed from: e */
    private static volatile String f48398e;

    /* renamed from: f */
    private static String[] f48399f;
    ...
    public static String[] getMccMnc(TelephonyManager telephonyManager) {
        ...
        if (!strArr2[0].equals("0") && !strArr2[1].equals("0")) {
            f48399f = strArr2;
            return strArr2;
        } else if (!strArr2[0].equals("0") || !strArr2[1].equals("0") || (strArr = f48399f) == null) {
            return strArr2;
        } else {
    ...
    /* renamed from: com.didichuxing.bigdata.dp.locsdk.Utils$1 */
    static /* synthetic */ class C159051 {

        /* renamed from: $SwitchMap$com$didichuxing$bigdata$dp$locsdk$Config$LocatePermissonStrategy */
        static final /* synthetic */ int[] f48400xbd3682fa;
        ...
        static {
            ...
            L_0x0012:
                int[] r0 = f48400xbd3682fa     // Catch:{ NoSuchFieldError -> 0x001d }
            ...
            L_0x001d:
                int[] r0 = f48400xbd3682fa     // Catch:{ NoSuchFieldError -> 0x0028 }
            ...
            L_0x0028:
                int[] r0 = f48400xbd3682fa     // Catch:{ NoSuchFieldError -> 0x0033 }
            ...
            L_0x0033:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.didichuxing.bigdata.p174dp.locsdk.Utils.C159051.<clinit>():void");
        }
    }

    public static boolean isPermissionStrategyAllowed(Context context) {
        int i = C159051.f48400xbd3682fa[Config.sPermissionStrategy.ordinal()];
        if (i == 1) {
            return true;
        }
        if (i == 2) {
    ...
    /* renamed from: a */
    static boolean m36239a(Location location) {
    ...
    public static String getChipInfo() {
        if (f48398e == null) {
            f48398e = executeShell("getprop", "ro.board.platform");
        }
        return f48398e;
    }
