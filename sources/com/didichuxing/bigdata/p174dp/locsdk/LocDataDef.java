...
/* renamed from: com.didichuxing.bigdata.dp.locsdk.LocDataDef */
public class LocDataDef {
    ...
    /* renamed from: com.didichuxing.bigdata.dp.locsdk.LocDataDef$LocWifiInfo */
    ...
    /* renamed from: com.didichuxing.bigdata.dp.locsdk.LocDataDef$LocCellInfo */
    ...
    /* renamed from: com.didichuxing.bigdata.dp.locsdk.LocDataDef$LocNeighboringCellInfo */
    ...
    /* renamed from: com.didichuxing.bigdata.dp.locsdk.LocDataDef$LocPreCellInfo */
    public static class LocPreCellInfo implements Serializable {
        public long cellid_bsid;

        /* renamed from: dt */
        public long f48367dt;
        public long lac_nid;
        public long mcc;
        public long mnc_sid;
        public long rssi;
        ...
        public String toJson() {
            return Const.joLeft + Const.js_req_cell_mcc + ":" + this.mcc + "," + Const.js_req_cell_mnc_sid + ":" + this.mnc_sid + "," + Const.js_req_cell_lac_nid + ":" + this.lac_nid + "," + Const.js_req_cell_cellid_bsid + ":" + this.cellid_bsid + "," + "\"type\"" + ":" + this.type + "," + "\"dt\"" + ":" + this.f48367dt + "," + "\"rssi\"" + ":" + this.rssi + "}";
        }
    }
}
