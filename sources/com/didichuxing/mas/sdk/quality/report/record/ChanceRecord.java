...
public class ChanceRecord extends Record {
    public void setFileType(FileType fileType) {
        if (fileType != null) {
            put(Constants.JSON_KEY_FILE_TYPE, Integer.valueOf(fileType.getType()));
        }
    }
    ...
    public void takeStorageInfo() {
        ...
        put("isi", "disk_total:" + externalStorage[0] + "\ndisk_free:" + externalStorage[1]);
    }
    ...
    public void addScreenshot(android.graphics.Bitmap r4) {
        /*
            ...
            int r2 = com.didichuxing.mas.sdk.quality.report.MASConfig.PIC_COMPRESS_QUALITY     // Catch:{ all -> 0x0024 }
            boolean r4 = r4.compress(r0, r2, r1)     // Catch:{ all -> 0x0024 }
            if (r4 != 0) goto L_0x0019
            java.lang.String r4 = "addScreenshot(): Bitmap compress fail!"
            com.didichuxing.mas.sdk.quality.report.utils.OLog.m37867w(r4)     // Catch:{ all -> 0x0024 }
        ...
        L_0x0025:
            ...
            com.didichuxing.mas.sdk.quality.report.utils.OLog.m37867w(r4)     // Catch:{ all -> 0x0030 }
        ...
        L_0x0036:
            throw r4
        */
        throw new UnsupportedOperationException("Method not decompiled: com.didichuxing.mas.sdk.quality.report.record.ChanceRecord.addScreenshot(android.graphics.Bitmap):void");
    }
    ...
    public void imageDeepCompress() {
        try {
            ...
            if (list.size() != 0) {
                ...
                for (byte[] bArr : list) {
                    ...
                    if (decodeByteArray != null) {
                        ...
                        matrix.postScale(MASConfig.CRASH_SCREENSHOT_SCALE, MASConfig.CRASH_SCREENSHOT_SCALE);
                        Bitmap createBitmap = Bitmap.createBitmap(decodeByteArray, 0, 0, decodeByteArray.getWidth(), decodeByteArray.getHeight(), matrix, true);
                        ByteArrayOutputStream byteArrayOutputStream = new ByteArrayOutputStream();
                        if (!createBitmap.compress(Bitmap.CompressFormat.JPEG, MASConfig.PIC_COMPRESS_QUALITY, byteArrayOutputStream)) {
                            OLog.m37867w("addScreenshot(): Bitmap compress fail! when deep compressed");
                            return;
                        }
            ...
            OLog.m37868w("imageDeepCompress fail!", th);
        }
    }
