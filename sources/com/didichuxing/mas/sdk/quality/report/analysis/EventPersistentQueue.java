...
public class EventPersistentQueue {
    ...
    private static void startPersistentThread() {
        EventPersistentThread instance = EventPersistentThread.getInstance();
        try {
            if (!instance.isAlive()) {
                instance.start();
            }
    ...
    private static class EventPersistentThread extends Thread {
        private EventPersistentThread() {
            super("MAS.EventThread");
        }

        public static EventPersistentThread getInstance() {
            return InnerHolder.INASTANCE;
        }

        private static class InnerHolder {
            /* access modifiers changed from: private */
            public static EventPersistentThread INASTANCE = new EventPersistentThread();
        ...
        public void run() {
            /*
                r6 = this;
            L_0x0000:
                com.didichuxing.mas.sdk.quality.report.analysis.EventPersistentQueue$ArrayBlockingQueue r0 = com.didichuxing.mas.sdk.quality.report.analysis.EventPersistentQueue.sQueue     // Catch:{ all -> 0x0000 }
                java.lang.Object r0 = r0.take()     // Catch:{ all -> 0x0000 }
                com.didichuxing.mas.sdk.quality.report.record.Event r0 = (com.didichuxing.mas.sdk.quality.report.record.Event) r0     // Catch:{ all -> 0x0000 }
                long r1 = r0.getSeq()     // Catch:{ all -> 0x0000 }
                java.lang.String r3 = com.didichuxing.mas.sdk.quality.report.perforence.RuntimeCheck.getProcessNameInMD5()     // Catch:{ all -> 0x0000 }
                long r3 = com.didichuxing.mas.sdk.quality.report.collector.PersistentInfoCollector.getLastSendEventSeq(r3)     // Catch:{ all -> 0x0000 }
                boolean r5 = com.didichuxing.mas.sdk.quality.report.analysis.EventPersistentQueue.isSamePid(r1, r3)     // Catch:{ all -> 0x0000 }
                ...
                if (r5 <= 0) goto L_0x0000
            L_0x0026:
                com.didichuxing.mas.sdk.quality.report.analysis.EventStorage.push(r0)     // Catch:{ all -> 0x0000 }
                goto L_0x0000
            */
            throw new UnsupportedOperationException("Method not decompiled: com.didichuxing.mas.sdk.quality.report.analysis.EventPersistentQueue.EventPersistentThread.run():void");
        }
    }
