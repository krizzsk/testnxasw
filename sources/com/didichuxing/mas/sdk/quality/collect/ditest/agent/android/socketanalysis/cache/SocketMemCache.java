...
public class SocketMemCache {
    ...
    /* renamed from: j */
    private static SocketMemCache f50603j;
    public static TransactionInfo mSocketMemoryCache;

    /* renamed from: a */
    private final String f50604a = "tls";

    /* renamed from: b */
    private final String f50605b = "ver";

    /* renamed from: c */
    private final String f50606c = "seqid";

    /* renamed from: d */
    private final String f50607d = "time";

    /* renamed from: e */
    private final String f50608e = "up";

    /* renamed from: f */
    private final String f50609f = "down";

    /* renamed from: g */
    private final String f50610g = "type";

    /* renamed from: h */
    private final String f50611h = "uc";

    /* renamed from: i */
    private final String f50612i = "dc";
    ...
    public static synchronized SocketMemCache getMemCacheInstance() {
        ...
        synchronized (SocketMemCache.class) {
            if (f50603j == null) {
                f50603j = new SocketMemCache();
            }
            socketMemCache = f50603j;
        }
    ...
    public void uploadEventImmediatelyByMemoryCache() {
        ...
        L_0x0019:
            ...
            com.didichuxing.mas.sdk.quality.report.utils.OLog.m37861e(r1)     // Catch:{ all -> 0x0022 }
        L_0x001e:
