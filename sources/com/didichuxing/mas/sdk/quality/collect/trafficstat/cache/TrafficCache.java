...
public class TrafficCache {
    ...
    /* renamed from: b */
    private static TrafficCache f50779b;

    /* renamed from: a */
    private File f50780a;
    ...
    private TrafficCache() {
        this.f50780a = null;
        this.f50781c = "new_traffic.log";
        this.f50780a = new File(TrafficUtils.getTrafficCacheDir(), this.f50781c);
    }
    ...
    public static synchronized TrafficCache getTrafficCacheInstance() {
        ...
        synchronized (TrafficCache.class) {
            if (f50779b == null) {
                f50779b = new TrafficCache();
            }
            trafficCache = f50779b;
        }
        return trafficCache;
    }
    ...
    public java.util.Map<java.lang.String, java.lang.Object> readMapDataFromFile() {
        /*
            ...
            r0.<init>()
            java.io.File r1 = r8.f50780a
            r2 = 0
            if (r1 == 0) goto L_0x00cb
            boolean r1 = r1.exists()
            if (r1 == 0) goto L_0x00cb
            boolean r1 = com.didichuxing.mas.sdk.quality.collect.trafficstat.utils.TrafficUtils.hasFileExpiration()
            if (r1 == 0) goto L_0x0018
            goto L_0x00cb
        L_0x0018:
            java.io.File r1 = r8.f50780a     // Catch:{ Exception -> 0x00a6 }
            ...
            java.io.File r5 = r8.f50780a     // Catch:{ all -> 0x0096 }
            r4.<init>(r5)     // Catch:{ all -> 0x0096 }
            r3.<init>(r4)     // Catch:{ all -> 0x0096 }
        L_0x0027:
            java.lang.String r2 = r3.readLine()     // Catch:{ all -> 0x00a2 }
            if (r2 == 0) goto L_0x008e
            java.util.Map r2 = com.didichuxing.mas.sdk.quality.report.utils.JsonUtil.json2Map(r2)     // Catch:{ Exception -> 0x0074 }
            if (r2 == 0) goto L_0x0027
            boolean r4 = r2.isEmpty()     // Catch:{ all -> 0x00a2 }
            if (r4 != 0) goto L_0x0027
            boolean r4 = com.didichuxing.mas.sdk.quality.collect.trafficstat.utils.TrafficUtils.containsAllKey(r2)     // Catch:{ all -> 0x00a2 }
        ...
        L_0x0048:
            ...
            java.util.Map r4 = r8.m37803a(r4, r6)     // Catch:{ all -> 0x00a2 }
        L_0x0070:
        ...
        L_0x0074:
            ...
            com.didichuxing.mas.sdk.quality.report.utils.OLog.m37861e(r2)     // Catch:{ all -> 0x00a2 }
            goto L_0x0027
        L_0x008e:
            monitor-exit(r1)     // Catch:{ all -> 0x00a2 }
            r3.close()     // Catch:{ IOException -> 0x00b8 }
            r8.m37804a()     // Catch:{ IOException -> 0x00b8 }
            goto L_0x00bc
        L_0x0096:
            r3 = move-exception
            r7 = r3
        ...
        L_0x00a7:
            ...
            com.didichuxing.mas.sdk.quality.report.analysis.Tracker.trackGood(r3, r1)     // Catch:{ all -> 0x00a4 }
        ...
        L_0x00bd:
            ...
            r8.m37804a()     // Catch:{ IOException -> 0x00c6 }
            goto L_0x00ca
        L_0x00c6:
            r1 = move-exception
            r1.printStackTrace()
        ...
        L_0x00cb:
            ...
            return r2
        */
        throw new UnsupportedOperationException("Method not decompiled: com.didichuxing.mas.sdk.quality.collect.trafficstat.cache.TrafficCache.readMapDataFromFile():java.util.Map");
    }

    /* renamed from: a */
    private Map<String, Object> m37803a(Map<String, Object> map, Map<String, Object> map2) {
    ...
    public void writeCacheFileAsync(java.util.Map<java.lang.String, java.lang.Object> r7) {
        /*
            ...
            return
        L_0x0007:
            java.io.File r0 = r6.f50780a
            if (r0 == 0) goto L_0x0017
            boolean r0 = r0.exists()
            if (r0 == 0) goto L_0x0017
            boolean r0 = com.didichuxing.mas.sdk.quality.collect.trafficstat.utils.TrafficUtils.hasFileExpiration()
        ...
        L_0x001a:
            ...
            java.io.File r4 = r6.f50780a     // Catch:{ Exception -> 0x0058 }
            r5 = 1
            ...
            java.lang.String r7 = com.didichuxing.mas.sdk.quality.report.utils.JsonUtil.map2Json(r7)     // Catch:{ Exception -> 0x0053, all -> 0x0050 }
        ...
        L_0x004c:
            com.didichuxing.mas.sdk.quality.report.utils.OLog.m37867w(r7)     // Catch:{ all -> 0x0078 }
            goto L_0x006a
        L_0x0050:
            r7 = move-exception
            r1 = r2
        ...
        L_0x0059:
            ...
            com.didichuxing.mas.sdk.quality.report.analysis.Tracker.trackGood(r2, r7)     // Catch:{ all -> 0x0056 }
        ...
        L_0x0072:
            ...
            com.didichuxing.mas.sdk.quality.report.utils.OLog.m37867w(r1)     // Catch:{ all -> 0x0078 }
        L_0x0077:
        ...
        L_0x0078:
            ...
            throw r7
        */
        throw new UnsupportedOperationException("Method not decompiled: com.didichuxing.mas.sdk.quality.collect.trafficstat.cache.TrafficCache.writeCacheFileAsync(java.util.Map):void");
    }
    ...
    /* renamed from: a */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    private void m37804a() {
        /*
            r6 = this;
            java.io.File r0 = new java.io.File
            java.io.File r1 = com.didichuxing.mas.sdk.quality.collect.trafficstat.utils.TrafficUtils.getTrafficCacheDir()
            java.lang.String r2 = r6.f50781c
            r0.<init>(r1, r2)
            r6.f50780a = r0
            monitor-enter(r0)
            r1 = 0
            ...
            java.io.File r4 = r6.f50780a     // Catch:{ FileNotFoundException -> 0x0047, IOException -> 0x0038, all -> 0x0033 }
            ...
            com.didichuxing.mas.sdk.quality.collect.trafficstat.utils.TrafficUtils.savefileCreatedTime()     // Catch:{ FileNotFoundException -> 0x0031, IOException -> 0x002f }
        ...
        L_0x0064:
            ...
            throw r1
        */
        throw new UnsupportedOperationException("Method not decompiled: com.didichuxing.mas.sdk.quality.collect.trafficstat.cache.TrafficCache.m37804a():void");
    }
}
