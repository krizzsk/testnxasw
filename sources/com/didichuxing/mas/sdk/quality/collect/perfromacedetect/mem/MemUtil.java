...
public class MemUtil {
    ...
    public static String getSimpleRuntimeMemInfo() {
        return " Runtime (From: java.lang.Runtime)\n  TotalMemory:" + String.format("%15s", new Object[]{Long.valueOf((Runtime.getRuntime().totalMemory() >> 10) >> 10)}) + "m\n  FreeMemory: " + String.format("%15s", new Object[]{Long.valueOf((Runtime.getRuntime().freeMemory() >> 10) >> 10)}) + "m\n  MaxMemory: " + String.format("%15s", new Object[]{Long.valueOf((Runtime.getRuntime().maxMemory() >> 10) >> 10)}) + "m\n -\n";
    }
