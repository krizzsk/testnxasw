...
class CpuSampler extends AbstractSampler {
    ...
    public boolean isCpuBusy(long j, long j2) {
        ...
        synchronized (this.mCpuInfoEntries) {
            long j5 = 0;
            for (Map.Entry<Long, String> key : this.mCpuInfoEntries.entrySet()) {
                long longValue = ((Long) key.getKey()).longValue();
                if (j3 < longValue && longValue < j4) {
                    if (j5 != 0 && longValue - j5 > ((long) this.BUSY_TIME)) {
                        return true;
                    }
                    j5 = longValue;
                }
    ...
    public void doSample() {
        /*
            r10 = this;
            boolean r0 = r10.hasReadPermission()
        ...
        L_0x0007:
            ...
            r2 = r4
        L_0x0024:
            int r5 = r10.mPid     // Catch:{ all -> 0x0067 }
            if (r5 != 0) goto L_0x002e
            int r5 = android.os.Process.myPid()     // Catch:{ all -> 0x0067 }
            r10.mPid = r5     // Catch:{ all -> 0x0067 }
        L_0x002e:
            ...
            int r9 = r10.mPid     // Catch:{ all -> 0x0067 }
            r8.append(r9)     // Catch:{ all -> 0x0067 }
        ...
        L_0x005c:
            r4 = r0
        L_0x005d:
            r10.parse(r2, r4)     // Catch:{ all -> 0x0068 }
        ...
        L_0x0073:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.didichuxing.alpha.lag.CpuSampler.doSample():void");
    }
                ...
                if (this.mTotalLast != 0) {
                    ...
                    synchronized (this.mCpuInfoEntries) {
                        ...
                        if (this.mCpuInfoEntries.size() > 10) {
                            ...
                            if (it.hasNext()) {
                                this.mCpuInfoEntries.remove((Long) it.next().getKey());
                            }
                        }
                    }
                } else {
