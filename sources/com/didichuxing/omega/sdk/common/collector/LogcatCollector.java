...
public class LogcatCollector {
    public static String geEventLogcat() {
        return dumpLogcat(OmegaConfig.LOGCAT_TAIL_COUNT, (Consumer<String>) null, "events");
    }

    public static String getLogcat() {
        return dumpLogcat(OmegaConfig.LOGCAT_TAIL_COUNT, (Consumer<String>) null, NachoConstants.NACHO_ENTRYPOINT_NAME, "system", "events", "crash");
    }
    ...
    public static java.lang.String getLogcat(int r6, java.lang.String[] r7) {
        /*
            ...
            boolean r1 = com.didichuxing.omega.sdk.common.OmegaConfig.LOGCAT_ONLY_MY_APP
            r2 = 0
        ...
        L_0x0022:
            ...
            com.didichuxing.omega.sdk.common.collector.LogcatCollector$1 r2 = new com.didichuxing.omega.sdk.common.collector.LogcatCollector$1     // Catch:{ all -> 0x0085 }
        ...
        L_0x0086:
            ...
            com.didichuxing.omega.sdk.common.utils.OLog.m38212w(r6)     // Catch:{ all -> 0x009a }
        ...
        L_0x00a5:
            throw r6
        */
        throw new UnsupportedOperationException("Method not decompiled: com.didichuxing.omega.sdk.common.collector.LogcatCollector.getLogcat(int, java.lang.String[]):java.lang.String");
    }
    ...
    /* JADX WARNING: Removed duplicated region for block: B:78:0x012a A[SYNTHETIC] */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public static java.lang.String dumpLogcat(int r19, com.didichuxing.omega.sdk.common.utils.Consumer<java.lang.String> r20, java.lang.String... r21) {
        /*
            r1 = r20
            r2 = r21
        ...
        L_0x0054:
            ...
            java.lang.String r13 = "com.didichuxing.omega.sdk.common.collector.LogcatCollector"
            com.didi.sdk.apm.SystemUtils.log(r9, r10, r11, r12, r13, r14)
            r8 = 0
            java.lang.Runtime r9 = java.lang.Runtime.getRuntime()     // Catch:{ Exception -> 0x0118, all -> 0x0114 }
            java.lang.String[] r10 = new java.lang.String[r5]     // Catch:{ Exception -> 0x0118, all -> 0x0114 }
            java.lang.Object[] r0 = r0.toArray(r10)     // Catch:{ Exception -> 0x0118, all -> 0x0114 }
            java.lang.String[] r0 = (java.lang.String[]) r0     // Catch:{ Exception -> 0x0118, all -> 0x0114 }
            java.lang.Process r9 = r9.exec(r0)     // Catch:{ Exception -> 0x0118, all -> 0x0114 }
            java.io.InputStreamReader r0 = new java.io.InputStreamReader     // Catch:{ Exception -> 0x010f, all -> 0x010a }
            java.io.InputStream r10 = r9.getInputStream()     // Catch:{ Exception -> 0x010f, all -> 0x010a }
            r0.<init>(r10)     // Catch:{ Exception -> 0x010f, all -> 0x010a }
            java.io.InputStreamReader r10 = new java.io.InputStreamReader     // Catch:{ Exception -> 0x010f, all -> 0x010a }
            java.io.InputStream r11 = r9.getErrorStream()     // Catch:{ Exception -> 0x010f, all -> 0x010a }
            r10.<init>(r11)     // Catch:{ Exception -> 0x010f, all -> 0x010a }
            java.io.BufferedReader r11 = new java.io.BufferedReader     // Catch:{ Exception -> 0x010f, all -> 0x010a }
            r11.<init>(r0)     // Catch:{ Exception -> 0x010f, all -> 0x010a }
        ...
        L_0x0092:
            java.lang.String r12 = r11.readLine()     // Catch:{ Exception -> 0x0107, all -> 0x0104 }
            java.lang.String r13 = "\n"
            if (r12 == 0) goto L_0x00a6
            r0.append(r12)     // Catch:{ Exception -> 0x0107, all -> 0x0104 }
            r0.append(r13)     // Catch:{ Exception -> 0x0107, all -> 0x0104 }
            if (r1 == 0) goto L_0x0092
            r1.accept(r12)     // Catch:{ Exception -> 0x0107, all -> 0x0104 }
            goto L_0x0092
        L_0x00a6:
            boolean r12 = android.text.TextUtils.isEmpty(r0)     // Catch:{ Exception -> 0x0107, all -> 0x0104 }
            if (r12 != 0) goto L_0x00b6
            java.lang.String r0 = r0.toString()     // Catch:{ Exception -> 0x0107, all -> 0x0104 }
            r3.append(r0)     // Catch:{ Exception -> 0x0107, all -> 0x0104 }
            if (r9 == 0) goto L_0x00f9
            goto L_0x00f6
        L_0x00b6:
            if (r7 == 0) goto L_0x00f4
            java.io.BufferedReader r12 = new java.io.BufferedReader     // Catch:{ Exception -> 0x0107, all -> 0x0104 }
            r12.<init>(r10)     // Catch:{ Exception -> 0x0107, all -> 0x0104 }
            java.lang.StringBuilder r0 = new java.lang.StringBuilder     // Catch:{ Exception -> 0x00f2, all -> 0x00f0 }
            r0.<init>()     // Catch:{ Exception -> 0x00f2, all -> 0x00f0 }
        L_0x00c2:
            java.lang.String r8 = r12.readLine()     // Catch:{ Exception -> 0x00f2, all -> 0x00f0 }
            if (r8 == 0) goto L_0x00cf
            r0.append(r8)     // Catch:{ Exception -> 0x00f2, all -> 0x00f0 }
            r0.append(r13)     // Catch:{ Exception -> 0x00f2, all -> 0x00f0 }
            goto L_0x00c2
        L_0x00cf:
            r12.close()     // Catch:{ Exception -> 0x00f2, all -> 0x00f0 }
            boolean r8 = android.text.TextUtils.isEmpty(r0)     // Catch:{ Exception -> 0x00f2, all -> 0x00f0 }
            if (r8 != 0) goto L_0x00ea
            java.lang.String r14 = "Logcat"
            java.lang.String r15 = r0.toString()     // Catch:{ Exception -> 0x00f2, all -> 0x00f0 }
            r13 = 3
            r16 = 0
            java.lang.String r17 = "com.didichuxing.omega.sdk.common.collector.LogcatCollector"
            r18 = 178(0xb2, float:2.5E-43)
            com.didi.sdk.apm.SystemUtils.log(r13, r14, r15, r16, r17, r18)     // Catch:{ Exception -> 0x00f2, all -> 0x00f0 }
            r6 = 1
            r7 = 0
        L_0x00ea:
        ...
        L_0x011b:
            ...
            java.lang.String r0 = r0.getLocalizedMessage()     // Catch:{ all -> 0x0132 }
        ...
        L_0x0138:
            ...
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.didichuxing.omega.sdk.common.collector.LogcatCollector.dumpLogcat(int, com.didichuxing.omega.sdk.common.utils.Consumer, java.lang.String[]):java.lang.String");
    }
    ...
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public static com.didichuxing.omega.sdk.common.collector.LogcatCollector.LogcatBuffer getLogcat_old(int r8, java.lang.String r9) {
        /*
            int r0 = android.os.Process.myPid()
            boolean r1 = com.didichuxing.omega.sdk.common.OmegaConfig.LOGCAT_ONLY_MY_APP
            r2 = 0
        ...
        L_0x0022:
            ...
            com.didichuxing.omega.sdk.common.collector.LogcatCollector$3 r2 = new com.didichuxing.omega.sdk.common.collector.LogcatCollector$3     // Catch:{ all -> 0x00ad }
        ...
        L_0x00ae:
            ...
            com.didichuxing.omega.sdk.common.utils.OLog.m38212w(r8)     // Catch:{ all -> 0x00c8 }
        ...
        L_0x00bd:
            r1 = r5
        L_0x00be:
            com.didichuxing.omega.sdk.common.collector.LogcatCollector$LogcatBuffer r8 = new com.didichuxing.omega.sdk.common.collector.LogcatCollector$LogcatBuffer
        ...
        L_0x00d3:
            throw r8
        */
        throw new UnsupportedOperationException("Method not decompiled: com.didichuxing.omega.sdk.common.collector.LogcatCollector.getLogcat_old(int, java.lang.String):com.didichuxing.omega.sdk.common.collector.LogcatCollector$LogcatBuffer");
    }
    ...
    public static java.lang.String getLogcatWithAnrReason(long r6) {
        /*
            ...
            com.didichuxing.omega.sdk.common.collector.LogcatCollector$4 r2 = new com.didichuxing.omega.sdk.common.collector.LogcatCollector$4     // Catch:{ all -> 0x006b }
        ...
        L_0x006c:
            java.lang.String r6 = "LogcatCollector.getLogcat failed!"
            com.didichuxing.omega.sdk.common.utils.OLog.m38212w(r6)     // Catch:{ all -> 0x0091 }
        ...
        L_0x009c:
            throw r6
        */
        throw new UnsupportedOperationException("Method not decompiled: com.didichuxing.omega.sdk.common.collector.LogcatCollector.getLogcatWithAnrReason(long):java.lang.String");
    }
