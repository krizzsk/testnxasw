...
public class SavedState {
    ...
    public SavedState(Context context) {
        this.PREFERENCE_FILE_PREFIX = Security.packageName(context) + "_omega_sdk";
        SharedPreferences sharedPreferences = SystemUtils.getSharedPreferences(context, getPreferenceFileName(Security.packageName(context)), 0);
        this.prefs = sharedPreferences;
        this.editor = sharedPreferences.edit();
    }

    public SavedState(Context context, String str) {
        this.PREFERENCE_FILE_PREFIX = Security.packageName(context) + str;
        SharedPreferences sharedPreferences = SystemUtils.getSharedPreferences(context, getPreferenceFileName(Security.packageName(context)), 0);
        this.prefs = sharedPreferences;
        this.editor = sharedPreferences.edit();
    }
