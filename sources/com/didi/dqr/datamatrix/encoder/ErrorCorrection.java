...
public final class ErrorCorrection {
    ...
    public static String encodeECC200(String str, SymbolInfo symbolInfo) {
        if (str.length() == symbolInfo.getDataCapacity()) {
            ...
            if (interleavedBlockCount == 1) {
                sb.append(m17238a(str, symbolInfo.getErrorCodewords()));
            } else {
                ...
                for (int i3 = 0; i3 < interleavedBlockCount; i3++) {
                    ...
                    String a = m17238a(sb2.toString(), iArr2[i3]);
                    int i5 = i3;
                    int i6 = 0;
                    while (i5 < iArr2[i3] * interleavedBlockCount) {
                        sb.setCharAt(symbolInfo.getDataCapacity() + i5, a.charAt(i6));
    ...
    /* renamed from: a */
    private static String m17238a(CharSequence charSequence, int i) {
        int i2 = 0;
        while (true) {
            int[] iArr = f20486a;
            if (i2 >= iArr.length) {
