...
public final class Version {
    ...
    /* renamed from: a */
    private static final Version[] f20467a = m17203b();
    ...
    /* renamed from: g */
    private final ECBlocks f20473g;
    ...
    /* renamed from: a */
    public ECBlocks mo63255a() {
        return this.f20473g;
    }

    public static Version getVersionForDimensions(int i, int i2) throws FormatException {
        if ((i & 1) == 0 && (i2 & 1) == 0) {
            for (Version version : f20467a) {
                if (version.f20469c == i && version.f20470d == i2) {
                    return version;
                }
            }
    ...
    public String toString() {
        return String.valueOf(this.f20468b);
    }

    /* renamed from: b */
    private static Version[] m17203b() {
