...
public class GlobalHistogramBinarizer extends Binarizer {
    ...
    /* renamed from: a */
    private static final int f20410a = 5;

    /* renamed from: b */
    private static final int f20411b = 3;

    /* renamed from: c */
    private static final int f20412c = 32;

    /* renamed from: d */
    private static final byte[] f20413d = new byte[0];

    /* renamed from: e */
    private byte[] f20414e = f20413d;

    /* renamed from: f */
    private final int[] f20415f = new int[32];
    ...
    public BitArray getBlackRow(int i, BitArray bitArray) throws NotFoundException {
        ...
        m17157a(width);
        byte[] row = luminanceSource.getRow(i, this.f20414e);
        int[] iArr = this.f20415f;
    ...
    public BitArray getRotatedBlackRow(int i, BitArray bitArray) throws NotFoundException {
        ...
        m17157a(width);
        byte[] row = rotateLuminanceSource.getRow(i, this.f20414e);
        int[] iArr = this.f20415f;
        for (int i2 = 0; i2 < width; i2++) {
            int i3 = (row[i2] & 255) >> 3;
            iArr[i3] = iArr[i3] + 1;
    ...
    public BitMatrix getBlackMatrix() throws NotFoundException {
        ...
        int[] iArr = this.f20415f;
        for (int i = 1; i < 5; i++) {
            byte[] row = luminanceSource.getRow((height * i) / 5, this.f20414e);
            int i2 = (width * 4) / 5;
    ...
    /* renamed from: a */
    private void m17157a(int i) {
        if (this.f20414e.length < i) {
            this.f20414e = new byte[i];
        }
    ...
    /* renamed from: a */
    private static int m17156a(int[] iArr) throws NotFoundException {
