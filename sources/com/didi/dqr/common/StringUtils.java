...
public final class StringUtils {
    ...
    /* renamed from: b */
    private static final String f20433b = "EUC_JP";

    /* renamed from: c */
    private static final String f20434c = "UTF8";

    /* renamed from: d */
    private static final String f20435d = "ISO8859_1";

    /* renamed from: e */
    private static final boolean f20436e;

    static {
        String name = Charset.defaultCharset().name();
        f20432a = name;
        f20436e = "SJIS".equalsIgnoreCase(name) || f20433b.equalsIgnoreCase(f20432a);
    }
    ...
    public static String guessEncoding(byte[] bArr, Map<DecodeHintType, ?> map) {
        ...
        if (z3 && (f20436e || i9 >= 3 || i >= 3)) {
            return "SJIS";
        }
        if (z && z3) {
            return (!(i9 == 2 && i2 == 2) && i10 * 10 < length) ? f20435d : "SJIS";
        }
        if (z) {
            return f20435d;
        }
