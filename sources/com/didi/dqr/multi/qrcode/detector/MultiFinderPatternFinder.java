...
final class MultiFinderPatternFinder extends FinderPatternFinder {
    ...
    /* renamed from: a */
    private static final FinderPatternInfo[] f20535a = new FinderPatternInfo[0];

    /* renamed from: b */
    private static final float f20536b = 180.0f;

    /* renamed from: c */
    private static final float f20537c = 9.0f;

    /* renamed from: d */
    private static final float f20538d = 0.05f;

    /* renamed from: e */
    private static final float f20539e = 0.5f;
    ...
    /* renamed from: a */
    private FinderPattern[][] m17305a() throws NotFoundException {
                ...
                if (finderPattern != null) {
                    ...
                    while (i3 < size - 1) {
                        ...
                        if (finderPattern2 != null) {
                            ...
                            float f = f20538d;
                            float f2 = 0.5f;
                            if (abs > 0.5f && estimatedModuleSize >= f20538d) {
                                break;
                            }
                            int i4 = i3 + 1;
                            while (i4 < size) {
    ...
    /* renamed from: a */
    public FinderPatternInfo[] mo63316a(Map<DecodeHintType, ?> map) throws NotFoundException {
        ...
        FinderPattern[][] a = m17305a();
        ArrayList arrayList = new ArrayList();
        for (FinderPattern[] finderPatternArr : a) {
            ResultPoint.orderBestPatterns(finderPatternArr);
