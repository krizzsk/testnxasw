...
final class C8474b {
    ...
    /* renamed from: b */
    static int m17611b(int i) throws WriterException {
        if (i <= 0) {
    ...
    /* renamed from: a */
    static String m17610a(CharSequence charSequence, int i) {
        int a = m17609a(i);
        ...
        for (int i2 = 0; i2 < length; i2++) {
            ...
            while (i3 >= 1) {
                cArr[i3] = (char) ((cArr[i3 - 1] + (929 - ((f20862a[i][i3] * charAt) % 929))) % 929);
                i3--;
            }
            cArr[0] = (char) ((929 - ((charAt * f20862a[i][0]) % 929)) % 929);
        }
