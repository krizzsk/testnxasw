...
public class GlobalOmegaUtils {
    public static void trackPayMethodSettingPageSW(Context context, int i) {
        ...
        hashMap.put("passenger_id", m29459a(context));
        hashMap.put("city_id", m29460b(context));
        hashMap.put("payment", "");
    ...
    public static void trackPayMethodSelectPageSwitchPayMethod(Context context, DidiGlobalPayMethodListData.Entrance entrance) {
        HashMap hashMap = new HashMap();
        hashMap.put("source", Integer.valueOf(m29458a(entrance)));
        hashMap.put("passenger_id", m29459a(context));
        hashMap.put("city_id", m29460b(context));
    ...
    /* renamed from: a */
    private static String m29459a(Context context) {
        return context == null ? "" : PayBaseParamUtil.getStringParam(context, "uid");
    }

    /* renamed from: b */
    private static String m29460b(Context context) {
    ...
    static /* synthetic */ class C131511 {
        ...
        static {
            ...
            L_0x0012:
                int[] r0 = f39123x8a3a0836     // Catch:{ NoSuchFieldError -> 0x001d }
            ...
            L_0x001d:
                int[] r0 = f39123x8a3a0836     // Catch:{ NoSuchFieldError -> 0x0028 }
            ...
            L_0x0028:
                int[] r0 = f39123x8a3a0836     // Catch:{ NoSuchFieldError -> 0x0033 }
            ...
            L_0x0033:
                int[] r0 = f39123x8a3a0836     // Catch:{ NoSuchFieldError -> 0x003e }
            ...
            L_0x003e:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.didi.sdk.global.util.GlobalOmegaUtils.C131511.<clinit>():void");
        }
    }

    /* renamed from: a */
    private static int m29458a(DidiGlobalPayMethodListData.Entrance entrance) {
        int i = C131511.f39123x8a3a0836[entrance.ordinal()];
        if (i != 1) {
            if (i == 2) {
                return 3;
            }
