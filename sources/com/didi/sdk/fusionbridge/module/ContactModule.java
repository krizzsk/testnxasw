...
public class ContactModule extends BaseHybridModule {
    ...
    public void handleContactResult(int r10, android.content.Intent r11) {
        /*
            ...
            return
        L_0x000d:
            android.app.Activity r10 = r9.f38746a     // Catch:{ Exception -> 0x00af }
            ...
            android.app.Activity r2 = r9.f38746a     // Catch:{ Exception -> 0x00af }
            r4 = 0
            r5 = 0
            r6 = 0
            r7 = 0
        ...
        L_0x00a7:
            ...
            r5 = r10
            r6 = r0
            r2.m29185a(r3, r4, r5, r6, r7)     // Catch:{ Exception -> 0x00af }
            goto L_0x00b4
        L_0x00af:
        ...
        L_0x00b4:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.didi.sdk.fusionbridge.module.ContactModule.handleContactResult(int, android.content.Intent):void");
    }

    /* renamed from: a */
    private void m29185a(String str, List<String> list, String str2, String str3, String str4) {
        ...
        CallbackFunction callbackFunction = this.f38747b;
    ...
    /* renamed from: a */
    private void m29184a(String str) {
        JSONObject jSONObject = new JSONObject();
        try {
