...
public class GlobalTitleBar extends RelativeLayout {
    ...
    public GlobalTitleBar(Context context, AttributeSet attributeSet, int i) {
    ...
    /* renamed from: a */
    private void m30454a() {
        LayoutInflater.from(getContext()).inflate(R.layout.global_titlebar, this, true);
        this.mContentView = findViewById(R.id.main_id);
    ...
    public void setTitle(int i) {
        m30456a(this.mMiddleTv, i);
        m30455a((View) this.mMiddleTv);
    }

    public void setTitle(String str) {
        m30457a(this.mMiddleTv, str);
        m30455a((View) this.mMiddleTv);
    }

    public void setRightText(int i) {
        m30456a(this.mRightTv, i);
        m30455a((View) this.mRightTv);
    }

    public void setRightText(String str) {
        m30457a(this.mRightTv, str);
        m30455a((View) this.mRightTv);
    }
    ...
    /* renamed from: a */
    private void m30456a(TextView textView, int i) {
        textView.setText(i);
    }

    /* renamed from: a */
    private void m30457a(TextView textView, String str) {
        textView.setText(str);
    }

    /* renamed from: a */
    private void m30455a(View view) {
