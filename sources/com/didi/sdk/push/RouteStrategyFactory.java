...
class RouteStrategyFactory {
    ...
    static /* synthetic */ class C137771 {
        ...
        static {
            ...
            L_0x0028:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.didi.sdk.push.RouteStrategyFactory.C137771.<clinit>():void");
        }
    }

    static IRouteStrategy create(RouteType routeType) {
        int i = C137771.$SwitchMap$com$didi$sdk$push$RouteType[routeType.ordinal()];
        if (i == 1) {
