...
public class UserInfoEntity implements Parcelable, IEntity {
    ...
    protected UserInfoEntity(Parcel parcel) {
        ...
        this.greetWords = parcel.readString();
    }
    ...
    public void writeToParcel(Parcel parcel, int i) {
        ...
        parcel.writeString(this.greetWords);
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (Objects.equals(this.headUrl, userInfoEntity.headUrl) && Objects.equals(this.firstName, userInfoEntity.firstName) && Objects.equals(this.lastName, userInfoEntity.lastName) && this.hasNewMsg == userInfoEntity.hasNewMsg && this.greetWords.equals(userInfoEntity.greetWords) && Objects.equals(this.unEvaluatedOrderId, userInfoEntity.unEvaluatedOrderId)) {
