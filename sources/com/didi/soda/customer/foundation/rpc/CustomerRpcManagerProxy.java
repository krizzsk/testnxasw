...
public final class CustomerRpcManagerProxy {
    ...
    /* renamed from: a */
    private static CustomerRpcService f43562a;
    ...
    public static CustomerRpcService get() {
        if (f43562a == null) {
            if (CustomerToolBoxUtil.shouldMockApi()) {
                f43562a = (CustomerRpcService) Proxy.newProxyInstance(CustomerRpcService.class.getClassLoader(), new Class[]{CustomerRpcService.class}, new CustomerRpcManagerInvocationHandler(new C14524a()));
            } else {
                f43562a = new C14524a();
            }
        }
    ...
    static class CustomerRpcManagerInvocationHandler implements InvocationHandler {
        ...
        private C14524a mTarget;

        CustomerRpcManagerInvocationHandler(C14524a aVar) {
            this.mTarget = aVar;
        }
