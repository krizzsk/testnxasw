...
final class ShopSaver$getCurVisibleShopsInScreen$1 extends Lambda implements Function1<Integer, Unit> {
    final /* synthetic */ Set<CollectedShopInfo> $set;
    final /* synthetic */ ShopSaver this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    ShopSaver$getCurVisibleShopsInScreen$1(ShopSaver shopSaver, Set<CollectedShopInfo> set) {
        super(1);
