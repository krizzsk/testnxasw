...
public final class OpenPageActionKt {
    /* access modifiers changed from: private */
    /* renamed from: a */
    public static final Bundle m32286a(Map<?, ?> map) {
        ...
        for (Map.Entry next : map.entrySet()) {
            ...
            if (!(key instanceof String) || value == null) {
                ...
                if (Intrinsics.areEqual(key, (Object) Const.PageParams.ANCHOR_INFO)) {
                    ...
                    m32287a(bundle, lowerCase, value);
                }
            }
        }
        return bundle;
    ...
    /* renamed from: a */
    private static final void m32287a(Bundle bundle, String str, Object obj) {
