...
public abstract class AnimationLoadingRender extends BaseLoadingRender implements Animator.AnimatorListener {
    ...
    public View onCreateView(Context context, Bundle bundle) {
        ...
        this.f44651b = ofFloat;
        ofFloat.setRepeatCount(-1);
        this.f44651b.setRepeatMode(1);
        this.f44651b.setDuration(bundle.getLong("Loading::Duration", 1200));
        this.f44651b.setInterpolator(AnimationUtils.loadInterpolator(context, bundle.getInt("Loading::Interpolator::Id", 17563659)));
        this.f44651b.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
            public void onAnimationUpdate(ValueAnimator valueAnimator) {
                AnimationLoadingRender.this.computeRender(((Float) valueAnimator.getAnimatedValue()).floatValue());
                AnimationLoadingRender.this.m33152a();
            }
        });
        this.f44651b.addListener(this);
    ...
    /* renamed from: a */
    public void m33152a() {
        for (ILoadingRender.Callback invalidateDrawable : this.f44652a) {
    ...
    class LoadingDrawable extends Drawable implements Animatable {
        ...
        LoadingDrawable(ILoadingRender iLoadingRender) {
            C146631 r1 = new ILoadingRender.SimpleCallback() {
