...
final class TabBarController$Event$onDestroy$1 extends Lambda implements Function1<ComponentController, Unit> {
    public static final TabBarController$Event$onDestroy$1 INSTANCE = new TabBarController$Event$onDestroy$1();

    TabBarController$Event$onDestroy$1() {
        super(1);
    }
