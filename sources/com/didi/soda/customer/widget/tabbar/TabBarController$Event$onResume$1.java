...
final class TabBarController$Event$onResume$1 extends Lambda implements Function1<ComponentController, Unit> {
    public static final TabBarController$Event$onResume$1 INSTANCE = new TabBarController$Event$onResume$1();

    TabBarController$Event$onResume$1() {
        super(1);
    }
