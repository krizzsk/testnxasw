...
final class TabBarController$Event$onStart$1 extends Lambda implements Function1<ComponentController, Unit> {
    public static final TabBarController$Event$onStart$1 INSTANCE = new TabBarController$Event$onStart$1();

    TabBarController$Event$onStart$1() {
        super(1);
    }
