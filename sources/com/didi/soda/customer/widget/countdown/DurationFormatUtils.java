...
public class DurationFormatUtils {
    ...
    /* renamed from: a */
    static final Object f44299a = SameLayerRenderingUtil.KEY_COMP_Y;

    /* renamed from: b */
    static final Object f44300b = "M";

    /* renamed from: c */
    static final Object f44301c = "d";

    /* renamed from: d */
    static final Object f44302d = "H";

    /* renamed from: e */
    static final Object f44303e = "m";

    /* renamed from: f */
    static final Object f44304f = RavenKey.STACK;

    /* renamed from: g */
    static final Object f44305g = ExifInterface.LATITUDE_SOUTH;
    ...
    public static String formatDuration(long j, String str, boolean z) {
        ...
        int i4;
        Token[] a = m32945a(str);
        if (Token.containsTokenWithValue(a, f44301c)) {
        ...
        if (Token.containsTokenWithValue(a, f44302d)) {
        ...
        if (Token.containsTokenWithValue(a, f44303e)) {
            int i7 = (int) (j / 60000);
            j -= ((long) i7) * 60000;
            i3 = i7;
        } else {
        ...
        if (Token.containsTokenWithValue(a, f44304f)) {
            int i8 = (int) (j / 1000);
            j -= ((long) i8) * 1000;
            i4 = i8;
        } else {
        ...
        return m32944a(a, 0, 0, i, i2, i3, i4, Token.containsTokenWithValue(a, f44305g) ? (int) j : 0, z);
    }
    ...
    public static String formatPeriod(long j, long j2, String str, boolean z, TimeZone timeZone) {
        ...
        int a2 = i6 - m32942a(instance, instance2, 14, i6);
        int a3 = i7 - m32942a(instance, instance2, 13, i7);
        int a4 = i8 - m32942a(instance, instance2, 12, i8);
        int a5 = i9 - m32942a(instance, instance2, 11, i9);
        int a6 = i10 - m32942a(instance, instance2, 5, i10);
        int a7 = i11 - m32942a(instance, instance2, 2, i11);
        int a8 = i13 - m32942a(instance, instance2, 1, i13);
        if (!Token.containsTokenWithValue(a, f44299a)) {
            if (Token.containsTokenWithValue(a, f44300b)) {
                a7 += a8 * 12;
            } else {
                a6 += a8 * 365;
            }
        ...
        return m32944a(a, i, a7, i2, a5, i3, i5, i4, z);
    }
    ...
    public static String leftPad(String str, int i, char c) {
        ...
        return m32943a(length, c).concat(str);
    }
    ...
    /* renamed from: a */
    static String m32944a(Token[] tokenArr, int i, int i2, int i3, int i4, int i5, int i6, int i7, boolean z) {
        String str;
        String str2;
        String str3;
        String str4;
    ...
    /* renamed from: a */
    static int m32942a(Calendar calendar, Calendar calendar2, int i, int i2) {
    ...
    static com.didi.soda.customer.widget.countdown.DurationFormatUtils.Token[] m32945a(java.lang.String r10) {
        /*
        ...
        L_0x0020:
            ...
            r6.<init>()
            com.didi.soda.customer.widget.countdown.DurationFormatUtils$Token r9 = new com.didi.soda.customer.widget.countdown.DurationFormatUtils$Token
            r9.<init>(r6)
            r0.add(r9)
        L_0x004d:
            r6.append(r8)
            goto L_0x007a
        L_0x0051:
            java.lang.Object r8 = f44299a
            goto L_0x007b
        L_0x0054:
            java.lang.Object r8 = f44304f
            goto L_0x007b
        L_0x0057:
            java.lang.Object r8 = f44303e
            goto L_0x007b
        L_0x005a:
            java.lang.Object r8 = f44301c
            goto L_0x007b
        L_0x005d:
            java.lang.Object r8 = f44305g
            goto L_0x007b
        L_0x0060:
            java.lang.Object r8 = f44300b
            goto L_0x007b
        L_0x0063:
            java.lang.Object r8 = f44302d
            goto L_0x007b
        L_0x0066:
        ...
        L_0x006c:
            java.lang.StringBuffer r6 = new java.lang.StringBuffer
            r6.<init>()
            com.didi.soda.customer.widget.countdown.DurationFormatUtils$Token r5 = new com.didi.soda.customer.widget.countdown.DurationFormatUtils$Token
            r5.<init>(r6)
            r0.add(r5)
            r5 = 1
        L_0x007a:
        ...
        L_0x007b:
            ...
            goto L_0x0092
        L_0x0089:
            com.didi.soda.customer.widget.countdown.DurationFormatUtils$Token r6 = new com.didi.soda.customer.widget.countdown.DurationFormatUtils$Token
            r6.<init>(r8)
            r0.add(r6)
            r7 = r6
        L_0x0092:
        ...
        L_0x0093:
            ...
            goto L_0x0011
        L_0x0097:
            com.didi.soda.customer.widget.countdown.DurationFormatUtils$Token[] r10 = new com.didi.soda.customer.widget.countdown.DurationFormatUtils.Token[r2]
            java.lang.Object[] r10 = r0.toArray(r10)
            com.didi.soda.customer.widget.countdown.DurationFormatUtils$Token[] r10 = (com.didi.soda.customer.widget.countdown.DurationFormatUtils.Token[]) r10
            return r10
        */
        throw new UnsupportedOperationException("Method not decompiled: com.didi.soda.customer.widget.countdown.DurationFormatUtils.m32945a(java.lang.String):com.didi.soda.customer.widget.countdown.DurationFormatUtils$Token[]");
    }

    /* renamed from: a */
    private static String m32943a(int i, char c) throws IndexOutOfBoundsException {
        if (i >= 0) {
