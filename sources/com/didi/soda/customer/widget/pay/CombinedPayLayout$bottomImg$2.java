...
final class CombinedPayLayout$bottomImg$2 extends Lambda implements Function0<ImageView> {
    final /* synthetic */ CombinedPayLayout this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    CombinedPayLayout$bottomImg$2(CombinedPayLayout combinedPayLayout) {
        super(0);
        this.this$0 = combinedPayLayout;
    }

    public final ImageView invoke() {
        return (ImageView) this.this$0.findViewById(R.id.customer_pay_combined_card_bottom);
    }
}
