...
public class LoginPopDialogView extends Contract.AbsPopDialogView {
    ...
    /* renamed from: a */
    private static final String f43104a = "LoginPopDialogView";
    @BindView(18471)
    ImageView mPopClose;
    @BindView(18472)
    ImageView mPopImage;
    ...
    public void updatePopDialog(final NAPopDialogEntity nAPopDialogEntity) {
        LogUtil.m32588i(f43104a, "updatePopDialog");
        FlyImageLoader.loadImageDownLoadOnly(getScopeContext(), FitType.FIT_None, nAPopDialogEntity.info.imgUrl).transform(new ClipBottomTransformation(getContext(), getResources().getDimensionPixelOffset(R.dimen.customer_580px), getResources().getDimensionPixelOffset(R.dimen.customer_774px), DisplayUtils.dip2px(getContext(), 5.0f))).downloadOnly(new ImageDownloadListener() {
            public void onFailure(Exception exc) {
                ...
                if (exc != null) {
                    ...
                    str = sb.toString();
                    LogUtil.m32588i(LoginPopDialogView.f43104a, "down load image fail = " + str);
                } else {
                    str = "";
                }
            ...
            public void onSuccess(File file) {
                ...
                if (convertFileToBitmap == null) {
                    LogUtil.m32588i(LoginPopDialogView.f43104a, "convert file to bitmap fail");
                    ((Contract.AbsPopDialogPresenter) LoginPopDialogView.this.getPresenter()).onDownloadPicFail("convert file to bitmap fail");
                    return;
                }
                LoginPopDialogView.this.showPopDialog(nAPopDialogEntity);
                LogUtil.m32588i(LoginPopDialogView.f43104a, "download onSuccess");
                ((Contract.AbsPopDialogPresenter) LoginPopDialogView.this.getPresenter()).onDownloadPicSucess();
                LoginPopDialogView.this.mPopImage.setImageBitmap(convertFileToBitmap);
