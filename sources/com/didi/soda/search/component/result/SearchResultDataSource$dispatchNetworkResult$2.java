...
final class SearchResultDataSource$dispatchNetworkResult$2 extends Lambda implements Function1<SearchResultPageParam, Unit> {
    public static final SearchResultDataSource$dispatchNetworkResult$2 INSTANCE = new SearchResultDataSource$dispatchNetworkResult$2();

    SearchResultDataSource$dispatchNetworkResult$2() {
        super(1);
    }
    ...
    public final void invoke(SearchResultPageParam searchResultPageParam) {
        ...
        searchResultPageParam.setPageType(1);
    }
}
