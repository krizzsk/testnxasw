...
final class BlocksTrackHelper$Companion$trackCosumedTimeForTreeRendering$1 extends Lambda implements Function0<Unit> {
    final /* synthetic */ long $duration;
    final /* synthetic */ String $templateId;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    BlocksTrackHelper$Companion$trackCosumedTimeForTreeRendering$1(String str, long j) {
        super(0);
        this.$templateId = str;
        this.$duration = j;
    }
    ...
    public final void invoke() {
        ...
        if (tracker != null) {
            tracker.track(TrackConst.Event.TECH_SAILING_C_X_AETHER_WIDGET_TREE_RENDER, mutableMapOf);
        }
    }
}
