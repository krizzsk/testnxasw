...
final /* synthetic */ class HorizontalScrollerWithEntrance$createView$1$1 extends FunctionReference implements Function4<Integer, Integer, Integer, Integer, Unit> {
    HorizontalScrollerWithEntrance$createView$1$1(HorizontalScrollerWithEntrance horizontalScrollerWithEntrance) {
        super(4, horizontalScrollerWithEntrance);
    }
    ...
    public final void invoke(int i, int i2, int i3, int i4) {
        ((HorizontalScrollerWithEntrance) this.receiver).onScrollChanged(i, i2, i3, i4);
    }
}
