...
final class EditAddressInfoView$upAddress$2 extends Lambda implements Function0<Unit> {
    final /* synthetic */ EditAddressInfoView this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    EditAddressInfoView$upAddress$2(EditAddressInfoView editAddressInfoView) {
        super(0);
    ...
    public final void invoke() {
        ...
        if (access$getAddressAnimHelper$p != null) {
            access$getAddressAnimHelper$p.onAddressUpPin();
        }
    }
}
