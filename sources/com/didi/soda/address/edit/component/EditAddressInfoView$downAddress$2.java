...
final class EditAddressInfoView$downAddress$2 extends Lambda implements Function0<Unit> {
    final /* synthetic */ EditAddressInfoView this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    EditAddressInfoView$downAddress$2(EditAddressInfoView editAddressInfoView) {
        super(0);
    ...
    public final void invoke() {
        ...
        if (access$getAddressAnimHelper$p != null) {
            access$getAddressAnimHelper$p.onAddressDownPin();
        }
        this.this$0.m31135e();
        this.this$0.m31111a(1.0f);
    }
}
