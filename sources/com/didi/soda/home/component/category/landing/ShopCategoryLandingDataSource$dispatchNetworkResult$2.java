...
final class ShopCategoryLandingDataSource$dispatchNetworkResult$2 extends Lambda implements Function1<HomeFeedParam, Unit> {
    public static final ShopCategoryLandingDataSource$dispatchNetworkResult$2 INSTANCE = new ShopCategoryLandingDataSource$dispatchNetworkResult$2();

    ShopCategoryLandingDataSource$dispatchNetworkResult$2() {
        super(1);
    }
