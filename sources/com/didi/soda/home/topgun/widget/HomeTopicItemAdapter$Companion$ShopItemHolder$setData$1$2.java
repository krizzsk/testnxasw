...
final class HomeTopicItemAdapter$Companion$ShopItemHolder$setData$1$2 extends Lambda implements Function0<Unit> {
    final /* synthetic */ HomeTopicBinder.Companion.Logic $logic;
    final /* synthetic */ HomeBusinessInfoRvModel $shopModel;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    HomeTopicItemAdapter$Companion$ShopItemHolder$setData$1$2(HomeTopicBinder.Companion.Logic logic, HomeBusinessInfoRvModel homeBusinessInfoRvModel) {
        super(0);
        this.$logic = logic;
