...
final class HomeTopicItemAdapter$Companion$GoodsHolder$setData$1$3 extends Lambda implements Function0<Unit> {
    final /* synthetic */ BusinessGoodsItemRvModel $goodsItem;
    final /* synthetic */ HomeTopicBinder.Companion.Logic $logic;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    HomeTopicItemAdapter$Companion$GoodsHolder$setData$1$3(HomeTopicBinder.Companion.Logic logic, BusinessGoodsItemRvModel businessGoodsItemRvModel) {
        super(0);
        this.$logic = logic;
