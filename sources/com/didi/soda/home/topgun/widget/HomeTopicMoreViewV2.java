...
public final class HomeTopicMoreViewV2 extends HomeTopicBaseView {
    ...
    /* JADX INFO: this call moved to the top of the method (can break code semantics) */
    public /* synthetic */ HomeTopicMoreViewV2(Context context, AttributeSet attributeSet, int i, int i2, DefaultConstructorMarker defaultConstructorMarker) {
        this(context, (i2 & 2) != 0 ? null : attributeSet, (i2 & 4) != 0 ? 0 : i);
    }

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public HomeTopicMoreViewV2(Context context, AttributeSet attributeSet, int i) {
        super(context, attributeSet, i);
        Intrinsics.checkNotNullParameter(context, "context");
        FrameLayout.inflate(context, R.layout.customer_home_item_topic_more_v2, this);
        ...
        this.f45681a = (TextView) findViewById;
        ...
        this.f45682b = (TextView) findViewById2;
    ...
    public final void setData(ViewMoreEntity viewMoreEntity) {
        ...
        this.f45681a.setText(viewMoreEntity.getIcon());
        this.f45682b.setText(viewMoreEntity.getText());
    }
}
