...
public final class HomeColumnRoot extends BinderRoot<ColumnWidget, ComponentModel> {
    ...
    public ColumnWidget createView(Context context, ComponentModel componentModel) {
        ...
        Buildable renderViewWithData$default = BlocksEngine.renderViewWithData$default(BlocksEngine.Companion.getInstance$default(BlocksEngine.Companion, (String) null, 1, (Object) null), context, this.f45239a, componentModel.getWidgetNodeModel(), (BinderRootConfig) null, 8, (Object) null);
    ...
    public void bind(ColumnWidget columnWidget, ComponentModel componentModel, int i) {
        ...
        BlocksEngine.bindDataOnWidget$default(BlocksEngine.Companion.getInstance$default(BlocksEngine.Companion, (String) null, 1, (Object) null), this.f45239a, buildable, componentModel.getWidgetNodeModel(), (BinderRootConfig) null, 8, (Object) null);
    }
}
