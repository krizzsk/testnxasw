...
final class SceneViewHolder$bindData$1 extends Lambda implements Function2<GridItemModel, Integer, Unit> {
    final /* synthetic */ SceneViewHolder this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    SceneViewHolder$bindData$1(SceneViewHolder sceneViewHolder) {
        super(2);
    ...
    public final void invoke(GridItemModel gridItemModel, int i) {
        ...
        access$getLogic$p.onSceneItemClick((SceneComponentModel) item, gridItemModel, i);
    }
}
