...
final class CustomerBillPresenter$getItemListForTracker$6 extends Lambda implements Function1<CartItemEntity, CharSequence> {
    public static final CustomerBillPresenter$getItemListForTracker$6 INSTANCE = new CustomerBillPresenter$getItemListForTracker$6();

    CustomerBillPresenter$getItemListForTracker$6() {
        super(1);
    }
