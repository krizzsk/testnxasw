...
final class CustomerBillPresenterV2$showPayErrorDialog$1$2 extends Lambda implements Function0<Unit> {
    ...
    CustomerBillPresenterV2$showPayErrorDialog$1$2(CustomerBillPresenterV2 customerBillPresenterV2, PayChannelEntity payChannelEntity) {
        super(0);
    ...
    public final void invoke() {
        ...
        companion.tracePayErrorGuideDialogCK(access$getCartId$p, str, this.$channelEntity, 2);
    }
}
