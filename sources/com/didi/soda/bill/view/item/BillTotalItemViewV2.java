...
@Metadata(mo148867d1 = {"\u0000:\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0010\u000b\n\u0000\u0018\u00002\b\u0012\u0004\u0012\u00020\u00020\u0001B\u000f\b\u0016\u0012\u0006\u0010\u0003\u001a\u00020\u0004¢\u0006\u0002\u0010\u0005J\b\u0010\u000b\u001a\u00020\fH\u0016J\u0010\u0010\r\u001a\u00020\f2\u0006\u0010\u000e\u001a\u00020\u000fH\u0016J\u0010\u0010\u0010\u001a\u00020\f2\u0006\u0010\u0011\u001a\u00020\u0012H\u0002R\u000e\u0010\u0006\u001a\u00020\u0007X.¢\u0006\u0002\n\u0000R\u000e\u0010\b\u001a\u00020\u0007X.¢\u0006\u0002\n\u0000R\u000e\u0010\t\u001a\u00020\nX.¢\u0006\u0002\n\u0000¨\u0006\u0013"}, mo148868d2 = {"Lcom/didi/soda/bill/view/item/BillTotalItemViewV2;", "Lcom/didi/soda/bill/view/BillItemView;", "Lcom/didi/soda/bill/view/item/logic/ItemViewTotalPriceLogic;", "context", "Landroid/content/Context;", "(Landroid/content/Context;)V", "totalName", "Landroid/widget/TextView;", "totalPrice", "totalPriceHint", "Lcom/didi/soda/customer/widget/text/RichTextView;", "initView", "", "setData", "componentModel", "Lcom/didi/soda/bill/model/ComponentModel;", "showOrHide", "isShow", "", "customer-aar_brazilEmbedRelease"}, mo148869k = 1, mo148870mv = {1, 5, 1}, mo148872xi = 48)
/* compiled from: BillTotalItemViewV2.kt */
public final class BillTotalItemViewV2 extends BillItemView<ItemViewTotalPriceLogic> {
    ...
    /* renamed from: c */
    private RichTextView f41964c;

    public void _$_clearFindViewByIdCache() {
    }

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public BillTotalItemViewV2(Context context) {
        super(context, false, 2, (DefaultConstructorMarker) null);
        Intrinsics.checkNotNullParameter(context, "context");
    }

    public void initView() {
        View.inflate(getContext(), R.layout.customer_item_bill_total_v2, this);
        ...
        this.f41962a = (TextView) findViewById;
        ...
        this.f41963b = (TextView) findViewById2;
        ...
        this.f41964c = (RichTextView) findViewById3;
    }
    ...
    public void setData(com.didi.soda.bill.model.ComponentModel r6) {
        /*
            ...
            android.widget.TextView r0 = r5.f41962a
            r1 = 0
        ...
        L_0x0011:
            ...
            r0.setText(r2)
            com.didi.soda.customer.widget.text.RichTextView r0 = r5.f41964c
        ...
        L_0x0062:
            ...
            com.didi.soda.bill.view.item.BillTotalItemViewV2$setData$1$1 r1 = new com.didi.soda.bill.view.item.BillTotalItemViewV2$setData$1$1
            r1.<init>(r5)
            kotlin.jvm.functions.Function1 r1 = (kotlin.jvm.functions.Function1) r1
            r0.startTotalPriceAnim(r6, r1)
            goto L_0x0098
        L_0x0083:
            android.widget.TextView r0 = r5.f41963b
        ...
        L_0x009f:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.didi.soda.bill.view.item.BillTotalItemViewV2.setData(com.didi.soda.bill.model.ComponentModel):void");
    }

    /* renamed from: a */
    private final void m31470a(boolean z) {
        setVisibility(z ? 0 : 8);
    }
}
