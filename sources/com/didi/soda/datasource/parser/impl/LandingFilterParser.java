...
@ParserMeta(type = {"landing_filter"})
public class LandingFilterParser extends FeedParser {
    public RecyclerModel parse(Context context, JsonObject jsonObject, FeedPayload feedPayload) {
        ...
        FilterDataManager instanceByScene = FilterDataManager.Companion.getInstanceByScene(2);
