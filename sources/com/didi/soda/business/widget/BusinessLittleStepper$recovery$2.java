...
final class BusinessLittleStepper$recovery$2 extends Lambda implements Function0<Unit> {
    final /* synthetic */ BusinessLittleStepper this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    BusinessLittleStepper$recovery$2(BusinessLittleStepper businessLittleStepper) {
        super(0);
    ...
    public final void invoke() {
        ...
        access$getNumView$p.setVisibility(8);
        this.this$0.m31923c();
        BusinessLittleStepper.StepperListener stepperListener = this.this$0.getStepperListener();
        if (stepperListener != null) {
            stepperListener.onRecovery();
        }
    }
}
