...
/* renamed from: com.didi.rfusion.R */
public final class C12330R {

    /* renamed from: com.didi.rfusion.R$anim */
    public static final class C12331anim {
        private C12331anim() {
        }
    }

    /* renamed from: com.didi.rfusion.R$animator */
    public static final class C12332animator {
        private C12332animator() {
        }
    }

    /* renamed from: com.didi.rfusion.R$attr */
    public static final class attr {
        private attr() {
        }
    }

    /* renamed from: com.didi.rfusion.R$bool */
    public static final class bool {
        private bool() {
        }
    }

    /* renamed from: com.didi.rfusion.R$color */
    public static final class C12333color {
        private C12333color() {
        }
    }

    /* renamed from: com.didi.rfusion.R$dimen */
    public static final class dimen {
        private dimen() {
        }
    }

    /* renamed from: com.didi.rfusion.R$drawable */
    public static final class C12334drawable {
        private C12334drawable() {
        }
    }

    /* renamed from: com.didi.rfusion.R$font */
    public static final class C12335font {
        private C12335font() {
        }
    }

    /* renamed from: com.didi.rfusion.R$id */
    public static final class C12336id {
        private C12336id() {
        }
    }

    /* renamed from: com.didi.rfusion.R$integer */
    public static final class integer {
        private integer() {
        }
    }

    /* renamed from: com.didi.rfusion.R$interpolator */
    public static final class C12337interpolator {
        private C12337interpolator() {
        }
    }

    /* renamed from: com.didi.rfusion.R$layout */
    public static final class C12338layout {
        private C12338layout() {
        }
    }

    /* renamed from: com.didi.rfusion.R$raw */
    public static final class C12339raw {
        private C12339raw() {
        }
    }

    /* renamed from: com.didi.rfusion.R$string */
    public static final class string {
        private string() {
        }
    }

    /* renamed from: com.didi.rfusion.R$style */
    public static final class C12340style {
        private C12340style() {
        }
    }

    /* renamed from: com.didi.rfusion.R$styleable */
    public static final class styleable {
        static {
            ...
            RFButton = new int[]{R.attr.rf_enabled, R.attr.rf_text};
            RFCheckableIconButton = new int[]{16843087, R.attr.rf_checked_text};
            RFEditText = new int[]{R.attr.rf_font_flavor};
            RFGhostButton = new int[]{R.attr.rf_btn_type};
            RFMainButton = new int[]{R.attr.rf_enable_shadow};
            RFRadioGroup = new int[]{R.attr.rf_checked_id, R.attr.rf_orientation};
            RFRoundRelativeLayout = new int[]{R.attr.rf_bottom_left_radius, R.attr.rf_bottom_right_radius, R.attr.rf_radius, R.attr.rf_top_left_radius, R.attr.rf_top_right_radius};
            RFSelectorButton = new int[]{R.attr.rf_checked, R.attr.rf_emphasize, R.attr.rf_enabled, R.attr.rf_icon, R.attr.rf_selector_type, R.attr.rf_tips, R.attr.rf_title};
            RFShadowLayout = new int[]{R.attr.rf_shadow_color, R.attr.rf_shadow_corner_radius, R.attr.rf_shadow_elevation, R.attr.rf_shadow_offset_x, R.attr.rf_shadow_offset_y};
            RFSlideButton = new int[]{R.attr.rf_enabled, R.attr.rf_text, R.attr.rf_tips};
            RFStepper = new int[]{R.attr.rf_default_value, R.attr.rf_enable_minus_action, R.attr.rf_enable_plus_action, R.attr.rf_enabled, R.attr.rf_max_value, R.attr.rf_min_value, R.attr.rf_step_value, R.attr.rf_stepper_spec};
            RFStyleButton = new int[]{R.attr.rf_btn_spec, R.attr.rf_left_icon, R.attr.rf_loading, R.attr.rf_right_icon};
            RFSuperFrameLayout = new int[]{R.attr.rf_max_height, R.attr.rf_max_width};
            RFTabBar = new int[]{R.attr.rf_show_divider_line, R.attr.rf_tab_spec};
            RFTag = new int[]{R.attr.checkable, R.attr.disable, R.attr.rf_tag_spec, R.attr.selected, R.attr.text};
            RFTextButton = new int[]{R.attr.rf_btn_type};
            RFTextField = new int[]{16843110, 16843296};
            RFTextInputLayout = new int[]{16842766, 16843039, 16843071, 16843088, R.attr.rf_box_background_color, R.attr.rf_box_background_mode, R.attr.rf_clear_enabled, R.attr.rf_counter_enabled, R.attr.rf_counter_location, R.attr.rf_counter_max_length, R.attr.rf_end_icon, R.attr.rf_helper_text, R.attr.rf_password_toggle_enabled, R.attr.rf_placeholder_text, R.attr.rf_prefix_text, R.attr.rf_suffix_text};
            RFTextView = new int[]{R.attr.rf_font_flavor};
