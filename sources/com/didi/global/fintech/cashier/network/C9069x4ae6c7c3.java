...
/* renamed from: com.didi.global.fintech.cashier.network.FastPayNetwork$setFastPayStatus$$inlined$getBaseResponseCallback$1 */
/* compiled from: CashierNetCallback.kt */
public final class C9069x4ae6c7c3 implements RpcService.CallbackV2<CashierBaseResponse<FastPayStatusResponse>> {
    final /* synthetic */ CashierNetCallback $callback;

    public C9069x4ae6c7c3(CashierNetCallback cashierNetCallback) {
        this.$callback = cashierNetCallback;
    }

    public void onSuccess(RpcResponseProxy<CashierBaseResponse<FastPayStatusResponse>> rpcResponseProxy) {
        String str;
        String errmsg;
        ...
        Log.i("Arirus", Intrinsics.stringPlus("onSuccess: ", FastPayStatusResponse.class));
        boolean z = false;
        ...
        if (!z) {
            ...
            CashierBaseResponse<FastPayStatusResponse> content2 = rpcResponseProxy.getContent();
