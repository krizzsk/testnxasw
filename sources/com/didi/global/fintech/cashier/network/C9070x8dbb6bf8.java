...
/* renamed from: com.didi.global.fintech.cashier.network.FastPayNetwork$submitQuestionnaire$$inlined$getBaseResponseCallback$1 */
/* compiled from: CashierNetCallback.kt */
public final class C9070x8dbb6bf8 implements RpcService.CallbackV2<CashierBaseResponse<FastPaySubmitQuizResponse>> {
    final /* synthetic */ CashierNetCallback $callback;

    public C9070x8dbb6bf8(CashierNetCallback cashierNetCallback) {
        this.$callback = cashierNetCallback;
    }

    public void onSuccess(RpcResponseProxy<CashierBaseResponse<FastPaySubmitQuizResponse>> rpcResponseProxy) {
        String str;
        String errmsg;
        ...
        Log.i("Arirus", Intrinsics.stringPlus("onSuccess: ", FastPaySubmitQuizResponse.class));
        boolean z = false;
        ...
        if (!z) {
            ...
            CashierBaseResponse<FastPaySubmitQuizResponse> content2 = rpcResponseProxy.getContent();
