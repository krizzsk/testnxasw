...
public final class CashierNetwork$prePay$$inlined$getBaseResponseCallback$1 implements RpcService.CallbackV2<CashierBaseResponse<PrepayResponse>> {
    final /* synthetic */ CashierNetCallback $callback;

    public CashierNetwork$prePay$$inlined$getBaseResponseCallback$1(CashierNetCallback cashierNetCallback) {
        this.$callback = cashierNetCallback;
    }

    public void onSuccess(RpcResponseProxy<CashierBaseResponse<PrepayResponse>> rpcResponseProxy) {
        String str;
        String errmsg;
        ...
        Log.i("Arirus", Intrinsics.stringPlus("onSuccess: ", PrepayResponse.class));
        boolean z = false;
        ...
        if (!z) {
            ...
            CashierBaseResponse<PrepayResponse> content2 = rpcResponseProxy.getContent();
