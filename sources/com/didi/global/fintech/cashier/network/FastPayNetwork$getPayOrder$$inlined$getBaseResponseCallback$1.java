...
public final class FastPayNetwork$getPayOrder$$inlined$getBaseResponseCallback$1 implements RpcService.CallbackV2<CashierBaseResponse<FastPayOrderResponse>> {
    final /* synthetic */ CashierNetCallback $callback;

    public FastPayNetwork$getPayOrder$$inlined$getBaseResponseCallback$1(CashierNetCallback cashierNetCallback) {
        this.$callback = cashierNetCallback;
    }

    public void onSuccess(RpcResponseProxy<CashierBaseResponse<FastPayOrderResponse>> rpcResponseProxy) {
        String str;
        String errmsg;
        ...
        Log.i("Arirus", Intrinsics.stringPlus("onSuccess: ", FastPayOrderResponse.class));
        boolean z = false;
        ...
        if (!z) {
            ...
            CashierBaseResponse<FastPayOrderResponse> content2 = rpcResponseProxy.getContent();
