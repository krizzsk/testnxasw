...
/* renamed from: com.didi.global.fintech.cashier.network.CashierNetwork$payment3DSDetails$$inlined$getBaseResponseCallback$1 */
/* compiled from: CashierNetCallback.kt */
public final class C9067xdccc6c34 implements RpcService.CallbackV2<CashierBaseResponse<PaymentThreeDSDetailsResponse>> {
    final /* synthetic */ CashierNetCallback $callback;

    public C9067xdccc6c34(CashierNetCallback cashierNetCallback) {
        this.$callback = cashierNetCallback;
    }

    public void onSuccess(RpcResponseProxy<CashierBaseResponse<PaymentThreeDSDetailsResponse>> rpcResponseProxy) {
        String str;
        String errmsg;
        ...
        Log.i("Arirus", Intrinsics.stringPlus("onSuccess: ", PaymentThreeDSDetailsResponse.class));
        boolean z = false;
        ...
        if (!z) {
            ...
            CashierBaseResponse<PaymentThreeDSDetailsResponse> content2 = rpcResponseProxy.getContent();
