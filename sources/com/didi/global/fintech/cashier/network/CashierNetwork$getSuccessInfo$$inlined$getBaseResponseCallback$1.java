...
public final class CashierNetwork$getSuccessInfo$$inlined$getBaseResponseCallback$1 implements RpcService.CallbackV2<CashierBaseResponse<SuccessInfoResponse>> {
    final /* synthetic */ CashierNetCallback $callback;

    public CashierNetwork$getSuccessInfo$$inlined$getBaseResponseCallback$1(CashierNetCallback cashierNetCallback) {
        this.$callback = cashierNetCallback;
    }

    public void onSuccess(RpcResponseProxy<CashierBaseResponse<SuccessInfoResponse>> rpcResponseProxy) {
        String str;
        String errmsg;
        ...
        Log.i("Arirus", Intrinsics.stringPlus("onSuccess: ", SuccessInfoResponse.class));
        boolean z = false;
        ...
        if (!z) {
            ...
            CashierBaseResponse<SuccessInfoResponse> content2 = rpcResponseProxy.getContent();
