...
public final class FastPayNetwork$changePayLimit$$inlined$getBaseResponseCallback$1 implements RpcService.CallbackV2<CashierBaseResponse<ChangePayLimitResponse>> {
    final /* synthetic */ CashierNetCallback $callback;

    public FastPayNetwork$changePayLimit$$inlined$getBaseResponseCallback$1(CashierNetCallback cashierNetCallback) {
        this.$callback = cashierNetCallback;
    }

    public void onSuccess(RpcResponseProxy<CashierBaseResponse<ChangePayLimitResponse>> rpcResponseProxy) {
        String str;
        String errmsg;
        ...
        Log.i("Arirus", Intrinsics.stringPlus("onSuccess: ", ChangePayLimitResponse.class));
        boolean z = false;
        ...
        if (!z) {
            ...
            CashierBaseResponse<ChangePayLimitResponse> content2 = rpcResponseProxy.getContent();
