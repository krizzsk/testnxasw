...
public final class CashierNetwork$getCVVInfo$$inlined$getBaseResponseCallback$1 implements RpcService.CallbackV2<CashierBaseResponse<CVVInfoResponse>> {
    final /* synthetic */ CashierNetCallback $callback;

    public CashierNetwork$getCVVInfo$$inlined$getBaseResponseCallback$1(CashierNetCallback cashierNetCallback) {
        this.$callback = cashierNetCallback;
    }

    public void onSuccess(RpcResponseProxy<CashierBaseResponse<CVVInfoResponse>> rpcResponseProxy) {
        String str;
        String errmsg;
        ...
        Log.i("Arirus", Intrinsics.stringPlus("onSuccess: ", CVVInfoResponse.class));
        boolean z = false;
        ...
        if (!z) {
            ...
            CashierBaseResponse<CVVInfoResponse> content2 = rpcResponseProxy.getContent();
