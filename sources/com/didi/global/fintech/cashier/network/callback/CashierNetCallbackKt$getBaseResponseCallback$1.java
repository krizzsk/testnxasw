...
public final class CashierNetCallbackKt$getBaseResponseCallback$1 implements RpcService.CallbackV2<CashierBaseResponse<T>> {
    ...
    public void onSuccess(RpcResponseProxy<CashierBaseResponse<T>> rpcResponseProxy) {
        String str;
        String errmsg;
        CashierBaseResponse content;
        Object obj = null;
        SystemUtils.log(4, "Arirus", Intrinsics.stringPlus("onSuccess: ", rpcResponseProxy == null ? null : rpcResponseProxy.getContent()), (Throwable) null, "com.didi.global.fintech.cashier.network.callback.CashierNetCallbackKt$getBaseResponseCallback$1", 26);
        Intrinsics.reifiedOperationMarker(4, "T");
        SystemUtils.log(4, "Arirus", Intrinsics.stringPlus("onSuccess: ", Object.class), (Throwable) null, "com.didi.global.fintech.cashier.network.callback.CashierNetCallbackKt$getBaseResponseCallback$1", 27);
        boolean z = false;
        if (!(rpcResponseProxy == null || (content = rpcResponseProxy.getContent()) == null || content.getErrno() != 0)) {
            z = true;
        }
        if (!z) {
            CashierNetCallback<T> cashierNetCallback = this.$callback;
            Intrinsics.checkNotNull(rpcResponseProxy);
            CashierBaseResponse<T> content2 = rpcResponseProxy.getContent();
        ...
        if ((content5 == null ? null : content5.getData()) != null) {
            ...
            SystemUtils.log(4, "Arirus", Intrinsics.stringPlus("onSuccess: ", gson.toJson(content6 == null ? null : content6.getData())), (Throwable) null, "com.didi.global.fintech.cashier.network.callback.CashierNetCallbackKt$getBaseResponseCallback$1", 40);
            CashierNetCallback<T> cashierNetCallback2 = this.$callback;
        ...
        SystemUtils.log(4, "Arirus", "NET_ERROR: XXXXXXXXXXXXXXXXXXXXXXX1", (Throwable) null, "com.didi.global.fintech.cashier.network.callback.CashierNetCallbackKt$getBaseResponseCallback$1", 44);
