...
public final class FastPayNetwork$getFastPayInfo$$inlined$getBaseResponseCallback$1 implements RpcService.CallbackV2<CashierBaseResponse<FastPayInfoResponse>> {
    final /* synthetic */ CashierNetCallback $callback;

    public FastPayNetwork$getFastPayInfo$$inlined$getBaseResponseCallback$1(CashierNetCallback cashierNetCallback) {
        this.$callback = cashierNetCallback;
    }

    public void onSuccess(RpcResponseProxy<CashierBaseResponse<FastPayInfoResponse>> rpcResponseProxy) {
        String str;
        String errmsg;
        ...
        Log.i("Arirus", Intrinsics.stringPlus("onSuccess: ", FastPayInfoResponse.class));
        boolean z = false;
        ...
        if (!z) {
            ...
            CashierBaseResponse<FastPayInfoResponse> content2 = rpcResponseProxy.getContent();
