...
public final class CashierNetwork$getPayStatus$$inlined$getBaseResponseCallback$1 implements RpcService.CallbackV2<CashierBaseResponse<PayStatusResponse>> {
    ...
    public void onSuccess(RpcResponseProxy<CashierBaseResponse<PayStatusResponse>> rpcResponseProxy) {
        String str;
        String errmsg;
        ...
        Log.i("Arirus", Intrinsics.stringPlus("onSuccess: ", PayStatusResponse.class));
        boolean z = false;
        ...
        if (!z) {
            ...
            CashierBaseResponse<PayStatusResponse> content2 = rpcResponseProxy.getContent();
