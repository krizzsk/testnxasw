...
/* renamed from: com.didi.global.fintech.cashier.network.CashierNetwork$canChangeNewVersion$$inlined$getBaseResponseCallback$1 */
/* compiled from: CashierNetCallback.kt */
public final class C9064xb907fc42 implements RpcService.CallbackV2<CashierBaseResponse<CanChangeNewVersionResponse>> {
    final /* synthetic */ CashierNetCallback $callback;

    public C9064xb907fc42(CashierNetCallback cashierNetCallback) {
        this.$callback = cashierNetCallback;
    }

    public void onSuccess(RpcResponseProxy<CashierBaseResponse<CanChangeNewVersionResponse>> rpcResponseProxy) {
        String str;
        String errmsg;
        ...
        Log.i("Arirus", Intrinsics.stringPlus("onSuccess: ", CanChangeNewVersionResponse.class));
        boolean z = false;
        ...
        if (!z) {
            ...
            CashierBaseResponse<CanChangeNewVersionResponse> content2 = rpcResponseProxy.getContent();
