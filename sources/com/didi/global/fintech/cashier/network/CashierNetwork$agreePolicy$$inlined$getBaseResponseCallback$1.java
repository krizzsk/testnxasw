...
public final class CashierNetwork$agreePolicy$$inlined$getBaseResponseCallback$1 implements RpcService.CallbackV2<CashierBaseResponse<AgreePolicyResponse>> {
    final /* synthetic */ CashierNetCallback $callback;

    public CashierNetwork$agreePolicy$$inlined$getBaseResponseCallback$1(CashierNetCallback cashierNetCallback) {
        this.$callback = cashierNetCallback;
    }

    public void onSuccess(RpcResponseProxy<CashierBaseResponse<AgreePolicyResponse>> rpcResponseProxy) {
        String str;
        String errmsg;
        ...
        Log.i("Arirus", Intrinsics.stringPlus("onSuccess: ", AgreePolicyResponse.class));
        boolean z = false;
        ...
        if (!z) {
            ...
            CashierBaseResponse<AgreePolicyResponse> content2 = rpcResponseProxy.getContent();
