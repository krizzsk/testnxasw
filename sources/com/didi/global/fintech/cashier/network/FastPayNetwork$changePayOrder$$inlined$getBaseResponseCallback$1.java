...
public final class FastPayNetwork$changePayOrder$$inlined$getBaseResponseCallback$1 implements RpcService.CallbackV2<CashierBaseResponse<ChangePayOrderResponse>> {
    final /* synthetic */ CashierNetCallback $callback;

    public FastPayNetwork$changePayOrder$$inlined$getBaseResponseCallback$1(CashierNetCallback cashierNetCallback) {
        this.$callback = cashierNetCallback;
    }

    public void onSuccess(RpcResponseProxy<CashierBaseResponse<ChangePayOrderResponse>> rpcResponseProxy) {
        String str;
        String errmsg;
        ...
        Log.i("Arirus", Intrinsics.stringPlus("onSuccess: ", ChangePayOrderResponse.class));
        boolean z = false;
        ...
        if (!z) {
            ...
            CashierBaseResponse<ChangePayOrderResponse> content2 = rpcResponseProxy.getContent();
