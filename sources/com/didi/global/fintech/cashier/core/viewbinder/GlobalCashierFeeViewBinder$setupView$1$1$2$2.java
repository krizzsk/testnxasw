...
final class GlobalCashierFeeViewBinder$setupView$1$1$2$2 extends Lambda implements Function1<FeeHelpInfo, Unit> {
    public static final GlobalCashierFeeViewBinder$setupView$1$1$2$2 INSTANCE = new GlobalCashierFeeViewBinder$setupView$1$1$2$2();

    GlobalCashierFeeViewBinder$setupView$1$1$2$2() {
        super(1);
    }
