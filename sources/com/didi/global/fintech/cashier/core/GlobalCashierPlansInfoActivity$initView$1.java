...
final class GlobalCashierPlansInfoActivity$initView$1 extends Lambda implements Function1<View, Unit> {
    final /* synthetic */ GlobalCashierPlansInfoActivity this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    GlobalCashierPlansInfoActivity$initView$1(GlobalCashierPlansInfoActivity globalCashierPlansInfoActivity) {
        super(1);
