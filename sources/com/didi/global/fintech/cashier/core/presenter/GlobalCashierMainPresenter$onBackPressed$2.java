...
final class GlobalCashierMainPresenter$onBackPressed$2 extends Lambda implements Function0<Unit> {
    final /* synthetic */ GlobalCashierMainPresenter this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    GlobalCashierMainPresenter$onBackPressed$2(GlobalCashierMainPresenter globalCashierMainPresenter) {
        super(0);
