...
final class GlobalCashierConfirmPayActivity$initViewAndData$1 extends Lambda implements Function1<View, Unit> {
    final /* synthetic */ GlobalCashierConfirmPayActivity this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    GlobalCashierConfirmPayActivity$initViewAndData$1(GlobalCashierConfirmPayActivity globalCashierConfirmPayActivity) {
        super(1);
