...
final class CashierFacade$doLaunchImpl$1 extends Lambda implements Function1<Boolean, Unit> {
    ...
    CashierFacade$doLaunchImpl$1(CashierLaunchListener cashierLaunchListener, CashierFacade cashierFacade, Activity activity, Integer num, CashierParam cashierParam) {
        super(1);
    ...
    public final void invoke(boolean z) {
        ...
        if (z) {
            ...
            if (access$getCashierProcessor$p != null) {
                access$getCashierProcessor$p.launch(this.$activity, (Intent) null, this.$requestCode, this.$param);
                return;
            }
            return;
        }
