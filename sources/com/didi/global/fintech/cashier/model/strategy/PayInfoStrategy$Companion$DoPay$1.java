...
final class PayInfoStrategy$Companion$DoPay$1 extends Lambda implements Function2<PayInfoStrategy, PayInfoResponse, BaseStrategy.Result> {
    public static final PayInfoStrategy$Companion$DoPay$1 INSTANCE = new PayInfoStrategy$Companion$DoPay$1();

    PayInfoStrategy$Companion$DoPay$1() {
        super(2);
    }
