...
final class SodaPaymentsView$mPayBtnViewHolder$2 extends Lambda implements Function0<GlobalCashierPayBtnViewHolder> {
    final /* synthetic */ SodaPaymentsView this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    SodaPaymentsView$mPayBtnViewHolder$2(SodaPaymentsView sodaPaymentsView) {
        super(0);
    ...
    public final GlobalCashierPayBtnViewHolder invoke() {
        ...
        ViewGroup access$getMBottomView$p = this.this$0.f23562f;
