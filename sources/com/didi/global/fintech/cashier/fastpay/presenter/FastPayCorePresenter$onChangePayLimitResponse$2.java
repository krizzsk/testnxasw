...
final class FastPayCorePresenter$onChangePayLimitResponse$2 extends Lambda implements Function0<Unit> {
    final /* synthetic */ FastPayCorePresenter this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    FastPayCorePresenter$onChangePayLimitResponse$2(FastPayCorePresenter fastPayCorePresenter) {
        super(0);
    ...
    public final void invoke() {
        ...
        if (iFastPaySettingProcessor != null) {
            iFastPaySettingProcessor.onPasswordInterpreted(IFastPaySettingProcessor.PasswordInterpreted.TYPE_LIMIT);
        }
        IFastPayOperateProcessor iFastPayOperateProcessor = (IFastPayOperateProcessor) this.this$0.m19195a(IFastPayOperateProcessor.class);
