...
public final class TitleItem extends BaseItemView {
    ...
    public TitleItem(android.view.ViewGroup r4) {
        /*
            r3 = this;
            ...
            r3.<init>(r4)
            com.didi.global.fintech.cashier.ui.viewholder.ItemViewFactory$Type r4 = com.didi.global.fintech.cashier.p118ui.viewholder.ItemViewFactory.Type.Title
            r3.f23740a = r4
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.didi.global.fintech.cashier.p118ui.viewholder.TitleItem.<init>(android.view.ViewGroup):void");
    }
    ...
    public void bind(FastPayOrderItem fastPayOrderItem, Function0<Unit> function0) {
        ...
        this.f23741b.setText(fastPayOrderItem == null ? null : fastPayOrderItem.getContent());
    }
}
