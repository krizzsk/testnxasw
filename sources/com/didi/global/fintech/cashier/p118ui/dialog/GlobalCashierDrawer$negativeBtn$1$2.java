...
/* renamed from: com.didi.global.fintech.cashier.ui.dialog.GlobalCashierDrawer$negativeBtn$1$2 */
/* compiled from: GlobalCashierDrawer.kt */
final class GlobalCashierDrawer$negativeBtn$1$2 extends Lambda implements Function1<View, Unit> {
    final /* synthetic */ Map.Entry<String, View.OnClickListener> $entry;
    final /* synthetic */ GlobalCashierDrawer this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    GlobalCashierDrawer$negativeBtn$1$2(Map.Entry<String, ? extends View.OnClickListener> entry, GlobalCashierDrawer globalCashierDrawer) {
        super(1);
        this.$entry = entry;
