...
public class XPanelProgressBar extends View implements IParser, IView {

    /* renamed from: a */
    private float f24172a;

    /* renamed from: b */
    private Context f24173b;

    /* renamed from: c */
    private LinearGradient f24174c;
    ...
    public XPanelProgressBar(Context context) {
        this(context, (AttributeSet) null);
    }

    public XPanelProgressBar(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, 0);
    }

    public XPanelProgressBar(Context context, AttributeSet attributeSet, int i) {
    ...
    public void onSizeChanged(int i, int i2, int i3, int i4) {
        ...
        boolean z = getBackground() instanceof XPanelRoundColorDrawable;
        this.f24174c = new LinearGradient(0.0f, 0.0f, (float) getMeasuredWidth(), 0.0f, this.f24176e, this.f24175d, Shader.TileMode.CLAMP);
    }
    ...
    public void onDraw(Canvas canvas) {
        ...
        this.mRectF.right = ((float) getMeasuredWidth()) * this.f24172a;
        this.mRectF.bottom = (float) getMeasuredHeight();
        this.mPath.reset();
        LinearGradient linearGradient = this.f24174c;
    ...
    public void parse(java.lang.String r4, java.lang.String r5, com.facebook.yoga.YogaNode r6) {
        ...
        L_0x0046:
            ...
            throw r5
        L_0x005d:
            java.lang.String r4 = getFullColorString(r5)     // Catch:{ Exception -> 0x0078 }
            int r4 = android.graphics.Color.parseColor(r4)     // Catch:{ Exception -> 0x0078 }
            r3.setStartColor(r4)     // Catch:{ Exception -> 0x0078 }
            goto L_0x0078
        L_0x0069:
        ...
        L_0x0078:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.didi.global.globalgenerickit.template.yoga.view.XPanelProgressBar.parse(java.lang.String, java.lang.String, com.facebook.yoga.YogaNode):void");
    }
