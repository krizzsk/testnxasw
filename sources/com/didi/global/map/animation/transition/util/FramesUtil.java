...
public class FramesUtil {
    public static final int[] customer_frames = {R.drawable.t_c_00000, R.drawable.t_c_00001, R.drawable.t_c_00002, R.drawable.t_c_00003, R.drawable.t_c_00004, R.drawable.t_c_00005, R.drawable.t_c_00006, R.drawable.t_c_00007, R.drawable.t_c_00008, R.drawable.t_c_00009, R.drawable.t_c_00010, R.drawable.t_c_00011, R.drawable.t_c_00012, R.drawable.t_c_00013, R.drawable.t_c_00014, R.drawable.t_c_00015, R.drawable.t_c_00016, R.drawable.t_c_00017, R.drawable.t_c_00018, R.drawable.t_c_00019, R.drawable.t_c_00020, R.drawable.t_c_00021, R.drawable.t_c_00022, R.drawable.t_c_00023, R.drawable.t_c_00024, R.drawable.t_c_00025};

    public static int getCustomerInitialResourceId() {
        return R.drawable.t_c_00025;
    }
    ...
    public static int getBusinessFrame(Context context, int i) {
        ...
        return resources.getIdentifier("t_bb_000" + sb2, RConfigConstants.TYPE_DRAWABLE, packageName);
    }
    ...
    public static int getDeliveryFrame(Context context, int i) {
        ...
        String packageName = applicationContext.getPackageName();
        Resources resources = applicationContext.getResources();
        return resources.getIdentifier("t_d1_" + i, RConfigConstants.TYPE_DRAWABLE, packageName);
    }
    ...
    public static int[] getDeliveryFrames(Context context, int i) {
        ...
        for (int i2 = 1; i2 <= 3; i2++) {
            Resources resources = applicationContext.getResources();
            iArr[i2 - 1] = resources.getIdentifier("t_d" + i2 + "_" + i, RConfigConstants.TYPE_DRAWABLE, packageName);
        }
        return iArr;
    }
    ...
    public static int[] getDeliveryDrawables(Context context, LatLng latLng, LatLng latLng2) {
        ...
        LogUtil.m19846e("getDeliveryDrawables() from = null || to = null");
        return null;
    }
    ...
    public static int[] getBoxFrames(Context context, int i) {
        int i2;
        String str = (i < 1 || i > 9) ? "t_to_left_box_" : "t_to_right_box_";
        Context applicationContext = context.getApplicationContext();
        String packageName = applicationContext.getPackageName();
        int[] iArr = new int[14];
        int i3 = 0;
