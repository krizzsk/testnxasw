...
final class ExpectationCardAnimation$collapse$1$3 extends Lambda implements Function1<Transition, Unit> {
    final /* synthetic */ Function0<Unit> $onTransitionEnd;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    ExpectationCardAnimation$collapse$1$3(Function0<Unit> function0) {
        super(1);
