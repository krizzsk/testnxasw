...
@ServiceProvider(alias = "sa_home", value = {ISFTripRecordingService.class})
public class SAAudioRecordingService implements ISFTripRecordingService {
    /* access modifiers changed from: private */

    /* renamed from: a */
    public GlobalDialog f17288a = new GlobalDialog();
    ...
    public void showDialog(final FragmentActivity fragmentActivity, String str, String str2, String str3, String str4, final View.OnClickListener onClickListener) {
        if (this.f17288a.isPendingDismiss() || !this.f17288a.isVisible()) {
            this.f17288a.build().title(str2).actions(new GlobalDialog.IButtonAction[]{new GlobalDialog.PositiveButtonAction() {
                ...
                public Runnable getAction() {
                    return new Runnable() {
                        public void run() {
                            ...
                            SAAudioRecordingService.this.f17288a.dismiss();
                        }
                    };
                }
