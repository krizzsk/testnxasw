...
public class PushManagerProvider implements ISfPushManagerService {
    ...
    /* renamed from: a */
    private Map<ISfPushManagerService.ISfPushListener, DPushListener> f17302a = new HashMap();
    ...
    public void registerCommonMsgPush(final ISfPushManagerService.ISfPushListener iSfPushListener) {
        ...
        this.f17302a.put(iSfPushListener, r1);
    ...
    public void unregisterCommonMsgPush(ISfPushManagerService.ISfPushListener iSfPushListener) {
        if (this.f17302a.containsKey(iSfPushListener)) {
            DPushManager.getInstance().unregisterPush(this.f17302a.remove(iSfPushListener));
        }
    }
}
