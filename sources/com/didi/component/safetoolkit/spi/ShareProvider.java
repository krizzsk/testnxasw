...
public class ShareProvider implements ISfShareService {
    ...
    /* renamed from: a */
    private CommonTripShareManager f17303a;

    public void startSocialShare(Context context) {
        CommonTripShareManager commonTripShareManager = this.f17303a;
        ...
        if (presenter instanceof AbsSafeToolkitPresenter) {
            ...
            if (order != null) {
                if (this.f17303a == null) {
                    this.f17303a = new CommonTripShareManager();
                }
                ComponentParams componentParams = ((AbsSafeToolkitPresenter) presenter).getComponentParams();
                if (componentParams != null) {
                    this.f17303a.showShareDialog(componentParams.getActivity(), order.oid, order.productid);
                    return;
                }
