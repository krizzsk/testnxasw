...
public class SodaEntregaShareProvider implements ISfShareService {
    ...
    /* renamed from: a */
    private CommonTripShareManager f17297a;

    public void startSocialShare(Context context) {
        CommonTripShareManager commonTripShareManager = this.f17297a;
        ...
        if (presenter instanceof AbsSafeToolkitPresenter) {
            ...
            if (order != null) {
                if (this.f17297a == null) {
                    this.f17297a = new CommonTripShareManager();
                }
                ComponentParams componentParams = ((AbsSafeToolkitPresenter) presenter).getComponentParams();
                if (componentParams != null) {
                    this.f17297a.showShareDialog(componentParams.getActivity(), order.oid, order.productid);
                    return;
                }
