...
public class SodaEntregaLocationProvider implements ISfLocationService {
                ...
                if (presenter == null || !(presenter instanceof AbsSafeToolkitPresenter) || (componentParams = ((AbsSafeToolkitPresenter) presenter).getComponentParams()) != null) {
                    ...
                    instance.requestLocationUpdateOnce(context, new LocationController.OneCarLocationListener() {
                        ...
                        public void onLocationChanged(DIDILocation dIDILocation) {
                            SfLocation a = SodaEntregaLocationProvider.this.m14542a(dIDILocation);
                            ComponentParams componentParams = componentParams;
                            if (componentParams != null) {
                                SodaEntregaLocationProvider.this.m14543a(context, a, dIDILocation, componentParams, sfCallback);
                            }
                        }
    ...
    /* renamed from: a */
    public void m14543a(Context context, final SfLocation sfLocation, DIDILocation dIDILocation, ComponentParams componentParams, final ISfLocationService.SfCallback sfCallback) {
    ...
    /* access modifiers changed from: private */
    /* renamed from: a */
    public SfLocation m14542a(DIDILocation dIDILocation) {
