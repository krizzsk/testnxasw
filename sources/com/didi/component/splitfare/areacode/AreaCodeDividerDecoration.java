...
public class AreaCodeDividerDecoration extends RecyclerView.ItemDecoration {
    ...
    /* renamed from: b */
    private Paint f17749b;

    public AreaCodeDividerDecoration(Context context) {
        Paint paint = new Paint();
        this.f17749b = paint;
        paint.setColor(Color.parseColor("#0B000000"));
        this.f17748a = (int) TypedValue.applyDimension(1, 1.0f, context.getResources().getDisplayMetrics());
    }

    public void getItemOffsets(Rect rect, View view, RecyclerView recyclerView, RecyclerView.State state) {
        super.getItemOffsets(rect, view, recyclerView, state);
        rect.bottom = this.f17748a;
    }
    ...
    public void onDraw(Canvas canvas, RecyclerView recyclerView, RecyclerView.State state) {
        ...
        for (int i = 0; i < childCount; i++) {
            ...
            if (i != 0 || childLayoutPosition != 0) {
                ...
                canvas2.drawRect((float) paddingLeft, (float) childAt.getBottom(), (float) width, (float) (childAt.getBottom() + this.f17748a), this.f17749b);
            }
        }
    }
}
