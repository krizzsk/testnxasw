...
public class GenericHelper {
    public static Class<? extends Object> getGenericTypeArgument(Class cls, Class cls2, int i) {
        Class<? extends Object> a = m13859a(cls2, i, cls.getGenericSuperclass());
        if (a != null) {
            return a;
        }
        Class<? extends Object> a2 = m13859a(cls2, i, cls.getGenericInterfaces());
        if (a2 != null) {
            return a2;
        }
        return getGenericTypeArgument(m13860a(cls, cls2), cls2, i);
    }

    /* renamed from: a */
    private static Class<? extends Object> m13860a(Class cls, Class cls2) {
    ...
    /* renamed from: a */
    private static Class m13859a(Class cls, int i, Type... typeArr) {
