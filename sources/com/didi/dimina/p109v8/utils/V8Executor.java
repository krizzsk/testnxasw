...
/* renamed from: com.didi.dimina.v8.utils.V8Executor */
public class V8Executor extends Thread {
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:48:0x0099, code lost:
        ...
        r4 = new com.didi.dimina.p109v8.V8Array(r8.runtime);
        r5 = new com.didi.dimina.p109v8.V8Array(r8.runtime);
     */
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:53:0x00bb, code lost:
        r4.push((com.didi.dimina.p109v8.V8Value) r5);
    ...
    public void run() {
        /*
            r8 = this;
            monitor-enter(r8)
            com.didi.dimina.v8.V8 r0 = com.didi.dimina.p109v8.C8369V8.createV8Runtime()     // Catch:{ all -> 0x012d }
            r8.runtime = r0     // Catch:{ all -> 0x012d }
            com.didi.dimina.v8.utils.V8Executor$ExecutorTermination r1 = new com.didi.dimina.v8.utils.V8Executor$ExecutorTermination     // Catch:{ all -> 0x012d }
            r1.<init>()     // Catch:{ all -> 0x012d }
            java.lang.String r2 = "__j2v8__checkThreadTerminate"
            r0.registerJavaMethod((com.didi.dimina.p109v8.JavaVoidCallback) r1, (java.lang.String) r2)     // Catch:{ all -> 0x012d }
            com.didi.dimina.v8.V8 r0 = r8.runtime     // Catch:{ all -> 0x012d }
            ...
            com.didi.dimina.v8.V8 r2 = r8.runtime     // Catch:{ Exception -> 0x00f4 }
        ...
        L_0x0043:
            boolean r3 = r2 instanceof com.didi.dimina.p109v8.Releasable     // Catch:{ Exception -> 0x00f4 }
            if (r3 == 0) goto L_0x004c
            com.didi.dimina.v8.Releasable r2 = (com.didi.dimina.p109v8.Releasable) r2     // Catch:{ Exception -> 0x00f4 }
        ...
        L_0x0074:
            ...
            monitor-enter(r8)
            com.didi.dimina.v8.V8 r2 = r8.runtime     // Catch:{ all -> 0x008d }
            com.didi.dimina.v8.V8Locker r2 = r2.getLocker()     // Catch:{ all -> 0x008d }
        ...
        L_0x0090:
            ...
            com.didi.dimina.v8.V8Array r4 = new com.didi.dimina.v8.V8Array     // Catch:{ Exception -> 0x00f4 }
            com.didi.dimina.v8.V8 r5 = r8.runtime     // Catch:{ Exception -> 0x00f4 }
            r4.<init>(r5)     // Catch:{ Exception -> 0x00f4 }
            com.didi.dimina.v8.V8Array r5 = new com.didi.dimina.v8.V8Array     // Catch:{ Exception -> 0x00f4 }
            com.didi.dimina.v8.V8 r6 = r8.runtime     // Catch:{ Exception -> 0x00f4 }
        ...
        L_0x00b1:
            ...
            goto L_0x00b1
        L_0x00bb:
            r4.push((com.didi.dimina.p109v8.V8Value) r5)     // Catch:{ all -> 0x00cc }
            com.didi.dimina.v8.V8 r2 = r8.runtime     // Catch:{ all -> 0x00cc }
        ...
        L_0x00d7:
            monitor-enter(r8)
            com.didi.dimina.v8.V8 r2 = r8.runtime     // Catch:{ all -> 0x00ef }
            com.didi.dimina.v8.V8Locker r2 = r2.getLocker()     // Catch:{ all -> 0x00ef }
        ...
        L_0x00f4:
            ...
            monitor-enter(r8)
            com.didi.dimina.v8.V8 r2 = r8.runtime     // Catch:{ all -> 0x010f }
            com.didi.dimina.v8.V8Locker r2 = r2.getLocker()     // Catch:{ all -> 0x010f }
        ...
        L_0x0112:
            monitor-enter(r8)
            com.didi.dimina.v8.V8 r3 = r8.runtime     // Catch:{ all -> 0x012a }
            com.didi.dimina.v8.V8Locker r3 = r3.getLocker()     // Catch:{ all -> 0x012a }
        ...
        L_0x012d:
            ...
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.didi.dimina.p109v8.utils.V8Executor.run():void");
    }
    ...
    /* renamed from: com.didi.dimina.v8.utils.V8Executor$ExecutorTermination */
