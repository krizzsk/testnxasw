...
public class BridgeHelper {
    ...
    public static final String ASSET_BRIDGE4_JS = "fusion/diminadidibridge4.js";
    ...
    /* renamed from: a */
    static final String f20137a = "";

    /* renamed from: b */
    static final String f20138b = "/";

    /* renamed from: c */
    private static final String f20139c = "BridgeHelper";
    ...
    public static String assetFileToString(Context context, String str) {
        ...
        return m17023a(inputStream);
    }

    /* renamed from: a */
    private static String m17023a(InputStream inputStream) {
        String readLine;
        if (inputStream == null) {
            return "";
        }
