...
public final class PageContainerPlugin implements FlutterPlugin, MethodChannel.MethodCallHandler {
    ...
    /* renamed from: a */
    private final String f21751a = "com.didi.rlab/container_plugin";
    ...
    public void onAttachedToEngine(FlutterPlugin.FlutterPluginBinding flutterPluginBinding) {
        Intrinsics.checkNotNullParameter(flutterPluginBinding, "binding");
        new MethodChannel(flutterPluginBinding.getFlutterEngine().getDartExecutor(), this.f21751a).setMethodCallHandler(this);
    }
