...
public class ShareDefaultImp implements IShareInterface {
    ...
    public void shareToPlatform(Context context, ShareToolModel shareToolModel, ICallback.IPlatformShareCallback iPlatformShareCallback) {
        ShareBuilder.shareToPlatform(context, m18216a(shareToolModel), iPlatformShareCallback);
    }
    ...
    public void showSharePlatform(Context context, ArrayList<ShareToolModel> arrayList, ICallback.IShareCallback iShareCallback) {
        if (arrayList != null && arrayList.size() > 0) {
            ...
            while (it.hasNext()) {
                arrayList2.add(m18216a(it.next()));
            }
    ...
    /* renamed from: a */
    private static OneKeyShareInfo m18216a(ShareToolModel shareToolModel) {
        ...
        oneKeyShareInfo.smsMessage = m18217b(shareToolModel);
        return oneKeyShareInfo;
    }

    /* renamed from: b */
    private static String m18217b(ShareToolModel shareToolModel) {
