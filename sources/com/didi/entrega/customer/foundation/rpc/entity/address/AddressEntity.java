...
public class AddressEntity implements Parcelable, IEntity {
    ...
    public AddressEntity clone() {
        ...
        addressEntity.uid = this.uid;
        PoiEntity poiEntity = this.poi;
        if (poiEntity != null) {
            addressEntity.poi = poiEntity.clone();
        }
        addressEntity.type = this.type;
        addressEntity.houseNumber = this.houseNumber;
        addressEntity.createTime = this.createTime;
        addressEntity.canUseCash = this.canUseCash;
        addressEntity.recid = this.recid;
        addressEntity.callingCode = this.callingCode;
        addressEntity.countryId = this.countryId;
        addressEntity.phone = this.phone;
        addressEntity.name = this.name;
        addressEntity.userCountryCode = this.userCountryCode;
        addressEntity.houseName = this.houseName;
        addressEntity.buildingName = this.buildingName;
        addressEntity.firstName = this.firstName;
        addressEntity.lastName = this.lastName;
        addressEntity.required = this.required;
        addressEntity.bizLine = this.bizLine;
    ...
    protected AddressEntity(Parcel parcel) {
        ...
        this.required = parcel.readInt() == 1 ? true : z;
    ...
    public String getAptAndBuildingName() {
        ...
        if (!TextUtils.isEmpty(this.houseNumber) && !TextUtils.isEmpty(this.buildingName)) {
            sb.append(ResourceHelper.getString(R.string.entrega_global_blank));
        }
        if (!TextUtils.isEmpty(this.buildingName)) {
            sb.append(this.buildingName);
        }
