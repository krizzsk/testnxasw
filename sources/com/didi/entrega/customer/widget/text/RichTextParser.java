...
public final class RichTextParser {
    ...
    /* renamed from: a */
    private static final String f22466a = "RichTextParser";

    /* renamed from: b */
    private static final int f22467b = 4;

    /* renamed from: c */
    private static Pattern f22468c = Pattern.compile("&em#.*?&em#");

    private RichTextParser() {
    }

    public static CharSequence parseText(CharSequence charSequence) {
        return m18491a(charSequence, false);
    }

    public static CharSequence parseIconText(CharSequence charSequence) {
        return m18491a(charSequence, true);
    }
    ...
    /* renamed from: a */
    private static CharSequence m18491a(CharSequence charSequence, boolean z) {
        if (TextUtils.isEmpty(charSequence)) {
            return "";
        }
        SpannableStringBuilder spannableStringBuilder = new SpannableStringBuilder();
        Matcher matcher = f22468c.matcher(charSequence);
        int i = 0;
        while (matcher.find()) {
            if (i < matcher.start()) {
            ...
            if (start < end) {
                if (z) {
                    spannableStringBuilder.append(m18492b(charSequence.subSequence(start, end)));
                } else {
                    spannableStringBuilder.append(m18489a(charSequence.subSequence(start, end)));
                }
            }
            i = matcher.end();
        }
    ...
    /* renamed from: a */
    private static SpannableString m18489a(CharSequence charSequence) {
        ...
        try {
            ...
            LogUtil.m18185i(f22466a, "RichTextView produces Exception:" + e.toString());
            e.printStackTrace();
            richTextModel = null;
        }
        ...
        if (richTextModel.mWeight > 0) {
            spannableString.setSpan(new CustomerTypeFaceSpan(((IToolsService) CustomerServiceManager.getService(IToolsService.class)).getFontTypeFace(m18490a(richTextModel.mWeight))), 0, richTextModel.mText.length(), 17);
        }
        return spannableString;
    }

    /* renamed from: b */
    private static SpannableString m18492b(CharSequence charSequence) {
        RichTextModel richTextModel;
        String str;
        try {
            richTextModel = (RichTextModel) GsonUtil.fromJson((Reader) new CharSequenceReader(charSequence), (Type) RichTextModel.class);
        ...
        if (richTextModel.mWeight > 0) {
            spannableString.setSpan(new CustomerTypeFaceSpan(((IToolsService) CustomerServiceManager.getService(IToolsService.class)).getFontTypeFace(m18490a(richTextModel.mWeight))), 0, str.length(), 17);
        }
        return spannableString;
    }

    /* renamed from: a */
    private static IToolsService.FontType m18490a(int i) {
        if (i == 2) {
