package com.didi.entrega.customer.base.pages.changehandler;
...
public class CustomerVerticalChangeHandler extends AnimatorChangeHandler {
    ...
    /* renamed from: a */
    private static final long f21672a = 1;

    /* renamed from: b */
    private static final long f21673b = 400;
    ...
    public Animator getAnimator(ViewGroup viewGroup, View view, final View view2, boolean z, boolean z2) {
        ...
        if (z) {
            if (view2 != null) {
                ...
                duration.setInterpolator(m18112c());
            ...
            duration2.setInterpolator(m18112c());
