...
public abstract class HomeCityItemBinder extends ItemBinder<HomeCityItemRvModel, ViewHolder> {
    ...
    public ViewHolder create(LayoutInflater layoutInflater, ViewGroup viewGroup) {
        return new ViewHolder(layoutInflater.inflate(R.layout.entrega_item_home_city_item, viewGroup, false));
    }
    ...
    static class ViewHolder extends ItemViewHolder<HomeCityItemRvModel> {
        ...
        /* access modifiers changed from: private */
        public CustomerAppCompatTextView mName;

        ViewHolder(View view) {
            super(view);
            this.mName = (CustomerAppCompatTextView) view.findViewById(R.id.entrega_tv_name);
            this.mDivider = view.findViewById(R.id.entrega_view_divider);
        }
    }
}
