...
final class InfoOmegaHelper$trackContactCommonShow$4 extends Lambda implements Function0<Unit> {
    ...
    InfoOmegaHelper$trackContactCommonShow$4(Ref.ObjectRef<String> objectRef, Ref.ObjectRef<String> objectRef2, Ref.ObjectRef<String> objectRef3, OmegaCommonModel omegaCommonModel) {
        super(0);
