...
final class InfoOmegaHelper$trackContactCommonCK$3 extends Lambda implements Function0<Unit> {
    ...
    InfoOmegaHelper$trackContactCommonCK$3(OmegaCommonModel omegaCommonModel, Ref.ObjectRef<String> objectRef, Ref.ObjectRef<String> objectRef2, Ref.ObjectRef<String> objectRef3) {
        super(0);
    ...
    public final void invoke() {
        ...
        this.$poiCityKey.element = ParamConst.InfoOmega.RECEIVER_CITY_ID;
        this.$eventName.element = EventConst.INFO.SAILING_C_E_ENTREGAPAGE_RECEIVER_RETURN_CK;
    }
}
