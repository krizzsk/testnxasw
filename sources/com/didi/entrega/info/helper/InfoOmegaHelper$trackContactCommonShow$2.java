...
final class InfoOmegaHelper$trackContactCommonShow$2 extends Lambda implements Function0<Unit> {
    ...
    InfoOmegaHelper$trackContactCommonShow$2(Ref.ObjectRef<String> objectRef, Ref.ObjectRef<String> objectRef2, Ref.ObjectRef<String> objectRef3, OmegaCommonModel omegaCommonModel) {
        super(0);
