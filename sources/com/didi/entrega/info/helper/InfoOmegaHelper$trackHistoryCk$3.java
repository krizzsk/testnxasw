...
final class InfoOmegaHelper$trackHistoryCk$3 extends Lambda implements Function0<Unit> {
    final /* synthetic */ Ref.ObjectRef<String> $eventName;
    final /* synthetic */ OmegaCommonModel $omegaCommonModel;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    InfoOmegaHelper$trackHistoryCk$3(Ref.ObjectRef<String> objectRef, OmegaCommonModel omegaCommonModel) {
        super(0);
    ...
    public final void invoke() {
        this.$eventName.element = EventConst.INFO.SAILING_C_E_ENTREGAPAGE_RECEIVER_HISTORYRECORD_CK;
