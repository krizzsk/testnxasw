...
final class InfoOmegaHelper$trackConfirmCk$1 extends Lambda implements Function0<Unit> {
    ...
    InfoOmegaHelper$trackConfirmCk$1(OmegaCommonModel omegaCommonModel, Ref.ObjectRef<String> objectRef, Ref.ObjectRef<String> objectRef2, Ref.ObjectRef<String> objectRef3) {
        super(0);
