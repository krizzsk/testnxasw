...
final class InfoOmegaHelper$trackConfirmCk$4 extends Lambda implements Function0<Unit> {
    ...
    InfoOmegaHelper$trackConfirmCk$4(OmegaCommonModel omegaCommonModel, Ref.ObjectRef<String> objectRef, Ref.ObjectRef<String> objectRef2, Ref.ObjectRef<String> objectRef3) {
        super(0);
