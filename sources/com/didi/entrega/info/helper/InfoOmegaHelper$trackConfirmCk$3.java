...
final class InfoOmegaHelper$trackConfirmCk$3 extends Lambda implements Function0<Unit> {
    ...
    InfoOmegaHelper$trackConfirmCk$3(OmegaCommonModel omegaCommonModel, Ref.ObjectRef<String> objectRef, Ref.ObjectRef<String> objectRef2, Ref.ObjectRef<String> objectRef3) {
        super(0);
    ...
    public final void invoke() {
        ...
        this.$eventName.element = EventConst.INFO.SAILING_C_E_ENTREGAPAGE_RECEIVER_CONFIRM_CK;
    }
}
