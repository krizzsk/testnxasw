...
final class InfoOmegaHelper$trackContactCommonCK$2 extends Lambda implements Function0<Unit> {
    ...
    InfoOmegaHelper$trackContactCommonCK$2(OmegaCommonModel omegaCommonModel, Ref.ObjectRef<String> objectRef, Ref.ObjectRef<String> objectRef2, Ref.ObjectRef<String> objectRef3) {
        super(0);
    ...
    public final void invoke() {
        ...
        this.$eventName.element = EventConst.INFO.SAILING_C_E_ENTREGAPAGE_SENDER_COMMON_CK;
    }
}
