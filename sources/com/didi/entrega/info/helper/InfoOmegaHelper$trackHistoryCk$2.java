...
final class InfoOmegaHelper$trackHistoryCk$2 extends Lambda implements Function0<Unit> {
    final /* synthetic */ Ref.ObjectRef<String> $eventName;
    final /* synthetic */ OmegaCommonModel $omegaCommonModel;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    InfoOmegaHelper$trackHistoryCk$2(Ref.ObjectRef<String> objectRef, OmegaCommonModel omegaCommonModel) {
        super(0);
