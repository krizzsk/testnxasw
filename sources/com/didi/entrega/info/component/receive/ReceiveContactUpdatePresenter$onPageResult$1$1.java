...
final class ReceiveContactUpdatePresenter$onPageResult$1$1 extends Lambda implements Function0<BaseContactModel> {
    final /* synthetic */ AddressEntity $it;
    final /* synthetic */ ReceiveContactUpdatePresenter this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    ReceiveContactUpdatePresenter$onPageResult$1$1(ReceiveContactUpdatePresenter receiveContactUpdatePresenter, AddressEntity addressEntity) {
        super(0);
    ...
    public final BaseContactModel invoke() {
        ...
        this.this$0.getComponentRepo().setReceiverValue(this.this$0.getContractModel());
