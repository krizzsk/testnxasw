...
final class StuffUpdatePresenter$showAbnormal$abnormalViewModel$1 extends Lambda implements Function1<View, Unit> {
    final /* synthetic */ StuffUpdatePresenter this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    StuffUpdatePresenter$showAbnormal$abnormalViewModel$1(StuffUpdatePresenter stuffUpdatePresenter) {
        super(1);
