...
public final class SendContactView extends ContactConstract.AbsEditContactView {

    /* renamed from: a */
    private EditContactBinder f22636a;

    /* renamed from: b */
    private final InfoComponentRepo f22637b = ((InfoComponentRepo) RepoFactory.getRepo(InfoComponentRepo.class));
    ...
    public final void setEditBinder(EditContactBinder editContactBinder) {
        this.f22636a = editContactBinder;
    }
    ...
    public void onCreate() {
        ...
        ((TitleBarView) getRootView().findViewById(R.id.title_bar)).setOnBackClickListener(new OnBackClickListener() {
            public final void onBackClick(View view) {
                SendContactView.m18622a(SendContactView.this, view);
            }
        });
        this.f22637b.subscribe(getScopeContext(), new Action1() {
            public final void call(Object obj) {
                SendContactView.m18623a(SendContactView.this, (String) obj);
            }
        });
    }
    ...
    /* renamed from: a */
    public static final void m18622a(SendContactView sendContactView, View view) {
        Intrinsics.checkNotNullParameter(sendContactView, "this$0");
        ((AbsInfoPresenter) sendContactView.getPresenter()).handleBack();
    }
    ...
    public static final void m18623a(com.didi.entrega.info.component.send.SendContactView r6, java.lang.String r7) {
        /*
            java.lang.String r7 = "this$0"
            kotlin.jvm.internal.Intrinsics.checkNotNullParameter(r6, r7)
            com.didi.entrega.info.repo.InfoComponentRepo r7 = r6.getRepo()
            com.didi.entrega.info.model.ContactModel r7 = r7.getSender()
            r0 = 1
        ...
        L_0x0188:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.didi.entrega.info.component.send.SendContactView.m18623a(com.didi.entrega.info.component.send.SendContactView, java.lang.String):void");
    }
    ...
    public void initItemBinders() {
        ...
        editContactBinder.setSender(true);
        ...
        editContactBinder.setContactCardClickListener(new SendContactView$initItemBinders$1$1(this));
        Unit unit = Unit.INSTANCE;
        this.f22636a = editContactBinder;
        registerBinder(editContactBinder);
        HistoryItemBinder historyItemBinder = new HistoryItemBinder();
        historyItemBinder.setBinderFusionChannel(getFusionChannel());
        historyItemBinder.setHistoryClickListener(new SendContactView$initItemBinders$2$1(this));
