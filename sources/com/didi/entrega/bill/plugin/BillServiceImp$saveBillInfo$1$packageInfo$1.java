...
final class BillServiceImp$saveBillInfo$1$packageInfo$1 extends Lambda implements Function1<BillComponentEntity, Unit> {
    final /* synthetic */ ICustomerContactManager $this_apply;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    BillServiceImp$saveBillInfo$1$packageInfo$1(ICustomerContactManager iCustomerContactManager) {
        super(1);
