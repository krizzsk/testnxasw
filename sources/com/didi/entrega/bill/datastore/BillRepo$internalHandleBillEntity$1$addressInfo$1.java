...
final class BillRepo$internalHandleBillEntity$1$addressInfo$1 extends Lambda implements Function1<BillComponentEntity, Unit> {
    final /* synthetic */ ICustomerContactManager $this_apply;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    BillRepo$internalHandleBillEntity$1$addressInfo$1(ICustomerContactManager iCustomerContactManager) {
        super(1);
