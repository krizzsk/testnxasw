...
final class BillOmegaHelper$buildCommonParams$addCouponAction$1 extends Lambda implements Function1<BillComponentEntity, OmegaTracker.Builder> {
    final /* synthetic */ OmegaTracker.Builder $builder;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    BillOmegaHelper$buildCommonParams$addCouponAction$1(OmegaTracker.Builder builder) {
        super(1);
    ...
    public final OmegaTracker.Builder invoke(BillComponentEntity billComponentEntity) {
        ...
        return builder.addEventParam(ParamConst.PARAM_COUPON_PRICE, Integer.valueOf(BillExtKt.orZero(num)));
    }
}
