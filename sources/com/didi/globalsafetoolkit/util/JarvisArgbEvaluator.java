...
public class JarvisArgbEvaluator implements TypeEvaluator {

    /* renamed from: a */
    private static final JarvisArgbEvaluator f25184a = new JarvisArgbEvaluator();

    public static JarvisArgbEvaluator getInstance() {
        return f25184a;
    }
