...
import com.didi.globalsafetoolkit.business.contacts.model.SfContactModel;
...
import com.didi.globalsafetoolkit.widget.DiTips;
...
public class SfContactInfoShowVH extends SfContactInfoBaseVH {
    ...
    /* renamed from: a */
    public Callback f24993a;

    /* renamed from: b */
    private TextView f24994b = ((TextView) this.itemView.findViewById(R.id.add_area_code_btn));
                        ...
                        titleTypeface.setContent(sb.toString()).setRightBtn(SfStringGetter.getString(R.string.sf_remove), (View.OnClickListener) new View.OnClickListener() {
                            public void onClick(View view) {
                                ...
                                if (SfApolloUtil.isNewSyncContactInterface()) {
                                    ...
                                    try {
                                        SfContactInfoShowVH.this.f24993a.deleteDialogClickPerform(new Gson().toJson((Object) arrayList));
                                    } catch (Exception e) {
                                        e.printStackTrace();
                                    }
                                } else {
                                    ...
                                    try {
                                        SfContactInfoShowVH.this.f24993a.deleteDialogClickPerform(new Gson().toJson((Object) arrayList2));
                                    } catch (Exception e2) {
                                        e2.printStackTrace();
                                    }
                                }
    ...
    public void setData(final SfContactsModel sfContactsModel) {
        ...
        if (!SfApolloUtil.isAreaCode4StockShow()) {
            ...
            this.f24994b.setOnClickListener(new View.OnClickListener() {
                public void onClick(View view) {
                    AutoTrackHelper.trackViewOnClick(view);
                    if (SfContactInfoShowVH.this.f24993a != null) {
                        SfOmegaUtil.addEventId("gp_addAreaCode_btn_ck").report();
                        SfContactInfoShowVH.this.f24993a.onAddAreaCodeClick(sfContactsModel);
                    }
                }
            });
        } else {
            this.f24994b.setVisibility(8);
            this.f24994b.setOnClickListener((View.OnClickListener) null);
        }
    }

    public void setCallback(Callback callback) {
        this.f24993a = callback;
    }
}
