...
public class TripRecordOmageUtils {
    ...
    public static void sendLawBtnClickOmega(boolean z, String str) {
        SfOmegaUtil.addEventId("pax_safetyRecord_pax_btn_ck").addKeyValue("type", Integer.valueOf(GlobalTripRecordingManagerNew.Companion.getInstance().isRecording() ? 3 : z ? 2 : 1)).addKeyValue("order_id", str).report();
    }

    public static void sendTripRecordingActShowOmega(boolean z, String str) {
        SfOmegaUtil.addEventId("pax_safetyRecord_view_sw").addKeyValue("type", Integer.valueOf(GlobalTripRecordingManagerNew.Companion.getInstance().isRecording() ? 3 : z ? 2 : 1)).addKeyValue("order_id", str).report();
    }
