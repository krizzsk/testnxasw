...
public class UnipayTextUtil extends SpannableStringBuilder {
    ...
    /* renamed from: a */
    private static final String f47276a = "(([0-9]*\\.?[0-9]+)*,?[0-9]*)";

    /* renamed from: b */
    private static final String f47277b = "&#10;";

    /* renamed from: c */
    private CharSequence f47278c;
    ...
    public static String getFirstMoneyFromText(String str) {
        ...
        Matcher matcher = Pattern.compile(f47276a).matcher(str);
        if (matcher.find()) {
    ...
    public SpannableStringBuilder spanNumSize(float f) {
        Matcher matcher = Pattern.compile(f47276a).matcher(this.f47278c);
        while (matcher.find()) {
            m35188a(f, matcher.start(), matcher.end());
        }
        return this;
    }

    /* renamed from: a */
    private void m35188a(float f, int i, int i2) {
