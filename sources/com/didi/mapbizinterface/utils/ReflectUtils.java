...
public class ReflectUtils {
    ...
    public static boolean getDeclaredBooleanField(Class<?> cls, Object obj, String str, boolean z) {
        try {
    ...
    public static void setDeclaredBooleanField(Class<?> cls, Object obj, String str, boolean z) {
        try {
            Field declaredField = cls.getDeclaredField(str);
            declaredField.setAccessible(true);
    ...
    public static int getDeclaredIntField(Class<?> cls, Object obj, String str, int i) {
        try {
            Field declaredField = cls.getDeclaredField(str);
            declaredField.setAccessible(true);
    ...
    public static void setDeclaredIntField(Class<?> cls, Object obj, String str, int i) {
        try {
            Field declaredField = cls.getDeclaredField(str);
            declaredField.setAccessible(true);
    ...
    public static long getDeclaredLongField(Class<?> cls, Object obj, String str, long j) {
        try {
            Field declaredField = cls.getDeclaredField(str);
            declaredField.setAccessible(true);
    ...
    public static void setDeclaredLongField(Class<?> cls, Object obj, String str, long j) {
        try {
            Field declaredField = cls.getDeclaredField(str);
            declaredField.setAccessible(true);
    ...
    public static String getDeclaredStringField(Class<?> cls, Object obj, String str, String str2) {
        try {
            Field declaredField = cls.getDeclaredField(str);
            declaredField.setAccessible(true);
    ...
    public static void setDeclaredStringField(Class<?> cls, Object obj, String str, String str2) {
        try {
            Field declaredField = cls.getDeclaredField(str);
            declaredField.setAccessible(true);
    ...
    private static java.lang.Class<?>[] m24109a(java.lang.Object... r5) {
        /*
        ...
        L_0x003c:
            return r1
        */
        throw new UnsupportedOperationException("Method not decompiled: com.didi.mapbizinterface.utils.ReflectUtils.m24109a(java.lang.Object[]):java.lang.Class[]");
    }

    /* renamed from: a */
    private static Method m24108a(Class<?> cls, String str, Object... objArr) {
        try {
            Class[] a = m24109a(objArr);
    ...
    public static Object invokeMethodReturnObject(Class<?> cls, Object obj, String str, Object... objArr) {
        try {
            Method a = m24108a(cls, str, objArr);
            if (a != null) {
