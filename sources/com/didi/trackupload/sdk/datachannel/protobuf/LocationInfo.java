...
public final class LocationInfo extends Message {
    ...
    private LocationInfo(com.didi.trackupload.sdk.datachannel.protobuf.LocationInfo.Builder r21) {
        /*
            ...
            r0 = r21
            r1 = r20
            java.lang.Double r2 = r0.f46645x
            java.lang.Double r3 = r0.f46646y
    ...
    public int hashCode() {
        ...
        Double d = this.f46643x;
        int i2 = 0;
        int hashCode = (d != null ? d.hashCode() : 0) * 37;
        Double d2 = this.f46644y;
    ...
    public static final class Builder extends Message.Builder<LocationInfo> {
        ...
        /* renamed from: x */
        public Double f46645x;

        /* renamed from: y */
        public Double f46646y;
        ...
        public Builder(LocationInfo locationInfo) {
            ...
            if (locationInfo != null) {
                this.f46645x = locationInfo.f46643x;
                this.f46646y = locationInfo.f46644y;
        ...
        /* renamed from: x */
        public Builder mo116114x(Double d) {
            this.f46645x = d;
            return this;
        }

        /* renamed from: y */
        public Builder mo116115y(Double d) {
            this.f46646y = d;
            return this;
        }
