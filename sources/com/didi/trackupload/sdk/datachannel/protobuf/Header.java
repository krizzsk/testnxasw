...
public final class Header extends Message {
    ...
    public static final Long DEFAULT_SEQ_NUM = 0L;
    ...
    public Header(Integer num, Long l, Long l2, ByteString byteString, UserAgent userAgent, Long l3, UserConnInfo userConnInfo, Long l4, Integer num2, Long l5) {
        this.type = num;
        this.msg_id = l;
    ...
    private Header(Builder builder) {
        this(builder.type, builder.msg_id, builder.auth_user_id, builder.log_id, builder.user_agent, builder.timestamp, builder.user_conn_info, builder.city_id, builder.flow_tag, builder.seq_num);
        setBuilder(builder);
    }
