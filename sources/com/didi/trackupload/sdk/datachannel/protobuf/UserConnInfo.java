...
public final class UserConnInfo extends Message {
    ...
    /* renamed from: ip */
    public final ByteString f46647ip;
    ...
    public UserConnInfo(ByteString byteString, Integer num, String str) {
        this.f46647ip = byteString;
        this.port = num;
        this.zone = str;
    }

    private UserConnInfo(Builder builder) {
        this(builder.f46648ip, builder.port, builder.zone);
        setBuilder(builder);
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (!equals((Object) this.f46647ip, (Object) userConnInfo.f46647ip) || !equals((Object) this.port, (Object) userConnInfo.port) || !equals((Object) this.zone, (Object) userConnInfo.zone)) {
            return false;
        }
        return true;
    }
    ...
    public int hashCode() {
        ...
        ByteString byteString = this.f46647ip;
        int i2 = 0;
    ...
    public static final class Builder extends Message.Builder<UserConnInfo> {
        ...
        public Builder(UserConnInfo userConnInfo) {
            ...
            if (userConnInfo != null) {
                this.f46648ip = userConnInfo.f46647ip;
        ...
        /* renamed from: ip */
        public Builder mo116172ip(ByteString byteString) {
            this.f46648ip = byteString;
            return this;
        }
