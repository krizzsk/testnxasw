...
public final class DriverOrderMoneyGetReqV2 extends Message {
    ...
    private DriverOrderMoneyGetReqV2(Builder builder) {
        this(builder.phone, builder.token, builder.order_type, builder.f46642id, builder.info, builder.plutus_data);
        setBuilder(builder);
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (!equals((Object) this.phone, (Object) driverOrderMoneyGetReqV2.phone) || !equals((Object) this.token, (Object) driverOrderMoneyGetReqV2.token) || !equals((Object) this.order_type, (Object) driverOrderMoneyGetReqV2.order_type) || !equals((Object) this.f46641id, (Object) driverOrderMoneyGetReqV2.f46641id) || !equals((List<?>) this.info, (List<?>) driverOrderMoneyGetReqV2.info) || !equals((Object) this.plutus_data, (Object) driverOrderMoneyGetReqV2.plutus_data)) {
            return false;
        }
        return true;
    }
    ...
    public static final class Builder extends Message.Builder<DriverOrderMoneyGetReqV2> {
        ...
        public Builder(DriverOrderMoneyGetReqV2 driverOrderMoneyGetReqV2) {
            ...
            if (driverOrderMoneyGetReqV2 != null) {
                ...
                this.f46642id = driverOrderMoneyGetReqV2.f46641id;
        ...
        /* renamed from: id */
        public Builder mo116079id(String str) {
            this.f46642id = str;
            return this;
        }
