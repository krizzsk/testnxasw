...
public class DeleteAccountResponse extends BaseResponse implements Serializable {
    ...
    public DeleteAccountResponse setDeleteAccountFailTexts(List<DeleteContent> list) {
    ...
    public DeleteAccountResponse setDeleteAccountPromptTexts(List<DeleteContent> list) {
    ...
    public DeleteAccountResponse setSubPromptTitle(String str) {
    ...
    public DeleteAccountResponse setSubTitle(String str) {
        this.subTitle = str;
        return this;
    }
