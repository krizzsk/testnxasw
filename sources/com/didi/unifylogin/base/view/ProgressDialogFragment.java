...
public final class ProgressDialogFragment extends BaseDialogFragment {
    ...
    /* renamed from: c */
    private int f47377c = R.drawable.login_unify_loading_progress_bar;
    ...
    public ProgressDialogFragment() {
        ...
        if (productThemeStyle.getIndeterminateDrawable() != 0) {
            ...
            this.f47377c = productThemeStyle2.getIndeterminateDrawable();
        }
    }
    ...
    public View onCreateView(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle) {
        ...
        View inflate = layoutInflater.inflate(R.layout.login_unify_loading, viewGroup);
        View findViewById = inflate.findViewById(R.id.progress_bar);
        if (findViewById != null) {
            ((ProgressBar) findViewById).setIndeterminateDrawable(ResourcesCompat.getDrawable(getResources(), this.f47377c, (Resources.Theme) null));
            if (!TextUtils.isEmpty(this.f47375a)) {
                View findViewById2 = inflate.findViewById(R.id.tv_msg);
                if (findViewById2 != null) {
                    ((TextView) findViewById2).setText(this.f47375a);
                } else {
