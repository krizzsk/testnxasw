...
public class SfJsonUtils {
    ...
    /* renamed from: a */
    private static final Gson f37290a;
    ...
    static {
        ...
        f37290a = gsonBuilder.setPrettyPrinting().create();
    }

    public static <T> T fromJson(String str, Type type) {
        try {
            return f37290a.fromJson(str, type);
        } catch (Throwable th) {
            SfLog.m28132e("fromJson take exception ! msg = " + th);
            return null;
        }
    }
    ...
    public static <T> T fromJson(Reader reader, Type type) {
        try {
            return f37290a.fromJson(reader, type);
        } catch (Throwable th) {
            SfLog.m28132e("fromJson take exception ! msg = " + th);
            return null;
        }
