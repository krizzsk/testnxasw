...
public class SfSafeCenterAdapter extends RecyclerView.Adapter {
    ...
    /* renamed from: a */
    private List<SfCenterCardModel> f37171a;
    /* access modifiers changed from: private */

    /* renamed from: b */
    public CardClickListener f37172b;
    ...
    public void setCardClickListener(CardClickListener cardClickListener) {
        this.f37172b = cardClickListener;
    }
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder viewHolder, int i) {
        ((BaseViewHolder) viewHolder).bindData(this.f37171a.get(i));
    }

    public int getItemViewType(int i) {
        return this.f37171a.get(i).typeLocal;
    }

    public int getItemCount() {
        List<SfCenterCardModel> list = this.f37171a;
        if (list != null) {
            return list.size();
        }
        return 0;
            ...
            if (sfCenterCardModel != null) {
                ...
                this.itemView.setOnClickListener(new View.OnClickListener() {
                    public void onClick(View view) {
                        ...
                        if (SfSafeCenterAdapter.this.f37172b != null) {
                            SfSafeCenterAdapter.this.f37172b.onClick(sfCenterCardModel);
                        }
                    }
                });
            }
