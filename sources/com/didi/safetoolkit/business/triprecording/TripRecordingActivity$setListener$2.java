...
final class TripRecordingActivity$setListener$2 implements View.OnClickListener {
    ...
    public final void onClick(View view) {
        ...
        boolean z = false;
        TripRecordOmageUtils.sendLawBtnClickOmega(access$getSfViewRecordingModel$p != null ? access$getSfViewRecordingModel$p.canRecord : false, this.this$0.f37235a);
        ...
        if (bussinessCallback != null) {
            bussinessCallback.openLawWebView();
        }
    }
}
