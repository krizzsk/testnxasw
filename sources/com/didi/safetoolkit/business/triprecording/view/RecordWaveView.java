...
public final class RecordWaveView extends ViewGroup {
    ...
    /* renamed from: d */
    public final ArrayList<RecordWaveLine> f37272d;

    /* renamed from: e */
    private ValueAnimator f37273e;

    /* renamed from: f */
    private volatile boolean f37274f;

    /* renamed from: g */
    private HashMap f37275g;
    ...
    public View _$_findCachedViewById(int i) {
        if (this.f37275g == null) {
            this.f37275g = new HashMap();
        }
        View view = (View) this.f37275g.get(Integer.valueOf(i));
        if (view != null) {
            return view;
        }
        View findViewById = findViewById(i);
        this.f37275g.put(Integer.valueOf(i), findViewById);
        return findViewById;
    }
    ...
    public RecordWaveView(Context context, AttributeSet attributeSet, int i) {
        ...
        int i2 = 0;
        this.f37273e = ValueAnimator.ofInt(new int[]{1, this.f37269a - 2});
        if (attributeSet != null) {
            ...
            this.f37271c = (int) obtainStyledAttributes.getDimension(1, 20.0f);
        }
        int i3 = this.f37269a;
        if (i3 >= 0) {
            while (true) {
                ...
                this.f37272d.add(recordWaveLine);
    ...
    public void onMeasure(int i, int i2) {
        ...
        Iterator<RecordWaveLine> it = this.f37272d.iterator();
        while (it.hasNext()) {
    ...
    public void onSizeChanged(int i, int i2, int i3, int i4) {
        ...
        int i5 = this.f37269a;
        this.f37270b = (i - (this.f37271c * i5)) / (i5 + 2);
    }
    ...
    public void onLayout(boolean z, int i, int i2, int i3, int i4) {
        ...
        Iterator<RecordWaveLine> it = this.f37272d.iterator();
        while (it.hasNext()) {
            it.next().layout(i5, 0, this.f37271c + i5, getMeasuredHeight());
            i5 += this.f37271c + this.f37270b;
        }
    }
}
