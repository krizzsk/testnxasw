package com.didi.app.nova.assemblyunit;

import com.taxis99.R;

/* renamed from: com.didi.app.nova.assemblyunit.R */
public final class C4226R {

    /* renamed from: com.didi.app.nova.assemblyunit.R$anim */
    public static final class C4227anim {
        private C4227anim() {
        }
    }

    /* renamed from: com.didi.app.nova.assemblyunit.R$animator */
    public static final class C4228animator {
        private C4228animator() {
        }
    }

    /* renamed from: com.didi.app.nova.assemblyunit.R$attr */
    public static final class attr {
        private attr() {
        }
    }

    /* renamed from: com.didi.app.nova.assemblyunit.R$bool */
    public static final class bool {
        private bool() {
        }
    }

    /* renamed from: com.didi.app.nova.assemblyunit.R$color */
    public static final class C4229color {
        private C4229color() {
        }
    }

    /* renamed from: com.didi.app.nova.assemblyunit.R$dimen */
    public static final class dimen {
        private dimen() {
        }
    }

    /* renamed from: com.didi.app.nova.assemblyunit.R$drawable */
    public static final class C4230drawable {
        private C4230drawable() {
        }
    }

    /* renamed from: com.didi.app.nova.assemblyunit.R$id */
    public static final class C4231id {
        private C4231id() {
        }
    }

    /* renamed from: com.didi.app.nova.assemblyunit.R$integer */
    public static final class integer {
        private integer() {
        }
    }

    /* renamed from: com.didi.app.nova.assemblyunit.R$layout */
    public static final class C4232layout {
        private C4232layout() {
        }
    }

    /* renamed from: com.didi.app.nova.assemblyunit.R$raw */
    public static final class C4233raw {
        private C4233raw() {
        }
    }

    /* renamed from: com.didi.app.nova.assemblyunit.R$string */
    public static final class string {
        private string() {
        }
    }

    /* renamed from: com.didi.app.nova.assemblyunit.R$style */
    public static final class C4234style {
        private C4234style() {
        }
    }

    /* renamed from: com.didi.app.nova.assemblyunit.R$styleable */
    public static final class styleable {
        static {
            ...
            Banner = new int[]{R.attr.auto_play, R.attr.default_drawable, R.attr.fit_type, R.attr.indicator_visible, R.attr.infinite_loop, R.attr.pager_margin, R.attr.pager_marginLeft, R.attr.pager_marginRight};
            ...
            CountryList = new int[]{R.attr.nova_assembly_country_item_iv_selected};
            DotLoadingView = new int[]{R.attr.loading_auto_running, R.attr.loading_color_highlight, R.attr.loading_color_normal, R.attr.loading_count, R.attr.loading_duration, R.attr.loading_margin_between, R.attr.loading_mode, R.attr.loading_radius_highlight, R.attr.loading_radius_normal, R.attr.loading_radius_scale};
