...
public final class ThreadManager {
    ...
    /* renamed from: a */
    private static final String[] f27574a;

    /* renamed from: b */
    private static final Handler[] f27575b;
    /* access modifiers changed from: private */

    /* renamed from: c */
    public static final ConcurrentLinkedQueue<Runnable> f27576c = new ConcurrentLinkedQueue<>();

    /* renamed from: d */
    private static final MessageQueue.IdleHandler f27577d = new MessageQueue.IdleHandler() {
        public boolean queueIdle() {
            while (!ThreadManager.f27576c.isEmpty()) {
                Runnable runnable = (Runnable) ThreadManager.f27576c.poll();
                if (runnable != null) {
                    try {
                        runnable.run();
    ...
    static {
        ...
        f27574a = strArr;
        f27575b = new Handler[strArr.length];
    }
    ...
    /* renamed from: a */
    static void m21808a() {
        synchronized (f27575b) {
            f27575b[0] = new Handler(Looper.getMainLooper());
        }
    }
    ...
    public static void removeCallbacks(int i, Runnable runnable) {
        if (runnable != null && i < f27574a.length) {
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:14:0x0023, code lost:
        r0 = new android.os.HandlerThread(f27574a[r3]);
        r0.setPriority(10);
        r0.start();
    ...
    public static android.os.Handler getHandler(int r3) {
        /*
            ...
            java.lang.String[] r0 = f27574a
            int r0 = r0.length
            if (r3 >= r0) goto L_0x0051
            android.os.Handler[] r0 = f27575b
            monitor-enter(r0)
            android.os.Handler[] r1 = f27575b     // Catch:{ all -> 0x004e }
        ...
        L_0x0023:
            ...
            r0 = r1
        L_0x003e:
            android.os.Handler[] r1 = f27575b
            monitor-enter(r1)
            android.os.Handler[] r2 = f27575b     // Catch:{ all -> 0x004b }
            r2[r3] = r0     // Catch:{ all -> 0x004b }
            android.os.Handler[] r0 = f27575b     // Catch:{ all -> 0x004b }
        ...
        L_0x0051:
            ...
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.didi.map.global.component.departure.util.ThreadManager.getHandler(int):android.os.Handler");
    }
