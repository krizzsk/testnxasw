...
final class SctxCaseParser$getCode$res$1 extends Lambda implements Function1<SctxCaseCode, CharSequence> {
    public static final SctxCaseParser$getCode$res$1 INSTANCE = new SctxCaseParser$getCode$res$1();

    SctxCaseParser$getCode$res$1() {
        super(1);
    }

    public final CharSequence invoke(SctxCaseCode sctxCaseCode) {
        Intrinsics.checkNotNullParameter(sctxCaseCode, "it");
        return String.valueOf(sctxCaseCode.getCode());
    }
}
