...
final class BTMViewModel$start$1$onPositiveResult$1 extends Lambda implements Function1<Boolean, Unit> {
    final /* synthetic */ BTMViewModel this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    BTMViewModel$start$1$onPositiveResult$1(BTMViewModel bTMViewModel) {
        super(1);
