...
public class SubAddressItemEnhancer implements IAddressItemEnhancer {
    public void enhance(View view, int i, RpcPoi rpcPoi) {
        if (view != null && i >= 0 && rpcPoi != null && rpcPoi.base_info != null) {
            ...
            m8545a((TextView) view.findViewById(R.id.sub_item_tag), (TextView) view.findViewById(R.id.sub_item_content), rpcPoi, displayMetrics);
        }
    }

    /* renamed from: a */
    private void m8545a(TextView textView, TextView textView2, RpcPoi rpcPoi, DisplayMetrics displayMetrics) {
