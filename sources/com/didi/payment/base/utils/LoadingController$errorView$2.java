...
final class LoadingController$errorView$2 extends Lambda implements Function0<View> {
    ...
    public final View invoke() {
        if (this.this$0.f32450b.getErrorLayoutId() == 0) {
            return this.this$0.f32450b.getErrorLayoutView();
        }
        return View.inflate(this.this$0.f32449a.getContext(), this.this$0.f32450b.getErrorLayoutId(), (ViewGroup) null);
    }
}
