...
public final class WebTitleBar implements ITitleBar {
    public void addViewToTitleBar(Activity activity, View view, ViewGroup.LayoutParams layoutParams) {
        ...
        try {
            Method declaredMethod = Class.forName("com.didi.sdk.webview.WebActivity").getDeclaredMethod("addViewToTitleBar", new Class[]{View.class, RelativeLayout.LayoutParams.class});
            declaredMethod.setAccessible(true);
            declaredMethod.invoke(activity, new Object[]{view, layoutParams});
    ...
    public void removeViewFromTitleBar(Activity activity, Object obj) {
        ...
        try {
            Method declaredMethod = Class.forName("com.didi.sdk.webview.WebActivity").getDeclaredMethod("removeViewFromTitleBar", new Class[]{Object.class});
            declaredMethod.setAccessible(true);
