...
public class PayParam {
    ...
    /* renamed from: A3 */
    public static final String f32317A3 = "a3";
    public static final String ANDROID_ID = "android_id";
    public static final String APPSFLYER_ID = "aid";
    public static final String APP_VERSION = "appversion";
    public static final String BFF_APP_ID = "appID";
    ...
    public static final String COUNTY_GROUP_ID = "countyGroupId";
    public static final String COUNTY_ID = "countyId";
    public static final String CPU = "cpu";
    public static final String CURRENCY = "currency";
    public static final String DATA_TYPE = "datatype";
    public static final String DEVICE_ID = "dviceid";
    public static final String FIREBASE_ID = "frid";
    public static final String IDFA = "idfa";
    public static final String IMEI = "imei";
    public static final String IMSI = "imsi";

    /* renamed from: IP */
    public static final String f32318IP = "ip";
    ...
    /* renamed from: OS */
    public static final String f32319OS = "os";
    ...
    public static final String TRIP_CITY = "trip_cityid";
