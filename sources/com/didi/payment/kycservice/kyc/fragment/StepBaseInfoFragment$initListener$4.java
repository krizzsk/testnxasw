...
final class StepBaseInfoFragment$initListener$4 extends Lambda implements Function1<Editable, Unit> {
    final /* synthetic */ StepBaseInfoFragment this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    StepBaseInfoFragment$initListener$4(StepBaseInfoFragment stepBaseInfoFragment) {
        super(1);
    ...
    public final void invoke(Editable editable) {
        NewPixInputView access$getMCPFInput$p = this.this$0.f33350f;
        ...
        if (access$getMCPFInput$p.getInputStr().length() == 14) {
            if (this.this$0.m25392h()) {
                NewPixInputView access$getMCPFInput$p2 = this.this$0.f33350f;
                ...
                NewPixInputView access$getMCPFInput$p3 = this.this$0.f33350f;
