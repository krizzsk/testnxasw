...
final class StepIncomeInfoFragment$initListener$2 extends Lambda implements Function0<Unit> {
    final /* synthetic */ StepIncomeInfoFragment this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    StepIncomeInfoFragment$initListener$2(StepIncomeInfoFragment stepIncomeInfoFragment) {
        super(0);
        this.this$0 = stepIncomeInfoFragment;
    }

    public final void invoke() {
        SignUpVM access$getPixSignUpVM$p = this.this$0.f33370f;
        ...
        SignUpVM access$getPixSignUpVM$p2 = this.this$0.f33370f;
