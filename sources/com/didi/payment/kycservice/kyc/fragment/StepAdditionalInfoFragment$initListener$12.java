...
final class StepAdditionalInfoFragment$initListener$12 extends Lambda implements Function0<Unit> {
    final /* synthetic */ String $phone;
    final /* synthetic */ StepAdditionalInfoFragment this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    StepAdditionalInfoFragment$initListener$12(StepAdditionalInfoFragment stepAdditionalInfoFragment, String str) {
        super(0);
    ...
    public final void invoke() {
        NewPixInputView access$getMZipCodeInput$p = this.this$0.f33328b;
        ...
        if (z) {
            NewPixInputView access$getMZipCodeInput$p2 = this.this$0.f33328b;
            ...
            NewPixInputView access$getMZipCodeInput$p3 = this.this$0.f33328b;
        ...
        if (context != null) {
            ...
            NewPixInputView access$getMZipCodeInput$p4 = stepAdditionalInfoFragment.f33328b;
