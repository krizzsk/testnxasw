...
final class FullKycExtraFragment$initListener$14 extends Lambda implements Function0<Unit> {
    final /* synthetic */ String $phone;
    final /* synthetic */ FullKycExtraFragment this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    FullKycExtraFragment$initListener$14(FullKycExtraFragment fullKycExtraFragment, String str) {
        super(0);
    ...
    public final void invoke() {
        ...
        if (context != null) {
            ...
            NewPixInputView access$getMStreetInput$p = fullKycExtraFragment.f33248h;
