...
final class FullKycExtraFragment$initListener$15 extends Lambda implements Function0<Unit> {
    final /* synthetic */ String $phone;
    final /* synthetic */ FullKycExtraFragment this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    FullKycExtraFragment$initListener$15(FullKycExtraFragment fullKycExtraFragment, String str) {
        super(0);
    ...
    public final void invoke() {
        ...
        if (context != null) {
            ...
            NewPixInputView access$getMAddMoreInput$p = fullKycExtraFragment.f33250j;
