...
final class StepAdditionalInfoFragment$initListener$16 extends Lambda implements Function0<Unit> {
    final /* synthetic */ String $phone;
    final /* synthetic */ StepAdditionalInfoFragment this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    StepAdditionalInfoFragment$initListener$16(StepAdditionalInfoFragment stepAdditionalInfoFragment, String str) {
        super(0);
    ...
    public final void invoke() {
        ...
        if (context != null) {
            ...
            NewPixInputView access$getMDistrictInput$p = stepAdditionalInfoFragment.f33333g;
