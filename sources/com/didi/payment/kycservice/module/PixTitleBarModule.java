...
public final class PixTitleBarModule extends BaseModule<TitleBarData> {
    ...
    /* renamed from: a */
    private LinearLayout f33438a;

    /* renamed from: b */
    private View f33439b;

    /* renamed from: c */
    private TextView f33440c;

    /* renamed from: d */
    private TextView f33441d;

    /* renamed from: e */
    private TextView f33442e;

    /* renamed from: f */
    private View.OnClickListener f33443f;
    ...
    private final void m25410a() {
        ...
        this.f33438a = (LinearLayout) findViewById;
        ...
        this.f33440c = (TextView) findViewById3;
        ...
        this.f33441d = (TextView) findViewById4;
        ...
        this.f33442e = (TextView) findViewById5;
        View view = this.f33439b;
        if (view == null) {
        ...
        view.setOnClickListener(new View.OnClickListener() {
            public final void onClick(View view) {
                PixTitleBarModule.m25411a(PixTitleBarModule.this, view);
            }
        });
    }
    ...
    /* renamed from: a */
    public static final void m25411a(PixTitleBarModule pixTitleBarModule, View view) {
        Intrinsics.checkNotNullParameter(pixTitleBarModule, "this$0");
        View.OnClickListener onClickListener = pixTitleBarModule.f33443f;
    ...
    public void bindData(TitleBarData titleBarData) {
        ...
        TextView textView = this.f33440c;
        View view = null;
        if (textView == null) {
        ...
        TextView textView2 = this.f33441d;
        if (textView2 == null) {
        ...
        TextView textView3 = this.f33442e;
        if (textView3 == null) {
    ...
    public final LinearLayout getToolBar() {
        LinearLayout linearLayout = this.f33438a;
