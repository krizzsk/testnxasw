...
final class WalletNumKeyboard$okDeletePath$2 extends Lambda implements Function0<Path> {
    final /* synthetic */ WalletNumKeyboard this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    WalletNumKeyboard$okDeletePath$2(WalletNumKeyboard walletNumKeyboard) {
        super(0);
    ...
    public final Path invoke() {
        ...
        return walletNumKeyboard.m26895a((walletNumKeyboard.f35566C * 3.5f) - UiUtils.Companion.floatSize(20), this.this$0.f35565B / ((float) 2));
    }
}
