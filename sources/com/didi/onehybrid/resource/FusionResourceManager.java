...
public class FusionResourceManager {
    ...
    /* renamed from: a */
    private static final String f32154a = "FusionResourceManager";
    ...
    public static FusionResource fetchResourceFromNet(String str, Map<String, String> map, boolean z) {
        ...
        if (fusionHttpClient.connect() == 0 && 200 == fusionHttpClient.getResponseCode()) {
            return m24456a(fusionHttpClient, z);
        }
        return null;
    }

    /* renamed from: a */
    private static FusionResource m24456a(FusionHttpClient fusionHttpClient, boolean z) {
    ...
    /* renamed from: a */
    private static FusionResource m24457a(String str, Map<String, String> map, boolean z) {
        FusionCacheClient fusionCacheClient = FusionCacheClient.sInstance;
        ...
        if (!TextUtils.isEmpty(str2) && (z2 || !str2.contains("text/html"))) {
            ...
            if (fusionResource != null && z) {
                m24458a(str, map, fusionCacheClient.getHeaderForRequest(str));
            }
        }
    ...
    /* renamed from: a */
    private static void m24458a(final String str, final Map<String, String> map, final Map<String, String> map2) {
        FusionAsynDispatcher.Instance.asynRunTask(new Runnable() {
            public void run() {
                FusionCacheClient fusionCacheClient = FusionCacheClient.sInstance;
                        ...
                        for (String str : list) {
                            ...
                            if (!fusionCacheClient.isCacheExist(str)) {
                                if (C11212Util.isApkDebug(context)) {
                                    SystemUtils.log(4, "Preload", "preload resource:" + str, (Throwable) null, "com.didi.onehybrid.resource.FusionResourceManager$3", 235);
                                }
