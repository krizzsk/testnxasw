...
public class ColorKeyframeAnimation extends C1482a<Integer> {
    ...
    public int getIntValue(Keyframe<Integer> keyframe, float f) {
        ...
        if (this.valueCallback != null) {
            Integer num = (Integer) this.valueCallback.getValueInternal(keyframe.startFrame, keyframe.endFrame.floatValue(), Integer.valueOf(intValue), Integer.valueOf(intValue2), f, mo15224a(), getProgress());
            if (num != null) {
                return num.intValue();
            }
        }
