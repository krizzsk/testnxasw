...
public class ShapeDataParser implements C1523u<ShapeData> {
    public static final ShapeDataParser INSTANCE = new ShapeDataParser();

    /* renamed from: a */
    private static final JsonReader.Options f1599a = JsonReader.Options.m1436of("c", RavenKey.VERSION, "i", "o");
    ...
    public ShapeData parse(JsonReader jsonReader, float f) throws IOException {
        ...
        while (jsonReader.hasNext()) {
            int selectName = jsonReader.selectName(f1599a);
            if (selectName == 0) {
                z = jsonReader.nextBoolean();
            } else if (selectName == 1) {
                list = C1503g.m1413a(jsonReader, f);
            } else if (selectName == 2) {
                list2 = C1503g.m1413a(jsonReader, f);
            } else if (selectName != 3) {
                jsonReader.skipName();
                jsonReader.skipValue();
            } else {
                list3 = C1503g.m1413a(jsonReader, f);
            }
        }
