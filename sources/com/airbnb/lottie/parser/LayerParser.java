...
public class LayerParser {
    ...
    /* renamed from: a */
    private static final JsonReader.Options f1591a = JsonReader.Options.m1436of(RavenKey.NAME, "ind", "refId", "ty", "parent", LoginOmegaUtil.ACTIONID_SW, "sh", "sc", "ks", "tt", "masksProperties", "shapes", RavenKey.TYPE, "ef", "sr", UserDataStore.STATE, "w", "h", "ip", "op", "tm", "cl", "hd");

    /* renamed from: b */
    private static final JsonReader.Options f1592b = JsonReader.Options.m1436of("d", Constants.FILE_ANR_KEY);

    /* renamed from: c */
    private static final JsonReader.Options f1593c = JsonReader.Options.m1436of(RavenKey.NAME);
    ...
    public static Layer parse(JsonReader jsonReader, LottieComposition lottieComposition) throws IOException {
        ...
        while (jsonReader.hasNext()) {
            switch (jsonReader2.selectName(f1591a)) {
                case 0:
                ...
                case 10:
                    ...
                    while (jsonReader.hasNext()) {
                        arrayList3.add(C1506j.m1427a(jsonReader, lottieComposition));
                    }
                ...
                case 12:
                    jsonReader.beginObject();
                    while (jsonReader.hasNext()) {
                        int selectName = jsonReader2.selectName(f1592b);
                        if (selectName == 0) {
                            animatableTextFrame = AnimatableValueParser.m1396e(jsonReader, lottieComposition);
                ...
                case 13:
                    ...
                    while (jsonReader.hasNext()) {
                        jsonReader.beginObject();
                        while (jsonReader.hasNext()) {
                            if (jsonReader2.selectName(f1593c) != 0) {
                                jsonReader.skipName();
                                jsonReader.skipValue();
                            } else {
