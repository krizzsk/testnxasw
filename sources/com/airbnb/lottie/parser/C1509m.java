...
class C1509m {
    ...
    /* renamed from: a */
    private static final JsonReader.Options f1617a = JsonReader.Options.m1436of(RavenKey.NAME, "sy", "pt", RavenConfigKey.PHONE, "r", "or", "os", "ir", "is", "hd");

    private C1509m() {
    }

    /* renamed from: a */
    static PolystarShape m1430a(JsonReader jsonReader, LottieComposition lottieComposition) throws IOException {
        String str = null;
        ...
        while (jsonReader.hasNext()) {
            switch (jsonReader.selectName(f1617a)) {
                case 0:
