...
class InstallReferrerClientImpl extends InstallReferrerClient {
    ...
    public ReferrerDetails getInstallReferrer() throws RemoteException {
        if (isReady()) {
            ...
            bundle.putString(GlobalCashierCoreModule.PACKAGE_NAME, this.mApplicationContext.getPackageName());
            try {
    ...
    private boolean isPlayStoreCompatible() {
        try {
            if (SystemUtils.getPackageInfo(this.mApplicationContext.getPackageManager(), "com.android.vending", 128).versionCode >= PLAY_STORE_MIN_APP_VER) {
                return true;
            }
            return false;
