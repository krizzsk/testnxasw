...
class ActivityStack {
    ...
    private static void clearUpByIndex(int r3) {
        ...
        L_0x003c:
            ...
            throw r3
        */
        throw new UnsupportedOperationException("Method not decompiled: com.android.didi.theme.ActivityStack.clearUpByIndex(int):void");
    }
    ...
    private static void logI(String str, String str2) {
        if (isDebug) {
            SystemUtils.log(4, str, str2, (Throwable) null, "com.android.didi.theme.ActivityStack", 498);
        }
    }
