package com.android.didi.safetoolkit.safe_toolkit;

import com.taxis99.R;

/* renamed from: com.android.didi.safetoolkit.safe_toolkit.R */
public final class C1578R {

    /* renamed from: com.android.didi.safetoolkit.safe_toolkit.R$anim */
    public static final class C1579anim {
        private C1579anim() {
        }
    }

    /* renamed from: com.android.didi.safetoolkit.safe_toolkit.R$animator */
    public static final class C1580animator {
        private C1580animator() {
        }
    }

    /* renamed from: com.android.didi.safetoolkit.safe_toolkit.R$array */
    public static final class array {
        private array() {
        }
    }

    /* renamed from: com.android.didi.safetoolkit.safe_toolkit.R$attr */
    public static final class attr {
        private attr() {
        }
    }

    /* renamed from: com.android.didi.safetoolkit.safe_toolkit.R$bool */
    public static final class bool {
        private bool() {
        }
    }

    /* renamed from: com.android.didi.safetoolkit.safe_toolkit.R$color */
    public static final class C1581color {
        private C1581color() {
        }
    }

    /* renamed from: com.android.didi.safetoolkit.safe_toolkit.R$dimen */
    public static final class dimen {
        private dimen() {
        }
    }

    /* renamed from: com.android.didi.safetoolkit.safe_toolkit.R$drawable */
    public static final class C1582drawable {
        private C1582drawable() {
        }
    }

    /* renamed from: com.android.didi.safetoolkit.safe_toolkit.R$id */
    public static final class C1583id {
        private C1583id() {
        }
    }

    /* renamed from: com.android.didi.safetoolkit.safe_toolkit.R$integer */
    public static final class integer {
        private integer() {
        }
    }

    /* renamed from: com.android.didi.safetoolkit.safe_toolkit.R$interpolator */
    public static final class C1584interpolator {
        private C1584interpolator() {
        }
    }

    /* renamed from: com.android.didi.safetoolkit.safe_toolkit.R$layout */
    public static final class C1585layout {
        private C1585layout() {
        }
    }

    /* renamed from: com.android.didi.safetoolkit.safe_toolkit.R$mipmap */
    public static final class mipmap {
        private mipmap() {
        }
    }

    /* renamed from: com.android.didi.safetoolkit.safe_toolkit.R$plurals */
    public static final class plurals {
        private plurals() {
        }
    }

    /* renamed from: com.android.didi.safetoolkit.safe_toolkit.R$raw */
    public static final class C1586raw {
        private C1586raw() {
        }
    }

    /* renamed from: com.android.didi.safetoolkit.safe_toolkit.R$string */
    public static final class string {
        private string() {
        }
    }

    /* renamed from: com.android.didi.safetoolkit.safe_toolkit.R$style */
    public static final class C1587style {
        private C1587style() {
        }
    }

    /* renamed from: com.android.didi.safetoolkit.safe_toolkit.R$styleable */
    public static final class styleable {
        static {
            ...
            AlignTextView = new int[]{R.attr.align};
            ...
            BLTextView = new int[]{R.attr.boldTextColor, R.attr.boldTextSize, R.attr.lightTextColor, R.attr.lightTextSize, R.attr.text, R.attr.textGravity};
            ...
            DotLoader = new int[]{R.attr.color_array, R.attr.dot_radius, R.attr.number_of_dots};
            ...
            LEGOLoadingButton = new int[]{R.attr.button_background, R.attr.button_loading_lottie_name, R.attr.button_loading_lottie_rawRes, R.attr.button_text, R.attr.button_text_color, R.attr.button_text_size};
            ...
            RoundImageView = new int[]{R.attr.corner_radius, R.attr.left_bottom_radius, R.attr.left_top_radius, R.attr.radius, R.attr.right_bottom_radius, R.attr.right_top_radius};
            SaBackLayout = new int[]{R.attr.sa_back_layout_marginBottom, R.attr.sa_back_layout_marginLeft, R.attr.sa_back_layout_marginRight, R.attr.sa_back_layout_marginTop};
            ...
            SwipeMenuLayout = new int[]{R.attr.isClickMenuAndClose, R.attr.isEnableLeftMenu, R.attr.isEnableSwipe, R.attr.isOpenChoke};
            ...
            departurePinView = new int[]{R.attr.small_circle_radius};
            ...
            sugView = new int[]{R.attr.contentViewDefaultMargin, R.attr.contentViewLayout};
    ...
    /* renamed from: com.android.didi.safetoolkit.safe_toolkit.R$xml */
    public static final class C1588xml {
        private C1588xml() {
        }
    }
