...
public class SmartRefreshLayout extends ViewGroup implements NestedScrollingParent, RefreshLayout {
    ...
    public SmartRefreshLayout(Context context, AttributeSet attributeSet) {
        ...
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C11267R.styleable.SmartRefreshLayout);
    ...
    public void onMeasure(int r18, int r19) {
        ...
        L_0x001a:
            ...
            r11 = 2131434343(0x7f0b1b67, float:1.8490497E38)
    ...
    public void setStateLoading(final boolean z) {
        C214361 r0 = new AnimatorListenerAdapter() {
    ...
    public void setStateRefreshing(final boolean z) {
        C214382 r0 = new AnimatorListenerAdapter() {
            public void onAnimationEnd(Animator animator) {
                if (animator == null || animator.getDuration() != 0) {
    ...
    public void moveSpinnerInfinitely(float f) {
        ...
        if (f2 > ((float) (this.mScreenHeightPixels * 5)) && getTag() == null && getTag(R.id.srl_tag) == null) {
            ...
            if (f3 < ((float) i) / 6.0f && this.mLastTouchX < ((float) i) / 16.0f) {
                SystemUtils.showToast(Toast.makeText(getContext(), "你这么死拉，臣妾做不到啊！", 0));
        ...
        if (this.mState == RefreshState.TwoLevel && f2 > 0.0f) {
            ...
            if (f2 < ((float) i2)) {
                ...
                double d = (double) (f4 - ((float) this.mHeaderHeight));
            ...
            if (f2 > ((float) (-i4))) {
                ...
                double d4 = (double) (f5 - ((float) this.mFooterHeight));
    ...
    public static class LayoutParams extends ViewGroup.MarginLayoutParams {
        ...
        public LayoutParams(Context context, AttributeSet attributeSet) {
            super(context, attributeSet);
            TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C11267R.styleable.SmartRefreshLayout_Layout);
                ...
                if (onFinish < Integer.MAX_VALUE) {
                    ...
                    SmartRefreshLayout.this.mHandler.postDelayed(new Runnable() {
                        public void run() {
                            ...
                            C214451 r2 = new AnimatorListenerAdapter() {
                                public void onAnimationEnd(Animator animator) {
                                    if (animator == null || animator.getDuration() != 0) {
                                        SmartRefreshLayout.this.mFooterLocked = false;
                                        if (z2) {
    ...
    public class RefreshKernelImpl implements RefreshKernel {
        ...
        public RefreshKernel setState(RefreshState refreshState) {
            switch (C2143710.$SwitchMap$com$scwang$smart$refresh$layout$constant$RefreshState[refreshState.ordinal()]) {
                case 1:
        ...
        public RefreshKernel startTwoLevel(boolean z) {
            if (z) {
                C214521 r4 = new AnimatorListenerAdapter() {
                    public void onAnimationEnd(Animator animator) {
                        if (animator == null || animator.getDuration() != 0) {
    ...
    /* renamed from: com.scwang.smart.refresh.layout.SmartRefreshLayout$10 */
    static /* synthetic */ class C2143710 {
        ...
        static {
            ...
            L_0x0090:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.scwang.smart.refresh.layout.SmartRefreshLayout.C2143710.<clinit>():void");
        }
    }
}
