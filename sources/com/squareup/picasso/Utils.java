...
final class Utils {
    ...
    static void log(String str, String str2, String str3, String str4) {
        SystemUtils.log(3, "Picasso", String.format("%1$-11s %2$-12s %3$s %4$s", new Object[]{str, str2, str3, str4}), (Throwable) null, "com.squareup.picasso.Utils", 169);
    }
    ...
    static long calculateDiskCacheSize(File file) {
        ...
        return Math.max(Math.min(j, XECacheConfig.XE_CACHE_DEF_MAX_SIZE), 5242880);
    }
