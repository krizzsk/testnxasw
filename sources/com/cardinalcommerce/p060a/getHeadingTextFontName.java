...
/* renamed from: com.cardinalcommerce.a.getHeadingTextFontName */
public final class getHeadingTextFontName extends ChallengeParameters.Cardinal {
    public getHeadingTextFontName(getSDKAppID getsdkappid, getAcsTransactionID getacstransactionid, getAcsTransactionID getacstransactionid2) {
        this(getsdkappid, getacstransactionid, getacstransactionid2, false);
    }

    public getHeadingTextFontName(getSDKAppID getsdkappid, getAcsTransactionID getacstransactionid, getAcsTransactionID getacstransactionid2, boolean z) {
    ...
    getHeadingTextFontName(getSDKAppID getsdkappid, getAcsTransactionID getacstransactionid, getAcsTransactionID getacstransactionid2, getAcsTransactionID[] getacstransactionidArr, boolean z) {
    ...
    public final ChallengeParameters Cardinal(ChallengeParameters challengeParameters) {
        ...
        getAcsTransactionID cca_continue3 = cca_continue.cleanup().init(configure3).cca_continue(configure2).cca_continue(getacstransactionid2.init(getacstransactionid3));
        getAcsTransactionID init = CardinalActionCode.init();
        getAcsTransactionID Cardinal = cca_continue.cleanup().cca_continue(init).init(configure3).cca_continue(configure2).Cardinal(cca_continue3, configure, configure3);
        ...
        if (Cardinal.cleanup()) {
            return new getHeadingTextFontName(cca_continue, Cardinal, cca_continue.getWarnings().values(), this.getInstance);
        }
        ...
        return new getHeadingTextFontName(cca_continue, init3, Cardinal.cca_continue(configure4).configure().Cardinal(cca_continue3, init, init4), new getAcsTransactionID[]{init4}, this.getInstance);
    }
    ...
    public final ChallengeParameters getInstance(ChallengeParameters challengeParameters) {
        ...
        if (warnings.cleanup()) {
            ...
            getacstransactionid5 = instance.configure().cca_continue(instance).cca_continue(values).cca_continue(cca_continue.cleanup());
            if (getacstransactionid5.cleanup()) {
                return new getHeadingTextFontName(cca_continue, getacstransactionid5, cca_continue.getWarnings().values(), this.getInstance);
            }
            ...
            if (init3.cleanup()) {
                return new getHeadingTextFontName(cca_continue, init3, cca_continue.getWarnings().values(), this.getInstance);
            }
        ...
        return new getHeadingTextFontName(cca_continue, getacstransactionid5, getacstransactionid4, new getAcsTransactionID[]{getacstransactionid6}, this.getInstance);
    }
    ...
    public final ChallengeParameters getRequestTimeout() {
        ...
        if (!CardinalError) {
            cleanup = cleanup.init(configure);
        }
        getAcsTransactionID cca_continue2 = getacstransactionid2.configure().cca_continue(init).cca_continue(cleanup);
        if (cca_continue2.cleanup()) {
            return new getHeadingTextFontName(cca_continue, cca_continue2, cca_continue.getWarnings().values(), this.getInstance);
        }
        ...
        return new getHeadingTextFontName(cca_continue, configure2, getacstransactionid.cca_continue(cca_continue2, init).cca_continue(configure2).cca_continue(init2), new getAcsTransactionID[]{init2}, this.getInstance);
    }
    ...
    public final ChallengeParameters getString() {
        ...
        return new getHeadingTextFontName(getsdkappid, getacstransactionid, getacstransactionid2.cca_continue(getacstransactionid3), getacstransactionidArr, this.getInstance);
    }

    public final ChallengeParameters configure() {
        getAcsTransactionID sDKVersion = getSDKVersion();
        if (CardinalEnvironment()) {
            return new getHeadingTextFontName((getSDKAppID) null, sDKVersion, CardinalError());
        }
