...
/* renamed from: com.cardinalcommerce.a.setHeadingTextFontName */
public final class setHeadingTextFontName extends ChallengeParameters.Cardinal {
    public setHeadingTextFontName(getSDKAppID getsdkappid, getAcsTransactionID getacstransactionid, getAcsTransactionID getacstransactionid2) {
        this(getsdkappid, getacstransactionid, getacstransactionid2, false);
    }

    public setHeadingTextFontName(getSDKAppID getsdkappid, getAcsTransactionID getacstransactionid, getAcsTransactionID getacstransactionid2, boolean z) {
    ...
    setHeadingTextFontName(getSDKAppID getsdkappid, getAcsTransactionID getacstransactionid, getAcsTransactionID getacstransactionid2, getAcsTransactionID[] getacstransactionidArr, boolean z) {
    ...
    public final ChallengeParameters Cardinal(ChallengeParameters challengeParameters) {
        ...
        if (Cardinal.cleanup()) {
            return new setHeadingTextFontName(cca_continue, Cardinal, cca_continue.getWarnings(), this.getInstance);
        }
        getAcsTransactionID init2 = Cardinal.configure().init(init);
        getAcsTransactionID init3 = Cardinal.init(configure4).init(configure3);
        return new setHeadingTextFontName(cca_continue, init2, Cardinal.cca_continue(configure4).configure().Cardinal(cca_continue3, CardinalActionCode.init(), init3), new getAcsTransactionID[]{init3}, this.getInstance);
    }
    ...
    public final ChallengeParameters getInstance(ChallengeParameters challengeParameters) {
        ...
        if (warnings.cleanup()) {
            ...
            if (getacstransactionid5.cleanup()) {
                return new setHeadingTextFontName(cca_continue, getacstransactionid5, cca_continue.getWarnings(), this.getInstance);
            }
            ...
            if (init3.cleanup()) {
                return new setHeadingTextFontName(cca_continue, init3, cca_continue.getWarnings(), this.getInstance);
            }
        ...
        return new setHeadingTextFontName(cca_continue, getacstransactionid5, getacstransactionid4, new getAcsTransactionID[]{getacstransactionid6}, this.getInstance);
    }
    ...
    public final ChallengeParameters getRequestTimeout() {
        ...
        if (!CardinalError) {
            getacstransactionid3 = getacstransactionid3.configure();
        }
        getAcsTransactionID cca_continue2 = getacstransactionid2.configure().cca_continue(init).cca_continue(getacstransactionid3);
        if (cca_continue2.cleanup()) {
            return new setHeadingTextFontName(cca_continue, cca_continue2, cca_continue.getWarnings(), this.getInstance);
        }
        getAcsTransactionID configure = cca_continue2.configure();
        getAcsTransactionID init2 = CardinalError ? cca_continue2 : cca_continue2.init(getacstransactionid3);
        getAcsTransactionID configure2 = getacstransactionid2.cca_continue(getacstransactionid).configure();
        return new setHeadingTextFontName(cca_continue, configure, configure2.cca_continue(cca_continue2).cca_continue(getacstransactionid3).init(configure2).cca_continue(configure), new getAcsTransactionID[]{init2}, this.getInstance);
    }
    ...
    public final ChallengeParameters getString() {
        ...
        return new setHeadingTextFontName(getsdkappid, getacstransactionid, getacstransactionid2.cca_continue(getacstransactionid3), getacstransactionidArr, this.getInstance);
    }

    public final ChallengeParameters configure() {
        getAcsTransactionID sDKVersion = getSDKVersion();
        if (CardinalEnvironment()) {
            return new setHeadingTextFontName((getSDKAppID) null, sDKVersion, CardinalError());
        }
