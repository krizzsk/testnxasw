...
/* renamed from: com.cardinalcommerce.a.getButtonText */
public final class getButtonText extends ChallengeParameters.Cardinal {
    public getButtonText(getSDKAppID getsdkappid, getAcsTransactionID getacstransactionid, getAcsTransactionID getacstransactionid2) {
        this(getsdkappid, getacstransactionid, getacstransactionid2, false);
    }

    public getButtonText(getSDKAppID getsdkappid, getAcsTransactionID getacstransactionid, getAcsTransactionID getacstransactionid2, boolean z) {
    ...
    getButtonText(getSDKAppID getsdkappid, getAcsTransactionID getacstransactionid, getAcsTransactionID getacstransactionid2, getAcsTransactionID[] getacstransactionidArr, boolean z) {
    ...
    public final ChallengeParameters Cardinal(ChallengeParameters challengeParameters) {
        ...
        if (Cardinal.cleanup()) {
            return new getButtonText(cca_continue, Cardinal, cca_continue.getWarnings(), this.getInstance);
        }
        ...
        return new getButtonText(cca_continue, init3, Cardinal.cca_continue(configure4).configure().Cardinal(cca_continue3, init, init4), new getAcsTransactionID[]{init4}, this.getInstance);
    }
    ...
    public final ChallengeParameters getInstance(ChallengeParameters challengeParameters) {
        ...
        if (warnings.cleanup()) {
            ...
            if (getacstransactionid5.cleanup()) {
                return new getButtonText(cca_continue, getacstransactionid5, cca_continue.getWarnings(), this.getInstance);
            }
            ...
            if (init3.cleanup()) {
                return new getButtonText(cca_continue, init3, cca_continue.getWarnings(), this.getInstance);
            }
        ...
        return new getButtonText(cca_continue, getacstransactionid5, getacstransactionid4, new getAcsTransactionID[]{getacstransactionid6}, this.getInstance);
    }
    ...
    public final ChallengeParameters getRequestTimeout() {
        ...
        if (cca_continue2.cleanup()) {
            return new getButtonText(cca_continue, cca_continue2, cca_continue.getWarnings(), this.getInstance);
        }
        ...
        return new getButtonText(cca_continue, configure2, configure3.cca_continue(cca_continue2).cca_continue(configure).init(configure3).cca_continue(getacstransactionid3).cca_continue(configure2).cca_continue(init), new getAcsTransactionID[]{init}, this.getInstance);
    }
    ...
    public final ChallengeParameters getString() {
        ...
        return new getButtonText(getsdkappid, getacstransactionid, getacstransactionid2.cca_continue(getacstransactionid3), getacstransactionidArr, this.getInstance);
    }

    public final ChallengeParameters configure() {
        getAcsTransactionID sDKVersion = getSDKVersion();
        if (CardinalEnvironment()) {
            return new getButtonText((getSDKAppID) null, sDKVersion, CardinalError());
        }
