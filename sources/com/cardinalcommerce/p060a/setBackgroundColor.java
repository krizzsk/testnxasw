...
/* renamed from: com.cardinalcommerce.a.setBackgroundColor */
public final class setBackgroundColor extends ChallengeParameters.Cardinal {
    public setBackgroundColor(getSDKAppID getsdkappid, getAcsTransactionID getacstransactionid, getAcsTransactionID getacstransactionid2) {
        this(getsdkappid, getacstransactionid, getacstransactionid2, false);
    }

    public setBackgroundColor(getSDKAppID getsdkappid, getAcsTransactionID getacstransactionid, getAcsTransactionID getacstransactionid2, boolean z) {
    ...
    setBackgroundColor(getSDKAppID getsdkappid, getAcsTransactionID getacstransactionid, getAcsTransactionID getacstransactionid2, getAcsTransactionID[] getacstransactionidArr, boolean z) {
    ...
    public final ChallengeParameters Cardinal(ChallengeParameters challengeParameters) {
        ...
        if (Cardinal.cleanup()) {
            return new setBackgroundColor(cca_continue, Cardinal, cca_continue.getWarnings().values(), this.getInstance);
        }
        ...
        return new setBackgroundColor(cca_continue, init3, Cardinal.cca_continue(configure4).configure().Cardinal(cca_continue3, init, init4), new getAcsTransactionID[]{init4}, this.getInstance);
    }
    ...
    public final ChallengeParameters getInstance(ChallengeParameters challengeParameters) {
        ...
        if (warnings.cleanup()) {
            ...
            if (getacstransactionid5.cleanup()) {
                return new setBackgroundColor(cca_continue, getacstransactionid5, cca_continue.getWarnings().values(), this.getInstance);
            }
            ...
            if (init3.cleanup()) {
                return new setBackgroundColor(cca_continue, init3, cca_continue.getWarnings().values(), this.getInstance);
            }
        ...
        return new setBackgroundColor(cca_continue, getacstransactionid5, getacstransactionid4, new getAcsTransactionID[]{getacstransactionid6}, this.getInstance);
    }
    ...
    public final ChallengeParameters getRequestTimeout() {
        ...
        if (cca_continue2.cleanup()) {
            return new setBackgroundColor(cca_continue, cca_continue2, cca_continue.getWarnings().values(), this.getInstance);
        }
        ...
        return new setBackgroundColor(cca_continue, configure2, getacstransactionid.cca_continue(cca_continue2, init).cca_continue(configure2).cca_continue(init2), new getAcsTransactionID[]{init2}, this.getInstance);
    }
    ...
    public final ChallengeParameters getString() {
        ...
        return new setBackgroundColor(getsdkappid, getacstransactionid, getacstransactionid2.cca_continue(getacstransactionid3), getacstransactionidArr, this.getInstance);
    }

    public final ChallengeParameters configure() {
        getAcsTransactionID sDKVersion = getSDKVersion();
        if (CardinalEnvironment()) {
            return new setBackgroundColor((getSDKAppID) null, sDKVersion, CardinalError());
        }
