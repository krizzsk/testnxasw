...
/* renamed from: com.cardinalcommerce.a.setContentView */
public final class setContentView extends ChallengeParameters.Cardinal {
    public setContentView(getSDKAppID getsdkappid, getAcsTransactionID getacstransactionid, getAcsTransactionID getacstransactionid2) {
        this(getsdkappid, getacstransactionid, getacstransactionid2, false);
    }

    public setContentView(getSDKAppID getsdkappid, getAcsTransactionID getacstransactionid, getAcsTransactionID getacstransactionid2, boolean z) {
    ...
    setContentView(getSDKAppID getsdkappid, getAcsTransactionID getacstransactionid, getAcsTransactionID getacstransactionid2, getAcsTransactionID[] getacstransactionidArr, boolean z) {
    ...
    public final ChallengeParameters Cardinal(ChallengeParameters challengeParameters) {
        ...
        if (Cardinal.cleanup()) {
            return new setContentView(cca_continue, Cardinal, cca_continue.getWarnings().values(), this.getInstance);
        }
        getAcsTransactionID init2 = Cardinal.configure().init(init);
        getAcsTransactionID init3 = Cardinal.init(configure4).init(configure3);
        return new setContentView(cca_continue, init2, Cardinal.cca_continue(configure4).configure().Cardinal(cca_continue3, CardinalActionCode.init(), init3), new getAcsTransactionID[]{init3}, this.getInstance);
    }
    ...
    public final ChallengeParameters getInstance(ChallengeParameters challengeParameters) {
        ...
        if (warnings.cleanup()) {
            ...
            if (getacstransactionid5.cleanup()) {
                return new setContentView(cca_continue, getacstransactionid5, cca_continue.getWarnings().values(), this.getInstance);
            }
            ...
            if (init3.cleanup()) {
                return new setContentView(cca_continue, init3, cca_continue.getWarnings().values(), this.getInstance);
            }
        ...
        return new setContentView(cca_continue, getacstransactionid5, getacstransactionid4, new getAcsTransactionID[]{getacstransactionid6}, this.getInstance);
    }
    ...
    public final ChallengeParameters getRequestTimeout() {
        ...
        if (cca_continue2.cleanup()) {
            return new setContentView(cca_continue, cca_continue2, cca_continue.getWarnings().values(), this.getInstance);
        }
        ...
        return new setContentView(cca_continue, configure2, getacstransactionid.cca_continue(cca_continue2, init).cca_continue(configure2).cca_continue(init2), new getAcsTransactionID[]{init2}, this.getInstance);
    }
    ...
    public final ChallengeParameters getString() {
        ...
        return new setContentView(getsdkappid, getacstransactionid, getacstransactionid2.cca_continue(getacstransactionid3), getacstransactionidArr, this.getInstance);
    }

    public final ChallengeParameters configure() {
        getAcsTransactionID sDKVersion = getSDKVersion();
        if (CardinalEnvironment()) {
            return new setContentView((getSDKAppID) null, sDKVersion, CardinalError());
        }
