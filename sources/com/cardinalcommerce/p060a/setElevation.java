...
/* renamed from: com.cardinalcommerce.a.setElevation */
public final class setElevation extends ChallengeParameters.cca_continue {
    public setElevation(getSDKAppID getsdkappid, getAcsTransactionID getacstransactionid, getAcsTransactionID getacstransactionid2) {
        this(getsdkappid, getacstransactionid, getacstransactionid2, false);
    }

    public setElevation(getSDKAppID getsdkappid, getAcsTransactionID getacstransactionid, getAcsTransactionID getacstransactionid2, boolean z) {
    ...
    setElevation(getSDKAppID getsdkappid, getAcsTransactionID getacstransactionid, getAcsTransactionID getacstransactionid2, getAcsTransactionID[] getacstransactionidArr, boolean z) {
    ...
    public final ChallengeParameters getString() {
        return valueOf() ? this : new setElevation(this.Cardinal, this.configure, this.init.getInstance(), this.cca_continue, this.getInstance);
    }

    public final ChallengeParameters configure() {
        getAcsTransactionID sDKVersion = getSDKVersion();
        if (CardinalEnvironment()) {
            return new setElevation((getSDKAppID) null, sDKVersion, CardinalError());
        }
    ...
    public final com.cardinalcommerce.p060a.ChallengeParameters getInstance(com.cardinalcommerce.p060a.ChallengeParameters r17) {
        ...
        L_0x0103:
            ...
            r5 = 0
            r1[r5] = r2
            com.cardinalcommerce.a.setElevation r8 = new com.cardinalcommerce.a.setElevation
            ...
            return r8
        */
        throw new UnsupportedOperationException("Method not decompiled: com.cardinalcommerce.p060a.setElevation.getInstance(com.cardinalcommerce.a.ChallengeParameters):com.cardinalcommerce.a.ChallengeParameters");
    }
    ...
    public final ChallengeParameters getRequestTimeout() {
        ...
        int[] iArr2 = new int[5];
        int[] iArr3 = new int[5];
        setId.cca_continue(setoncheckedchangelistener.getInstance, iArr3);
        int[] iArr4 = new int[5];
        setId.cca_continue(iArr3, iArr4);
        boolean CardinalError = setoncheckedchangelistener3.CardinalError();
        int[] iArr5 = setoncheckedchangelistener3.getInstance;
        if (!CardinalError) {
            setId.cca_continue(setoncheckedchangelistener3.getInstance, iArr2);
            iArr5 = iArr2;
        }
        setId.cca_continue(setoncheckedchangelistener2.getInstance, iArr5, iArr);
        setId.getInstance(setoncheckedchangelistener2.getInstance, iArr5, iArr2);
        setId.init(iArr2, iArr, iArr2);
        setId.getInstance(setScrollContainer.cca_continue(iArr2, iArr2, iArr2), iArr2);
        setId.init(iArr3, setoncheckedchangelistener2.getInstance, iArr3);
        setId.getInstance(setDrawingCacheQuality.getInstance(5, iArr3, 0), iArr3);
        setId.getInstance(setDrawingCacheQuality.init(5, iArr4, 0, iArr), iArr);
        setOnCheckedChangeListener setoncheckedchangelistener4 = new setOnCheckedChangeListener(iArr4);
        setId.cca_continue(iArr2, setoncheckedchangelistener4.getInstance);
        setId.cca_continue(setoncheckedchangelistener4.getInstance, iArr3, setoncheckedchangelistener4.getInstance);
        setId.cca_continue(setoncheckedchangelistener4.getInstance, iArr3, setoncheckedchangelistener4.getInstance);
        setOnCheckedChangeListener setoncheckedchangelistener5 = new setOnCheckedChangeListener(iArr3);
        setId.cca_continue(iArr3, setoncheckedchangelistener4.getInstance, setoncheckedchangelistener5.getInstance);
        setId.init(setoncheckedchangelistener5.getInstance, iArr2, setoncheckedchangelistener5.getInstance);
        setId.cca_continue(setoncheckedchangelistener5.getInstance, iArr, setoncheckedchangelistener5.getInstance);
        setOnCheckedChangeListener setoncheckedchangelistener6 = new setOnCheckedChangeListener(iArr2);
        ...
        return new setElevation(cca_continue, setoncheckedchangelistener4, setoncheckedchangelistener5, new getAcsTransactionID[]{setoncheckedchangelistener6}, this.getInstance);
    }
