...
public class KeyFactorySpi extends BaseKeyFactorySpi {
    public PrivateKey engineGeneratePrivate(KeySpec keySpec) throws InvalidKeySpecException {
        return keySpec instanceof X509CertUtils ? new BCDSTU4145PrivateKey((X509CertUtils) keySpec) : keySpec instanceof ECPrivateKeySpec ? new BCDSTU4145PrivateKey((ECPrivateKeySpec) keySpec) : super.engineGeneratePrivate(keySpec);
    }

    public PublicKey engineGeneratePublic(KeySpec keySpec) throws InvalidKeySpecException {
        return keySpec instanceof ByteUtils ? new BCDSTU4145PublicKey((ByteUtils) keySpec, JWK.getInstance) : keySpec instanceof ECPublicKeySpec ? new BCDSTU4145PublicKey((ECPublicKeySpec) keySpec) : super.engineGeneratePublic(keySpec);
    }
    ...
    public final PrivateKey cca_continue(PrivateKeyInfo privateKeyInfo) throws IOException {
        ...
        if (aSN1ObjectIdentifier.equals(DSASigner.dsaSha3_512.configure) || aSN1ObjectIdentifier.equals(DSASigner.dsaSha3_512.cca_continue)) {
