...
public class KeyFactorySpi extends BaseKeyFactorySpi {
    /* renamed from: a */
    private static boolean m2197a(ASN1ObjectIdentifier aSN1ObjectIdentifier) {
        return aSN1ObjectIdentifier.equals(DSASigner.detDSA224.init) || aSN1ObjectIdentifier.equals(DSASigner.detDSA224.Cardinal) || aSN1ObjectIdentifier.equals(DSASigner.detDSA224.getWarnings) || aSN1ObjectIdentifier.equals(DSASigner.detDSA224.values);
    }

    public PrivateKey engineGeneratePrivate(KeySpec keySpec) throws InvalidKeySpecException {
        return keySpec instanceof X509CertUtils ? new BCECGOST3410_2012PrivateKey((X509CertUtils) keySpec) : keySpec instanceof ECPrivateKeySpec ? new BCECGOST3410_2012PrivateKey((ECPrivateKeySpec) keySpec) : super.engineGeneratePrivate(keySpec);
    }

    public PublicKey engineGeneratePublic(KeySpec keySpec) throws InvalidKeySpecException {
        return keySpec instanceof ByteUtils ? new BCECGOST3410_2012PublicKey((ByteUtils) keySpec, JWK.getInstance) : keySpec instanceof ECPublicKeySpec ? new BCECGOST3410_2012PublicKey((ECPublicKeySpec) keySpec) : super.engineGeneratePublic(keySpec);
    }
    ...
    public final PrivateKey cca_continue(PrivateKeyInfo privateKeyInfo) throws IOException {
        ...
        if (m2197a(aSN1ObjectIdentifier)) {
