...
public class PendingTrace extends LinkedList<DDSpan> {
    ...
    public void registerSpan(DDSpan dDSpan) {
        if (this.traceId != null && dDSpan.context() != null && this.traceId.equals(dDSpan.context().getTraceId())) {
            ...
            synchronized (dDSpan) {
                if (dDSpan.f4080a == null) {
                    dDSpan.f4080a = new WeakReference<>(dDSpan, this.referenceQueue);
                    this.weakReferences.add(dDSpan.f4080a);
    ...
    private void expireSpan(com.datadog.opentracing.DDSpan r3, boolean r4) {
        ...
        L_0x001c:
            monitor-enter(r3)
            java.lang.ref.WeakReference<com.datadog.opentracing.DDSpan> r0 = r3.f4080a     // Catch:{ all -> 0x003f }
            if (r0 != 0) goto L_0x0023
            monitor-exit(r3)     // Catch:{ all -> 0x003f }
            return
        L_0x0023:
            java.util.Set<java.lang.ref.WeakReference<?>> r0 = r2.weakReferences     // Catch:{ all -> 0x003f }
            java.lang.ref.WeakReference<com.datadog.opentracing.DDSpan> r1 = r3.f4080a     // Catch:{ all -> 0x003f }
            r0.remove(r1)     // Catch:{ all -> 0x003f }
            java.lang.ref.WeakReference<com.datadog.opentracing.DDSpan> r0 = r3.f4080a     // Catch:{ all -> 0x003f }
            r0.clear()     // Catch:{ all -> 0x003f }
            r0 = 0
            r3.f4080a = r0     // Catch:{ all -> 0x003f }
            if (r4 == 0) goto L_0x0038
            r2.expireReference()     // Catch:{ all -> 0x003f }
            goto L_0x003d
        L_0x0038:
            java.util.concurrent.atomic.AtomicInteger r4 = r2.pendingReferenceCount     // Catch:{ all -> 0x003f }
            r4.decrementAndGet()     // Catch:{ all -> 0x003f }
        L_0x003d:
            monitor-exit(r3)     // Catch:{ all -> 0x003f }
            return
        L_0x003f:
        ...
        if (this.pendingReferenceCount.decrementAndGet() == 0) {
            ...
            synchronized (this) {
                if (size() > this.tracer.getPartialFlushMinSpans()) {
                    ...
                    this.tracer.mo22535a((Collection<DDSpan>) arrayList);
                }
            }
        }
    }
    ...
    private synchronized void write() {
        if (this.isWritten.compareAndSet(false, true)) {
            removePendingTrace();
            if (!isEmpty()) {
                this.tracer.mo22535a((Collection<DDSpan>) this);
            }
        }
    }
    ...
    private static class SpanCleaner implements Closeable, Runnable {
        ...
        public SpanCleaner() {
            CommonTaskExecutor.INSTANCE.scheduleAtFixedRate(SpanCleanerTask.INSTANCE, this, 0, 1, TimeUnit.SECONDS, "Pending trace cleaner");
        }
