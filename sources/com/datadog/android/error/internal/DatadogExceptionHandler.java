...
@Metadata(mo148867d1 = {"\u0000F\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0010\u000e\n\u0000\n\u0002\u0010\u0003\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u0002\n\u0002\b\u0005\b\u0000\u0018\u0000 \u00192\u00020\u0001:\u0001\u0019B%\u0012\u0006\u0010\u0002\u001a\u00020\u0003\u0012\f\u0010\u0004\u001a\b\u0012\u0004\u0012\u00020\u00060\u0005\u0012\b\u0010\u0007\u001a\u0004\u0018\u00010\b¢\u0006\u0002\u0010\tJ\u0010\u0010\r\u001a\u00020\u000e2\u0006\u0010\u000f\u001a\u00020\u0010H\u0002J\u0018\u0010\u0011\u001a\u00020\u00062\u0006\u0010\u0012\u001a\u00020\u00132\u0006\u0010\u000f\u001a\u00020\u0010H\u0002J\u0006\u0010\u0014\u001a\u00020\u0015J\u0018\u0010\u0016\u001a\u00020\u00152\u0006\u0010\u0017\u001a\u00020\u00132\u0006\u0010\u0018\u001a\u00020\u0010H\u0016R\u0016\u0010\n\u001a\n\u0012\u0006\u0012\u0004\u0018\u00010\b0\u000bX\u0004¢\u0006\u0002\n\u0000R\u000e\u0010\u0002\u001a\u00020\u0003X\u0004¢\u0006\u0002\n\u0000R\u0010\u0010\f\u001a\u0004\u0018\u00010\u0001X\u000e¢\u0006\u0002\n\u0000R\u0014\u0010\u0004\u001a\b\u0012\u0004\u0012\u00020\u00060\u0005X\u0004¢\u0006\u0002\n\u0000¨\u0006\u001a"}, mo148868d2 = {"Lcom/datadog/android/error/internal/DatadogExceptionHandler;", "Ljava/lang/Thread$UncaughtExceptionHandler;", "logGenerator", "Lcom/datadog/android/log/internal/domain/LogGenerator;", "writer", "Lcom/datadog/android/core/internal/persistence/DataWriter;", "Lcom/datadog/android/log/model/LogEvent;", "appContext", "Landroid/content/Context;", "(Lcom/datadog/android/log/internal/domain/LogGenerator;Lcom/datadog/android/core/internal/persistence/DataWriter;Landroid/content/Context;)V", "contextRef", "Ljava/lang/ref/WeakReference;", "previousHandler", "createCrashMessage", "", "throwable", "", "createLog", "thread", "Ljava/lang/Thread;", "register", "", "uncaughtException", "t", "e", "Companion", "dd-sdk-android_release"}, mo148869k = 1, mo148870mv = {1, 5, 1}, mo148872xi = 48)
...
public final class DatadogExceptionHandler implements Thread.UncaughtExceptionHandler {
    ...
    /* renamed from: a */
    private final LogGenerator f3604a;

    /* renamed from: b */
    private final DataWriter<LogEvent> f3605b;

    /* renamed from: c */
    private final WeakReference<Context> f3606c;

    /* renamed from: d */
    private Thread.UncaughtExceptionHandler f3607d;

    public DatadogExceptionHandler(LogGenerator logGenerator, DataWriter<LogEvent> dataWriter, Context context) {
        Intrinsics.checkNotNullParameter(logGenerator, "logGenerator");
        Intrinsics.checkNotNullParameter(dataWriter, "writer");
        this.f3604a = logGenerator;
        this.f3605b = dataWriter;
        this.f3606c = new WeakReference<>(context);
    }
    ...
    public void uncaughtException(java.lang.Thread r8, java.lang.Throwable r9) {
        /*
            ...
            com.datadog.android.core.internal.persistence.DataWriter<com.datadog.android.log.model.LogEvent> r0 = r7.f3605b
            com.datadog.android.log.model.LogEvent r1 = r7.m2373a(r8, r9)
            r0.write(r1)
        ...
        L_0x0020:
            ...
            goto L_0x002c
        L_0x0023:
            java.lang.String r1 = r7.m2374a(r9)
        ...
        L_0x0052:
            java.lang.ref.WeakReference<android.content.Context> r0 = r7.f3606c
        ...
        L_0x0060:
            java.lang.Thread$UncaughtExceptionHandler r0 = r7.f3607d
    ...
    public final void register() {
        this.f3607d = Thread.getDefaultUncaughtExceptionHandler();
        Thread.setDefaultUncaughtExceptionHandler(this);
    }

    /* renamed from: a */
    private final LogEvent m2373a(Thread thread, Throwable th) {
        Throwable th2 = th;
        return LogGenerator.generateLog$default(this.f3604a, 9, m2374a(th2), th2, MapsKt.emptyMap(), SetsKt.emptySet(), System.currentTimeMillis(), thread.getName(), false, false, (UserInfo) null, (NetworkInfo) null, 1920, (Object) null);
    }

    /* renamed from: a */
    private final String m2374a(Throwable th) {
        ...
        return Intrinsics.stringPlus("Application crash detected: ", canonicalName);
    }

    @Metadata(mo148867d1 = {"\u0000\u001c\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0010\u000e\n\u0002\b\u0002\n\u0002\u0010\t\n\u0002\b\u0002\b\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002R\u000e\u0010\u0003\u001a\u00020\u0004XT¢\u0006\u0002\n\u0000R\u000e\u0010\u0005\u001a\u00020\u0004XT¢\u0006\u0002\n\u0000R\u000e\u0010\u0006\u001a\u00020\u0007XT¢\u0006\u0002\n\u0000R\u000e\u0010\b\u001a\u00020\u0004XT¢\u0006\u0002\n\u0000¨\u0006\t"}, mo148868d2 = {"Lcom/datadog/android/error/internal/DatadogExceptionHandler$Companion;", "", "()V", "EXECUTOR_NOT_IDLED_WARNING_MESSAGE", "", "LOGGER_NAME", "MAX_WAIT_FOR_IDLE_TIME_IN_MS", "", "MESSAGE", "dd-sdk-android_release"}, mo148869k = 1, mo148870mv = {1, 5, 1}, mo148872xi = 48)
    /* compiled from: DatadogExceptionHandler.kt */
