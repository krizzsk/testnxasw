...
public final class SpanEventSerializer implements Serializer<SpanEvent> {
    ...
    public String serialize(SpanEvent spanEvent) {
        ...
        JsonElement json = m2548a(spanEvent).toJson();
    ...
    /* renamed from: a */
    private final SpanEvent m2548a(SpanEvent spanEvent) {
        return SpanEvent.copy$default(spanEvent, (String) null, (String) null, (String) null, (String) null, (String) null, (String) null, 0, 0, 0, m2546a(spanEvent.getMetrics()), SpanEvent.Meta.copy$default(spanEvent.getMeta(), (String) null, (SpanEvent.C2212Dd) null, (SpanEvent.Span) null, (SpanEvent.Tracer) null, m2547a(spanEvent.getMeta().getUsr()), (SpanEvent.Network) null, (Map) null, 111, (Object) null), 511, (Object) null);
    }

    /* renamed from: a */
    private final SpanEvent.Usr m2547a(SpanEvent.Usr usr) {
        ...
        for (Map.Entry entry : validateAttributes$default.entrySet()) {
            linkedHashMap.put(entry.getKey(), m2549a(entry.getValue()));
        }
    ...
    /* renamed from: a */
    private final SpanEvent.Metrics m2546a(SpanEvent.Metrics metrics) {
    ...
    /* renamed from: a */
    private final String m2549a(Object obj) {
    ...
    @Metadata(mo148867d1 = {"\u0000\u0014\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0010\u000e\n\u0002\b\u0004\b\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002R\u000e\u0010\u0003\u001a\u00020\u0004XT¢\u0006\u0002\n\u0000R\u000e\u0010\u0005\u001a\u00020\u0004XT¢\u0006\u0002\n\u0000R\u000e\u0010\u0006\u001a\u00020\u0004XT¢\u0006\u0002\n\u0000R\u000e\u0010\u0007\u001a\u00020\u0004XT¢\u0006\u0002\n\u0000¨\u0006\b"}, mo148868d2 = {"Lcom/datadog/android/tracing/internal/domain/event/SpanEventSerializer$Companion;", "", "()V", "META_USR_KEY_PREFIX", "", "METRICS_KEY_PREFIX", "TAG_ENV", "TAG_SPANS", "dd-sdk-android_release"}, mo148869k = 1, mo148870mv = {1, 5, 1}, mo148872xi = 48)
    /* compiled from: SpanEventSerializer.kt */
