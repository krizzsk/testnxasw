...
@Metadata(mo148867d1 = {"\u0000\n\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\u0010\u0000\u001a\b\u0012\u0004\u0012\u00020\u00020\u0001H\n"}, mo148868d2 = {"<anonymous>", "Lcom/datadog/android/rum/internal/tracking/FragmentLifecycleCallbacks;", "Landroid/app/Activity;"}, mo148869k = 3, mo148870mv = {1, 5, 1}, mo148872xi = 48)
...
final class FragmentViewTrackingStrategy$oreoLifecycleCallbacks$2 extends Lambda implements Function0<FragmentLifecycleCallbacks<Activity>> {
    ...
    public final FragmentLifecycleCallbacks<Activity> invoke() {
        ...
        return new OreoFragmentLifecycleCallbacks(r3, defaultFragmentComponentPredicate$dd_sdk_android_release, (ViewLoadingTimer) null, rumMonitor, advancedRumMonitor, 4, (DefaultConstructorMarker) null);
    }
}
