...
public abstract class RumRawEvent {
    ...
    public static final class StartView extends RumRawEvent {
        ...
        public String toString() {
            return "StartView(key=" + this.key + ", name=" + this.name + ", attributes=" + this.attributes + ", eventTime=" + getEventTime() + VersionRange.RIGHT_OPEN;
        }
    ...
    public static final class StopView extends RumRawEvent {
        ...
        public String toString() {
            return "StopView(key=" + this.key + ", attributes=" + this.attributes + ", eventTime=" + getEventTime() + VersionRange.RIGHT_OPEN;
        }
    ...
    public static final class StartAction extends RumRawEvent {
        ...
        public String toString() {
            return "StartAction(type=" + this.type + ", name=" + this.name + ", waitForStop=" + this.waitForStop + ", attributes=" + this.attributes + ", eventTime=" + getEventTime() + VersionRange.RIGHT_OPEN;
        }
    ...
    public static final class StopAction extends RumRawEvent {
        ...
        public String toString() {
            return "StopAction(type=" + this.type + ", name=" + this.name + ", attributes=" + this.attributes + ", eventTime=" + getEventTime() + VersionRange.RIGHT_OPEN;
        }
    ...
    public static final class StartResource extends RumRawEvent {
        ...
        public String toString() {
            return "StartResource(key=" + this.key + ", url=" + this.url + ", method=" + this.method + ", attributes=" + this.attributes + ", eventTime=" + getEventTime() + VersionRange.RIGHT_OPEN;
        }
    ...
    public static final class WaitForResourceTiming extends RumRawEvent {
        ...
        public String toString() {
            return "WaitForResourceTiming(key=" + this.key + ", eventTime=" + getEventTime() + VersionRange.RIGHT_OPEN;
        }
    ...
    public static final class AddResourceTiming extends RumRawEvent {
        ...
        public String toString() {
            return "AddResourceTiming(key=" + this.key + ", timing=" + this.timing + ", eventTime=" + getEventTime() + VersionRange.RIGHT_OPEN;
        }
    ...
    public static final class StopResource extends RumRawEvent {
        ...
        public String toString() {
            return "StopResource(key=" + this.key + ", statusCode=" + this.statusCode + ", size=" + this.size + ", kind=" + this.kind + ", attributes=" + this.attributes + ", eventTime=" + getEventTime() + VersionRange.RIGHT_OPEN;
        }
    ...
    public static final class StopResourceWithError extends RumRawEvent {
        ...
        public final StopResourceWithError copy(String str, Long l, String str2, RumErrorSource rumErrorSource, Throwable th, Map<String, ? extends Object> map, Time time) {
            ...
            return new StopResourceWithError(str, l, str2, rumErrorSource, th, map, time2);
        }
        ...
        public String toString() {
            return "StopResourceWithError(key=" + this.key + ", statusCode=" + this.statusCode + ", message=" + this.message + ", source=" + this.source + ", throwable=" + this.throwable + ", attributes=" + this.attributes + ", eventTime=" + getEventTime() + VersionRange.RIGHT_OPEN;
        }
    ...
    public static final class AddError extends RumRawEvent {
        ...
        public String toString() {
            return "AddError(message=" + this.message + ", source=" + this.source + ", throwable=" + this.throwable + ", stacktrace=" + this.stacktrace + ", isFatal=" + this.isFatal + ", attributes=" + this.attributes + ", eventTime=" + getEventTime() + ", type=" + this.type + ", sourceType=" + this.sourceType + VersionRange.RIGHT_OPEN;
        }
    ...
    public static final class UpdateViewLoadingTime extends RumRawEvent {
        ...
        public int hashCode() {
            return (((((this.key.hashCode() * 31) + C$r8$backportedMethods$utility$Long$1$hashCode.hashCode(this.loadingTime)) * 31) + this.loadingType.hashCode()) * 31) + getEventTime().hashCode();
        }

        public String toString() {
            return "UpdateViewLoadingTime(key=" + this.key + ", loadingTime=" + this.loadingTime + ", loadingType=" + this.loadingType + ", eventTime=" + getEventTime() + VersionRange.RIGHT_OPEN;
        }
    ...
    public static final class ResourceSent extends RumRawEvent {
        ...
        public String toString() {
            return "ResourceSent(viewId=" + this.viewId + ", eventTime=" + getEventTime() + VersionRange.RIGHT_OPEN;
        }
    ...
    public static final class ActionSent extends RumRawEvent {
        ...
        public String toString() {
            return "ActionSent(viewId=" + this.viewId + ", eventTime=" + getEventTime() + VersionRange.RIGHT_OPEN;
        }
    ...
    public static final class ErrorSent extends RumRawEvent {
        ...
        public String toString() {
            return "ErrorSent(viewId=" + this.viewId + ", eventTime=" + getEventTime() + VersionRange.RIGHT_OPEN;
        }
    ...
    public static final class LongTaskSent extends RumRawEvent {
        ...
        public String toString() {
            return "LongTaskSent(viewId=" + this.viewId + ", isFrozenFrame=" + this.isFrozenFrame + ", eventTime=" + getEventTime() + VersionRange.RIGHT_OPEN;
        }
    ...
    public static final class ResourceDropped extends RumRawEvent {
        ...
        public String toString() {
            return "ResourceDropped(viewId=" + this.viewId + ", eventTime=" + getEventTime() + VersionRange.RIGHT_OPEN;
        }
    ...
    public static final class ActionDropped extends RumRawEvent {
        ...
        public String toString() {
            return "ActionDropped(viewId=" + this.viewId + ", eventTime=" + getEventTime() + VersionRange.RIGHT_OPEN;
        }
    ...
    public static final class ErrorDropped extends RumRawEvent {
        ...
        public String toString() {
            return "ErrorDropped(viewId=" + this.viewId + ", eventTime=" + getEventTime() + VersionRange.RIGHT_OPEN;
        }
    ...
    public static final class LongTaskDropped extends RumRawEvent {
        ...
        public String toString() {
            return "LongTaskDropped(viewId=" + this.viewId + ", isFrozenFrame=" + this.isFrozenFrame + ", eventTime=" + getEventTime() + VersionRange.RIGHT_OPEN;
        }
    ...
    @Metadata(mo148867d1 = {"\u0000\u0012\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0004\b\u0000\u0018\u00002\u00020\u0001B\r\u0012\u0006\u0010\u0002\u001a\u00020\u0003¢\u0006\u0002\u0010\u0004R\u0014\u0010\u0002\u001a\u00020\u0003X\u0004¢\u0006\b\n\u0000\u001a\u0004\b\u0005\u0010\u0006¨\u0006\u0007"}, mo148868d2 = {"Lcom/datadog/android/rum/internal/domain/scope/RumRawEvent$ViewTreeChanged;", "Lcom/datadog/android/rum/internal/domain/scope/RumRawEvent;", "eventTime", "Lcom/datadog/android/rum/internal/domain/Time;", "(Lcom/datadog/android/rum/internal/domain/Time;)V", "getEventTime", "()Lcom/datadog/android/rum/internal/domain/Time;", "dd-sdk-android_release"}, mo148869k = 1, mo148870mv = {1, 5, 1}, mo148872xi = 48)
    /* compiled from: RumRawEvent.kt */
    public static final class ViewTreeChanged extends RumRawEvent {
        ...
        /* JADX INFO: super call moved to the top of the method (can break code semantics) */
        public ViewTreeChanged(Time time) {
            super((DefaultConstructorMarker) null);
            Intrinsics.checkNotNullParameter(time, "eventTime");
            this.eventTime = time;
        }
    ...
    @Metadata(mo148867d1 = {"\u0000*\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0006\n\u0002\u0010\u000b\n\u0000\n\u0002\u0010\u0000\n\u0000\n\u0002\u0010\b\n\u0000\n\u0002\u0010\u000e\n\u0000\b\b\u0018\u00002\u00020\u0001B\u000f\u0012\b\b\u0002\u0010\u0002\u001a\u00020\u0003¢\u0006\u0002\u0010\u0004J\t\u0010\u0007\u001a\u00020\u0003HÆ\u0003J\u0013\u0010\b\u001a\u00020\u00002\b\b\u0002\u0010\u0002\u001a\u00020\u0003HÆ\u0001J\u0013\u0010\t\u001a\u00020\n2\b\u0010\u000b\u001a\u0004\u0018\u00010\fHÖ\u0003J\t\u0010\r\u001a\u00020\u000eHÖ\u0001J\t\u0010\u000f\u001a\u00020\u0010HÖ\u0001R\u0014\u0010\u0002\u001a\u00020\u0003X\u0004¢\u0006\b\n\u0000\u001a\u0004\b\u0005\u0010\u0006¨\u0006\u0011"}, mo148868d2 = {"Lcom/datadog/android/rum/internal/domain/scope/RumRawEvent$ResetSession;", "Lcom/datadog/android/rum/internal/domain/scope/RumRawEvent;", "eventTime", "Lcom/datadog/android/rum/internal/domain/Time;", "(Lcom/datadog/android/rum/internal/domain/Time;)V", "getEventTime", "()Lcom/datadog/android/rum/internal/domain/Time;", "component1", "copy", "equals", "", "other", "", "hashCode", "", "toString", "", "dd-sdk-android_release"}, mo148869k = 1, mo148870mv = {1, 5, 1}, mo148872xi = 48)
    /* compiled from: RumRawEvent.kt */
    public static final class ResetSession extends RumRawEvent {
        ...
        public String toString() {
            return "ResetSession(eventTime=" + getEventTime() + VersionRange.RIGHT_OPEN;
        }
    ...
    public static final class KeepAlive extends RumRawEvent {
        ...
        public String toString() {
            return "KeepAlive(eventTime=" + getEventTime() + VersionRange.RIGHT_OPEN;
        }
    ...
    public static final class ApplicationStarted extends RumRawEvent {
        ...
        public int hashCode() {
            return (getEventTime().hashCode() * 31) + C$r8$backportedMethods$utility$Long$1$hashCode.hashCode(this.applicationStartupNanos);
        }

        public String toString() {
            return "ApplicationStarted(eventTime=" + getEventTime() + ", applicationStartupNanos=" + this.applicationStartupNanos + VersionRange.RIGHT_OPEN;
        }
    ...
    public static final class AddCustomTiming extends RumRawEvent {
        ...
        public String toString() {
            return "AddCustomTiming(name=" + this.name + ", eventTime=" + getEventTime() + VersionRange.RIGHT_OPEN;
        }
    ...
    public static final class AddLongTask extends RumRawEvent {
        ...
        public int hashCode() {
            return (((C$r8$backportedMethods$utility$Long$1$hashCode.hashCode(this.durationNs) * 31) + this.target.hashCode()) * 31) + getEventTime().hashCode();
        }

        public String toString() {
            return "AddLongTask(durationNs=" + this.durationNs + ", target=" + this.target + ", eventTime=" + getEventTime() + VersionRange.RIGHT_OPEN;
        }
    ...
    public static final class SendCustomActionNow extends RumRawEvent {
        ...
        public String toString() {
            return "SendCustomActionNow(eventTime=" + getEventTime() + VersionRange.RIGHT_OPEN;
        }
