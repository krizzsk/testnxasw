...
@Metadata(mo148867d1 = {"\u0000,\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\t\n\u0002\b\u0003\n\u0002\u0010\u000b\n\u0000\n\u0002\u0010\u0002\n\u0002\b\u0006\b\u0000\u0018\u00002\u00020\u0001:\u0001\u0012B\u0005¢\u0006\u0002\u0010\u0002J\u0015\u0010\u0006\u001a\u0004\u0018\u00010\u00072\u0006\u0010\b\u001a\u00020\u0001¢\u0006\u0002\u0010\tJ\u000e\u0010\n\u001a\u00020\u000b2\u0006\u0010\b\u001a\u00020\u0001J\u000e\u0010\f\u001a\u00020\r2\u0006\u0010\b\u001a\u00020\u0001J\u000e\u0010\u000e\u001a\u00020\r2\u0006\u0010\b\u001a\u00020\u0001J\u000e\u0010\u000f\u001a\u00020\r2\u0006\u0010\b\u001a\u00020\u0001J\u000e\u0010\u0010\u001a\u00020\r2\u0006\u0010\b\u001a\u00020\u0001J\u000e\u0010\u0011\u001a\u00020\r2\u0006\u0010\b\u001a\u00020\u0001R\u001a\u0010\u0003\u001a\u000e\u0012\u0004\u0012\u00020\u0001\u0012\u0004\u0012\u00020\u00050\u0004X\u0004¢\u0006\u0002\n\u0000¨\u0006\u0013"}, mo148868d2 = {"Lcom/datadog/android/rum/internal/tracking/ViewLoadingTimer;", "", "()V", "viewsTimeAndState", "Ljava/util/WeakHashMap;", "Lcom/datadog/android/rum/internal/tracking/ViewLoadingTimer$ViewLoadingInfo;", "getLoadingTime", "", "view", "(Ljava/lang/Object;)Ljava/lang/Long;", "isFirstTimeLoading", "", "onCreated", "", "onDestroyed", "onFinishedLoading", "onPaused", "onStartLoading", "ViewLoadingInfo", "dd-sdk-android_release"}, mo148869k = 1, mo148870mv = {1, 5, 1}, mo148872xi = 48)
/* compiled from: ViewLoadingTimer.kt */
public final class ViewLoadingTimer {

    /* renamed from: a */
    private final WeakHashMap<Object, ViewLoadingInfo> f3894a = new WeakHashMap<>();

    public final void onCreated(Object obj) {
        Intrinsics.checkNotNullParameter(obj, "view");
        this.f3894a.put(obj, new ViewLoadingInfo(Long.valueOf(System.nanoTime()), 0, false, false, 14, (DefaultConstructorMarker) null));
    }

    public final void onStartLoading(Object obj) {
        ViewLoadingInfo viewLoadingInfo;
        Intrinsics.checkNotNullParameter(obj, "view");
        if (this.f3894a.containsKey(obj)) {
            viewLoadingInfo = this.f3894a.get(obj);
        } else {
            ...
            this.f3894a.put(obj, viewLoadingInfo2);
    ...
    public final void onFinishedLoading(Object obj) {
        Intrinsics.checkNotNullParameter(obj, "view");
        ViewLoadingInfo viewLoadingInfo = this.f3894a.get(obj);
    ...
    private static final class ViewLoadingInfo {
        ...
        public int hashCode() {
            ...
            int hashCode = (((l == null ? 0 : l.hashCode()) * 31) + C$r8$backportedMethods$utility$Long$1$hashCode.hashCode(this.loadingTime)) * 31;
        ...
        public String toString() {
            return "ViewLoadingInfo(loadingStart=" + this.loadingStart + ", loadingTime=" + this.loadingTime + ", firstTimeLoading=" + this.firstTimeLoading + ", finishedLoadingOnce=" + this.finishedLoadingOnce + VersionRange.RIGHT_OPEN;
        }
