...
final class Configuration$Builder$addPlugin$1 extends Lambda implements Function0<Unit> {
    ...
    public final void invoke() {
        ...
        if (i == 1) {
            ...
            builder.rumConfig = Configuration.Feature.RUM.copy$default(builder.rumConfig, (String) null, CollectionsKt.plus(this.this$0.rumConfig.getPlugins(), this.$plugin), 0.0f, (UserActionTrackingStrategy) null, (ViewTrackingStrategy) null, (TrackingStrategy) null, (EventMapper) null, false, 253, (Object) null);
        } else if (i == 2) {
