...
final class FileExtKt$listSafe$2 extends Lambda implements Function1<File, String[]> {
    final /* synthetic */ FilenameFilter $filter;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    FileExtKt$listSafe$2(FilenameFilter filenameFilter) {
        super(1);
