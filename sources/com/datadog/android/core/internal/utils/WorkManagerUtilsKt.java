...
@Metadata(mo148867d1 = {"\u0000\u001e\n\u0000\n\u0002\u0010\u000e\n\u0000\n\u0002\u0010\t\n\u0002\b\u0005\n\u0002\u0010\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\u001a\u0010\u0010\b\u001a\u00020\t2\u0006\u0010\n\u001a\u00020\u000bH\u0000\u001a\u0010\u0010\f\u001a\u00020\t2\u0006\u0010\n\u001a\u00020\u000bH\u0000\"\u000e\u0010\u0000\u001a\u00020\u0001XT¢\u0006\u0002\n\u0000\"\u000e\u0010\u0002\u001a\u00020\u0003XT¢\u0006\u0002\n\u0000\"\u000e\u0010\u0004\u001a\u00020\u0001XT¢\u0006\u0002\n\u0000\"\u000e\u0010\u0005\u001a\u00020\u0001XT¢\u0006\u0002\n\u0000\"\u000e\u0010\u0006\u001a\u00020\u0001XT¢\u0006\u0002\n\u0000\"\u000e\u0010\u0007\u001a\u00020\u0001XT¢\u0006\u0002\n\u0000¨\u0006\r"}, mo148868d2 = {"CANCEL_ERROR_MESSAGE", "", "DELAY_MS", "", "SETUP_ERROR_MESSAGE", "TAG_DATADOG_UPLOAD", "UPLOAD_WORKER_NAME", "UPLOAD_WORKER_WAS_SCHEDULED", "cancelUploadWorker", "", "context", "Landroid/content/Context;", "triggerUploadWorker", "dd-sdk-android_release"}, mo148869k = 2, mo148870mv = {1, 5, 1}, mo148872xi = 48)
...
public final class WorkManagerUtilsKt {
    ...
    public static final void cancelUploadWorker(Context context) {
        ...
        try {
            ...
            Logger.e$default(RuntimeUtilsKt.getSdkLogger(), CANCEL_ERROR_MESSAGE, e, (Map) null, 4, (Object) null);
        }
    }
    ...
    public static final void triggerUploadWorker(Context context) {
        ...
        try {
            ...
            Intrinsics.checkNotNullExpressionValue(build2, "Builder(UploadWorker::class.java)\n            .setConstraints(constraints)\n            .addTag(TAG_DATADOG_UPLOAD)\n            .setInitialDelay(DELAY_MS, TimeUnit.MILLISECONDS)\n            .build()");
            ...
            Logger.e$default(RuntimeUtilsKt.getSdkLogger(), SETUP_ERROR_MESSAGE, e, (Map) null, 4, (Object) null);
        }
    }
}
