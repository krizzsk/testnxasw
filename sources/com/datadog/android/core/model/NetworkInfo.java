...
public final class NetworkInfo {
    ...
    public static /* synthetic */ NetworkInfo copy$default(NetworkInfo networkInfo, Connectivity connectivity, String str, Long l, Long l2, Long l3, Long l4, String str2, int i, Object obj) {
        if ((i & 1) != 0) {
            connectivity = networkInfo.f3591a;
        }
        if ((i & 2) != 0) {
            str = networkInfo.f3592b;
        }
        String str3 = str;
        if ((i & 4) != 0) {
            l = networkInfo.f3593c;
        }
        Long l5 = l;
        if ((i & 8) != 0) {
            l2 = networkInfo.f3594d;
        }
        Long l6 = l2;
        if ((i & 16) != 0) {
            l3 = networkInfo.f3595e;
        }
        Long l7 = l3;
        if ((i & 32) != 0) {
            l4 = networkInfo.f3596f;
        }
        Long l8 = l4;
        if ((i & 64) != 0) {
            str2 = networkInfo.f3597g;
        }
    ...
    public final NetworkInfo copy(Connectivity connectivity, String str, Long l, Long l2, Long l3, Long l4, String str2) {
        Intrinsics.checkNotNullParameter(connectivity, "connectivity");
        return new NetworkInfo(connectivity, str, l, l2, l3, l4, str2);
    }
    ...
    public boolean equals(Object obj) {
        ...
        return this.f3591a == networkInfo.f3591a && Intrinsics.areEqual((Object) this.f3592b, (Object) networkInfo.f3592b) && Intrinsics.areEqual((Object) this.f3593c, (Object) networkInfo.f3593c) && Intrinsics.areEqual((Object) this.f3594d, (Object) networkInfo.f3594d) && Intrinsics.areEqual((Object) this.f3595e, (Object) networkInfo.f3595e) && Intrinsics.areEqual((Object) this.f3596f, (Object) networkInfo.f3596f) && Intrinsics.areEqual((Object) this.f3597g, (Object) networkInfo.f3597g);
    }
    ...
    public String toString() {
        return "NetworkInfo(connectivity=" + this.f3591a + ", carrierName=" + this.f3592b + ", carrierId=" + this.f3593c + ", upKbps=" + this.f3594d + ", downKbps=" + this.f3595e + ", strength=" + this.f3596f + ", cellularTechnology=" + this.f3597g + VersionRange.RIGHT_OPEN;
    }

    public NetworkInfo(Connectivity connectivity, String str, Long l, Long l2, Long l3, Long l4, String str2) {
        Intrinsics.checkNotNullParameter(connectivity, "connectivity");
        this.f3591a = connectivity;
        this.f3592b = str;
        this.f3593c = l;
        this.f3594d = l2;
        this.f3595e = l3;
    ...
    public final JsonElement toJson() {
        ...
        jsonObject.add("connectivity", this.f3591a.toJson());
        String str = this.f3592b;
        if (str != null) {
    ...
    @Metadata(mo148867d1 = {"\u0000\u0018\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u000e\n\u0000\b\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002J\u0010\u0010\u0003\u001a\u00020\u00042\u0006\u0010\u0005\u001a\u00020\u0006H\u0007¨\u0006\u0007"}, mo148868d2 = {"Lcom/datadog/android/core/model/NetworkInfo$Companion;", "", "()V", "fromJson", "Lcom/datadog/android/core/model/NetworkInfo;", "serializedObject", "", "dd-sdk-android_release"}, mo148869k = 1, mo148870mv = {1, 5, 1}, mo148872xi = 48)
    /* compiled from: NetworkInfo.kt */
    ...
    @Metadata(mo148867d1 = {"\u0000\u001a\n\u0002\u0018\u0002\n\u0002\u0010\u0010\n\u0000\n\u0002\u0010\u000e\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u000e\b\u0001\u0018\u0000 \u00132\b\u0012\u0004\u0012\u00020\u00000\u0001:\u0001\u0013B\u000f\b\u0002\u0012\u0006\u0010\u0002\u001a\u00020\u0003¢\u0006\u0002\u0010\u0004J\u0006\u0010\u0005\u001a\u00020\u0006R\u000e\u0010\u0002\u001a\u00020\u0003X\u0004¢\u0006\u0002\n\u0000j\u0002\b\u0007j\u0002\b\bj\u0002\b\tj\u0002\b\nj\u0002\b\u000bj\u0002\b\fj\u0002\b\rj\u0002\b\u000ej\u0002\b\u000fj\u0002\b\u0010j\u0002\b\u0011j\u0002\b\u0012¨\u0006\u0014"}, mo148868d2 = {"Lcom/datadog/android/core/model/NetworkInfo$Connectivity;", "", "jsonValue", "", "(Ljava/lang/String;ILjava/lang/String;)V", "toJson", "Lcom/google/gson/JsonElement;", "NETWORK_NOT_CONNECTED", "NETWORK_ETHERNET", "NETWORK_WIFI", "NETWORK_WIMAX", "NETWORK_BLUETOOTH", "NETWORK_2G", "NETWORK_3G", "NETWORK_4G", "NETWORK_5G", "NETWORK_MOBILE_OTHER", "NETWORK_CELLULAR", "NETWORK_OTHER", "Companion", "dd-sdk-android_release"}, mo148869k = 1, mo148870mv = {1, 5, 1}, mo148872xi = 48)
    /* compiled from: NetworkInfo.kt */
    public enum Connectivity {
        ...
        @Metadata(mo148867d1 = {"\u0000\u0018\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u000e\n\u0000\b\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002J\u0010\u0010\u0003\u001a\u00020\u00042\u0006\u0010\u0005\u001a\u00020\u0006H\u0007¨\u0006\u0007"}, mo148868d2 = {"Lcom/datadog/android/core/model/NetworkInfo$Connectivity$Companion;", "", "()V", "fromJson", "Lcom/datadog/android/core/model/NetworkInfo$Connectivity;", "serializedObject", "", "dd-sdk-android_release"}, mo148869k = 1, mo148870mv = {1, 5, 1}, mo148872xi = 48)
        /* compiled from: NetworkInfo.kt */
        public static final class Companion {
            public /* synthetic */ Companion(DefaultConstructorMarker defaultConstructorMarker) {
                this();
