...
public final class TypeResolver {
    ...
    private static class TypeTable {
        ...
        TypeTable() {
            this.map = ImmutableMap.m40851of();
        }
    ...
    private static class WildcardCapturer {
        ...
        /* renamed from: id */
        private final AtomicInteger f55223id;
        ...
        public TypeVariable<?> captureAsTypeVariable(Type[] typeArr) {
            return Types.newArtificialTypeVariable(WildcardCapturer.class, "capture#" + this.f55223id.incrementAndGet() + "-of ? extends " + Joiner.m40801on((char) Typography.amp).join((Object[]) typeArr), typeArr);
        }

        private WildcardCapturer forTypeVariable(final TypeVariable<?> typeVariable) {
            return new WildcardCapturer(this.f55223id) {
                /* access modifiers changed from: package-private */
                public TypeVariable<?> captureAsTypeVariable(Type[] typeArr) {
