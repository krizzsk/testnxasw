...
public abstract class EndpointPair<N> implements Iterable<N> {
    ...
    /* renamed from: of */
    static <N> EndpointPair<N> m40931of(Graph<?> graph, N n, N n2) {
        return graph.isDirected() ? ordered(n, n2) : unordered(n, n2);
    }

    /* renamed from: of */
    static <N> EndpointPair<N> m40932of(Network<?, ?> network, N n, N n2) {
    ...
    private static final class Ordered<N> extends EndpointPair<N> {
        ...
        public String toString() {
            return IMTextUtils.STREET_IMAGE_TAG_START + source() + " -> " + target() + IMTextUtils.STREET_IMAGE_TAG_END;
        }
    }
    ...
    private static final class Unordered<N> extends EndpointPair<N> {
        ...
        public String toString() {
            return Const.jaLeft + nodeU() + ", " + nodeV() + Const.jaRight;
        }
    }
}
