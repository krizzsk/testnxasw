...
final class ConfigurableMutableNetwork<N, E> extends ConfigurableNetwork<N, E> implements MutableNetwork<N, E> {
    ...
    public boolean addEdge(N n, N n2, E e) {
        ...
        if (containsEdge(e)) {
            ...
            EndpointPair of = EndpointPair.m40932of((Network<?, ?>) this, n, n2);
    ...
    private NetworkConnections<N, E> newConnections() {
        if (isDirected()) {
            if (allowsParallelEdges()) {
                return DirectedMultiNetworkConnections.m40929of();
            }
            return DirectedNetworkConnections.m40930of();
        } else if (allowsParallelEdges()) {
            return UndirectedMultiNetworkConnections.m40935of();
        } else {
            return UndirectedNetworkConnections.m40936of();
        }
    }
}
