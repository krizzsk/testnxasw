package com.google.common.p216io;
...
public abstract class BaseEncoding {
    private static final BaseEncoding BASE16 = new Base16Encoding("base16()", C2948a.f6666a);
    ...
    static class StandardBaseEncoding extends BaseEncoding {
        ...
        public com.google.common.p216io.BaseEncoding withPadChar(char r3) {
            /*
                r2 = this;
            ...
            L_0x001f:
                return r2
            */
            throw new UnsupportedOperationException("Method not decompiled: com.google.common.p216io.BaseEncoding.StandardBaseEncoding.withPadChar(char):com.google.common.io.BaseEncoding");
        }
    ...
    static final class Base64Encoding extends StandardBaseEncoding {
        ...
        public void encodeTo(Appendable appendable, byte[] bArr, int i, int i2) throws IOException {
            ...
            while (i2 >= 3) {
                ...
                appendable.append(this.alphabet.encode((b >>> Ascii.f55141FF) & 63));
        ...
        return new Reader() {
            ...
            public int read() throws java.io.IOException {
                ...
                L_0x0012:
                    return r0
                */
                throw new UnsupportedOperationException("Method not decompiled: com.google.common.p216io.BaseEncoding.C191023.read():int");
            }
