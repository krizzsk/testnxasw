...
public final class CacheBuilder<K, V> {
    ...
    public String toString() {
        ...
        if (this.expireAfterWriteNanos != -1) {
            stringHelper.add("expireAfterWrite", (Object) this.expireAfterWriteNanos + Config.KEY_NS);
        }
        if (this.expireAfterAccessNanos != -1) {
            stringHelper.add("expireAfterAccess", (Object) this.expireAfterAccessNanos + Config.KEY_NS);
        }
