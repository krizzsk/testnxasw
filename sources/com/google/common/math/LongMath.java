...
public final class LongMath {
    ...
    static final byte[] maxLog10ForLeadingZeros = {19, Ascii.DC2, Ascii.DC2, Ascii.DC2, Ascii.DC2, 17, 17, 17, 16, 16, 16, Ascii.f55148SI, Ascii.f55148SI, Ascii.f55148SI, Ascii.f55148SI, Ascii.f55149SO, Ascii.f55149SO, Ascii.f55149SO, Ascii.f55139CR, Ascii.f55139CR, Ascii.f55139CR, Ascii.f55141FF, Ascii.f55141FF, Ascii.f55141FF, Ascii.f55141FF, 11, 11, 11, 10, 10, 10, 9, 9, 9, 9, 8, 8, 8, 7, 7, 7, 6, 6, 6, 6, 5, 5, 5, 4, 4, 4, 3, 3, 3, 3, 2, 2, 2, 1, 1, 1, 0, 0, 0};
    ...
    static /* synthetic */ class C191231 {
        ...
        static {
            ...
            L_0x0060:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.google.common.math.LongMath.C191231.<clinit>():void");
        }
    }

    public static int log2(long j, RoundingMode roundingMode) {
        MathPreconditions.checkPositive("x", j);
        switch (C191231.$SwitchMap$java$math$RoundingMode[roundingMode.ordinal()]) {
            case 1:
    ...
    public static int log10(long r4, java.math.RoundingMode r6) {
        /*
            ...
            long[] r1 = powersOf10
            r2 = r1[r0]
            int[] r1 = com.google.common.math.LongMath.C191231.$SwitchMap$java$math$RoundingMode
            int r6 = r6.ordinal()
            r6 = r1[r6]
            switch(r6) {
    ...
    public static long divide(long r9, long r11, java.math.RoundingMode r13) {
        ...
        L_0x0010:
            ...
            r9 = 1
            r10 = r10 | r9
            int[] r7 = com.google.common.math.LongMath.C191231.$SwitchMap$java$math$RoundingMode
            int r8 = r13.ordinal()
            r7 = r7[r8]
            r8 = 0
            switch(r7) {
    ...
    public static long gcd(long j, long j2) {
        MathPreconditions.checkNonNegative(Constants.FILE_ANR_KEY, j);
    ...
    public static boolean isPrime(long j) {
        int i = (j > 2 ? 1 : (j == 2 ? 0 : -1));
        if (i < 0) {
            MathPreconditions.checkNonNegative(CampaignValue.f43060b, j);
            return false;
    ...
    private enum MillerRabinTester {
        ...
        LARGE {
            ...
            public long mulMod(long j, long j2, long j3) {
                ...
                long j5 = j >>> 32;
                long j6 = j2 >>> 32;
                long j7 = j & InternalZipConstants.ZIP_64_SIZE_LIMIT;
                long j8 = j2 & InternalZipConstants.ZIP_64_SIZE_LIMIT;
