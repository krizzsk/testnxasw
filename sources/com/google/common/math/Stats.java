...
public final class Stats implements Serializable {
    ...
    /* renamed from: of */
    public static Stats m40939of(Iterable<? extends Number> iterable) {
    ...
    /* renamed from: of */
    public static Stats m40940of(Iterator<? extends Number> it) {
        StatsAccumulator statsAccumulator = new StatsAccumulator();
    ...
    /* renamed from: of */
    public static Stats m40941of(double... dArr) {
        StatsAccumulator statsAccumulator = new StatsAccumulator();
    ...
    /* renamed from: of */
    public static Stats m40942of(int... iArr) {
        StatsAccumulator statsAccumulator = new StatsAccumulator();
    ...
    /* renamed from: of */
    public static Stats m40943of(long... jArr) {
        StatsAccumulator statsAccumulator = new StatsAccumulator();
    ...
    public String toString() {
        if (count() > 0) {
            return MoreObjects.toStringHelper((Object) this).add(Const.PageParams.COUNT, this.count).add("mean", this.mean).add("populationStandardDeviation", populationStandardDeviation()).add("min", this.min).add("max", this.max).toString();
        }
        return MoreObjects.toStringHelper((Object) this).add(Const.PageParams.COUNT, this.count).toString();
    }
