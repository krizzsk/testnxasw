...
public class EventBus {
    ...
    static final class LoggingHandler implements SubscriberExceptionHandler {
        ...
        private static String message(SubscriberExceptionContext subscriberExceptionContext) {
            ...
            return "Exception thrown by subscriber method " + subscriberMethod.getName() + VersionRange.LEFT_OPEN + subscriberMethod.getParameterTypes()[0].getName() + VersionRange.RIGHT_OPEN + " on subscriber " + subscriberExceptionContext.getSubscriber() + " when dispatching event: " + subscriberExceptionContext.getEvent();
        }
    }
}
