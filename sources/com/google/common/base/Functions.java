...
public final class Functions {
    ...
    private static class FunctionComposition<A, B, C> implements Function<A, C>, Serializable {
        ...
        /* renamed from: f */
        private final Function<A, ? extends B> f55153f;

        /* renamed from: g */
        private final Function<B, C> f55154g;

        public FunctionComposition(Function<B, C> function, Function<A, ? extends B> function2) {
            this.f55154g = (Function) Preconditions.checkNotNull(function);
            this.f55153f = (Function) Preconditions.checkNotNull(function2);
        }

        public C apply(@NullableDecl A a) {
            return this.f55154g.apply(this.f55153f.apply(a));
        }
        ...
        public boolean equals(@NullableDecl Object obj) {
            ...
            if (!this.f55153f.equals(functionComposition.f55153f) || !this.f55154g.equals(functionComposition.f55154g)) {
                return false;
            }
            return true;
        }
        ...
        public int hashCode() {
            return this.f55153f.hashCode() ^ this.f55154g.hashCode();
        }

        public String toString() {
            return this.f55154g + "(" + this.f55153f + ")";
        }
    }
