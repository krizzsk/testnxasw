...
public abstract class CharMatcher implements Predicate<Character> {
    ...
    /* renamed from: is */
    public static CharMatcher m40795is(char c) {
        return new C18748Is(c);
    }
    ...
    public static CharMatcher anyOf(CharSequence charSequence) {
        ...
        if (length == 1) {
            return m40795is(charSequence.charAt(0));
        }
        if (length != 2) {
    ...
    /* renamed from: or */
    public CharMatcher mo142917or(CharMatcher charMatcher) {
        return new C18749Or(this, charMatcher);
    }
    ...
    private static CharMatcher precomputedPositive(int i, BitSet bitSet, String str) {
        ...
        if (i == 1) {
            return m40795is((char) bitSet.nextSetBit(0));
        }
        if (i == 2) {
    ...
    public static String showCharacter(char c) {
        ...
        for (int i = 0; i < 4; i++) {
            cArr[5 - i] = C2948a.f6666a.charAt(c & 15);
            c = (char) (c >> 4);
        }
    ...
    private static final class C18749Or extends CharMatcher {
        final CharMatcher first;
        final CharMatcher second;
        ...
        C18749Or(CharMatcher charMatcher, CharMatcher charMatcher2) {
            this.first = (CharMatcher) Preconditions.checkNotNull(charMatcher);
            this.second = (CharMatcher) Preconditions.checkNotNull(charMatcher2);
        }
    ...
    private static final class C18748Is extends FastMatcher {
        ...
        /* renamed from: or */
        public CharMatcher mo142917or(CharMatcher charMatcher) {
            return charMatcher.matches(this.match) ? charMatcher : super.mo142917or(charMatcher);
        }
