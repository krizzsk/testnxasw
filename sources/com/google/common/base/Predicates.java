...
public final class Predicates {
    ...
    /* renamed from: or */
    public static <T> Predicate<T> m40809or(Iterable<? extends Predicate<? super T>> iterable) {
        return new OrPredicate(defensiveCopy(iterable));
    }

    @SafeVarargs
    /* renamed from: or */
    public static <T> Predicate<T> m40810or(Predicate<? super T>... predicateArr) {
        return new OrPredicate(defensiveCopy((T[]) predicateArr));
    }

    /* renamed from: or */
    public static <T> Predicate<T> m40808or(Predicate<? super T> predicate, Predicate<? super T> predicate2) {
    ...
    /* renamed from: in */
    public static <T> Predicate<T> m40807in(Collection<? extends T> collection) {
    ...
    private static class CompositionPredicate<A, B> implements Predicate<A>, Serializable {
        ...
        /* renamed from: f */
        final Function<A, ? extends B> f55155f;

        /* renamed from: p */
        final Predicate<B> f55156p;

        private CompositionPredicate(Predicate<B> predicate, Function<A, ? extends B> function) {
            this.f55156p = (Predicate) Preconditions.checkNotNull(predicate);
            this.f55155f = (Function) Preconditions.checkNotNull(function);
        }

        public boolean apply(@NullableDecl A a) {
            return this.f55156p.apply(this.f55155f.apply(a));
        }
        ...
        public boolean equals(@NullableDecl Object obj) {
            ...
            if (!this.f55155f.equals(compositionPredicate.f55155f) || !this.f55156p.equals(compositionPredicate.f55156p)) {
                return false;
            }
            return true;
        }
        ...
        public int hashCode() {
            return this.f55155f.hashCode() ^ this.f55156p.hashCode();
        }

        public String toString() {
            return this.f55156p + "(" + this.f55155f + ")";
        }
    }
