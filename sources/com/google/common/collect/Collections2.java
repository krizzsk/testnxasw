...
public final class Collections2 {
    ...
    static String toStringImpl(Collection<?> collection) {
        ...
        newStringBuilderForCollection.append(VersionRange.LEFT_CLOSED);
        boolean z = true;
        ...
        newStringBuilderForCollection.append(VersionRange.RIGHT_CLOSED);
    ...
    private static class PermutationIterator<E> extends AbstractIterator<List<E>> {
        ...
        PermutationIterator(List<E> list2) {
            ...
            this.f55173c = iArr;
            this.f55175o = new int[size];
            Arrays.fill(iArr, 0);
            Arrays.fill(this.f55175o, 1);
        }
        ...
        public void calculateNextPermutation() {
            ...
            if (size != -1) {
                int i = 0;
                while (true) {
                    int[] iArr = this.f55173c;
                    int i2 = this.f55174j;
                    int i3 = iArr[i2] + this.f55175o[i2];
                    if (i3 < 0) {
                        switchDirection();
                    } else if (i3 != i2 + 1) {
                        Collections.swap(this.list, (i2 - iArr[i2]) + i, (i2 - i3) + i);
                        this.f55173c[this.f55174j] = i3;
                        return;
                    } else if (i2 != 0) {
                        i++;
                        switchDirection();
