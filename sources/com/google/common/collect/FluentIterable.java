...
public abstract class FluentIterable<E> implements Iterable<E> {
    ...
    private Iterable<E> getDelegate() {
        return this.iterableDelegate.mo142883or(this);
    }
    ...
    /* renamed from: of */
    public static <E> FluentIterable<E> m40822of() {
        return from(ImmutableList.m40832of());
    }

    /* renamed from: of */
    public static <E> FluentIterable<E> m40823of(@NullableDecl E e, E... eArr) {
    ...
    public final Optional<E> first() {
        ...
        return it.hasNext() ? Optional.m40803of(it.next()) : Optional.absent();
    }
    ...
    public final Optional<E> last() {
        ...
        if (delegate instanceof List) {
            ...
            return Optional.m40803of(list.get(list.size() - 1));
        }
        ...
        if (delegate instanceof SortedSet) {
            return Optional.m40803of(((SortedSet) delegate).last());
        }
        do {
            next = it.next();
        } while (it.hasNext());
        return Optional.m40803of(next);
    }
