...
final class GeneralRange<T> implements Serializable {
    ...
    public String toString() {
        ...
        sb.append(":");
        sb.append(this.lowerBoundType == BoundType.CLOSED ? VersionRange.LEFT_CLOSED : VersionRange.LEFT_OPEN);
        sb.append(this.hasLowerBound ? this.lowerEndpoint : "-∞");
        sb.append(',');
        sb.append(this.hasUpperBound ? this.upperEndpoint : "∞");
        sb.append(this.upperBoundType == BoundType.CLOSED ? VersionRange.RIGHT_CLOSED : VersionRange.RIGHT_OPEN);
        return sb.toString();
    }
