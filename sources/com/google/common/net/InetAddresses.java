...
import com.google.common.p216io.ByteStreams;
...
public final class InetAddresses {
    ...
    private static final Splitter IPV4_SPLITTER = Splitter.m40814on('.').limit(4);
    private static final int IPV6_PART_COUNT = 8;
    private static final Splitter IPV6_SPLITTER = Splitter.m40814on(':').limit(10);
    ...
    public static String toUriString(InetAddress inetAddress) {
        ...
        return Const.jaLeft + toAddrString(inetAddress) + Const.jaRight;
    }
