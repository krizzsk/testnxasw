...
public class IidStore {
    ...
    public IidStore(FirebaseApp firebaseApp) {
        this.iidPrefs = SystemUtils.getSharedPreferences(firebaseApp.getApplicationContext(), IID_SHARED_PREFS_NAME, 0);
    ...
    private static String getIdFromPublicKey(PublicKey publicKey) {
        try {
            ...
            digest[0] = (byte) (((digest[0] & Ascii.f55148SI) + 112) & 255);
            return Base64.encodeToString(digest, 0, 8, 11);
        } catch (NoSuchAlgorithmException unused) {
            SystemUtils.log(5, "ContentValues", "Unexpected error, device missing required algorithms", (Throwable) null, "com.google.firebase.installations.local.IidStore", 193);
            return null;
        }
    }
    ...
    private PublicKey parseKey(String str) {
        try {
            ...
            SystemUtils.log(5, "ContentValues", "Invalid key stored " + e, (Throwable) null, "com.google.firebase.installations.local.IidStore", 207);
            return null;
        }
    }
}
