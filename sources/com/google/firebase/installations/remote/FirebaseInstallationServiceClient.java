...
public class FirebaseInstallationServiceClient {
    ...
    public void deleteFirebaseInstallation(String str, String str2, String str3, String str4) throws FirebaseInstallationsException {
        ...
        while (i <= 1) {
            ...
            HttpURLConnection openHttpURLConnection = openHttpURLConnection(fullyQualifiedRequestUri, str);
            try {
                openHttpURLConnection.setRequestMethod(AsyncHttpDelete.METHOD);
    ...
    private static void logBadConfigError() {
        SystemUtils.log(6, FIS_TAG, "Firebase Installations can not communicate with Firebase server APIs due to invalid configuration. Please update your Firebase initialization process and set valid Firebase options (API key, Project ID, Application ID) when initializing Firebase.", (Throwable) null, "com.google.firebase.installations.remote.FirebaseInstallationServiceClient", 462);
    }
    ...
    private InstallationResponse readCreateResponse(HttpURLConnection httpURLConnection) throws AssertionError, IOException {
        ...
        jsonReader.close();
        inputStream.close();
        return builder2.setResponseCode(InstallationResponse.ResponseCode.f56622OK).build();
    }
    ...
    private TokenResult readGenerateAuthTokenResponse(HttpURLConnection httpURLConnection) throws AssertionError, IOException {
        ...
        jsonReader.close();
        inputStream.close();
        return builder.setResponseCode(TokenResult.ResponseCode.f56623OK).build();
    }
    ...
    private String getFingerprintHashForPackage() {
        try {
            ...
            SystemUtils.log(6, "ContentValues", "Could not get fingerprint hash for package: " + this.context.getPackageName(), (Throwable) null, "com.google.firebase.installations.remote.FirebaseInstallationServiceClient", 580);
            return null;
        } catch (PackageManager.NameNotFoundException e) {
            PackageManager.NameNotFoundException nameNotFoundException = e;
            SystemUtils.log(6, "ContentValues", "No such package: " + this.context.getPackageName(), nameNotFoundException, "com.google.firebase.installations.remote.FirebaseInstallationServiceClient", 586);
            return null;
        }
    }
    ...
    private static void logFisCommunicationError(HttpURLConnection httpURLConnection, String str, String str2, String str3) {
        ...
        if (!TextUtils.isEmpty(readErrorResponse)) {
            SystemUtils.log(5, FIS_TAG, readErrorResponse, (Throwable) null, "com.google.firebase.installations.remote.FirebaseInstallationServiceClient", 613);
            SystemUtils.log(5, FIS_TAG, availableFirebaseOptions(str, str2, str3), (Throwable) null, "com.google.firebase.installations.remote.FirebaseInstallationServiceClient", 614);
        }
    }
