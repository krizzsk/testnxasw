...
public class DataCollectionConfigStorage {
    ...
    public DataCollectionConfigStorage(Context context, String str, Publisher publisher2) {
        ...
        this.sharedPreferences = SystemUtils.getSharedPreferences(directBootSafe, FIREBASE_APP_PREFS + str, 0);
    ...
    private boolean readManifestDataCollectionEnabled() {
        ...
        try {
            ...
            if (packageManager == null || (applicationInfo = SystemUtils.getApplicationInfo(packageManager, this.deviceProtectedContext.getPackageName(), 128)) == null || applicationInfo.metaData == null || !applicationInfo.metaData.containsKey(DATA_COLLECTION_DEFAULT_ENABLED)) {
                return true;
            }
