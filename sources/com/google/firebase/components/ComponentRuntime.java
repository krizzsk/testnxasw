...
public class ComponentRuntime extends AbstractComponentContainer implements ComponentLoader {
    ...
    private ComponentRuntime(Executor executor, Iterable<Provider<ComponentRegistrar>> iterable, Collection<Component<?>> collection) {
        ...
        arrayList.add(Component.m42711of(this.eventBus, EventBus.class, Subscriber.class, Publisher.class));
        arrayList.add(Component.m42711of(this, ComponentLoader.class, new Class[0]));
        ...
        synchronized (this) {
            ...
            while (it.hasNext()) {
                try {
                    ...
                    InvalidRegistrarException invalidRegistrarException = e;
                    it.remove();
                    SystemUtils.log(5, "ComponentDiscovery", "Invalid component registrar.", invalidRegistrarException, "com.google.firebase.components.ComponentRuntime", 114);
                }
            }
    ...
    public <T> Deferred<T> getDeferred(Class<T> cls) {
        ...
        return OptionalProvider.m42712of(provider);
    }
