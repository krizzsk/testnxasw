...
public final class ComponentDiscovery<T> {
    ...
    public List<ComponentRegistrar> discover() {
        ...
        for (String instantiate : this.retriever.retrieve(this.context)) {
            try {
                ...
                SystemUtils.log(5, TAG, "Invalid component registrar.", e, "com.google.firebase.components.ComponentDiscovery", 88);
            }
        }
        return arrayList;
    }
    ...
    public static ComponentRegistrar instantiate(String str) {
        try {
            ...
            SystemUtils.log(5, TAG, String.format("Class %s is not an found.", new Object[]{str}), (Throwable) null, "com.google.firebase.components.ComponentDiscovery", 128);
            return null;
    ...
    private static class MetadataRegistrarNameRetriever implements RegistrarNameRetriever<Context> {
        ...
        public List<String> retrieve(Context context) {
            ...
            if (metadata == null) {
                SystemUtils.log(5, ComponentDiscovery.TAG, "Could not retrieve metadata, returning empty list of registrars.", (Throwable) null, "com.google.firebase.components.ComponentDiscovery$MetadataRegistrarNameRetriever", 159);
        ...
        private Bundle getMetadata(Context context) {
            try {
                ...
                if (packageManager == null) {
                    SystemUtils.log(5, ComponentDiscovery.TAG, "Context has no PackageManager.", (Throwable) null, "com.google.firebase.components.ComponentDiscovery$MetadataRegistrarNameRetriever", 177);
                    return null;
                }
                ...
                SystemUtils.log(5, ComponentDiscovery.TAG, this.discoveryService + " has no service info.", (Throwable) null, "com.google.firebase.components.ComponentDiscovery$MetadataRegistrarNameRetriever", 184);
                return null;
            } catch (PackageManager.NameNotFoundException unused) {
                SystemUtils.log(5, ComponentDiscovery.TAG, "Application info not found.", (Throwable) null, "com.google.firebase.components.ComponentDiscovery$MetadataRegistrarNameRetriever", 189);
                return null;
            }
        }
    }
