...
public class ConfigFetchHandler {
    ...
    public Task<FetchResponse> fetch(long j) {
        return this.fetchedConfigsCache.get().continueWithTask(this.executor, new Continuation(j) {
    ...
    public Task<FetchResponse> lambda$fetch$0$ConfigFetchHandler(Task<ConfigContainer> task, long j) {
        ...
        if (backoffEndTimeInMillis != null) {
            ...
            task2 = Tasks.whenAllComplete((Task<?>[]) new Task[]{id, token}).continueWithTask(this.executor, new Continuation(id, token, date) {
    ...
    public /* synthetic */ Task lambda$fetchIfCacheExpiredAndNotThrottled$1$ConfigFetchHandler(Task task, Task task2, Date date, Task task3) throws Exception {
    ...
    public /* synthetic */ Task lambda$fetchIfCacheExpiredAndNotThrottled$2$ConfigFetchHandler(Date date, Task task) throws Exception {
