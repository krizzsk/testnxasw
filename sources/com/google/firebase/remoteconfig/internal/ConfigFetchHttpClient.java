...
public class ConfigFetchHttpClient {
    ...
    private String getFingerprintHashForPackage() {
        try {
            ...
            SystemUtils.log(6, FirebaseRemoteConfig.TAG, "Could not get fingerprint hash for package: " + this.context.getPackageName(), (Throwable) null, "com.google.firebase.remoteconfig.internal.ConfigFetchHttpClient", 275);
            return null;
        } catch (PackageManager.NameNotFoundException e) {
            PackageManager.NameNotFoundException nameNotFoundException = e;
            SystemUtils.log(6, FirebaseRemoteConfig.TAG, "No such package: " + this.context.getPackageName(), nameNotFoundException, "com.google.firebase.remoteconfig.internal.ConfigFetchHttpClient", 281);
            return null;
        }
    }
    ...
    private JSONObject createFetchRequestBody(String str, String str2, Map<String, String> map) throws FirebaseRemoteConfigClientException {
        ...
        if (str != null) {
            ...
            try {
                PackageInfo packageInfo = SystemUtils.getPackageInfo(this.context.getPackageManager(), this.context.getPackageName(), 0);
                if (packageInfo != null) {
