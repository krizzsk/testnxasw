...
public class FirebaseApp {
    ...
    public static FirebaseApp initializeApp(Context context) {
        synchronized (LOCK) {
            ...
            if (fromResource == null) {
                SystemUtils.log(5, LOG_TAG, "Default FirebaseApp failed to initialize because no default options were found. This usually means that com.google.gms:google-services was not applied to your gradle project.", (Throwable) null, "com.google.firebase.FirebaseApp", 245);
                return null;
            }
    ...
    protected FirebaseApp(Context context, String str, FirebaseOptions firebaseOptions) {
        ...
        this.componentRuntime = ComponentRuntime.builder(UI_EXECUTOR).addLazyComponentRegistrars(ComponentDiscovery.forContext(context, ComponentDiscoveryService.class).discoverLazy()).addComponentRegistrar(new FirebaseCommonRegistrar()).addComponent(Component.m42711of(context, Context.class, new Class[0])).addComponent(Component.m42711of(this, FirebaseApp.class, new Class[0])).addComponent(Component.m42711of(firebaseOptions, FirebaseOptions.class, new Class[0])).build();
    ...
    public void notifyBackgroundStateChangeListeners(boolean z) {
        SystemUtils.log(3, LOG_TAG, "Notifying background state change listeners.", (Throwable) null, "com.google.firebase.FirebaseApp", 457);
    ...
    public void initializeAllApis() {
        if (!UserManagerCompat.isUserUnlocked(this.applicationContext)) {
            SystemUtils.log(4, LOG_TAG, "Device in Direct Boot Mode: postponing initialization of Firebase APIs for app " + getName(), (Throwable) null, "com.google.firebase.FirebaseApp", 576);
            UserUnlockReceiver.ensureReceiverRegistered(this.applicationContext);
            return;
        }
        SystemUtils.log(4, LOG_TAG, "Device unlocked: initializing all Firebase APIs for app " + getName(), (Throwable) null, "com.google.firebase.FirebaseApp", 583);
