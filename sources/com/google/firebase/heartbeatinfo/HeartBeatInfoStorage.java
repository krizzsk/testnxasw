...
class HeartBeatInfoStorage {
    ...
    private HeartBeatInfoStorage(Context context) {
        this.sharedPreferences = SystemUtils.getSharedPreferences(context, PREFERENCES_NAME, 0);
        this.heartBeatSharedPreferences = SystemUtils.getSharedPreferences(context, STORAGE_PREFERENCES_NAME, 0);
    }
