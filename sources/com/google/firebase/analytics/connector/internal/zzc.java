...
public final class zzc {
    ...
    private static final List zzd = Arrays.asList(new String[]{RavenEvent.DefaultEvent.REQUEST, "_dbg"});
    private static final List zze = Arrays.asList((String[]) ArrayUtils.concat(zzhh.zza, zzhh.zzb));
    ...
    public static Bundle zza(AnalyticsConnector.ConditionalUserProperty conditionalUserProperty) {
        ...
        if (conditionalUserProperty.value != null) {
            zzhe.zzb(bundle, conditionalUserProperty.value);
        }
    ...
    public static AnalyticsConnector.ConditionalUserProperty zzb(Bundle bundle) {
        ...
        conditionalUserProperty.origin = (String) Preconditions.checkNotNull((String) zzhe.zza(bundle, "origin", String.class, (Object) null));
        conditionalUserProperty.name = (String) Preconditions.checkNotNull((String) zzhe.zza(bundle, "name", String.class, (Object) null));
        conditionalUserProperty.value = zzhe.zza(bundle, "value", Object.class, (Object) null);
        conditionalUserProperty.triggerEventName = (String) zzhe.zza(bundle, AppMeasurementSdk.ConditionalUserProperty.TRIGGER_EVENT_NAME, String.class, (Object) null);
        conditionalUserProperty.triggerTimeout = ((Long) zzhe.zza(bundle, AppMeasurementSdk.ConditionalUserProperty.TRIGGER_TIMEOUT, Long.class, 0L)).longValue();
        conditionalUserProperty.timedOutEventName = (String) zzhe.zza(bundle, AppMeasurementSdk.ConditionalUserProperty.TIMED_OUT_EVENT_NAME, String.class, (Object) null);
        conditionalUserProperty.timedOutEventParams = (Bundle) zzhe.zza(bundle, AppMeasurementSdk.ConditionalUserProperty.TIMED_OUT_EVENT_PARAMS, Bundle.class, (Object) null);
        conditionalUserProperty.triggeredEventName = (String) zzhe.zza(bundle, AppMeasurementSdk.ConditionalUserProperty.TRIGGERED_EVENT_NAME, String.class, (Object) null);
        conditionalUserProperty.triggeredEventParams = (Bundle) zzhe.zza(bundle, AppMeasurementSdk.ConditionalUserProperty.TRIGGERED_EVENT_PARAMS, Bundle.class, (Object) null);
        conditionalUserProperty.timeToLive = ((Long) zzhe.zza(bundle, AppMeasurementSdk.ConditionalUserProperty.TIME_TO_LIVE, Long.class, 0L)).longValue();
        conditionalUserProperty.expiredEventName = (String) zzhe.zza(bundle, AppMeasurementSdk.ConditionalUserProperty.EXPIRED_EVENT_NAME, String.class, (Object) null);
        conditionalUserProperty.expiredEventParams = (Bundle) zzhe.zza(bundle, AppMeasurementSdk.ConditionalUserProperty.EXPIRED_EVENT_PARAMS, Bundle.class, (Object) null);
        conditionalUserProperty.active = ((Boolean) zzhe.zza(bundle, "active", Boolean.class, false)).booleanValue();
        conditionalUserProperty.creationTimestamp = ((Long) zzhe.zza(bundle, AppMeasurementSdk.ConditionalUserProperty.CREATION_TIMESTAMP, Long.class, 0L)).longValue();
        conditionalUserProperty.triggeredTimestamp = ((Long) zzhe.zza(bundle, AppMeasurementSdk.ConditionalUserProperty.TRIGGERED_TIMESTAMP, Long.class, 0L)).longValue();
    ...
    public static boolean zzi(AnalyticsConnector.ConditionalUserProperty conditionalUserProperty) {
        ...
        if ((conditionalUserProperty.value != null && zzit.zza(conditionalUserProperty.value) == null) || !zzl(str) || !zzm(str, conditionalUserProperty.name)) {
            return false;
        }
