...
class GmsRpc {
    ...
    private Bundle setDefaultAttributesToBundle(String str, String str2, String str3, Bundle bundle) {
        ...
        bundle.putString(Const.BillClickType.SENDER, str2);
        ...
        try {
            ...
            if (!TextUtils.isEmpty(token)) {
                ...
                SystemUtils.log(5, Constants.TAG, "FIS auth token is empty", (Throwable) null, "com.google.firebase.messaging.GmsRpc", 14);
            }
        } catch (InterruptedException | ExecutionException e) {
            SystemUtils.log(6, Constants.TAG, "Failed to get FIS auth token", e, "com.google.firebase.messaging.GmsRpc", 15);
        }
    ...
    private String handleResponse(Bundle bundle) throws IOException {
        if (bundle != null) {
            ...
            if ("RST".equals(string3)) {
                ...
                sb.append(valueOf);
                SystemUtils.log(5, Constants.TAG, sb.toString(), new Throwable(), "com.google.firebase.messaging.GmsRpc", 8);
