...
public class FirebaseMessagingService extends EnhancedIntentService {
    ...
    private boolean alreadyReceivedMessage(String str) {
        ...
        if (!recentlyReceivedMessageIds.contains(str)) {
            ...
            SystemUtils.log(3, Constants.TAG, valueOf.length() != 0 ? "Received duplicate message: ".concat(valueOf) : new String("Received duplicate message: "), (Throwable) null, "com.google.firebase.messaging.FirebaseMessagingService", 4);
            return true;
        }
    }
    ...
    private void passMessageIntentToSdk(android.content.Intent r8) {
        ...
        L_0x0059:
            ...
            java.lang.String r5 = "com.google.firebase.messaging.FirebaseMessagingService"
            com.didi.sdk.apm.SystemUtils.log(r1, r2, r3, r4, r5, r6)
            return
        L_0x0065:
            java.lang.String r0 = r7.getMessageId(r8)
        ...
        L_0x0082:
            ...
            return
        L_0x0086:
            com.google.firebase.messaging.MessagingAnalytics.logNotificationReceived(r8)
    ...
    public void handleIntent(Intent intent) {
        ...
        if ("com.google.android.c2dm.intent.RECEIVE".equals(action) || ACTION_DIRECT_BOOT_REMOTE_INTENT.equals(action)) {
            ...
            SystemUtils.log(3, Constants.TAG, valueOf.length() != 0 ? "Unknown intent action: ".concat(valueOf) : new String("Unknown intent action: "), (Throwable) null, "com.google.firebase.messaging.FirebaseMessagingService", 6);
        }
    }
