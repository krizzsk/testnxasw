...
public class FirebaseMessaging {
    ...
    private class AutoInit {
        ...
        private Boolean readEnabled() {
            ...
            try {
                ...
                if (packageManager == null || (applicationInfo = SystemUtils.getApplicationInfo(packageManager, applicationContext.getPackageName(), 128)) == null || applicationInfo.metaData == null || !applicationInfo.metaData.containsKey("firebase_messaging_auto_init_enabled")) {
                    return null;
                }
        ...
        public synchronized void setEnabled(boolean z) {
            ...
            SharedPreferences.Editor edit = SystemUtils.getSharedPreferences(FirebaseMessaging.this.firebaseApp.getApplicationContext(), "com.google.firebase.messaging", 0).edit();
    ...
    public void bridge$lambda$0$FirebaseMessaging(String str) {
        if (FirebaseApp.DEFAULT_APP_NAME.equals(this.firebaseApp.getName())) {
            if (Log.isLoggable(Constants.TAG, 3)) {
                ...
                SystemUtils.log(3, Constants.TAG, valueOf.length() != 0 ? "Invoking onNewToken for app: ".concat(valueOf) : new String("Invoking onNewToken for app: "), (Throwable) null, "com.google.firebase.messaging.FirebaseMessaging", 3);
            }
    ...
    public void send(RemoteMessage remoteMessage) {
        if (!TextUtils.isEmpty(remoteMessage.getTo())) {
            ...
            intent.putExtra("app", PendingIntent.getBroadcast(this.context, 0, intent2, Build.VERSION.SDK_INT >= 23 ? View.STATUS_BAR_TRANSIENT : 0));
    ...
    FirebaseMessaging(FirebaseApp firebaseApp2, FirebaseInstanceIdInternal firebaseInstanceIdInternal, FirebaseInstallationsApi firebaseInstallationsApi, TransportFactory transportFactory2, Subscriber subscriber, Metadata metadata2, GmsRpc gmsRpc2, Executor executor, Executor executor2) {
        ...
        if (applicationContext instanceof Application) {
            ...
            SystemUtils.log(5, Constants.TAG, sb.toString(), (Throwable) null, "com.google.firebase.messaging.FirebaseMessaging", 14);
        }
        if (firebaseInstanceIdInternal != null) {
