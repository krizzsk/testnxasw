...
final class TopicOperation {
    ...
    private static String normalizeTopicOrThrow(String str, String str2) {
        if (str != null && str.startsWith("/topics/")) {
            SystemUtils.log(5, Constants.TAG, String.format("Format /topics/topic-name is deprecated. Only 'topic-name' should be used in %s.", new Object[]{str2}), (Throwable) null, "com.google.firebase.messaging.TopicOperation", 3);
            str = str.substring(8);
        }
