...
public final class RemoteMessage extends AbstractSafeParcelable {
    ...
    public static class Builder {
        ...
        public Builder(String str) {
            if (TextUtils.isEmpty(str)) {
                ...
                this.bundle.putString(Constants.MessagePayloadKeys.f56625TO, str);
            }
        }
    ...
    public long getSentTime() {
        ...
        try {
            ...
            sb.append(valueOf);
            SystemUtils.log(5, Constants.TAG, sb.toString(), (Throwable) null, "com.google.firebase.messaging.RemoteMessage", 6);
            return 0;
        }
    }

    public String getTo() {
        return this.bundle.getString(Constants.MessagePayloadKeys.f56625TO);
    }
