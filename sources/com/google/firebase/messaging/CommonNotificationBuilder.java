...
public final class CommonNotificationBuilder {
    ...
    private static PendingIntent createContentIntent(Context context, NotificationParams notificationParams, String str, PackageManager packageManager) {
        ...
        createTargetIntent.addFlags(View.STATUS_BAR_TRANSIENT);
    ...
    private static Intent createTargetIntent(String str, NotificationParams notificationParams, PackageManager packageManager) {
        ...
        if (launchIntentForPackage == null) {
            SystemUtils.log(5, Constants.TAG, "No activity found to launch app", (Throwable) null, "com.google.firebase.messaging.CommonNotificationBuilder", 11);
        }
    ...
    private static Integer getColor(Context context, String str, Bundle bundle) {
        ...
        if (!TextUtils.isEmpty(str)) {
            try {
                ...
                SystemUtils.log(5, Constants.TAG, sb.toString(), (Throwable) null, "com.google.firebase.messaging.CommonNotificationBuilder", 3);
            }
        }
        ...
        if (i != 0) {
            try {
                ...
                SystemUtils.log(5, Constants.TAG, "Cannot find the color resource referenced in AndroidManifest.", (Throwable) null, "com.google.firebase.messaging.CommonNotificationBuilder", 6);
            }
        }
        return null;
    }
    ...
    private static Bundle getManifestMetadata(PackageManager packageManager, String str) {
        try {
            ApplicationInfo applicationInfo = SystemUtils.getApplicationInfo(packageManager, str, 128);
            ...
            sb.append(valueOf);
            SystemUtils.log(5, Constants.TAG, sb.toString(), (Throwable) null, "com.google.firebase.messaging.CommonNotificationBuilder", 4);
        }
        return Bundle.EMPTY;
    }
    ...
    public static String getOrCreateChannel(Context context, String str, Bundle bundle) {
        ...
        try {
            if (SystemUtils.getApplicationInfo(context.getPackageManager(), context.getPackageName(), 0).targetSdkVersion >= 26) {
                ...
                if (!TextUtils.isEmpty(str)) {
                    ...
                    SystemUtils.log(5, Constants.TAG, sb.toString(), (Throwable) null, "com.google.firebase.messaging.CommonNotificationBuilder", 6);
                }
                String string = bundle.getString(METADATA_DEFAULT_CHANNEL_ID);
                if (TextUtils.isEmpty(string)) {
                    SystemUtils.log(5, Constants.TAG, "Missing Default Notification Channel metadata in AndroidManifest. Default value will be used.", (Throwable) null, "com.google.firebase.messaging.CommonNotificationBuilder", 11);
                } else if (notificationManager.getNotificationChannel(string) != null) {
                    return string;
                } else {
                    SystemUtils.log(5, Constants.TAG, "Notification Channel set in AndroidManifest.xml has not been created by the app. Default value will be used.", (Throwable) null, "com.google.firebase.messaging.CommonNotificationBuilder", 10);
                }
                if (notificationManager.getNotificationChannel(FCM_FALLBACK_NOTIFICATION_CHANNEL) == null) {
                    ...
                    if (identifier == 0) {
                        SystemUtils.log(6, Constants.TAG, "String resource \"fcm_fallback_notification_channel_label\" is not found. Using default string channel name.", (Throwable) null, "com.google.firebase.messaging.CommonNotificationBuilder", 16);
                        str2 = "Misc";
                    } else {
    ...
    private static int getSmallIcon(PackageManager packageManager, Resources resources, String str, String str2, Bundle bundle) {
        if (!TextUtils.isEmpty(str2)) {
            int identifier = resources.getIdentifier(str2, RConfigConstants.TYPE_DRAWABLE, str);
        ...
        if (i == 0 || !isValidIcon(resources, i)) {
            try {
                i = SystemUtils.getApplicationInfo(packageManager, str, 0).icon;
            } catch (PackageManager.NameNotFoundException e) {
                String valueOf = String.valueOf(e);
                StringBuilder sb2 = new StringBuilder(String.valueOf(valueOf).length() + 35);
                sb2.append("Couldn't get own application info: ");
                sb2.append(valueOf);
                SystemUtils.log(5, Constants.TAG, sb2.toString(), (Throwable) null, "com.google.firebase.messaging.CommonNotificationBuilder", 10);
            }
        }
        if (i == 0 || !isValidIcon(resources, i)) {
            return 17301651;
    ...
    private static boolean isValidIcon(Resources resources, int i) {
        ...
        try {
            ...
            sb.append(i);
            SystemUtils.log(6, Constants.TAG, sb.toString(), (Throwable) null, "com.google.firebase.messaging.CommonNotificationBuilder", 3);
            return false;
            ...
            SystemUtils.log(6, Constants.TAG, sb2.toString(), (Throwable) null, "com.google.firebase.messaging.CommonNotificationBuilder", 4);
            return false;
        }
    }
