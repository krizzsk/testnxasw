    ...
    TextureViewPreview(Context context, ViewGroup viewGroup) {
        ...
        textureView.setSurfaceTextureListener(new TextureView.SurfaceTextureListener() {
            public void onSurfaceTextureAvailable(SurfaceTexture surfaceTexture, int i, int i2) {
                SystemUtils.log(6, "panlei", "textureview available", (Throwable) null, "com.google.android.cameraview.TextureViewPreview$1", 43);
            ...
            public void onSurfaceTextureSizeChanged(SurfaceTexture surfaceTexture, int i, int i2) {
                SystemUtils.log(6, "panlei", "textureview sizechange", (Throwable) null, "com.google.android.cameraview.TextureViewPreview$1", 51);
                TextureViewPreview.this.setSize(i, i2);
                TextureViewPreview.this.configureTransform();
                TextureViewPreview.this.dispatchSurfaceChanged();
            }
            ...
            public boolean onSurfaceTextureDestroyed(SurfaceTexture surfaceTexture) {
                SystemUtils.log(6, "panlei", "textureview destroy", (Throwable) null, "com.google.android.cameraview.TextureViewPreview$1", 59);
                TextureViewPreview.this.setSize(0, 0);
                return true;
            }

            public void onSurfaceTextureUpdated(SurfaceTexture surfaceTexture) {
                SystemUtils.log(6, "panlei", "textureview update", (Throwable) null, "com.google.android.cameraview.TextureViewPreview$1", 66);
            }
        });
    }
