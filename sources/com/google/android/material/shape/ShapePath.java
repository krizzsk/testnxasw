...
public class ShapePath {
    ...
    public void lineTo(float f, float f2) {
        ...
        float unused = pathLineOperation.f55541x = f;
        float unused2 = pathLineOperation.f55542y = f2;
    ...
    static class LineShadowOperation extends ShadowCompatOperation {
        ...
        public void draw(Matrix matrix, ShadowRenderer shadowRenderer, int i, Canvas canvas) {
            RectF rectF = new RectF(0.0f, 0.0f, (float) Math.hypot((double) (this.operation.f55542y - this.startY), (double) (this.operation.f55541x - this.startX)), 0.0f);
        ...
        public float getAngle() {
            return (float) Math.toDegrees(Math.atan((double) ((this.operation.f55542y - this.startY) / (this.operation.f55541x - this.startX))));
        }
    }
    ...
    public static class PathLineOperation extends PathOperation {
        ...
        /* renamed from: x */
        public float f55541x;
        /* access modifiers changed from: private */

        /* renamed from: y */
        public float f55542y;

        public void applyToPath(Matrix matrix, Path path) {
            Matrix matrix2 = this.matrix;
            matrix.invert(matrix2);
            path.transform(matrix2);
            path.lineTo(this.f55541x, this.f55542y);
