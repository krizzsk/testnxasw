...
public final class LinearProgressIndicatorSpec extends BaseProgressIndicatorSpec {
    ...
    public LinearProgressIndicatorSpec(Context context, AttributeSet attributeSet, int i, int i2) {
        ...
        boolean z = false;
        TypedArray obtainStyledAttributes = ThemeEnforcement.obtainStyledAttributes(context, attributeSet, C11267R.styleable.LinearProgressIndicator, R.attr.linearProgressIndicatorStyle, LinearProgressIndicator.Widget_MaterialComponents_LinearProgressIndicator, new int[0]);
