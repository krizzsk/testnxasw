...
public class SwitchMaterial extends SwitchCompat {
    private static final int DEF_STYLE_RES = 2132018258;
    ...
    public SwitchMaterial(Context context, AttributeSet attributeSet, int i) {
        ...
        TypedArray obtainStyledAttributes = ThemeEnforcement.obtainStyledAttributes(context2, attributeSet, C11267R.styleable.SwitchMaterial, i, DEF_STYLE_RES, new int[0]);
