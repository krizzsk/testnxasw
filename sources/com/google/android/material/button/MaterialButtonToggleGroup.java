...
public class MaterialButtonToggleGroup extends LinearLayout {
    private static final int DEF_STYLE_RES = 2132018264;
    ...
    public MaterialButtonToggleGroup(Context context, AttributeSet attributeSet, int i) {
        ...
        TypedArray obtainStyledAttributes = ThemeEnforcement.obtainStyledAttributes(getContext(), attributeSet, C11267R.styleable.MaterialButtonToggleGroup, i, DEF_STYLE_RES, new int[0]);
    ...
    public void addView(View view, int i, ViewGroup.LayoutParams layoutParams) {
        if (!(view instanceof MaterialButton)) {
            SystemUtils.log(6, LOG_TAG, "Child views must be of type MaterialButton.", (Throwable) null, "com.google.android.material.button.MaterialButtonToggleGroup", 227);
            return;
        }
    ...
    public int getChildDrawingOrder(int i, int i2) {
        ...
        SystemUtils.log(5, LOG_TAG, "Child order wasn't updated", (Throwable) null, "com.google.android.material.button.MaterialButtonToggleGroup", 778);
        return i2;
    }
