...
abstract class BaseMotionStrategy implements MotionStrategy {
    ...
    public AnimatorSet createAnimator(MotionSpec motionSpec2) {
        ...
        if (motionSpec2.hasPropertyValues(NNGestureClassfy.SCALE_LABLE)) {
            arrayList.add(motionSpec2.getAnimator(NNGestureClassfy.SCALE_LABLE, this.fab, View.SCALE_Y));
            arrayList.add(motionSpec2.getAnimator(NNGestureClassfy.SCALE_LABLE, this.fab, View.SCALE_X));
        }
        ...
        if (motionSpec2.hasPropertyValues(Const.YogaConst.PADDING_START)) {
            arrayList.add(motionSpec2.getAnimator(Const.YogaConst.PADDING_START, this.fab, ExtendedFloatingActionButton.PADDING_START));
        }
        if (motionSpec2.hasPropertyValues(Const.YogaConst.PADDING_END)) {
            arrayList.add(motionSpec2.getAnimator(Const.YogaConst.PADDING_END, this.fab, ExtendedFloatingActionButton.PADDING_END));
        }
