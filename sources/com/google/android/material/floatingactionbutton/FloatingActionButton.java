...
public class FloatingActionButton extends VisibilityAwareImageButton implements CoordinatorLayout.AttachedBehavior, TintableBackgroundView, TintableImageSourceView, ExpandableTransformationWidget, Shapeable {
    ...
    public FloatingActionButton(Context context, AttributeSet attributeSet, int i) {
        ...
        TypedArray obtainStyledAttributes = ThemeEnforcement.obtainStyledAttributes(context2, attributeSet, C11267R.styleable.FloatingActionButton, i, DEF_STYLE_RES, new int[0]);
    ...
    public void setBackgroundDrawable(Drawable drawable) {
        SystemUtils.log(4, LOG_TAG, "Setting a custom background is not supported.", (Throwable) null, "com.google.android.material.floatingactionbutton.FloatingActionButton", 497);
    }

    public void setBackgroundResource(int i) {
        SystemUtils.log(4, LOG_TAG, "Setting a custom background is not supported.", (Throwable) null, "com.google.android.material.floatingactionbutton.FloatingActionButton", 502);
    }

    public void setBackgroundColor(int i) {
        SystemUtils.log(4, LOG_TAG, "Setting a custom background is not supported.", (Throwable) null, "com.google.android.material.floatingactionbutton.FloatingActionButton", 507);
    }
    ...
    protected static class BaseBehavior<T extends FloatingActionButton> extends CoordinatorLayout.Behavior<T> {
        ...
        public BaseBehavior(Context context, AttributeSet attributeSet) {
            super(context, attributeSet);
            TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C11267R.styleable.FloatingActionButton_Behavior_Layout);
