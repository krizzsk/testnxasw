...
public final class CollapsingTextHelper {
    ...
    private StaticLayout createStaticLayout(int i, float f, boolean z) {
        ...
        try {
            ...
            StaticLayoutBuilderCompat.StaticLayoutBuilderCompatException staticLayoutBuilderCompatException = e;
            SystemUtils.log(6, TAG, staticLayoutBuilderCompatException.getCause().getMessage(), staticLayoutBuilderCompatException, "com.google.android.material.internal.CollapsingTextHelper", 981);
            staticLayout = null;
        }
