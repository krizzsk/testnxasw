...
public class TextAppearance {
    ...
    public TextAppearance(Context context, int i) {
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(i, C11267R.styleable.TextAppearance);
        ...
        if (Build.VERSION.SDK_INT >= 21) {
            TypedArray obtainStyledAttributes2 = context.obtainStyledAttributes(i, C11267R.styleable.MaterialTextAppearance);
    ...
    public Typeface getFont(Context context) {
        ...
        if (!context.isRestricted()) {
            try {
                ...
                Exception exc = e;
                SystemUtils.log(3, TAG, "Error loading font " + this.fontFamily, exc, "com.google.android.material.resources.TextAppearance", 145);
            }
        }
        createFallbackFont();
    ...
    public void getFontAsync(Context context, final TextAppearanceFontCallback textAppearanceFontCallback) {
        ...
        try {
            ...
            Exception exc = e;
            SystemUtils.log(3, TAG, "Error loading font " + this.fontFamily, exc, "com.google.android.material.resources.TextAppearance", 213);
            this.fontResolved = true;
