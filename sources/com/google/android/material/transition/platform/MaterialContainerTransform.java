...
public final class MaterialContainerTransform extends Transition {
    ...
    public Animator createAnimator(ViewGroup viewGroup, TransitionValues transitionValues, TransitionValues transitionValues2) {
        ...
        if (!(transitionValues3 == null || transitionValues4 == null)) {
            ...
            if (rectF == null || shapeAppearanceModel == null) {
                SystemUtils.log(5, TAG, "Skipping due to null start bounds. Ensure start view is laid out and measured.", (Throwable) null, "com.google.android.material.transition.platform.MaterialContainerTransform", 901);
            } else {
                ...
                if (rectF2 == null || shapeAppearanceModel2 == null) {
                    SystemUtils.log(5, TAG, "Skipping due to null end bounds. Ensure end view is laid out and measured.", (Throwable) null, "com.google.android.material.transition.platform.MaterialContainerTransform", 909);
                    return null;
                }
    ...
    private static final class TransitionDrawable extends Drawable {
        ...
        private void updateProgress(float f) {
            ...
            this.currentStartBounds.set(f7 - (evaluate.currentStartWidth / 2.0f), f6, (this.fitModeResult.currentStartWidth / 2.0f) + f7, this.fitModeResult.currentStartHeight + f6);
