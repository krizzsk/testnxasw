...
public class MaterialToolbar extends Toolbar {
    private static final int DEF_STYLE_RES = 2132018326;
    ...
    public MaterialToolbar(Context context, AttributeSet attributeSet, int i) {
        ...
        TypedArray obtainStyledAttributes = ThemeEnforcement.obtainStyledAttributes(context2, attributeSet, C11267R.styleable.MaterialToolbar, i, DEF_STYLE_RES, new int[0]);
