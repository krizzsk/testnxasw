...
public class AppBarLayout extends LinearLayout implements CoordinatorLayout.AttachedBehavior {
    ...
    public AppBarLayout(Context context, AttributeSet attributeSet, int i) {
        ...
        TypedArray obtainStyledAttributes = ThemeEnforcement.obtainStyledAttributes(context2, attributeSet, C11267R.styleable.AppBarLayout, i, DEF_STYLE_RES, new int[0]);
    ...
    public int[] onCreateDrawableState(int i) {
        ...
        iArr[0] = this.liftable ? R.attr.state_liftable : -2130970942;
        iArr[1] = (!this.liftable || !this.lifted) ? -2130970943 : R.attr.state_lifted;
        iArr[2] = this.liftable ? R.attr.state_collapsible : -2130970940;
        iArr[3] = (!this.liftable || !this.lifted) ? -2130970939 : R.attr.state_collapsed;
    ...
    public static class LayoutParams extends LinearLayout.LayoutParams {
        ...
        public LayoutParams(Context context, AttributeSet attributeSet) {
            ...
            TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C11267R.styleable.AppBarLayout_Layout);
    ...
    public static class ScrollingViewBehavior extends HeaderScrollingViewBehavior {
        ...
        public ScrollingViewBehavior(Context context, AttributeSet attributeSet) {
            super(context, attributeSet);
            TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C11267R.styleable.ScrollingViewBehavior_Layout);
