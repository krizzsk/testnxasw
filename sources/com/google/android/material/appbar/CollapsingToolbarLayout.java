...
public class CollapsingToolbarLayout extends FrameLayout {
    ...
    private static final int DEF_STYLE_RES = 2132018204;
    ...
    public CollapsingToolbarLayout(Context context, AttributeSet attributeSet, int i) {
        ...
        TypedArray obtainStyledAttributes = ThemeEnforcement.obtainStyledAttributes(context2, attributeSet, C11267R.styleable.CollapsingToolbarLayout, i, DEF_STYLE_RES, new int[0]);
        ...
        this.collapsingTextHelper.setExpandedTextAppearance(2132017890);
        this.collapsingTextHelper.setCollapsedTextAppearance(2132017864);
        ...
        if (obtainStyledAttributes.hasValue(12)) {
            this.collapsingTextHelper.setMaxLines(obtainStyledAttributes.getInt(12, 1));
        }
