...
public class TabLayout extends HorizontalScrollView {
    ...
    private static final int DEF_STYLE_RES = 2132018209;
    ...
    public TabLayout(Context context, AttributeSet attributeSet, int i) {
        ...
        TypedArray obtainStyledAttributes = ThemeEnforcement.obtainStyledAttributes(context2, attributeSet, C11267R.styleable.TabLayout, i, DEF_STYLE_RES, 23);
        ...
        int resourceId = obtainStyledAttributes.getResourceId(23, 2132017900);
        this.tabTextAppearance = resourceId;
        TypedArray obtainStyledAttributes2 = context2.obtainStyledAttributes(resourceId, C11267R.styleable.TextAppearance);
        try {
            ...
            this.tabIconTintMode = ViewUtils.parseTintMode(obtainStyledAttributes.getInt(4, -1), (PorterDuff.Mode) null);
    ...
    public Tab newTab() {
        ...
        if (createTabFromPool.f55543id != -1) {
            createTabFromPool.view.setId(createTabFromPool.f55543id);
        }
    ...
    private void applyModeAndGravity() {
        ...
        if (i3 == 0) {
            ...
            if (this.tabGravity == 2) {
                SystemUtils.log(5, LOG_TAG, "GRAVITY_START is not supported with the current tab mode, GRAVITY_CENTER will be used instead", (Throwable) null, "com.google.android.material.tabs.TabLayout", 1906);
            }
    ...
    private void applyGravityForModeScrollable(int i) {
        if (i == 0) {
            SystemUtils.log(5, LOG_TAG, "MODE_SCROLLABLE + GRAVITY_FILL is not supported, GRAVITY_START will be used instead", (Throwable) null, "com.google.android.material.tabs.TabLayout", 1927);
        } else if (i == 1) {
            this.slidingTabIndicator.setGravity(1);
            return;
        } else if (i != 2) {
    ...
    class SlidingTabIndicator extends LinearLayout {
        ...
        private void updateOrRecreateIndicatorAnimation(boolean z, final int i, int i2) {
            ...
            C197581 r2 = new ValueAnimator.AnimatorUpdateListener() {
                public void onAnimationUpdate(ValueAnimator valueAnimator) {
