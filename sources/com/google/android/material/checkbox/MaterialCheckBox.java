...
public class MaterialCheckBox extends AppCompatCheckBox {
    private static final int DEF_STYLE_RES = 2132018256;
    ...
    public MaterialCheckBox(Context context, AttributeSet attributeSet, int i) {
        ...
        TypedArray obtainStyledAttributes = ThemeEnforcement.obtainStyledAttributes(context2, attributeSet, C11267R.styleable.MaterialCheckBox, i, DEF_STYLE_RES, new int[0]);
