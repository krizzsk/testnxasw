...
public class Chip extends AppCompatCheckBox implements ChipDrawable.Delegate, Shapeable {
    ...
    private static final int DEF_STYLE_RES = 2132018246;
    ...
    public Chip(Context context, AttributeSet attributeSet, int i) {
        ...
        TypedArray obtainStyledAttributes = ThemeEnforcement.obtainStyledAttributes(context2, attributeSet, C11267R.styleable.Chip, i, DEF_STYLE_RES, new int[0]);
    ...
    private void initMinTouchTarget(Context context, AttributeSet attributeSet, int i) {
        TypedArray obtainStyledAttributes = ThemeEnforcement.obtainStyledAttributes(context, attributeSet, C11267R.styleable.Chip, i, DEF_STYLE_RES, new int[0]);
    ...
    private void validateAttributes(AttributeSet attributeSet) {
        if (attributeSet != null) {
            if (attributeSet.getAttributeValue(NAMESPACE_ANDROID, Constants.BACKGROUND) != null) {
                SystemUtils.log(5, TAG, "Do not set the background; Chip manages its own background drawable.", (Throwable) null, "com.google.android.material.chip.Chip", 375);
            }
            if (attributeSet.getAttributeValue(NAMESPACE_ANDROID, "drawableLeft") != null) {
                ...
                SystemUtils.log(5, TAG, "Chip text must be vertically center and start aligned", (Throwable) null, "com.google.android.material.chip.Chip", 399);
            }
        }
    }
    ...
    public void setGravity(int i) {
        if (i != 8388627) {
            SystemUtils.log(5, TAG, "Chip text must be vertically center and start aligned", (Throwable) null, "com.google.android.material.chip.Chip", 503);
        } else {
            super.setGravity(i);
        }
    }
    ...
    public void setBackgroundTintList(ColorStateList colorStateList) {
        SystemUtils.log(5, TAG, "Do not set the background tint list; Chip manages its own background drawable.", (Throwable) null, "com.google.android.material.chip.Chip", 510);
    }

    public void setBackgroundTintMode(PorterDuff.Mode mode) {
        SystemUtils.log(5, TAG, "Do not set the background tint mode; Chip manages its own background drawable.", (Throwable) null, "com.google.android.material.chip.Chip", 515);
    }

    public void setBackgroundColor(int i) {
        SystemUtils.log(5, TAG, "Do not set the background color; Chip manages its own background drawable.", (Throwable) null, "com.google.android.material.chip.Chip", 520);
    }

    public void setBackgroundResource(int i) {
        SystemUtils.log(5, TAG, "Do not set the background resource; Chip manages its own background drawable.", (Throwable) null, "com.google.android.material.chip.Chip", 525);
    }
    ...
    public void setBackground(Drawable drawable) {
        if (drawable == getBackgroundDrawable() || drawable == this.ripple) {
            ...
            SystemUtils.log(5, TAG, "Do not set the background; Chip manages its own background drawable.", (Throwable) null, "com.google.android.material.chip.Chip", 531);
        }
    }
    ...
    public void setBackgroundDrawable(Drawable drawable) {
        if (drawable == getBackgroundDrawable() || drawable == this.ripple) {
            ...
            SystemUtils.log(5, TAG, "Do not set the background drawable; Chip manages its own background drawable.", (Throwable) null, "com.google.android.material.chip.Chip", 540);
        }
    }
    ...
    private boolean handleAccessibilityExit(MotionEvent motionEvent) {
        if (motionEvent.getAction() == 10) {
            try {
                ...
                SystemUtils.log(6, TAG, "Unable to send Accessibility Exit event", e, "com.google.android.material.chip.Chip", 834);
            } catch (IllegalAccessException e2) {
                SystemUtils.log(6, TAG, "Unable to send Accessibility Exit event", e2, "com.google.android.material.chip.Chip", 837);
            } catch (InvocationTargetException e3) {
                SystemUtils.log(6, TAG, "Unable to send Accessibility Exit event", e3, "com.google.android.material.chip.Chip", 840);
            } catch (NoSuchFieldException e4) {
                SystemUtils.log(6, TAG, "Unable to send Accessibility Exit event", e4, "com.google.android.material.chip.Chip", 843);
            }
        }
        return false;
    }
