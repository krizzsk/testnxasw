...
public class ChipGroup extends FlowLayout {
    private static final int DEF_STYLE_RES = 2132018250;
    ...
    public ChipGroup(Context context, AttributeSet attributeSet, int i) {
        ...
        TypedArray obtainStyledAttributes = ThemeEnforcement.obtainStyledAttributes(getContext(), attributeSet, C11267R.styleable.ChipGroup, i, DEF_STYLE_RES, new int[0]);
