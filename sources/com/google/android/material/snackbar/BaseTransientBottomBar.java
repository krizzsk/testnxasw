...
public abstract class BaseTransientBottomBar<B extends BaseTransientBottomBar<B>> {
            ...
            public void run() {
                ...
                if (BaseTransientBottomBar.this.view != null && BaseTransientBottomBar.this.context != null && (access$500 = (BaseTransientBottomBar.this.getScreenHeight() - BaseTransientBottomBar.this.getViewAbsoluteBottom()) + ((int) BaseTransientBottomBar.this.view.getTranslationY())) < BaseTransientBottomBar.this.extraBottomMarginGestureInset) {
                    ...
                    if (!(layoutParams instanceof ViewGroup.MarginLayoutParams)) {
                        SystemUtils.log(5, BaseTransientBottomBar.TAG, "Unable to apply gesture inset because layout params are not MarginLayoutParams", (Throwable) null, "com.google.android.material.snackbar.BaseTransientBottomBar$3", 298);
                        return;
                    }
    ...
    public void updateMargins() {
        ...
        if (!(layoutParams instanceof ViewGroup.MarginLayoutParams) || this.originalMargins == null) {
            SystemUtils.log(5, TAG, "Unable to update margins because layout params are not MarginLayoutParams", (Throwable) null, "com.google.android.material.snackbar.BaseTransientBottomBar", 449);
            return;
        }
        ViewGroup.MarginLayoutParams marginLayoutParams = (ViewGroup.MarginLayoutParams) layoutParams;
    ...
    protected static class SnackbarBaseLayout extends FrameLayout {
        ...
        protected SnackbarBaseLayout(Context context, AttributeSet attributeSet) {
            ...
            TypedArray obtainStyledAttributes = context2.obtainStyledAttributes(attributeSet, C11267R.styleable.SnackbarLayout);
