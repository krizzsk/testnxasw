...
public class MaterialCardView extends CardView implements Checkable, Shapeable {
    ...
    private static final int DEF_STYLE_RES = 2132018244;
    ...
    public MaterialCardView(Context context, AttributeSet attributeSet, int i) {
        ...
        TypedArray obtainStyledAttributes = ThemeEnforcement.obtainStyledAttributes(getContext(), attributeSet, C11267R.styleable.MaterialCardView, i, DEF_STYLE_RES, new int[0]);
    ...
    public void setBackgroundDrawable(Drawable drawable) {
        if (this.isParentCardViewDoneInitializing) {
            if (!this.cardViewHelper.isBackgroundOverwritten()) {
                SystemUtils.log(4, LOG_TAG, "Setting a custom background is not supported.", (Throwable) null, "com.google.android.material.card.MaterialCardView", 363);
