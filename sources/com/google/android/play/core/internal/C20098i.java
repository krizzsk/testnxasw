...
public final class C20098i {
    /* renamed from: a */
    private static int m42296a(int i) {
        if (i == 513) {
            return 1;
        }
        if (i == 514) {
    ...
    /* renamed from: a */
    public static long m42297a(ByteBuffer byteBuffer) {
        m42314c(byteBuffer);
        return m42298a(byteBuffer, byteBuffer.position() + 16);
    }

    /* renamed from: a */
    private static long m42298a(ByteBuffer byteBuffer, int i) {
        return ((long) byteBuffer.getInt(i)) & InternalZipConstants.ZIP_64_SIZE_LIMIT;
    }

    /* renamed from: a */
    static Pair<ByteBuffer, Long> m42299a(RandomAccessFile randomAccessFile) throws IOException {
        if (randomAccessFile.length() < 22) {
            return null;
        }
        Pair<ByteBuffer, Long> a = m42300a(randomAccessFile, 0);
        return a != null ? a : m42300a(randomAccessFile, 65535);
    }

    /* renamed from: a */
    private static Pair<ByteBuffer, Long> m42300a(RandomAccessFile randomAccessFile, int i) throws IOException {
        int i2;
    ...
    /* renamed from: a */
    public static String m42301a(String str, String str2) {
    ...
    /* renamed from: a */
    public static String m42302a(String str, String str2, String str3) {
    ...
    /* renamed from: a */
    private static void m42303a(int i, byte[] bArr) {
        bArr[1] = (byte) (i & 255);
        bArr[2] = (byte) ((i >>> 8) & 255);
    ...
    /* renamed from: a */
    public static void m42304a(ByteBuffer byteBuffer, long j) {
        m42314c(byteBuffer);
        int position = byteBuffer.position() + 16;
        if (j < 0 || j > InternalZipConstants.ZIP_64_SIZE_LIMIT) {
    ...
    /* renamed from: a */
    private static void m42305a(Map<Integer, byte[]> map, FileChannel fileChannel, long j, long j2, long j3, ByteBuffer byteBuffer) throws SecurityException {
        if (!map.isEmpty()) {
            C20093d dVar = new C20093d(fileChannel, 0, j);
            C20093d dVar2 = new C20093d(fileChannel, j2, j3 - j2);
            ByteBuffer duplicate = byteBuffer.duplicate();
            duplicate.order(ByteOrder.LITTLE_ENDIAN);
            long j4 = j;
            m42304a(duplicate, j);
            C20050b bVar = new C20050b(duplicate);
            int size = map.size();
            ...
            try {
                byte[][] a = m42307a(iArr, new C20077c[]{dVar, dVar2, bVar});
                while (i < size) {
                    int i3 = iArr[i];
                    ...
                    if (MessageDigest.isEqual(map.get(Integer.valueOf(i3)), a[i])) {
                        ...
                        throw new SecurityException(m42311b(i3).concat(" digest of contents did not verify"));
                    }
                }
    ...
    private static java.security.cert.X509Certificate[] m42306a(java.nio.ByteBuffer r22, java.util.Map<java.lang.Integer, byte[]> r23, java.security.cert.CertificateFactory r24) throws java.lang.SecurityException, java.io.IOException {
        /*
            java.nio.ByteBuffer r0 = m42315d(r22)
            java.nio.ByteBuffer r1 = m42315d(r22)
            byte[] r2 = m42316e(r22)
        ...
        L_0x0016:
            ...
            int r8 = r8 + 1
            java.nio.ByteBuffer r10 = m42315d(r1)     // Catch:{ IOException -> 0x0066, BufferUnderflowException -> 0x0064 }
        ...
        L_0x0046:
            ...
            int r11 = m42296a((int) r5)     // Catch:{ IOException -> 0x0066, BufferUnderflowException -> 0x0064 }
            int r12 = m42296a((int) r7)     // Catch:{ IOException -> 0x0066, BufferUnderflowException -> 0x0064 }
            if (r11 == r15) goto L_0x0016
            if (r12 == r15) goto L_0x0055
            goto L_0x0016
        L_0x0055:
            byte[] r7 = m42316e(r10)     // Catch:{ IOException -> 0x0066, BufferUnderflowException -> 0x0064 }
            r9 = r7
            r7 = r5
            goto L_0x0016
        L_0x005c:
        ...
        L_0x014e:
            ...
            r0.clear()
            java.nio.ByteBuffer r1 = m42315d(r0)
        ...
        L_0x0164:
            ...
            int r5 = r5 + r15
            java.nio.ByteBuffer r8 = m42315d(r1)     // Catch:{ IOException -> 0x0191, BufferUnderflowException -> 0x018f }
            ...
            byte[] r6 = m42316e(r8)     // Catch:{ IOException -> 0x0191, BufferUnderflowException -> 0x018f }
            goto L_0x0164
        L_0x0187:
        ...
        L_0x0278:
            ...
            throw r1
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.play.core.internal.C20098i.m42306a(java.nio.ByteBuffer, java.util.Map, java.security.cert.CertificateFactory):java.security.cert.X509Certificate[]");
    }

    /* renamed from: a */
    private static byte[][] m42307a(int[] iArr, C20077c[] cVarArr) throws DigestException {
        long j;
        int i;
        int length;
        int[] iArr2 = iArr;
        ...
        while (true) {
            ...
            j3 += (cVarArr[i2].mo164290a() + 1048575) / 1048576;
            i2++;
        }
        if (j3 < 2097151) {
            int i3 = (int) j3;
            ...
            while (true) {
                ...
                byte[] bArr2 = new byte[((m42313c(iArr2[i4]) * i3) + 5)];
                bArr2[0] = 90;
                m42303a(i3, bArr2);
                bArr[i4] = bArr2;
                i4++;
            ...
            int i8 = 0;
            for (i = 3; i6 < i; i = 3) {
                C20077c cVar = cVarArr[i6];
                long j4 = j2;
                int i9 = i6;
                long a = cVar.mo164290a();
                while (a > j2) {
                    ...
                    long j5 = j4;
                    try {
                        cVar.mo164291a(messageDigestArr, j5, min);
                        int i11 = 0;
    ...
    /* renamed from: a */
    public static X509Certificate[][] m42308a(String str) throws C20095f, SecurityException, IOException {
        ByteBuffer byteBuffer;
        int limit;
        int position;
        RandomAccessFile randomAccessFile = new RandomAccessFile(str, "r");
        try {
            Pair<ByteBuffer, Long> a = m42299a(randomAccessFile);
            if (a != null) {
                ...
                if (j >= 0) {
                    ...
                    if (randomAccessFile.readInt() == 1347094023) {
                        throw new C20095f("ZIP64 APK not supported");
                    }
                }
                long a2 = m42297a(byteBuffer2);
                if (a2 >= longValue) {
                    ...
                    sb.append(longValue);
                    throw new C20095f(sb.toString());
                } else if (m42310b(byteBuffer2) + a2 != longValue) {
                    throw new C20095f("ZIP Central Directory is not immediately followed by End of Central Directory");
                } else if (a2 >= 32) {
                    ...
                    if (allocate.getLong(8) == 2334950737559900225L && allocate.getLong(16) == 3617552046287187010L) {
                        ...
                        if (j2 < ((long) allocate.capacity()) || j2 > 2147483639) {
                            ...
                            sb2.append(j2);
                            throw new C20095f(sb2.toString());
                        }
                        int i3 = (int) (8 + j2);
                        long j3 = a2 - ((long) i3);
                        if (j3 >= 0) {
                                            ...
                                            while (slice.hasRemaining()) {
                                                ...
                                                if (slice.remaining() >= i) {
                                                    ...
                                                    if (j5 < 4 || j5 > 2147483647L) {
                                                        ...
                                                        sb3.append(j5);
                                                        throw new C20095f(sb3.toString());
                                                    }
                                                    int i4 = (int) j5;
                                                    ...
                                                    if (i4 > slice.remaining()) {
                                                        ...
                                                        throw new C20095f(sb4.toString());
                                                    } else if (slice.getInt() == 1896449818) {
                                                        X509Certificate[][] a3 = m42309a(randomAccessFile.getChannel(), new C20094e(m42312b(slice, i4 - 4), longValue2, a2, longValue, byteBuffer2));
                                                    ...
                                                    sb5.append(i2);
                                                    throw new C20095f(sb5.toString());
                                                }
                                            }
                                            throw new C20095f("No APK Signature Scheme v2 block in APK Signing Block");
                                        }
                ...
                sb11.append(length);
                sb11.append(" bytes");
                throw new C20095f(sb11.toString());
            }
        } catch (Throwable th) {
            try {
                randomAccessFile.close();
    ...
    /* renamed from: a */
    private static X509Certificate[][] m42309a(FileChannel fileChannel, C20094e eVar) throws SecurityException {
        HashMap hashMap = new HashMap();
        ArrayList arrayList = new ArrayList();
        try {
            CertificateFactory instance = CertificateFactory.getInstance("X.509");
            try {
                ByteBuffer d = m42315d(eVar.f56116a);
                int i = 0;
                while (d.hasRemaining()) {
                    i++;
                    try {
                        arrayList.add(m42306a(m42315d(d), (Map<Integer, byte[]>) hashMap, instance));
                ...
                if (i <= 0) {
                    ...
                    m42305a(hashMap, fileChannel, eVar.f56117b, eVar.f56118c, eVar.f56119d, eVar.f56120e);
    ...
    /* renamed from: b */
    public static long m42310b(ByteBuffer byteBuffer) {
        m42314c(byteBuffer);
        return m42298a(byteBuffer, byteBuffer.position() + 12);
    }

    /* renamed from: b */
    private static String m42311b(int i) {
        if (i == 1) {
            return "SHA-256";
        }
        if (i == 2) {
    ...
    /* renamed from: b */
    private static ByteBuffer m42312b(ByteBuffer byteBuffer, int i) throws BufferUnderflowException {
        if (i >= 0) {
    ...
    /* renamed from: c */
    private static int m42313c(int i) {
        if (i == 1) {
            return 32;
        }
        if (i == 2) {
    ...
    /* renamed from: c */
    private static void m42314c(ByteBuffer byteBuffer) {
        if (byteBuffer.order() != ByteOrder.LITTLE_ENDIAN) {
            throw new IllegalArgumentException("ByteBuffer byte order must be little endian");
        }
    }
    ...
    /* renamed from: d */
    private static ByteBuffer m42315d(ByteBuffer byteBuffer) throws IOException {
        if (byteBuffer.remaining() >= 4) {
            int i = byteBuffer.getInt();
            if (i < 0) {
                throw new IllegalArgumentException("Negative length");
            } else if (i <= byteBuffer.remaining()) {
                return m42312b(byteBuffer, i);
            } else {
    ...
    /* renamed from: e */
    private static byte[] m42316e(ByteBuffer byteBuffer) throws IOException {
        int i = byteBuffer.getInt();
        if (i < 0) {
