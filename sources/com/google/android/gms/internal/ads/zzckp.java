        ...
        if (valueOf == null || zzl == null || valueOf.equals(zzl)) {
            ...
            if (Constants.BACKGROUND.equals(str)) {
                ...
                if (equals || equals2) {
                    ...
                    int zzb2 = zzb(context, map, SameLayerRenderingUtil.KEY_COMP_Y, 0);
                ...
                if (zza3 == null) {
                    ...
                    int zzb6 = zzb(context2, map, SameLayerRenderingUtil.KEY_COMP_Y, 0);
                    ...
                    String str8 = (String) map.get(Const.BlockParamConst.SRC);
