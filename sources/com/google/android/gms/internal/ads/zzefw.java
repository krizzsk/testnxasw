...
public final class zzefw extends zzefx {
    ...
    static {
        ...
        zzb.put(NetworkInfo.DetailedState.SUSPENDED.ordinal(), zzbhc.zzf);
    ...
    static /* synthetic */ zzbgt zza(zzefw zzefw, Bundle bundle) {
        zzbgm zza = zzbgt.zza();
    ...
    static /* synthetic */ zzbhc zzb(zzefw zzefw, Bundle bundle) {
        return (zzbhc) zzb.get(zzfeq.zza(zzfeq.zza(bundle, "device"), "network").getInt("active_network_state", -1), zzbhc.UNSPECIFIED);
    }

    static /* synthetic */ byte[] zze(zzefw zzefw, boolean z, ArrayList arrayList, zzbgt zzbgt, zzbhc zzbhc) {
