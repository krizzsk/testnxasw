...
public final class zzfll {
    ...
    public final void zzb(WebView webView, String str, Object... objArr) {
        if (webView != null) {
            ...
            if (r8 > 0) {
                for (Object obj : objArr) {
                    if (obj == null) {
                        ...
                        if (obj2.startsWith(Const.joLeft)) {
                            sb.append(obj2);
                        } else {
            ...
            if (zzfko.zza.booleanValue() && !TextUtils.isEmpty(concat)) {
                SystemUtils.log(4, "OMIDLIB", concat, (Throwable) null, "com.google.android.gms.internal.ads.zzfll", 21);
            }
        }
    }
    ...
    public final void zzd(WebView webView, JSONObject jSONObject) {
        zzb(webView, IPixView.PAGE_STATUS_INIT, jSONObject);
    }
