...
public final class zzbim {
    ...
    public final boolean zzc() {
        return ((Boolean) zzcb.zza(this.zza, zzbil.zza)).booleanValue() && Wrappers.packageManager(this.zza).checkCallingOrSelfPermission(Permission.WRITE_EXTERNAL_STORAGE) == 0;
    }
}
