...
public final class zzfnq {
    ...
    public final /* synthetic */ zzana zzd() throws Exception {
        Context context = this.zza;
        return zzfnf.zza(context, context.getPackageName(), Integer.toString(SystemUtils.getPackageInfo(context.getPackageManager(), context.getPackageName(), 0).versionCode));
    }
