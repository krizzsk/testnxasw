...
public final class zzdwz implements zza, zzdde, zzddu, zzdhr {
    ...
    private final zzdxp zzf(String str) {
        ...
        if (this.zze.zzak) {
            zza2.zzb("device_connectivity", true != zzt.zzo().zzv(this.zza) ? "offline" : BuildConfig.FLAVOR);
