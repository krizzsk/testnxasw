...
public final class zzbqb implements zzbpu {
    static final Map zza = CollectionUtils.mapOfKeyValueArrays(new String[]{Const.BlockParamConst.RESIZE, "playVideo", "storePicture", "createCalendarEvent", "setOrientationProperties", "closeResizedAd", "unload"}, new Integer[]{1, 2, 3, 4, 5, 6, 7});
    ...
    public final /* synthetic */ void zza(Object obj, Map map) {
        ...
        int intValue = ((Integer) zza.get((String) map.get(Constants.FILE_ANR_KEY))).intValue();
        int i = 6;
        boolean z = true;
        if (intValue != 5) {
            if (intValue != 7) {
