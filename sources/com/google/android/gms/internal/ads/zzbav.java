    ...
    public final boolean handleMessage(Message message) {
        ...
        if (i == 1) {
            try {
                ...
                SystemUtils.log(6, "DummySurface", "Failed to initialize dummy surface", e, "com.google.android.gms.internal.ads.zzbav", 29);
                this.zze = e;
                synchronized (this) {
                    notify();
                }
                ...
                try {
                    SystemUtils.log(6, "DummySurface", "Failed to initialize dummy surface", e2, "com.google.android.gms.internal.ads.zzbav", 26);
                    this.zzd = e2;
                    synchronized (this) {
                        notify();
                    }
            ...
            try {
                ...
                try {
                    SystemUtils.log(6, "DummySurface", "Failed to release dummy surface", th2, "com.google.android.gms.internal.ads.zzbav", 5);
                } catch (Throwable th3) {
                    quit();
                    throw th3;
                }
