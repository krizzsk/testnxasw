...
public final class zzerz implements zzeve {
    ...
    public final /* synthetic */ zzery zzc() throws Exception {
        ...
        if (!((Boolean) zzay.zzc().zzb(zzbjc.zzff)).booleanValue()) {
            ...
            str = SystemUtils.getSharedPreferences(context, "mobileads_consent", 0).getString("consent_string", str2);
        }
        if (((Boolean) zzay.zzc().zzb(zzbjc.zzfh)).booleanValue()) {
            str2 = SystemUtils.getSharedPreferences(this.zza, "mobileads_consent", 0).getString("fc_consent", str2);
        }
        zzt.zzp();
        ...
        if (!((Boolean) zzay.zzc().zzb(zzbjc.zzfg)).booleanValue()) {
            ...
            SharedPreferences defaultSharedPreferences = SystemUtils.getDefaultSharedPreferences(context2);
            bundle = new Bundle();
