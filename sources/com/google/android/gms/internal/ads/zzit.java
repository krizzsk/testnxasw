...
final class zzit extends zzm implements zzhl {
    ...
    public zzit(zzhk zzhk, zzcg zzcg) {
        ...
        try {
            ...
            String str = zzen.zze;
            zzdw.zzd("ExoPlayerImpl", "Init " + hexString + " [AndroidXMedia3/1.0.0-beta02] [" + str + Const.jaRight);
            ...
            zzip zzip = this.zzv;
            zzka[] zza2 = zzcly.zza(handler, zzip, zzip, zzip, zzip);
            this.zzh = zza2;
            ...
            this.zzu = zzde;
            this.zzg = zzcg;
            this.zzl = new zzdt(this.zzs, zzde, new zzhv(this));
            ...
            if (zzko != null) {
                ...
                zzkl zzkl = new zzkl(zzhk2.zza, handler3, this.zzv);
                this.zzz = zzkl;
                int i = this.zzW.zzc;
                zzkl.zzf(3);
    ...
    static /* synthetic */ void zzN(zzit zzit, SurfaceTexture surfaceTexture) {
    ...
    private final zzjx zzao(zzjw zzjw) {
        int zzag2 = zzag();
        zzjd zzjd = this.zzk;
        return new zzjx(zzjd, zzjw, this.zzaf.zza, zzag2 == -1 ? 0 : zzag2, this.zzu, zzjd.zzb());
    }
    ...
    public final void zzX() {
        ...
        String str = zzen.zze;
        String zza = zzbh.zza();
        zzdw.zzd("ExoPlayerImpl", "Release " + hexString + " [AndroidXMedia3/1.0.0-beta02] [" + str + "] [" + zza + Const.jaRight);
        zzax();
