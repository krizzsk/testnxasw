...
final class zzcru implements zzfbq {
    ...
    /* synthetic */ zzcru(zzcpw zzcpw, Context context, String str, zzq zzq, zzcrt zzcrt) {
        ...
        zzgxv zzc2 = zzgxh.zzc(new zzfbo(zzgxv, zzcpw2.zzp, zzcpw2.zzR, this.zzf, this.zzg, zzfeh.zza()));
        this.zzh = zzc2;
        this.zzi = zzgxh.zzc(new zzeoo(this.zzc, this.zzd, this.zze, zzc2, this.zzf, this.zzg, this.zza.zzi));
    }
