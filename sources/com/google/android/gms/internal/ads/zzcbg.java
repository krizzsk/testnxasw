...
public final class zzcbg {
    ...
    private final void zzd(Context context) {
        ...
        if (!((Boolean) zzay.zzc().zzb(zzbjc.zziE)).booleanValue() || Build.VERSION.SDK_INT < 33) {
            try {
                intent2 = context.registerReceiver((BroadcastReceiver) null, intentFilter);
            } catch (Exception e) {
        ...
        if (intent != null) {
            ...
            this.zzm = (double) (((float) intent.getIntExtra("level", -1)) / ((float) intent.getIntExtra(NNGestureClassfy.SCALE_LABLE, -1)));
