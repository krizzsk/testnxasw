    ...
    private final void zzo(zzavq zzavq, long j) {
        ...
        if ("S_TEXT/UTF8".equals(zzavq.zza)) {
            ...
            if (j2 == -9223372036854775807L) {
                ...
                bArr = zzbar.zzq(String.format(Locale.US, "%02d:%02d:%02d,%03d", new Object[]{Integer.valueOf(i), Integer.valueOf(i2), Integer.valueOf(i3), Integer.valueOf((int) ((j4 - ((long) (i3 * 1000000))) / 1000))}));
            }
