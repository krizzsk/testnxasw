...
public final class zzfqd {
    public static final int zza = (Build.VERSION.SDK_INT > 22 ? View.STATUS_BAR_TRANSIENT : 0);
    ...
    public static PendingIntent zza(Context context, int i, Intent intent, int i2, int i3) {
        ...
        if (zzb(0, 1)) {
            zzfsx.zzf(!zzb(i2, View.STATUS_BAR_TRANSIENT), "Cannot set mutability flags if PendingIntent.FLAG_IMMUTABLE is set.");
        } else {
            if (Build.VERSION.SDK_INT >= 23 && !zzb(i2, View.STATUS_BAR_TRANSIENT)) {
                z = false;
            }
