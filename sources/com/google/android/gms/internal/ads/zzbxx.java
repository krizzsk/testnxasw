...
public final class zzbxx extends zzbyf {
    ...
    private final String zzf = zze(ErrorBundle.SUMMARY_ENTRY);
    ...
    public final void zzc() {
        ...
        zzG.setPositiveButton(zzd2 != null ? zzd2.getString(R.string.s3) : HttpHeaders.ACCEPT, new zzbxv(this));
        zzG.setNegativeButton(zzd2 != null ? zzd2.getString(R.string.s4) : "Decline", new zzbxw(this));
        SystemUtils.showDialog(zzG.create());
    }
}
