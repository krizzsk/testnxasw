        ...
        synchronized (this.zzc) {
            if (!this.zze) {
                ...
                while (it.hasNext()) {
                    ...
                    if (((Boolean) zzay.zzc().zzb(zzbjc.zzhZ)).booleanValue()) {
                        ...
                        if (zza3 != null) {
                            if (zza3.zzd) {
                                ...
                                boolean z2 = zzbrq.zzb;
                                list2.add(new zzeae(str3, str2, zzc2, z2 ? 1 : 0, zzbrq.zzd, zzbrq.zzc, z));
                            }
                        }
                    }
                    z = false;
                    ...
                    boolean z22 = zzbrq.zzb;
                    list22.add(new zzeae(str32, str2, zzc22, z22 ? 1 : 0, zzbrq.zzd, zzbrq.zzc, z));
                }
                this.zze = true;
            }
        }
