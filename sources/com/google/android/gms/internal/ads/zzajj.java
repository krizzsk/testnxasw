                                            ...
                                            while (slice.hasRemaining()) {
                                                ...
                                                if (slice.remaining() >= i) {
                                                    ...
                                                    if (j5 < 4 || j5 > 2147483647L) {
                                                        throw new zzajg("APK Signing Block entry #" + i2 + " size out of range: " + j5);
                                                    }
                                                    int i4 = (int) j5;
                                                    int position2 = slice.position() + i4;
                                                    if (i4 > slice.remaining()) {
                                                        throw new zzajg("APK Signing Block entry #" + i2 + " size out of range: " + i4 + ", available: " + slice.remaining());
                                                    } else if (slice.getInt() == 1896449818) {
                                                        X509Certificate[][] zzl = zzl(randomAccessFile.getChannel(), new zzajf(zze(slice, i4 - 4), longValue2, zza, longValue, byteBuffer2, (zzajb) null));
                                                    ...
                                                    throw new zzajg("Insufficient data to read size of APK Signing Block entry #" + i2);
                                                }
                                            }
