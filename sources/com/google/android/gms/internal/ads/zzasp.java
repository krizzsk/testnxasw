...
final class zzasp implements zzasm {
    ...
    public zzasp(zzatb[] zzatbArr, zzazh zzazh, zzcjv zzcjv, byte[] bArr) {
        ...
        SystemUtils.log(4, "ExoPlayerImpl", "Init ExoPlayerLib/2.4.2 [" + str + Const.jaRight, (Throwable) null, "com.google.android.gms.internal.ads.zzasp", 1);
        this.zza = zzatbArr;
        if (zzazh2 != null) {
            this.zzb = zzazh2;
            this.zzj = false;
            ...
            this.zzt = zzasr;
            this.zze = new zzasu(zzatbArr, zzazh, zzcjv, this.zzj, 0, this.zzd, zzasr, this, (byte[]) null);
            return;
        }
        throw null;
    }
