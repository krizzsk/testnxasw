...
public final class zzflw {
    ...
    private static final String[] zzc = {"x", SameLayerRenderingUtil.KEY_COMP_Y, "width", "height"};

    public static JSONObject zza(int i, int i2, int i3, int i4) {
        JSONObject jSONObject = new JSONObject();
        try {
            jSONObject.put("x", (double) (((float) i) / zza));
            jSONObject.put(SameLayerRenderingUtil.KEY_COMP_Y, (double) (((float) i2) / zza));
    ...
    public static void zzh(JSONObject jSONObject, String str, Object obj) {
        try {
            ...
            zzflx.zza("JSONException during JSONObject.put for name [" + str + Const.jaRight, e);
        }
    }
