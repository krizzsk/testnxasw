...
public final class zzcmo extends WebChromeClient {
    ...
    public final void onGeolocationPermissionsShowPrompt(String str, GeolocationPermissions.Callback callback) {
        ...
        if (callback != null) {
            zzt.zzp();
            if (!zzs.zzx(this.zza.getContext(), Permission.ACCESS_FINE_LOCATION)) {
                zzt.zzp();
                if (!zzs.zzx(this.zza.getContext(), Permission.ACCESS_COARSE_LOCATION)) {
                    z = false;
    ...
    public final boolean onJsConfirm(WebView webView, String str, String str2, JsResult jsResult) {
        return zza(zzb(webView), XPanelScene.SCENE_CONFIRM, str, str2, (String) null, jsResult, (JsPromptResult) null, false);
    }
        ...
        try {
            ...
            if (zzcmp == null || zzcmp.zzP() == null || this.zza.zzP().zzd() == null || (zzd = this.zza.zzP().zzd()) == null || zzd.zzc()) {
                ...
                if (z) {
                    ...
                    SystemUtils.showDialog(zzG.setView(linearLayout).setPositiveButton(17039370, new zzcmm(jsPromptResult, editText)).setNegativeButton(17039360, new zzcml(jsPromptResult)).setOnCancelListener(new zzcmk(jsPromptResult)).create());
                } else {
                    SystemUtils.showDialog(zzG.setMessage(str3).setPositiveButton(17039370, new zzcmj(jsResult)).setNegativeButton(17039360, new zzcmi(jsResult)).setOnCancelListener(new zzcmh(jsResult)).create());
                }
                return true;
            }
