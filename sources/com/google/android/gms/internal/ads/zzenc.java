...
public final class zzenc {
    ...
    private final synchronized void zzk() {
        /*
            r9 = this;
            monitor-enter(r9)
            com.google.android.gms.internal.ads.zzbke r0 = com.google.android.gms.internal.ads.zzbkx.zze     // Catch:{ all -> 0x0084 }
            java.lang.Object r0 = r0.zze()     // Catch:{ all -> 0x0084 }
            java.lang.Boolean r0 = (java.lang.Boolean) r0     // Catch:{ all -> 0x0084 }
            boolean r0 = r0.booleanValue()     // Catch:{ all -> 0x0084 }
            if (r0 != 0) goto L_0x0082
            com.google.android.gms.internal.ads.zzbiu r0 = com.google.android.gms.internal.ads.zzbjc.zzbz     // Catch:{ all -> 0x0084 }
            com.google.android.gms.internal.ads.zzbja r1 = com.google.android.gms.ads.internal.client.zzay.zzc()     // Catch:{ all -> 0x0084 }
            java.lang.Object r0 = r1.zzb(r0)     // Catch:{ all -> 0x0084 }
            java.lang.Boolean r0 = (java.lang.Boolean) r0     // Catch:{ all -> 0x0084 }
            boolean r0 = r0.booleanValue()     // Catch:{ all -> 0x0084 }
            if (r0 != 0) goto L_0x0022
            goto L_0x0082
        L_0x0022:
            com.google.android.gms.internal.ads.zzcfy r0 = com.google.android.gms.ads.internal.zzt.zzo()     // Catch:{ all -> 0x0084 }
            com.google.android.gms.ads.internal.util.zzg r0 = r0.zzh()     // Catch:{ all -> 0x0084 }
            com.google.android.gms.internal.ads.zzcfs r0 = r0.zzh()     // Catch:{ all -> 0x0084 }
            org.json.JSONObject r0 = r0.zzf()     // Catch:{ all -> 0x0084 }
            if (r0 != 0) goto L_0x0036
            monitor-exit(r9)
            return
        L_0x0036:
            java.lang.String r1 = "signal_adapters"
            org.json.JSONArray r0 = r0.getJSONArray(r1)     // Catch:{ JSONException -> 0x007a }
            r1 = 0
            r2 = 0
        L_0x003f:
            int r3 = r0.length()     // Catch:{ JSONException -> 0x007a }
            if (r2 >= r3) goto L_0x0078
            org.json.JSONObject r3 = r0.getJSONObject(r2)     // Catch:{ JSONException -> 0x007a }
            java.lang.String r4 = "data"
            org.json.JSONObject r4 = r3.optJSONObject(r4)     // Catch:{ JSONException -> 0x007a }
            android.os.Bundle r4 = zzl(r4)     // Catch:{ JSONException -> 0x007a }
            java.lang.String r5 = "adapter_class_name"
            java.lang.String r5 = r3.optString(r5)     // Catch:{ JSONException -> 0x007a }
            java.lang.String r6 = "render"
            boolean r6 = r3.optBoolean(r6, r1)     // Catch:{ JSONException -> 0x007a }
            java.lang.String r7 = "collect_signals"
            boolean r3 = r3.optBoolean(r7, r1)     // Catch:{ JSONException -> 0x007a }
            boolean r7 = android.text.TextUtils.isEmpty(r5)     // Catch:{ JSONException -> 0x007a }
            if (r7 != 0) goto L_0x0075
            java.util.Map r7 = r9.zzb     // Catch:{ JSONException -> 0x007a }
            com.google.android.gms.internal.ads.zzeng r8 = new com.google.android.gms.internal.ads.zzeng     // Catch:{ JSONException -> 0x007a }
            r8.<init>(r5, r3, r6, r4)     // Catch:{ JSONException -> 0x007a }
            r7.put(r5, r8)     // Catch:{ JSONException -> 0x007a }
        L_0x0075:
            int r2 = r2 + 1
            goto L_0x003f
        L_0x0078:
        ...
        L_0x007a:
            ...
            com.google.android.gms.ads.internal.util.zze.zzb(r1, r0)     // Catch:{ all -> 0x0084 }
            monitor-exit(r9)
            return
        L_0x0082:
            monitor-exit(r9)
