...
public abstract class zzvw extends zzvz {
    ...
    public final zzwa zzn(zzkb[] zzkbArr, zzuh zzuh, zzsi zzsi, zzcn zzcn) throws zzha {
        ...
        zzvv zzvv = new zzvv(strArr, iArr6, zzuhArr, iArr4, iArr3, new zzuh((zzcp[]) zzen.zzae(zzcpArr[2], iArr2[2])));
        ...
        for (int i20 = 0; i20 < zzvxArr.length; i20++) {
            ...
            listArr[i20] = zzvx != null ? zzfvn.zzp(zzvx) : zzfvn.zzo();
        }
        zzfvk zzfvk = new zzfvk();
        for (int i21 = 0; i21 < 2; i21++) {
            zzuh zzd = zzvv.zzd(i21);
