...
public final class zzbjh {
    ...
    Context zze;
    String zzf;
    private final HashSet zzg = new HashSet(Arrays.asList(new String[]{Packet.NOOP, "activeViewPingSent", "viewabilityChanged", "visibilityChanged"}));
    ...
    public final void zzd(Context context, String str, String str2, Map map) {
        ...
        if (this.zzh.get() && (externalStorageDirectory = SystemUtils.getExternalStorageDirectory()) != null) {
