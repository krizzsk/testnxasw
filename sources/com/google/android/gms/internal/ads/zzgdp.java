    ...
    public static byte[] zza(byte[] bArr, byte[] bArr2) {
        ...
        while (true) {
            ...
            if (i2 < length) {
                ...
                long zzc = (((j23 & j30) | (j25 & 67108863 & j31) | (j32 << 26)) & InternalZipConstants.ZIP_64_SIZE_LIMIT) + zzc(bArr3, 16);
                long zzc2 = (((j32 >> 6) | (j33 << 20)) & InternalZipConstants.ZIP_64_SIZE_LIMIT) + zzc(bArr3, 20) + (zzc >> 32);
                long zzc3 = (((j33 >> 12) | (j34 << 14)) & InternalZipConstants.ZIP_64_SIZE_LIMIT) + zzc(bArr3, 24) + (zzc2 >> 32);
                long zzc4 = zzc(bArr3, 28);
                byte[] bArr6 = new byte[16];
                zzd(bArr6, zzc & InternalZipConstants.ZIP_64_SIZE_LIMIT, 0);
                zzd(bArr6, zzc2 & InternalZipConstants.ZIP_64_SIZE_LIMIT, 4);
                zzd(bArr6, zzc3 & InternalZipConstants.ZIP_64_SIZE_LIMIT, 8);
                zzd(bArr6, ((((((j29 & j31) | (j21 & j30)) << 8) | (j34 >> 18)) & InternalZipConstants.ZIP_64_SIZE_LIMIT) + zzc4 + (zzc3 >> 32)) & InternalZipConstants.ZIP_64_SIZE_LIMIT, 12);
                return bArr6;
            }
        }
    }
