                ...
                if (!zzy() && nanoTime - this.zzz >= 500000) {
                    ...
                    if (zzh2) {
                        ...
                        if (zzd2 < this.zzK) {
                            ...
                            SystemUtils.log(5, "AudioTrack", "Spurious audio timestamp (system clock mismatch): " + zzc2 + ", " + zzd2 + ", " + nanoTime + ", " + zzb2, (Throwable) null, "com.google.android.gms.internal.ads.zzaue", 12);
                            this.zzy = false;
                        } else if (Math.abs(zzq(zzc2) - zzb2) > 5000000) {
                            SystemUtils.log(5, "AudioTrack", "Spurious audio timestamp (frame position mismatch): " + zzc2 + ", " + zzd2 + ", " + nanoTime + ", " + zzb2, (Throwable) null, "com.google.android.gms.internal.ads.zzaue", 15);
                            this.zzy = false;
                        }
                    }
                    ...
                    if (method != null && !this.zzn) {
                        try {
                            ...
                            this.zzL = max;
                            if (max > 5000000) {
                                SystemUtils.log(5, "AudioTrack", "Ignoring impossibly large audio latency: " + max, (Throwable) null, "com.google.android.gms.internal.ads.zzaue", 18);
                                this.zzL = 0;
                            }
        ...
        if (this.zzP == null) {
            ...
            if (this.zzI == 0) {
                ...
                if (this.zzI == 1 && Math.abs(zzq2 - j3) > 200000) {
                    SystemUtils.log(6, "AudioTrack", "Discontinuity detected [expected " + zzq2 + ", got " + j3 + Const.jaRight, (Throwable) null, "com.google.android.gms.internal.ads.zzaue", 35);
                    this.zzI = 2;
                }
                if (this.zzI == 2) {
                    this.zzJ += j3 - zzq2;
