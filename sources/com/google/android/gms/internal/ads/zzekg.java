...
public abstract class zzekg implements zzehc {
    ...
    public final zzfzp zza(zzfdw zzfdw, zzfdk zzfdk) {
        zzfdk zzfdk2 = zzfdk;
        String optString = zzfdk2.zzw.optString(AbstractAdViewAdapter.AD_UNIT_ID_PARAMETER, "");
    ...
    public final boolean zzb(zzfdw zzfdw, zzfdk zzfdk) {
        return !TextUtils.isEmpty(zzfdk.zzw.optString(AbstractAdViewAdapter.AD_UNIT_ID_PARAMETER, ""));
    }
