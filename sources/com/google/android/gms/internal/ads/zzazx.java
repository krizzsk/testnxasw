...
final class zzazx extends Handler implements Runnable {
    ...
    public final void run() {
        try {
            ...
            SystemUtils.log(6, "LoadTask", "Unexpected exception loading stream", e2, "com.google.android.gms.internal.ads.zzazx", 13);
            if (!this.zzi) {
                obtainMessage(3, new zzazz(e2)).sendToTarget();
            }
        } catch (OutOfMemoryError e3) {
            SystemUtils.log(6, "LoadTask", "OutOfMemory error loading stream", e3, "com.google.android.gms.internal.ads.zzazx", 11);
            if (!this.zzi) {
                obtainMessage(3, new zzazz(e3)).sendToTarget();
            }
        } catch (Error e4) {
            SystemUtils.log(6, "LoadTask", "Unexpected error loading stream", e4, "com.google.android.gms.internal.ads.zzazx", 8);
            if (!this.zzi) {
