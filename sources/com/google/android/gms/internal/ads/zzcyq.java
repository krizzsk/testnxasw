...
public final class zzcyq extends FrameLayout implements ViewTreeObserver.OnGlobalLayoutListener, ViewTreeObserver.OnScrollChangedListener {
    ...
    private final void zzc(JSONObject jSONObject, RelativeLayout relativeLayout, int i) {
        ...
        int zzb2 = zzb(jSONObject.optDouble(Const.YogaConst.PADDING_PADDING, 0.0d));
