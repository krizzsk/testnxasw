...
public class zzbyf {
    ...
    public final void zzf(int i, int i2, int i3, int i4) {
        try {
            this.zza.zze("onDefaultPositionReceived", new JSONObject().put("x", i).put(SameLayerRenderingUtil.KEY_COMP_Y, i2).put("width", i3).put("height", i4));
    ...
    public final void zzj(int i, int i2, int i3, int i4) {
        try {
            this.zza.zze("onSizeChanged", new JSONObject().put("x", i).put(SameLayerRenderingUtil.KEY_COMP_Y, i2).put("width", i3).put("height", i4));
        } catch (JSONException e) {
