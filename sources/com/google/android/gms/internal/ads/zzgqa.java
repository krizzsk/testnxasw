...
final class zzgqa extends zzgqe {
    ...
    public final int zzi() throws IOException {
        ...
        if (j - j2 >= 4) {
            this.zzm = 4 + j2;
            zza = (zzgui.zza(j2) & 255) | ((zzgui.zza(1 + j2) & 255) << 8) | ((zzgui.zza(2 + j2) & 255) << 16);
            zza2 = zzgui.zza(j2 + 3);
        } else {
    ...
    public final long zzq() throws IOException {
        ...
        if (j - j2 >= 8) {
            this.zzm = 8 + j2;
            zza = (((long) zzgui.zza(j2)) & 255) | ((((long) zzgui.zza(1 + j2)) & 255) << 8) | ((((long) zzgui.zza(2 + j2)) & 255) << 16) | ((((long) zzgui.zza(3 + j2)) & 255) << 24) | ((((long) zzgui.zza(4 + j2)) & 255) << 32) | ((((long) zzgui.zza(5 + j2)) & 255) << 40) | ((((long) zzgui.zza(6 + j2)) & 255) << 48);
            zza2 = zzgui.zza(j2 + 7);
        } else {
        ...
        if (this.zzo != j4) {
            ...
            if (zza >= 0) {
                ...
                if (zza2 < 0) {
                    ...
                    long j7 = j6 + 1;
                    byte zza3 = zza2 ^ (zzgui.zza(j6) << Ascii.f55149SO);
                    if (zza3 >= 0) {
                        j = (long) (zza3 ^ 16256);
                    } else {
                        j6 = j7 + 1;
                        byte zza4 = zza3 ^ (zzgui.zza(j7) << Ascii.NAK);
                        if (zza4 < 0) {
                            b = zza4 ^ -2080896;
                        } else {
                            j7 = j6 + 1;
