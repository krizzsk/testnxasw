...
public abstract class zzfxx<V> extends zzgai implements zzfzp<V> {
    ...
    final class zzj extends zza {
        ...
        /* JADX WARNING: Code restructure failed: missing block: B:3:?, code lost:
            r0 = (sun.misc.Unsafe) java.security.AccessController.doPrivileged(new com.google.android.gms.internal.ads.zzfxx.zzj.C195601());
         */
    ...
    static {
        ...
        try {
            ...
            try {
                ...
                th = e2;
                th2 = e;
                zza2 = new zzg((C195581) null);
            }
        }
        zzaW = zza2;
        if (th != null) {
            zzaV.logp(Level.SEVERE, "com.google.common.util.concurrent.AbstractFuture", "<clinit>", "UnsafeAtomicHelper is broken!", th2);
            zzaV.logp(Level.SEVERE, "com.google.common.util.concurrent.AbstractFuture", "<clinit>", "SafeAtomicHelper is broken!", th);
        }
    }
