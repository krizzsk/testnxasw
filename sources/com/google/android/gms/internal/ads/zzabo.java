    ...
    public final int zza(zzzj zzzj, zzaai zzaai) throws IOException {
        ...
        if (i == 0) {
            ...
            if ((zzo >> 2) == 16382) {
                ...
                if (zzzv2 != null) {
                    if (zzzv2.zzk != null) {
                        zzaal = new zzzt(zzzv2, zzf2);
                    } else if (zzd2 == -1 || zzzv2.zzj <= 0) {
                        zzaal = new zzaak(zzzv2.zza(), 0);
                    } else {
                        zzabm zzabm = new zzabm(zzzv2, this.zzk, zzf2, zzd2);
                        this.zzl = zzabm;
                        zzaal = zzabm.zzb();
                    }
                    zzzl.zzN(zzaal);
            ...
            zzzv zzzv3 = this.zzi;
            if (zzzv3 != null) {
                zzabm zzabm2 = this.zzl;
                if (zzabm2 != null && zzabm2.zze()) {
                    return zzabm2.zza(zzzj2, zzaai);
                }
                if (this.zzn == -1) {
                    this.zzn = zzzr.zzb(zzzj2, zzzv3);
                    return 0;
                }
                zzef zzef6 = this.zzc;
                int zzd3 = zzef6.zzd();
