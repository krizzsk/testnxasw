...
public final class zzckq implements zzbpu {
    public final /* synthetic */ void zza(Object obj, Map map) {
        ...
        if (zzs == null) {
            try {
                zzcnl zzcnl = new zzcnl(zzciy, Float.parseFloat((String) map.get("duration")), "1".equals(map.get("customControlsAllowed")), "1".equals(map.get("clickToExpandAllowed")));
                zzciy.zzE(zzcnl);
                zzs = zzcnl;
        ...
        String str = (String) map.get(Const.YogaConst.ASPECT_RATIO);
