...
public final class zzbba extends zzawu {
        ...
        if (zze2 && zzasw.zzj > 0 && zzasw.zzk > 0) {
            if (zzbar.zza >= 21) {
                ...
                if (!zze2) {
                    ...
                    SystemUtils.log(3, "MediaCodecVideoRenderer", "FalseCheck [legacyFrameSize, " + i3 + "x" + i4 + "] [" + str2 + Const.jaRight, (Throwable) null, "com.google.android.gms.internal.ads.zzbba", 11);
                }
            }
        }
    ...
    public final void zzs(zzasw[] zzaswArr, long j) throws zzasi {
        ...
        if (i == 10) {
            long j2 = this.zzf[9];
            SystemUtils.log(5, "MediaCodecVideoRenderer", "Too many stream changes, so dropping offset: " + j2, (Throwable) null, "com.google.android.gms.internal.ads.zzbba", 1);
        } else {
            this.zzA = i + 1;
        }
