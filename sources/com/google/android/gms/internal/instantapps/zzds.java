...
final class zzds implements zzex {
    ...
    private zzds(zzec zzec) {
        this.zzaqz = (zzec) zzcy.zza(zzec, "messageInfoFactory");
    }
    ...
    private static zzec zzcu() {
        try {
            return (zzec) Class.forName("com.google.protobuf.DescriptorMessageInfoFactory").getDeclaredMethod("getInstance", new Class[0]).invoke((Object) null, new Object[0]);
