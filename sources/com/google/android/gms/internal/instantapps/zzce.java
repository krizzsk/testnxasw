...
public abstract class zzce extends zzbm {
    ...
    public final void zza(String str, zzfy zzfy) throws IOException {
        logger.logp(Level.WARNING, "com.google.protobuf.CodedOutputStream", "inefficientWriteStringNoTag", "Converting ill-formed UTF-16. Your Protocol Buffer will not round trip correctly!", zzfy);
