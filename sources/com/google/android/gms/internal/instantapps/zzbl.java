...
final class zzbl {
    ...
    static int zza(int i, byte[] bArr, int i2, zzbk zzbk) {
        ...
        byte b2 = bArr[i4];
        if (b2 >= 0) {
            zzbk.zzako = i5 | (b2 << Ascii.f55149SO);
            return i6;
        }
        int i7 = i5 | ((b2 & Byte.MAX_VALUE) << Ascii.f55149SO);
        int i8 = i6 + 1;
        byte b3 = bArr[i6];
        if (b3 >= 0) {
            zzbk.zzako = i7 | (b3 << Ascii.NAK);
            return i8;
        }
        ...
        byte b4 = bArr[i8];
        if (b4 >= 0) {
            zzbk.zzako = i9 | (b4 << Ascii.f55142FS);
            return i10;
        }
        int i11 = i9 | ((b4 & Byte.MAX_VALUE) << Ascii.f55142FS);
        while (true) {
            int i12 = i10 + 1;
            if (bArr[i10] >= 0) {
                zzbk.zzako = i11;
    ...
    static int zza(com.google.android.gms.internal.instantapps.zzeu r6, byte[] r7, int r8, int r9, com.google.android.gms.internal.instantapps.zzbk r10) throws java.io.IOException {
        /*
            int r0 = r8 + 1
            byte r8 = r7[r8]
            if (r8 >= 0) goto L_0x000c
            int r0 = zza((int) r8, (byte[]) r7, (int) r0, (com.google.android.gms.internal.instantapps.zzbk) r10)
            int r8 = r10.zzako
        L_0x000c:
            r3 = r0
            ...
            return r8
        L_0x0025:
            com.google.android.gms.internal.instantapps.zzdf r6 = com.google.android.gms.internal.instantapps.zzdf.zzcf()
            throw r6
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.internal.instantapps.zzbl.zza(com.google.android.gms.internal.instantapps.zzeu, byte[], int, int, com.google.android.gms.internal.instantapps.zzbk):int");
    }
    ...
    static int zza(zzeu<?> zzeu, int i, byte[] bArr, int i2, int i3, zzdc<?> zzdc, zzbk zzbk) throws IOException {
        int zza = zza((zzeu) zzeu, bArr, i2, i3, zzbk);
        zzdc.add(zzbk.zzakq);
        while (zza < i3) {
            int zza2 = zza(bArr, zza, zzbk);
            if (i != zzbk.zzako) {
            ...
            zza = zza((zzeu) zzeu, bArr, zza2, i3, zzbk);
            zzdc.add(zzbk.zzakq);
        }
        return zza;
    }
