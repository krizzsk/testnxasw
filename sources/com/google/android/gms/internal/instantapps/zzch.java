...
final class zzch implements zzgi {
    ...
    private zzch(zzce zzce) {
        zzce zzce2 = (zzce) zzcy.zza(zzce, "output");
        this.zzalb = zzce2;
        zzce2.zzalr = this;
    }
    ...
    public final <K, V> void zza(int i, zzdw<K, V> zzdw, Map<K, V> map) throws IOException {
        for (Map.Entry next : map.entrySet()) {
            this.zzalb.zzb(i, 2);
            this.zzalb.zzx(zzdx.zza(zzdw, next.getKey(), next.getValue()));
            zzdx.zza(this.zzalb, zzdw, next.getKey(), next.getValue());
        }
    }
}
