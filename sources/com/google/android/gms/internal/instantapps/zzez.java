...
class zzez<K extends Comparable<K>, V> extends AbstractMap<K, V> {
    ...
    public List<zzfe> zzasp;
    /* access modifiers changed from: private */
    public Map<K, V> zzasq;
    private volatile zzfg zzasr;
    /* access modifiers changed from: private */
    public Map<K, V> zzass;
    ...
    public V get(Object obj) {
        ...
        if (zza >= 0) {
            return this.zzasp.get(zza).getValue();
        }
        return this.zzasq.get(comparable);
    }
    ...
    public final V put(K k, V v) {
        ...
        int zza = zza(k);
        if (zza >= 0) {
            return this.zzasp.get(zza).setValue(v);
        }
        zzdu();
    ...
    public final V zzaw(int i) {
        zzdu();
        V value = this.zzasp.remove(i).getValue();
        if (!this.zzasq.isEmpty()) {
            Iterator it = zzdv().entrySet().iterator();
            this.zzasp.add(new zzfe(this, (Map.Entry) it.next()));
            it.remove();
        }
        return value;
    }
    ...
    public Set<Map.Entry<K, V>> entrySet() {
        if (this.zzasr == null) {
            this.zzasr = new zzfg(this, (zzey) null);
        }
        return this.zzasr;
    }
    ...
    public final Set<Map.Entry<K, V>> zzdt() {
        if (this.zzast == null) {
            this.zzast = new zzfa(this, (zzey) null);
        }
        return this.zzast;
    }
