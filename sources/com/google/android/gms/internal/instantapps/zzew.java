...
final class zzew {
    ...
    static int zzq(List<Long> list) {
        ...
        if (list instanceof zzdt) {
            ...
            int i3 = 0;
            while (i2 < size) {
                i3 = i + zzce.zzg(list.get(i2).longValue());
                i2++;
            }
        }
        return i;
    ...
    static int zzr(List<Long> list) {
        ...
        if (list instanceof zzdt) {
            ...
            int i3 = 0;
            while (i2 < size) {
                i3 = i + zzce.zzh(list.get(i2).longValue());
                i2++;
            }
        }
        return i;
    ...
    static int zzs(List<Long> list) {
        ...
        if (list instanceof zzdt) {
            ...
            int i3 = 0;
            while (i2 < size) {
                i3 = i + zzce.zzi(list.get(i2).longValue());
                i2++;
            }
        }
        return i;
    ...
    static int zzt(List<Integer> list) {
        ...
        if (list instanceof zzcz) {
            ...
            int i3 = 0;
            while (i2 < size) {
                i3 = i + zzce.zzag(list.get(i2).intValue());
                i2++;
            }
        }
        return i;
    ...
    static int zzu(List<Integer> list) {
        ...
        if (list instanceof zzcz) {
            ...
            int i3 = 0;
            while (i2 < size) {
                i3 = i + zzce.zzab(list.get(i2).intValue());
                i2++;
            }
        }
        return i;
    ...
    static int zzv(List<Integer> list) {
        ...
        if (list instanceof zzcz) {
            ...
            int i3 = 0;
            while (i2 < size) {
                i3 = i + zzce.zzac(list.get(i2).intValue());
                i2++;
            }
        }
        return i;
    ...
    static int zzw(List<Integer> list) {
        ...
        if (list instanceof zzcz) {
            ...
            int i3 = 0;
            while (i2 < size) {
                i3 = i + zzce.zzad(list.get(i2).intValue());
                i2++;
            }
        }
        return i;
    ...
    private static zzfm<?, ?> zzd(boolean z) {
        try {
            ...
            return (zzfm) zzdq.getConstructor(new Class[]{Boolean.TYPE}).newInstance(new Object[]{Boolean.valueOf(z)});
    ...
    static <T> void zza(zzdy zzdy, T t, T t2, long j) {
        zzfs.zza((Object) t, j, zzdy.zzb(zzfs.zzp(t, j), zzfs.zzp(t2, j)));
    }
