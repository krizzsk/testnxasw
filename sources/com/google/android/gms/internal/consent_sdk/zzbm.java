...
final class zzbm implements zzg {
    ...
    private final void zzf(JSONObject jSONObject) {
        ...
        if (TextUtils.isEmpty(optString)) {
            SystemUtils.log(3, "UserMessagingPlatform", "Action[browser]: empty url.", (Throwable) null, "com.google.android.gms.internal.consent_sdk.zzbm", 3);
        }
        Uri parse = Uri.parse(optString);
        if (parse.getScheme() == null) {
            String valueOf = String.valueOf(optString);
            SystemUtils.log(3, "UserMessagingPlatform", valueOf.length() != 0 ? "Action[browser]: empty scheme: ".concat(valueOf) : new String("Action[browser]: empty scheme: "), (Throwable) null, "com.google.android.gms.internal.consent_sdk.zzbm", 7);
        }
        try {
            ...
            SystemUtils.log(3, "UserMessagingPlatform", valueOf2.length() != 0 ? "Action[browser]: can not open url: ".concat(valueOf2) : new String("Action[browser]: can not open url: "), activityNotFoundException, "com.google.android.gms.internal.consent_sdk.zzbm", 11);
        }
    }
    ...
    public final void zzd(String str) {
        ...
        SystemUtils.log(3, "UserMessagingPlatform", valueOf.length() != 0 ? "Receive consent action: ".concat(valueOf) : new String("Receive consent action: "), (Throwable) null, "com.google.android.gms.internal.consent_sdk.zzbm", 2);
