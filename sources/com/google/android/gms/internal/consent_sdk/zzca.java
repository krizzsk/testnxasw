    ...
    public static void zzb(Context context, Set<String> set) {
        ...
        for (String next : set) {
            ...
            if (zza == null) {
                ...
                SystemUtils.log(3, "UserMessagingPlatform", valueOf.length() != 0 ? "clearKeys: unable to process key: ".concat(valueOf) : new String("clearKeys: unable to process key: "), (Throwable) null, "com.google.android.gms.internal.consent_sdk.zzca", 5);
            } else {
