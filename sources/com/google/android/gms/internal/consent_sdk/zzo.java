...
final class zzo {
    ...
    static /* synthetic */ zzbu zza(zzo zzo) throws zzj {
        ...
        if (TextUtils.isEmpty(zza2)) {
            try {
                bundle = SystemUtils.getApplicationInfo(zzo.zza.zza.getPackageManager(), zzo.zza.zza.getPackageName(), 128).metaData;
        ...
        try {
            packageInfo = SystemUtils.getPackageInfo(zzo.zza.zza.getPackageManager(), zza4.getPackageName(), 0);
