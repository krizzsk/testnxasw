...
public final class zzbz extends zzce {
    ...
    public static final Object zze(Bundle bundle, Class cls) {
        ...
        try {
            ...
            SystemUtils.log(5, "AM", String.format("Unexpected object type. Expected, Received: %s, %s", new Object[]{cls.getCanonicalName(), obj.getClass().getCanonicalName()}), e, "com.google.android.gms.internal.measurement.zzbz", 5);
            throw e;
        }
    }
