    ...
    public static void installIfNeeded(Context context) throws GooglePlayServicesRepairableException, GooglePlayServicesNotAvailableException {
        ...
        synchronized (zzb) {
            ...
            try {
                ...
                SystemUtils.log(5, "ProviderInstaller", "Failed to load providerinstaller module: ".concat(String.valueOf(e.getMessage())), (Throwable) null, "com.google.android.gms.security.ProviderInstaller", 6);
                context2 = null;
            }
            if (context2 == null) {
                ...
                if (remoteContext != null) {
                    try {
                        ...
                        SystemUtils.log(5, "ProviderInstaller", "Failed to report request stats: ".concat(String.valueOf(e2.getMessage())), (Throwable) null, "com.google.android.gms.security.ProviderInstaller", 11);
                    }
                }
                if (remoteContext != null) {
                    zzc(remoteContext, context, "com.google.android.gms.common.security.ProviderInstallerImpl");
                } else {
                    SystemUtils.log(6, "ProviderInstaller", "Failed to get remote context", (Throwable) null, "com.google.android.gms.security.ProviderInstaller", 14);
    ...
    private static void zzc(Context context, Context context2, String str) throws GooglePlayServicesNotAvailableException {
        try {
            ...
            if (Log.isLoggable("ProviderInstaller", 6)) {
                SystemUtils.log(6, "ProviderInstaller", "Failed to install provider: ".concat(String.valueOf(cause == null ? e.getMessage() : cause.getMessage())), (Throwable) null, "com.google.android.gms.security.ProviderInstaller", 6);
            }
            throw new GooglePlayServicesNotAvailableException(8);
        }
    }
