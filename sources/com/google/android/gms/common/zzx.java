...
class zzx {
    ...
    public final void zze() {
        if (!this.zza && Log.isLoggable("GoogleCertificatesRslt", 3)) {
            if (this.zzc != null) {
                SystemUtils.log(3, "GoogleCertificatesRslt", zza(), this.zzc, "com.google.android.gms.common.zzx", 2);
            } else {
                SystemUtils.log(3, "GoogleCertificatesRslt", zza(), (Throwable) null, "com.google.android.gms.common.zzx", 3);
            }
        }
    }
}
