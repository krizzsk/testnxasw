...
public final class SignInButton extends FrameLayout implements View.OnClickListener {
    ...
    private final void zaa(Context context) {
        ...
        try {
            ...
            SystemUtils.log(5, "SignInButton", "Sign in button not found, using placeholder instead", (Throwable) null, "com.google.android.gms.common.SignInButton", 3);
            int i = this.zaa;
            int i2 = this.zab;
    ...
    public SignInButton(Context context, AttributeSet attributeSet, int i) {
        ...
        this.zad = null;
        TypedArray obtainStyledAttributes = context.getTheme().obtainStyledAttributes(attributeSet, C11267R.styleable.SignInButton, 0, 0);
        try {
