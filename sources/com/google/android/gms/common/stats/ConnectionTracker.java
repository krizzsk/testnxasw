...
public class ConnectionTracker {
    ...
    private final boolean zzc(Context context, String str, Intent intent, ServiceConnection serviceConnection, int i, boolean z, @Nullable Executor executor) {
        ...
        if (component != null) {
            ...
            try {
                if ((Wrappers.packageManager(context).getApplicationInfo(packageName, 0).flags & 2097152) != 0) {
                    SystemUtils.log(5, "ConnectionTracker", "Attempted to bind to a service in a STOPPED package.", (Throwable) null, "com.google.android.gms.common.stats.ConnectionTracker", 15);
                    return false;
                }
        ...
        if (!(serviceConnection2 == null || serviceConnection == serviceConnection2)) {
            SystemUtils.log(5, "ConnectionTracker", String.format("Duplicate binding with the same ServiceConnection: %s, %s, %s.", new Object[]{serviceConnection, str, intent.getAction()}), (Throwable) null, "com.google.android.gms.common.stats.ConnectionTracker", 10);
        }
        try {
