...
public class BitmapTeleporter extends AbstractSafeParcelable implements ReflectedParcelable {
    ...
    private static final void zaa(Closeable closeable) {
        try {
            ...
            SystemUtils.log(5, "BitmapTeleporter", "Could not close stream", e, "com.google.android.gms.common.data.BitmapTeleporter", 2);
        }
    }
    ...
    public void release() {
        if (!this.zae) {
            try {
                ...
                SystemUtils.log(5, "BitmapTeleporter", "Could not close PFD", e, "com.google.android.gms.common.data.BitmapTeleporter", 2);
            }
        }
    }
