...
public class GoogleApiActivity extends Activity implements DialogInterface.OnCancelListener {
    ...
    private final void zab() {
        ...
        if (extras == null) {
            SystemUtils.log(6, "GoogleApiActivity", "Activity started without extras", (Throwable) null, "com.google.android.gms.common.api.GoogleApiActivity", 2);
            finish();
            return;
        }
        ...
        if (pendingIntent == null && num == null) {
            SystemUtils.log(6, "GoogleApiActivity", "Activity started without resolution", (Throwable) null, "com.google.android.gms.common.api.GoogleApiActivity", 21);
            finish();
            ...
            try {
                ...
                if (extras.getBoolean("notify_manager", true)) {
                    ...
                    SystemUtils.log(6, "GoogleApiActivity", str, activityNotFoundException, "com.google.android.gms.common.api.GoogleApiActivity", 13);
                }
                this.zaa = 1;
                finish();
            } catch (IntentSender.SendIntentException e2) {
                SystemUtils.log(6, "GoogleApiActivity", "Failed to launch pendingIntent", e2, "com.google.android.gms.common.api.GoogleApiActivity", 8);
                finish();
            }
        } else {
