...
public final class zabq implements GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener, zau {
    ...
    private final boolean zaL(zai zai2) {
        ...
        SystemUtils.log(5, "GoogleApiManager", name + " could not execute call because it requires feature (" + name2 + ", " + version + ").", (Throwable) null, "com.google.android.gms.common.api.internal.zabq", 9);
        ...
        if (!this.zac.isConnected() && !this.zac.isConnecting()) {
            try {
                ...
                if (zab2 != 0) {
                    ...
                    SystemUtils.log(5, "GoogleApiManager", "The service for " + name + " is not available: " + obj, (Throwable) null, "com.google.android.gms.common.api.internal.zabq", 12);
                    zar(connectionResult, (Exception) null);
                    return;
                }
                GoogleApiManager googleApiManager2 = this.zaa;
