    ...
    public static final void zan(Result result) {
        if (result instanceof Releasable) {
            try {
                ...
                SystemUtils.log(5, "TransformedResultImpl", "Unable to release ".concat(String.valueOf(String.valueOf(result))), e, "com.google.android.gms.common.api.internal.zada", 3);
            }
        }
    }
