    ...
    public static void zal(Result result) {
        if (result instanceof Releasable) {
            try {
                ...
                SystemUtils.log(5, "BasePendingResult", "Unable to release ".concat(String.valueOf(String.valueOf(result))), e, "com.google.android.gms.common.api.internal.BasePendingResult", 3);
            }
        }
    }
