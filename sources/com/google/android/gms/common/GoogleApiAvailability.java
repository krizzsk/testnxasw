...
public class GoogleApiAvailability extends GoogleApiAvailabilityLight {
    ...
    public void showErrorNotification(Context context, int i) {
        zae(context, i, (String) null, getErrorResolutionPendingIntent(context, i, 0, CampaignValue.f43060b));
    }
    ...
    public final Dialog zaa(Context context, int i, zag zag, DialogInterface.OnCancelListener onCancelListener) {
        ...
        SystemUtils.log(5, "GoogleApiAvailability", String.format("Creating dialog for Google Play services availability issue. ConnectionResult=%s", new Object[]{Integer.valueOf(i)}), new IllegalArgumentException(), "com.google.android.gms.common.GoogleApiAvailability", 15);
    ...
    public final void zad(Activity activity, Dialog dialog, String str, DialogInterface.OnCancelListener onCancelListener) {
        ...
        SystemUtils.showDialogFragmentManager(ErrorDialogFragment.newInstance(dialog, onCancelListener), activity.getFragmentManager(), str);
    }
    ...
    public final void zae(Context context, int i, String str, PendingIntent pendingIntent) {
        int i2;
        String str2;
        SystemUtils.log(5, "GoogleApiAvailability", String.format("GMS core API Availability. ConnectionResult=%s, tag=%s", new Object[]{Integer.valueOf(i), null}), new IllegalArgumentException(), "com.google.android.gms.common.GoogleApiAvailability", 2);
        if (i == 18) {
            zaf(context);
            ...
            if (i == 1 || i == 2 || i == 3) {
                ...
                i2 = C14360R2.styleable.Theme_actionBarSplitStyle;
            }
            notificationManager.notify(i2, build);
        } else if (i == 6) {
            SystemUtils.log(5, "GoogleApiAvailability", "Missing resolution for ConnectionResult.RESOLUTION_REQUIRED. Call GoogleApiAvailability#showErrorNotification(Context, ConnectionResult) instead.", (Throwable) null, "com.google.android.gms.common.GoogleApiAvailability", 4);
        }
    }
    ...
    public final boolean zah(Context context, ConnectionResult connectionResult, int i) {
        ...
        zae(context, connectionResult.getErrorCode(), (String) null, PendingIntent.getActivity(context, 0, GoogleApiActivity.zaa(context, errorResolutionPendingIntent, i, true), zap.zaa | View.NAVIGATION_BAR_TRANSIENT));
        return true;
    }
