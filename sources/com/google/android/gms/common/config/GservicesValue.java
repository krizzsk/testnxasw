...
public abstract class GservicesValue<T> {
    ...
    public void override(T t) {
        SystemUtils.log(5, "GservicesValue", "GservicesValue.override(): test should probably call initForTests() first", (Throwable) null, "com.google.android.gms.common.config.GservicesValue", 1);
        this.zzd = t;
        synchronized (zzc) {
            synchronized (zzc) {
            }
