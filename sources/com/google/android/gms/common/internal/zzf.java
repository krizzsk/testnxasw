    ...
    public final boolean zzd() {
        try {
            ...
            if (!this.zzf.getServiceDescriptor().equals(interfaceDescriptor)) {
                ...
                SystemUtils.log(5, "GmsClient", "service descriptor mismatch: " + serviceDescriptor + " vs. " + interfaceDescriptor, (Throwable) null, "com.google.android.gms.common.internal.zzf", 4);
                return false;
            }
            ...
            SystemUtils.log(5, "GmsClient", "service probably died", (Throwable) null, "com.google.android.gms.common.internal.zzf", 2);
            return false;
        }
    }
}
