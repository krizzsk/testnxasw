    ...
    public final Intent zzc(Context context) {
        ...
        if (this.zzf) {
            ...
            try {
                ...
                SystemUtils.log(5, "ConnectionStatusConfig", "Dynamic intent resolution failed: ".concat(e.toString()), (Throwable) null, "com.google.android.gms.common.internal.zzn", 5);
                bundle = null;
            }
            if (bundle != null) {
            ...
            if (intent == null) {
                SystemUtils.log(5, "ConnectionStatusConfig", "Dynamic lookup for intent failed for action: ".concat(String.valueOf(this.zzb)), (Throwable) null, "com.google.android.gms.common.internal.zzn", 7);
            }
        }
        if (intent != null) {
            return intent;
