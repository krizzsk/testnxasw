    ...
    public final void zaf(GoogleApiClient.ConnectionCallbacks connectionCallbacks) {
        ...
        synchronized (this.zai) {
            if (this.zac.contains(connectionCallbacks)) {
                ...
                SystemUtils.log(5, "GmsClientEvents", "registerConnectionCallbacks(): listener " + valueOf + " is already registered", (Throwable) null, "com.google.android.gms.common.internal.zak", 3);
            } else {
    ...
    public final void zag(GoogleApiClient.OnConnectionFailedListener onConnectionFailedListener) {
        ...
        synchronized (this.zai) {
            if (this.zad.contains(onConnectionFailedListener)) {
                ...
                SystemUtils.log(5, "GmsClientEvents", "registerConnectionFailedListener(): listener " + valueOf + " is already registered", (Throwable) null, "com.google.android.gms.common.internal.zak", 3);
            } else {
    ...
    public final void zah(GoogleApiClient.ConnectionCallbacks connectionCallbacks) {
        ...
        synchronized (this.zai) {
            if (!this.zac.remove(connectionCallbacks)) {
                String valueOf = String.valueOf(connectionCallbacks);
                SystemUtils.log(5, "GmsClientEvents", "unregisterConnectionCallbacks(): listener " + valueOf + " not found", (Throwable) null, "com.google.android.gms.common.internal.zak", 3);
            } else if (this.zag) {
    ...
    public final void zai(GoogleApiClient.OnConnectionFailedListener onConnectionFailedListener) {
        ...
        synchronized (this.zai) {
            if (!this.zad.remove(onConnectionFailedListener)) {
                String valueOf = String.valueOf(onConnectionFailedListener);
                SystemUtils.log(5, "GmsClientEvents", "unregisterConnectionFailedListener(): listener " + valueOf + " not found", (Throwable) null, "com.google.android.gms.common.internal.zak", 3);
            }
        }
    }
