...
public class GoogleSignatureVerifier {
    ...
    static final zzj zza(PackageInfo packageInfo, zzj... zzjArr) {
        ...
        if (packageInfo.signatures.length != 1) {
            SystemUtils.log(5, "GoogleSignatureVerifier", "Package has more than one signature.", (Throwable) null, "com.google.android.gms.common.GoogleSignatureVerifier", 3);
            return null;
        }
    ...
    private final zzx zzc(String str, boolean z, boolean z2) {
        ...
        if (zzn.zzg()) {
            ...
            try {
                PackageInfo packageInfo = SystemUtils.getPackageInfo(this.zzc.getPackageManager(), str, 64);
    ...
    public boolean isGooglePublicSignedPackage(PackageInfo packageInfo) {
        ...
        if (zzb(packageInfo, true)) {
            ...
            SystemUtils.log(5, "GoogleSignatureVerifier", "Test-keys aren't accepted on this build.", (Throwable) null, "com.google.android.gms.common.GoogleSignatureVerifier", 4);
        }
        return false;
    }
