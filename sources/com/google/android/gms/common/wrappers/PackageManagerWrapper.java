...
public class PackageManagerWrapper {
    ...
    public ApplicationInfo getApplicationInfo(String str, int i) throws PackageManager.NameNotFoundException {
        return SystemUtils.getApplicationInfo(this.zza.getPackageManager(), str, i);
    }

    public CharSequence getApplicationLabel(String str) throws PackageManager.NameNotFoundException {
        return this.zza.getPackageManager().getApplicationLabel(SystemUtils.getApplicationInfo(this.zza.getPackageManager(), str, 0));
    }

    public Pair<CharSequence, Drawable> getApplicationLabelAndIcon(String str) throws PackageManager.NameNotFoundException {
        ApplicationInfo applicationInfo = SystemUtils.getApplicationInfo(this.zza.getPackageManager(), str, 0);
    ...
    public PackageInfo getPackageInfo(String str, int i) throws PackageManager.NameNotFoundException {
        return SystemUtils.getPackageInfo(this.zza.getPackageManager(), str, i);
    }
