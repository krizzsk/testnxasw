...
final class zzn {
    ...
    static synchronized void zze(Context context) {
        synchronized (zzn.class) {
            if (zzg != null) {
                SystemUtils.log(5, "GoogleCertificates", "GoogleCertificates has been initialized already", (Throwable) null, "com.google.android.gms.common.zzn", 2);
    ...
    static boolean zzf() {
        ...
        try {
            ...
            SystemUtils.log(6, "GoogleCertificates", "Failed to get Google certificates from remote", e, "com.google.android.gms.common.zzn", 4);
            StrictMode.setThreadPolicy(allowThreadDiskReads);
            return false;
        } catch (Throwable th) {
            StrictMode.setThreadPolicy(allowThreadDiskReads);
    ...
    private static zzx zzh(String str, zzj zzj, boolean z, boolean z2) {
        try {
            ...
            try {
                ...
                SystemUtils.log(6, "GoogleCertificates", "Failed to get Google certificates from remote", e, "com.google.android.gms.common.zzn", 7);
                return zzx.zzd("module call", e);
            }
        } catch (DynamiteModule.LoadingException e2) {
            SystemUtils.log(6, "GoogleCertificates", "Failed to get Google certificates from remote", e2, "com.google.android.gms.common.zzn", 2);
            return zzx.zzd("module init: ".concat(String.valueOf(e2.getMessage())), e2);
        }
    }

    /* JADX WARNING: type inference failed for: r4v1, types: [com.google.android.gms.dynamic.IObjectWrapper, android.os.IBinder] */
    private static zzx zzi(String str, boolean z, boolean z2, boolean z3, boolean z4) {
        ...
        try {
            ...
            SystemUtils.log(6, "GoogleCertificates", "Failed to get Google certificates from remote", e2, "com.google.android.gms.common.zzn", 9);
