...
public final class zzbx {
        ...
        try {
            ...
            try {
                ...
                try {
                    ...
                    jSONObject3.put(SameLayerRenderingUtil.KEY_COMP_Y, zzaw.zzb().zzb(context, point2.y));
            ...
            if (view2 != null) {
                ...
                try {
                    ...
                    try {
                        ...
                        jSONObject5.put(SameLayerRenderingUtil.KEY_COMP_Y, zzaw.zzb().zzb(context2, zzj2[1] - zzj[1]));
                        ...
                        if (view2.getLocalVisibleRect(rect)) {
                            ...
                            jSONObject2.put(SameLayerRenderingUtil.KEY_COMP_Y, zzaw.zzb().zzb(context2, zzj2[1] - zzj[1]));
                        ...
                        if (view2 instanceof TextView) {
                            ...
                            jSONObject4.put(BlocksConst.WIDGET_PARAMS_TEXT_COLOR, textView.getCurrentTextColor());
                            entry = entry2;
    ...
    private static JSONObject zzk(Context context, Rect rect) throws JSONException {
        ...
        jSONObject.put(SameLayerRenderingUtil.KEY_COMP_Y, zzaw.zzb().zzb(context, rect.top));
