...
public final class zzce {
    ...
    public final void zzb(Context context) {
        ...
        if (!defaultUserAgent.equals(this.zza)) {
            ...
            SharedPreferences.Editor putString = SystemUtils.getSharedPreferences(context, "admob_user_agent", 0).edit().putString("user_agent", WebSettings.getDefaultUserAgent(context));
            if (remoteContext == null) {
                putString.apply();
            } else {
