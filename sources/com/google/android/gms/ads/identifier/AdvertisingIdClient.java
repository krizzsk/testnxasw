...
public class AdvertisingIdClient {
            ...
            synchronized (advertisingIdClient) {
                if (!advertisingIdClient.zzc) {
                    ...
                    try {
                        ...
                        SystemUtils.log(4, "AdvertisingIdClient", "GMS remote exception ", e, "com.google.android.gms.ads.identifier.AdvertisingIdClient", 12);
        ...
        synchronized (this) {
            if (!this.zzc) {
                ...
                try {
                    ...
                    SystemUtils.log(4, "AdvertisingIdClient", "GMS remote exception ", e, "com.google.android.gms.ads.identifier.AdvertisingIdClient", 11);
                    throw new IOException("Remote exception");
                } catch (Exception e2) {
                    throw new IOException("AdvertisingIdClient cannot reconnect.", e2);
                }
    ...
    public final void zza() {
        /*
            ...
            monitor-enter(r7)
            android.content.Context r0 = r7.zzg     // Catch:{ all -> 0x0038 }
            if (r0 == 0) goto L_0x0036
            com.google.android.gms.common.BlockingServiceConnection r0 = r7.zza     // Catch:{ all -> 0x0038 }
            if (r0 != 0) goto L_0x000f
            goto L_0x0036
        L_0x000f:
            boolean r0 = r7.zzc     // Catch:{ all -> 0x001f }
            ...
            android.content.Context r1 = r7.zzg     // Catch:{ all -> 0x001f }
            com.google.android.gms.common.BlockingServiceConnection r2 = r7.zza     // Catch:{ all -> 0x001f }
        ...
        L_0x001f:
            ...
            r6 = 5
            com.didi.sdk.apm.SystemUtils.log(r1, r2, r3, r4, r5, r6)     // Catch:{ all -> 0x0038 }
        L_0x002c:
            r0 = 0
            r7.zzc = r0     // Catch:{ all -> 0x0038 }
            r0 = 0
            r7.zzb = r0     // Catch:{ all -> 0x0038 }
            r7.zza = r0     // Catch:{ all -> 0x0038 }
