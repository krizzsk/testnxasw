...
public final class GoogleAuthUtil extends zzl {
    ...
    private static TokenData zzf(Context context, Account account, String str, Bundle bundle) throws IOException, GoogleAuthException {
        try {
            ...
            SystemUtils.log(5, "GoogleAuthUtil", "Error when getting token", googlePlayServicesAvailabilityException, "com.google.android.gms.auth.GoogleAuthUtil", 8);
            throw new UserRecoverableNotifiedException("User intervention required. Notification has been pushed.");
        } catch (UserRecoverableAuthException e2) {
            GooglePlayServicesUtil.cancelAvailabilityErrorNotifications(context);
            SystemUtils.log(5, "GoogleAuthUtil", "Error when getting token", e2, "com.google.android.gms.auth.GoogleAuthUtil", 4);
            throw new UserRecoverableNotifiedException("User intervention required. Notification has been pushed.");
        }
    }
