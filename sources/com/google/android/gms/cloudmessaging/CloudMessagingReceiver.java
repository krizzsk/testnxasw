...
public abstract class CloudMessagingReceiver extends BroadcastReceiver {
    ...
    public final void onReceive(Context context, Intent intent) {
        if (intent != null) {
            getBroadcastExecutor().execute(new zzd(this, intent, context, SystemUtils.isOrderedBroadcast(this), goAsync()));
        }
    }
    ...
    private final int zza(Context context, Intent intent) {
        ...
        if (pendingIntent != null) {
            try {
                ...
                SystemUtils.log(6, "CloudMessagingReceiver", "Notification pending intent canceled", (Throwable) null, "com.google.android.gms.cloudmessaging.CloudMessagingReceiver", 21);
            }
        }
        ...
        if (IntentActionKeys.NOTIFICATION_OPEN.equals(intent.getAction())) {
            ...
            SystemUtils.log(6, "CloudMessagingReceiver", "Unknown notification action", (Throwable) null, "com.google.android.gms.cloudmessaging.CloudMessagingReceiver", 30);
            return 500;
        }
    }
    ...
    private final int zzb(Context context, Intent intent) {
        ...
        try {
            ...
            sb.append(valueOf);
            SystemUtils.log(5, "CloudMessagingReceiver", sb.toString(), (Throwable) null, "com.google.android.gms.cloudmessaging.CloudMessagingReceiver", 51);
        }
    ...
    public final /* synthetic */ void zza(Intent intent, Context context, boolean z, BroadcastReceiver.PendingResult pendingResult) {
        ...
        try {
            ...
            SystemUtils.pendingResultFinish(pendingResult);
        }
    }
}
