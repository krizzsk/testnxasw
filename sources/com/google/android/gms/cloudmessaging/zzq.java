...
abstract class zzq<T> {
    ...
    public final void zza(T t) {
        if (Log.isLoggable("MessengerIpcClient", 3)) {
            ...
            sb.append(" with ");
            sb.append(valueOf2);
            SystemUtils.log(3, "MessengerIpcClient", sb.toString(), (Throwable) null, "com.google.android.gms.cloudmessaging.zzq", 8);
        }
    ...
    public final void zza(zzp zzp) {
        if (Log.isLoggable("MessengerIpcClient", 3)) {
            ...
            sb.append(" with ");
            sb.append(valueOf2);
            SystemUtils.log(3, "MessengerIpcClient", sb.toString(), (Throwable) null, "com.google.android.gms.cloudmessaging.zzq", 12);
        }
