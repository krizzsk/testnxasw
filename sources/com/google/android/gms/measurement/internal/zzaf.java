...
public final class zzaf extends zzhb {
    ...
    private final String zzB(String str, String str2) {
        try {
            ...
            this.zzs.zzaz().zzd().zzb("Could not find SystemProperties.get() method", e2);
            return "";
        } catch (IllegalAccessException e3) {
            this.zzs.zzaz().zzd().zzb("Could not access SystemProperties.get()", e3);
            return "";
    ...
    public final java.util.List zzp(java.lang.String r4) {
        ...
        L_0x002c:
            ...
            com.google.android.gms.measurement.internal.zzgi r0 = r3.zzs     // Catch:{ NotFoundException -> 0x0048 }
            android.content.Context r0 = r0.zzav()     // Catch:{ NotFoundException -> 0x0048 }
