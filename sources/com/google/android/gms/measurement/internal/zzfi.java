...
public final class zzfi {
    ...
    public zzfi(zzfn zzfn, String str, Bundle bundle) {
        this.zza = zzfn;
    ...
    public final android.os.Bundle zza() {
        ...
        L_0x0069:
            ...
            com.google.android.gms.measurement.internal.zzfn r4 = r11.zza     // Catch:{ NumberFormatException | JSONException -> 0x00a3 }
            com.google.android.gms.measurement.internal.zzgi r4 = r4.zzs     // Catch:{ NumberFormatException | JSONException -> 0x00a3 }
            com.google.android.gms.measurement.internal.zzey r4 = r4.zzaz()     // Catch:{ NumberFormatException | JSONException -> 0x00a3 }
            com.google.android.gms.measurement.internal.zzew r4 = r4.zzd()     // Catch:{ NumberFormatException | JSONException -> 0x00a3 }
        ...
        L_0x009b:
            ...
            goto L_0x00b4
        L_0x00a3:
            com.google.android.gms.measurement.internal.zzfn r4 = r11.zza     // Catch:{ JSONException -> 0x00bb }
            com.google.android.gms.measurement.internal.zzgi r4 = r4.zzs     // Catch:{ JSONException -> 0x00bb }
            com.google.android.gms.measurement.internal.zzey r4 = r4.zzaz()     // Catch:{ JSONException -> 0x00bb }
            com.google.android.gms.measurement.internal.zzew r4 = r4.zzd()     // Catch:{ JSONException -> 0x00bb }
            ...
            for (String str2 : bundle.keySet()) {
                ...
                if (obj != null) {
                    try {
                        ...
                        jSONObject.put(CampaignValue.f43060b, str2);
                        jSONObject.put(RavenKey.VERSION, obj.toString());
                        if (obj instanceof String) {
                            jSONObject.put(RavenKey.TYPE, RavenKey.STACK);
                        } else if (obj instanceof Long) {
                            jSONObject.put(RavenKey.TYPE, "l");
                        } else if (obj instanceof Double) {
                            jSONObject.put(RavenKey.TYPE, "d");
                        } else {
                            this.zza.zzs.zzaz().zzd().zzb("Cannot serialize bundle value to SharedPreferences. Type", obj.getClass());
                        }
                        jSONArray.put(jSONObject);
                    } catch (JSONException e) {
                        this.zza.zzs.zzaz().zzd().zzb("Cannot serialize bundle value to SharedPreferences", e);
                    }
                }
            }
