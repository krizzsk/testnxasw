        ...
        synchronized (zzb.class) {
            ...
            synchronized (zzb) {
                try {
                    ...
                    SystemUtils.log(5, "DynamiteLoaderV2CL", "Failed to get thread context classloader " + message, (Throwable) null, "com.google.android.gms.dynamite.zzb", 4);
                }
            }
            return classLoader;
        }
                ...
                try {
                    ...
                    if (zza2 == null) {
                        try {
                            ...
                            e = e3;
                            zza3 = zza2;
                            SystemUtils.log(5, "DynamiteLoaderV2CL", "Failed to enumerate thread/threadgroup " + e.getMessage(), (Throwable) null, "com.google.android.gms.dynamite.zzb", 14);
                            zza2 = zza3;
                            return zza2;
                        }
                        zza2 = zza3;
