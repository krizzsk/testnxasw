...
final class SchemaManager extends SQLiteOpenHelper {
    ...
    static {
        $$Lambda$SchemaManager$GnoKRnczwOa6Fk7ZCPhACcfPzQ r0 = $$Lambda$SchemaManager$GnoKRnczwOa6Fk7ZCPhACcfPzQ.INSTANCE;
        MIGRATE_TO_V4 = r0;
        INCREMENTAL_MIGRATIONS = Arrays.asList(new Migration[]{MIGRATE_TO_V1, MIGRATE_TO_V2, MIGRATE_TO_V3, r0});
    }
