...
public class SQLiteEventStore implements EventStore, SynchronizationGuard {
    ...
    private static final Encoding PROTOBUF_ENCODING = Encoding.m40760of("proto");
    ...
    public PersistedEvent persist(TransportContext transportContext, EventInternal eventInternal) {
        Logging.m40765d(LOG_TAG, "Storing event with priority=%s, name=%s for destination %s", transportContext.getPriority(), eventInternal.getTransportName(), transportContext.getBackendName());
    ...
    public /* synthetic */ Long lambda$persist$1$SQLiteEventStore(TransportContext transportContext, EventInternal eventInternal, SQLiteDatabase sQLiteDatabase) {
        ...
        if (!z) {
            ...
            for (int i = 1; i <= ceil; i++) {
                ...
                contentValues2.put(ParamKeys.PARAM_EVENT_ID, Long.valueOf(insert));
        ...
        for (Map.Entry next : eventInternal.getMetadata().entrySet()) {
            ...
            contentValues3.put(ParamKeys.PARAM_EVENT_ID, Long.valueOf(insert));
    ...
    private Long getTransportContextId(SQLiteDatabase sQLiteDatabase, TransportContext transportContext) {
        ...
        return (Long) tryWithCursor(sQLiteDatabase.query("transport_contexts", new String[]{ShareDBHelper.ID_NAME}, sb.toString(), (String[]) arrayList.toArray(new String[0]), (String) null, (String) null, (String) null), $$Lambda$SQLiteEventStore$huP16S6r4seAEE6hUvL2FlE7jI.INSTANCE);
    }
    ...
    private Map<Long, Set<Metadata>> loadMetadata(SQLiteDatabase sQLiteDatabase, List<PersistedEvent> list) {
        ...
        sb.append(VersionRange.RIGHT_OPEN);
        tryWithCursor(sQLiteDatabase.query("event_metadata", new String[]{ParamKeys.PARAM_EVENT_ID, "name", "value"}, sb.toString(), (String[]) null, (String) null, (String) null, (String) null), new Function(hashMap) {
