...
public class GeoJsonParser {
    ...
    private static GeoJsonFeature parseFeature(JSONObject jSONObject) {
        ...
        try {
            ...
            SystemUtils.log(5, LOG_TAG, "Feature could not be successfully parsed " + jSONObject.toString(), (Throwable) null, "com.google.maps.android.data.geojson.GeoJsonParser", 147);
            return null;
        }
    }
    ...
    private static GeoJsonFeature parseGeometryToFeature(JSONObject jSONObject) {
        ...
        SystemUtils.log(5, LOG_TAG, "Geometry could not be parsed", (Throwable) null, "com.google.maps.android.data.geojson.GeoJsonParser", 211);
        return null;
    }
    ...
    private void parseGeoJson() {
        try {
            ...
            if (string.equals(FEATURE)) {
                ...
                SystemUtils.log(5, LOG_TAG, "GeoJSON file could not be parsed.", (Throwable) null, "com.google.maps.android.data.geojson.GeoJsonParser", 454);
            }
        } catch (JSONException unused) {
            SystemUtils.log(5, LOG_TAG, "GeoJSON file could not be parsed.", (Throwable) null, "com.google.maps.android.data.geojson.GeoJsonParser", 457);
        }
    }
                ...
                try {
                    ...
                    if (jSONObject2.getString("type").equals(FEATURE)) {
                        ...
                        if (parseFeature != null) {
                            ...
                            SystemUtils.log(5, LOG_TAG, "Index of Feature in Feature Collection that could not be created: " + i, (Throwable) null, "com.google.maps.android.data.geojson.GeoJsonParser", 491);
                        }
                    }
                } catch (JSONException unused) {
                    SystemUtils.log(5, LOG_TAG, "Index of Feature in Feature Collection that could not be created: " + i, (Throwable) null, "com.google.maps.android.data.geojson.GeoJsonParser", 497);
                }
            }
            return arrayList;
        } catch (JSONException unused2) {
            SystemUtils.log(5, LOG_TAG, "Feature Collection could not be created.", (Throwable) null, "com.google.maps.android.data.geojson.GeoJsonParser", 478);
            return arrayList;
        }
    }
