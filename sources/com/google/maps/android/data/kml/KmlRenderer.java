...
public class KmlRenderer extends Renderer {
    ...
    private class MarkerIconImageDownload extends AsyncTask<String, Void, Bitmap> {
        ...
        public void onPostExecute(Bitmap bitmap) {
            if (bitmap == null) {
                SystemUtils.log(6, KmlRenderer.LOG_TAG, "Image at this URL could not be found " + this.mIconUrl, (Throwable) null, "com.google.maps.android.data.kml.KmlRenderer$MarkerIconImageDownload", 557);
            } else {
    ...
    private class GroundOverlayImageDownload extends AsyncTask<String, Void, Bitmap> {
        ...
        public Bitmap doInBackground(String... strArr) {
            try {
                ...
                SystemUtils.log(6, KmlRenderer.LOG_TAG, "Image [" + this.mGroundOverlayUrl + "] download issue", iOException, "com.google.maps.android.data.kml.KmlRenderer$GroundOverlayImageDownload", 594);
                return null;
            }
        }
        ...
        public void onPostExecute(Bitmap bitmap) {
            if (bitmap == null) {
                SystemUtils.log(6, KmlRenderer.LOG_TAG, "Image at this URL could not be found " + this.mGroundOverlayUrl, (Throwable) null, "com.google.maps.android.data.kml.KmlRenderer$GroundOverlayImageDownload", 607);
            } else {
