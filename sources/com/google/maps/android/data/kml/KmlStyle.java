...
public class KmlStyle extends Style {
    ...
    public void setFillColor(String str) {
        setPolygonFillColor(Color.parseColor(RConfigConstants.KEYWORD_COLOR_SIGN + convertColor(str)));
        this.mStylesSet.add("fillColor");
    }

    /* access modifiers changed from: package-private */
    public void setMarkerColor(String str) {
        this.mMarkerColor = getHueValue(Color.parseColor(RConfigConstants.KEYWORD_COLOR_SIGN + convertColor(str)));
    ...
    public void setOutlineColor(String str) {
        ...
        polylineOptions.color(Color.parseColor(RConfigConstants.KEYWORD_COLOR_SIGN + convertColor(str)));
        PolygonOptions polygonOptions = this.mPolygonOptions;
        polygonOptions.strokeColor(Color.parseColor(RConfigConstants.KEYWORD_COLOR_SIGN + convertColor(str)));
