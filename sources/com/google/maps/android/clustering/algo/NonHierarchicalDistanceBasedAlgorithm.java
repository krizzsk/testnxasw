...
public class NonHierarchicalDistanceBasedAlgorithm<T extends ClusterItem> extends AbstractAlgorithm<T> {
    ...
    public Set<? extends Cluster<T>> getClusters(float f) {
        float f2 = f;
        double pow = (((double) this.mMaxDistance) / Math.pow(2.0d, (double) ((int) f2))) / 256.0d;
    ...
    private Bounds createBoundsFromSpan(Point point, double d) {
        double d2 = d / 2.0d;
        return new Bounds(point.f55226x - d2, point.f55226x + d2, point.f55227y - d2, point.f55227y + d2);
    }

    protected static class QuadItem<T extends ClusterItem> implements Cluster<T>, PointQuadTree.Item {
        /* access modifiers changed from: private */
