...
import com.google.maps.android.p217ui.IconGenerator;
import com.google.maps.android.p217ui.SquareTextView;
...
public class DefaultClusterRenderer<T extends ClusterItem> implements ClusterRenderer<T> {
    ...
    public DefaultClusterRenderer(Context context, GoogleMap googleMap, ClusterManager<T> clusterManager) {
        ...
        this.mIconGenerator.setTextAppearance(2132018357);
    ...
    private class RenderTask implements Runnable {
        ...
        public void run() {
            ...
            float access$1300 = f - DefaultClusterRenderer.this.mZoom;
            Set<MarkerWithPosition> access$1700 = DefaultClusterRenderer.this.mMarkers;
            try {
            ...
            for (Cluster cluster2 : this.clusters) {
                ...
                if (!z || !contains || !DefaultClusterRenderer.this.mAnimate) {
                    ...
                    Point access$1900 = DefaultClusterRenderer.this.findClosestCluster(arrayList, this.mSphericalMercatorProjection.toPoint(cluster2.getPosition()));
                    if (access$1900 != null) {
                        markerModifier.add(true, new CreateMarkerTask(cluster2, newSetFromMap, this.mSphericalMercatorProjection.toLatLng(access$1900)));
                    } else {
            ...
            access$1700.removeAll(newSetFromMap);
            ...
            for (MarkerWithPosition markerWithPosition : access$1700) {
                boolean contains2 = latLngBounds.contains(markerWithPosition.position);
                if (z || access$1300 <= -3.0f || !contains2 || !DefaultClusterRenderer.this.mAnimate) {
                    markerModifier.remove(contains2, markerWithPosition.marker);
                } else {
                    Point access$19002 = DefaultClusterRenderer.this.findClosestCluster(arrayList2, this.mSphericalMercatorProjection.toPoint(markerWithPosition.position));
                    if (access$19002 != null) {
                        markerModifier.animateThenRemove(markerWithPosition, markerWithPosition.position, this.mSphericalMercatorProjection.toLatLng(access$19002));
                    } else {
    ...
    private static double distanceSquared(Point point, Point point2) {
        return ((point.f55226x - point2.f55226x) * (point.f55226x - point2.f55226x)) + ((point.f55227y - point2.f55227y) * (point.f55227y - point2.f55227y));
    }
    ...
    private class AnimationTask extends AnimatorListenerAdapter implements ValueAnimator.AnimatorUpdateListener {
        ...
        public void onAnimationEnd(Animator animator) {
            ...
            LatLng unused = this.markerWithPosition.position = this.f55225to;
        }
        ...
        public void onAnimationUpdate(ValueAnimator valueAnimator) {
            ...
            double d2 = ((this.f55225to.latitude - this.from.latitude) * d) + this.from.latitude;
            double d3 = this.f55225to.longitude - this.from.longitude;
