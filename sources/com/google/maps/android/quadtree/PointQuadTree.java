...
public class PointQuadTree<T extends Item> {
    ...
    public void add(T t) {
        ...
        if (this.mBounds.contains(point.f55226x, point.f55227y)) {
            insert(point.f55226x, point.f55227y, t);
        }
    }
    ...
    private void split() {
        ...
        this.mItems = null;
        for (T t : set) {
            insert(t.getPoint().f55226x, t.getPoint().f55227y, t);
        }
    }
    ...
    public boolean remove(T t) {
        ...
        return remove(point.f55226x, point.f55227y, t);
    }
