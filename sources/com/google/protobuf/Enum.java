...
public final class Enum extends GeneratedMessageV3 implements EnumOrBuilder {
    ...
    public boolean equals(Object obj) {
        ...
        Enum enumR = (Enum) obj;
        boolean z = (((getName().equals(enumR.getName())) && getEnumvalueList().equals(enumR.getEnumvalueList())) && getOptionsList().equals(enumR.getOptionsList())) && hasSourceContext() == enumR.hasSourceContext();
        if (hasSourceContext()) {
            z = z && getSourceContext().equals(enumR.getSourceContext());
        }
    ...
    public static final class Builder extends GeneratedMessageV3.Builder<Builder> implements EnumOrBuilder {
        ...
        public Enum buildPartial() {
            ...
            int unused9 = enumR.bitField0_ = 0;
            onBuilt();
            return enumR;
        }
