...
public final class Field extends GeneratedMessageV3 implements FieldOrBuilder {
    ...
    public int hashCode() {
        ...
        int hashCode = ((((((((((((((((((((((((((((779 + getDescriptorForType().hashCode()) * 37) + 1) * 53) + this.kind_) * 37) + 2) * 53) + this.cardinality_) * 37) + 3) * 53) + getNumber()) * 37) + 4) * 53) + getName().hashCode()) * 37) + 6) * 53) + getTypeUrl().hashCode()) * 37) + 7) * 53) + getOneofIndex()) * 37) + 8) * 53) + Internal.hashBoolean(getPacked());
    ...
    public static final class Builder extends GeneratedMessageV3.Builder<Builder> implements FieldOrBuilder {
        ...
        public Field buildPartial() {
            ...
            int unused12 = field.bitField0_ = 0;
            onBuilt();
            return field;
        }
