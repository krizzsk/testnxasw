...
final class MessageLiteToString {
    ...
    private static void reflectivePrintWithIndent(MessageLite messageLite, StringBuilder sb, int i) {
        ...
        for (String replaceFirst : treeSet) {
            ...
            if (((Method) hashMap2.get(GuideParamModel.ACTION_SET + replaceFirst2)) != null) {
        ...
        if (messageLite instanceof GeneratedMessageLite.ExtendableMessage) {
            ...
            while (it.hasNext()) {
                ...
                printField(sb, i, Const.jaLeft + ((GeneratedMessageLite.ExtensionDescriptor) next.getKey()).getNumber() + Const.jaRight, next.getValue());
            }
        }
