...
public final class JsonKeysetReader implements KeysetReader {
    ...
    public Keyset read() throws IOException {
        try {
            if (this.json != null) {
                Keyset keysetFromJson = keysetFromJson(this.json);
            ...
            Keyset keysetFromJson2 = keysetFromJson(new JSONObject(new String(C20308Util.readAll(this.inputStream), UTF_8)));
    ...
    public EncryptedKeyset readEncrypted() throws IOException {
        try {
            if (this.json != null) {
                EncryptedKeyset encryptedKeysetFromJson = encryptedKeysetFromJson(this.json);
                InputStream inputStream2 = this.inputStream;
                if (inputStream2 != null && this.closeStreamAfterReading) {
                    inputStream2.close();
                }
            ...
            EncryptedKeyset encryptedKeysetFromJson2 = encryptedKeysetFromJson(new JSONObject(new String(C20308Util.readAll(this.inputStream), UTF_8)));
            InputStream inputStream3 = this.inputStream;
            if (inputStream3 != null && this.closeStreamAfterReading) {
                inputStream3.close();
            }
