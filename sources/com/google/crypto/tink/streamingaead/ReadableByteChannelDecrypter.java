...
final class ReadableByteChannelDecrypter implements ReadableByteChannel {
    ...
    public synchronized int read(java.nio.ByteBuffer r4) throws java.io.IOException {
        /*
            r3 = this;
            monitor-enter(r3)
            int r0 = r4.remaining()     // Catch:{ all -> 0x0044 }
            r1 = 0
            if (r0 != 0) goto L_0x000a
            monitor-exit(r3)
            return r1
        L_0x000a:
            java.nio.channels.ReadableByteChannel r0 = r3.matchingChannel     // Catch:{ all -> 0x0044 }
            if (r0 == 0) goto L_0x0016
            java.nio.channels.ReadableByteChannel r0 = r3.matchingChannel     // Catch:{ all -> 0x0044 }
            int r4 = r0.read(r4)     // Catch:{ all -> 0x0044 }
            monitor-exit(r3)
            return r4
        L_0x0016:
            java.nio.channels.ReadableByteChannel r0 = r3.attemptingChannel     // Catch:{ all -> 0x0044 }
            if (r0 != 0) goto L_0x0020
            java.nio.channels.ReadableByteChannel r0 = r3.nextAttemptingChannel()     // Catch:{ all -> 0x0044 }
            r3.attemptingChannel = r0     // Catch:{ all -> 0x0044 }
        L_0x0020:
            java.nio.channels.ReadableByteChannel r0 = r3.attemptingChannel     // Catch:{ IOException -> 0x0038 }
            int r0 = r0.read(r4)     // Catch:{ IOException -> 0x0038 }
            if (r0 != 0) goto L_0x002a
            monitor-exit(r3)
            return r1
        L_0x002a:
            java.nio.channels.ReadableByteChannel r2 = r3.attemptingChannel     // Catch:{ IOException -> 0x0038 }
            r3.matchingChannel = r2     // Catch:{ IOException -> 0x0038 }
            r2 = 0
            r3.attemptingChannel = r2     // Catch:{ IOException -> 0x0038 }
            com.google.crypto.tink.subtle.RewindableReadableByteChannel r2 = r3.ciphertextChannel     // Catch:{ IOException -> 0x0038 }
            r2.disableRewinding()     // Catch:{ IOException -> 0x0038 }
            monitor-exit(r3)
            return r0
        L_0x0038:
            com.google.crypto.tink.subtle.RewindableReadableByteChannel r0 = r3.ciphertextChannel     // Catch:{ all -> 0x0044 }
            r0.rewind()     // Catch:{ all -> 0x0044 }
            java.nio.channels.ReadableByteChannel r0 = r3.nextAttemptingChannel()     // Catch:{ all -> 0x0044 }
            r3.attemptingChannel = r0     // Catch:{ all -> 0x0044 }
            goto L_0x0020
        L_0x0044:
