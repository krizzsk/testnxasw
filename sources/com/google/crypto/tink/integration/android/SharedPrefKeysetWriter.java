...
public final class SharedPrefKeysetWriter implements KeysetWriter {
    ...
    public SharedPrefKeysetWriter(Context context, String str, String str2) {
        if (str != null) {
            ...
            if (str2 == null) {
                this.editor = SystemUtils.getDefaultSharedPreferences(applicationContext).edit();
            } else {
                this.editor = SystemUtils.getSharedPreferences(applicationContext, str2, 0).edit();
            }
        } else {
