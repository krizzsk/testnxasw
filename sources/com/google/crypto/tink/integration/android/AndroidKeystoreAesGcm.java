...
public final class AndroidKeystoreAesGcm implements Aead {
    ...
    public byte[] encrypt(byte[] bArr, byte[] bArr2) throws GeneralSecurityException {
        try {
            ...
            SystemUtils.log(5, TAG, "encountered a potentially transient KeyStore error, will wait and retry", e, "com.google.crypto.tink.integration.android.AndroidKeystoreAesGcm", 70);
            sleep();
            return encryptInternal(bArr, bArr2);
        }
    }
    ...
    public byte[] decrypt(byte[] bArr, byte[] bArr2) throws GeneralSecurityException {
        try {
            ...
            SystemUtils.log(5, TAG, "encountered a potentially transient KeyStore error, will wait and retry", e, "com.google.crypto.tink.integration.android.AndroidKeystoreAesGcm", 99);
            sleep();
            return decryptInternal(bArr, bArr2);
        }
    }
