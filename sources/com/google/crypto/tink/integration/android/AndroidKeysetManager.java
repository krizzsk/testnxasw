...
public final class AndroidKeysetManager {
    ...
    public static final String TAG = AndroidKeysetManager.class.getSimpleName();
    private KeysetManager keysetManager;
    private final Aead masterKey;
    private final KeysetWriter writer;

    /* synthetic */ AndroidKeysetManager(Builder builder, C203361 r2) throws GeneralSecurityException, IOException {
        this(builder);
    }
    ...
    public static final class Builder {
        ...
        public synchronized AndroidKeysetManager build() throws GeneralSecurityException, IOException {
            ...
            return new AndroidKeysetManager(this, (C203361) null);
        }
        ...
        private Aead readOrGenerateNewMasterKey() throws GeneralSecurityException {
            ...
            if (!AndroidKeysetManager.isAtLeastM()) {
                SystemUtils.log(5, AndroidKeysetManager.TAG, "Android Keystore requires at least Android M", (Throwable) null, "com.google.crypto.tink.integration.android.AndroidKeysetManager$Builder", 245);
                return null;
            }
            ...
            if (!hasKey) {
                try {
                    ...
                    SystemUtils.log(5, AndroidKeysetManager.TAG, "cannot use Android Keystore, it'll be disabled", e, "com.google.crypto.tink.integration.android.AndroidKeysetManager$Builder", 261);
                    return null;
                }
            }
            try {
                ...
                Throwable th = e2;
                if (!hasKey) {
                    SystemUtils.log(5, AndroidKeysetManager.TAG, "cannot use Android Keystore, it'll be disabled", th, "com.google.crypto.tink.integration.android.AndroidKeysetManager$Builder", 279);
                    return null;
                }
                throw new KeyStoreException(String.format("the master key %s exists but is unusable", new Object[]{this.masterKeyUri}), th);
            }
        }
        ...
        private KeysetManager readOrGenerateNewKeyset() throws GeneralSecurityException, IOException {
            try {
                ...
                SystemUtils.log(5, AndroidKeysetManager.TAG, "keyset not found, will generate a new one", e, "com.google.crypto.tink.integration.android.AndroidKeysetManager$Builder", 290);
        ...
        private KeysetManager read() throws GeneralSecurityException, IOException {
            ...
            if (aead != null) {
                try {
                    ...
                    SystemUtils.log(5, AndroidKeysetManager.TAG, "cannot decrypt keyset: ", e, "com.google.crypto.tink.integration.android.AndroidKeysetManager$Builder", 324);
                }
            }
    ...
    static /* synthetic */ class C203361 {
        ...
        static {
            ...
            L_0x0033:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.google.crypto.tink.integration.android.AndroidKeysetManager.C203361.<clinit>():void");
        }
    }

    /* access modifiers changed from: private */
    public static KeyTemplate.OutputPrefixType fromProto(OutputPrefixType outputPrefixType) {
        int i = C203361.$SwitchMap$com$google$crypto$tink$proto$OutputPrefixType[outputPrefixType.ordinal()];
        if (i == 1) {
