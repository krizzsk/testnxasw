...
public final class RsaSsaPkcs1VerifyJce implements PublicKeyVerify {
    ...
    static /* synthetic */ class C205011 {
        ...
        static {
            ...
            L_0x001d:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.google.crypto.tink.subtle.RsaSsaPkcs1VerifyJce.C205011.<clinit>():void");
        }
    }

    private byte[] toAsnPrefix(Enums.HashType hashType) throws GeneralSecurityException {
        int i = C205011.$SwitchMap$com$google$crypto$tink$subtle$Enums$HashType[hashType.ordinal()];
        if (i == 1) {
