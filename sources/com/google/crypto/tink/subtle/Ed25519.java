...
final class Ed25519 {
    ...
    /* renamed from: eq */
    private static int m42706eq(int i, int i2) {
        int i3 = (~(i ^ i2)) & 255;
        int i4 = i3 & (i3 << 4);
        int i5 = i4 & (i4 << 2);
        return ((i5 & (i5 << 1)) >> 7) & 1;
    ...
    private static class XYZ {
        ...
        XYZ(XYZ xyz) {
            this.f56609x = Arrays.copyOf(xyz.f56609x, 10);
            this.f56610y = Arrays.copyOf(xyz.f56610y, 10);
            this.f56611z = Arrays.copyOf(xyz.f56611z, 10);
        }
        ...
        static XYZ fromPartialXYZT(XYZ xyz, PartialXYZT partialXYZT) {
            Field25519.mult(xyz.f56609x, partialXYZT.xyz.f56609x, partialXYZT.f56608t);
            Field25519.mult(xyz.f56610y, partialXYZT.xyz.f56610y, partialXYZT.xyz.f56611z);
            Field25519.mult(xyz.f56611z, partialXYZT.xyz.f56611z, partialXYZT.f56608t);
            return xyz;
        }
        ...
        public byte[] toBytes() {
            ...
            Field25519.inverse(jArr, this.f56611z);
            Field25519.mult(jArr2, this.f56609x, jArr);
            Field25519.mult(jArr3, this.f56610y, jArr);
        ...
        public boolean isOnCurve() {
            long[] jArr = new long[10];
            Field25519.square(jArr, this.f56609x);
            long[] jArr2 = new long[10];
            Field25519.square(jArr2, this.f56610y);
            long[] jArr3 = new long[10];
            Field25519.square(jArr3, this.f56611z);
            ...
            Field25519.mult(jArr6, jArr6, Ed25519Constants.f56614D);
    ...
    private static class XYZT {
        ...
        public static XYZT fromPartialXYZT(XYZT xyzt, PartialXYZT partialXYZT) {
            Field25519.mult(xyzt.xyz.f56609x, partialXYZT.xyz.f56609x, partialXYZT.f56608t);
            Field25519.mult(xyzt.xyz.f56610y, partialXYZT.xyz.f56610y, partialXYZT.xyz.f56611z);
            Field25519.mult(xyzt.xyz.f56611z, partialXYZT.xyz.f56611z, partialXYZT.f56608t);
            Field25519.mult(xyzt.f56612t, partialXYZT.xyz.f56609x, partialXYZT.xyz.f56610y);
            return xyzt;
        }
        ...
        public static XYZT fromBytesNegateVarTime(byte[] bArr) throws GeneralSecurityException {
            ...
            Field25519.mult(jArr5, jArr4, Ed25519Constants.f56614D);
    ...
    private static class PartialXYZT {
        ...
        PartialXYZT(PartialXYZT partialXYZT) {
            ...
            this.f56608t = Arrays.copyOf(partialXYZT.f56608t, 10);
        }
    }
    ...
    private static class CachedXYZT extends CachedXYT {
        ...
        CachedXYZT(XYZT xyzt) {
            this();
            Field25519.sum(this.yPlusX, xyzt.xyz.f56610y, xyzt.xyz.f56609x);
            Field25519.sub(this.yMinusX, xyzt.xyz.f56610y, xyzt.xyz.f56609x);
            System.arraycopy(xyzt.xyz.f56611z, 0, this.f56607z, 0, 10);
            Field25519.mult(this.t2d, xyzt.f56612t, Ed25519Constants.f56615D2);
        }
        ...
        public void multByZ(long[] jArr, long[] jArr2) {
            Field25519.mult(jArr, jArr2, this.f56607z);
        }
    }

    private static void add(PartialXYZT partialXYZT, XYZT xyzt, CachedXYT cachedXYT) {
        long[] jArr = new long[10];
        Field25519.sum(partialXYZT.xyz.f56609x, xyzt.xyz.f56610y, xyzt.xyz.f56609x);
        Field25519.sub(partialXYZT.xyz.f56610y, xyzt.xyz.f56610y, xyzt.xyz.f56609x);
        Field25519.mult(partialXYZT.xyz.f56610y, partialXYZT.xyz.f56610y, cachedXYT.yMinusX);
        Field25519.mult(partialXYZT.xyz.f56611z, partialXYZT.xyz.f56609x, cachedXYT.yPlusX);
        Field25519.mult(partialXYZT.f56608t, xyzt.f56612t, cachedXYT.t2d);
        cachedXYT.multByZ(partialXYZT.xyz.f56609x, xyzt.xyz.f56611z);
        Field25519.sum(jArr, partialXYZT.xyz.f56609x, partialXYZT.xyz.f56609x);
        Field25519.sub(partialXYZT.xyz.f56609x, partialXYZT.xyz.f56611z, partialXYZT.xyz.f56610y);
        Field25519.sum(partialXYZT.xyz.f56610y, partialXYZT.xyz.f56611z, partialXYZT.xyz.f56610y);
        Field25519.sum(partialXYZT.xyz.f56611z, jArr, partialXYZT.f56608t);
        Field25519.sub(partialXYZT.f56608t, jArr, partialXYZT.f56608t);
    }
    ...
    private static void sub(PartialXYZT partialXYZT, XYZT xyzt, CachedXYT cachedXYT) {
        ...
        Field25519.sum(partialXYZT.xyz.f56609x, xyzt.xyz.f56610y, xyzt.xyz.f56609x);
        Field25519.sub(partialXYZT.xyz.f56610y, xyzt.xyz.f56610y, xyzt.xyz.f56609x);
        Field25519.mult(partialXYZT.xyz.f56610y, partialXYZT.xyz.f56610y, cachedXYT.yPlusX);
        Field25519.mult(partialXYZT.xyz.f56611z, partialXYZT.xyz.f56609x, cachedXYT.yMinusX);
        Field25519.mult(partialXYZT.f56608t, xyzt.f56612t, cachedXYT.t2d);
        cachedXYT.multByZ(partialXYZT.xyz.f56609x, xyzt.xyz.f56611z);
        Field25519.sum(jArr, partialXYZT.xyz.f56609x, partialXYZT.xyz.f56609x);
        Field25519.sub(partialXYZT.xyz.f56609x, partialXYZT.xyz.f56611z, partialXYZT.xyz.f56610y);
        Field25519.sum(partialXYZT.xyz.f56610y, partialXYZT.xyz.f56611z, partialXYZT.xyz.f56610y);
        Field25519.sub(partialXYZT.xyz.f56611z, jArr, partialXYZT.f56608t);
        Field25519.sum(partialXYZT.f56608t, jArr, partialXYZT.f56608t);
    }

    private static void doubleXYZ(PartialXYZT partialXYZT, XYZ xyz) {
        long[] jArr = new long[10];
        Field25519.square(partialXYZT.xyz.f56609x, xyz.f56609x);
        Field25519.square(partialXYZT.xyz.f56611z, xyz.f56610y);
        Field25519.square(partialXYZT.f56608t, xyz.f56611z);
        Field25519.sum(partialXYZT.f56608t, partialXYZT.f56608t, partialXYZT.f56608t);
        Field25519.sum(partialXYZT.xyz.f56610y, xyz.f56609x, xyz.f56610y);
        Field25519.square(jArr, partialXYZT.xyz.f56610y);
        Field25519.sum(partialXYZT.xyz.f56610y, partialXYZT.xyz.f56611z, partialXYZT.xyz.f56609x);
        Field25519.sub(partialXYZT.xyz.f56611z, partialXYZT.xyz.f56611z, partialXYZT.xyz.f56609x);
        Field25519.sub(partialXYZT.xyz.f56609x, jArr, partialXYZT.xyz.f56610y);
        Field25519.sub(partialXYZT.f56608t, partialXYZT.f56608t, partialXYZT.xyz.f56611z);
    }
    ...
    private static void select(CachedXYT cachedXYT, int i, byte b) {
        int i2 = (b & 255) >> 7;
        int i3 = b - (((-i2) & b) << 1);
        cachedXYT.copyConditional(Ed25519Constants.B_TABLE[i][0], m42706eq(i3, 1));
        cachedXYT.copyConditional(Ed25519Constants.B_TABLE[i][1], m42706eq(i3, 2));
        cachedXYT.copyConditional(Ed25519Constants.B_TABLE[i][2], m42706eq(i3, 3));
        cachedXYT.copyConditional(Ed25519Constants.B_TABLE[i][3], m42706eq(i3, 4));
        cachedXYT.copyConditional(Ed25519Constants.B_TABLE[i][4], m42706eq(i3, 5));
        cachedXYT.copyConditional(Ed25519Constants.B_TABLE[i][5], m42706eq(i3, 6));
        cachedXYT.copyConditional(Ed25519Constants.B_TABLE[i][6], m42706eq(i3, 7));
        cachedXYT.copyConditional(Ed25519Constants.B_TABLE[i][7], m42706eq(i3, 8));
    ...
    private static XYZ doubleScalarMultVarTime(byte[] bArr, XYZT xyzt, byte[] bArr2) {
        ...
        while (i2 >= 0) {
            ...
            if (slide2[i2] > 0) {
                add(partialXYZT2, XYZT.fromPartialXYZT(xyzt3, partialXYZT2), Ed25519Constants.f56613B2[slide2[i2] / 2]);
            } else if (slide2[i2] < 0) {
                sub(partialXYZT2, XYZT.fromPartialXYZT(xyzt3, partialXYZT2), Ed25519Constants.f56613B2[(-slide2[i2]) / 2]);
            }
            i2--;
        }
