...
class Poly1305 {
    ...
    private static long load32(byte[] bArr, int i) {
        return ((long) (((bArr[i + 3] & 255) << Ascii.CAN) | (bArr[i] & 255) | ((bArr[i + 1] & 255) << 8) | ((bArr[i + 2] & 255) << 16))) & InternalZipConstants.ZIP_64_SIZE_LIMIT;
    }
    ...
    static byte[] computeMac(byte[] bArr, byte[] bArr2) {
        ...
        if (bArr3.length == 32) {
            ...
            long j28 = j17 + (j27 >> 26);
            long j29 = j19 + (j28 >> 26);
            long j30 = (j21 + (j29 >> 26)) - qqqqqy.bee0065e00650065;
            long j31 = j30 >> 63;
            long j32 = j23 & j31;
            long j33 = j24 & j31;
            long j34 = j17 & j31;
            ...
            long j41 = (j32 | (j26 & j37) | (j38 << 26)) & InternalZipConstants.ZIP_64_SIZE_LIMIT;
            long j42 = ((j38 >> 6) | (j39 << 20)) & InternalZipConstants.ZIP_64_SIZE_LIMIT;
            long j43 = ((j39 >> 12) | (j40 << 14)) & InternalZipConstants.ZIP_64_SIZE_LIMIT;
            long j44 = ((j40 >> 18) | (((j30 & j37) | j36) << 8)) & InternalZipConstants.ZIP_64_SIZE_LIMIT;
            long load32 = j41 + load32(bArr3, 16);
            long j45 = load32 & InternalZipConstants.ZIP_64_SIZE_LIMIT;
            long load322 = j42 + load32(bArr3, 20) + (load32 >> 32);
            long j46 = load322 & InternalZipConstants.ZIP_64_SIZE_LIMIT;
            long load323 = j43 + load32(bArr3, 24) + (load322 >> 32);
            long j47 = load323 & InternalZipConstants.ZIP_64_SIZE_LIMIT;
            long load324 = (j44 + load32(bArr3, 28) + (load323 >> 32)) & InternalZipConstants.ZIP_64_SIZE_LIMIT;
            byte[] bArr6 = new byte[16];
            toByteArray(bArr6, j45, 0);
            toByteArray(bArr6, j46, 4);
            toByteArray(bArr6, j47, 8);
