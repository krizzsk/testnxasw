...
public class Frame {
    ...
    public <T extends Trackable> Collection<T> getUpdatedTrackables(Class<T> cls) {
        Session.C20252c a = Session.C20252c.m42645a(cls);
        if (a == Session.C20252c.UNKNOWN_TO_JAVA) {
            return Collections.emptyList();
        }
        return this.session.convertNativeTrackablesToCollection(cls, nativeAcquireUpdatedTrackables(this.session.nativeWrapperHandle, this.nativeHandle, a.f56429b));
    }
