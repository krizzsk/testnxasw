...
public class ImageMetadata {
    ...
    private final C20245a sketchEntry;

    /* renamed from: com.google.ar.core.ImageMetadata$a */
    static class C20245a {
    ...
    public byte getByte(int i) {
        ...
        if (this.sketchEntry.f56382b == 0 && this.sketchEntry.f56383c == 1) {
            byte nativeGetByteFromMetadataEntry = nativeGetByteFromMetadataEntry(this.session.nativeWrapperHandle, this.sketchEntry.f56381a);
            nativeDestroyMetadataEntry(this.session.nativeWrapperHandle, this.sketchEntry.f56381a);
    ...
    public int getInt(int i) {
        getMetdataEntry(i, this.sketchEntry);
        if (this.sketchEntry.f56382b == 1 && this.sketchEntry.f56383c == 1) {
            int nativeGetIntFromMetadataEntry = nativeGetIntFromMetadataEntry(this.session.nativeWrapperHandle, this.sketchEntry.f56381a);
            nativeDestroyMetadataEntry(this.session.nativeWrapperHandle, this.sketchEntry.f56381a);
    ...
    public float getFloat(int i) {
        getMetdataEntry(i, this.sketchEntry);
        if (this.sketchEntry.f56382b == 2 && this.sketchEntry.f56383c == 1) {
            float nativeGetFloatFromMetadataEntry = nativeGetFloatFromMetadataEntry(this.session.nativeWrapperHandle, this.sketchEntry.f56381a);
            nativeDestroyMetadataEntry(this.session.nativeWrapperHandle, this.sketchEntry.f56381a);
    ...
    public long getLong(int i) {
        getMetdataEntry(i, this.sketchEntry);
        if (this.sketchEntry.f56382b == 3 && this.sketchEntry.f56383c == 1) {
            long nativeGetLongFromMetadataEntry = nativeGetLongFromMetadataEntry(this.session.nativeWrapperHandle, this.sketchEntry.f56381a);
            nativeDestroyMetadataEntry(this.session.nativeWrapperHandle, this.sketchEntry.f56381a);
            return nativeGetLongFromMetadataEntry;
        }
        throw new IllegalArgumentException(String.format("Wrong return type for ImageMetadata key: %1$d, type: %2$d, count: %3$d.", new Object[]{Integer.valueOf(i), Integer.valueOf(this.sketchEntry.f56382b), Integer.valueOf(this.sketchEntry.f56383c)}));
    }

    public double getDouble(int i) {
        getMetdataEntry(i, this.sketchEntry);
        if (this.sketchEntry.f56382b == 4 && this.sketchEntry.f56383c == 1) {
            double nativeGetDoubleFromMetadataEntry = nativeGetDoubleFromMetadataEntry(this.session.nativeWrapperHandle, this.sketchEntry.f56381a);
            nativeDestroyMetadataEntry(this.session.nativeWrapperHandle, this.sketchEntry.f56381a);
    ...
    public Rational getRational(int i) {
        getMetdataEntry(i, this.sketchEntry);
        if (this.sketchEntry.f56382b == 5 && this.sketchEntry.f56383c == 1) {
            Rational nativeGetRationalFromMetadataEntry = nativeGetRationalFromMetadataEntry(this.session.nativeWrapperHandle, this.sketchEntry.f56381a);
            nativeDestroyMetadataEntry(this.session.nativeWrapperHandle, this.sketchEntry.f56381a);
    ...
    public byte[] getByteArray(int i) {
        getMetdataEntry(i, this.sketchEntry);
        if (this.sketchEntry.f56382b == 0) {
            byte[] nativeGetByteArrayFromMetadataEntry = nativeGetByteArrayFromMetadataEntry(this.session.nativeWrapperHandle, this.sketchEntry.f56381a);
            nativeDestroyMetadataEntry(this.session.nativeWrapperHandle, this.sketchEntry.f56381a);
    ...
    public int[] getIntArray(int i) {
        getMetdataEntry(i, this.sketchEntry);
        if (this.sketchEntry.f56382b == 1) {
            int[] nativeGetIntArrayFromMetadataEntry = nativeGetIntArrayFromMetadataEntry(this.session.nativeWrapperHandle, this.sketchEntry.f56381a);
            nativeDestroyMetadataEntry(this.session.nativeWrapperHandle, this.sketchEntry.f56381a);
    ...
    public float[] getFloatArray(int i) {
        getMetdataEntry(i, this.sketchEntry);
        if (this.sketchEntry.f56382b == 2) {
            float[] nativeGetFloatArrayFromMetadataEntry = nativeGetFloatArrayFromMetadataEntry(this.session.nativeWrapperHandle, this.sketchEntry.f56381a);
            nativeDestroyMetadataEntry(this.session.nativeWrapperHandle, this.sketchEntry.f56381a);
    ...
    public long[] getLongArray(int i) {
        getMetdataEntry(i, this.sketchEntry);
        if (this.sketchEntry.f56382b == 3) {
            long[] nativeGetLongArrayFromMetadataEntry = nativeGetLongArrayFromMetadataEntry(this.session.nativeWrapperHandle, this.sketchEntry.f56381a);
            nativeDestroyMetadataEntry(this.session.nativeWrapperHandle, this.sketchEntry.f56381a);
    ...
    public double[] getDoubleArray(int i) {
        getMetdataEntry(i, this.sketchEntry);
        if (this.sketchEntry.f56382b == 4) {
            double[] nativeGetDoubleArrayFromMetadataEntry = nativeGetDoubleArrayFromMetadataEntry(this.session.nativeWrapperHandle, this.sketchEntry.f56381a);
            nativeDestroyMetadataEntry(this.session.nativeWrapperHandle, this.sketchEntry.f56381a);
    ...
    public Rational[] getRationalArray(int i) {
        getMetdataEntry(i, this.sketchEntry);
        if (this.sketchEntry.f56382b == 5) {
            Rational[] nativeGetRationalArrayFromMetadataEntry = nativeGetRationalArrayFromMetadataEntry(this.session.nativeWrapperHandle, this.sketchEntry.f56381a);
            nativeDestroyMetadataEntry(this.session.nativeWrapperHandle, this.sketchEntry.f56381a);
    ...
    private void getMetdataEntry(int i, C20245a aVar) {
        aVar.f56381a = nativeGetMetadataEntry(this.session.nativeWrapperHandle, this.nativeHandle, i);
        if (aVar.f56381a != 0) {
            aVar.f56382b = nativeGetMetadataEntryValueType(this.session.nativeWrapperHandle, aVar.f56381a);
            aVar.f56383c = nativeGetMetadataEntryValueCount(this.session.nativeWrapperHandle, aVar.f56381a);
            return;
        }
