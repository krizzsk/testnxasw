...
final class FieldParser {
    ...
    private static final Object[][] TWO_DIGIT_DATA_LENGTH = {new Object[]{"00", 18}, new Object[]{"01", 14}, new Object[]{"02", 14}, new Object[]{"10", VARIABLE_LENGTH, 20}, new Object[]{"11", 6}, new Object[]{"12", 6}, new Object[]{DiFaceLogger.EVENT_ID_BIOASSAY_ACTION_SUCCESS, 6}, new Object[]{DiFaceLogger.EVENT_ID_COMPARE_REQUEST_LAUNCH, 6}, new Object[]{DiFaceLogger.EVENT_ID_BIOASSAY_EXIT, 6}, new Object[]{"20", 2}, new Object[]{ScarShareReportModel.CHANNEL_FACEBOOK, VARIABLE_LENGTH, 20}, new Object[]{ScarShareReportModel.CHANNEL_WHATSAPP, VARIABLE_LENGTH, 29}, new Object[]{DiFaceLogger.EVENT_ID_APPEAL_DATA_SUBMIT_ENTER_PHOTO_DEMO_CHECK, VARIABLE_LENGTH, 8}, new Object[]{"37", VARIABLE_LENGTH, 8}, new Object[]{"90", VARIABLE_LENGTH, 30}, new Object[]{"91", VARIABLE_LENGTH, 30}, new Object[]{"92", VARIABLE_LENGTH, 30}, new Object[]{"93", VARIABLE_LENGTH, 30}, new Object[]{"94", VARIABLE_LENGTH, 30}, new Object[]{"95", VARIABLE_LENGTH, 30}, new Object[]{"96", VARIABLE_LENGTH, 30}, new Object[]{"97", VARIABLE_LENGTH, 30}, new Object[]{"98", VARIABLE_LENGTH, 30}, new Object[]{"99", VARIABLE_LENGTH, 30}};
    ...
    private static String processFixedAI(int i, int i2, String str) throws NotFoundException {
        if (str.length() >= i) {
            ...
            if (str.length() >= i3) {
                ...
                String str2 = "(" + substring + VersionRange.RIGHT_OPEN + substring2;
