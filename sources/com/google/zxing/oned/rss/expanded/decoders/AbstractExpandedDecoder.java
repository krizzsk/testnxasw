...
public abstract class AbstractExpandedDecoder {
    ...
    public static AbstractExpandedDecoder createDecoder(BitArray bitArray) {
        ...
        switch (GeneralAppIdDecoder.extractNumericValueFromBitArray(bitArray, 1, 7)) {
            ...
            case 58:
                return new AI013x0x1xDecoder(bitArray, "310", DiFaceLogger.EVENT_ID_BIOASSAY_ACTION_SUCCESS);
            case 59:
                return new AI013x0x1xDecoder(bitArray, "320", DiFaceLogger.EVENT_ID_BIOASSAY_ACTION_SUCCESS);
            case 60:
                return new AI013x0x1xDecoder(bitArray, "310", DiFaceLogger.EVENT_ID_COMPARE_REQUEST_LAUNCH);
            case 61:
                return new AI013x0x1xDecoder(bitArray, "320", DiFaceLogger.EVENT_ID_COMPARE_REQUEST_LAUNCH);
            case 62:
                return new AI013x0x1xDecoder(bitArray, "310", DiFaceLogger.EVENT_ID_BIOASSAY_EXIT);
            case 63:
                return new AI013x0x1xDecoder(bitArray, "320", DiFaceLogger.EVENT_ID_BIOASSAY_EXIT);
            default:
