...
public final class TypeAdapters {
    ...
    public static final TypeAdapterFactory ENUM_FACTORY = new TypeAdapterFactory() {
        ...
        public <T> com.google.gson.TypeAdapter<T> create(com.google.gson.Gson r1, com.google.gson.reflect.TypeToken<T> r2) {
            ...
            L_0x0021:
                ...
                return r1
            */
            throw new UnsupportedOperationException("Method not decompiled: com.google.gson.internal.bind.TypeAdapters.C1931530.create(com.google.gson.Gson, com.google.gson.reflect.TypeToken):com.google.gson.TypeAdapter");
        }
    };
    ...
    static {
        ...
        TypeAdapter<BitSet> nullSafe2 = new TypeAdapter<BitSet>() {
            ...
            public java.util.BitSet read(com.google.gson.stream.JsonReader r8) throws java.io.IOException {
                ...
                L_0x000e:
                    ...
                    int[] r4 = com.google.gson.internal.bind.TypeAdapters.C1932236.$SwitchMap$com$google$gson$stream$JsonToken
                    int r5 = r1.ordinal()
                    r4 = r4[r5]
                    r5 = 1
                ...
                L_0x0075:
                    ...
                    return r0
                */
                throw new UnsupportedOperationException("Method not decompiled: com.google.gson.internal.bind.TypeAdapters.C193022.read(com.google.gson.stream.JsonReader):java.util.BitSet");
            }
        ...
        C1929614 r0 = new TypeAdapter<Number>() {
            public Number read(JsonReader jsonReader) throws IOException {
                JsonToken peek = jsonReader.peek();
                int i = C1932236.$SwitchMap$com$google$gson$stream$JsonToken[peek.ordinal()];
                if (i == 1 || i == 3) {
        ...
        C1930119 r02 = new TypeAdapter<StringBuilder>() {
        ...
        C1930320 r03 = new TypeAdapter<StringBuffer>() {
        ...
        C1930421 r04 = new TypeAdapter<URL>() {
        ...
        C1930522 r05 = new TypeAdapter<URI>() {
        ...
        C1930623 r06 = new TypeAdapter<InetAddress>() {
        ...
        C1930724 r07 = new TypeAdapter<UUID>() {
        ...
        C1931127 r08 = new TypeAdapter<Calendar>() {
        ...
        C1931228 r09 = new TypeAdapter<Locale>() {
        ...
        C1931329 r010 = new TypeAdapter<JsonElement>() {
            public JsonElement read(JsonReader jsonReader) throws IOException {
                switch (C1932236.$SwitchMap$com$google$gson$stream$JsonToken[jsonReader.peek().ordinal()]) {
                    case 1:
    ...
    static /* synthetic */ class C1932236 {
        ...
        static {
            ...
            L_0x0078:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.google.gson.internal.bind.TypeAdapters.C1932236.<clinit>():void");
        }
    }
    ...
    public static <TT> TypeAdapterFactory newFactory(final Class<TT> cls, final TypeAdapter<TT> typeAdapter) {
        return new TypeAdapterFactory() {
            ...
            public String toString() {
                return "Factory[type=" + cls.getName() + ",adapter=" + typeAdapter + Const.jaRight;
            }
        };
    }
    ...
    public static <TT> TypeAdapterFactory newFactory(final Class<TT> cls, final Class<TT> cls2, final TypeAdapter<? super TT> typeAdapter) {
        return new TypeAdapterFactory() {
            ...
            public String toString() {
                return "Factory[type=" + cls2.getName() + "+" + cls.getName() + ",adapter=" + typeAdapter + Const.jaRight;
            }
        };
    }
    ...
    public static <TT> TypeAdapterFactory newFactoryForMultipleTypes(final Class<TT> cls, final Class<? extends TT> cls2, final TypeAdapter<? super TT> typeAdapter) {
        return new TypeAdapterFactory() {
            ...
            public String toString() {
                return "Factory[type=" + cls.getName() + "+" + cls2.getName() + ",adapter=" + typeAdapter + Const.jaRight;
            }
        };
    }
    ...
    public static <T1> TypeAdapterFactory newTypeHierarchyFactory(final Class<T1> cls, final TypeAdapter<T1> typeAdapter) {
        return new TypeAdapterFactory() {
            ...
            public String toString() {
                return "Factory[typeHierarchy=" + cls.getName() + ",adapter=" + typeAdapter + Const.jaRight;
            }
        };
    }
}
