...
public class JsonWriter implements Closeable, Flushable {
    ...
    public JsonWriter beginArray() throws IOException {
        writeDeferredName();
        return open(1, VersionRange.LEFT_CLOSED);
    }

    public JsonWriter endArray() throws IOException {
        return close(1, 2, VersionRange.RIGHT_CLOSED);
    }
    ...
    public JsonWriter value(boolean z) throws IOException {
        writeDeferredName();
        beforeValue();
        this.out.write(z ? "true" : SDKConsts.BOOLEAN_FALSE);
        return this;
    }
    ...
    public JsonWriter value(Boolean bool) throws IOException {
        ...
        writeDeferredName();
        beforeValue();
        this.out.write(bool.booleanValue() ? "true" : SDKConsts.BOOLEAN_FALSE);
        return this;
    }
