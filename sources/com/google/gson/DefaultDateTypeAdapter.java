...
final class DefaultDateTypeAdapter extends TypeAdapter<Date> {
    ...
    public String toString() {
        ...
        if (dateFormat instanceof SimpleDateFormat) {
            return "DefaultDateTypeAdapter(" + ((SimpleDateFormat) dateFormat).toPattern() + VersionRange.RIGHT_OPEN;
        }
        return "DefaultDateTypeAdapter(" + dateFormat.getClass().getSimpleName() + VersionRange.RIGHT_OPEN;
    }
}
