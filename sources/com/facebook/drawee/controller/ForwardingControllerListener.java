...
public class ForwardingControllerListener<INFO> implements ControllerListener<INFO> {
    ...
    /* renamed from: of */
    public static <INFO> ForwardingControllerListener<INFO> m40590of(ControllerListener<? super INFO> controllerListener) {
    ...
    /* renamed from: of */
    public static <INFO> ForwardingControllerListener<INFO> m40591of(ControllerListener<? super INFO> controllerListener, ControllerListener<? super INFO> controllerListener2) {
        ForwardingControllerListener<INFO> create = create();
        create.addListener(controllerListener);
    ...
    private synchronized void onException(String str, Throwable th) {
        SystemUtils.log(6, TAG, str, th, "com.facebook.drawee.controller.ForwardingControllerListener", 65);
    }
