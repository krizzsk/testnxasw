...
public class YogaValue {
    ...
    static /* synthetic */ class C185901 {
        ...
        static {
            ...
            L_0x0033:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.facebook.yoga.YogaValue.C185901.<clinit>():void");
        }
    }

    public String toString() {
        int i = C185901.$SwitchMap$com$facebook$yoga$YogaUnit[this.unit.ordinal()];
        if (i == 1) {
            return "undefined";
        }
        if (i == 2) {
