...
public final class MinElf {
    ...
    public static String[] extract_DT_NEEDED(File file) throws IOException {
        ...
        while (true) {
            ...
            try {
                ...
                if (i <= 3) {
                    Thread.interrupted();
                    SystemUtils.log(6, TAG, "retrying extract_DT_NEEDED due to ClosedByInterruptException", closedByInterruptException, "com.facebook.soloader.MinElf", 88);
                } else {
    ...
    public static String[] extract_DT_NEEDED(FileChannel fileChannel) throws IOException {
        ...
        long j12 = getu32(fileChannel2, allocate, 0);
        if (j12 == 1179403647) {
            boolean z = true;
            ...
            long j13 = z ? (long) getu16(fileChannel2, allocate, 44) : (long) getu16(fileChannel2, allocate, 56);
            int i = getu16(fileChannel2, allocate, z ? 42 : 54);
            if (j13 == 65535) {
                long r3 = z ? getu32(fileChannel2, allocate, 32) : get64(fileChannel2, allocate, 40);
                if (z) {
                    j11 = getu32(fileChannel2, allocate, r3 + 28);
                } else {
                    j11 = getu32(fileChannel2, allocate, r3 + 44);
                }
                j13 = j11;
            }
            long j14 = r15;
            ...
            while (true) {
                ...
                if (z) {
                    j10 = getu32(fileChannel2, allocate, j14 + 0);
                } else {
                    j10 = getu32(fileChannel2, allocate, j14 + 0);
                }
                if (j10 != 2) {
            ...
            if (j != 0) {
                ...
                while (true) {
                    boolean z2 = z;
                    long r7 = z ? getu32(fileChannel2, allocate, j17 + j16) : get64(fileChannel2, allocate, j17 + j16);
                    if (r7 == 1) {
                        j2 = j;
                        ...
                        if (r7 == 5) {
                            if (z2) {
                                j9 = getu32(fileChannel2, allocate, j17 + 4);
                            } else {
                                j9 = get64(fileChannel2, allocate, j17 + 8);
                            }
                            j18 = j9;
                        }
                    }
                    ...
                    if (r7 != 0) {
                        ...
                        while (true) {
                            ...
                            if (z2) {
                                j4 = getu32(fileChannel2, allocate, r15 + j16);
                            } else {
                                j4 = getu32(fileChannel2, allocate, r15 + j16);
                            }
                            if (j4 == 1) {
                                if (z2) {
                                    ...
                                    j6 = get64(fileChannel2, allocate, r15 + j19);
                                }
                                if (z2) {
                                    j5 = j13;
                        ...
                        if (j3 != 0) {
                            ...
                            while (true) {
                                long j21 = j2 + j20;
                                long r10 = z2 ? getu32(fileChannel2, allocate, j21) : get64(fileChannel2, allocate, j21);
                                if (r10 == 1) {
                                    strArr[i4] = getSz(fileChannel2, allocate, (z2 ? getu32(fileChannel2, allocate, j2 + 4) : get64(fileChannel2, allocate, j2 + 8)) + j3);
