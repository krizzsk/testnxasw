...
public class ApplicationSoSource extends SoSource {
    ...
    public ApplicationSoSource(Context context, int i) {
        ...
        if (applicationContext2 == null) {
            SystemUtils.log(5, "SoLoader", "context.getApplicationContext returned null, holding reference to original context.", (Throwable) null, "com.facebook.soloader.ApplicationSoSource", 38);
    ...
    public boolean checkAndMaybeUpdate() throws IOException {
        ...
        SystemUtils.log(3, "SoLoader", "Native library directory updated from " + file + " to " + nativeLibDirFromContext, (Throwable) null, "com.facebook.soloader.ApplicationSoSource", 60);
        int i = this.flags | 1;
        this.flags = i;
