...
public final class SysUtil {
    ...
    public static void deleteOrThrow(File file) throws IOException {
        ...
        if (parentFile != null && !parentFile.canWrite() && !parentFile.setWritable(true)) {
            SystemUtils.log(6, TAG, "Enable write permission failed: " + parentFile, (Throwable) null, "com.facebook.soloader.SysUtil", 66);
        }
    ...
    private static final class LollipopSysdeps {
        ...
        public static String[] getSupportedAbis() {
            ...
            try {
                ...
                SystemUtils.log(6, SysUtil.TAG, String.format("Could not read /proc/self/exe. Falling back to default ABI list: %s. errno: %d Err msg: %s", new Object[]{Arrays.toString(strArr), Integer.valueOf(e.errno), e.getMessage()}), (Throwable) null, "com.facebook.soloader.SysUtil$LollipopSysdeps", 152);
        ...
        public static boolean is64Bit() throws ErrnoException {
            return Os.readlink("/proc/self/exe").contains(DiFaceLogger.EVENT_ID_SUBMIT_MATERIALS_CALLBACK);
        }
    }
    ...
    public static int getAppVersionCode(Context context) {
        ...
        if (packageManager != null) {
            try {
                return SystemUtils.getPackageInfo(packageManager, context.getPackageName(), 0).versionCode;
    ...
    public static boolean is64Bit() {
        ...
        try {
            ...
            SystemUtils.log(6, TAG, String.format("Could not read /proc/self/exe. Err msg: %s", new Object[]{e.getMessage()}), (Throwable) null, "com.facebook.soloader.SysUtil", 326);
            return false;
        }
    }
}
