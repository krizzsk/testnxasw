...
public class GameRequestDialog extends FacebookDialogBase<GameRequestContent, Result> {
    ...
    public static final class Result {
        ...
        /* renamed from: to */
        List<String> f54606to;

        private Result(Bundle bundle) {
            this.requestId = bundle.getString("request");
            this.f54606to = new ArrayList();
            while (true) {
                if (bundle.containsKey(String.format(ShareConstants.WEB_DIALOG_RESULT_PARAM_TO_ARRAY_MEMBER, new Object[]{Integer.valueOf(this.f54606to.size())}))) {
                    List<String> list = this.f54606to;
        ...
        private Result(GraphResponse graphResponse) {
            try {
                ...
                for (int i = 0; i < jSONArray.length(); i++) {
                    this.f54606to.add(jSONArray.getString(i));
                }
    ...
    private void showForCloud(GameRequestContent gameRequestContent, Object obj) {
        ...
        C183993 r1 = new DaemonRequest.Callback() {
