...
@Metadata(mo148867d1 = {"\u0000\"\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\u0010\u000b\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u0004\n\u0000\u0018\u00002\u00020\u0001B\u0005¢\u0006\u0002\u0010\u0002J\u001e\u0010\u0003\u001a\n\u0012\u0004\u0012\u00020\u0005\u0018\u00010\u00042\u0006\u0010\u0006\u001a\u00020\u00072\u0006\u0010\b\u001a\u00020\t¨\u0006\n"}, mo148868d2 = {"Lcom/facebook/gamingservices/TournamentUpdater;", "", "()V", "update", "Lcom/facebook/bolts/TaskCompletionSource;", "", "tournament", "Lcom/facebook/gamingservices/Tournament;", "score", "", "facebook-gamingservices_release"}, mo148869k = 1, mo148870mv = {1, 5, 1}, mo148872xi = 48)
...
public final class TournamentUpdater {
    public final TaskCompletionSource<Boolean> update(Tournament tournament, Number number) {
        ...
        if (currentAccessToken.getGraphDomain() != null && Intrinsics.areEqual((Object) FacebookSdk.GAMING, (Object) currentAccessToken.getGraphDomain())) {
            ...
            String stringPlus = Intrinsics.stringPlus(tournament.getIdentifier(), "/update_score");
            ...
            new GraphRequest(currentAccessToken, stringPlus, bundle, HttpMethod.POST, new GraphRequest.Callback() {
                public final void onCompleted(GraphResponse graphResponse) {
                    TournamentUpdater.m47853update$lambda0(TaskCompletionSource.this, graphResponse);
                }
    ...
    public static final void m47853update$lambda0(com.facebook.bolts.TaskCompletionSource r3, com.facebook.GraphResponse r4) {
        /*
        ...
        L_0x0069:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.gamingservices.TournamentUpdater.m47853update$lambda0(com.facebook.bolts.TaskCompletionSource, com.facebook.GraphResponse):void");
    }
}
