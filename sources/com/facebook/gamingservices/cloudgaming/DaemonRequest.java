            ...
            public GraphResponse get() {
                ...
                try {
                    ...
                    if (!string.equals(SDKMessageEnum.GET_ACCESS_TOKEN.toString()) && !string.equals(SDKMessageEnum.IS_ENV_READY.toString())) {
                        String string2 = SystemUtils.getSharedPreferences(DaemonRequest.this.mContext, SDKConstants.PREF_DAEMON_PACKAGE_NAME, 0).getString(SDKConstants.PARAM_DAEMON_PACKAGE_NAME, (String) null);
                        if (string2 == null) {
