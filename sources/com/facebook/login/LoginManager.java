...
public class LoginManager {
    ...
    public final void registerCallback(CallbackManager callbackManager, FacebookCallback<LoginResult> facebookCallback) {
        if (callbackManager instanceof CallbackManagerImpl) {
            ((CallbackManagerImpl) callbackManager).registerCallback(CallbackManagerImpl.RequestCodeOffset.Login.toRequestCode(), new CallbackManagerImpl.Callback(facebookCallback) {
                ...
                public final boolean onActivityResult(int i, Intent intent) {
                    return LoginManager.m47925registerCallback$lambda0(LoginManager.this, this.f$1, i, intent);
                }
            });
            return;
        }
    ...
    public static final boolean m47925registerCallback$lambda0(LoginManager loginManager, FacebookCallback facebookCallback, int i, Intent intent) {
    ...
    private final void startLogin(StartActivityDelegate startActivityDelegate, LoginClient.Request request) throws FacebookException {
        ...
        CallbackManagerImpl.Companion.registerStaticCallback(CallbackManagerImpl.RequestCodeOffset.Login.toRequestCode(), new CallbackManagerImpl.Callback() {
            public final boolean onActivityResult(int i, Intent intent) {
                return LoginManager.m47927startLogin$lambda1(LoginManager.this, i, intent);
            }
        });
    ...
    public static final boolean m47927startLogin$lambda1(LoginManager loginManager, int i, Intent intent) {
        Intrinsics.checkNotNullParameter(loginManager, "this$0");
    ...
    private final void retrieveLoginStatusImpl(Context context, LoginStatusCallback loginStatusCallback, long j) {
        ...
        loginStatusClient.setCompletedListener(new PlatformServiceClient.CompletedListener(uuid, loginLogger, loginStatusCallback, applicationId) {
            ...
            public final void completed(Bundle bundle) {
                LoginManager.m47926retrieveLoginStatusImpl$lambda2(this.f$0, this.f$1, this.f$2, this.f$3, bundle);
            }
        });
    ...
    public static final void m47926retrieveLoginStatusImpl$lambda2(String str, LoginLogger loginLogger, LoginStatusCallback loginStatusCallback, String str2, Bundle bundle) {
        String str3 = str;
    ...
    private static final class AndroidxActivityResultRegistryOwnerStartActivityDelegate implements StartActivityDelegate {
        ...
        public void startActivityForResult(Intent intent, int i) {
            ...
            C18519x7971582c loginManager$AndroidxActivityResultRegistryOwnerStartActivityDelegate$startActivityForResult$LauncherHolder = new C18519x7971582c();
            loginManager$AndroidxActivityResultRegistryOwnerStartActivityDelegate$startActivityForResult$LauncherHolder.setLauncher(this.activityResultRegistryOwner.getActivityResultRegistry().register("facebook-login", new C18518x357b4191(), new ActivityResultCallback(loginManager$AndroidxActivityResultRegistryOwnerStartActivityDelegate$startActivityForResult$LauncherHolder) {
                public final /* synthetic */ C18519x7971582c f$1;
                ...
                public final void onActivityResult(Object obj) {
                    LoginManager.AndroidxActivityResultRegistryOwnerStartActivityDelegate.m47928startActivityForResult$lambda0(LoginManager.AndroidxActivityResultRegistryOwnerStartActivityDelegate.this, this.f$1, (Pair) obj);
                }
            }));
        ...
        public static final void m47928startActivityForResult$lambda0(AndroidxActivityResultRegistryOwnerStartActivityDelegate androidxActivityResultRegistryOwnerStartActivityDelegate, C18519x7971582c loginManager$AndroidxActivityResultRegistryOwnerStartActivityDelegate$startActivityForResult$LauncherHolder, Pair pair) {
    ...
    @Metadata(mo148867d1 = {"\u0000\u001a\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0000\bÂ\u0002\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002J\u0012\u0010\u0005\u001a\u0004\u0018\u00010\u00042\b\u0010\u0006\u001a\u0004\u0018\u00010\u0007R\u0010\u0010\u0003\u001a\u0004\u0018\u00010\u0004X\u000e¢\u0006\u0002\n\u0000¨\u0006\b"}, mo148868d2 = {"Lcom/facebook/login/LoginManager$LoginLoggerHolder;", "", "()V", "logger", "Lcom/facebook/login/LoginLogger;", "getLogger", "context", "Landroid/content/Context;", "facebook-common_release"}, mo148869k = 1, mo148870mv = {1, 5, 1}, mo148872xi = 48)
    /* compiled from: LoginManager.kt */
