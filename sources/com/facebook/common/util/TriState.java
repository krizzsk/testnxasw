...
public enum TriState {
    ...
    static /* synthetic */ class C183441 {
        ...
        static {
            ...
            L_0x0012:
                ...
                com.facebook.common.util.TriState r1 = com.facebook.common.util.TriState.f54603NO     // Catch:{ NoSuchFieldError -> 0x001d }
            ...
            L_0x0028:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.facebook.common.util.TriState.C183441.<clinit>():void");
        }
    }

    public boolean asBoolean() {
        int i = C183441.$SwitchMap$com$facebook$common$util$TriState[ordinal()];
        if (i == 1) {
            return true;
        }
        if (i == 2) {
