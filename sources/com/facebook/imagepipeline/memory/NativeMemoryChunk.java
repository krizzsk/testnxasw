...
public class NativeMemoryChunk implements MemoryChunk, Closeable {
    ...
    public void copy(int i, MemoryChunk memoryChunk, int i2, int i3) {
        ...
        if (memoryChunk.getUniqueId() == getUniqueId()) {
            SystemUtils.log(5, TAG, "Copying from NativeMemoryChunk " + Integer.toHexString(System.identityHashCode(this)) + " to NativeMemoryChunk " + Integer.toHexString(System.identityHashCode(memoryChunk)) + " which share the same address " + Long.toHexString(this.mNativePtr), (Throwable) null, "com.facebook.imagepipeline.memory.NativeMemoryChunk", 141);
    ...
    public void finalize() throws Throwable {
        if (!isClosed()) {
            SystemUtils.log(5, TAG, "finalize: Chunk " + Integer.toHexString(System.identityHashCode(this)) + " still active. ", (Throwable) null, "com.facebook.imagepipeline.memory.NativeMemoryChunk", 196);
            try {
                close();
            } finally {
                super.finalize();
