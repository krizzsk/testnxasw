...
public class BufferMemoryChunk implements MemoryChunk, Closeable {
    ...
    public void copy(int i, MemoryChunk memoryChunk, int i2, int i3) {
        ...
        if (memoryChunk.getUniqueId() == getUniqueId()) {
            SystemUtils.log(5, TAG, "Copying from BufferMemoryChunk " + Long.toHexString(getUniqueId()) + " to BufferMemoryChunk " + Long.toHexString(memoryChunk.getUniqueId()) + " which are the same ", (Throwable) null, "com.facebook.imagepipeline.memory.BufferMemoryChunk", 103);
