        ...
        public void onNewResultImpl(@Nullable EncodedImage encodedImage, int i) {
            if (!this.mIsCancelled) {
                ...
                if (encodedImage != null) {
                    TriState access$700 = ResizeAndRotateProducer.shouldTransform(this.mProducerContext.getImageRequest(), encodedImage, (ImageTranscoder) Preconditions.checkNotNull(this.mImageTranscoderFactory.createImageTranscoder(encodedImage.getImageFormat(), this.mIsResizingEnabled)));
        ...
        public void doTransform(EncodedImage encodedImage, int i, ImageTranscoder imageTranscoder) {
            ...
            try {
                ...
                if (transcode.getTranscodeStatus() != 2) {
                    ...
                    CloseableReference of = CloseableReference.m40588of(newOutputStream.toByteBuffer());
                    try {
