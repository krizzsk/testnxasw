...
public class LocalContentUriThumbnailFetchProducer extends LocalFetchProducer implements ThumbnailProducer<EncodedImage> {
    ...
    private static final String[] PROJECTION = {ShareDBHelper.ID_NAME, "_data"};
    ...
    private EncodedImage getCameraImage(Uri uri, ResizeOptions resizeOptions) throws IOException {
        ...
        try {
            ...
            if (resizeOptions == null || (thumbnail = getThumbnail(resizeOptions, query.getInt(query.getColumnIndex(ShareDBHelper.ID_NAME)))) == null) {
                query.close();
                return null;
            }
    ...
    private static int getRotationAngle(String str) {
        if (str != null) {
            try {
                ...
                FLog.m40523e(TAG, (Throwable) e, "Unable to retrieve thumbnail rotation for %s", str);
            }
        }
        return 0;
    }
