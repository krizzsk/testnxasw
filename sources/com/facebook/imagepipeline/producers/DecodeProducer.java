...
public class DecodeProducer implements Producer<CloseableReference<CloseableImage>> {
    ...
    public DecodeProducer(com.facebook.common.memory.ByteArrayPool r1, java.util.concurrent.Executor r2, com.facebook.imagepipeline.decoder.ImageDecoder r3, com.facebook.imagepipeline.decoder.ProgressiveJpegConfig r4, boolean r5, boolean r6, boolean r7, com.facebook.imagepipeline.producers.Producer<com.facebook.imagepipeline.image.EncodedImage> r8, int r9) {
        /*
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.imagepipeline.producers.DecodeProducer.<init>(com.facebook.common.memory.ByteArrayPool, java.util.concurrent.Executor, com.facebook.imagepipeline.decoder.ImageDecoder, com.facebook.imagepipeline.decoder.ProgressiveJpegConfig, boolean, boolean, boolean, com.facebook.imagepipeline.producers.Producer, int):void");
    }
    ...
    private abstract class ProgressiveDecoder extends DelegatingConsumer<EncodedImage, CloseableReference<CloseableImage>> {
        ...
        public void doDecode(com.facebook.imagepipeline.image.EncodedImage r19, int r20) {
            ...
            L_0x0100:
                ...
                com.facebook.common.logging.FLog.m40566w((java.lang.String) r3, (java.lang.String) r4, (java.lang.Object[]) r9)     // Catch:{ Exception -> 0x00fd }
        ...
        private void handleResult(CloseableImage closeableImage, int i) {
            CloseableReference of = CloseableReference.m40588of(closeableImage);
            try {
    ...
    private class LocalImagesProgressiveDecoder extends ProgressiveDecoder {
        ...
        public QualityInfo getQualityInfo() {
            return ImmutableQualityInfo.m40593of(0, false, false);
        }
    }
