...
public final class DefaultImageFormats {
    ...
    public static final ImageFormat GIF = new ImageFormat(TunaView.GRAPHICSTYPE_GIF, "gif");
    ...
    public static final ImageFormat PNG = new ImageFormat(TunaView.GRAPHICSTYPE_PNG, "png");
