...
public final class UserDataStore {
            ...
            try {
                ...
                FacebookSdk.getExecutor().execute(new Runnable(str, str2) {
                    ...
                    public final void run() {
                        UserDataStore.m47796writeDataIntoCache$lambda0(this.f$0, this.f$1);
                    }
                });
            } catch (Throwable th) {
    ...
    public static final void m47796writeDataIntoCache$lambda0(String str, String str2) {
        Class<UserDataStore> cls = UserDataStore.class;
        if (!CrashShieldHandler.isObjectCrashing(cls)) {
            try {
        ...
        if (!CrashShieldHandler.isObjectCrashing(cls)) {
            try {
                InternalAppEventsLogger.Companion.getAnalyticsExecutor().execute(new Runnable(bundle) {
                    ...
                    public final void run() {
                        UserDataStore.m47795setUserDataAndHash$lambda1(this.f$0);
                    }
                });
            } catch (Throwable th) {
                CrashShieldHandler.handleThrowable(th, cls);
    ...
    public static final void m47795setUserDataAndHash$lambda1(Bundle bundle) {
        Class<UserDataStore> cls = UserDataStore.class;
        if (!CrashShieldHandler.isObjectCrashing(cls)) {
            try {
                if (!initialized.get()) {
                    SystemUtils.log(5, TAG, "initStore should have been called before calling setUserData", (Throwable) null, "com.facebook.appevents.UserDataStore", 85);
                    INSTANCE.initAndWait();
                }
    ...
    public static final void m47793clear$lambda2() {
        Class<UserDataStore> cls = UserDataStore.class;
        if (!CrashShieldHandler.isObjectCrashing(cls)) {
            try {
                if (!initialized.get()) {
                    SystemUtils.log(5, TAG, "initStore should have been called before calling setUserData", (Throwable) null, "com.facebook.appevents.UserDataStore", 145);
                    INSTANCE.initAndWait();
                }
    ...
    public static final String getHashedUserData$facebook_core_release() {
        ...
        try {
            if (!initialized.get()) {
                SystemUtils.log(5, TAG, "initStore should have been called before calling setUserID", (Throwable) null, "com.facebook.appevents.UserDataStore", 156);
                INSTANCE.initAndWait();
            }
            Utility utility = Utility.INSTANCE;
    ...
    private final synchronized void initAndWait() {
        if (!CrashShieldHandler.isObjectCrashing(this)) {
            try {
                if (!initialized.get()) {
                    FacebookSdk facebookSdk = FacebookSdk.INSTANCE;
                    SharedPreferences defaultSharedPreferences = SystemUtils.getDefaultSharedPreferences(FacebookSdk.getApplicationContext());
        ...
        try {
            ...
            if (obj != null) {
                ...
                if (Intrinsics.areEqual((Object) "em", (Object) str)) {
                    ...
                    SystemUtils.log(6, TAG, "Setting email failure: this is not a valid email address", (Throwable) null, "com.facebook.appevents.UserDataStore", 259);
                    return "";
                    ...
                    if (!Intrinsics.areEqual((Object) "f", (Object) str3)) {
                        if (!Intrinsics.areEqual((Object) "m", (Object) str3)) {
                            SystemUtils.log(6, TAG, "Setting gender failure: the supported value for gender is f or m", (Throwable) null, "com.facebook.appevents.UserDataStore", 271);
                            return "";
                        }
                    }
                    return str3;
