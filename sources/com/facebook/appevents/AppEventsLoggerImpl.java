...
public final class AppEventsLoggerImpl {
        ...
        if (!CrashShieldHandler.isObjectCrashing(this)) {
            try {
                ...
                if (AutomaticAnalyticsLogger.isImplicitPurchaseLoggingEnabled()) {
                    SystemUtils.log(5, TAG, "You are logging purchase events while auto-logging of in-app purchase is enabled in the SDK. Make sure you don't log duplicate events", (Throwable) null, "com.facebook.appevents.AppEventsLoggerImpl", 117);
                }
        ...
        if (!CrashShieldHandler.isObjectCrashing(this)) {
            try {
                ...
                if (!StringsKt.startsWith$default(str, ACCOUNT_KIT_EVENT_NAME_PREFIX, false, 2, (Object) null)) {
                    SystemUtils.log(6, TAG, "logSdkEvent is deprecated and only supports account kit for legacy, please use logEvent instead", (Throwable) null, "com.facebook.appevents.AppEventsLoggerImpl", 268);
                    return;
                }
                FacebookSdk facebookSdk = FacebookSdk.INSTANCE;
    ...
    public static final class Companion {
        ...
        public final void functionDEPRECATED(String str) {
            ...
            SystemUtils.log(5, AppEventsLoggerImpl.access$getTAG$cp(), Intrinsics.stringPlus("This function is deprecated. ", str), (Throwable) null, "com.facebook.appevents.AppEventsLoggerImpl$Companion", 431);
        }
                ...
                if (access$getBackgroundExecutor$cp != null) {
                    access$getBackgroundExecutor$cp.execute(new Runnable(context, appEventsLoggerImpl) {
                        ...
                        public final void run() {
                            AppEventsLoggerImpl.Companion.m47784initializeLib$lambda4(this.f$0, this.f$1);
                        }
                    });
                    return;
                }
        ...
        public static final void m47784initializeLib$lambda4(Context context, AppEventsLoggerImpl appEventsLoggerImpl) {
            Intrinsics.checkNotNullParameter(context, "$context");
            ...
            SharedPreferences sharedPreferences = SystemUtils.getSharedPreferences(context, "com.facebook.sdk.appEventPreferences", 0);
        ...
        public final String getInstallReferrer() {
            ...
            FacebookSdk facebookSdk = FacebookSdk.INSTANCE;
            return SystemUtils.getSharedPreferences(FacebookSdk.getApplicationContext(), "com.facebook.sdk.appEventPreferences", 0).getString("install_referrer", (String) null);
        }

        @JvmStatic
        public final void setInstallReferrer(String str) {
            FacebookSdk facebookSdk = FacebookSdk.INSTANCE;
            SharedPreferences sharedPreferences = SystemUtils.getSharedPreferences(FacebookSdk.getApplicationContext(), "com.facebook.sdk.appEventPreferences", 0);
            if (str != null) {
        ...
        /* JADX WARNING: Code restructure failed: missing block: B:10:0x001b, code lost:
            r3 = com.facebook.appevents.C18292xd20d8340.INSTANCE;
        ...
        public final void initializeTimersIfNeeded() {
            ...
            L_0x000d:
                ...
                monitor-exit(r0)
                com.facebook.appevents.-$$Lambda$AppEventsLoggerImpl$Companion$BVyOVuKsF-eL5r9hStsFJI8nP-s r3 = com.facebook.appevents.C18292xd20d8340.INSTANCE
        ...
        public static final void m47785initializeTimersIfNeeded$lambda6() {
                ...
                synchronized (AppEventsLoggerImpl.access$getStaticLock$cp()) {
                    if (AppEventsLoggerImpl.access$getAnonymousAppDeviceGUID$cp() == null) {
                        ...
                        if (AppEventsLoggerImpl.access$getAnonymousAppDeviceGUID$cp() == null) {
                            ...
                            SystemUtils.getSharedPreferences(context, "com.facebook.sdk.appEventPreferences", 0).edit().putString("anonymousAppDeviceGUID", AppEventsLoggerImpl.access$getAnonymousAppDeviceGUID$cp()).apply();
                        }
                    }
                    Unit unit = Unit.INSTANCE;
                }
