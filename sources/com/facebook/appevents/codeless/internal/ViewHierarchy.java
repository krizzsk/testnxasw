...
public final class ViewHierarchy {
    ...
    public static final JSONObject getDictionaryOfView(View view) {
        ...
        try {
            ...
            SystemUtils.log(6, TAG, "Failed to create JSONObject for view.", e, "com.facebook.appevents.codeless.internal.ViewHierarchy", 213);
        } catch (Throwable th) {
            CrashShieldHandler.handleThrowable(th, cls);
            return null;
        }
    ...
    private final JSONObject getDimensionOfView(View view) {
        ...
        try {
            ...
            SystemUtils.log(6, TAG, "Failed to create JSONObject for dimension.", e, "com.facebook.appevents.codeless.internal.ViewHierarchy", 334);
        } catch (Throwable th) {
