...
public final class AppEventUtility {
    ...
    public static final String getAppVersion() {
        ...
        try {
            String str = SystemUtils.getPackageInfo(applicationContext.getPackageManager(), applicationContext.getPackageName(), 0).versionName;
