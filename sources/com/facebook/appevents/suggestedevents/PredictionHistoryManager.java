        ...
        if (!CrashShieldHandler.isObjectCrashing(this)) {
            try {
                if (!initialized.get()) {
                    ...
                    SharedPreferences sharedPreferences = SystemUtils.getSharedPreferences(FacebookSdk.getApplicationContext(), CLICKED_PATH_STORE, 0);
