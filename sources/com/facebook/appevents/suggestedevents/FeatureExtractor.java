...
public final class FeatureExtractor {
    ...
    public static final void initialize(File file) {
        ...
        if (!CrashShieldHandler.isObjectCrashing(cls)) {
            try {
                ...
                try {
                    languageInfo = MapsKt.mapOf(TuplesKt.m41339to(ViewHierarchyConstants.ENGLISH, "1"), TuplesKt.m41339to(ViewHierarchyConstants.GERMAN, "2"), TuplesKt.m41339to(ViewHierarchyConstants.SPANISH, "3"), TuplesKt.m41339to(ViewHierarchyConstants.JAPANESE, "4"));
                    eventInfo = MapsKt.mapOf(TuplesKt.m41339to(ViewHierarchyConstants.VIEW_CONTENT, "0"), TuplesKt.m41339to(ViewHierarchyConstants.SEARCH, "1"), TuplesKt.m41339to(ViewHierarchyConstants.ADD_TO_CART, "2"), TuplesKt.m41339to(ViewHierarchyConstants.ADD_TO_WISHLIST, "3"), TuplesKt.m41339to(ViewHierarchyConstants.INITIATE_CHECKOUT, "4"), TuplesKt.m41339to(ViewHierarchyConstants.ADD_PAYMENT_INFO, "5"), TuplesKt.m41339to(ViewHierarchyConstants.PURCHASE, "6"), TuplesKt.m41339to(ViewHierarchyConstants.LEAD, "7"), TuplesKt.m41339to(ViewHierarchyConstants.COMPLETE_REGISTRATION, "8"));
                    textTypeInfo = MapsKt.mapOf(TuplesKt.m41339to(ViewHierarchyConstants.BUTTON_TEXT, "1"), TuplesKt.m41339to(ViewHierarchyConstants.PAGE_TITLE, "2"), TuplesKt.m41339to(ViewHierarchyConstants.RESOLVED_DOCUMENT_LINK, "3"), TuplesKt.m41339to(ViewHierarchyConstants.BUTTON_ID, "4"));
                    initialized = true;
                } catch (Throwable th) {
                    CrashShieldHandler.handleThrowable(th, cls);
                }
    ...
    public static final String getTextFeature(String str, String str2, String str3) {
        ...
        try {
            ...
            Intrinsics.checkNotNullParameter(str3, AppsFlyerHelperKt.appLinkAppName);
    ...
    public static final float[] getDenseFeatures(JSONObject jSONObject, String str) {
        ...
        try {
            ...
            Intrinsics.checkNotNullParameter(str, AppsFlyerHelperKt.appLinkAppName);
            if (!initialized) {
                return null;
            }
    ...
    private final float[] parseFeatures(JSONObject jSONObject) {
        ...
        try {
            ...
            if (matchIndicators(new String[]{"$", "amount", "price", ParamConst.PARAM_TOTAL}, strArr)) {
                fArr[0] = fArr[0] + 1.0f;
            }
            ...
            if (matchIndicators(new String[]{"complete", XPanelScene.SCENE_CONFIRM, "done", NewGlobalPaymentStateView.TYPE_SUBMIT}, new String[]{lowerCase})) {
                fArr[10] = fArr[10] + 1.0f;
            }
            if (StringsKt.contains$default((CharSequence) lowerCase3, (CharSequence) "radio", false, 2, (Object) null) && StringsKt.contains$default((CharSequence) lowerCase3, (CharSequence) CarServerParam.PARAM_BUTTON, false, 2, (Object) null)) {
