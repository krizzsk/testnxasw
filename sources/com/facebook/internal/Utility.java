...
public final class Utility {
    ...
    @Metadata(mo148867d1 = {"\u0000\u001e\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0000\n\u0002\u0010\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0000\bf\u0018\u00002\u00020\u0001J\u0012\u0010\u0002\u001a\u00020\u00032\b\u0010\u0004\u001a\u0004\u0018\u00010\u0005H&J\u0012\u0010\u0006\u001a\u00020\u00032\b\u0010\u0007\u001a\u0004\u0018\u00010\bH&¨\u0006\t"}, mo148868d2 = {"Lcom/facebook/internal/Utility$GraphMeRequestWithCacheCallback;", "", "onFailure", "", "error", "Lcom/facebook/FacebookException;", "onSuccess", "userInfo", "Lorg/json/JSONObject;", "facebook-core_release"}, mo148869k = 1, mo148870mv = {1, 5, 1}, mo148872xi = 48)
    /* compiled from: Utility.kt */
    ...
    private final void clearCookiesForDomain(Context context, String str) {
        try {
            clearCookiesForDomain$delegate(context, str);
        } catch (Exception e) {
            Log.d("CookieSyncManager", "sync error", e);
        }
    }
    ...
    public static final Bundle parseUrlQueryString(String str) {
        ...
        if (!isNullOrEmpty(str)) {
            if (str != null) {
                Object[] array = StringsKt.split$default((CharSequence) str, new String[]{ParamKeys.SIGN_AND}, false, 0, 6, (Object) null).toArray(new String[0]);
                if (array != null) {
    ...
    private final void clearCookiesForDomain$delegate(Context context, String str) {
    ...
    public static final void logd(String str, Exception exc) {
        ...
        if (FacebookSdk.isDebugEnabled() && str != null && exc != null) {
            SystemUtils.log(3, str, exc.getClass().getSimpleName() + ": " + exc.getMessage(), (Throwable) null, "com.facebook.internal.Utility", 482);
        }
    }
    ...
    public static final void logd(String str, String str2) {
        ...
        if (FacebookSdk.isDebugEnabled() && str != null && str2 != null) {
            SystemUtils.log(3, str, str2, (Throwable) null, "com.facebook.internal.Utility", 489);
        }
    }
    ...
    public static final void logd(String str, String str2, Throwable th) {
        ...
        if (FacebookSdk.isDebugEnabled() && !isNullOrEmpty(str)) {
            SystemUtils.log(3, str, str2, th, "com.facebook.internal.Utility", 496);
        }
    }
    ...
    public static final String getAppVersion() {
        ...
        try {
            PackageInfo packageInfo = SystemUtils.getPackageInfo(applicationContext.getPackageManager(), applicationContext.getPackageName(), 0);
            if (packageInfo == null) {
                return null;
            }
    ...
    public static final void setAppEventExtendedDeviceInfoParameters(JSONObject jSONObject, Context context) throws JSONException {
        ...
        int i3 = -1;
        try {
            PackageInfo packageInfo = SystemUtils.getPackageInfo(context.getPackageManager(), packageName, 0);
            if (packageInfo != null) {
    ...
    public static final void getGraphMeRequestWithCacheAsync(String str, GraphMeRequestWithCacheCallback graphMeRequestWithCacheCallback) {
        ...
        $$Lambda$Utility$SiJuQsWBfR6TkJ4AVljhxBXsqfM r0 = new GraphRequest.Callback(str) {
            ...
            public final void onCompleted(GraphResponse graphResponse) {
                Utility.m47878getGraphMeRequestWithCacheAsync$lambda3(Utility.GraphMeRequestWithCacheCallback.this, this.f$1, graphResponse);
            }
        };
    ...
    public static final void m47878getGraphMeRequestWithCacheAsync$lambda3(GraphMeRequestWithCacheCallback graphMeRequestWithCacheCallback, String str, GraphResponse graphResponse) {
        Intrinsics.checkNotNullParameter(graphMeRequestWithCacheCallback, "$callback");
    ...
    public static final boolean m47879refreshBestGuessNumberOfCPUCores$lambda4(File file, String str) {
    ...
    private final void refreshAvailableExternalStorage() {
        try {
            if (externalStorageExists()) {
                StatFs statFs = new StatFs(SystemUtils.getExternalStorageDirectory().getPath());
    ...
    public static final JSONObject getDataProcessingOptions() {
        ...
        try {
            FacebookSdk facebookSdk = FacebookSdk.INSTANCE;
            String string = SystemUtils.getSharedPreferences(FacebookSdk.getApplicationContext(), FacebookSdk.DATA_PROCESSING_OPTIONS_PREFERENCES, 0).getString(FacebookSdk.DATA_PROCESSION_OPTIONS, (String) null);
            if (string != null) {
                try {
