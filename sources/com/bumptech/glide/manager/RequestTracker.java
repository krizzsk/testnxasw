...
public class RequestTracker {
    ...
    public void runRequest(Request request) {
        ...
        if (Log.isLoggable(TAG, 2)) {
            SystemUtils.log(2, TAG, "Paused, delaying request", (Throwable) null, "com.bumptech.glide.manager.RequestTracker", 45);
        }
    ...
    public void pauseRequests() {
        this.isPaused = true;
        for (T t : C1850Util.getSnapshot(this.requests)) {
            if (t.isRunning()) {
                t.pause();
    ...
    public void clearRequests() {
        for (T clearAndRemove : C1850Util.getSnapshot(this.requests)) {
