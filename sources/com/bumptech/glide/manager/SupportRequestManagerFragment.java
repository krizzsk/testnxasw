        ...
        if (rootFragmentManager != null) {
            try {
                ...
                if (Log.isLoggable(TAG, 5)) {
                    SystemUtils.log(5, TAG, "Unable to register fragment with root", illegalStateException, "com.bumptech.glide.manager.SupportRequestManagerFragment", 188);
                }
            }
        } else if (Log.isLoggable(TAG, 5)) {
            SystemUtils.log(5, TAG, "Unable to register fragment with root, ancestor detached", (Throwable) null, "com.bumptech.glide.manager.SupportRequestManagerFragment", 178);
        }
    }
