        ...
        public void loadData(Priority priority, DataFetcher.DataCallback<? super ByteBuffer> dataCallback) {
            try {
                ...
                if (Log.isLoggable(ByteBufferFileLoader.TAG, 3)) {
                    SystemUtils.log(3, ByteBufferFileLoader.TAG, "Failed to obtain ByteBuffer for file", e, "com.bumptech.glide.load.model.ByteBufferFileLoader$ByteBufferFetcher", 65);
                }
