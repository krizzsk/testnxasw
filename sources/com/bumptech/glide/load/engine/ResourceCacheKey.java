...
final class ResourceCacheKey implements Key {
    ...
    public boolean equals(Object obj) {
        ...
        if (this.height != resourceCacheKey.height || this.width != resourceCacheKey.width || !C1850Util.bothNullOrEqual(this.transformation, resourceCacheKey.transformation) || !this.decodedResourceClass.equals(resourceCacheKey.decodedResourceClass) || !this.sourceKey.equals(resourceCacheKey.sourceKey) || !this.signature.equals(resourceCacheKey.signature) || !this.options.equals(resourceCacheKey.options)) {
            return false;
        }
        return true;
    }
