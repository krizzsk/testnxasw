...
class EngineJob<R> implements DecodeJob.Callback<R>, FactoryPools.Poolable {
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:16:0x0055, code lost:
        r1 = r0.next();
        r1.executor.execute(new com.bumptech.glide.load.engine.EngineJob.CallResourceReady(r5, r1.f2162cb));
     */
    ...
    public void notifyCallbacksOfResult() {
        ...
        L_0x004f:
            ...
            com.bumptech.glide.request.ResourceCallback r1 = r1.f2162cb
            r3.<init>(r1)
            r2.execute(r3)
            goto L_0x004f
        L_0x0068:
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:16:0x003f, code lost:
        r1 = r0.next();
        r1.executor.execute(new com.bumptech.glide.load.engine.EngineJob.CallLoadFailed(r4, r1.f2162cb));
     */
    ...
    private class CallLoadFailed implements Runnable {
        ...
        /* renamed from: cb */
        private final ResourceCallback f2160cb;

        CallLoadFailed(ResourceCallback resourceCallback) {
            this.f2160cb = resourceCallback;
        }

        public void run() {
            synchronized (this.f2160cb.getLock()) {
                synchronized (EngineJob.this) {
                    if (EngineJob.this.cbs.contains(this.f2160cb)) {
                        EngineJob.this.callCallbackOnLoadFailed(this.f2160cb);
                    }
    ...
    private class CallResourceReady implements Runnable {
        ...
        /* renamed from: cb */
        private final ResourceCallback f2161cb;

        CallResourceReady(ResourceCallback resourceCallback) {
            this.f2161cb = resourceCallback;
        }

        public void run() {
            synchronized (this.f2161cb.getLock()) {
                synchronized (EngineJob.this) {
                    if (EngineJob.this.cbs.contains(this.f2161cb)) {
                        EngineJob.this.engineResource.acquire();
                        EngineJob.this.callCallbackOnResourceReady(this.f2161cb);
                        EngineJob.this.removeCallback(this.f2161cb);
                    }
                    EngineJob.this.decrementPendingCallbacks();
                }
            }
    ...
    static final class ResourceCallbackAndExecutor {
        ...
        /* renamed from: cb */
        final ResourceCallback f2162cb;
        final Executor executor;

        ResourceCallbackAndExecutor(ResourceCallback resourceCallback, Executor executor2) {
            this.f2162cb = resourceCallback;
            this.executor = executor2;
        }

        public boolean equals(Object obj) {
            if (obj instanceof ResourceCallbackAndExecutor) {
                return this.f2162cb.equals(((ResourceCallbackAndExecutor) obj).f2162cb);
            }
            return false;
        }

        public int hashCode() {
            return this.f2162cb.hashCode();
        }
    }
