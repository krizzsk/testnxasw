...
public class Engine implements EngineJobListener, EngineResource.ResourceListener, MemoryCache.ResourceRemovedListener {
    ...
    private static void logWithTimeAndKey(String str, long j, Key key) {
        SystemUtils.log(2, TAG, str + " in " + LogTime.getElapsedMillis(j) + "ms, key: " + key, (Throwable) null, "com.bumptech.glide.load.engine.Engine", 322);
    }
    ...
    public class LoadStatus {
        ...
        /* renamed from: cb */
        private final ResourceCallback f2159cb;
        private final EngineJob<?> engineJob;

        LoadStatus(ResourceCallback resourceCallback, EngineJob<?> engineJob2) {
            this.f2159cb = resourceCallback;
            this.engineJob = engineJob2;
        }

        public void cancel() {
            synchronized (Engine.this) {
                this.engineJob.removeCallback(this.f2159cb);
            }
        }
    }
