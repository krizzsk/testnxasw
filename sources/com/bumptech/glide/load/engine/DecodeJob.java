...
class DecodeJob<R> implements DataFetcherGenerator.FetcherReadyCallback, FactoryPools.Poolable, Comparable<DecodeJob<?>>, Runnable {
    ...
    private void runWrapped() {
        int i = C17991.$SwitchMap$com$bumptech$glide$load$engine$DecodeJob$RunReason[this.runReason.ordinal()];
        if (i == 1) {
    ...
    private DataFetcherGenerator getNextGenerator() {
        int i = C17991.$SwitchMap$com$bumptech$glide$load$engine$DecodeJob$Stage[this.stage.ordinal()];
        if (i == 1) {
    ...
    private Stage getNextStage(Stage stage2) {
        int i = C17991.$SwitchMap$com$bumptech$glide$load$engine$DecodeJob$Stage[stage2.ordinal()];
        if (i != 1) {
            if (i == 2) {
    ...
    private void logWithTimeAndKey(String str, long j, String str2) {
        ...
        SystemUtils.log(2, TAG, sb.toString(), (Throwable) null, "com.bumptech.glide.load.engine.DecodeJob", 547);
    }
    ...
    public <Z> com.bumptech.glide.load.engine.Resource<Z> onResourceDecoded(com.bumptech.glide.load.DataSource r12, com.bumptech.glide.load.engine.Resource<Z> r13) {
        ...
        L_0x0042:
            ...
            int[] r12 = com.bumptech.glide.load.engine.DecodeJob.C17991.$SwitchMap$com$bumptech$glide$load$EncodeStrategy
            int r1 = r13.ordinal()
            r12 = r12[r1]
    ...
    static /* synthetic */ class C17991 {
        ...
        static {
            ...
            L_0x007e:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.bumptech.glide.load.engine.DecodeJob.C17991.<clinit>():void");
        }
    }
