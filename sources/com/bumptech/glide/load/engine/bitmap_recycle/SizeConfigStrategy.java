...
public class SizeConfigStrategy implements LruPoolStrategy {
    ...
    public void put(Bitmap bitmap) {
        Key key = this.keyPool.get(C1850Util.getBitmapByteSize(bitmap), bitmap.getConfig());
    ...
    public Bitmap get(int i, int i2, Bitmap.Config config) {
        Key findBestKey = findBestKey(C1850Util.getBitmapByteSize(i, i2, config), config);
    ...
    public Bitmap removeLast() {
        ...
        if (removeLast != null) {
            decrementBitmapOfSize(Integer.valueOf(C1850Util.getBitmapByteSize(removeLast)), removeLast);
        }
        return removeLast;
    }
    ...
    public String logBitmap(Bitmap bitmap) {
        return getBitmapString(C1850Util.getBitmapByteSize(bitmap), bitmap.getConfig());
    }

    public String logBitmap(int i, int i2, Bitmap.Config config) {
        return getBitmapString(C1850Util.getBitmapByteSize(i, i2, config), config);
    }

    public int getSize(Bitmap bitmap) {
        return C1850Util.getBitmapByteSize(bitmap);
    }
    ...
    static final class Key implements Poolable {
        ...
        public boolean equals(Object obj) {
            ...
            Key key = (Key) obj;
            if (this.size != key.size || !C1850Util.bothNullOrEqual(this.config, key.config)) {
                return false;
            }
            return true;
        }
    ...
    private static Bitmap.Config[] getInConfigs(Bitmap.Config config) {
        ...
        int i = C18091.$SwitchMap$android$graphics$Bitmap$Config[config.ordinal()];
        if (i == 1) {
    ...
    static /* synthetic */ class C18091 {
        ...
        static {
            ...
            L_0x0033:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.bumptech.glide.load.engine.bitmap_recycle.SizeConfigStrategy.C18091.<clinit>():void");
        }
    }
}
