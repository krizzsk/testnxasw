...
public final class LruArrayPool implements ArrayPool {
    ...
    private <T> T getForKey(Key key, Class<T> cls) {
        ...
        if (Log.isLoggable(adapterFromType.getTag(), 2)) {
            SystemUtils.log(2, adapterFromType.getTag(), "Allocated " + key.size + " bytes", (Throwable) null, "com.bumptech.glide.load.engine.bitmap_recycle.LruArrayPool", 105);
        }
    ...
    private void evictToSize(int i) {
        while (this.currentSize > i) {
            ...
            if (Log.isLoggable(adapterFromObject.getTag(), 2)) {
                SystemUtils.log(2, adapterFromObject.getTag(), "evicted: " + adapterFromObject.getArrayLength(removeLast), (Throwable) null, "com.bumptech.glide.load.engine.bitmap_recycle.LruArrayPool", 159);
            }
        }
    }
