...
final class BitmapPreFillRunner implements Runnable {
    ...
    public boolean allocate() {
        ...
        while (!this.toPrefill.isEmpty() && !isGcDetected(now)) {
            ...
            int bitmapByteSize = C1850Util.getBitmapByteSize(bitmap);
            ...
            if (Log.isLoggable(TAG, 3)) {
                SystemUtils.log(3, TAG, "allocated [" + remove.getWidth() + "x" + remove.getHeight() + "] " + remove.getConfig() + " size: " + bitmapByteSize, (Throwable) null, "com.bumptech.glide.load.engine.prefill.BitmapPreFillRunner", 132);
            }
        }
