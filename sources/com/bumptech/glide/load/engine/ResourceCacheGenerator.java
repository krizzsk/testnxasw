...
class ResourceCacheGenerator implements DataFetcher.DataCallback<Object>, DataFetcherGenerator {
    ...
    /* renamed from: cb */
    private final DataFetcherGenerator.FetcherReadyCallback f2163cb;
    ...
    ResourceCacheGenerator(DecodeHelper<?> decodeHelper, DataFetcherGenerator.FetcherReadyCallback fetcherReadyCallback) {
        ...
        this.f2163cb = fetcherReadyCallback;
    }
    ...
    public void onDataReady(Object obj) {
        this.f2163cb.onDataFetcherReady(this.sourceKey, obj, this.loadData.fetcher, DataSource.RESOURCE_DISK_CACHE, this.currentKey);
    }

    public void onLoadFailed(Exception exc) {
        this.f2163cb.onDataFetcherFailed(this.currentKey, exc, this.loadData.fetcher, DataSource.RESOURCE_DISK_CACHE);
    }
}
