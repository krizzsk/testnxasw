...
public class VideoDecoder<T> implements ResourceDecoder<T, Bitmap> {
    ...
    private static Bitmap decodeScaledFrame(MediaMetadataRetriever mediaMetadataRetriever, long j, int i, int i2, int i3, DownsampleStrategy downsampleStrategy) {
        try {
            ...
            SystemUtils.log(3, TAG, "Exception trying to decode a scaled frame on oreo+, falling back to a fullsize frame", th2, "com.bumptech.glide.load.resource.bitmap.VideoDecoder", 276);
            return null;
        }
    }
