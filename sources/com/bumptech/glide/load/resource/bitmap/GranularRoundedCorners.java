...
public final class GranularRoundedCorners extends BitmapTransformation {
    ...
    /* renamed from: ID */
    private static final String f2170ID = "com.bumptech.glide.load.resource.bitmap.GranularRoundedCorners";
    private static final byte[] ID_BYTES = f2170ID.getBytes(CHARSET);
    ...
    public int hashCode() {
        return C1850Util.hashCode(this.bottomLeft, C1850Util.hashCode(this.bottomRight, C1850Util.hashCode(this.topRight, C1850Util.hashCode(-2013597734, C1850Util.hashCode(this.topLeft)))));
    }
