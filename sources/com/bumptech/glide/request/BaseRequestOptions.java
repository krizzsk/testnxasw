...
public abstract class BaseRequestOptions<T extends BaseRequestOptions<T>> implements Cloneable {
    ...
    public boolean equals(Object obj) {
        ...
        if (Float.compare(baseRequestOptions.sizeMultiplier, this.sizeMultiplier) == 0 && this.errorId == baseRequestOptions.errorId && C1850Util.bothNullOrEqual(this.errorPlaceholder, baseRequestOptions.errorPlaceholder) && this.placeholderId == baseRequestOptions.placeholderId && C1850Util.bothNullOrEqual(this.placeholderDrawable, baseRequestOptions.placeholderDrawable) && this.fallbackId == baseRequestOptions.fallbackId && C1850Util.bothNullOrEqual(this.fallbackDrawable, baseRequestOptions.fallbackDrawable) && this.isCacheable == baseRequestOptions.isCacheable && this.overrideHeight == baseRequestOptions.overrideHeight && this.overrideWidth == baseRequestOptions.overrideWidth && this.isTransformationRequired == baseRequestOptions.isTransformationRequired && this.isTransformationAllowed == baseRequestOptions.isTransformationAllowed && this.useUnlimitedSourceGeneratorsPool == baseRequestOptions.useUnlimitedSourceGeneratorsPool && this.onlyRetrieveFromCache == baseRequestOptions.onlyRetrieveFromCache && this.diskCacheStrategy.equals(baseRequestOptions.diskCacheStrategy) && this.priority == baseRequestOptions.priority && this.options.equals(baseRequestOptions.options) && this.transformations.equals(baseRequestOptions.transformations) && this.resourceClass.equals(baseRequestOptions.resourceClass) && C1850Util.bothNullOrEqual(this.signature, baseRequestOptions.signature) && C1850Util.bothNullOrEqual(this.theme, baseRequestOptions.theme)) {
            return true;
        }
        return false;
    }
    ...
    public int hashCode() {
        return C1850Util.hashCode((Object) this.theme, C1850Util.hashCode((Object) this.signature, C1850Util.hashCode((Object) this.resourceClass, C1850Util.hashCode((Object) this.transformations, C1850Util.hashCode((Object) this.options, C1850Util.hashCode((Object) this.priority, C1850Util.hashCode((Object) this.diskCacheStrategy, C1850Util.hashCode(this.onlyRetrieveFromCache, C1850Util.hashCode(this.useUnlimitedSourceGeneratorsPool, C1850Util.hashCode(this.isTransformationAllowed, C1850Util.hashCode(this.isTransformationRequired, C1850Util.hashCode(this.overrideWidth, C1850Util.hashCode(this.overrideHeight, C1850Util.hashCode(this.isCacheable, C1850Util.hashCode((Object) this.fallbackDrawable, C1850Util.hashCode(this.fallbackId, C1850Util.hashCode((Object) this.placeholderDrawable, C1850Util.hashCode(this.placeholderId, C1850Util.hashCode((Object) this.errorPlaceholder, C1850Util.hashCode(this.errorId, C1850Util.hashCode(this.sizeMultiplier)))))))))))))))))))));
    }
    ...
    public final boolean isValidOverride() {
        return C1850Util.isValidDimensions(this.overrideWidth, this.overrideHeight);
    }
