...
public final class SingleRequest<R> implements Request, ResourceCallback, SizeReadyCallback {
    ...
    public void begin() {
        /*
            ...
            boolean r1 = com.bumptech.glide.util.C1850Util.isValidDimensions(r1, r2)     // Catch:{ all -> 0x00bd }
    ...
    public void clear() {
        /*
            ...
            java.lang.Object r0 = r4.requestLock
            monitor-enter(r0)
            r4.assertNotCallingCallbacks()     // Catch:{ all -> 0x0043 }
            com.bumptech.glide.util.pool.StateVerifier r1 = r4.stateVerifier     // Catch:{ all -> 0x0043 }
            r1.throwIfRecycled()     // Catch:{ all -> 0x0043 }
            com.bumptech.glide.request.SingleRequest$Status r1 = r4.status     // Catch:{ all -> 0x0043 }
            com.bumptech.glide.request.SingleRequest$Status r2 = com.bumptech.glide.request.SingleRequest.Status.CLEARED     // Catch:{ all -> 0x0043 }
            if (r1 != r2) goto L_0x0013
            monitor-exit(r0)     // Catch:{ all -> 0x0043 }
            return
        L_0x0013:
            r4.cancel()     // Catch:{ all -> 0x0043 }
            com.bumptech.glide.load.engine.Resource<R> r1 = r4.resource     // Catch:{ all -> 0x0043 }
            r2 = 0
            if (r1 == 0) goto L_0x0020
            com.bumptech.glide.load.engine.Resource<R> r1 = r4.resource     // Catch:{ all -> 0x0043 }
            r4.resource = r2     // Catch:{ all -> 0x0043 }
            r2 = r1
        L_0x0020:
            boolean r1 = r4.canNotifyCleared()     // Catch:{ all -> 0x0043 }
            if (r1 == 0) goto L_0x002f
            com.bumptech.glide.request.target.Target<R> r1 = r4.target     // Catch:{ all -> 0x0043 }
            android.graphics.drawable.Drawable r3 = r4.getPlaceholderDrawable()     // Catch:{ all -> 0x0043 }
            r1.onLoadCleared(r3)     // Catch:{ all -> 0x0043 }
        L_0x002f:
            java.lang.String r1 = "GlideRequest"
            int r3 = r4.cookie     // Catch:{ all -> 0x0043 }
            com.bumptech.glide.util.pool.GlideTrace.endSectionAsync(r1, r3)     // Catch:{ all -> 0x0043 }
            com.bumptech.glide.request.SingleRequest$Status r1 = com.bumptech.glide.request.SingleRequest.Status.CLEARED     // Catch:{ all -> 0x0043 }
            r4.status = r1     // Catch:{ all -> 0x0043 }
            monitor-exit(r0)     // Catch:{ all -> 0x0043 }
    ...
    /* JADX WARNING: Removed duplicated region for block: B:20:0x00b1 A[Catch:{ all -> 0x00c9 }] */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    private void onResourceReady(com.bumptech.glide.load.engine.Resource<R> r10, R r11, com.bumptech.glide.load.DataSource r12, boolean r13) {
        /*
            ...
            java.lang.String r5 = "com.bumptech.glide.request.SingleRequest"
            com.didi.sdk.apm.SystemUtils.log(r1, r2, r3, r4, r5, r6)
        L_0x0070:
            r10 = 1
            r9.isCallingCallbacks = r10
            r6 = 0
            java.util.List<com.bumptech.glide.request.RequestListener<R>> r0 = r9.requestListeners     // Catch:{ all -> 0x00c9 }
            if (r0 == 0) goto L_0x0098
            java.util.List<com.bumptech.glide.request.RequestListener<R>> r0 = r9.requestListeners     // Catch:{ all -> 0x00c9 }
            java.util.Iterator r7 = r0.iterator()     // Catch:{ all -> 0x00c9 }
            r8 = 0
        L_0x007f:
            boolean r0 = r7.hasNext()     // Catch:{ all -> 0x00c9 }
            if (r0 == 0) goto L_0x0099
            java.lang.Object r0 = r7.next()     // Catch:{ all -> 0x00c9 }
            com.bumptech.glide.request.RequestListener r0 = (com.bumptech.glide.request.RequestListener) r0     // Catch:{ all -> 0x00c9 }
            java.lang.Object r2 = r9.model     // Catch:{ all -> 0x00c9 }
            com.bumptech.glide.request.target.Target<R> r3 = r9.target     // Catch:{ all -> 0x00c9 }
            r1 = r11
            r4 = r12
            r5 = r13
            boolean r0 = r0.onResourceReady(r1, r2, r3, r4, r5)     // Catch:{ all -> 0x00c9 }
            r8 = r8 | r0
            goto L_0x007f
        L_0x0098:
            r8 = 0
        L_0x0099:
            com.bumptech.glide.request.RequestListener<R> r0 = r9.targetListener     // Catch:{ all -> 0x00c9 }
        ...
        L_0x00ae:
            ...
            com.bumptech.glide.request.transition.TransitionFactory<? super R> r10 = r9.animationFactory     // Catch:{ all -> 0x00c9 }
            com.bumptech.glide.request.transition.Transition r10 = r10.build(r12, r13)     // Catch:{ all -> 0x00c9 }
            com.bumptech.glide.request.target.Target<R> r12 = r9.target     // Catch:{ all -> 0x00c9 }
            r12.onResourceReady(r11, r10)     // Catch:{ all -> 0x00c9 }
        L_0x00bc:
    ...
    private void onLoadFailed(GlideException glideException, int i) {
        ...
        synchronized (this.requestLock) {
            ...
            if (logLevel <= i) {
                SystemUtils.log(5, "Glide", "Load failed for " + this.model + " with size [" + this.width + "x" + this.height + Const.jaRight, glideException, "com.bumptech.glide.request.SingleRequest", 685);
                if (logLevel <= 4) {
    ...
    public boolean isEquivalentTo(Request request) {
        ...
        return i == i3 && i2 == i4 && C1850Util.bothModelsNullEquivalentOrEquals(obj, obj2) && cls.equals(cls2) && baseRequestOptions.equals(baseRequestOptions2) && priority2 == priority3 && size == size2;
    }

    private void logV(String str) {
        SystemUtils.log(2, TAG, str + " this: " + this.tag, (Throwable) null, "com.bumptech.glide.request.SingleRequest", 778);
    }
    ...
    public String toString() {
        ...
        return super.toString() + "[model=" + obj + ", transcodeClass=" + cls + Const.jaRight;
    }
}
