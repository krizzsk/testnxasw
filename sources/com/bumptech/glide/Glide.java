...
public class Glide implements ComponentCallbacks2 {
    ...
    public static File getPhotoCacheDir(Context context, String str) {
        ...
        if (Log.isLoggable("Glide", 6)) {
            SystemUtils.log(6, "Glide", "default disk cache dir is null", (Throwable) null, "com.bumptech.glide.Glide", 174);
        }
        return null;
    }
    ...
    private static void initializeGlide(Context context, GlideBuilder glideBuilder, GeneratedAppGlideModule generatedAppGlideModule) {
        GlideBuilder glideBuilder2 = glideBuilder;
        GeneratedAppGlideModule generatedAppGlideModule2 = generatedAppGlideModule;
        Context applicationContext = context.getApplicationContext();
        List<GlideModule> emptyList = Collections.emptyList();
        if (generatedAppGlideModule2 == null || generatedAppGlideModule.isManifestParsingEnabled()) {
            emptyList = new ManifestParser(applicationContext).parse();
        }
        if (generatedAppGlideModule2 != null && !generatedAppGlideModule.getExcludedModuleClasses().isEmpty()) {
            ...
            while (it.hasNext()) {
                ...
                if (excludedModuleClasses.contains(next.getClass())) {
                    if (Log.isLoggable("Glide", 3)) {
                        SystemUtils.log(3, "Glide", "AppGlideModule excludes manifest GlideModule: " + next, (Throwable) null, "com.bumptech.glide.Glide", 293);
                    }
                    it.remove();
                }
            }
        ...
        if (Log.isLoggable("Glide", 3)) {
            for (GlideModule glideModule : emptyList) {
                SystemUtils.log(3, "Glide", "Discovered GlideModule from manifest: " + glideModule.getClass(), (Throwable) null, "com.bumptech.glide.Glide", 301);
            }
        }
        glideBuilder2.setRequestManagerFactory(generatedAppGlideModule2 != null ? generatedAppGlideModule.getRequestManagerFactory() : null);
        for (GlideModule applyOptions : emptyList) {
            applyOptions.applyOptions(applicationContext, glideBuilder2);
        }
        if (generatedAppGlideModule2 != null) {
            generatedAppGlideModule2.applyOptions(applicationContext, glideBuilder2);
        }
        Glide build = glideBuilder2.build(applicationContext);
        ...
        if (generatedAppGlideModule2 != null) {
            generatedAppGlideModule2.registerComponents(applicationContext, build, build.registry);
        }
    ...
    private static GeneratedAppGlideModule getAnnotationGeneratedGlideModules(Context context) {
        try {
            ...
            if (Log.isLoggable("Glide", 5)) {
                SystemUtils.log(5, "Glide", "Failed to find GeneratedAppGlideModule. You should include an annotationProcessor compile dependency on com.github.bumptech.glide:compiler in your application and a @GlideModule annotated AppGlideModule implementation or LibraryGlideModules will be silently ignored", (Throwable) null, "com.bumptech.glide.Glide", 349);
            }
    ...
    Glide(Context context, Engine engine2, MemoryCache memoryCache2, BitmapPool bitmapPool2, ArrayPool arrayPool2, RequestManagerRetriever requestManagerRetriever2, ConnectivityMonitorFactory connectivityMonitorFactory2, int i, RequestOptionsFactory requestOptionsFactory, Map<Class<?>, TransitionOptions<?, ?>> map, List<RequestListener<Object>> list, GlideExperiments glideExperiments) {
        ...
        if (Build.VERSION.SDK_INT < 28 || !glideExperiments2.isEnabled(GlideBuilder.EnableImageDecoderForAnimatedWebp.class)) {
            ...
            cls = cls2;
            this.registry.append("Animation", InputStream.class, Drawable.class, AnimatedWebpDecoder.streamDecoder(imageHeaderParsers, arrayPool3));
            this.registry.append("Animation", ByteBuffer.class, Drawable.class, AnimatedWebpDecoder.byteBufferDecoder(imageHeaderParsers, arrayPool3));
        }
        ...
        this.registry.append(ByteBuffer.class, new ByteBufferEncoder()).append(InputStream.class, new StreamEncoder(arrayPool3)).append(Registry.BUCKET_BITMAP, ByteBuffer.class, Bitmap.class, resourceDecoder).append(Registry.BUCKET_BITMAP, InputStream.class, Bitmap.class, resourceDecoder2);
        ...
        this.glideContext = new GlideContext(context4, arrayPool4, this.registry, new ImageViewTargetFactory(), requestOptionsFactory, map, list, engine2, glideExperiments, i);
    }
    ...
    public void clearDiskCache() {
        C1850Util.assertBackgroundThread();
