...
/* renamed from: com.bumptech.glide.util.Util */
public final class C1850Util {
    ...
    public static int getBitmapByteSize(Bitmap bitmap) {
        ...
        throw new IllegalStateException("Cannot obtain size for recycled Bitmap: " + bitmap + Const.jaLeft + bitmap.getWidth() + "x" + bitmap.getHeight() + "] " + bitmap.getConfig());
    }
    ...
    public static int getBytesPerPixel(Bitmap.Config config) {
        ...
        int i = C18511.$SwitchMap$android$graphics$Bitmap$Config[config.ordinal()];
        if (i == 1) {
            return 1;
        }
        if (i == 2 || i == 3) {
    ...
    static /* synthetic */ class C18511 {
        ...
        static {
            ...
            L_0x003e:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.bumptech.glide.util.C1850Util.C18511.<clinit>():void");
        }
    }
