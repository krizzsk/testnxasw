...
class StrictLineReader implements Closeable {
    ...
    /* renamed from: CR */
    private static final byte f2145CR = 13;

    /* renamed from: LF */
    private static final byte f2146LF = 10;
    private byte[] buf;
    ...
    /* renamed from: in */
    private final InputStream f2147in;
    private int pos;
    ...
    public StrictLineReader(InputStream inputStream, int i, Charset charset2) {
        ...
        } else if (charset2.equals(C1769Util.US_ASCII)) {
            this.f2147in = inputStream;
    ...
    public String readLine() throws IOException {
        ...
        synchronized (this.f2147in) {
            if (this.buf != null) {
                ...
                C17681 r1 = new ByteArrayOutputStream((this.end - this.pos) + 80) {
    ...
    private void fillBuf() throws IOException {
        InputStream inputStream = this.f2147in;
        byte[] bArr = this.buf;
