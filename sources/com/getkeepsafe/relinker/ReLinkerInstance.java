...
public class ReLinkerInstance {
    ...
    /* renamed from: a */
    private static final String f54762a = "lib";
    ...
    protected ReLinkerInstance() {
        this(new C18612a(), new ApkLibraryInstaller());
    }
    ...
    public void loadLibrary(Context context, String str, String str2, ReLinker.LoadListener loadListener) {
        if (context == null) {
        ...
        } else if (!C18613b.m40682a(str)) {
            log("Beginning load of %s...", str);
            if (loadListener == null) {
                m40680a(context, str, str2);
                return;
            }
            ...
            new Thread(new Runnable() {
                public void run() {
                    try {
                        ReLinkerInstance.this.m40680a(context2, str3, str4);
    ...
    /* renamed from: a */
    public void m40680a(Context context, String str, String str2) {
        ElfParser elfParser;
    ...
    public File getWorkaroundLibDir(Context context) {
        return context.getDir(f54762a, 0);
    }
