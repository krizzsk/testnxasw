...
public class Task<TResult> {
    public static final ExecutorService BACKGROUND_EXECUTOR = BoltsExecutors.m919a();
    public static final Executor UI_THREAD_EXECUTOR = AndroidExecutors.m918b();

    /* renamed from: a */
    private static final Executor f414a = BoltsExecutors.m921c();

    /* renamed from: b */
    private static volatile UnobservedExceptionHandler f415b;

    /* renamed from: k */
    private static Task<?> f416k = new Task<>((Object) null);

    /* renamed from: l */
    private static Task<Boolean> f417l = new Task<>(true);

    /* renamed from: m */
    private static Task<Boolean> f418m = new Task<>(false);

    /* renamed from: n */
    private static Task<?> f419n = new Task<>(true);
    ...
    /* renamed from: f */
    private TResult f423f;

    /* renamed from: g */
    private Exception f424g;

    /* renamed from: h */
    private boolean f425h;

    /* renamed from: i */
    private C1249a f426i;

    /* renamed from: j */
    private List<Continuation<TResult, Void>> f427j = new ArrayList();
    ...
    public static void setUnobservedExceptionHandler(UnobservedExceptionHandler unobservedExceptionHandler) {
        f415b = unobservedExceptionHandler;
    }
    ...
    public boolean waitForCompletion(long j, TimeUnit timeUnit) throws InterruptedException {
        ...
        synchronized (this.f420c) {
            if (!isCompleted()) {
                this.f420c.wait(timeUnit.toMillis(j));
            }
    ...
    public static <TResult> Task<TResult> forResult(TResult tresult) {
        ...
        if (tresult instanceof Boolean) {
            return ((Boolean) tresult).booleanValue() ? f417l : f418m;
        }
    ...
    public static Task<Void> delay(long j) {
        return m934a(j, BoltsExecutors.m920b(), (CancellationToken) null);
    }

    public static Task<Void> delay(long j, CancellationToken cancellationToken) {
        return m934a(j, BoltsExecutors.m920b(), cancellationToken);
    }

    /* renamed from: a */
    static Task<Void> m934a(long j, ScheduledExecutorService scheduledExecutorService, CancellationToken cancellationToken) {
    ...
    public Task<Void> continueWhile(Callable<Boolean> callable, Continuation<Void, Task<Void>> continuation) {
        return continueWhile(callable, continuation, f414a, (CancellationToken) null);
    }
    ...
    public Task<Void> continueWhile(Callable<Boolean> callable, Continuation<Void, Task<Void>> continuation, CancellationToken cancellationToken) {
        return continueWhile(callable, continuation, f414a, cancellationToken);
    }
    ...
    public <TContinuationResult> Task<TContinuationResult> continueWith(Continuation<TResult, TContinuationResult> continuation, Executor executor, CancellationToken cancellationToken) {
        ...
        synchronized (this.f420c) {
            ...
            if (!isCompleted) {
                ...
                final Executor executor2 = executor;
                final CancellationToken cancellationToken2 = cancellationToken;
                this.f427j.add(new Continuation<TResult, Void>() {
                    public Void then(Task<TResult> task) {
                        Task.m938c(taskCompletionSource2, continuation2, task, executor2, cancellationToken2);
                        return null;
                    }
                });
            }
        ...
        if (isCompleted) {
            m938c(taskCompletionSource, continuation, this, executor, cancellationToken);
        }
        return taskCompletionSource.getTask();
    }

    public <TContinuationResult> Task<TContinuationResult> continueWith(Continuation<TResult, TContinuationResult> continuation) {
        return continueWith(continuation, f414a, (CancellationToken) null);
    }
    ...
    public <TContinuationResult> Task<TContinuationResult> continueWith(Continuation<TResult, TContinuationResult> continuation, CancellationToken cancellationToken) {
        return continueWith(continuation, f414a, cancellationToken);
    }
    ...
    public <TContinuationResult> Task<TContinuationResult> continueWithTask(Continuation<TResult, Task<TContinuationResult>> continuation, Executor executor, CancellationToken cancellationToken) {
        ...
        synchronized (this.f420c) {
            ...
            if (!isCompleted) {
                ...
                this.f427j.add(new Continuation<TResult, Void>() {
                    public Void then(Task<TResult> task) {
                        Task.m939d(taskCompletionSource2, continuation2, task, executor2, cancellationToken2);
                        return null;
                    }
                });
            }
        ...
        if (isCompleted) {
            m939d(taskCompletionSource, continuation, this, executor, cancellationToken);
        }
        return taskCompletionSource.getTask();
    }

    public <TContinuationResult> Task<TContinuationResult> continueWithTask(Continuation<TResult, Task<TContinuationResult>> continuation) {
        return continueWithTask(continuation, f414a, (CancellationToken) null);
    }
    ...
    public <TContinuationResult> Task<TContinuationResult> continueWithTask(Continuation<TResult, Task<TContinuationResult>> continuation, CancellationToken cancellationToken) {
        return continueWithTask(continuation, f414a, cancellationToken);
    }
    ...
    public <TContinuationResult> Task<TContinuationResult> onSuccess(Continuation<TResult, TContinuationResult> continuation) {
        return onSuccess(continuation, f414a, (CancellationToken) null);
    }
    ...
    public <TContinuationResult> Task<TContinuationResult> onSuccess(Continuation<TResult, TContinuationResult> continuation, CancellationToken cancellationToken) {
        return onSuccess(continuation, f414a, cancellationToken);
    }
    ...
    public <TContinuationResult> Task<TContinuationResult> onSuccessTask(Continuation<TResult, Task<TContinuationResult>> continuation) {
        return onSuccessTask(continuation, f414a);
    }
    ...
    public <TContinuationResult> Task<TContinuationResult> onSuccessTask(Continuation<TResult, Task<TContinuationResult>> continuation, CancellationToken cancellationToken) {
        return onSuccessTask(continuation, f414a, cancellationToken);
    }

    /* access modifiers changed from: private */
    /* renamed from: c */
    public static <TContinuationResult, TResult> void m938c(final TaskCompletionSource<TContinuationResult> taskCompletionSource, final Continuation<TResult, TContinuationResult> continuation, final Task<TResult> task, Executor executor, final CancellationToken cancellationToken) {
        try {
            executor.execute(new Runnable() {
                public void run() {
                    CancellationToken cancellationToken = cancellationToken;
    ...
    /* access modifiers changed from: private */
    /* renamed from: d */
    public static <TContinuationResult, TResult> void m939d(final TaskCompletionSource<TContinuationResult> taskCompletionSource, final Continuation<TResult, Task<TContinuationResult>> continuation, final Task<TResult> task, Executor executor, final CancellationToken cancellationToken) {
        try {
            executor.execute(new Runnable() {
                public void run() {
                    CancellationToken cancellationToken = cancellationToken;
    ...
    private void m936b() {
        synchronized (this.f420c) {
            for (Continuation then : this.f427j) {
                try {
                    then.then(this);
    ...
    /* access modifiers changed from: package-private */
    /* renamed from: a */
    public boolean mo14026a(TResult tresult) {
        synchronized (this.f420c) {
            if (this.f421d) {
                return false;
            }
    ...
    public boolean mo14025a(java.lang.Exception r4) {
        /*
            r3 = this;
            java.lang.Object r0 = r3.f420c
            monitor-enter(r0)
            boolean r1 = r3.f421d     // Catch:{ all -> 0x002c }
            r2 = 0
        ...
        L_0x000a:
            r1 = 1
            r3.f421d = r1     // Catch:{ all -> 0x002c }
            r3.f424g = r4     // Catch:{ all -> 0x002c }
            r3.f425h = r2     // Catch:{ all -> 0x002c }
            java.lang.Object r4 = r3.f420c     // Catch:{ all -> 0x002c }
            r4.notifyAll()     // Catch:{ all -> 0x002c }
            r3.m936b()     // Catch:{ all -> 0x002c }
            boolean r4 = r3.f425h     // Catch:{ all -> 0x002c }
            if (r4 != 0) goto L_0x002a
            bolts.Task$UnobservedExceptionHandler r4 = getUnobservedExceptionHandler()     // Catch:{ all -> 0x002c }
            if (r4 == 0) goto L_0x002a
            bolts.a r4 = new bolts.a     // Catch:{ all -> 0x002c }
            r4.<init>(r3)     // Catch:{ all -> 0x002c }
            r3.f426i = r4     // Catch:{ all -> 0x002c }
        L_0x002a:
            monitor-exit(r0)     // Catch:{ all -> 0x002c }
            return r1
        L_0x002c:
            ...
            throw r4
        */
        throw new UnsupportedOperationException("Method not decompiled: bolts.Task.mo14025a(java.lang.Exception):boolean");
    }
