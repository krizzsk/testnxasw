...
class C2718o extends C2717n {
    ...
    /* renamed from: a */
    private static final int m5476a(String str, String str2, int i) {
        if (str != null) {
    ...
    /* renamed from: b */
    private static final int m5501b(String str, char c, int i) {
        if (str != null) {
    ...
    /* renamed from: b */
    private static final int m5504b(String str, String str2, int i) {
        if (str != null) {
    ...
    /* renamed from: a */
    private static final String m5477a(String str) {
        if (str != null) {
    ...
    /* renamed from: b */
    private static final String m5505b(String str) {
        if (str != null) {
    ...
    @DeprecatedSinceKotlin(warningSince = "1.5")
    /* renamed from: c */
    private static final String m5511c(String str) {
        if (str != null) {
    ...
    /* renamed from: d */
    private static final String m5513d(String str) {
        if (str != null) {
    ...
    /* renamed from: e */
    private static final char[] m5516e(String str) {
        if (str != null) {
    ...
    /* renamed from: a */
    static /* synthetic */ char[] m5500a(String str, char[] cArr, int i, int i2, int i3, int i4, Object obj) {
        if ((i4 & 2) != 0) {
            i = 0;
        }
        if ((i4 & 4) != 0) {
    ...
    /* renamed from: a */
    private static final char[] m5499a(String str, char[] cArr, int i, int i2, int i3) {
        if (str != null) {
            str.getChars(i2, i3, cArr, i);
            return cArr;
        }
    ...
    /* renamed from: a */
    private static final String m5482a(String str, Object... objArr) {
    ...
    /* renamed from: a */
    private static final String m5485a(StringCompanionObject stringCompanionObject, String str, Object... objArr) {
        String format = String.format(str, Arrays.copyOf(objArr, objArr.length));
    ...
    /* renamed from: a */
    private static final /* synthetic */ String m5481a(String str, Locale locale, Object... objArr) {
    ...
    /* renamed from: b */
    private static final String m5507b(String str, Locale locale, Object... objArr) {
        String format = String.format(locale, str, Arrays.copyOf(objArr, objArr.length));
        Intrinsics.checkNotNullExpressionValue(format, "java.lang.String.format(locale, this, *args)");
        return format;
    }
    ...
    @DeprecatedSinceKotlin(hiddenSince = "1.4")
    /* renamed from: a */
    private static final /* synthetic */ String m5486a(StringCompanionObject stringCompanionObject, Locale locale, String str, Object... objArr) {
        String format = String.format(locale, str, Arrays.copyOf(objArr, objArr.length));
    ...
    /* renamed from: b */
    private static final String m5508b(StringCompanionObject stringCompanionObject, Locale locale, String str, Object... objArr) {
        String format = String.format(locale, str, Arrays.copyOf(objArr, objArr.length));
        Intrinsics.checkNotNullExpressionValue(format, "java.lang.String.format(locale, format, *args)");
        return format;
    }
    ...
    /* renamed from: a */
    private static final String m5478a(String str, int i) {
        if (str != null) {
    ...
    /* renamed from: a */
    private static final String m5479a(String str, int i, int i2) {
        if (str != null) {
            String substring = str.substring(i, i2);
            Intrinsics.checkNotNullExpressionValue(substring, "(this as java.lang.Strin…ing(startIndex, endIndex)");
            return substring;
    ...
    /* renamed from: a */
    private static final String m5489a(byte[] bArr, int i, int i2, Charset charset) {
        return new String(bArr, i, i2, charset);
    }

    /* renamed from: a */
    private static final String m5490a(byte[] bArr, Charset charset) {
        return new String(bArr, charset);
    }

    /* renamed from: a */
    private static final String m5488a(byte[] bArr, int i, int i2) {
        return new String(bArr, i, i2, Charsets.UTF_8);
    }

    /* renamed from: a */
    private static final String m5487a(byte[] bArr) {
        return new String(bArr, Charsets.UTF_8);
    }

    /* renamed from: a */
    private static final String m5491a(char[] cArr) {
        return new String(cArr);
    }

    /* renamed from: a */
    private static final String m5492a(char[] cArr, int i, int i2) {
        return new String(cArr, i, i2);
    }

    /* renamed from: a */
    private static final String m5493a(int[] iArr, int i, int i2) {
        return new String(iArr, i, i2);
    }

    /* renamed from: a */
    private static final String m5483a(StringBuffer stringBuffer) {
        return new String(stringBuffer);
    }

    /* renamed from: a */
    private static final String m5484a(StringBuilder sb) {
        return new String(sb);
    }

    /* renamed from: b */
    private static final int m5502b(String str, int i) {
        if (str != null) {
    ...
    /* renamed from: c */
    private static final int m5509c(String str, int i) {
        if (str != null) {
    ...
    /* renamed from: b */
    private static final int m5503b(String str, int i, int i2) {
        if (str != null) {
    ...
    /* renamed from: a */
    private static final boolean m5495a(String str, CharSequence charSequence) {
        if (str != null) {
    ...
    /* renamed from: a */
    private static final boolean m5496a(String str, StringBuffer stringBuffer) {
        if (str != null) {
    ...
    /* renamed from: f */
    private static final String m5517f(String str) {
        if (str != null) {
    ...
    public static final boolean isBlank(java.lang.CharSequence r4) {
        ...
        L_0x0041:
            return r1
        */
        throw new UnsupportedOperationException("Method not decompiled: kotlin.text.C2718o.isBlank(java.lang.CharSequence):boolean");
    }

    /* renamed from: c */
    private static final int m5510c(String str, int i, int i2) {
        if (str != null) {
    ...
    @DeprecatedSinceKotlin(warningSince = "1.5")
    /* renamed from: a */
    private static final String m5480a(String str, Locale locale) {
        if (str != null) {
    ...
    /* renamed from: b */
    private static final String m5506b(String str, Locale locale) {
        if (str != null) {
            String lowerCase = str.toLowerCase(locale);
            Intrinsics.checkNotNullExpressionValue(lowerCase, "(this as java.lang.String).toLowerCase(locale)");
            return lowerCase;
    ...
    @DeprecatedSinceKotlin(warningSince = "1.5")
    /* renamed from: c */
    private static final String m5512c(String str, Locale locale) {
        if (str != null) {
    ...
    /* renamed from: d */
    private static final String m5514d(String str, Locale locale) {
        if (str != null) {
            String upperCase = str.toUpperCase(locale);
            Intrinsics.checkNotNullExpressionValue(upperCase, "(this as java.lang.String).toUpperCase(locale)");
            return upperCase;
    ...
    /* renamed from: a */
    private static final byte[] m5497a(String str, Charset charset) {
        if (str != null) {
    ...
    /* renamed from: a */
    static /* synthetic */ byte[] m5498a(String str, Charset charset, int i, Object obj) {
        if ((i & 1) != 0) {
    ...
    /* renamed from: a */
    static /* synthetic */ Pattern m5494a(String str, int i, int i2, Object obj) {
        if ((i2 & 1) != 0) {
            i = 0;
        }
    ...
    /* renamed from: d */
    private static final Pattern m5515d(String str, int i) {
        Pattern compile = Pattern.compile(str, i);
        Intrinsics.checkNotNullExpressionValue(compile, "java.util.regex.Pattern.compile(this, flags)");
        return compile;
    }
