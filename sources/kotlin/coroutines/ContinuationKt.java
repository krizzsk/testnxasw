...
public final class ContinuationKt {
    ...
    /* renamed from: a */
    private static final <T> void m4278a(Continuation<? super T> continuation, T t) {
        Result.Companion companion = Result.Companion;
        continuation.resumeWith(Result.m47938constructorimpl(t));
    }

    /* renamed from: a */
    private static final <T> void m4279a(Continuation<? super T> continuation, Throwable th) {
        Result.Companion companion = Result.Companion;
        continuation.resumeWith(Result.m47938constructorimpl(ResultKt.createFailure(th)));
    }

    /* renamed from: a */
    private static final <T> Continuation<T> m4276a(CoroutineContext coroutineContext, Function1<? super Result<? extends T>, Unit> function1) {
    ...
    public static final <T> void startCoroutine(Function1<? super Continuation<? super T>, ? extends Object> function1, Continuation<? super T> continuation) {
        ...
        Result.Companion companion = Result.Companion;
        intercepted.resumeWith(Result.m47938constructorimpl(unit));
    }
    ...
    /* renamed from: a */
    private static final <T> Object m4275a(Function1<? super Continuation<? super T>, Unit> function1, Continuation<? super T> continuation) {
        InlineMarker.mark(0);
    ...
    /* renamed from: a */
    private static final CoroutineContext m4277a() {
