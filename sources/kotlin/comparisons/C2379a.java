...
class C2379a {
    public static final <T> int compareValuesBy(T t, T t2, Function1<? super T, ? extends Comparable<?>>... function1Arr) {
        ...
        if (function1Arr.length > 0) {
            return m4208a(t, t2, function1Arr);
        }
    ...
    /* renamed from: a */
    public static final <T> int m4208a(T t, T t2, Function1<? super T, ? extends Comparable<?>>[] function1Arr) {
    ...
    /* renamed from: a */
    private static final <T> int m4207a(T t, T t2, Function1<? super T, ? extends Comparable<?>> function1) {
        return ComparisonsKt.compareValues((Comparable) function1.invoke(t), (Comparable) function1.invoke(t2));
    }

    /* renamed from: a */
    private static final <T, K> int m4206a(T t, T t2, Comparator<? super K> comparator, Function1<? super T, ? extends K> function1) {
    ...
    /* renamed from: a */
    private static final <T> Comparator<T> m4213a(Function1<? super T, ? extends Comparable<?>> function1) {
        return new ComparisonsKt__ComparisonsKt$compareBy$2<>(function1);
    }

    /* renamed from: a */
    private static final <T, K> Comparator<T> m4211a(Comparator<? super K> comparator, Function1<? super T, ? extends K> function1) {
        return new ComparisonsKt__ComparisonsKt$compareBy$3<>(comparator, function1);
    }

    /* renamed from: b */
    private static final <T> Comparator<T> m4217b(Function1<? super T, ? extends Comparable<?>> function1) {
        return new ComparisonsKt__ComparisonsKt$compareByDescending$1<>(function1);
    }

    /* renamed from: b */
    private static final <T, K> Comparator<T> m4216b(Comparator<? super K> comparator, Function1<? super T, ? extends K> function1) {
        return new ComparisonsKt__ComparisonsKt$compareByDescending$2<>(comparator, function1);
    }

    /* renamed from: c */
    private static final <T> Comparator<T> m4218c(Comparator<T> comparator, Function1<? super T, ? extends Comparable<?>> function1) {
        return new ComparisonsKt__ComparisonsKt$thenBy$1<>(comparator, function1);
    }

    /* renamed from: a */
    private static final <T, K> Comparator<T> m4210a(Comparator<T> comparator, Comparator<? super K> comparator2, Function1<? super T, ? extends K> function1) {
        return new ComparisonsKt__ComparisonsKt$thenBy$2<>(comparator, comparator2, function1);
    }

    /* renamed from: d */
    private static final <T> Comparator<T> m4219d(Comparator<T> comparator, Function1<? super T, ? extends Comparable<?>> function1) {
        return new ComparisonsKt__ComparisonsKt$thenByDescending$1<>(comparator, function1);
    }

    /* renamed from: b */
    private static final <T, K> Comparator<T> m4215b(Comparator<T> comparator, Comparator<? super K> comparator2, Function1<? super T, ? extends K> function1) {
        return new ComparisonsKt__ComparisonsKt$thenByDescending$2<>(comparator, comparator2, function1);
    }

    /* renamed from: a */
    private static final <T> Comparator<T> m4212a(Comparator<T> comparator, Function2<? super T, ? super T, Integer> function2) {
    ...
    /* renamed from: a */
    private static final <T extends Comparable<? super T>> Comparator<T> m4209a() {
    ...
    /* renamed from: b */
    private static final <T extends Comparable<? super T>> Comparator<T> m4214b() {
        return ComparisonsKt.nullsLast(ComparisonsKt.naturalOrder());
    }

    public static final <T extends Comparable<? super T>> Comparator<T> naturalOrder() {
        C2382d dVar = C2382d.f4572a;
        if (dVar != null) {
            return dVar;
        }
    ...
    public static final <T> Comparator<T> reversed(Comparator<T> comparator) {
        ...
        if (comparator instanceof C2384f) {
            return ((C2384f) comparator).mo23648a();
        }
        if (Intrinsics.areEqual((Object) comparator, (Object) C2382d.f4572a)) {
            C2383e eVar = C2383e.f4573a;
            if (eVar != null) {
                return eVar;
            }
            throw new NullPointerException("null cannot be cast to non-null type kotlin.Comparator<T> /* = java.util.Comparator<T> */");
        } else if (!Intrinsics.areEqual((Object) comparator, (Object) C2383e.f4573a)) {
            return new C2384f<>(comparator);
        } else {
            C2382d dVar = C2382d.f4572a;
            if (dVar != null) {
                return dVar;
