...
class C2403c extends C2402b {
    ...
    public static final java.lang.String getNameWithoutExtension(java.nio.file.Path r3) {
        ...
        L_0x001e:
            return r3
        */
        throw new UnsupportedOperationException("Method not decompiled: kotlin.p066io.path.C2403c.getNameWithoutExtension(java.nio.file.Path):java.lang.String");
    }
    ...
    public static final java.lang.String getExtension(java.nio.file.Path r2) {
        ...
        L_0x001c:
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: kotlin.p066io.path.C2403c.getExtension(java.nio.file.Path):java.lang.String");
    }

    /* renamed from: a */
    private static final String m4420a(Path path) {
    ...
    /* renamed from: b */
    private static final String m4440b(Path path) {
        return PathsKt.getInvariantSeparatorsPathString(path);
    }

    /* renamed from: c */
    private static final Path m4450c(Path path) {
    ...
    /* renamed from: d */
    private static final String m4454d(Path path) {
    ...
    public static final Path relativeTo(Path path, Path path2) {
        ...
        try {
            return C2401a.f4600a.mo23749a(path, path2);
    ...
    /* renamed from: a */
    private static final Path m4430a(Path path, Path path2, boolean z) throws IOException {
    ...
    /* renamed from: a */
    static /* synthetic */ Path m4431a(Path path, Path path2, boolean z, int i, Object obj) throws IOException {
        if ((i & 2) != 0) {
            z = false;
        }
        CopyOption[] copyOptionArr = z ? new CopyOption[]{StandardCopyOption.REPLACE_EXISTING} : new CopyOption[0];
    ...
    /* renamed from: a */
    private static final Path m4432a(Path path, Path path2, CopyOption... copyOptionArr) throws IOException {
        Path copy = Files.copy(path, path2, (CopyOption[]) Arrays.copyOf(copyOptionArr, copyOptionArr.length));
        Intrinsics.checkNotNullExpressionValue(copy, "Files.copy(this, target, *options)");
        return copy;
    }
    ...
    /* renamed from: a */
    private static final boolean m4439a(Path path, LinkOption... linkOptionArr) {
        return Files.exists(path, (LinkOption[]) Arrays.copyOf(linkOptionArr, linkOptionArr.length));
    }

    /* renamed from: b */
    private static final boolean m4449b(Path path, LinkOption... linkOptionArr) {
        return Files.notExists(path, (LinkOption[]) Arrays.copyOf(linkOptionArr, linkOptionArr.length));
    }

    /* renamed from: c */
    private static final boolean m4453c(Path path, LinkOption... linkOptionArr) {
        return Files.isRegularFile(path, (LinkOption[]) Arrays.copyOf(linkOptionArr, linkOptionArr.length));
    }

    /* renamed from: d */
    private static final boolean m4455d(Path path, LinkOption... linkOptionArr) {
        return Files.isDirectory(path, (LinkOption[]) Arrays.copyOf(linkOptionArr, linkOptionArr.length));
    }

    /* renamed from: e */
    private static final boolean m4457e(Path path) {
        return Files.isSymbolicLink(path);
    }

    /* renamed from: f */
    private static final boolean m4459f(Path path) {
        return Files.isExecutable(path);
    }

    /* renamed from: g */
    private static final boolean m4461g(Path path) throws IOException {
        return Files.isHidden(path);
    }

    /* renamed from: h */
    private static final boolean m4463h(Path path) {
        return Files.isReadable(path);
    }

    /* renamed from: i */
    private static final boolean m4465i(Path path) {
        return Files.isWritable(path);
    }

    /* renamed from: a */
    private static final boolean m4438a(Path path, Path path2) throws IOException {
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:9:0x0028, code lost:
        kotlin.p066io.CloseableKt.closeFinally(r2, r3);
     */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public static final java.util.List<java.nio.file.Path> listDirectoryEntries(java.nio.file.Path r2, java.lang.String r3) throws java.io.IOException {
        ...
        L_0x0027:
            ...
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: kotlin.p066io.path.C2403c.listDirectoryEntries(java.nio.file.Path, java.lang.String):java.util.List");
    }
    ...
    /* renamed from: a */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    private static final <T> T m4417a(java.nio.file.Path r4, java.lang.String r5, kotlin.jvm.functions.Function1<? super kotlin.sequences.Sequence<? extends java.nio.file.Path>, ? extends T> r6) throws java.io.IOException {
        /*
        ...
        L_0x0049:
            ...
            throw r6
        */
        throw new UnsupportedOperationException("Method not decompiled: kotlin.p066io.path.C2403c.m4417a(java.nio.file.Path, java.lang.String, kotlin.jvm.functions.Function1):java.lang.Object");
    }
    ...
    /* renamed from: a */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    static /* synthetic */ java.lang.Object m4418a(java.nio.file.Path r2, java.lang.String r3, kotlin.jvm.functions.Function1 r4, int r5, java.lang.Object r6) throws java.io.IOException {
        /*
            r6 = 1
            r5 = r5 & r6
        ...
        L_0x004e:
            ...
            throw r4
        */
        throw new UnsupportedOperationException("Method not decompiled: kotlin.p066io.path.C2403c.m4418a(java.nio.file.Path, java.lang.String, kotlin.jvm.functions.Function1, int, java.lang.Object):java.lang.Object");
    }
    ...
    /* renamed from: b */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    private static final void m4447b(java.nio.file.Path r4, java.lang.String r5, kotlin.jvm.functions.Function1<? super java.nio.file.Path, kotlin.Unit> r6) throws java.io.IOException {
        /*
            java.nio.file.DirectoryStream r4 = java.nio.file.Files.newDirectoryStream(r4, r5)
            java.io.Closeable r4 = (java.io.Closeable) r4
            r5 = 0
        ...
        L_0x0055:
            ...
            throw r6
        */
        throw new UnsupportedOperationException("Method not decompiled: kotlin.p066io.path.C2403c.m4447b(java.nio.file.Path, java.lang.String, kotlin.jvm.functions.Function1):void");
    }
    ...
    /* renamed from: b */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    static /* synthetic */ void m4448b(java.nio.file.Path r2, java.lang.String r3, kotlin.jvm.functions.Function1 r4, int r5, java.lang.Object r6) throws java.io.IOException {
        /*
            r6 = 1
            r5 = r5 & r6
            if (r5 == 0) goto L_0x0006
        ...
        L_0x005a:
            ...
            throw r4
        */
        throw new UnsupportedOperationException("Method not decompiled: kotlin.p066io.path.C2403c.m4448b(java.nio.file.Path, java.lang.String, kotlin.jvm.functions.Function1, int, java.lang.Object):void");
    }

    /* renamed from: j */
    private static final long m4466j(Path path) throws IOException {
        return Files.size(path);
    }

    /* renamed from: k */
    private static final void m4468k(Path path) throws IOException {
        Files.delete(path);
    }

    /* renamed from: l */
    private static final boolean m4469l(Path path) throws IOException {
        return Files.deleteIfExists(path);
    }

    /* renamed from: a */
    private static final Path m4437a(Path path, FileAttribute<?>... fileAttributeArr) throws IOException {
    ...
    /* renamed from: b */
    private static final Path m4445b(Path path, FileAttribute<?>... fileAttributeArr) throws IOException {
    ...
    /* renamed from: b */
    private static final Path m4444b(Path path, Path path2, CopyOption... copyOptionArr) throws IOException {
    ...
    /* renamed from: b */
    private static final Path m4442b(Path path, Path path2, boolean z) throws IOException {
        CopyOption[] copyOptionArr = z ? new CopyOption[]{StandardCopyOption.REPLACE_EXISTING} : new CopyOption[0];
        Path move = Files.move(path, path2, (CopyOption[]) Arrays.copyOf(copyOptionArr, copyOptionArr.length));
        Intrinsics.checkNotNullExpressionValue(move, "Files.move(this, target, *options)");
        return move;
    ...
    /* renamed from: b */
    static /* synthetic */ Path m4443b(Path path, Path path2, boolean z, int i, Object obj) throws IOException {
        if ((i & 2) != 0) {
            z = false;
        }
        CopyOption[] copyOptionArr = z ? new CopyOption[]{StandardCopyOption.REPLACE_EXISTING} : new CopyOption[0];
    ...
    /* renamed from: m */
    private static final FileStore m4470m(Path path) throws IOException {
    ...
    /* renamed from: a */
    private static final Object m4419a(Path path, String str, LinkOption... linkOptionArr) throws IOException {
        return Files.getAttribute(path, str, (LinkOption[]) Arrays.copyOf(linkOptionArr, linkOptionArr.length));
    }

    /* renamed from: a */
    private static final Path m4429a(Path path, String str, Object obj, LinkOption... linkOptionArr) throws IOException {
    ...
    /* renamed from: f */
    private static final /* synthetic */ <V extends FileAttributeView> V m4458f(Path path, LinkOption... linkOptionArr) {
    ...
    /* renamed from: g */
    private static final /* synthetic */ <A extends BasicFileAttributes> A m4460g(Path path, LinkOption... linkOptionArr) throws IOException {
    ...
    /* renamed from: b */
    private static final Map<String, Object> m4446b(Path path, String str, LinkOption... linkOptionArr) throws IOException {
    ...
    /* renamed from: h */
    private static final FileTime m4462h(Path path, LinkOption... linkOptionArr) throws IOException {
    ...
    /* renamed from: a */
    private static final Path m4434a(Path path, FileTime fileTime) throws IOException {
    ...
    /* renamed from: i */
    private static final UserPrincipal m4464i(Path path, LinkOption... linkOptionArr) throws IOException {
        return Files.getOwner(path, (LinkOption[]) Arrays.copyOf(linkOptionArr, linkOptionArr.length));
    }

    /* renamed from: a */
    private static final Path m4435a(Path path, UserPrincipal userPrincipal) throws IOException {
    ...
    /* renamed from: j */
    private static final Set<PosixFilePermission> m4467j(Path path, LinkOption... linkOptionArr) throws IOException {
    ...
    /* renamed from: a */
    private static final Path m4436a(Path path, Set<? extends PosixFilePermission> set) throws IOException {
    ...
    /* renamed from: b */
    private static final Path m4441b(Path path, Path path2) throws IOException {
    ...
    /* renamed from: a */
    private static final Path m4433a(Path path, Path path2, FileAttribute<?>... fileAttributeArr) throws IOException {
    ...
    /* renamed from: n */
    private static final Path m4471n(Path path) throws IOException {
    ...
    /* renamed from: c */
    private static final Path m4452c(Path path, FileAttribute<?>... fileAttributeArr) throws IOException {
    ...
    /* renamed from: a */
    static /* synthetic */ Path m4423a(String str, String str2, FileAttribute[] fileAttributeArr, int i, Object obj) throws IOException {
        if ((i & 1) != 0) {
            str = null;
        }
        if ((i & 2) != 0) {
    ...
    /* renamed from: a */
    private static final Path m4422a(String str, String str2, FileAttribute<?>... fileAttributeArr) throws IOException {
        Path createTempFile = Files.createTempFile(str, str2, (FileAttribute[]) Arrays.copyOf(fileAttributeArr, fileAttributeArr.length));
        Intrinsics.checkNotNullExpressionValue(createTempFile, "Files.createTempFile(prefix, suffix, *attributes)");
        return createTempFile;
    }
    ...
    /* renamed from: a */
    static /* synthetic */ Path m4426a(String str, FileAttribute[] fileAttributeArr, int i, Object obj) throws IOException {
        if ((i & 1) != 0) {
            str = null;
        }
    ...
    /* renamed from: a */
    private static final Path m4425a(String str, FileAttribute<?>... fileAttributeArr) throws IOException {
        Path createTempDirectory = Files.createTempDirectory(str, (FileAttribute[]) Arrays.copyOf(fileAttributeArr, fileAttributeArr.length));
        Intrinsics.checkNotNullExpressionValue(createTempDirectory, "Files.createTempDirectory(prefix, *attributes)");
        return createTempDirectory;
    }
    ...
    /* renamed from: c */
    private static final Path m4451c(Path path, Path path2) {
    ...
    /* renamed from: a */
    private static final Path m4428a(Path path, String str) {
        Intrinsics.checkNotNullParameter(path, "$this$div");
    ...
    /* renamed from: a */
    private static final Path m4421a(String str) {
    ...
    /* renamed from: a */
    private static final Path m4424a(String str, String... strArr) {
    ...
    /* renamed from: a */
    private static final Path m4427a(URI uri) {
