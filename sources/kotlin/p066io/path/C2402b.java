...
class C2402b {
    ...
    /* renamed from: a */
    private static final InputStreamReader m4393a(Path path, Charset charset, OpenOption... openOptionArr) throws IOException {
        return new InputStreamReader(Files.newInputStream(path, (OpenOption[]) Arrays.copyOf(openOptionArr, openOptionArr.length)), charset);
    }

    /* renamed from: a */
    static /* synthetic */ BufferedReader m4391a(Path path, Charset charset, int i, OpenOption[] openOptionArr, int i2, Object obj) throws IOException {
        if ((i2 & 1) != 0) {
            charset = Charsets.UTF_8;
        }
        if ((i2 & 2) != 0) {
    ...
    /* renamed from: a */
    private static final BufferedReader m4390a(Path path, Charset charset, int i, OpenOption... openOptionArr) throws IOException {
        return new BufferedReader(new InputStreamReader(Files.newInputStream(path, (OpenOption[]) Arrays.copyOf(openOptionArr, openOptionArr.length)), charset), i);
    }

    /* renamed from: b */
    static /* synthetic */ OutputStreamWriter m4414b(Path path, Charset charset, OpenOption[] openOptionArr, int i, Object obj) throws IOException {
        if ((i & 1) != 0) {
            charset = Charsets.UTF_8;
        }
    ...
    /* renamed from: b */
    private static final OutputStreamWriter m4413b(Path path, Charset charset, OpenOption... openOptionArr) throws IOException {
        return new OutputStreamWriter(Files.newOutputStream(path, (OpenOption[]) Arrays.copyOf(openOptionArr, openOptionArr.length)), charset);
    }

    /* renamed from: b */
    static /* synthetic */ BufferedWriter m4411b(Path path, Charset charset, int i, OpenOption[] openOptionArr, int i2, Object obj) throws IOException {
        if ((i2 & 1) != 0) {
            charset = Charsets.UTF_8;
        }
        if ((i2 & 2) != 0) {
    ...
    /* renamed from: b */
    private static final BufferedWriter m4410b(Path path, Charset charset, int i, OpenOption... openOptionArr) throws IOException {
        return new BufferedWriter(new OutputStreamWriter(Files.newOutputStream(path, (OpenOption[]) Arrays.copyOf(openOptionArr, openOptionArr.length)), charset), i);
    }

    /* renamed from: a */
    private static final byte[] m4409a(Path path) throws IOException {
    ...
    /* renamed from: a */
    private static final void m4408a(Path path, byte[] bArr, OpenOption... openOptionArr) throws IOException {
        Files.write(path, bArr, (OpenOption[]) Arrays.copyOf(openOptionArr, openOptionArr.length));
    }

    /* renamed from: a */
    private static final void m4407a(Path path, byte[] bArr) throws IOException {
    ...
    public static final java.lang.String readText(java.nio.file.Path r3, java.nio.charset.Charset r4) throws java.io.IOException {
        /*
            ...
            java.lang.String r4 = kotlin.p066io.TextStreamsKt.readText(r4)     // Catch:{ all -> 0x002e }
            kotlin.p066io.CloseableKt.closeFinally(r2, r3)
            return r4
        L_0x002e:
            r3 = move-exception
        ...
        L_0x0030:
            ...
            throw r4
        */
        throw new UnsupportedOperationException("Method not decompiled: kotlin.p066io.path.C2402b.readText(java.nio.file.Path, java.nio.charset.Charset):java.lang.String");
    }
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:9:0x003b, code lost:
        kotlin.p066io.CloseableKt.closeFinally(r4, r1);
     */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public static final void writeText(java.nio.file.Path r1, java.lang.CharSequence r2, java.nio.charset.Charset r3, java.nio.file.OpenOption... r4) throws java.io.IOException {
        ...
        L_0x003a:
            ...
            throw r2
        */
        throw new UnsupportedOperationException("Method not decompiled: kotlin.p066io.path.C2402b.writeText(java.nio.file.Path, java.lang.CharSequence, java.nio.charset.Charset, java.nio.file.OpenOption[]):void");
    }
    ...
    public static final void appendText(java.nio.file.Path r3, java.lang.CharSequence r4, java.nio.charset.Charset r5) throws java.io.IOException {
        ...
        L_0x0038:
            ...
            throw r4
        */
        throw new UnsupportedOperationException("Method not decompiled: kotlin.p066io.path.C2402b.appendText(java.nio.file.Path, java.lang.CharSequence, java.nio.charset.Charset):void");
    }
    ...
    /* renamed from: a */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    static /* synthetic */ void m4406a(java.nio.file.Path r2, java.nio.charset.Charset r3, kotlin.jvm.functions.Function1 r4, int r5, java.lang.Object r6) throws java.io.IOException {
        /*
            r6 = 1
            r5 = r5 & r6
        ...
        L_0x0020:
            ...
            kotlin.sequences.Sequence r0 = kotlin.p066io.TextStreamsKt.lineSequence(r0)     // Catch:{ all -> 0x0055 }
        ...
        L_0x0068:
            ...
            throw r4
        */
        throw new UnsupportedOperationException("Method not decompiled: kotlin.p066io.path.C2402b.m4406a(java.nio.file.Path, java.nio.charset.Charset, kotlin.jvm.functions.Function1, int, java.lang.Object):void");
    }
    ...
    /* renamed from: a */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    private static final void m4405a(java.nio.file.Path r4, java.nio.charset.Charset r5, kotlin.jvm.functions.Function1<? super java.lang.String, kotlin.Unit> r6) throws java.io.IOException {
        /*
        ...
        L_0x001a:
            ...
            kotlin.sequences.Sequence r2 = kotlin.p066io.TextStreamsKt.lineSequence(r2)     // Catch:{ all -> 0x0050 }
        ...
        L_0x0063:
            ...
            throw r6
        */
        throw new UnsupportedOperationException("Method not decompiled: kotlin.p066io.path.C2402b.m4405a(java.nio.file.Path, java.nio.charset.Charset, kotlin.jvm.functions.Function1):void");
    }

    /* renamed from: a */
    private static final InputStream m4392a(Path path, OpenOption... openOptionArr) throws IOException {
    ...
    /* renamed from: b */
    private static final OutputStream m4412b(Path path, OpenOption... openOptionArr) throws IOException {
    ...
    /* renamed from: a */
    static /* synthetic */ List m4404a(Path path, Charset charset, int i, Object obj) throws IOException {
        if ((i & 1) != 0) {
            charset = Charsets.UTF_8;
        }
    ...
    /* renamed from: a */
    private static final List<String> m4403a(Path path, Charset charset) throws IOException {
        List<String> readAllLines = Files.readAllLines(path, charset);
        Intrinsics.checkNotNullExpressionValue(readAllLines, "Files.readAllLines(this, charset)");
        return readAllLines;
    }
    ...
    /* renamed from: b */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    static /* synthetic */ java.lang.Object m4416b(java.nio.file.Path r2, java.nio.charset.Charset r3, kotlin.jvm.functions.Function1 r4, int r5, java.lang.Object r6) throws java.io.IOException {
        /*
            r6 = 1
            r5 = r5 & r6
            if (r5 == 0) goto L_0x0006
        ...
        L_0x0006:
            ...
            kotlin.sequences.Sequence r0 = kotlin.p066io.TextStreamsKt.lineSequence(r0)     // Catch:{ all -> 0x0037 }
        ...
        L_0x004c:
            ...
            throw r4
        */
        throw new UnsupportedOperationException("Method not decompiled: kotlin.p066io.path.C2402b.m4416b(java.nio.file.Path, java.nio.charset.Charset, kotlin.jvm.functions.Function1, int, java.lang.Object):java.lang.Object");
    }
    ...
    /* renamed from: b */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    private static final <T> T m4415b(java.nio.file.Path r4, java.nio.charset.Charset r5, kotlin.jvm.functions.Function1<? super kotlin.sequences.Sequence<java.lang.String>, ? extends T> r6) throws java.io.IOException {
        /*
            java.io.BufferedReader r4 = java.nio.file.Files.newBufferedReader(r4, r5)
            java.io.Closeable r4 = (java.io.Closeable) r4
            r5 = 0
            ...
            kotlin.sequences.Sequence r2 = kotlin.p066io.TextStreamsKt.lineSequence(r2)     // Catch:{ all -> 0x0032 }
        ...
        L_0x0047:
            ...
            throw r6
        */
        throw new UnsupportedOperationException("Method not decompiled: kotlin.p066io.path.C2402b.m4415b(java.nio.file.Path, java.nio.charset.Charset, kotlin.jvm.functions.Function1):java.lang.Object");
    }

    /* renamed from: a */
    static /* synthetic */ Path m4398a(Path path, Iterable iterable, Charset charset, OpenOption[] openOptionArr, int i, Object obj) throws IOException {
        if ((i & 2) != 0) {
            charset = Charsets.UTF_8;
        }
    ...
    /* renamed from: a */
    private static final Path m4397a(Path path, Iterable<? extends CharSequence> iterable, Charset charset, OpenOption... openOptionArr) throws IOException {
        Path write = Files.write(path, iterable, charset, (OpenOption[]) Arrays.copyOf(openOptionArr, openOptionArr.length));
        Intrinsics.checkNotNullExpressionValue(write, "Files.write(this, lines, charset, *options)");
        return write;
    }
    ...
    /* renamed from: a */
    static /* synthetic */ Path m4402a(Path path, Sequence sequence, Charset charset, OpenOption[] openOptionArr, int i, Object obj) throws IOException {
        if ((i & 2) != 0) {
            charset = Charsets.UTF_8;
        }
    ...
    /* renamed from: a */
    private static final Path m4401a(Path path, Sequence<? extends CharSequence> sequence, Charset charset, OpenOption... openOptionArr) throws IOException {
        Path write = Files.write(path, SequencesKt.asIterable(sequence), charset, (OpenOption[]) Arrays.copyOf(openOptionArr, openOptionArr.length));
        Intrinsics.checkNotNullExpressionValue(write, "Files.write(this, lines.…ble(), charset, *options)");
        return write;
    }
    ...
    /* renamed from: a */
    static /* synthetic */ Path m4396a(Path path, Iterable iterable, Charset charset, int i, Object obj) throws IOException {
        if ((i & 2) != 0) {
            charset = Charsets.UTF_8;
        }
    ...
    /* renamed from: a */
    private static final Path m4395a(Path path, Iterable<? extends CharSequence> iterable, Charset charset) throws IOException {
        Path write = Files.write(path, iterable, charset, new OpenOption[]{StandardOpenOption.APPEND});
        Intrinsics.checkNotNullExpressionValue(write, "Files.write(this, lines,…tandardOpenOption.APPEND)");
        return write;
    }
    ...
    /* renamed from: a */
    static /* synthetic */ Path m4400a(Path path, Sequence sequence, Charset charset, int i, Object obj) throws IOException {
        if ((i & 2) != 0) {
            charset = Charsets.UTF_8;
        }
    ...
    /* renamed from: a */
    private static final Path m4399a(Path path, Sequence<? extends CharSequence> sequence, Charset charset) throws IOException {
        Path write = Files.write(path, SequencesKt.asIterable(sequence), charset, new OpenOption[]{StandardOpenOption.APPEND});
        Intrinsics.checkNotNullExpressionValue(write, "Files.write(this, lines.…tandardOpenOption.APPEND)");
        return write;
    }
