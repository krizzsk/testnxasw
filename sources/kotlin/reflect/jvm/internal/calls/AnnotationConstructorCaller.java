...
public final class AnnotationConstructorCaller implements Caller {
    ...
    @Metadata(mo148867d1 = {"\u0000\f\n\u0002\u0018\u0002\n\u0002\u0010\u0010\n\u0002\b\u0004\b\u0001\u0018\u00002\b\u0012\u0004\u0012\u00020\u00000\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002j\u0002\b\u0003j\u0002\b\u0004¨\u0006\u0005"}, mo148868d2 = {"Lkotlin/reflect/jvm/internal/calls/AnnotationConstructorCaller$Origin;", "", "(Ljava/lang/String;I)V", "JAVA", "KOTLIN", "kotlin-reflection"}, mo148869k = 1, mo148870mv = {1, 5, 1})
    /* compiled from: AnnotationConstructorCaller.kt */
    public enum Origin {
        JAVA,
        KOTLIN
    ...
    public AnnotationConstructorCaller(Class<?> cls, List<String> list, CallMode callMode, Origin origin, List<Method> list2) {
        ...
        this.f4784a = (List) arrayList;
        Iterable<Method> iterable2 = this.f4790g;
        ...
        this.f4785b = (List) arrayList2;
        Iterable<Method> iterable3 = this.f4790g;
        ...
        this.f4786c = (List) arrayList3;
        if (this.f4789f == CallMode.POSITIONAL_CALL && origin == Origin.JAVA && (!CollectionsKt.minus(this.f4788e, "value").isEmpty())) {
    ...
    public Object call(Object[] objArr) {
        ...
        while (i < length) {
            ...
            int i3 = i2 + 1;
            if (obj2 == null && this.f4789f == CallMode.CALL_BY_NAME) {
                obj = this.f4786c.get(i2);
            } else {
                obj = AnnotationConstructorCallerKt.m4654a(obj2, this.f4785b.get(i2));
            }
            if (obj != null) {
                arrayList.add(obj);
                i++;
                ...
                Void unused = AnnotationConstructorCallerKt.m4655a(i2, this.f4788e.get(i2), this.f4785b.get(i2));
                throw null;
            }
        }
        return AnnotationConstructorCallerKt.createAnnotationInstance(this.f4787d, MapsKt.toMap(CollectionsKt.zip(this.f4788e, (List) arrayList)), this.f4790g);
    }
}
