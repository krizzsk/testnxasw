...
public final class InlineClassAwareCallerKt {
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:21:0x006a, code lost:
        if (m4656a(r6) == false) goto L_0x006d;
     */
    ...
    /* renamed from: a */
    private static final boolean m4656a(CallableMemberDescriptor callableMemberDescriptor) {
        KotlinType b = m4657b(callableMemberDescriptor);
        return b != null && InlineClassesUtilsKt.isInlineClassType(b);
    }
    ...
    public static final Method getUnboxMethod(Class<?> cls, CallableMemberDescriptor callableMemberDescriptor) {
        ...
        try {
            ...
            throw new KotlinReflectionInternalError("No unbox method found in inline class: " + cls + " (calling " + callableMemberDescriptor + VersionRange.RIGHT_OPEN);
        }
    }
    ...
    public static final Method getBoxMethod(Class<?> cls, CallableMemberDescriptor callableMemberDescriptor) {
        ...
        try {
            ...
            throw new KotlinReflectionInternalError("No box method found in inline class: " + cls + " (calling " + callableMemberDescriptor + VersionRange.RIGHT_OPEN);
        }
    }
    ...
    public static final Class<?> toInlineClass(DeclarationDescriptor declarationDescriptor) {
        ...
        throw new KotlinReflectionInternalError("Class object for the class " + classDescriptor.getName() + " cannot be found (classId=" + DescriptorUtilsKt.getClassId((ClassifierDescriptor) declarationDescriptor) + VersionRange.RIGHT_OPEN);
    }

    /* renamed from: b */
    private static final KotlinType m4657b(CallableMemberDescriptor callableMemberDescriptor) {
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:9:0x001f, code lost:
        r2 = getUnboxMethod((r0 = toInlineClass((r0 = m4657b(r2)))), r2);
     */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public static final java.lang.Object coerceToExpectedReceiverType(java.lang.Object r1, kotlin.reflect.jvm.internal.impl.descriptors.CallableMemberDescriptor r2) {
        /*
            ...
            return r1
        L_0x0013:
            kotlin.reflect.jvm.internal.impl.types.KotlinType r0 = m4657b(r2)
