...
public final class KPackageImpl extends KDeclarationContainerImpl {
    ...
    private final class Data extends KDeclarationContainerImpl.Data {
        ...
        static {
            ...
            $$delegatedProperties = new KProperty[]{C2404Reflection.property1(new PropertyReference1Impl(C2404Reflection.getOrCreateKotlinClass(cls), "kotlinClass", "getKotlinClass()Lorg/jetbrains/kotlin/descriptors/runtime/components/ReflectKotlinClass;")), C2404Reflection.property1(new PropertyReference1Impl(C2404Reflection.getOrCreateKotlinClass(cls), "scope", "getScope()Lorg/jetbrains/kotlin/resolve/scopes/MemberScope;")), C2404Reflection.property1(new PropertyReference1Impl(C2404Reflection.getOrCreateKotlinClass(cls), "multifileFacade", "getMultifileFacade()Ljava/lang/Class;")), C2404Reflection.property1(new PropertyReference1Impl(C2404Reflection.getOrCreateKotlinClass(cls), AdminPermission.METADATA, "getMetadata()Lkotlin/Triple;")), C2404Reflection.property1(new PropertyReference1Impl(C2404Reflection.getOrCreateKotlinClass(cls), "members", "getMembers()Ljava/util/Collection;"))};
        }
    ...
    public Class<?> getMethodOwner() {
        Class<?> multifileFacade = this.f4745a.invoke().getMultifileFacade();
        return multifileFacade != null ? multifileFacade : getJClass();
    }

    /* renamed from: a */
    private final MemberScope m4629a() {
        return this.f4745a.invoke().getScope();
    }

    public Collection<KCallable<?>> getMembers() {
        return this.f4745a.invoke().getMembers();
    }
    ...
    public Collection<PropertyDescriptor> getProperties(Name name) {
        ...
        return m4629a().getContributedVariables(name, NoLookupLocation.FROM_REFLECTION);
    }

    public Collection<FunctionDescriptor> getFunctions(Name name) {
        Intrinsics.checkNotNullParameter(name, "name");
        return m4629a().getContributedFunctions(name, NoLookupLocation.FROM_REFLECTION);
    }

    public PropertyDescriptor getLocalProperty(int i) {
        Triple<JvmNameResolver, ProtoBuf.Package, JvmMetadataVersion> metadata = this.f4745a.invoke().getMetadata();
        if (metadata == null) {
            return null;
        }
