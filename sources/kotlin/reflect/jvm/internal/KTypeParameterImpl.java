...
public final class KTypeParameterImpl implements KTypeParameter, KClassifierImpl {
    ...
    public List<KType> getUpperBounds() {
        return (List) this.f4774b.getValue(this, f4773a[0]);
    }
    ...
    public KTypeParameterImpl(KTypeParameterOwnerImpl kTypeParameterOwnerImpl, TypeParameterDescriptor typeParameterDescriptor) {
        ...
        this.f4776d = typeParameterDescriptor;
        if (kTypeParameterOwnerImpl == null) {
            ...
            if (containingDeclaration instanceof ClassDescriptor) {
                obj = kTypeParameterImpl.m4635a((ClassDescriptor) containingDeclaration);
                ...
                if (containingDeclaration2 instanceof ClassDescriptor) {
                    kClassImpl = kTypeParameterImpl.m4635a((ClassDescriptor) containingDeclaration2);
                } else {
                    ...
                    if (deserializedMemberDescriptor != null) {
                        KClass<?> kotlinClass = JvmClassMappingKt.getKotlinClass(kTypeParameterImpl.m4634a(deserializedMemberDescriptor));
                        if (kotlinClass != null) {
        ...
        this.f4775c = kTypeParameterOwnerImpl;
    }
    ...
    /* renamed from: a */
    private final KClassImpl<?> m4635a(ClassDescriptor classDescriptor) {
    ...
    /* renamed from: a */
    private final Class<?> m4634a(DeserializedMemberDescriptor deserializedMemberDescriptor) {
        Class<?> klass;
    ...
    public boolean equals(Object obj) {
        if (obj instanceof KTypeParameterImpl) {
            ...
            return Intrinsics.areEqual((Object) this.f4775c, (Object) kTypeParameterImpl.f4775c) && Intrinsics.areEqual((Object) getName(), (Object) kTypeParameterImpl.getName());
        }
    }

    public int hashCode() {
        return (this.f4775c.hashCode() * 31) + getName().hashCode();
    }
