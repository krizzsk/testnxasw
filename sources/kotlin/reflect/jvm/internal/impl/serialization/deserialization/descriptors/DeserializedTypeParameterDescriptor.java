...
public final class DeserializedTypeParameterDescriptor extends AbstractLazyTypeParameterDescriptor {
    ...
    /* renamed from: a */
    public final DeserializationContext f5781a;

    /* renamed from: b */
    private final ProtoBuf.TypeParameter f5782b;

    /* renamed from: c */
    private final DeserializedAnnotations f5783c;
    ...
    public List<KotlinType> resolveUpperBounds() {
        List<ProtoBuf.Type> upperBounds = ProtoTypeTableUtilKt.upperBounds(this.f5782b, this.f5781a.getTypeTable());
        ...
        TypeDeserializer typeDeserializer = this.f5781a.getTypeDeserializer();
