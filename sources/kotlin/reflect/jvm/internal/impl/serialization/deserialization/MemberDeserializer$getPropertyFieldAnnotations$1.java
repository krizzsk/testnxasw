...
final class MemberDeserializer$getPropertyFieldAnnotations$1 extends Lambda implements Function0<List<? extends AnnotationDescriptor>> {
    ...
    public final List<AnnotationDescriptor> invoke() {
        ...
        if (access$asProtoContainer == null) {
            ...
            if (z) {
                list = CollectionsKt.toList(memberDeserializer2.f5708a.getComponents().getAnnotationAndConstantLoader().loadPropertyDelegateFieldAnnotations(access$asProtoContainer, property));
            } else {
                list = CollectionsKt.toList(memberDeserializer2.f5708a.getComponents().getAnnotationAndConstantLoader().loadPropertyBackingFieldAnnotations(access$asProtoContainer, property));
            }
        }
