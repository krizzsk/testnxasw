...
public class ErrorUtils {
    ...
    /* renamed from: a */
    private static final ModuleDescriptor f5812a = new ModuleDescriptor() {
    ...
    /* renamed from: b */
    private static final ErrorClassDescriptor f5813b = new ErrorClassDescriptor(Name.special("<ERROR CLASS>"));

    /* renamed from: c */
    private static final KotlinType f5814c = createErrorType("<ERROR PROPERTY TYPE>");

    /* renamed from: d */
    private static final PropertyDescriptor f5815d;
    /* access modifiers changed from: private */

    /* renamed from: e */
    public static final Set<PropertyDescriptor> f5816e;

    /* renamed from: a */
    private static /* synthetic */ void m5213a(int i) {
    ...
    static {
        PropertyDescriptorImpl b = m5216b();
        f5815d = b;
        f5816e = Collections.singleton(b);
    }
    ...
    public static class ErrorScope implements MemberScope {
        ...
        public Set<? extends PropertyDescriptor> getContributedVariables(Name name, LookupLocation lookupLocation) {
            ...
            Set<? extends PropertyDescriptor> a = ErrorUtils.f5816e;
            if (a == null) {
                $$$reportNull$$$0(7);
            }
            return a;
        ...
        public Set<? extends SimpleFunctionDescriptor> getContributedFunctions(Name name, LookupLocation lookupLocation) {
            ...
            Set<? extends SimpleFunctionDescriptor> singleton = Collections.singleton(ErrorUtils.m5215b(this));
            if (singleton == null) {
                $$$reportNull$$$0(10);
            }
            return singleton;
    ...
    private static class ErrorClassDescriptor extends ClassDescriptorImpl {
        ...
        public ErrorClassDescriptor(Name name) {
            ...
            create.setReturnType(new ErrorType(ErrorUtils.m5217b("<ERROR>", this), createErrorScope));
    ...
    public static ClassDescriptor createErrorClass(String str) {
        ...
        return new ErrorClassDescriptor(Name.special("<ERROR CLASS: " + str + IMTextUtils.STREET_IMAGE_TAG_END));
    }
    ...
    /* renamed from: b */
    private static PropertyDescriptorImpl m5216b() {
        PropertyDescriptorImpl create = PropertyDescriptorImpl.create(f5813b, Annotations.Companion.getEMPTY(), Modality.OPEN, DescriptorVisibilities.PUBLIC, true, Name.special("<ERROR PROPERTY>"), CallableMemberDescriptor.Kind.DECLARATION, SourceElement.NO_SOURCE, false, false, false, false, false, false);
        create.setType(f5814c, Collections.emptyList(), (ReceiverParameterDescriptor) null, (ReceiverParameterDescriptor) null);
        if (create == null) {
            m5213a(4);
        }
        return create;
    ...
    /* access modifiers changed from: private */
    /* renamed from: b */
    public static SimpleFunctionDescriptor m5215b(ErrorScope errorScope) {
        if (errorScope == null) {
            m5213a(5);
        }
        ErrorSimpleFunctionDescriptorImpl errorSimpleFunctionDescriptorImpl = new ErrorSimpleFunctionDescriptorImpl(f5813b, errorScope);
    ...
    public static TypeConstructor createErrorTypeConstructor(String str) {
        ...
        return m5217b("[ERROR : " + str + Const.jaRight, f5813b);
    }
    ...
    public static TypeConstructor createErrorTypeConstructorWithCustomDebugName(String str) {
        ...
        return m5217b(str, f5813b);
    }

    /* access modifiers changed from: private */
    /* renamed from: b */
    public static TypeConstructor m5217b(final String str, final ErrorClassDescriptor errorClassDescriptor) {
        if (str == null) {
            m5213a(17);
        }
    ...
    public static boolean isError(DeclarationDescriptor declarationDescriptor) {
        ...
        return m5214a(declarationDescriptor) || m5214a(declarationDescriptor.getContainingDeclaration()) || declarationDescriptor == f5812a;
    }

    /* renamed from: a */
    private static boolean m5214a(DeclarationDescriptor declarationDescriptor) {
        return declarationDescriptor instanceof ErrorClassDescriptor;
    }

    public static ModuleDescriptor getErrorModule() {
        ModuleDescriptor moduleDescriptor = f5812a;
        if (moduleDescriptor == null) {
            m5213a(19);
        }
