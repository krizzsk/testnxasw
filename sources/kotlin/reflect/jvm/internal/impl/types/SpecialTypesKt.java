...
public final class SpecialTypesKt {
    ...
    public static final SimpleType makeSimpleTypeDefinitelyNotNullOrNotNull(SimpleType simpleType, boolean z) {
        ...
        SimpleType a = m5223a((KotlinType) simpleType);
        if (a == null) {
    ...
    public static final UnwrappedType makeDefinitelyNotNullOrNotNull(UnwrappedType unwrappedType, boolean z) {
        ...
        if (makeDefinitelyNotNull == null && (makeDefinitelyNotNull = m5223a((KotlinType) unwrappedType)) == null) {
    ...
    /* renamed from: a */
    private static final SimpleType m5223a(KotlinType kotlinType) {
        ...
        if (intersectionTypeConstructor == null || (a = m5222a(intersectionTypeConstructor)) == null) {
            return null;
        }
        return a.createType();
    }
    ...
    /* renamed from: a */
    private static final IntersectionTypeConstructor m5222a(IntersectionTypeConstructor intersectionTypeConstructor) {
