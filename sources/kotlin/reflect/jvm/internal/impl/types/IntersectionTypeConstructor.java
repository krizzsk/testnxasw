...
public final class IntersectionTypeConstructor implements TypeConstructor, IntersectionTypeConstructorMarker {
    ...
    /* renamed from: a */
    private KotlinType f5825a;

    /* renamed from: b */
    private final LinkedHashSet<KotlinType> f5826b;
    ...
    public IntersectionTypeConstructor(Collection<? extends KotlinType> collection) {
        ...
        if (!_Assertions.ENABLED || z) {
            ...
            this.f5826b = linkedHashSet;
            this.f5827c = linkedHashSet.hashCode();
            return;
        }
    ...
    public final MemberScope createScopeForKotlinType() {
        return TypeIntersectionScope.Companion.create("member scope for intersection type", this.f5826b);
    }

    public KotlinBuiltIns getBuiltIns() {
        KotlinBuiltIns builtIns = ((KotlinType) this.f5826b.iterator().next()).getConstructor().getBuiltIns();
    ...
    public final String makeDebugNameForIntersectionType(Function1<? super KotlinType, ? extends Object> function1) {
        ...
        return CollectionsKt.joinToString$default(CollectionsKt.sortedWith(this.f5826b, new C2662x55fe5063(function1)), " & ", Const.joLeft, "}", 0, (CharSequence) null, new IntersectionTypeConstructor$makeDebugNameForIntersectionType$3(function1), 24, (Object) null);
    }
    ...
    public boolean equals(Object obj) {
        ...
        return Intrinsics.areEqual((Object) this.f5826b, (Object) ((IntersectionTypeConstructor) obj).f5826b);
    }
    ...
    public final IntersectionTypeConstructor setAlternative(KotlinType kotlinType) {
        return new IntersectionTypeConstructor(this.f5826b, kotlinType);
    }
