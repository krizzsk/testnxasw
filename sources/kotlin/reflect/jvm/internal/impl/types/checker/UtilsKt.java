...
public final class UtilsKt {
    ...
    public static final kotlin.reflect.jvm.internal.impl.types.KotlinType findCorrespondingSupertype(kotlin.reflect.jvm.internal.impl.types.KotlinType r9, kotlin.reflect.jvm.internal.impl.types.KotlinType r10, kotlin.reflect.jvm.internal.impl.types.checker.TypeCheckingProcedureCallbacks r11) {
        ...
        L_0x0021:
            ...
            kotlin.reflect.jvm.internal.impl.types.checker.a r10 = (kotlin.reflect.jvm.internal.impl.types.checker.C2673a) r10
            kotlin.reflect.jvm.internal.impl.types.KotlinType r1 = r10.mo27145a()
            ...
            kotlin.reflect.jvm.internal.impl.types.checker.a r10 = r10.mo27146b()
        L_0x0043:
            if (r10 == 0) goto L_0x00c5
            kotlin.reflect.jvm.internal.impl.types.KotlinType r3 = r10.mo27145a()
        ...
        L_0x007e:
            ...
            kotlin.reflect.jvm.internal.impl.types.KotlinType r1 = m5264a((kotlin.reflect.jvm.internal.impl.types.KotlinType) r1)
            goto L_0x00b3
        L_0x009e:
            kotlin.reflect.jvm.internal.impl.types.TypeConstructorSubstitution$Companion r4 = kotlin.reflect.jvm.internal.impl.types.TypeConstructorSubstitution.Companion
            kotlin.reflect.jvm.internal.impl.types.TypeSubstitution r4 = r4.create(r3)
        ...
        L_0x00d4:
            ...
            r1.append(r2)
            java.lang.String r2 = m5262a((kotlin.reflect.jvm.internal.impl.types.TypeConstructor) r10)
            r1.append(r2)
            java.lang.String r2 = ", \n\nsupertype: "
            r1.append(r2)
            java.lang.String r2 = m5262a((kotlin.reflect.jvm.internal.impl.types.TypeConstructor) r9)
            r1.append(r2)
            java.lang.String r2 = " \n"
            r1.append(r2)
    ...
    /* renamed from: a */
    private static final KotlinType m5264a(KotlinType kotlinType) {
        return CapturedTypeApproximationKt.approximateCapturedTypes(kotlinType).getUpper();
    }

    /* renamed from: a */
    private static final String m5262a(TypeConstructor typeConstructor) {
        StringBuilder sb = new StringBuilder();
        m5263a(Intrinsics.stringPlus("type: ", typeConstructor), sb);
        m5263a(Intrinsics.stringPlus("hashCode: ", Integer.valueOf(typeConstructor.hashCode())), sb);
        m5263a(Intrinsics.stringPlus("javaClass: ", typeConstructor.getClass().getCanonicalName()), sb);
        for (DeclarationDescriptor declarationDescriptor = typeConstructor.getDeclarationDescriptor(); declarationDescriptor != null; declarationDescriptor = declarationDescriptor.getContainingDeclaration()) {
            m5263a(Intrinsics.stringPlus("fqName: ", DescriptorRenderer.FQ_NAMES_IN_TYPES.render(declarationDescriptor)), sb);
            m5263a(Intrinsics.stringPlus("javaClass: ", declarationDescriptor.getClass().getCanonicalName()), sb);
        }
    ...
    /* renamed from: a */
    private static final StringBuilder m5263a(String str, StringBuilder sb) {
