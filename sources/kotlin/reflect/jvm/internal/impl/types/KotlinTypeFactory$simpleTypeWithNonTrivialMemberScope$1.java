...
final class KotlinTypeFactory$simpleTypeWithNonTrivialMemberScope$1 extends Lambda implements Function1<KotlinTypeRefiner, SimpleType> {
    ...
    KotlinTypeFactory$simpleTypeWithNonTrivialMemberScope$1(TypeConstructor typeConstructor, List<? extends TypeProjection> list, Annotations annotations, boolean z, MemberScope memberScope) {
        super(1);
    ...
    public final SimpleType invoke(KotlinTypeRefiner kotlinTypeRefiner) {
        ...
        KotlinTypeFactory.ExpandedTypeOrRefinedConstructor access$refineConstructor = KotlinTypeFactory.INSTANCE.m5221a(this.$constructor, kotlinTypeRefiner, (List<? extends TypeProjection>) this.$arguments);
