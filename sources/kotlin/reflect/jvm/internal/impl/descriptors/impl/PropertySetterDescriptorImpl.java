...
public class PropertySetterDescriptorImpl extends PropertyAccessorDescriptorImpl implements PropertySetterDescriptor {
    ...
    /* renamed from: b */
    static final /* synthetic */ boolean f5006b = (!PropertySetterDescriptorImpl.class.desiredAssertionStatus());

    /* renamed from: c */
    private ValueParameterDescriptor f5007c;

    /* renamed from: d */
    private final PropertySetterDescriptor f5008d;

    /* renamed from: a */
    private static /* synthetic */ void m4729a(int i) {
        String str;
        int i2;
        Throwable th;
        switch (i) {
    ...
    public void initialize(ValueParameterDescriptor valueParameterDescriptor) {
        ...
        if (f5006b || this.f5007c == null) {
            this.f5007c = valueParameterDescriptor;
            return;
        }
    ...
    public List<ValueParameterDescriptor> getValueParameters() {
        ValueParameterDescriptor valueParameterDescriptor = this.f5007c;
        if (valueParameterDescriptor != null) {
    ...
    public PropertySetterDescriptor getOriginal() {
        PropertySetterDescriptor propertySetterDescriptor = this.f5008d;
        if (propertySetterDescriptor == null) {
            m4729a(13);
        }
