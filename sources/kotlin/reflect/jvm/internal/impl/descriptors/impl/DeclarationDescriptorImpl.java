...
public abstract class DeclarationDescriptorImpl extends AnnotatedImpl implements DeclarationDescriptor {
    ...
    public static String toString(DeclarationDescriptor declarationDescriptor) {
        ...
        try {
            String str = DescriptorRenderer.DEBUG_TEXT.render(declarationDescriptor) + Const.jaLeft + declarationDescriptor.getClass().getSimpleName() + "@" + Integer.toHexString(System.identityHashCode(declarationDescriptor)) + Const.jaRight;
            if (str == null) {
                $$$reportNull$$$0(5);
            }
            return str;
