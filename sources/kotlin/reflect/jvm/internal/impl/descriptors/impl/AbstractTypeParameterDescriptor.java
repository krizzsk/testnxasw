...
public abstract class AbstractTypeParameterDescriptor extends DeclarationDescriptorNonRootImpl implements TypeParameterDescriptor {
    ...
    /* renamed from: d */
    private final NotNullLazyValue<TypeConstructor> f4926d;

    /* renamed from: e */
    private final NotNullLazyValue<SimpleType> f4927e;

    /* renamed from: f */
    private final StorageManager f4928f;

    /* renamed from: a */
    private static /* synthetic */ void m4711a(int i) {
        String str;
        int i2;
        Throwable th;
        switch (i) {
    ...
    protected AbstractTypeParameterDescriptor(final StorageManager storageManager, DeclarationDescriptor declarationDescriptor, Annotations annotations, final Name name, Variance variance, boolean z, int i, SourceElement sourceElement, final SupertypeLoopChecker supertypeLoopChecker) {
        ...
        this.f4923a = variance;
        this.f4924b = z;
        this.f4925c = i;
        this.f4926d = storageManager.createLazyValue(new Function0<TypeConstructor>() {
            public TypeConstructor invoke() {
                return new TypeParameterTypeConstructor(AbstractTypeParameterDescriptor.this, storageManager, supertypeLoopChecker);
            }
        });
        this.f4927e = storageManager.createLazyValue(new Function0<SimpleType>() {
        ...
        this.f4928f = storageManager;
    }

    public Variance getVariance() {
        Variance variance = this.f4923a;
        if (variance == null) {
            m4711a(7);
        }
        return variance;
    ...
    public final TypeConstructor getTypeConstructor() {
        TypeConstructor typeConstructor = (TypeConstructor) this.f4926d.invoke();
    ...
    public SimpleType getDefaultType() {
        SimpleType simpleType = (SimpleType) this.f4927e.invoke();
        if (simpleType == null) {
            m4711a(10);
        }
        return simpleType;
    ...
    public StorageManager getStorageManager() {
        StorageManager storageManager = this.f4928f;
        if (storageManager == null) {
            m4711a(14);
        }
