...
public abstract class AbstractTypeAliasDescriptor extends DeclarationDescriptorNonRootImpl implements TypeAliasDescriptor {
    ...
    /* renamed from: a */
    private final DescriptorVisibility f4920a;

    /* renamed from: b */
    private List<? extends TypeParameterDescriptor> f4921b;

    /* renamed from: c */
    private final AbstractTypeAliasDescriptor$typeConstructor$1 f4922c = new AbstractTypeAliasDescriptor$typeConstructor$1(this);
    ...
    public AbstractTypeAliasDescriptor(DeclarationDescriptor declarationDescriptor, Annotations annotations, Name name, SourceElement sourceElement, DescriptorVisibility descriptorVisibility) {
        ...
        this.f4920a = descriptorVisibility;
    }
    ...
    public List<TypeParameterDescriptor> getDeclaredTypeParameters() {
        List<? extends TypeParameterDescriptor> list = this.f4921b;
        if (list != null) {
            return list;
        }
