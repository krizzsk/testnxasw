...
public final class Visibilities {
    ...
    /* renamed from: a */
    private static final Map<Visibility, Integer> f4896a;

    /* renamed from: b */
    private static final Public f4897b = Public.INSTANCE;
    ...
    static {
        ...
        f4896a = MapsKt.build(createMapBuilder);
    }
    ...
    public final Integer compareLocal$compiler_common(Visibility visibility, Visibility visibility2) {
        ...
        Integer num = f4896a.get(visibility);
        Integer num2 = f4896a.get(visibility2);
