...
final class Java8ParameterNamesLoader {
    ...
    /* renamed from: a */
    public static final Java8ParameterNamesLoader f5038a = new Java8ParameterNamesLoader();

    /* renamed from: b */
    private static Cache f5039b;
    ...
    /* renamed from: a */
    public final Cache mo24771a(Member member) {
    ...
    /* renamed from: b */
    public final List<String> mo24772b(Member member) {
        Method getName;
        Intrinsics.checkNotNullParameter(member, "member");
        Cache cache = f5039b;
        if (cache == null) {
            cache = mo24771a(member);
            f5039b = cache;
        }
