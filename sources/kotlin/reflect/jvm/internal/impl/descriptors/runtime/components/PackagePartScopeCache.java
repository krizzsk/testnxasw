...
public final class PackagePartScopeCache {
    ...
    /* renamed from: a */
    private final DeserializedDescriptorResolver f5024a;

    /* renamed from: b */
    private final ReflectKotlinClassFinder f5025b;

    /* renamed from: c */
    private final ConcurrentHashMap<ClassId, MemberScope> f5026c = new ConcurrentHashMap<>();
    ...
    public PackagePartScopeCache(DeserializedDescriptorResolver deserializedDescriptorResolver, ReflectKotlinClassFinder reflectKotlinClassFinder) {
        ...
        this.f5024a = deserializedDescriptorResolver;
        this.f5025b = reflectKotlinClassFinder;
    }
    ...
    public final MemberScope getPackagePartScope(ReflectKotlinClass reflectKotlinClass) {
        ...
        ConcurrentMap concurrentMap = this.f5026c;
        ...
        if (obj == null) {
            ...
            if (reflectKotlinClass.getClassHeader().getKind() == KotlinClassHeader.Kind.MULTIFILE_CLASS) {
                ...
                for (String byInternalName : reflectKotlinClass.getClassHeader().getMultifilePartNames()) {
                    ...
                    KotlinJvmBinaryClass findKotlinClass = KotlinClassFinderKt.findKotlinClass((KotlinClassFinder) this.f5025b, classId2);
            ...
            EmptyPackageFragmentDescriptor emptyPackageFragmentDescriptor = new EmptyPackageFragmentDescriptor(this.f5024a.getComponents().getModuleDescriptor(), packageFqName);
            Collection arrayList2 = new ArrayList();
            for (KotlinJvmBinaryClass createKotlinPackagePartScope : list) {
                MemberScope createKotlinPackagePartScope2 = this.f5024a.createKotlinPackagePartScope(emptyPackageFragmentDescriptor, createKotlinPackagePartScope);
