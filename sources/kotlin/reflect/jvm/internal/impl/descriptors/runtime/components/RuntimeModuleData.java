...
public final class RuntimeModuleData {
    ...
    /* renamed from: a */
    private final DeserializationComponents f5034a;

    /* renamed from: b */
    private final PackagePartScopeCache f5035b;
    ...
    private RuntimeModuleData(DeserializationComponents deserializationComponents, PackagePartScopeCache packagePartScopeCache) {
        this.f5034a = deserializationComponents;
        this.f5035b = packagePartScopeCache;
    }
    ...
    public final ModuleDescriptor getModule() {
        return this.f5034a.getModuleDescriptor();
    }
    ...
    public static final class Companion {
        ...
        public final RuntimeModuleData create(ClassLoader classLoader) {
            ...
            moduleDescriptorImpl3.initialize(new CompositePackageFragmentProvider(CollectionsKt.listOf(javaDescriptorResolver.getPackageFragmentProvider(), jvmBuiltInsPackageFragmentProvider), Intrinsics.stringPlus("CompositeProvider@RuntimeModuleData for ", moduleDescriptorImpl3)));
