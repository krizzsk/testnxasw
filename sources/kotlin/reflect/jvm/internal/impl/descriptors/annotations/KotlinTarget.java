...
public enum KotlinTarget {
    ...
    EXPRESSION(TrackConst.Params.EXPRESSION, false),
    FILE("file", false),
    ...
    static {
        ...
        USE_SITE_MAPPING = MapsKt.mapOf(TuplesKt.m41339to(AnnotationUseSiteTarget.CONSTRUCTOR_PARAMETER, VALUE_PARAMETER), TuplesKt.m41339to(AnnotationUseSiteTarget.FIELD, FIELD), TuplesKt.m41339to(AnnotationUseSiteTarget.PROPERTY, PROPERTY), TuplesKt.m41339to(AnnotationUseSiteTarget.FILE, FILE), TuplesKt.m41339to(AnnotationUseSiteTarget.PROPERTY_GETTER, PROPERTY_GETTER), TuplesKt.m41339to(AnnotationUseSiteTarget.PROPERTY_SETTER, PROPERTY_SETTER), TuplesKt.m41339to(AnnotationUseSiteTarget.RECEIVER, VALUE_PARAMETER), TuplesKt.m41339to(AnnotationUseSiteTarget.SETTER_PARAMETER, VALUE_PARAMETER), TuplesKt.m41339to(AnnotationUseSiteTarget.PROPERTY_DELEGATE_FIELD, FIELD));
    }
