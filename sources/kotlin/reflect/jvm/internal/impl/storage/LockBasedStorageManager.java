...
public class LockBasedStorageManager implements StorageManager {
    ...
    private static abstract class LockBasedLazyValueWithPostCompute<T> extends LockBasedLazyValue<T> {
        private volatile C2656a<T> valuePostCompute;
        ...
        public T invoke() {
            C2656a<T> aVar = this.valuePostCompute;
            if (aVar == null || !aVar.mo26979a()) {
                return super.invoke();
            }
            return aVar.mo26980b();
        }

        /* access modifiers changed from: protected */
        public final void postCompute(T t) {
            this.valuePostCompute = new C2656a<>(t);
            try {
                doPostCompute(t);
            } finally {
                this.valuePostCompute = null;
