...
public final class JvmProtoBufUtil {
    ...
    /* renamed from: a */
    private static final ExtensionRegistryLite f5427a;
    ...
    public static final Pair<JvmNameResolver, ProtoBuf.Class> readClassDataFrom(byte[] bArr, String[] strArr) {
        ...
        return new Pair<>(INSTANCE.m4949a(byteArrayInputStream, strArr), ProtoBuf.Class.parseFrom(byteArrayInputStream, f5427a));
    }
    ...
    public static final Pair<JvmNameResolver, ProtoBuf.Package> readPackageDataFrom(byte[] bArr, String[] strArr) {
        ...
        Intrinsics.checkNotNullParameter(strArr, "strings");
        InputStream byteArrayInputStream = new ByteArrayInputStream(bArr);
        return new Pair<>(INSTANCE.m4949a(byteArrayInputStream, strArr), ProtoBuf.Package.parseFrom(byteArrayInputStream, f5427a));
    }
    ...
    public static final Pair<JvmNameResolver, ProtoBuf.Function> readFunctionDataFrom(String[] strArr, String[] strArr2) {
        ...
        return new Pair<>(INSTANCE.m4949a(byteArrayInputStream, strArr2), ProtoBuf.Function.parseFrom(byteArrayInputStream, f5427a));
    }

    /* renamed from: a */
    private final JvmNameResolver m4949a(InputStream inputStream, String[] strArr) {
        JvmProtoBuf.StringTableTypes parseDelimitedFrom = JvmProtoBuf.StringTableTypes.parseDelimitedFrom(inputStream, f5427a);
    ...
    public final JvmMemberSignature.Method getJvmMethodSignature(ProtoBuf.Function function, NameResolver nameResolver, TypeTable typeTable) {
        ...
        if (jvmMethodSignature == null || !jvmMethodSignature.hasDesc()) {
            ...
            for (ProtoBuf.Type a : plus) {
                String a2 = INSTANCE.m4948a(a, nameResolver2);
                if (a2 == null) {
                    return null;
                }
                arrayList2.add(a2);
            ...
            String a3 = m4948a(ProtoTypeTableUtilKt.returnType(function2, typeTable2), nameResolver2);
            if (a3 == null) {
                return null;
            }
    ...
    public final JvmMemberSignature.Method getJvmConstructorSignature(ProtoBuf.Constructor constructor, NameResolver nameResolver, TypeTable typeTable) {
        ...
        if (jvmMethodSignature == null || !jvmMethodSignature.hasDesc()) {
            ...
            for (ProtoBuf.ValueParameter valueParameter : iterable) {
                ...
                Intrinsics.checkNotNullExpressionValue(valueParameter, "it");
                String a = jvmProtoBufUtil.m4948a(ProtoTypeTableUtilKt.type(valueParameter, typeTable), nameResolver);
                if (a == null) {
                    return null;
                }
                arrayList.add(a);
    ...
    public final JvmMemberSignature.Field getJvmFieldSignature(ProtoBuf.Property property, NameResolver nameResolver, TypeTable typeTable, boolean z) {
        ...
        if (field == null || !field.hasDesc()) {
            str = m4948a(ProtoTypeTableUtilKt.returnType(property, typeTable), nameResolver);
            if (str == null) {
                return null;
            }
        } else {
    ...
    /* renamed from: a */
    private final String m4948a(ProtoBuf.Type type, NameResolver nameResolver) {
