...
public final class OperatorChecks extends AbstractModifierChecks {
    ...
    /* renamed from: a */
    private static final List<Checks> f5896a;
    ...
    static {
        ...
        Check[] checkArr3 = {MemberKindCheck.MemberOrExtension.INSTANCE, C2688b.f5902a, new ValueParameterCountCheck.AtLeast(2), C2687a.f5900a};
        Name name4 = OperatorNameConventions.SET_VALUE;
        Check[] checkArr4 = {MemberKindCheck.MemberOrExtension.INSTANCE, C2688b.f5902a, new ValueParameterCountCheck.AtLeast(3), C2687a.f5900a};
        Name name5 = OperatorNameConventions.PROVIDE_DELEGATE;
        Check[] checkArr5 = {MemberKindCheck.MemberOrExtension.INSTANCE, C2688b.f5902a, new ValueParameterCountCheck.Equals(2), C2687a.f5900a};
        ...
        Check[] checkArr7 = {MemberKindCheck.MemberOrExtension.INSTANCE, ValueParameterCountCheck.SingleValueParameter.INSTANCE, C2688b.f5902a, ReturnsCheck.ReturnsBoolean.INSTANCE};
        ...
        Check[] checkArr11 = {MemberKindCheck.MemberOrExtension.INSTANCE, ValueParameterCountCheck.SingleValueParameter.INSTANCE, C2688b.f5902a};
        ...
        Check[] checkArr13 = {MemberKindCheck.MemberOrExtension.INSTANCE, ReturnsCheck.ReturnsInt.INSTANCE, ValueParameterCountCheck.SingleValueParameter.INSTANCE, C2688b.f5902a};
        Check[] checkArr14 = {MemberKindCheck.MemberOrExtension.INSTANCE, ValueParameterCountCheck.SingleValueParameter.INSTANCE, C2688b.f5902a};
