...
public final class EnumValue extends ConstantValue<Pair<? extends ClassId, ? extends Name>> {
    ...
    /* renamed from: a */
    private final ClassId f5583a;

    /* renamed from: b */
    private final Name f5584b;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public EnumValue(ClassId classId, Name name) {
        super(TuplesKt.m41339to(classId, name));
    ...
    public KotlinType getType(ModuleDescriptor moduleDescriptor) {
        ...
        ClassDescriptor findClassAcrossModuleDependencies = FindClassInModuleKt.findClassAcrossModuleDependencies(moduleDescriptor, this.f5583a);
        ...
        SimpleType createErrorType = ErrorUtils.createErrorType("Containing class for error-class based enum entry " + this.f5583a + '.' + this.f5584b);
    ...
    public String toString() {
        ...
        sb.append(this.f5583a.getShortClassName());
        sb.append('.');
