    ...
    public static abstract class Value {
        ...
        public static final class NormalClass extends Value {
            ...
            public String toString() {
                return "NormalClass(value=" + this.value + VersionRange.RIGHT_OPEN;
            }
        ...
        public static final class LocalClass extends Value {
            ...
            public String toString() {
                return "LocalClass(type=" + this.type + VersionRange.RIGHT_OPEN;
            }
    ...
    public final KotlinType getArgumentType(ModuleDescriptor moduleDescriptor) {
        ...
        if (value instanceof Value.NormalClass) {
            ...
            if (findClassAcrossModuleDependencies == null) {
                SimpleType createErrorType = ErrorUtils.createErrorType("Unresolved type: " + component1 + " (arrayDimensions=" + component2 + VersionRange.RIGHT_OPEN);
