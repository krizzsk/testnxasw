...
public class DescriptorFactory {
    /* renamed from: a */
    private static /* synthetic */ void m5098a(int i) {
    ...
    public static SimpleFunctionDescriptor createEnumValueOfMethod(ClassDescriptor classDescriptor) {
        ...
        SimpleFunctionDescriptorImpl initialize = simpleFunctionDescriptorImpl.initialize((ReceiverParameterDescriptor) null, (ReceiverParameterDescriptor) null, Collections.emptyList(), Collections.singletonList(new ValueParameterDescriptorImpl(create, (ValueParameterDescriptor) null, 0, Annotations.Companion.getEMPTY(), Name.identifier("value"), DescriptorUtilsKt.getBuiltIns(classDescriptor).getStringType(), false, false, false, (KotlinType) null, classDescriptor.getSource())), (KotlinType) classDescriptor.getDefaultType(), Modality.FINAL, DescriptorVisibilities.PUBLIC);
        if (initialize == null) {
            m5098a(25);
        }
        return initialize;
    ...
    public static boolean isEnumValuesMethod(FunctionDescriptor functionDescriptor) {
        ...
        return functionDescriptor.getName().equals(StandardNames.ENUM_VALUES) && m5099a(functionDescriptor);
    }
    ...
    public static boolean isEnumValueOfMethod(FunctionDescriptor functionDescriptor) {
        ...
        return functionDescriptor.getName().equals(StandardNames.ENUM_VALUE_OF) && m5099a(functionDescriptor);
    }

    /* renamed from: a */
    private static boolean m5099a(FunctionDescriptor functionDescriptor) {
        if (functionDescriptor == null) {
            m5098a(28);
        }
