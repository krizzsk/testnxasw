...
public final class InlineClassManglingRulesKt {
    ...
    public static final boolean isInlineClassThatRequiresMangling(DeclarationDescriptor declarationDescriptor) {
        ...
        return InlineClassesUtilsKt.isInlineClass(declarationDescriptor) && !m5135a((ClassDescriptor) declarationDescriptor);
    }
    ...
    /* renamed from: a */
    private static final boolean m5136a(KotlinType kotlinType) {
        return isInlineClassThatRequiresMangling(kotlinType) || m5137b(kotlinType);
    }

    /* renamed from: a */
    private static final boolean m5135a(ClassDescriptor classDescriptor) {
        return Intrinsics.areEqual((Object) DescriptorUtilsKt.getFqNameSafe(classDescriptor), (Object) StandardNames.RESULT_FQ_NAME);
    }

    /* renamed from: b */
    private static final boolean m5137b(KotlinType kotlinType) {
        ClassifierDescriptor declarationDescriptor = kotlinType.getConstructor().getDeclarationDescriptor();
        ...
        return m5136a(TypeUtilsKt.getRepresentativeUpperBound(typeParameterDescriptor));
    }
}
