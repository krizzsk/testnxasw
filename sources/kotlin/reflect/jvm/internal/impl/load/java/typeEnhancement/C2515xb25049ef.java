...
final class C2515xb25049ef extends Lambda implements Function1<SignatureEnhancementBuilder.ClassEnhancementBuilder.FunctionEnhancementBuilder, Unit> {
    final /* synthetic */ String $JFPredicate;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    C2515xb25049ef(String str) {
        super(1);
    ...
    public final void invoke(SignatureEnhancementBuilder.ClassEnhancementBuilder.FunctionEnhancementBuilder functionEnhancementBuilder) {
        ...
        functionEnhancementBuilder.parameter(this.$JFPredicate, PredefinedEnhancementInfoKt.f5315b, PredefinedEnhancementInfoKt.f5315b);
