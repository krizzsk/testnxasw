...
public final class LazyJavaPackageScope extends LazyJavaStaticScope {
    ...
    /* renamed from: b */
    private final JavaPackage f5266b;

    /* renamed from: c */
    private final LazyJavaPackageFragment f5267c;

    /* renamed from: d */
    private final NullableLazyValue<Set<String>> f5268d;

    /* renamed from: e */
    private final MemoizedFunctionToNullable<FindClassRequest, ClassDescriptor> f5269e;
    ...
    public LazyJavaPackageScope(LazyJavaResolverContext lazyJavaResolverContext, JavaPackage javaPackage, LazyJavaPackageFragment lazyJavaPackageFragment) {
        ...
        this.f5266b = javaPackage;
        this.f5267c = lazyJavaPackageFragment;
        this.f5268d = lazyJavaResolverContext.getStorageManager().createNullableLazyValue(new LazyJavaPackageScope$knownClassNamesInPackage$1(lazyJavaResolverContext, this));
        this.f5269e = lazyJavaResolverContext.getStorageManager().createMemoizedFunctionWithNullableValues(new LazyJavaPackageScope$classes$1(this, lazyJavaResolverContext));
    }
    ...
    /* renamed from: a */
    public final KotlinClassLookupResult m4835a(KotlinJvmBinaryClass kotlinJvmBinaryClass) {
    ...
    public ClassDescriptor getContributedClassifier(Name name, LookupLocation lookupLocation) {
        ...
        return m4834a(name, (JavaClass) null);
    }

    /* renamed from: a */
    private final ClassDescriptor m4834a(Name name, JavaClass javaClass) {
        if (!SpecialNames.isSafeIdentifier(name)) {
            return null;
        }
        Set set = (Set) this.f5268d.invoke();
        if (javaClass != null || set == null || set.contains(name.asString())) {
            return this.f5269e.invoke(new FindClassRequest(name, javaClass));
        }
        return null;
    }
    ...
    public final ClassDescriptor findClassifierByJavaClass$descriptors_jvm(JavaClass javaClass) {
        ...
        return m4834a(javaClass.getName(), javaClass);
    }
    ...
    public Set<Name> computeClassNames(DescriptorKindFilter descriptorKindFilter, Function1<? super Name, Boolean> function1) {
        ...
        Set<String> set = (Set) this.f5268d.invoke();
        if (set != null) {
        ...
        JavaPackage javaPackage = this.f5266b;
        if (function1 == null) {
