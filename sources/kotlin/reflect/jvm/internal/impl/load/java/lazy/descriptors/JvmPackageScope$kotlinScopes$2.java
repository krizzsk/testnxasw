...
final class JvmPackageScope$kotlinScopes$2 extends Lambda implements Function0<MemberScope[]> {
    ...
    public final MemberScope[] invoke() {
        ...
        for (KotlinJvmBinaryClass createKotlinPackagePartScope : this.this$0.f5220c.getBinaryClasses$descriptors_jvm().values()) {
            MemberScope createKotlinPackagePartScope2 = jvmPackageScope.f5219b.getComponents().getDeserializedDescriptorResolver().createKotlinPackagePartScope(jvmPackageScope.f5220c, createKotlinPackagePartScope);
