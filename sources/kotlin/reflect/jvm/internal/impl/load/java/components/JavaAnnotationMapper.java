...
public final class JavaAnnotationMapper {
    ...
    /* renamed from: a */
    private static final Name f5149a;

    /* renamed from: b */
    private static final Name f5150b;

    /* renamed from: c */
    private static final Name f5151c;

    /* renamed from: d */
    private static final Map<FqName, FqName> f5152d = MapsKt.mapOf(TuplesKt.m41339to(StandardNames.FqNames.target, JvmAnnotationNames.TARGET_ANNOTATION), TuplesKt.m41339to(StandardNames.FqNames.retention, JvmAnnotationNames.RETENTION_ANNOTATION), TuplesKt.m41339to(StandardNames.FqNames.repeatable, JvmAnnotationNames.REPEATABLE_ANNOTATION), TuplesKt.m41339to(StandardNames.FqNames.mustBeDocumented, JvmAnnotationNames.DOCUMENTED_ANNOTATION));

    /* renamed from: e */
    private static final Map<FqName, FqName> f5153e = MapsKt.mapOf(TuplesKt.m41339to(JvmAnnotationNames.TARGET_ANNOTATION, StandardNames.FqNames.target), TuplesKt.m41339to(JvmAnnotationNames.RETENTION_ANNOTATION, StandardNames.FqNames.retention), TuplesKt.m41339to(JvmAnnotationNames.DEPRECATED_ANNOTATION, StandardNames.FqNames.deprecated), TuplesKt.m41339to(JvmAnnotationNames.REPEATABLE_ANNOTATION, StandardNames.FqNames.repeatable), TuplesKt.m41339to(JvmAnnotationNames.DOCUMENTED_ANNOTATION, StandardNames.FqNames.mustBeDocumented));
    ...
    public final AnnotationDescriptor findMappedJavaAnnotation(FqName fqName, JavaAnnotationOwner javaAnnotationOwner, LazyJavaResolverContext lazyJavaResolverContext) {
        ...
        FqName fqName3 = f5152d.get(fqName);
