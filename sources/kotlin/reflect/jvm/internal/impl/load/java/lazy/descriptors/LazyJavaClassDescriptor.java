...
public final class LazyJavaClassDescriptor extends ClassDescriptorBase implements JavaClassDescriptor {
    ...
    /* renamed from: q */
    private static final Set<String> f5232q = SetsKt.setOf("equals", "hashCode", "getClass", "wait", "notify", "notifyAll", "toString");

    /* renamed from: a */
    private final LazyJavaResolverContext f5233a;

    /* renamed from: b */
    private final JavaClass f5234b;
    /* access modifiers changed from: private */

    /* renamed from: c */
    public final ClassDescriptor f5235c;
    /* access modifiers changed from: private */

    /* renamed from: d */
    public final LazyJavaResolverContext f5236d;

    /* renamed from: e */
    private final Lazy f5237e;

    /* renamed from: f */
    private final ClassKind f5238f;

    /* renamed from: g */
    private final Modality f5239g;

    /* renamed from: h */
    private final Visibility f5240h;

    /* renamed from: i */
    private final boolean f5241i;

    /* renamed from: j */
    private final LazyJavaClassTypeConstructor f5242j;
    /* access modifiers changed from: private */

    /* renamed from: k */
    public final LazyJavaClassMemberScope f5243k;

    /* renamed from: l */
    private final ScopesHolderForClass<LazyJavaClassMemberScope> f5244l;

    /* renamed from: m */
    private final InnerClassesScopeWrapper f5245m;

    /* renamed from: n */
    private final LazyJavaStaticClassScope f5246n;

    /* renamed from: o */
    private final Annotations f5247o;

    /* renamed from: p */
    private final NotNullLazyValue<List<TypeParameterDescriptor>> f5248p;
    ...
    public LazyJavaClassDescriptor(kotlin.reflect.jvm.internal.impl.load.java.lazy.LazyJavaResolverContext r16, kotlin.reflect.jvm.internal.impl.descriptors.DeclarationDescriptor r17, kotlin.reflect.jvm.internal.impl.load.java.structure.JavaClass r18, kotlin.reflect.jvm.internal.impl.descriptors.ClassDescriptor r19) {
        /*
            ...
            kotlin.reflect.jvm.internal.impl.load.java.structure.JavaClass r1 = r6.f5234b
            r2 = r6
            kotlin.reflect.jvm.internal.impl.descriptors.ClassDescriptor r2 = (kotlin.reflect.jvm.internal.impl.descriptors.ClassDescriptor) r2
            r0.recordClass(r1, r2)
            kotlin.reflect.jvm.internal.impl.load.java.structure.JavaClass r0 = r6.f5234b
        ...
        L_0x00c6:
            ...
            kotlin.reflect.jvm.internal.impl.load.java.structure.JavaClass r4 = r6.f5234b
        ...
        L_0x00e3:
            r4 = 1
        L_0x00e4:
            kotlin.reflect.jvm.internal.impl.load.java.structure.JavaClass r5 = r6.f5234b
        ...
        L_0x010f:
            ...
            kotlin.reflect.jvm.internal.impl.load.java.lazy.LazyJavaResolverContext r8 = r6.f5236d
            kotlin.reflect.jvm.internal.impl.load.java.structure.JavaClass r10 = r6.f5234b
            kotlin.reflect.jvm.internal.impl.descriptors.ClassDescriptor r4 = r6.f5235c
        ...
        L_0x0125:
            ...
            kotlin.reflect.jvm.internal.impl.load.java.lazy.LazyJavaResolverContext r1 = r6.f5236d
            kotlin.reflect.jvm.internal.impl.storage.StorageManager r1 = r1.getStorageManager()
            kotlin.reflect.jvm.internal.impl.load.java.lazy.LazyJavaResolverContext r3 = r6.f5236d
            ...
            kotlin.reflect.jvm.internal.impl.load.java.lazy.descriptors.LazyJavaClassMemberScope r1 = r6.f5243k
            ...
            kotlin.reflect.jvm.internal.impl.load.java.lazy.LazyJavaResolverContext r1 = r6.f5236d
            kotlin.reflect.jvm.internal.impl.load.java.structure.JavaClass r2 = r6.f5234b
            r0.<init>(r1, r2, r15)
            r6.f5246n = r0
            kotlin.reflect.jvm.internal.impl.load.java.lazy.LazyJavaResolverContext r0 = r6.f5236d
            kotlin.reflect.jvm.internal.impl.load.java.structure.JavaClass r1 = r6.f5234b
    ...
    public final List<JavaAnnotation> getModuleAnnotations() {
        return (List) this.f5237e.getValue();
    }
    ...
    public DescriptorVisibility getVisibility() {
        if (!Intrinsics.areEqual((Object) this.f5240h, (Object) DescriptorVisibilities.PRIVATE) || this.f5234b.getOuterClass() != null) {
            return UtilsKt.toDescriptorVisibility(this.f5240h);
        }
    ...
    public LazyJavaClassMemberScope getUnsubstitutedMemberScope(KotlinTypeRefiner kotlinTypeRefiner) {
        ...
        return this.f5244l.getScope(kotlinTypeRefiner);
    }
    ...
    public List<ClassConstructorDescriptor> getConstructors() {
        return (List) this.f5243k.getConstructors$descriptors_jvm().invoke();
    }
    ...
    public List<TypeParameterDescriptor> getDeclaredTypeParameters() {
        return (List) this.f5248p.invoke();
    }

    public Collection<ClassDescriptor> getSealedSubclasses() {
        if (this.f5239g != Modality.SEALED) {
        ...
        for (JavaClassifierType transformJavaType : this.f5234b.getPermittedTypes()) {
            ClassifierDescriptor declarationDescriptor = this.f5236d.getTypeResolver().transformJavaType(transformJavaType, attributes$default).getConstructor().getDeclarationDescriptor();
    ...
    private final class LazyJavaClassTypeConstructor extends AbstractClassTypeConstructor {
        private final NotNullLazyValue<List<TypeParameterDescriptor>> parameters = this.this$0.f5236d.getStorageManager().createLazyValue(new C2505xbaf55d8a(this.this$0));
        ...
        public LazyJavaClassTypeConstructor(LazyJavaClassDescriptor lazyJavaClassDescriptor) {
            super(lazyJavaClassDescriptor.f5236d.getStorageManager());
        ...
        public Collection<KotlinType> computeSupertypes() {
            ...
            while (true) {
                ...
                KotlinType enhanceSuperType = this.this$0.f5236d.getComponents().getSignatureEnhancement().enhanceSuperType(this.this$0.f5236d.getTypeResolver().transformJavaType(next, JavaTypeResolverKt.toAttributes$default(TypeUsage.SUPERTYPE, false, (TypeParameterDescriptor) null, 3, (Object) null)), this.this$0.f5236d);
            ...
            ClassDescriptor access$getAdditionalSupertypeClassDescriptor$p = this.this$0.f5235c;
            ...
            if (!arrayList2.isEmpty()) {
                ErrorReporter errorReporter = this.this$0.f5236d.getComponents().getErrorReporter();
            ...
            return collection.isEmpty() ^ true ? CollectionsKt.toList(arrayList) : CollectionsKt.listOf(this.this$0.f5236d.getModule().getBuiltIns().getAnyType());
        }
        ...
        private final kotlin.reflect.jvm.internal.impl.types.KotlinType getPurelyImplementedSupertype() {
            ...
            L_0x0031:
                kotlin.reflect.jvm.internal.impl.load.java.lazy.descriptors.LazyJavaClassDescriptor r4 = r8.this$0
                kotlin.reflect.jvm.internal.impl.load.java.lazy.LazyJavaResolverContext r4 = r4.f5236d
        ...
        public SupertypeLoopChecker getSupertypeLoopChecker() {
            return this.this$0.f5236d.getComponents().getSupertypeLoopChecker();
        }
    ...
    public final LazyJavaClassDescriptor copy$descriptors_jvm(JavaResolverCache javaResolverCache, ClassDescriptor classDescriptor) {
        ...
        LazyJavaResolverContext lazyJavaResolverContext = this.f5236d;
        ...
        return new LazyJavaClassDescriptor(replaceComponents, containingDeclaration, this.f5234b, classDescriptor);
    }
}
