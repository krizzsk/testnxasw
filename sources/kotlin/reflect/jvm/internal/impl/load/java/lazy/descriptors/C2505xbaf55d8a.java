...
final class C2505xbaf55d8a extends Lambda implements Function0<List<? extends TypeParameterDescriptor>> {
    final /* synthetic */ LazyJavaClassDescriptor this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    C2505xbaf55d8a(LazyJavaClassDescriptor lazyJavaClassDescriptor) {
        super(0);
