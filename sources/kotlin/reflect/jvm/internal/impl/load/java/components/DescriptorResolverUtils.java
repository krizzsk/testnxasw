...
public final class DescriptorResolverUtils {
    /* renamed from: a */
    private static /* synthetic */ void m4782a(int i) {
    ...
    public static <D extends CallableMemberDescriptor> Collection<D> resolveOverridesForNonStaticMembers(Name name, Collection<D> collection, Collection<D> collection2, ClassDescriptor classDescriptor, ErrorReporter errorReporter, OverridingUtil overridingUtil) {
        ...
        return m4781a(name, collection, collection2, classDescriptor, errorReporter, overridingUtil, false);
    }
    ...
    public static <D extends CallableMemberDescriptor> Collection<D> resolveOverridesForStaticMembers(Name name, Collection<D> collection, Collection<D> collection2, ClassDescriptor classDescriptor, ErrorReporter errorReporter, OverridingUtil overridingUtil) {
        ...
        return m4781a(name, collection, collection2, classDescriptor, errorReporter, overridingUtil, true);
    }

    /* renamed from: a */
    private static <D extends CallableMemberDescriptor> Collection<D> m4781a(Name name, Collection<D> collection, Collection<D> collection2, ClassDescriptor classDescriptor, final ErrorReporter errorReporter, OverridingUtil overridingUtil, final boolean z) {
        if (name == null) {
            m4782a(12);
        }
        if (collection == null) {
