...
final class C2532xb2505536 extends Lambda implements Function1<SignatureEnhancementBuilder.ClassEnhancementBuilder.FunctionEnhancementBuilder, Unit> {
    final /* synthetic */ String $JFConsumer;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    C2532xb2505536(String str) {
        super(1);
        this.$JFConsumer = str;
    }
    ...
    public final void invoke(SignatureEnhancementBuilder.ClassEnhancementBuilder.FunctionEnhancementBuilder functionEnhancementBuilder) {
        ...
        functionEnhancementBuilder.parameter(this.$JFConsumer, PredefinedEnhancementInfoKt.f5315b, PredefinedEnhancementInfoKt.f5316c);
    }
}
