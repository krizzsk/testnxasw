...
public final class MethodSignatureMappingKt {
    ...
    public static final boolean forceSingleValueParameterBoxing(CallableDescriptor callableDescriptor) {
        ...
        if (!Intrinsics.areEqual((Object) functionDescriptor.getName().asString(), (Object) WalletExtraConstant.Key.REMOVE) || functionDescriptor.getValueParameters().size() != 1 || SpecialBuiltinMembers.isFromJavaOrBuiltins((CallableMemberDescriptor) callableDescriptor)) {
            return false;
        }
    ...
    /* renamed from: a */
    private static final void m4928a(StringBuilder sb, KotlinType kotlinType) {
        sb.append(mapToJvmType(kotlinType));
    }

    public static final JvmType mapToJvmType(KotlinType kotlinType) {
        Intrinsics.checkNotNullParameter(kotlinType, "<this>");
        return (JvmType) DescriptorBasedTypeSignatureMappingKt.mapType$default(kotlinType, JvmTypeFactoryImpl.f5359a, TypeMappingMode.DEFAULT, TypeMappingConfigurationImpl.INSTANCE, (JvmDescriptorTypeWriter) null, (Function3) null, 32, (Object) null);
    }
