...
public final class BinaryClassAnnotationAndConstantLoaderImpl extends AbstractBinaryClassAnnotationAndConstantLoader<AnnotationDescriptor, ConstantValue<?>> {
    ...
    /* renamed from: a */
    private final ModuleDescriptor f5338a;

    /* renamed from: b */
    private final NotFoundClasses f5339b;

    /* renamed from: c */
    private final AnnotationDeserializer f5340c;
    ...
    public BinaryClassAnnotationAndConstantLoaderImpl(ModuleDescriptor moduleDescriptor, NotFoundClasses notFoundClasses, StorageManager storageManager, KotlinClassFinder kotlinClassFinder) {
        ...
        this.f5338a = moduleDescriptor;
        this.f5339b = notFoundClasses;
        this.f5340c = new AnnotationDeserializer(moduleDescriptor, notFoundClasses);
    }
    ...
    public AnnotationDescriptor loadTypeAnnotation(ProtoBuf.Annotation annotation, NameResolver nameResolver) {
        ...
        return this.f5340c.deserializeAnnotation(annotation, nameResolver);
    }
    ...
    public KotlinJvmBinaryClass.AnnotationArgumentVisitor loadAnnotation(ClassId classId, SourceElement sourceElement, List<AnnotationDescriptor> list) {
        ...
        return new BinaryClassAnnotationAndConstantLoaderImpl$loadAnnotation$1(this, m4915a(classId), list, sourceElement);
    }

    /* renamed from: a */
    private final ClassDescriptor m4915a(ClassId classId) {
        return FindClassInModuleKt.findNonGenericClassAcrossDependencies(this.f5338a, classId, this.f5339b);
    }
}
