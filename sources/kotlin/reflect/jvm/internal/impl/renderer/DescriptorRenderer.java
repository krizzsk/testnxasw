...
public abstract class DescriptorRenderer {
    ...
    public static final DescriptorRenderer FQ_NAMES_IN_TYPES_WITH_ANNOTATIONS = Companion.withOptions(C2617xb65db377.INSTANCE);
    ...
    public static final class Companion {
        ...
        public final String getClassifierKindPrefix(ClassifierDescriptorWithTypeParameters classifierDescriptorWithTypeParameters) {
            Intrinsics.checkNotNullParameter(classifierDescriptorWithTypeParameters, IdentityNamespace.REQUIREMENT_CLASSIFIER_DIRECTIVE);
