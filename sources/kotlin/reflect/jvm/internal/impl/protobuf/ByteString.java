...
public abstract class ByteString implements Iterable<Byte> {
    ...
    /* renamed from: a */
    static final /* synthetic */ boolean f5456a = (!ByteString.class.desiredAssertionStatus());
    ...
    /* renamed from: b */
    public abstract void mo26147b(OutputStream outputStream, int i, int i2) throws IOException;
    ...
    public ByteString concat(ByteString byteString) {
        ...
        if (((long) size) + ((long) size2) < 2147483647L) {
            return RopeByteString.m5005a(this, byteString);
        }
    ...
    public static ByteString copyFrom(Iterable<ByteString> iterable) {
        ...
        return m4959a(collection.iterator(), collection.size());
    }

    /* renamed from: a */
    private static ByteString m4959a(Iterator<ByteString> it, int i) {
        if (!f5456a && i < 1) {
            ...
            int i2 = i >>> 1;
            return m4959a(it, i2).concat(m4959a(it, i - i2));
        }
    }
    ...
    /* access modifiers changed from: package-private */
    /* renamed from: a */
    public void mo26146a(OutputStream outputStream, int i, int i2) throws IOException {
        if (i < 0) {
            StringBuilder sb = new StringBuilder(30);
            sb.append("Source offset < 0: ");
            sb.append(i);
