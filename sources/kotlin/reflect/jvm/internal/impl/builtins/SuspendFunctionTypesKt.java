...
public final class SuspendFunctionTypesKt {
    ...
    /* renamed from: a */
    private static final MutableClassDescriptor f4815a;

    /* renamed from: b */
    private static final MutableClassDescriptor f4816b;
    ...
    static {
        ...
        f4816b = mutableClassDescriptor2;
    }
    ...
    public static final SimpleType transformSuspendFunctionToRuntimeFunctionType(KotlinType kotlinType, boolean z) {
        ...
        if (!_Assertions.ENABLED || isSuspendFunctionType) {
            ...
            if (z) {
                typeConstructor = f4816b.getTypeConstructor();
            } else {
                typeConstructor = f4815a.getTypeConstructor();
            }
