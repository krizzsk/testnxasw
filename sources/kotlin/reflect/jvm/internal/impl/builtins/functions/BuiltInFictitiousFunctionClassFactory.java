...
public final class BuiltInFictitiousFunctionClassFactory implements ClassDescriptorFactory {
    ...
    /* renamed from: a */
    private final StorageManager f4823a;

    /* renamed from: b */
    private final ModuleDescriptor f4824b;
    ...
    public BuiltInFictitiousFunctionClassFactory(StorageManager storageManager, ModuleDescriptor moduleDescriptor) {
        ...
        this.f4823a = storageManager;
        this.f4824b = moduleDescriptor;
    }
    ...
    public ClassDescriptor createClass(ClassId classId) {
        ...
        for (Object next : this.f4824b.getPackage(packageFqName).getFragments()) {
        ...
        return new FunctionClassDescriptor(this.f4823a, (BuiltInsPackageFragment) obj, component1, component2);
    }
