...
public final class JvmBuiltInsSignatures {
    ...
    /* renamed from: a */
    private static final Set<String> f4870a = SetsKt.plus(SignatureBuildingComponents.INSTANCE.inJavaUtil("Collection", "toArray()[Ljava/lang/Object;", "toArray([Ljava/lang/Object;)[Ljava/lang/Object;"), "java/lang/annotation/Annotation.annotationType()Ljava/lang/Class;");

    /* renamed from: b */
    private static final Set<String> f4871b;

    /* renamed from: c */
    private static final Set<String> f4872c;

    /* renamed from: d */
    private static final Set<String> f4873d;

    /* renamed from: e */
    private static final Set<String> f4874e;

    /* renamed from: f */
    private static final Set<String> f4875f;
    ...
    static {
        ...
        f4874e = SetsKt.plus(plus, signatureBuildingComponents4.inJavaLang("String", (String[]) Arrays.copyOf(constructors2, constructors2.length)));
        ...
        f4875f = signatureBuildingComponents5.inJavaLang("Throwable", (String[]) Arrays.copyOf(constructors3, constructors3.length));
    }
    ...
    /* renamed from: a */
    private final Set<String> m4698a() {
        SignatureBuildingComponents signatureBuildingComponents = SignatureBuildingComponents.INSTANCE;
    ...
    /* renamed from: b */
    private final Set<String> m4699b() {
        SignatureBuildingComponents signatureBuildingComponents = SignatureBuildingComponents.INSTANCE;
