...
public final class CloneableClassScope extends GivenFunctionsMemberScope {
    ...
    /* renamed from: b */
    public static final Name f4834b;
    ...
    public List<FunctionDescriptor> computeDeclaredFunctions() {
        SimpleFunctionDescriptorImpl create = SimpleFunctionDescriptorImpl.create(getContainingClass(), Annotations.Companion.getEMPTY(), f4834b, CallableMemberDescriptor.Kind.DECLARATION, SourceElement.NO_SOURCE);
    ...
    public static final class Companion {
        ...
        public final Name getCLONE_NAME() {
            return CloneableClassScope.f4834b;
        }
    }
