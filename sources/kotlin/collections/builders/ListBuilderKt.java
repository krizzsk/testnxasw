...
public final class ListBuilderKt {
    ...
    /* renamed from: a */
    public static final <T> String m2966a(T[] tArr, int i, int i2) {
    ...
    /* access modifiers changed from: private */
    /* renamed from: b */
    public static final <T> int m2968b(T[] tArr, int i, int i2) {
        int i3 = 1;
    ...
    /* access modifiers changed from: private */
    /* renamed from: a */
    public static final <T> boolean m2967a(T[] tArr, int i, int i2, List<?> list) {
        if (i2 != list.size()) {
            return false;
        }
        for (int i3 = 0; i3 < i2; i3++) {
