...
class C2375w extends C2374v {
    ...
    /* renamed from: a */
    private static final <K, V> Map<K, V> m4145a() {
        return MapsKt.emptyMap();
    }

    /* renamed from: b */
    private static final <K, V> Map<K, V> m4159b() {
    ...
    /* renamed from: c */
    private static final <K, V> HashMap<K, V> m4163c() {
        return new HashMap<>();
    }
    ...
    /* renamed from: d */
    private static final <K, V> LinkedHashMap<K, V> m4168d() {
        return new LinkedHashMap<>();
    }
    ...
    /* renamed from: a */
    private static final <K, V> Map<K, V> m4147a(Function1<? super Map<K, V>, Unit> function1) {
    ...
    /* renamed from: a */
    private static final <K, V> Map<K, V> m4146a(int i, Function1<? super Map<K, V>, Unit> function1) {
    ...
    /* renamed from: a */
    private static final <K, V> boolean m4155a(Map<? extends K, ? extends V> map) {
        return !map.isEmpty();
    }

    /* renamed from: b */
    private static final <K, V> boolean m4162b(Map<? extends K, ? extends V> map) {
        return map == null || map.isEmpty();
    }

    /* renamed from: c */
    private static final <K, V> Map<K, V> m4164c(Map<K, ? extends V> map) {
    ...
    private static final <M extends java.util.Map<?, ?> & R, R> R m4144a(M r1, kotlin.jvm.functions.Function0<? extends R> r2) {
        /*
        ...
        L_0x000a:
            return r1
        */
        throw new UnsupportedOperationException("Method not decompiled: kotlin.collections.C2375w.m4144a(java.util.Map, kotlin.jvm.functions.Function0):java.lang.Object");
    }

    /* renamed from: a */
    private static final <K, V> boolean m4156a(Map<? extends K, ? extends V> map, K k) {
        Intrinsics.checkNotNullParameter(map, "$this$contains");
        return map.containsKey(k);
    }

    /* renamed from: b */
    private static final <K, V> V m4158b(Map<? extends K, ? extends V> map, K k) {
        Intrinsics.checkNotNullParameter(map, "$this$get");
        return map.get(k);
    }

    /* renamed from: a */
    private static final <K, V> void m4149a(Map<K, V> map, K k, V v) {
        Intrinsics.checkNotNullParameter(map, "$this$set");
        map.put(k, v);
    }

    /* renamed from: c */
    private static final <K> boolean m4166c(Map<? extends K, ?> map, K k) {
        if (map != null) {
            return map.containsKey(k);
        }
    ...
    /* renamed from: d */
    private static final <K, V> boolean m4169d(Map<K, ? extends V> map, V v) {
        return map.containsValue(v);
    }

    /* renamed from: e */
    private static final <K, V> V m4170e(Map<? extends K, V> map, K k) {
        if (map != null) {
    ...
    /* renamed from: a */
    private static final <K, V> K m4142a(Map.Entry<? extends K, ? extends V> entry) {
        Intrinsics.checkNotNullParameter(entry, "$this$component1");
        return entry.getKey();
    }

    /* renamed from: b */
    private static final <K, V> V m4157b(Map.Entry<? extends K, ? extends V> entry) {
        Intrinsics.checkNotNullParameter(entry, "$this$component2");
        return entry.getValue();
    }

    /* renamed from: c */
    private static final <K, V> Pair<K, V> m4165c(Map.Entry<? extends K, ? extends V> entry) {
        return new Pair<>(entry.getKey(), entry.getValue());
    }

    /* renamed from: a */
    private static final <K, V> V m4143a(Map<K, ? extends V> map, K k, Function0<? extends V> function0) {
        V v = map.get(k);
    ...
    /* renamed from: d */
    private static final <K, V> Iterator<Map.Entry<K, V>> m4167d(Map<? extends K, ? extends V> map) {
        Intrinsics.checkNotNullParameter(map, "$this$iterator");
        return map.entrySet().iterator();
    }

    /* renamed from: e */
    private static final <K, V> Iterator<Map.Entry<K, V>> m4171e(Map<K, V> map) {
        Intrinsics.checkNotNullParameter(map, "$this$iterator");
        return map.entrySet().iterator();
    }
    ...
    /* renamed from: a */
    private static final <K, V> void m4151a(Map<? super K, ? super V> map, Pair<? extends K, ? extends V> pair) {
        Intrinsics.checkNotNullParameter(map, "$this$plusAssign");
        map.put(pair.getFirst(), pair.getSecond());
    }

    /* renamed from: a */
    private static final <K, V> void m4148a(Map<? super K, ? super V> map, Iterable<? extends Pair<? extends K, ? extends V>> iterable) {
        Intrinsics.checkNotNullParameter(map, "$this$plusAssign");
        MapsKt.putAll(map, iterable);
    }

    /* renamed from: a */
    private static final <K, V> void m4154a(Map<? super K, ? super V> map, Pair<? extends K, ? extends V>[] pairArr) {
        Intrinsics.checkNotNullParameter(map, "$this$plusAssign");
        MapsKt.putAll(map, pairArr);
    }

    /* renamed from: a */
    private static final <K, V> void m4152a(Map<? super K, ? super V> map, Sequence<? extends Pair<? extends K, ? extends V>> sequence) {
        Intrinsics.checkNotNullParameter(map, "$this$plusAssign");
        MapsKt.putAll(map, sequence);
    }

    /* renamed from: a */
    private static final <K, V> void m4150a(Map<? super K, ? super V> map, Map<K, ? extends V> map2) {
        Intrinsics.checkNotNullParameter(map, "$this$plusAssign");
        map.putAll(map2);
    }
    ...
    /* renamed from: f */
    private static final <K, V> void m4172f(Map<K, V> map, K k) {
        Intrinsics.checkNotNullParameter(map, "$this$minusAssign");
        map.remove(k);
    }

    /* renamed from: b */
    private static final <K, V> void m4160b(Map<K, V> map, Iterable<? extends K> iterable) {
        Intrinsics.checkNotNullParameter(map, "$this$minusAssign");
        CollectionsKt.removeAll(map.keySet(), iterable);
    }

    /* renamed from: a */
    private static final <K, V> void m4153a(Map<K, V> map, K[] kArr) {
        Intrinsics.checkNotNullParameter(map, "$this$minusAssign");
        CollectionsKt.removeAll(map.keySet(), (T[]) kArr);
    }

    /* renamed from: b */
    private static final <K, V> void m4161b(Map<K, V> map, Sequence<? extends K> sequence) {
        Intrinsics.checkNotNullParameter(map, "$this$minusAssign");
