...
public class MediaSessionCompat {
    ...
    private MediaSessionCompat(Context context, String str, ComponentName componentName, PendingIntent pendingIntent, Bundle bundle) {
        ...
        if (context == null) {
            ...
            if (componentName == null && (componentName = MediaButtonReceiver.getMediaButtonReceiverComponent(context)) == null) {
                SystemUtils.log(5, TAG, "Couldn't find a unique registered media button receiver in the given context.", (Throwable) null, "android.support.v4.media.session.MediaSessionCompat", 480);
            }
    ...
    public static abstract class Callback {
        ...
        private class StubApi21 implements MediaSessionCompatApi21.Callback {
            ...
            public void onCommand(java.lang.String r8, android.os.Bundle r9, android.os.ResultReceiver r10) {
                /*
                    r7 = this;
                    java.lang.String r0 = "android.support.v4.media.session.command.GET_EXTRA_BINDER"
                    boolean r0 = r8.equals(r0)     // Catch:{ BadParcelableException -> 0x00c4 }
                    r1 = 0
                    if (r0 == 0) goto L_0x003d
                    android.support.v4.media.session.MediaSessionCompat$Callback r8 = android.support.p003v4.media.session.MediaSessionCompat.Callback.this     // Catch:{ BadParcelableException -> 0x00c4 }
                    java.lang.ref.WeakReference<android.support.v4.media.session.MediaSessionCompat$MediaSessionImpl> r8 = r8.mSessionImpl     // Catch:{ BadParcelableException -> 0x00c4 }
                    java.lang.Object r8 = r8.get()     // Catch:{ BadParcelableException -> 0x00c4 }
                    android.support.v4.media.session.MediaSessionCompat$MediaSessionImplApi21 r8 = (android.support.p003v4.media.session.MediaSessionCompat.MediaSessionImplApi21) r8     // Catch:{ BadParcelableException -> 0x00c4 }
                    if (r8 == 0) goto L_0x00d1
                    android.os.Bundle r9 = new android.os.Bundle     // Catch:{ BadParcelableException -> 0x00c4 }
                    r9.<init>()     // Catch:{ BadParcelableException -> 0x00c4 }
                    android.support.v4.media.session.MediaSessionCompat$Token r8 = r8.getSessionToken()     // Catch:{ BadParcelableException -> 0x00c4 }
                    android.support.v4.media.session.IMediaSession r0 = r8.getExtraBinder()     // Catch:{ BadParcelableException -> 0x00c4 }
                ...
                L_0x002b:
                    androidx.core.app.BundleCompat.putBinder(r9, r2, r1)     // Catch:{ BadParcelableException -> 0x00c4 }
                    android.os.Bundle r8 = r8.getSessionToken2Bundle()     // Catch:{ BadParcelableException -> 0x00c4 }
                    java.lang.String r0 = "android.support.v4.media.session.SESSION_TOKEN2_BUNDLE"
                    r9.putBundle(r0, r8)     // Catch:{ BadParcelableException -> 0x00c4 }
                    r8 = 0
                    r10.send(r8, r9)     // Catch:{ BadParcelableException -> 0x00c4 }
                    goto L_0x00d1
                L_0x003d:
                    ...
                    android.support.v4.media.session.MediaSessionCompat$Callback r8 = android.support.p003v4.media.session.MediaSessionCompat.Callback.this     // Catch:{ BadParcelableException -> 0x00c4 }
                    android.os.Parcelable r9 = r9.getParcelable(r2)     // Catch:{ BadParcelableException -> 0x00c4 }
                    android.support.v4.media.MediaDescriptionCompat r9 = (android.support.p003v4.media.MediaDescriptionCompat) r9     // Catch:{ BadParcelableException -> 0x00c4 }
                    r8.onAddQueueItem(r9)     // Catch:{ BadParcelableException -> 0x00c4 }
                    goto L_0x00d1
                L_0x0054:
                    ...
                    android.support.v4.media.session.MediaSessionCompat$Callback r8 = android.support.p003v4.media.session.MediaSessionCompat.Callback.this     // Catch:{ BadParcelableException -> 0x00c4 }
                    android.os.Parcelable r10 = r9.getParcelable(r2)     // Catch:{ BadParcelableException -> 0x00c4 }
                    android.support.v4.media.MediaDescriptionCompat r10 = (android.support.p003v4.media.MediaDescriptionCompat) r10     // Catch:{ BadParcelableException -> 0x00c4 }
                    int r9 = r9.getInt(r3)     // Catch:{ BadParcelableException -> 0x00c4 }
                    r8.onAddQueueItem(r10, r9)     // Catch:{ BadParcelableException -> 0x00c4 }
                    goto L_0x00d1
                L_0x006e:
                    ...
                    android.os.Parcelable r9 = r9.getParcelable(r2)     // Catch:{ BadParcelableException -> 0x00c4 }
                    android.support.v4.media.MediaDescriptionCompat r9 = (android.support.p003v4.media.MediaDescriptionCompat) r9     // Catch:{ BadParcelableException -> 0x00c4 }
                    r8.onRemoveQueueItem(r9)     // Catch:{ BadParcelableException -> 0x00c4 }
                    goto L_0x00d1
                L_0x0082:
                    ...
                    android.support.v4.media.session.MediaSessionCompat$MediaSessionImplApi21 r8 = (android.support.p003v4.media.session.MediaSessionCompat.MediaSessionImplApi21) r8     // Catch:{ BadParcelableException -> 0x00c4 }
                    if (r8 == 0) goto L_0x00d1
                    java.util.List<android.support.v4.media.session.MediaSessionCompat$QueueItem> r10 = r8.mQueue     // Catch:{ BadParcelableException -> 0x00c4 }
                    if (r10 == 0) goto L_0x00d1
                    r10 = -1
                    int r9 = r9.getInt(r3, r10)     // Catch:{ BadParcelableException -> 0x00c4 }
                    if (r9 < 0) goto L_0x00b2
                    java.util.List<android.support.v4.media.session.MediaSessionCompat$QueueItem> r10 = r8.mQueue     // Catch:{ BadParcelableException -> 0x00c4 }
                    int r10 = r10.size()     // Catch:{ BadParcelableException -> 0x00c4 }
                    if (r9 >= r10) goto L_0x00b2
                    java.util.List<android.support.v4.media.session.MediaSessionCompat$QueueItem> r8 = r8.mQueue     // Catch:{ BadParcelableException -> 0x00c4 }
                    java.lang.Object r8 = r8.get(r9)     // Catch:{ BadParcelableException -> 0x00c4 }
                    r1 = r8
                ...
                L_0x00b2:
                    ...
                    android.support.v4.media.session.MediaSessionCompat$Callback r8 = android.support.p003v4.media.session.MediaSessionCompat.Callback.this     // Catch:{ BadParcelableException -> 0x00c4 }
                    android.support.v4.media.MediaDescriptionCompat r9 = r1.getDescription()     // Catch:{ BadParcelableException -> 0x00c4 }
                    r8.onRemoveQueueItem(r9)     // Catch:{ BadParcelableException -> 0x00c4 }
                    goto L_0x00d1
                L_0x00be:
                    ...
                    r0.onCommand(r8, r9, r10)     // Catch:{ BadParcelableException -> 0x00c4 }
                    goto L_0x00d1
                L_0x00c4:
                    r1 = 6
                    r4 = 0
                    ...
                    java.lang.String r3 = "Could not unparcel the extra data."
                    java.lang.String r5 = "android.support.v4.media.session.MediaSessionCompat$Callback$StubApi21"
        ...
        class MessageHandler extends Handler {
            ...
            private void onMediaButtonEvent(KeyEvent keyEvent, Callback callback) {
                if (keyEvent != null && keyEvent.getAction() == 0) {
                    ...
                    SystemUtils.log(5, MediaSessionCompat.TAG, "KEYCODE_MEDIA_PLAY_PAUSE and KEYCODE_HEADSETHOOK are handled already", (Throwable) null, "android.support.v4.media.session.MediaSessionCompat$MediaSessionImplBase$MessageHandler", 3202);
                }
            }
        }
    }
        ...
        public void registerMediaButtonEventReceiver(PendingIntent pendingIntent, ComponentName componentName) {
            if (sIsMbrPendingIntentSupported) {
                try {
                    ...
                    SystemUtils.log(5, MediaSessionCompat.TAG, "Unable to register media button event receiver with PendingIntent, falling back to ComponentName.", (Throwable) null, "android.support.v4.media.session.MediaSessionCompat$MediaSessionImplApi18", 3274);
