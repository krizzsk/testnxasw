...
public final class RatingCompat implements Parcelable {
    ...
    public static RatingCompat newStarRating(int i, float f) {
        ...
        if (i == 3) {
            ...
            SystemUtils.log(6, TAG, "Invalid rating style (" + i + ") for a star rating", (Throwable) null, "android.support.v4.media.RatingCompat", 217);
            return null;
        } else {
            f2 = 5.0f;
        }
        ...
        SystemUtils.log(6, TAG, "Trying to set out of range star-based rating", (Throwable) null, "android.support.v4.media.RatingCompat", 221);
        return null;
    }
    ...
    public static RatingCompat newPercentageRating(float f) {
        ...
        SystemUtils.log(6, TAG, "Invalid percentage-based rating value", (Throwable) null, "android.support.v4.media.RatingCompat", 236);
        return null;
    }
