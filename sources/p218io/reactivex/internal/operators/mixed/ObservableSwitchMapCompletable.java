...
public final class ObservableSwitchMapCompletable<T> extends Completable {
    ...
    /* renamed from: a */
    final Observable<T> f61459a;

    /* renamed from: b */
    final Function<? super T, ? extends CompletableSource> f61460b;

    /* renamed from: c */
    final boolean f61461c;

    public ObservableSwitchMapCompletable(Observable<T> observable, Function<? super T, ? extends CompletableSource> function, boolean z) {
        this.f61459a = observable;
        this.f61460b = function;
        this.f61461c = z;
    }

    /* access modifiers changed from: protected */
    public void subscribeActual(CompletableObserver completableObserver) {
        if (!C22214a.m45938a((Object) this.f61459a, this.f61460b, completableObserver)) {
            this.f61459a.subscribe(new SwitchMapCompletableObserver(completableObserver, this.f61460b, this.f61461c));
        }
    }
