...
public final class ObservableSwitchMapMaybe<T, R> extends Observable<R> {
    ...
    /* renamed from: a */
    final Observable<T> f61462a;

    /* renamed from: b */
    final Function<? super T, ? extends MaybeSource<? extends R>> f61463b;

    /* renamed from: c */
    final boolean f61464c;

    public ObservableSwitchMapMaybe(Observable<T> observable, Function<? super T, ? extends MaybeSource<? extends R>> function, boolean z) {
        this.f61462a = observable;
        this.f61463b = function;
        this.f61464c = z;
    }

    /* access modifiers changed from: protected */
    public void subscribeActual(Observer<? super R> observer) {
        if (!C22214a.m45939a((Object) this.f61462a, this.f61463b, observer)) {
            this.f61462a.subscribe(new SwitchMapMaybeMainObserver(observer, this.f61463b, this.f61464c));
        }
    }
