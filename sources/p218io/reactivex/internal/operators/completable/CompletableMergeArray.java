...
public final class CompletableMergeArray extends Completable {
    ...
    /* renamed from: a */
    final CompletableSource[] f60898a;

    public CompletableMergeArray(CompletableSource[] completableSourceArr) {
        this.f60898a = completableSourceArr;
    }

    public void subscribeActual(CompletableObserver completableObserver) {
        CompositeDisposable compositeDisposable = new CompositeDisposable();
        InnerCompletableObserver innerCompletableObserver = new InnerCompletableObserver(completableObserver, new AtomicBoolean(), compositeDisposable, this.f60898a.length + 1);
        completableObserver.onSubscribe(compositeDisposable);
        CompletableSource[] completableSourceArr = this.f60898a;
