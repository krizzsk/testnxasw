...
public final class CompletableMerge extends Completable {
    ...
    /* renamed from: a */
    final Publisher<? extends CompletableSource> f60895a;

    /* renamed from: b */
    final int f60896b;

    /* renamed from: c */
    final boolean f60897c;

    public CompletableMerge(Publisher<? extends CompletableSource> publisher, int i, boolean z) {
        this.f60895a = publisher;
        this.f60896b = i;
        this.f60897c = z;
    }

    public void subscribeActual(CompletableObserver completableObserver) {
        this.f60895a.subscribe(new CompletableMergeSubscriber(completableObserver, this.f60896b, this.f60897c));
    }
