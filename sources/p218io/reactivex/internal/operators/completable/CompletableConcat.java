...
public final class CompletableConcat extends Completable {
    ...
    /* renamed from: a */
    final Publisher<? extends CompletableSource> f60860a;

    /* renamed from: b */
    final int f60861b;

    public CompletableConcat(Publisher<? extends CompletableSource> publisher, int i) {
        this.f60860a = publisher;
        this.f60861b = i;
    }

    public void subscribeActual(CompletableObserver completableObserver) {
        this.f60860a.subscribe(new CompletableConcatSubscriber(completableObserver, this.f60861b));
    }
