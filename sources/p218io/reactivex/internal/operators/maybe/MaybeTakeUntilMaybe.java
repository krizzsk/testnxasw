...
public final class MaybeTakeUntilMaybe<T, U> extends C22213a<T, T> {

    /* renamed from: a */
    final MaybeSource<U> f61393a;

    public MaybeTakeUntilMaybe(MaybeSource<T> maybeSource, MaybeSource<U> maybeSource2) {
        super(maybeSource);
        this.f61393a = maybeSource2;
    }
    ...
    public void subscribeActual(MaybeObserver<? super T> maybeObserver) {
        ...
        this.f61393a.subscribe(takeUntilMainMaybeObserver.other);
