...
public final class MaybeEqualSingle<T> extends Single<Boolean> {
    ...
    /* renamed from: a */
    final MaybeSource<? extends T> f61337a;

    /* renamed from: b */
    final MaybeSource<? extends T> f61338b;

    /* renamed from: c */
    final BiPredicate<? super T, ? super T> f61339c;

    public MaybeEqualSingle(MaybeSource<? extends T> maybeSource, MaybeSource<? extends T> maybeSource2, BiPredicate<? super T, ? super T> biPredicate) {
        this.f61337a = maybeSource;
        this.f61338b = maybeSource2;
        this.f61339c = biPredicate;
    }

    /* access modifiers changed from: protected */
    public void subscribeActual(SingleObserver<? super Boolean> singleObserver) {
        EqualCoordinator equalCoordinator = new EqualCoordinator(singleObserver, this.f61339c);
        singleObserver.onSubscribe(equalCoordinator);
        equalCoordinator.subscribe(this.f61337a, this.f61338b);
    }
