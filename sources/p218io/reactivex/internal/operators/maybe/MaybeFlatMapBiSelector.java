...
public final class MaybeFlatMapBiSelector<T, U, R> extends C22213a<T, R> {

    /* renamed from: a */
    final Function<? super T, ? extends MaybeSource<? extends U>> f61345a;

    /* renamed from: b */
    final BiFunction<? super T, ? super U, ? extends R> f61346b;
    ...
    public MaybeFlatMapBiSelector(MaybeSource<T> maybeSource, Function<? super T, ? extends MaybeSource<? extends U>> function, BiFunction<? super T, ? super U, ? extends R> biFunction) {
        super(maybeSource);
        this.f61345a = function;
        this.f61346b = biFunction;
    }

    /* access modifiers changed from: protected */
    public void subscribeActual(MaybeObserver<? super R> maybeObserver) {
        this.source.subscribe(new FlatMapBiMainObserver(maybeObserver, this.f61345a, this.f61346b));
    }
