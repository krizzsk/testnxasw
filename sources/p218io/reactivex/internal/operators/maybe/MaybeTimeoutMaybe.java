...
public final class MaybeTimeoutMaybe<T, U> extends C22213a<T, T> {

    /* renamed from: a */
    final MaybeSource<U> f61395a;

    /* renamed from: b */
    final MaybeSource<? extends T> f61396b;

    public MaybeTimeoutMaybe(MaybeSource<T> maybeSource, MaybeSource<U> maybeSource2, MaybeSource<? extends T> maybeSource3) {
        super(maybeSource);
        this.f61395a = maybeSource2;
        this.f61396b = maybeSource3;
    }

    /* access modifiers changed from: protected */
    public void subscribeActual(MaybeObserver<? super T> maybeObserver) {
        TimeoutMainMaybeObserver timeoutMainMaybeObserver = new TimeoutMainMaybeObserver(maybeObserver, this.f61396b);
        maybeObserver.onSubscribe(timeoutMainMaybeObserver);
        this.f61395a.subscribe(timeoutMainMaybeObserver.other);
