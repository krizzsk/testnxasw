...
public final class MaybeOnErrorNext<T> extends C22213a<T, T> {

    /* renamed from: a */
    final Function<? super Throwable, ? extends MaybeSource<? extends T>> f61380a;

    /* renamed from: b */
    final boolean f61381b;
    ...
    public void subscribeActual(MaybeObserver<? super T> maybeObserver) {
        this.source.subscribe(new OnErrorNextMaybeObserver(maybeObserver, this.f61380a, this.f61381b));
    }
