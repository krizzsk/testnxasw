...
public final class MaybeTakeUntilPublisher<T, U> extends C22213a<T, T> {

    /* renamed from: a */
    final Publisher<U> f61394a;

    public MaybeTakeUntilPublisher(MaybeSource<T> maybeSource, Publisher<U> publisher) {
        super(maybeSource);
        this.f61394a = publisher;
    }
    ...
    public void subscribeActual(MaybeObserver<? super T> maybeObserver) {
        ...
        this.f61394a.subscribe(takeUntilMainMaybeObserver.other);
