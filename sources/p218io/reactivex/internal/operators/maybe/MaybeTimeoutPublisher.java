...
public final class MaybeTimeoutPublisher<T, U> extends C22213a<T, T> {

    /* renamed from: a */
    final Publisher<U> f61397a;

    /* renamed from: b */
    final MaybeSource<? extends T> f61398b;

    public MaybeTimeoutPublisher(MaybeSource<T> maybeSource, Publisher<U> publisher, MaybeSource<? extends T> maybeSource2) {
        super(maybeSource);
        this.f61397a = publisher;
        this.f61398b = maybeSource2;
    }

    /* access modifiers changed from: protected */
    public void subscribeActual(MaybeObserver<? super T> maybeObserver) {
        TimeoutMainMaybeObserver timeoutMainMaybeObserver = new TimeoutMainMaybeObserver(maybeObserver, this.f61398b);
        maybeObserver.onSubscribe(timeoutMainMaybeObserver);
        this.f61397a.subscribe(timeoutMainMaybeObserver.other);
