...
public final class MaybeFlatMapNotification<T, R> extends C22213a<T, R> {

    /* renamed from: a */
    final Function<? super T, ? extends MaybeSource<? extends R>> f61355a;

    /* renamed from: b */
    final Function<? super Throwable, ? extends MaybeSource<? extends R>> f61356b;

    /* renamed from: c */
    final Callable<? extends MaybeSource<? extends R>> f61357c;
    ...
    public MaybeFlatMapNotification(MaybeSource<T> maybeSource, Function<? super T, ? extends MaybeSource<? extends R>> function, Function<? super Throwable, ? extends MaybeSource<? extends R>> function2, Callable<? extends MaybeSource<? extends R>> callable) {
        super(maybeSource);
        this.f61355a = function;
        this.f61356b = function2;
        this.f61357c = callable;
    }

    /* access modifiers changed from: protected */
    public void subscribeActual(MaybeObserver<? super R> maybeObserver) {
        this.source.subscribe(new FlatMapMaybeObserver(maybeObserver, this.f61355a, this.f61356b, this.f61357c));
    }
