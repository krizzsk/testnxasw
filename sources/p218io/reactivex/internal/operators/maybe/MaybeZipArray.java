...
public final class MaybeZipArray<T, R> extends Maybe<R> {
    ...
    /* renamed from: a */
    final MaybeSource<? extends T>[] f61412a;

    /* renamed from: b */
    final Function<? super Object[], ? extends R> f61413b;

    public MaybeZipArray(MaybeSource<? extends T>[] maybeSourceArr, Function<? super Object[], ? extends R> function) {
        this.f61412a = maybeSourceArr;
        this.f61413b = function;
    }

    /* access modifiers changed from: protected */
    public void subscribeActual(MaybeObserver<? super R> maybeObserver) {
        MaybeSource<? extends T>[] maybeSourceArr = this.f61412a;
        ...
        ZipCoordinator zipCoordinator = new ZipCoordinator(maybeObserver, length, this.f61413b);
    ...
    final class SingletonArrayFunc implements Function<T, R> {
        ...
        public R apply(T t) throws Exception {
            return ObjectHelper.requireNonNull(MaybeZipArray.this.f61413b.apply(new Object[]{t}), "The zipper returned a null value");
        }
    }
}
