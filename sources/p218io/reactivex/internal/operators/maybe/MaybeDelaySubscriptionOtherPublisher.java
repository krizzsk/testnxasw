...
public final class MaybeDelaySubscriptionOtherPublisher<T, U> extends C22213a<T, T> {

    /* renamed from: a */
    final Publisher<U> f61331a;

    public MaybeDelaySubscriptionOtherPublisher(MaybeSource<T> maybeSource, Publisher<U> publisher) {
        super(maybeSource);
        this.f61331a = publisher;
    }

    /* access modifiers changed from: protected */
    public void subscribeActual(MaybeObserver<? super T> maybeObserver) {
        this.f61331a.subscribe(new OtherSubscriber(maybeObserver, this.source));
    }
