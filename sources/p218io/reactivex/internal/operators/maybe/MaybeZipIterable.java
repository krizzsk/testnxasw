...
public final class MaybeZipIterable<T, R> extends Maybe<R> {
    ...
    /* renamed from: a */
    final Iterable<? extends MaybeSource<? extends T>> f61414a;

    /* renamed from: b */
    final Function<? super Object[], ? extends R> f61415b;

    public MaybeZipIterable(Iterable<? extends MaybeSource<? extends T>> iterable, Function<? super Object[], ? extends R> function) {
        this.f61414a = iterable;
        this.f61415b = function;
    }
    ...
    public void subscribeActual(MaybeObserver<? super R> maybeObserver) {
        ...
        try {
            int i = 0;
            for (MaybeSource maybeSource : this.f61414a) {
                if (maybeSource == null) {
            ...
            if (i == 0) {
                ...
                MaybeZipArray.ZipCoordinator zipCoordinator = new MaybeZipArray.ZipCoordinator(maybeObserver, i, this.f61415b);
    ...
    final class SingletonArrayFunc implements Function<T, R> {
        ...
        public R apply(T t) throws Exception {
            return ObjectHelper.requireNonNull(MaybeZipIterable.this.f61415b.apply(new Object[]{t}), "The zipper returned a null value");
        }
    }
}
