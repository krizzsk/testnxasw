...
public final class SingleEquals<T> extends Single<Boolean> {
    ...
    /* renamed from: a */
    final SingleSource<? extends T> f61897a;

    /* renamed from: b */
    final SingleSource<? extends T> f61898b;

    public SingleEquals(SingleSource<? extends T> singleSource, SingleSource<? extends T> singleSource2) {
        this.f61897a = singleSource;
        this.f61898b = singleSource2;
    }
    ...
    public void subscribeActual(SingleObserver<? super Boolean> singleObserver) {
        ...
        this.f61897a.subscribe(new InnerObserver(0, compositeDisposable2, objArr, singleObserver2, atomicInteger2));
        this.f61898b.subscribe(new InnerObserver(1, compositeDisposable2, objArr, singleObserver2, atomicInteger2));
    }
