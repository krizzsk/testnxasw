...
public final class SingleFlatMapIterableFlowable<T, R> extends Flowable<R> {
    ...
    /* renamed from: a */
    final SingleSource<T> f61904a;

    /* renamed from: b */
    final Function<? super T, ? extends Iterable<? extends R>> f61905b;

    public SingleFlatMapIterableFlowable(SingleSource<T> singleSource, Function<? super T, ? extends Iterable<? extends R>> function) {
        this.f61904a = singleSource;
        this.f61905b = function;
    }

    /* access modifiers changed from: protected */
    public void subscribeActual(Subscriber<? super R> subscriber) {
        this.f61904a.subscribe(new FlatMapIterableObserver(subscriber, this.f61905b));
    }
    ...
    static final class FlatMapIterableObserver<T, R> extends BasicIntQueueSubscription<R> implements SingleObserver<T> {
        ...
        /* renamed from: it */
        volatile Iterator<? extends R> f61906it;
        ...
        public void drain() {
            if (getAndIncrement() == 0) {
                ...
                Iterator<? extends R> it = this.f61906it;
