...
public final class SingleZipArray<T, R> extends Single<R> {
    ...
    /* renamed from: a */
    final SingleSource<? extends T>[] f61953a;

    /* renamed from: b */
    final Function<? super Object[], ? extends R> f61954b;

    public SingleZipArray(SingleSource<? extends T>[] singleSourceArr, Function<? super Object[], ? extends R> function) {
        this.f61953a = singleSourceArr;
        this.f61954b = function;
    }

    /* access modifiers changed from: protected */
    public void subscribeActual(SingleObserver<? super R> singleObserver) {
        SingleSource<? extends T>[] singleSourceArr = this.f61953a;
        ...
        ZipCoordinator zipCoordinator = new ZipCoordinator(singleObserver, length, this.f61954b);
    ...
    final class SingletonArrayFunc implements Function<T, R> {
        ...
        public R apply(T t) throws Exception {
            return ObjectHelper.requireNonNull(SingleZipArray.this.f61954b.apply(new Object[]{t}), "The zipper returned a null value");
        }
    }
}
