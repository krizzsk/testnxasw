...
public final class ParallelFilter<T> extends ParallelFlowable<T> {
    ...
    /* renamed from: a */
    final ParallelFlowable<T> f61806a;

    /* renamed from: b */
    final Predicate<? super T> f61807b;

    public ParallelFilter(ParallelFlowable<T> parallelFlowable, Predicate<? super T> predicate) {
        this.f61806a = parallelFlowable;
        this.f61807b = predicate;
    }
        ...
        if (validate(subscriberArr)) {
            ...
            for (int i = 0; i < length; i++) {
                ...
                if (conditionalSubscriber instanceof ConditionalSubscriber) {
                    subscriberArr2[i] = new ParallelFilterConditionalSubscriber(conditionalSubscriber, this.f61807b);
                } else {
                    subscriberArr2[i] = new ParallelFilterSubscriber(conditionalSubscriber, this.f61807b);
                }
            }
            this.f61806a.subscribe(subscriberArr2);
        }
    }

    public int parallelism() {
        return this.f61806a.parallelism();
    }
