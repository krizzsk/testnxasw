...
public final class ParallelFilterTry<T> extends ParallelFlowable<T> {
    ...
    /* renamed from: a */
    final ParallelFlowable<T> f61808a;

    /* renamed from: b */
    final Predicate<? super T> f61809b;

    /* renamed from: c */
    final BiFunction<? super Long, ? super Throwable, ParallelFailureHandling> f61810c;
    ...
    public ParallelFilterTry(ParallelFlowable<T> parallelFlowable, Predicate<? super T> predicate, BiFunction<? super Long, ? super Throwable, ParallelFailureHandling> biFunction) {
        this.f61808a = parallelFlowable;
        this.f61809b = predicate;
        this.f61810c = biFunction;
    }
        ...
        if (validate(subscriberArr)) {
            ...
            for (int i = 0; i < length; i++) {
                ...
                if (conditionalSubscriber instanceof ConditionalSubscriber) {
                    subscriberArr2[i] = new ParallelFilterConditionalSubscriber(conditionalSubscriber, this.f61809b, this.f61810c);
                } else {
                    subscriberArr2[i] = new ParallelFilterSubscriber(conditionalSubscriber, this.f61809b, this.f61810c);
                }
            }
            this.f61808a.subscribe(subscriberArr2);
        }
    }

    public int parallelism() {
        return this.f61808a.parallelism();
    }
    ...
    static final class ParallelFilterSubscriber<T> extends BaseFilterSubscriber<T> {
        ...
        public boolean tryOnNext(T r10) {
            ...
            L_0x0017:
                ...
                java.lang.Object r6 = p218io.reactivex.internal.functions.ObjectHelper.requireNonNull(r6, (java.lang.String) r7)     // Catch:{ all -> 0x004e }
                io.reactivex.parallel.ParallelFailureHandling r6 = (p218io.reactivex.parallel.ParallelFailureHandling) r6     // Catch:{ all -> 0x004e }
                int[] r7 = p218io.reactivex.internal.operators.parallel.ParallelFilterTry.C222171.$SwitchMap$io$reactivex$parallel$ParallelFailureHandling
                int r6 = r6.ordinal()
                r6 = r7[r6]
            ...
            L_0x0063:
                return r1
            */
            throw new UnsupportedOperationException("Method not decompiled: p218io.reactivex.internal.operators.parallel.ParallelFilterTry.ParallelFilterSubscriber.tryOnNext(java.lang.Object):boolean");
        }
    ...
    static /* synthetic */ class C222171 {
        ...
        static {
            ...
            L_0x0028:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: p218io.reactivex.internal.operators.parallel.ParallelFilterTry.C222171.<clinit>():void");
        }
    }
    ...
    static final class ParallelFilterConditionalSubscriber<T> extends BaseFilterSubscriber<T> {
        ...
        public boolean tryOnNext(T r10) {
            ...
            L_0x001a:
                ...
                java.lang.String r7 = "The errorHandler returned a null item"
                java.lang.Object r6 = p218io.reactivex.internal.functions.ObjectHelper.requireNonNull(r6, (java.lang.String) r7)     // Catch:{ all -> 0x0051 }
                io.reactivex.parallel.ParallelFailureHandling r6 = (p218io.reactivex.parallel.ParallelFailureHandling) r6     // Catch:{ all -> 0x0051 }
                int[] r7 = p218io.reactivex.internal.operators.parallel.ParallelFilterTry.C222171.$SwitchMap$io$reactivex$parallel$ParallelFailureHandling
                int r6 = r6.ordinal()
                r6 = r7[r6]
                if (r6 == r0) goto L_0x0007
            ...
            L_0x0066:
                return r1
            */
            throw new UnsupportedOperationException("Method not decompiled: p218io.reactivex.internal.operators.parallel.ParallelFilterTry.ParallelFilterConditionalSubscriber.tryOnNext(java.lang.Object):boolean");
        }
