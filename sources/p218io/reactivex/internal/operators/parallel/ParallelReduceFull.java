...
public final class ParallelReduceFull<T> extends Flowable<T> {
    ...
    /* renamed from: a */
    final ParallelFlowable<? extends T> f61842a;

    /* renamed from: b */
    final BiFunction<T, T, T> f61843b;

    public ParallelReduceFull(ParallelFlowable<? extends T> parallelFlowable, BiFunction<T, T, T> biFunction) {
        this.f61842a = parallelFlowable;
        this.f61843b = biFunction;
    }

    /* access modifiers changed from: protected */
    public void subscribeActual(Subscriber<? super T> subscriber) {
        ParallelReduceFullMainSubscriber parallelReduceFullMainSubscriber = new ParallelReduceFullMainSubscriber(subscriber, this.f61842a.parallelism(), this.f61843b);
        subscriber.onSubscribe(parallelReduceFullMainSubscriber);
        this.f61842a.subscribe(parallelReduceFullMainSubscriber.subscribers);
    }
