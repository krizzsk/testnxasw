...
public final class ParallelFromPublisher<T> extends ParallelFlowable<T> {
    ...
    /* renamed from: a */
    final Publisher<? extends T> f61817a;
    ...
    public void subscribe(Subscriber<? super T>[] subscriberArr) {
        if (validate(subscriberArr)) {
            this.f61817a.subscribe(new ParallelDispatcher(subscriberArr, this.f61819c));
        }
    }
        ...
        final class RailSubscription implements Subscription {
            ...
            public void request(long j) {
                ...
                if (SubscriptionHelper.validate(j)) {
                    ...
                    do {
                        j2 = atomicLongArray.get(this.f61820j);
                        if (j2 != Long.MAX_VALUE) {
                        } else {
                            return;
                        }
                    } while (!atomicLongArray.compareAndSet(this.f61820j, j2, BackpressureHelper.addCap(j2, j)));
                    if (ParallelDispatcher.this.subscriberCount.get() == this.f61821m) {
            ...
            public void cancel() {
                if (ParallelDispatcher.this.requests.compareAndSet(this.f61820j + this.f61821m, 0, 1)) {
