...
public final class ParallelMap<T, R> extends ParallelFlowable<R> {
    ...
    /* renamed from: a */
    final ParallelFlowable<T> f61825a;

    /* renamed from: b */
    final Function<? super T, ? extends R> f61826b;

    public ParallelMap(ParallelFlowable<T> parallelFlowable, Function<? super T, ? extends R> function) {
        this.f61825a = parallelFlowable;
        this.f61826b = function;
    }
        ...
        if (validate(subscriberArr)) {
            ...
            for (int i = 0; i < length; i++) {
                ...
                if (conditionalSubscriber instanceof ConditionalSubscriber) {
                    subscriberArr2[i] = new ParallelMapConditionalSubscriber(conditionalSubscriber, this.f61826b);
                } else {
                    subscriberArr2[i] = new ParallelMapSubscriber(conditionalSubscriber, this.f61826b);
                }
            }
            this.f61825a.subscribe(subscriberArr2);
        }
    }

    public int parallelism() {
        return this.f61825a.parallelism();
    }
