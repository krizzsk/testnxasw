...
public final class ObservablePublish<T> extends ConnectableObservable<T> implements HasUpstreamObservableSource<T> {
    ...
    /* renamed from: a */
    final ObservableSource<T> f61649a;

    /* renamed from: b */
    final AtomicReference<PublishObserver<T>> f61650b;

    /* renamed from: c */
    final ObservableSource<T> f61651c;
    ...
    private ObservablePublish(ObservableSource<T> observableSource, ObservableSource<T> observableSource2, AtomicReference<PublishObserver<T>> atomicReference) {
        this.f61651c = observableSource;
        this.f61649a = observableSource2;
        this.f61650b = atomicReference;
    }
    ...
    public void subscribeActual(Observer<? super T> observer) {
        this.f61651c.subscribe(observer);
    }
    ...
    public void connect(p218io.reactivex.functions.Consumer<? super p218io.reactivex.disposables.Disposable> r5) {
        /*
            r4 = this;
        L_0x0000:
            java.util.concurrent.atomic.AtomicReference<io.reactivex.internal.operators.observable.ObservablePublish$PublishObserver<T>> r0 = r4.f61650b
            java.lang.Object r0 = r0.get()
            io.reactivex.internal.operators.observable.ObservablePublish$PublishObserver r0 = (p218io.reactivex.internal.operators.observable.ObservablePublish.PublishObserver) r0
        ...
        L_0x0010:
            ...
            java.util.concurrent.atomic.AtomicReference<io.reactivex.internal.operators.observable.ObservablePublish$PublishObserver<T>> r2 = r4.f61650b
            r1.<init>(r2)
            java.util.concurrent.atomic.AtomicReference<io.reactivex.internal.operators.observable.ObservablePublish$PublishObserver<T>> r2 = r4.f61650b
        ...
        L_0x0035:
            ...
            io.reactivex.ObservableSource<T> r5 = r4.f61649a
            r5.subscribe(r0)
        L_0x003f:
            return
        L_0x0040:
            ...
            throw r5
        */
        throw new UnsupportedOperationException("Method not decompiled: p218io.reactivex.internal.operators.observable.ObservablePublish.connect(io.reactivex.functions.Consumer):void");
    }
