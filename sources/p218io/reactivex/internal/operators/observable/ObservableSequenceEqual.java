...
public final class ObservableSequenceEqual<T> extends Observable<Boolean> {
    ...
    /* renamed from: a */
    final ObservableSource<? extends T> f61694a;

    /* renamed from: b */
    final ObservableSource<? extends T> f61695b;

    /* renamed from: c */
    final BiPredicate<? super T, ? super T> f61696c;
    ...
    public ObservableSequenceEqual(ObservableSource<? extends T> observableSource, ObservableSource<? extends T> observableSource2, BiPredicate<? super T, ? super T> biPredicate, int i) {
        this.f61694a = observableSource;
        this.f61695b = observableSource2;
        this.f61696c = biPredicate;
        this.f61697d = i;
    }

    public void subscribeActual(Observer<? super Boolean> observer) {
        EqualCoordinator equalCoordinator = new EqualCoordinator(observer, this.f61697d, this.f61694a, this.f61695b, this.f61696c);
                ...
                while (!this.cancelled) {
                    ...
                    if (!z || (th2 = equalObserver.error) == null) {
                        ...
                        if (!z2 || (th = equalObserver2.error) == null) {
                            if (this.f61698v1 == null) {
                                this.f61698v1 = spscLinkedArrayQueue.poll();
                            }
                            boolean z3 = this.f61698v1 == null;
                            if (this.f61699v2 == null) {
                                this.f61699v2 = spscLinkedArrayQueue2.poll();
                            }
                            boolean z4 = this.f61699v2 == null;
                            if (z && z2 && z3 && z4) {
                                ...
                                if (!z3 && !z4) {
                                    try {
                                        if (!this.comparer.test(this.f61698v1, this.f61699v2)) {
