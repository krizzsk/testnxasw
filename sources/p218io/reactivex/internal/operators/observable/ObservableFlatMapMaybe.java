...
public final class ObservableFlatMapMaybe<T, R> extends C22215a<T, R> {

    /* renamed from: a */
    final Function<? super T, ? extends MaybeSource<? extends R>> f61590a;

    /* renamed from: b */
    final boolean f61591b;
    ...
    public ObservableFlatMapMaybe(ObservableSource<T> observableSource, Function<? super T, ? extends MaybeSource<? extends R>> function, boolean z) {
        ...
        this.f61590a = function;
        this.f61591b = z;
    }

    /* access modifiers changed from: protected */
    public void subscribeActual(Observer<? super R> observer) {
        this.source.subscribe(new FlatMapMaybeObserver(observer, this.f61590a, this.f61591b));
    }
