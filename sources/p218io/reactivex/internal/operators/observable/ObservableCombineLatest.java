...
public final class ObservableCombineLatest<T, R> extends Observable<R> {
    ...
    /* renamed from: a */
    final ObservableSource<? extends T>[] f61526a;

    /* renamed from: b */
    final Iterable<? extends ObservableSource<? extends T>> f61527b;

    /* renamed from: c */
    final Function<? super Object[], ? extends R> f61528c;

    /* renamed from: d */
    final int f61529d;

    /* renamed from: e */
    final boolean f61530e;

    public ObservableCombineLatest(ObservableSource<? extends T>[] observableSourceArr, Iterable<? extends ObservableSource<? extends T>> iterable, Function<? super Object[], ? extends R> function, int i, boolean z) {
        this.f61526a = observableSourceArr;
        this.f61527b = iterable;
        this.f61528c = function;
        this.f61529d = i;
        this.f61530e = z;
    }
    ...
    public void subscribeActual(Observer<? super R> observer) {
        int i;
        ObservableSource<? extends T>[] observableSourceArr = this.f61526a;
        if (observableSourceArr == null) {
            observableSourceArr = new Observable[8];
            i = 0;
            for (ObservableSource<? extends T> observableSource : this.f61527b) {
        ...
        new LatestCoordinator(observer, this.f61528c, i2, this.f61529d, this.f61530e).subscribe(observableSourceArr);
    }
    ...
    static final class LatestCoordinator<T, R> extends AtomicInteger implements Disposable {
        ...
        public void innerNext(int r4, T r5) {
            ...
            L_0x0029:
                ...
                throw r4
            */
            throw new UnsupportedOperationException("Method not decompiled: p218io.reactivex.internal.operators.observable.ObservableCombineLatest.LatestCoordinator.innerNext(int, java.lang.Object):void");
        }
        ...
        public void innerError(int r3, java.lang.Throwable r4) {
            ...
            L_0x0032:
                ...
                goto L_0x0039
            L_0x0036:
                p218io.reactivex.plugins.RxJavaPlugins.onError(r4)
            L_0x0039:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: p218io.reactivex.internal.operators.observable.ObservableCombineLatest.LatestCoordinator.innerError(int, java.lang.Throwable):void");
        }
        ...
        public void innerComplete(int r4) {
            ...
            L_0x0025:
                ...
                throw r4
            */
            throw new UnsupportedOperationException("Method not decompiled: p218io.reactivex.internal.operators.observable.ObservableCombineLatest.LatestCoordinator.innerComplete(int):void");
        }
    }
