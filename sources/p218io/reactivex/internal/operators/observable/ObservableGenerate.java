...
public final class ObservableGenerate<T, S> extends Observable<T> {
    ...
    /* renamed from: a */
    final Callable<S> f61604a;

    /* renamed from: b */
    final BiFunction<S, Emitter<T>, S> f61605b;

    /* renamed from: c */
    final Consumer<? super S> f61606c;

    public ObservableGenerate(Callable<S> callable, BiFunction<S, Emitter<T>, S> biFunction, Consumer<? super S> consumer) {
        this.f61604a = callable;
        this.f61605b = biFunction;
        this.f61606c = consumer;
    }

    public void subscribeActual(Observer<? super T> observer) {
        try {
            GeneratorDisposable generatorDisposable = new GeneratorDisposable(observer, this.f61605b, this.f61606c, this.f61604a.call());
