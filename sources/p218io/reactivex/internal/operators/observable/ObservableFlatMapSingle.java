...
public final class ObservableFlatMapSingle<T, R> extends C22215a<T, R> {

    /* renamed from: a */
    final Function<? super T, ? extends SingleSource<? extends R>> f61592a;

    /* renamed from: b */
    final boolean f61593b;
    ...
    public ObservableFlatMapSingle(ObservableSource<T> observableSource, Function<? super T, ? extends SingleSource<? extends R>> function, boolean z) {
        ...
        this.f61592a = function;
        this.f61593b = z;
    }

    /* access modifiers changed from: protected */
    public void subscribeActual(Observer<? super R> observer) {
        this.source.subscribe(new FlatMapSingleObserver(observer, this.f61592a, this.f61593b));
    }
