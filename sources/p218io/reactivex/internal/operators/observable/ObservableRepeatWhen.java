...
public final class ObservableRepeatWhen<T> extends C22215a<T, T> {

    /* renamed from: a */
    final Function<? super Observable<Object>, ? extends ObservableSource<?>> f61674a;
    ...
    public void subscribeActual(Observer<? super T> observer) {
        ...
        try {
            ObservableSource observableSource = (ObservableSource) ObjectHelper.requireNonNull(this.f61674a.apply(serialized), "The handler returned a null ObservableSource");
