...
public final class ObservableMergeWithMaybe<T> extends C22215a<T, T> {

    /* renamed from: a */
    final MaybeSource<? extends T> f61641a;

    public ObservableMergeWithMaybe(Observable<T> observable, MaybeSource<? extends T> maybeSource) {
        super(observable);
        this.f61641a = maybeSource;
    }
    ...
    public void subscribeActual(Observer<? super T> observer) {
        ...
        this.f61641a.subscribe(mergeWithObserver.otherObserver);
    }
