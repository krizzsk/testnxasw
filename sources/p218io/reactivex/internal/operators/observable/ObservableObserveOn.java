...
public final class ObservableObserveOn<T> extends C22215a<T, T> {

    /* renamed from: a */
    final Scheduler f61643a;

    /* renamed from: b */
    final boolean f61644b;
    ...
    public void subscribeActual(Observer<? super T> observer) {
        Scheduler scheduler = this.f61643a;
        if (scheduler instanceof TrampolineScheduler) {
            this.source.subscribe(observer);
            return;
        }
        this.source.subscribe(new ObserveOnObserver(observer, scheduler.createWorker(), this.f61644b, this.f61645c));
    }
