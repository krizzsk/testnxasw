...
public final class ObservablePublishSelector<T, R> extends C22215a<T, R> {

    /* renamed from: a */
    final Function<? super Observable<T>, ? extends ObservableSource<R>> f61652a;
    ...
    public void subscribeActual(Observer<? super R> observer) {
        ...
        try {
            ObservableSource observableSource = (ObservableSource) ObjectHelper.requireNonNull(this.f61652a.apply(create), "The selector returned a null ObservableSource");
