...
public final class ObservableOnErrorReturn<T> extends C22215a<T, T> {

    /* renamed from: a */
    final Function<? super Throwable, ? extends T> f61648a;

    public ObservableOnErrorReturn(ObservableSource<T> observableSource, Function<? super Throwable, ? extends T> function) {
        super(observableSource);
        this.f61648a = function;
    }

    public void subscribeActual(Observer<? super T> observer) {
        this.source.subscribe(new OnErrorReturnObserver(observer, this.f61648a));
    }
