...
public final class ObservableWindow<T> extends C22215a<T, Observable<T>> {
    ...
    public void subscribeActual(Observer<? super Observable<T>> observer) {
        if (this.f61761a == this.f61762b) {
            this.source.subscribe(new WindowExactObserver(observer, this.f61761a, this.f61763c));
            return;
        }
        this.source.subscribe(new WindowSkipObserver(observer, this.f61761a, this.f61762b, this.f61763c));
    }
