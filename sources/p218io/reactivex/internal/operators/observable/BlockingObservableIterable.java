...
public final class BlockingObservableIterable<T> implements Iterable<T> {
    ...
    /* renamed from: a */
    final ObservableSource<? extends T> f61470a;

    /* renamed from: b */
    final int f61471b;

    public BlockingObservableIterable(ObservableSource<? extends T> observableSource, int i) {
        this.f61470a = observableSource;
        this.f61471b = i;
    }

    public Iterator<T> iterator() {
        BlockingObservableIterator blockingObservableIterator = new BlockingObservableIterator(this.f61471b);
        this.f61470a.subscribe(blockingObservableIterator);
