...
public final class ObservableAny<T> extends C22215a<T, Boolean> {

    /* renamed from: a */
    final Predicate<? super T> f61481a;

    public ObservableAny(ObservableSource<T> observableSource, Predicate<? super T> predicate) {
        super(observableSource);
        this.f61481a = predicate;
    }

    /* access modifiers changed from: protected */
    public void subscribeActual(Observer<? super Boolean> observer) {
        this.source.subscribe(new AnyObserver(observer, this.f61481a));
    }
