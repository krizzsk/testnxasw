...
public final class ObservableConcatMap<T, U> extends C22215a<T, U> {

    /* renamed from: a */
    final Function<? super T, ? extends ObservableSource<? extends U>> f61531a;

    /* renamed from: b */
    final int f61532b;

    /* renamed from: c */
    final ErrorMode f61533c;

    public ObservableConcatMap(ObservableSource<T> observableSource, Function<? super T, ? extends ObservableSource<? extends U>> function, int i, ErrorMode errorMode) {
        super(observableSource);
        this.f61531a = function;
        this.f61533c = errorMode;
        this.f61532b = Math.max(8, i);
    }

    public void subscribeActual(Observer<? super U> observer) {
        if (!ObservableScalarXMap.tryScalarXMapSubscribe(this.source, observer, this.f61531a)) {
            if (this.f61533c == ErrorMode.IMMEDIATE) {
                this.source.subscribe(new SourceObserver(new SerializedObserver(observer), this.f61531a, this.f61532b));
            } else {
                this.source.subscribe(new ConcatMapDelayErrorObserver(observer, this.f61531a, this.f61532b, this.f61533c == ErrorMode.END));
            }
        }
    }
