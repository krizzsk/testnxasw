...
public final class ObservableDebounce<T, U> extends C22215a<T, T> {

    /* renamed from: a */
    final Function<? super T, ? extends ObservableSource<U>> f61543a;

    public ObservableDebounce(ObservableSource<T> observableSource, Function<? super T, ? extends ObservableSource<U>> function) {
        super(observableSource);
        this.f61543a = function;
    }

    public void subscribeActual(Observer<? super T> observer) {
        this.source.subscribe(new DebounceObserver(new SerializedObserver(observer), this.f61543a));
    }
