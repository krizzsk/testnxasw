...
public final class ObservableTimeout<T, U, V> extends C22215a<T, T> {

    /* renamed from: a */
    final ObservableSource<U> f61743a;

    /* renamed from: b */
    final Function<? super T, ? extends ObservableSource<V>> f61744b;

    /* renamed from: c */
    final ObservableSource<? extends T> f61745c;
    ...
    public ObservableTimeout(Observable<T> observable, ObservableSource<U> observableSource, Function<? super T, ? extends ObservableSource<V>> function, ObservableSource<? extends T> observableSource2) {
        super(observable);
        this.f61743a = observableSource;
        this.f61744b = function;
        this.f61745c = observableSource2;
    }

    /* access modifiers changed from: protected */
    public void subscribeActual(Observer<? super T> observer) {
        if (this.f61745c == null) {
            TimeoutObserver timeoutObserver = new TimeoutObserver(observer, this.f61744b);
            observer.onSubscribe(timeoutObserver);
            timeoutObserver.startFirstTimeout(this.f61743a);
            this.source.subscribe(timeoutObserver);
            return;
        }
        TimeoutFallbackObserver timeoutFallbackObserver = new TimeoutFallbackObserver(observer, this.f61744b, this.f61745c);
        observer.onSubscribe(timeoutFallbackObserver);
        timeoutFallbackObserver.startFirstTimeout(this.f61743a);
