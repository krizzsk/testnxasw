...
public final class ObservableMergeWithCompletable<T> extends C22215a<T, T> {

    /* renamed from: a */
    final CompletableSource f61640a;

    public ObservableMergeWithCompletable(Observable<T> observable, CompletableSource completableSource) {
        super(observable);
        this.f61640a = completableSource;
    }
    ...
    public void subscribeActual(Observer<? super T> observer) {
        ...
        this.f61640a.subscribe(mergeWithObserver.otherObserver);
    }
