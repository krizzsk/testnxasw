...
public final class ObservableWindowBoundarySupplier<T, B> extends C22215a<T, Observable<T>> {

    /* renamed from: a */
    final Callable<? extends ObservableSource<B>> f61772a;
    ...
    public ObservableWindowBoundarySupplier(ObservableSource<T> observableSource, Callable<? extends ObservableSource<B>> callable, int i) {
        ...
        this.f61772a = callable;
        this.f61773b = i;
    }

    public void subscribeActual(Observer<? super Observable<T>> observer) {
        this.source.subscribe(new WindowBoundaryMainObserver(observer, this.f61773b, this.f61772a));
    }
