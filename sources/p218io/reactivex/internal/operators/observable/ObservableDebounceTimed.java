...
public final class ObservableDebounceTimed<T> extends C22215a<T, T> {

    /* renamed from: a */
    final long f61544a;

    /* renamed from: b */
    final TimeUnit f61545b;

    /* renamed from: c */
    final Scheduler f61546c;

    public ObservableDebounceTimed(ObservableSource<T> observableSource, long j, TimeUnit timeUnit, Scheduler scheduler) {
        super(observableSource);
        this.f61544a = j;
        this.f61545b = timeUnit;
        this.f61546c = scheduler;
    }

    public void subscribeActual(Observer<? super T> observer) {
        this.source.subscribe(new DebounceTimedObserver(new SerializedObserver(observer), this.f61544a, this.f61545b, this.f61546c.createWorker()));
    }
