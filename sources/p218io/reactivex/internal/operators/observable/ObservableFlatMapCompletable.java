...
public final class ObservableFlatMapCompletable<T> extends C22215a<T, T> {

    /* renamed from: a */
    final Function<? super T, ? extends CompletableSource> f61585a;

    /* renamed from: b */
    final boolean f61586b;
    ...
    public void subscribeActual(Observer<? super T> observer) {
        this.source.subscribe(new FlatMapCompletableMainObserver(observer, this.f61585a, this.f61586b));
    }
