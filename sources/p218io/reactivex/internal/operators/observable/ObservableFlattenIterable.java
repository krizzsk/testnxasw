...
public final class ObservableFlattenIterable<T, R> extends C22215a<T, R> {

    /* renamed from: a */
    final Function<? super T, ? extends Iterable<? extends R>> f61594a;

    public ObservableFlattenIterable(ObservableSource<T> observableSource, Function<? super T, ? extends Iterable<? extends R>> function) {
        super(observableSource);
        this.f61594a = function;
    }

    /* access modifiers changed from: protected */
    public void subscribeActual(Observer<? super R> observer) {
        this.source.subscribe(new FlattenIterableObserver(observer, this.f61594a));
    }
