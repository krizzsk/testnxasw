...
public final class ObservableWindowBoundary<T, B> extends C22215a<T, Observable<T>> {

    /* renamed from: a */
    final ObservableSource<B> f61764a;
    ...
    public ObservableWindowBoundary(ObservableSource<T> observableSource, ObservableSource<B> observableSource2, int i) {
        ...
        this.f61764a = observableSource2;
        this.f61765b = i;
    }

    public void subscribeActual(Observer<? super Observable<T>> observer) {
        WindowBoundaryMainObserver windowBoundaryMainObserver = new WindowBoundaryMainObserver(observer, this.f61765b);
        observer.onSubscribe(windowBoundaryMainObserver);
        this.f61764a.subscribe(windowBoundaryMainObserver.boundaryObserver);
