...
import p218io.reactivex.subjects.Subject;

/* renamed from: io.reactivex.internal.operators.observable.ObservableRetryWhen */
public final class ObservableRetryWhen<T> extends C22215a<T, T> {

    /* renamed from: a */
    final Function<? super Observable<Throwable>, ? extends ObservableSource<?>> f61684a;
    ...
    public void subscribeActual(Observer<? super T> observer) {
        ...
        try {
            ObservableSource observableSource = (ObservableSource) ObjectHelper.requireNonNull(this.f61684a.apply(serialized), "The handler returned a null ObservableSource");
