...
public final class ObservableGroupBy<T, K, V> extends C22215a<T, GroupedObservable<K, V>> {

    /* renamed from: a */
    final Function<? super T, ? extends K> f61607a;

    /* renamed from: b */
    final Function<? super T, ? extends V> f61608b;

    /* renamed from: c */
    final int f61609c;

    /* renamed from: d */
    final boolean f61610d;
    ...
    public ObservableGroupBy(ObservableSource<T> observableSource, Function<? super T, ? extends K> function, Function<? super T, ? extends V> function2, int i, boolean z) {
        ...
        this.f61607a = function;
        this.f61608b = function2;
        this.f61609c = i;
        this.f61610d = z;
    }

    public void subscribeActual(Observer<? super GroupedObservable<K, V>> observer) {
        this.source.subscribe(new GroupByObserver(observer, this.f61607a, this.f61608b, this.f61609c, this.f61610d));
    }
