...
public final class ObservableCollectSingle<T, U> extends Single<U> implements FuseToObservable<U> {
    ...
    /* renamed from: a */
    final ObservableSource<T> f61522a;

    /* renamed from: b */
    final Callable<? extends U> f61523b;

    /* renamed from: c */
    final BiConsumer<? super U, ? super T> f61524c;

    public ObservableCollectSingle(ObservableSource<T> observableSource, Callable<? extends U> callable, BiConsumer<? super U, ? super T> biConsumer) {
        this.f61522a = observableSource;
        this.f61523b = callable;
        this.f61524c = biConsumer;
    }

    /* access modifiers changed from: protected */
    public void subscribeActual(SingleObserver<? super U> singleObserver) {
        try {
            this.f61522a.subscribe(new CollectObserver(singleObserver, ObjectHelper.requireNonNull(this.f61523b.call(), "The initialSupplier returned a null value"), this.f61524c));
        } catch (Throwable th) {
    ...
    public Observable<U> fuseToObservable() {
        return RxJavaPlugins.onAssembly(new ObservableCollect(this.f61522a, this.f61523b, this.f61524c));
    }
    ...
    static final class CollectObserver<T, U> implements Observer<T>, Disposable {
        ...
        public void onNext(T t) {
            if (!this.done) {
                try {
                    this.collector.accept(this.f61525u, t);
                } catch (Throwable th) {
                    this.upstream.dispose();
                    onError(th);
                }
        ...
        public void onComplete() {
            if (!this.done) {
                this.done = true;
                this.downstream.onSuccess(this.f61525u);
            }
        }
    }
}
