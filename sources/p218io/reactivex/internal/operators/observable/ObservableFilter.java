...
public final class ObservableFilter<T> extends C22215a<T, T> {

    /* renamed from: a */
    final Predicate<? super T> f61579a;

    public ObservableFilter(ObservableSource<T> observableSource, Predicate<? super T> predicate) {
        super(observableSource);
        this.f61579a = predicate;
    }

    public void subscribeActual(Observer<? super T> observer) {
        this.source.subscribe(new FilterObserver(observer, this.f61579a));
    }
    ...
    static final class FilterObserver<T> extends BasicFuseableObserver<T, T> {
        ...
        public T poll() throws java.lang.Exception {
            /*
                r2 = this;
            L_0x0000:
                io.reactivex.internal.fuseable.QueueDisposable r0 = r2.f60820qd
            ...
            L_0x0010:
                return r0
            */
            throw new UnsupportedOperationException("Method not decompiled: p218io.reactivex.internal.operators.observable.ObservableFilter.FilterObserver.poll():java.lang.Object");
        }
    }
}
