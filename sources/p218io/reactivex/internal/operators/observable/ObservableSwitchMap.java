...
public final class ObservableSwitchMap<T, R> extends C22215a<T, R> {

    /* renamed from: a */
    final Function<? super T, ? extends ObservableSource<? extends R>> f61720a;
    ...
    public ObservableSwitchMap(ObservableSource<T> observableSource, Function<? super T, ? extends ObservableSource<? extends R>> function, int i, boolean z) {
        ...
        this.f61720a = function;
        this.f61721b = i;
        this.f61722c = z;
    }

    public void subscribeActual(Observer<? super R> observer) {
        if (!ObservableScalarXMap.tryScalarXMapSubscribe(this.source, observer, this.f61720a)) {
            this.source.subscribe(new SwitchMapObserver(observer, this.f61720a, this.f61721b, this.f61722c));
        }
    }
    ...
    static final class SwitchMapObserver<T, R> extends AtomicInteger implements Observer<T>, Disposable {
        ...
        public void drain() {
            ...
            L_0x0052:
                java.lang.Object r5 = r1.get()
                io.reactivex.internal.operators.observable.ObservableSwitchMap$SwitchMapInnerObserver r5 = (p218io.reactivex.internal.operators.observable.ObservableSwitchMap.SwitchMapInnerObserver) r5
            ...
            L_0x00e9:
                ...
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: p218io.reactivex.internal.operators.observable.ObservableSwitchMap.SwitchMapObserver.drain():void");
        }
