...
public final class ObservableDelaySubscriptionOther<T, U> extends Observable<T> {
    ...
    /* renamed from: a */
    final ObservableSource<? extends T> f61554a;

    /* renamed from: b */
    final ObservableSource<U> f61555b;

    public ObservableDelaySubscriptionOther(ObservableSource<? extends T> observableSource, ObservableSource<U> observableSource2) {
        this.f61554a = observableSource;
        this.f61555b = observableSource2;
    }

    public void subscribeActual(Observer<? super T> observer) {
        SequentialDisposable sequentialDisposable = new SequentialDisposable();
        observer.onSubscribe(sequentialDisposable);
        this.f61555b.subscribe(new DelayObserver(sequentialDisposable, observer));
    }
    ...
    final class DelayObserver implements Observer<U> {
        ...
        public void onComplete() {
            if (!this.done) {
                this.done = true;
                ObservableDelaySubscriptionOther.this.f61554a.subscribe(new OnComplete());
            }
        }
