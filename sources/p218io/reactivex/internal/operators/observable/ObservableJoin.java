...
public final class ObservableJoin<TLeft, TRight, TLeftEnd, TRightEnd, R> extends C22215a<TLeft, R> {

    /* renamed from: a */
    final ObservableSource<? extends TRight> f61627a;

    /* renamed from: b */
    final Function<? super TLeft, ? extends ObservableSource<TLeftEnd>> f61628b;

    /* renamed from: c */
    final Function<? super TRight, ? extends ObservableSource<TRightEnd>> f61629c;

    /* renamed from: d */
    final BiFunction<? super TLeft, ? super TRight, ? extends R> f61630d;

    public ObservableJoin(ObservableSource<TLeft> observableSource, ObservableSource<? extends TRight> observableSource2, Function<? super TLeft, ? extends ObservableSource<TLeftEnd>> function, Function<? super TRight, ? extends ObservableSource<TRightEnd>> function2, BiFunction<? super TLeft, ? super TRight, ? extends R> biFunction) {
        super(observableSource);
        this.f61627a = observableSource2;
        this.f61628b = function;
        this.f61629c = function2;
        this.f61630d = biFunction;
    }

    /* access modifiers changed from: protected */
    public void subscribeActual(Observer<? super R> observer) {
        JoinDisposable joinDisposable = new JoinDisposable(observer, this.f61628b, this.f61629c, this.f61630d);
        ...
        this.f61627a.subscribe(leftRightObserver2);
    }
