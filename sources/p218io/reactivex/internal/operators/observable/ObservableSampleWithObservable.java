...
public final class ObservableSampleWithObservable<T> extends C22215a<T, T> {

    /* renamed from: a */
    final ObservableSource<?> f61689a;

    /* renamed from: b */
    final boolean f61690b;

    public ObservableSampleWithObservable(ObservableSource<T> observableSource, ObservableSource<?> observableSource2, boolean z) {
        super(observableSource);
        this.f61689a = observableSource2;
        this.f61690b = z;
    }
    ...
    public void subscribeActual(Observer<? super T> observer) {
        ...
        if (this.f61690b) {
            this.source.subscribe(new SampleMainEmitLast(serializedObserver, this.f61689a));
        } else {
            this.source.subscribe(new SampleMainNoLast(serializedObserver, this.f61689a));
        }
    }
