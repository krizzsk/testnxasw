...
import p218io.reactivex.ObservableEmitter;
import p218io.reactivex.ObservableOnSubscribe;
...
public final class ObservableCreate<T> extends Observable<T> {
    ...
    /* renamed from: a */
    final ObservableOnSubscribe<T> f61542a;

    public ObservableCreate(ObservableOnSubscribe<T> observableOnSubscribe) {
        this.f61542a = observableOnSubscribe;
    }
    ...
    public void subscribeActual(Observer<? super T> observer) {
        ...
        try {
            this.f61542a.subscribe(createEmitter);
        } catch (Throwable th) {
