...
public final class ObservableZipIterable<T, U, V> extends Observable<V> {
    ...
    /* renamed from: a */
    final Observable<? extends T> f61793a;

    /* renamed from: b */
    final Iterable<U> f61794b;

    /* renamed from: c */
    final BiFunction<? super T, ? super U, ? extends V> f61795c;

    public ObservableZipIterable(Observable<? extends T> observable, Iterable<U> iterable, BiFunction<? super T, ? super U, ? extends V> biFunction) {
        this.f61793a = observable;
        this.f61794b = iterable;
        this.f61795c = biFunction;
    }

    public void subscribeActual(Observer<? super V> observer) {
        try {
            Iterator it = (Iterator) ObjectHelper.requireNonNull(this.f61794b.iterator(), "The iterator returned by other is null");
            try {
                if (!it.hasNext()) {
                    EmptyDisposable.complete((Observer<?>) observer);
                } else {
                    this.f61793a.subscribe(new ZipIterableObserver(observer, it, this.f61795c));
                }
            } catch (Throwable th) {
