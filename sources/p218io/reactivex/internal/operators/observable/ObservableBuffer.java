...
public final class ObservableBuffer<T, U extends Collection<? super T>> extends C22215a<T, U> {
    ...
    /* renamed from: c */
    final Callable<U> f61490c;

    public ObservableBuffer(ObservableSource<T> observableSource, int i, int i2, Callable<U> callable) {
        super(observableSource);
        this.f61488a = i;
        this.f61489b = i2;
        this.f61490c = callable;
    }
    ...
    public void subscribeActual(Observer<? super U> observer) {
        ...
        int i2 = this.f61488a;
        if (i == i2) {
            BufferExactObserver bufferExactObserver = new BufferExactObserver(observer, i2, this.f61490c);
        ...
        this.source.subscribe(new BufferSkipObserver(observer, this.f61488a, this.f61489b, this.f61490c));
    }
