...
public final class ObservableFlatMap<T, U> extends C22215a<T, U> {

    /* renamed from: a */
    final Function<? super T, ? extends ObservableSource<? extends U>> f61580a;

    /* renamed from: b */
    final boolean f61581b;
    ...
    public void subscribeActual(Observer<? super U> observer) {
        if (!ObservableScalarXMap.tryScalarXMapSubscribe(this.source, observer, this.f61580a)) {
            this.source.subscribe(new MergeObserver(observer, this.f61580a, this.f61581b, this.f61582c, this.f61583d));
        }
    }
            ...
            while (!checkTerminate()) {
                ...
                if (!z || !((simplePlainQueue2 == null || simplePlainQueue2.isEmpty()) && length == 0 && i == 0)) {
                    if (length != 0) {
                        ...
                        if (length <= i5 || innerObserverArr[i5].f61584id != j) {
                            if (length <= i5) {
                                i5 = 0;
                            }
                            for (int i6 = 0; i6 < length && innerObserverArr[i5].f61584id != j; i6++) {
                                i5++;
                                if (i5 == length) {
                                    i5 = 0;
                                }
                            ...
                            this.lastIndex = i5;
                            this.lastId = innerObserverArr[i5].f61584id;
                        }
                        int i7 = 0;
                        int i8 = 0;
                        while (i7 < length) {
