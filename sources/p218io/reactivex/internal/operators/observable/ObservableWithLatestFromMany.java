...
import p218io.reactivex.internal.util.HalfSerializer;
import p218io.reactivex.plugins.RxJavaPlugins;

/* renamed from: io.reactivex.internal.operators.observable.ObservableWithLatestFromMany */
public final class ObservableWithLatestFromMany<T, R> extends C22215a<T, R> {

    /* renamed from: a */
    final ObservableSource<?>[] f61785a;

    /* renamed from: b */
    final Iterable<? extends ObservableSource<?>> f61786b;

    /* renamed from: c */
    final Function<? super Object[], R> f61787c;
    ...
    public ObservableWithLatestFromMany(ObservableSource<T> observableSource, ObservableSource<?>[] observableSourceArr, Function<? super Object[], R> function) {
        ...
        this.f61785a = observableSourceArr;
        this.f61786b = null;
        this.f61787c = function;
    }
    ...
    public void subscribeActual(Observer<? super R> observer) {
        int i;
        ObservableSource<?>[] observableSourceArr = this.f61785a;
        if (observableSourceArr == null) {
            observableSourceArr = new ObservableSource[8];
            try {
                i = 0;
                for (ObservableSource<?> observableSource : this.f61786b) {
        ...
        WithLatestFromObserver withLatestFromObserver = new WithLatestFromObserver(observer, this.f61787c, i);
    ...
    final class SingletonArrayFunc implements Function<T, R> {
        ...
        public R apply(T t) throws Exception {
            return ObjectHelper.requireNonNull(ObservableWithLatestFromMany.this.f61787c.apply(new Object[]{t}), "The combiner returned a null value");
        }
    }
}
