...
public final class ObservableMergeWithSingle<T> extends C22215a<T, T> {

    /* renamed from: a */
    final SingleSource<? extends T> f61642a;

    public ObservableMergeWithSingle(Observable<T> observable, SingleSource<? extends T> singleSource) {
        super(observable);
        this.f61642a = singleSource;
    }
    ...
    public void subscribeActual(Observer<? super T> observer) {
        ...
        this.f61642a.subscribe(mergeWithObserver.otherObserver);
    }
