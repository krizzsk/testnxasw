...
public final class ObservableTimeoutTimed<T> extends C22215a<T, T> {

    /* renamed from: a */
    final long f61746a;

    /* renamed from: b */
    final TimeUnit f61747b;

    /* renamed from: c */
    final Scheduler f61748c;

    /* renamed from: d */
    final ObservableSource<? extends T> f61749d;
    ...
    public ObservableTimeoutTimed(Observable<T> observable, long j, TimeUnit timeUnit, Scheduler scheduler, ObservableSource<? extends T> observableSource) {
        super(observable);
        this.f61746a = j;
        this.f61747b = timeUnit;
        this.f61748c = scheduler;
        this.f61749d = observableSource;
    }

    /* access modifiers changed from: protected */
    public void subscribeActual(Observer<? super T> observer) {
        if (this.f61749d == null) {
            TimeoutObserver timeoutObserver = new TimeoutObserver(observer, this.f61746a, this.f61747b, this.f61748c.createWorker());
            observer.onSubscribe(timeoutObserver);
            timeoutObserver.startTimeout(0);
            this.source.subscribe(timeoutObserver);
            return;
        }
        TimeoutFallbackObserver timeoutFallbackObserver = new TimeoutFallbackObserver(observer, this.f61746a, this.f61747b, this.f61748c.createWorker(), this.f61749d);
