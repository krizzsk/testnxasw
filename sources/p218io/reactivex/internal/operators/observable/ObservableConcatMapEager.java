...
import p218io.reactivex.internal.observers.InnerQueuedObserver;
import p218io.reactivex.internal.observers.InnerQueuedObserverSupport;
...
public final class ObservableConcatMapEager<T, R> extends C22215a<T, R> {

    /* renamed from: a */
    final Function<? super T, ? extends ObservableSource<? extends R>> f61534a;

    /* renamed from: b */
    final ErrorMode f61535b;
    ...
    public ObservableConcatMapEager(ObservableSource<T> observableSource, Function<? super T, ? extends ObservableSource<? extends R>> function, ErrorMode errorMode, int i, int i2) {
        ...
        this.f61534a = function;
        this.f61535b = errorMode;
        this.f61536c = i;
        this.f61537d = i2;
    }
    ...
    public void subscribeActual(Observer<? super R> observer) {
        this.source.subscribe(new ConcatMapEagerMainObserver(observer, this.f61534a, this.f61536c, this.f61537d, this.f61535b));
    }
