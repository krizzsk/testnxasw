...
public final class ObservableGroupJoin<TLeft, TRight, TLeftEnd, TRightEnd, R> extends C22215a<TLeft, R> {

    /* renamed from: a */
    final ObservableSource<? extends TRight> f61611a;

    /* renamed from: b */
    final Function<? super TLeft, ? extends ObservableSource<TLeftEnd>> f61612b;

    /* renamed from: c */
    final Function<? super TRight, ? extends ObservableSource<TRightEnd>> f61613c;

    /* renamed from: d */
    final BiFunction<? super TLeft, ? super Observable<TRight>, ? extends R> f61614d;
    ...
    public ObservableGroupJoin(ObservableSource<TLeft> observableSource, ObservableSource<? extends TRight> observableSource2, Function<? super TLeft, ? extends ObservableSource<TLeftEnd>> function, Function<? super TRight, ? extends ObservableSource<TRightEnd>> function2, BiFunction<? super TLeft, ? super Observable<TRight>, ? extends R> biFunction) {
        ...
        this.f61611a = observableSource2;
        this.f61612b = function;
        this.f61613c = function2;
        this.f61614d = biFunction;
    }

    /* access modifiers changed from: protected */
    public void subscribeActual(Observer<? super R> observer) {
        GroupJoinDisposable groupJoinDisposable = new GroupJoinDisposable(observer, this.f61612b, this.f61613c, this.f61614d);
        ...
        this.f61611a.subscribe(leftRightObserver2);
    }
