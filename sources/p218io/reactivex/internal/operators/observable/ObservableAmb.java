...
public final class ObservableAmb<T> extends Observable<T> {
    ...
    /* renamed from: a */
    final ObservableSource<? extends T>[] f61479a;

    /* renamed from: b */
    final Iterable<? extends ObservableSource<? extends T>> f61480b;

    public ObservableAmb(ObservableSource<? extends T>[] observableSourceArr, Iterable<? extends ObservableSource<? extends T>> iterable) {
        this.f61479a = observableSourceArr;
        this.f61480b = iterable;
    }

    public void subscribeActual(Observer<? super T> observer) {
        int i;
        ObservableSource<? extends T>[] observableSourceArr = this.f61479a;
        if (observableSourceArr == null) {
            observableSourceArr = new Observable[8];
            try {
                i = 0;
                for (ObservableSource<? extends T> observableSource : this.f61480b) {
