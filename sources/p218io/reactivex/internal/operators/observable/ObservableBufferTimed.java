...
public final class ObservableBufferTimed<T, U extends Collection<? super T>> extends C22215a<T, U> {
    ...
    /* renamed from: c */
    final TimeUnit f61500c;

    /* renamed from: d */
    final Scheduler f61501d;

    /* renamed from: e */
    final Callable<U> f61502e;

    /* renamed from: f */
    final int f61503f;

    /* renamed from: g */
    final boolean f61504g;

    public ObservableBufferTimed(ObservableSource<T> observableSource, long j, long j2, TimeUnit timeUnit, Scheduler scheduler, Callable<U> callable, int i, boolean z) {
        super(observableSource);
        this.f61498a = j;
        this.f61499b = j2;
        this.f61500c = timeUnit;
        this.f61501d = scheduler;
        this.f61502e = callable;
        this.f61503f = i;
        this.f61504g = z;
    }
    ...
    public void subscribeActual(Observer<? super U> observer) {
        if (this.f61498a == this.f61499b && this.f61503f == Integer.MAX_VALUE) {
            this.source.subscribe(new BufferExactUnboundedObserver(new SerializedObserver(observer), this.f61502e, this.f61498a, this.f61500c, this.f61501d));
            return;
        }
        Scheduler.Worker createWorker = this.f61501d.createWorker();
        if (this.f61498a == this.f61499b) {
            this.source.subscribe(new BufferExactBoundedObserver(new SerializedObserver(observer), this.f61502e, this.f61498a, this.f61500c, this.f61503f, this.f61504g, createWorker));
        } else {
            this.source.subscribe(new BufferSkipBoundedObserver(new SerializedObserver(observer), this.f61502e, this.f61498a, this.f61499b, this.f61500c, createWorker));
        }
    }
    ...
    static final class BufferSkipBoundedObserver<T, U extends Collection<? super T>> extends QueueDrainObserver<T, U, U> implements Disposable, Runnable {
        ...
        /* renamed from: w */
        final Scheduler.Worker f61506w;
        ...
        public void onSubscribe(Disposable disposable) {
            if (DisposableHelper.validate(this.upstream, disposable)) {
                ...
                try {
                    ...
                    this.downstream.onSubscribe(this);
                    Scheduler.Worker worker = this.f61506w;
                    long j = this.timeskip;
                    worker.schedulePeriodically(this, j, j, this.unit);
                    this.f61506w.schedule(new RemoveFromBufferEmit(collection), this.timespan, this.unit);
                } catch (Throwable th) {
                    Exceptions.throwIfFatal(th);
                    disposable.dispose();
                    EmptyDisposable.error(th, (Observer<?>) this.downstream);
                    this.f61506w.dispose();
                }
            }
        }
        ...
        public void onComplete() {
            ...
            this.done = true;
            if (enter()) {
                QueueDrainHelper.drainLoop(this.queue, this.downstream, false, this.f61506w, this);
            }
        }
            ...
            if (!this.cancelled) {
                try {
                    ...
                    synchronized (this) {
                        if (!this.cancelled) {
                            this.buffers.add(collection);
                            this.f61506w.schedule(new RemoveFromBuffer(collection), this.timespan, this.unit);
                        }
                    }
                } catch (Throwable th) {
                    Exceptions.throwIfFatal(th);
        ...
        final class RemoveFromBuffer implements Runnable {
            ...
            public void run() {
                synchronized (BufferSkipBoundedObserver.this) {
                    BufferSkipBoundedObserver.this.buffers.remove(this.f61507b);
                }
                BufferSkipBoundedObserver bufferSkipBoundedObserver = BufferSkipBoundedObserver.this;
                bufferSkipBoundedObserver.fastPathOrderedEmit(this.f61507b, false, bufferSkipBoundedObserver.f61506w);
            }
        }
        ...
        final class RemoveFromBufferEmit implements Runnable {
            ...
            public void run() {
                ...
                BufferSkipBoundedObserver bufferSkipBoundedObserver = BufferSkipBoundedObserver.this;
                bufferSkipBoundedObserver.fastPathOrderedEmit(this.buffer, false, bufferSkipBoundedObserver.f61506w);
            }
        }
    }
    ...
    static final class BufferExactBoundedObserver<T, U extends Collection<? super T>> extends QueueDrainObserver<T, U, U> implements Disposable, Runnable {
        ...
        /* renamed from: w */
        final Scheduler.Worker f61505w;
        ...
        public void onSubscribe(Disposable disposable) {
            if (DisposableHelper.validate(this.upstream, disposable)) {
                ...
                try {
                    this.buffer = (Collection) ObjectHelper.requireNonNull(this.bufferSupplier.call(), "The buffer supplied is null");
                    this.downstream.onSubscribe(this);
                    Scheduler.Worker worker = this.f61505w;
                    long j = this.timespan;
        ...
        /* JADX WARNING: Code restructure failed: missing block: B:17:?, code lost:
            r8 = (java.util.Collection) p218io.reactivex.internal.functions.ObjectHelper.requireNonNull(r7.bufferSupplier.call(), "The buffer supplied is null");
         */
        ...
        public void onNext(T r8) {
            ...
            L_0x0028:
                ...
                io.reactivex.Scheduler$Worker r0 = r7.f61505w
                long r4 = r7.timespan
            ...
            L_0x0066:
                ...
                throw r8
            */
            throw new UnsupportedOperationException("Method not decompiled: p218io.reactivex.internal.operators.observable.ObservableBufferTimed.BufferExactBoundedObserver.onNext(java.lang.Object):void");
        }
