...
public final class ObservableSkipUntil<T, U> extends C22215a<T, T> {

    /* renamed from: a */
    final ObservableSource<U> f61716a;

    public ObservableSkipUntil(ObservableSource<T> observableSource, ObservableSource<U> observableSource2) {
        super(observableSource);
        this.f61716a = observableSource2;
    }
    ...
    public void subscribeActual(Observer<? super T> observer) {
        ...
        this.f61716a.subscribe(new SkipUntil(arrayCompositeDisposable, skipUntilObserver, serializedObserver));
