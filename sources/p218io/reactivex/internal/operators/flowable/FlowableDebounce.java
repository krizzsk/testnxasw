...
public final class FlowableDebounce<T, U> extends C22212a<T, T> {

    /* renamed from: a */
    final Function<? super T, ? extends Publisher<U>> f61020a;
    ...
    public void subscribeActual(Subscriber<? super T> subscriber) {
        this.source.subscribe(new DebounceSubscriber(new SerializedSubscriber(subscriber), this.f61020a));
    }
