...
public final class FlowableRetryWhen<T> extends C22212a<T, T> {

    /* renamed from: a */
    final Function<? super Flowable<Throwable>, ? extends Publisher<?>> f61194a;

    public FlowableRetryWhen(Flowable<T> flowable, Function<? super Flowable<Throwable>, ? extends Publisher<?>> function) {
        super(flowable);
        this.f61194a = function;
    }
    ...
    public void subscribeActual(Subscriber<? super T> subscriber) {
        ...
        try {
            Publisher publisher = (Publisher) ObjectHelper.requireNonNull(this.f61194a.apply(serialized), "handler returned a null Publisher");
