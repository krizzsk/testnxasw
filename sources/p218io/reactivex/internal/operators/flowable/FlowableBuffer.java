...
public final class FlowableBuffer<T, C extends Collection<? super T>> extends C22212a<T, C> {
    ...
    public void subscribeActual(Subscriber<? super C> subscriber) {
        ...
        int i2 = this.f60955b;
        if (i == i2) {
            this.source.subscribe(new PublisherBufferExactSubscriber(subscriber, this.f60954a, this.f60956c));
        } else if (i2 > i) {
            this.source.subscribe(new PublisherBufferSkipSubscriber(subscriber, this.f60954a, this.f60955b, this.f60956c));
        } else {
            this.source.subscribe(new PublisherBufferOverlappingSubscriber(subscriber, this.f60954a, this.f60955b, this.f60956c));
        }
    }
