...
public final class FlowableOnErrorNext<T> extends C22212a<T, T> {

    /* renamed from: a */
    final Function<? super Throwable, ? extends Publisher<? extends T>> f61148a;

    /* renamed from: b */
    final boolean f61149b;
    ...
    public void subscribeActual(Subscriber<? super T> subscriber) {
        OnErrorNextSubscriber onErrorNextSubscriber = new OnErrorNextSubscriber(subscriber, this.f61148a, this.f61149b);
