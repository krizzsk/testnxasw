...
public final class FlowableConcatMap<T, R> extends C22212a<T, R> {

    /* renamed from: a */
    final Function<? super T, ? extends Publisher<? extends R>> f60998a;

    /* renamed from: b */
    final int f60999b;

    /* renamed from: c */
    final ErrorMode f61000c;
    ...
    public FlowableConcatMap(Flowable<T> flowable, Function<? super T, ? extends Publisher<? extends R>> function, int i, ErrorMode errorMode) {
        super(flowable);
        this.f60998a = function;
        this.f60999b = i;
        this.f61000c = errorMode;
    }

    /* renamed from: io.reactivex.internal.operators.flowable.FlowableConcatMap$1 */
    static /* synthetic */ class C222091 {
        ...
        static {
            /*
                io.reactivex.internal.util.ErrorMode[] r0 = p218io.reactivex.internal.util.ErrorMode.values()
                int r0 = r0.length
                int[] r0 = new int[r0]
                $SwitchMap$io$reactivex$internal$util$ErrorMode = r0
                io.reactivex.internal.util.ErrorMode r1 = p218io.reactivex.internal.util.ErrorMode.BOUNDARY     // Catch:{ NoSuchFieldError -> 0x0012 }
                int r1 = r1.ordinal()     // Catch:{ NoSuchFieldError -> 0x0012 }
                r2 = 1
                r0[r1] = r2     // Catch:{ NoSuchFieldError -> 0x0012 }
            L_0x0012:
                int[] r0 = $SwitchMap$io$reactivex$internal$util$ErrorMode     // Catch:{ NoSuchFieldError -> 0x001d }
                io.reactivex.internal.util.ErrorMode r1 = p218io.reactivex.internal.util.ErrorMode.END     // Catch:{ NoSuchFieldError -> 0x001d }
            ...
            L_0x001d:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: p218io.reactivex.internal.operators.flowable.FlowableConcatMap.C222091.<clinit>():void");
        }
    }
    ...
    public static <T, R> Subscriber<T> subscribe(Subscriber<? super R> subscriber, Function<? super T, ? extends Publisher<? extends R>> function, int i, ErrorMode errorMode) {
        int i2 = C222091.$SwitchMap$io$reactivex$internal$util$ErrorMode[errorMode.ordinal()];
        if (i2 == 1) {
    ...
    public void subscribeActual(Subscriber<? super R> subscriber) {
        if (!FlowableScalarXMap.tryScalarXMapSubscribe(this.source, subscriber, this.f60998a)) {
            this.source.subscribe(subscribe(subscriber, this.f60998a, this.f60999b, this.f61000c));
        }
    }
