...
public final class FlowableDistinct<T, K> extends C22212a<T, T> {

    /* renamed from: a */
    final Function<? super T, K> f61035a;

    /* renamed from: b */
    final Callable<? extends Collection<? super K>> f61036b;

    public FlowableDistinct(Flowable<T> flowable, Function<? super T, K> function, Callable<? extends Collection<? super K>> callable) {
        super(flowable);
        this.f61035a = function;
        this.f61036b = callable;
    }

    /* access modifiers changed from: protected */
    public void subscribeActual(Subscriber<? super T> subscriber) {
        try {
            this.source.subscribe(new DistinctSubscriber(subscriber, this.f61035a, (Collection) ObjectHelper.requireNonNull(this.f61036b.call(), "The collectionSupplier returned a null collection. Null values are generally not allowed in 2.x operators and sources.")));
        } catch (Throwable th) {
