...
import p218io.reactivex.internal.subscribers.InnerQueuedSubscriber;
import p218io.reactivex.internal.subscribers.InnerQueuedSubscriberSupport;
...
public final class FlowableConcatMapEager<T, R> extends C22212a<T, R> {

    /* renamed from: a */
    final Function<? super T, ? extends Publisher<? extends R>> f61001a;
    ...
    public FlowableConcatMapEager(Flowable<T> flowable, Function<? super T, ? extends Publisher<? extends R>> function, int i, int i2, ErrorMode errorMode) {
        super(flowable);
        this.f61001a = function;
        this.f61002b = i;
        this.f61003c = i2;
        this.f61004d = errorMode;
    }

    /* access modifiers changed from: protected */
    public void subscribeActual(Subscriber<? super R> subscriber) {
        this.source.subscribe(new ConcatMapEagerDelayErrorSubscriber(subscriber, this.f61001a, this.f61002b, this.f61003c, this.f61004d));
    }
