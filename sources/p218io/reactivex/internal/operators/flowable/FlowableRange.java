...
public final class FlowableRange extends Flowable<Integer> {
    ...
    public void subscribeActual(Subscriber<? super Integer> subscriber) {
        if (subscriber instanceof ConditionalSubscriber) {
            subscriber.onSubscribe(new RangeConditionalSubscription((ConditionalSubscriber) subscriber, this.f61159a, this.f61160b));
        } else {
            subscriber.onSubscribe(new RangeSubscription(subscriber, this.f61159a, this.f61160b));
        }
    }
