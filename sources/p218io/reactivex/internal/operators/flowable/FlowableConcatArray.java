...
public final class FlowableConcatArray<T> extends Flowable<T> {
    ...
    /* renamed from: a */
    final Publisher<? extends T>[] f60996a;

    /* renamed from: b */
    final boolean f60997b;

    public FlowableConcatArray(Publisher<? extends T>[] publisherArr, boolean z) {
        this.f60996a = publisherArr;
        this.f60997b = z;
    }

    /* access modifiers changed from: protected */
    public void subscribeActual(Subscriber<? super T> subscriber) {
        ConcatArraySubscriber concatArraySubscriber = new ConcatArraySubscriber(this.f60996a, this.f60997b, subscriber);
