...
public final class FlowableZipIterable<T, U, V> extends C22212a<T, V> {

    /* renamed from: a */
    final Iterable<U> f61309a;

    /* renamed from: b */
    final BiFunction<? super T, ? super U, ? extends V> f61310b;

    public FlowableZipIterable(Flowable<T> flowable, Iterable<U> iterable, BiFunction<? super T, ? super U, ? extends V> biFunction) {
        super(flowable);
        this.f61309a = iterable;
        this.f61310b = biFunction;
    }

    public void subscribeActual(Subscriber<? super V> subscriber) {
        try {
            Iterator it = (Iterator) ObjectHelper.requireNonNull(this.f61309a.iterator(), "The iterator returned by other is null");
            try {
                if (!it.hasNext()) {
                    EmptySubscription.complete(subscriber);
                } else {
                    this.source.subscribe(new ZipIterableSubscriber(subscriber, it, this.f61310b));
                }
            } catch (Throwable th) {
