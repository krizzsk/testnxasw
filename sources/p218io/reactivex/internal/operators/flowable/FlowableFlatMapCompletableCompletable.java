...
public final class FlowableFlatMapCompletableCompletable<T> extends Completable implements FuseToFlowable<T> {
    ...
    /* renamed from: a */
    final Flowable<T> f61068a;

    /* renamed from: b */
    final Function<? super T, ? extends CompletableSource> f61069b;
    ...
    public void subscribeActual(CompletableObserver completableObserver) {
        this.f61068a.subscribe(new FlatMapCompletableMainSubscriber(completableObserver, this.f61069b, this.f61071d, this.f61070c));
    }

    public Flowable<T> fuseToFlowable() {
        return RxJavaPlugins.onAssembly(new FlowableFlatMapCompletable(this.f61068a, this.f61069b, this.f61071d, this.f61070c));
    }
