...
import p218io.reactivex.internal.subscriptions.BasicQueueSubscription;
...
public final class FlowableFromIterable<T> extends Flowable<T> {
    ...
    /* renamed from: a */
    final Iterable<? extends T> f61090a;

    public FlowableFromIterable(Iterable<? extends T> iterable) {
        this.f61090a = iterable;
    }

    public void subscribeActual(Subscriber<? super T> subscriber) {
        try {
            subscribe(subscriber, this.f61090a.iterator());
        } catch (Throwable th) {
    ...
    static abstract class BaseRangeSubscription<T> extends BasicQueueSubscription<T> {
        ...
        public final T poll() {
            Iterator<? extends T> it = this.f61091it;
            if (it == null) {
                return null;
            }
            if (!this.once) {
            ...
            return ObjectHelper.requireNonNull(this.f61091it.next(), "Iterator.next() returned a null value");
        }
