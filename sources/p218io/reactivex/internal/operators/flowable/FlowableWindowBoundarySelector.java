...
import p218io.reactivex.subscribers.DisposableSubscriber;
...
public final class FlowableWindowBoundarySelector<T, B, V> extends C22212a<T, Flowable<T>> {

    /* renamed from: a */
    final Publisher<B> f61283a;

    /* renamed from: b */
    final Function<? super B, ? extends Publisher<V>> f61284b;
    ...
    public FlowableWindowBoundarySelector(Flowable<T> flowable, Publisher<B> publisher, Function<? super B, ? extends Publisher<V>> function, int i) {
        super(flowable);
        this.f61283a = publisher;
        this.f61284b = function;
        this.f61285c = i;
    }

    /* access modifiers changed from: protected */
    public void subscribeActual(Subscriber<? super Flowable<T>> subscriber) {
        this.source.subscribe(new WindowBoundaryMainSubscriber(new SerializedSubscriber(subscriber), this.f61283a, this.f61284b, this.f61285c));
    }
    ...
    static final class WindowBoundaryMainSubscriber<T, B, V> extends QueueDrainSubscriber<T, Object, Flowable<T>> implements Subscription {
        ...
        /* renamed from: ws */
        final List<UnicastProcessor<T>> f61287ws;
        ...
        public void onNext(T t) {
            if (!this.done) {
                if (fastEnter()) {
                    for (UnicastProcessor<T> onNext : this.f61287ws) {
                        onNext.onNext(t);
                    }
                    if (leave(-1) == 0) {
                        return;
        ...
        public void drainLoop() {
            ...
            List<UnicastProcessor<T>> list = this.f61287ws;
            int i = 1;
            while (true) {
                boolean z = this.done;
                ...
                if (z && z2) {
                    ...
                    if (windowOperation.f61288w != null) {
                        if (list.remove(windowOperation.f61288w)) {
                            windowOperation.f61288w.onComplete();
                            if (this.windows.decrementAndGet() == 0) {
                                dispose();
                                return;
                            }
        ...
        public void close(OperatorWindowBoundaryCloseSubscriber<T, V> operatorWindowBoundaryCloseSubscriber) {
            ...
            this.queue.offer(new WindowOperation(operatorWindowBoundaryCloseSubscriber.f61286w, null));
            if (enter()) {
                drainLoop();
            }
        }
    ...
    static final class WindowOperation<T, B> {
        ...
        /* renamed from: w */
        final UnicastProcessor<T> f61288w;

        WindowOperation(UnicastProcessor<T> unicastProcessor, B b) {
            this.f61288w = unicastProcessor;
            this.open = b;
        }
    }
    ...
    static final class OperatorWindowBoundaryCloseSubscriber<T, V> extends DisposableSubscriber<V> {
        ...
        /* renamed from: w */
        final UnicastProcessor<T> f61286w;
