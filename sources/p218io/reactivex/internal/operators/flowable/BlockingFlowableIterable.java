...
public final class BlockingFlowableIterable<T> implements Iterable<T> {
    ...
    /* renamed from: a */
    final Flowable<T> f60936a;

    /* renamed from: b */
    final int f60937b;

    public BlockingFlowableIterable(Flowable<T> flowable, int i) {
        this.f60936a = flowable;
        this.f60937b = i;
    }

    public Iterator<T> iterator() {
        BlockingFlowableIterator blockingFlowableIterator = new BlockingFlowableIterator(this.f60937b);
        this.f60936a.subscribe(blockingFlowableIterator);
