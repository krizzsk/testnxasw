...
public final class FlowableWithLatestFrom<T, U, R> extends C22212a<T, R> {

    /* renamed from: a */
    final BiFunction<? super T, ? super U, ? extends R> f61299a;

    /* renamed from: b */
    final Publisher<? extends U> f61300b;

    public FlowableWithLatestFrom(Flowable<T> flowable, BiFunction<? super T, ? super U, ? extends R> biFunction, Publisher<? extends U> publisher) {
        super(flowable);
        this.f61299a = biFunction;
        this.f61300b = publisher;
    }

    /* access modifiers changed from: protected */
    public void subscribeActual(Subscriber<? super R> subscriber) {
        SerializedSubscriber serializedSubscriber = new SerializedSubscriber(subscriber);
        WithLatestFromSubscriber withLatestFromSubscriber = new WithLatestFromSubscriber(serializedSubscriber, this.f61299a);
        serializedSubscriber.onSubscribe(withLatestFromSubscriber);
        this.f61300b.subscribe(new FlowableWithLatestSubscriber(withLatestFromSubscriber));
