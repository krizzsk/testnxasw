...
public final class FlowableSequenceEqual<T> extends Flowable<Boolean> {
    ...
    /* renamed from: a */
    final Publisher<? extends T> f61205a;

    /* renamed from: b */
    final Publisher<? extends T> f61206b;

    /* renamed from: c */
    final BiPredicate<? super T, ? super T> f61207c;
    ...
    public FlowableSequenceEqual(Publisher<? extends T> publisher, Publisher<? extends T> publisher2, BiPredicate<? super T, ? super T> biPredicate, int i) {
        this.f61205a = publisher;
        this.f61206b = publisher2;
        this.f61207c = biPredicate;
        this.f61208d = i;
    }

    public void subscribeActual(Subscriber<? super Boolean> subscriber) {
        EqualCoordinator equalCoordinator = new EqualCoordinator(subscriber, this.f61208d, this.f61207c);
        subscriber.onSubscribe(equalCoordinator);
        equalCoordinator.subscribe(this.f61205a, this.f61206b);
    }
