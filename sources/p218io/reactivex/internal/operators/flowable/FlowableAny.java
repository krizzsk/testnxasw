...
public final class FlowableAny<T> extends C22212a<T, Boolean> {

    /* renamed from: a */
    final Predicate<? super T> f60947a;

    public FlowableAny(Flowable<T> flowable, Predicate<? super T> predicate) {
        super(flowable);
        this.f60947a = predicate;
    }

    /* access modifiers changed from: protected */
    public void subscribeActual(Subscriber<? super Boolean> subscriber) {
        this.source.subscribe(new AnySubscriber(subscriber, this.f60947a));
    }
