...
public final class FlowableTimeout<T, U, V> extends C22212a<T, T> {

    /* renamed from: a */
    final Publisher<U> f61260a;

    /* renamed from: b */
    final Function<? super T, ? extends Publisher<V>> f61261b;

    /* renamed from: c */
    final Publisher<? extends T> f61262c;
    ...
    public FlowableTimeout(Flowable<T> flowable, Publisher<U> publisher, Function<? super T, ? extends Publisher<V>> function, Publisher<? extends T> publisher2) {
        super(flowable);
        this.f61260a = publisher;
        this.f61261b = function;
        this.f61262c = publisher2;
    }

    /* access modifiers changed from: protected */
    public void subscribeActual(Subscriber<? super T> subscriber) {
        if (this.f61262c == null) {
            TimeoutSubscriber timeoutSubscriber = new TimeoutSubscriber(subscriber, this.f61261b);
            subscriber.onSubscribe(timeoutSubscriber);
            timeoutSubscriber.startFirstTimeout(this.f61260a);
            this.source.subscribe(timeoutSubscriber);
            return;
        }
        TimeoutFallbackSubscriber timeoutFallbackSubscriber = new TimeoutFallbackSubscriber(subscriber, this.f61261b, this.f61262c);
        subscriber.onSubscribe(timeoutFallbackSubscriber);
        timeoutFallbackSubscriber.startFirstTimeout(this.f61260a);
