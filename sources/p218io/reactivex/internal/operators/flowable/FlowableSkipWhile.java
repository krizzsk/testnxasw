...
public final class FlowableSkipWhile<T> extends C22212a<T, T> {

    /* renamed from: a */
    final Predicate<? super T> f61230a;

    public FlowableSkipWhile(Flowable<T> flowable, Predicate<? super T> predicate) {
        super(flowable);
        this.f61230a = predicate;
    }

    /* access modifiers changed from: protected */
    public void subscribeActual(Subscriber<? super T> subscriber) {
        this.source.subscribe(new SkipWhileSubscriber(subscriber, this.f61230a));
    }
