...
public final class FlowableSkipLastTimed<T> extends C22212a<T, T> {

    /* renamed from: a */
    final long f61224a;

    /* renamed from: b */
    final TimeUnit f61225b;

    /* renamed from: c */
    final Scheduler f61226c;

    /* renamed from: d */
    final int f61227d;

    /* renamed from: e */
    final boolean f61228e;

    public FlowableSkipLastTimed(Flowable<T> flowable, long j, TimeUnit timeUnit, Scheduler scheduler, int i, boolean z) {
        super(flowable);
        this.f61224a = j;
        this.f61225b = timeUnit;
        this.f61226c = scheduler;
        this.f61227d = i;
        this.f61228e = z;
    }
    ...
    public void subscribeActual(Subscriber<? super T> subscriber) {
        this.source.subscribe(new SkipLastTimedSubscriber(subscriber, this.f61224a, this.f61225b, this.f61226c, this.f61227d, this.f61228e));
    }
