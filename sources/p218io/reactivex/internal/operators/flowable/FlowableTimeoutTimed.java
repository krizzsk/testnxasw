...
public final class FlowableTimeoutTimed<T> extends C22212a<T, T> {

    /* renamed from: a */
    final long f61263a;

    /* renamed from: b */
    final TimeUnit f61264b;

    /* renamed from: c */
    final Scheduler f61265c;

    /* renamed from: d */
    final Publisher<? extends T> f61266d;
    ...
    public FlowableTimeoutTimed(Flowable<T> flowable, long j, TimeUnit timeUnit, Scheduler scheduler, Publisher<? extends T> publisher) {
        super(flowable);
        this.f61263a = j;
        this.f61264b = timeUnit;
        this.f61265c = scheduler;
        this.f61266d = publisher;
    }

    /* access modifiers changed from: protected */
    public void subscribeActual(Subscriber<? super T> subscriber) {
        if (this.f61266d == null) {
            TimeoutSubscriber timeoutSubscriber = new TimeoutSubscriber(subscriber, this.f61263a, this.f61264b, this.f61265c.createWorker());
            subscriber.onSubscribe(timeoutSubscriber);
            timeoutSubscriber.startTimeout(0);
            this.source.subscribe(timeoutSubscriber);
            return;
        }
        TimeoutFallbackSubscriber timeoutFallbackSubscriber = new TimeoutFallbackSubscriber(subscriber, this.f61263a, this.f61264b, this.f61265c.createWorker(), this.f61266d);
