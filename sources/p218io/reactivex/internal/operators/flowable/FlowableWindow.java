...
public final class FlowableWindow<T> extends C22212a<T, Flowable<T>> {
    ...
    public void subscribeActual(Subscriber<? super Flowable<T>> subscriber) {
        long j = this.f61279b;
        long j2 = this.f61278a;
        if (j == j2) {
            this.source.subscribe(new WindowExactSubscriber(subscriber, this.f61278a, this.f61280c));
        } else if (j > j2) {
            this.source.subscribe(new WindowSkipSubscriber(subscriber, this.f61278a, this.f61279b, this.f61280c));
        } else {
            this.source.subscribe(new WindowOverlapSubscriber(subscriber, this.f61278a, this.f61279b, this.f61280c));
        }
    }
