...
public final class FlowableUnsubscribeOn<T> extends C22212a<T, T> {

    /* renamed from: a */
    final Scheduler f61273a;

    public FlowableUnsubscribeOn(Flowable<T> flowable, Scheduler scheduler) {
        super(flowable);
        this.f61273a = scheduler;
    }

    /* access modifiers changed from: protected */
    public void subscribeActual(Subscriber<? super T> subscriber) {
        this.source.subscribe(new UnsubscribeSubscriber(subscriber, this.f61273a));
    }
