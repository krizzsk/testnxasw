...
public final class FlowableTakeUntilPredicate<T> extends C22212a<T, T> {

    /* renamed from: a */
    final Predicate<? super T> f61249a;

    public FlowableTakeUntilPredicate(Flowable<T> flowable, Predicate<? super T> predicate) {
        super(flowable);
        this.f61249a = predicate;
    }

    /* access modifiers changed from: protected */
    public void subscribeActual(Subscriber<? super T> subscriber) {
        this.source.subscribe(new InnerSubscriber(subscriber, this.f61249a));
    }
