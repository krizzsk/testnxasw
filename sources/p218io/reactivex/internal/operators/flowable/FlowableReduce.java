...
public final class FlowableReduce<T> extends C22212a<T, T> {

    /* renamed from: a */
    final BiFunction<T, T, T> f61163a;

    public FlowableReduce(Flowable<T> flowable, BiFunction<T, T, T> biFunction) {
        super(flowable);
        this.f61163a = biFunction;
    }

    /* access modifiers changed from: protected */
    public void subscribeActual(Subscriber<? super T> subscriber) {
        this.source.subscribe(new ReduceSubscriber(subscriber, this.f61163a));
    }
