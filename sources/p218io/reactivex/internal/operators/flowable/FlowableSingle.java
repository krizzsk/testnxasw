...
public final class FlowableSingle<T> extends C22212a<T, T> {

    /* renamed from: a */
    final T f61217a;

    /* renamed from: b */
    final boolean f61218b;
    ...
    public void subscribeActual(Subscriber<? super T> subscriber) {
        this.source.subscribe(new SingleElementSubscriber(subscriber, this.f61217a, this.f61218b));
    }
