...
public final class FlowableOnBackpressureDrop<T> extends C22212a<T, T> implements Consumer<T> {

    /* renamed from: a */
    final Consumer<? super T> f61147a;
    ...
    public FlowableOnBackpressureDrop(Flowable<T> flowable, Consumer<? super T> consumer) {
        super(flowable);
        this.f61147a = consumer;
    }

    /* access modifiers changed from: protected */
    public void subscribeActual(Subscriber<? super T> subscriber) {
        this.source.subscribe(new BackpressureDropSubscriber(subscriber, this.f61147a));
    }
