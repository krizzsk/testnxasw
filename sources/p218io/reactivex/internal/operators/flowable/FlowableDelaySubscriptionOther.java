...
public final class FlowableDelaySubscriptionOther<T, U> extends Flowable<T> {
    ...
    /* renamed from: b */
    final Publisher<U> f61033b;

    public FlowableDelaySubscriptionOther(Publisher<? extends T> publisher, Publisher<U> publisher2) {
        this.f61032a = publisher;
        this.f61033b = publisher2;
    }

    public void subscribeActual(Subscriber<? super T> subscriber) {
        MainSubscriber mainSubscriber = new MainSubscriber(subscriber, this.f61032a);
        subscriber.onSubscribe(mainSubscriber);
        this.f61033b.subscribe(mainSubscriber.other);
    }
