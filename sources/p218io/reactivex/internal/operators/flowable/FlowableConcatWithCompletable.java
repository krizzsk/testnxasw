...
public final class FlowableConcatWithCompletable<T> extends C22212a<T, T> {

    /* renamed from: a */
    final CompletableSource f61014a;

    public FlowableConcatWithCompletable(Flowable<T> flowable, CompletableSource completableSource) {
        super(flowable);
        this.f61014a = completableSource;
    }

    /* access modifiers changed from: protected */
    public void subscribeActual(Subscriber<? super T> subscriber) {
        this.source.subscribe(new ConcatWithSubscriber(subscriber, this.f61014a));
    }
