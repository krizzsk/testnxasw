...
public final class FlowableFlatMapCompletable<T> extends C22212a<T, T> {

    /* renamed from: a */
    final Function<? super T, ? extends CompletableSource> f61065a;

    /* renamed from: b */
    final int f61066b;

    /* renamed from: c */
    final boolean f61067c;
    ...
    public void subscribeActual(Subscriber<? super T> subscriber) {
        this.source.subscribe(new FlatMapCompletableMainSubscriber(subscriber, this.f61065a, this.f61067c, this.f61066b));
    }
