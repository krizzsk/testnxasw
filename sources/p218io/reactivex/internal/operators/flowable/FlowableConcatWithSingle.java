...
public final class FlowableConcatWithSingle<T> extends C22212a<T, T> {

    /* renamed from: a */
    final SingleSource<? extends T> f61016a;

    public FlowableConcatWithSingle(Flowable<T> flowable, SingleSource<? extends T> singleSource) {
        super(flowable);
        this.f61016a = singleSource;
    }

    /* access modifiers changed from: protected */
    public void subscribeActual(Subscriber<? super T> subscriber) {
        this.source.subscribe(new ConcatWithSubscriber(subscriber, this.f61016a));
    }
