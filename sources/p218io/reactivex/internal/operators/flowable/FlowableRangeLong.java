...
public final class FlowableRangeLong extends Flowable<Long> {
    ...
    public void subscribeActual(Subscriber<? super Long> subscriber) {
        if (subscriber instanceof ConditionalSubscriber) {
            subscriber.onSubscribe(new RangeConditionalSubscription((ConditionalSubscriber) subscriber, this.f61161a, this.f61162b));
            return;
        }
        subscriber.onSubscribe(new RangeSubscription(subscriber, this.f61161a, this.f61162b));
    }
