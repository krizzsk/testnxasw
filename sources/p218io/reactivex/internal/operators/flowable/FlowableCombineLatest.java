...
public final class FlowableCombineLatest<T, R> extends Flowable<R> {
    ...
    /* renamed from: a */
    final Publisher<? extends T>[] f60991a;

    /* renamed from: b */
    final Iterable<? extends Publisher<? extends T>> f60992b;

    /* renamed from: c */
    final Function<? super Object[], ? extends R> f60993c;
    ...
    public FlowableCombineLatest(Publisher<? extends T>[] publisherArr, Function<? super Object[], ? extends R> function, int i, boolean z) {
        this.f60991a = publisherArr;
        this.f60992b = null;
        this.f60993c = function;
        this.f60994d = i;
        this.f60995e = z;
    }
    ...
    public void subscribeActual(Subscriber<? super R> subscriber) {
        int i;
        Publisher<? extends T>[] publisherArr = this.f60991a;
        if (publisherArr == null) {
            publisherArr = new Publisher[8];
            try {
                Iterator it = (Iterator) ObjectHelper.requireNonNull(this.f60992b.iterator(), "The iterator returned is null");
                i = 0;
                while (it.hasNext()) {
                    try {
                        try {
        ...
        if (i2 == 0) {
            ...
            CombineLatestCoordinator combineLatestCoordinator = new CombineLatestCoordinator(subscriber, this.f60993c, i2, this.f60994d, this.f60995e);
    ...
    static final class CombineLatestCoordinator<T, R> extends BasicIntQueueSubscription<R> {
        ...
        public void innerComplete(int r3) {
            ...
            L_0x001c:
                ...
                throw r3
            */
            throw new UnsupportedOperationException("Method not decompiled: p218io.reactivex.internal.operators.flowable.FlowableCombineLatest.CombineLatestCoordinator.innerComplete(int):void");
        }
    ...
    final class SingletonArrayFunc implements Function<T, R> {
        ...
        public R apply(T t) throws Exception {
            return FlowableCombineLatest.this.f60993c.apply(new Object[]{t});
        }
    }
}
