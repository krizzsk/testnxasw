...
public final class FlowableScanSeed<T, R> extends C22212a<T, R> {

    /* renamed from: a */
    final BiFunction<R, ? super T, R> f61203a;

    /* renamed from: b */
    final Callable<R> f61204b;

    public FlowableScanSeed(Flowable<T> flowable, Callable<R> callable, BiFunction<R, ? super T, R> biFunction) {
        super(flowable);
        this.f61203a = biFunction;
        this.f61204b = callable;
    }

    /* access modifiers changed from: protected */
    public void subscribeActual(Subscriber<? super R> subscriber) {
        try {
            this.source.subscribe(new ScanSeedSubscriber(subscriber, this.f61203a, ObjectHelper.requireNonNull(this.f61204b.call(), "The seed supplied is null"), bufferSize()));
        } catch (Throwable th) {
