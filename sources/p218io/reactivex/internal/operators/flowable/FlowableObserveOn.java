...
public final class FlowableObserveOn<T> extends C22212a<T, T> {

    /* renamed from: a */
    final Scheduler f61137a;

    /* renamed from: b */
    final boolean f61138b;
    ...
    public FlowableObserveOn(Flowable<T> flowable, Scheduler scheduler, boolean z, int i) {
        super(flowable);
        this.f61137a = scheduler;
        this.f61138b = z;
        this.f61139c = i;
    }

    public void subscribeActual(Subscriber<? super T> subscriber) {
        Scheduler.Worker createWorker = this.f61137a.createWorker();
        if (subscriber instanceof ConditionalSubscriber) {
            this.source.subscribe(new ObserveOnConditionalSubscriber((ConditionalSubscriber) subscriber, createWorker, this.f61138b, this.f61139c));
        } else {
            this.source.subscribe(new ObserveOnSubscriber(subscriber, createWorker, this.f61138b, this.f61139c));
        }
    }
