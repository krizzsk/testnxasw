...
import p218io.reactivex.schedulers.SchedulerRunnableIntrospection;
...
public final class ExecutorScheduler extends Scheduler {
    ...
    /* renamed from: c */
    static final Scheduler f61979c = Schedulers.single();

    /* renamed from: b */
    final Executor f61980b;

    public ExecutorScheduler(Executor executor) {
        this.f61980b = executor;
    }

    public Scheduler.Worker createWorker() {
        return new ExecutorWorker(this.f61980b);
    }

    public Disposable scheduleDirect(Runnable runnable) {
        Runnable onSchedule = RxJavaPlugins.onSchedule(runnable);
        try {
            if (this.f61980b instanceof ExecutorService) {
                ScheduledDirectTask scheduledDirectTask = new ScheduledDirectTask(onSchedule);
                scheduledDirectTask.setFuture(((ExecutorService) this.f61980b).submit(scheduledDirectTask));
                return scheduledDirectTask;
            }
            ExecutorWorker.BooleanRunnable booleanRunnable = new ExecutorWorker.BooleanRunnable(onSchedule);
            this.f61980b.execute(booleanRunnable);
    ...
    public Disposable scheduleDirect(Runnable runnable, long j, TimeUnit timeUnit) {
        Runnable onSchedule = RxJavaPlugins.onSchedule(runnable);
        if (this.f61980b instanceof ScheduledExecutorService) {
            try {
                ScheduledDirectTask scheduledDirectTask = new ScheduledDirectTask(onSchedule);
                scheduledDirectTask.setFuture(((ScheduledExecutorService) this.f61980b).schedule(scheduledDirectTask, j, timeUnit));
                return scheduledDirectTask;
            } catch (RejectedExecutionException e) {
                RxJavaPlugins.onError(e);
                return EmptyDisposable.INSTANCE;
            ...
            delayedRunnable.timed.replace(f61979c.scheduleDirect(new DelayedDispose(delayedRunnable), j, timeUnit));
    ...
    public Disposable schedulePeriodicallyDirect(Runnable runnable, long j, long j2, TimeUnit timeUnit) {
        ...
        try {
            ...
            scheduledDirectPeriodicTask.setFuture(((ScheduledExecutorService) this.f61980b).scheduleAtFixedRate(scheduledDirectPeriodicTask, j, j2, timeUnit));
    ...
    public static final class ExecutorWorker extends Scheduler.Worker implements Runnable {
        ...
        public Disposable schedule(Runnable runnable, long j, TimeUnit timeUnit) {
            ...
            if (executor2 instanceof ScheduledExecutorService) {
                ...
                scheduledRunnable.setFuture(new C22219a(ExecutorScheduler.f61979c.scheduleDirect(scheduledRunnable, j, timeUnit)));
            }
        ...
        public void run() {
            ...
            L_0x0025:
                ...
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: p218io.reactivex.internal.schedulers.ExecutorScheduler.ExecutorWorker.run():void");
        }
    ...
    final class DelayedDispose implements Runnable {
        ...
        /* renamed from: dr */
        private final DelayedRunnable f61981dr;

        DelayedDispose(DelayedRunnable delayedRunnable) {
            this.f61981dr = delayedRunnable;
        }

        public void run() {
            this.f61981dr.direct.replace(ExecutorScheduler.this.scheduleDirect(this.f61981dr));
        }
    }
}
