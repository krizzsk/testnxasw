...
public enum NotificationLite {
    ...
    static final class ErrorNotification implements Serializable {
        ...
        public String toString() {
            return "NotificationLite.Error[" + this.f62060e + Const.jaRight;
        }

        public int hashCode() {
            return this.f62060e.hashCode();
        }

        public boolean equals(Object obj) {
            if (obj instanceof ErrorNotification) {
                return ObjectHelper.equals(this.f62060e, ((ErrorNotification) obj).f62060e);
            }
            return false;
        }
    }
    ...
    static final class SubscriptionNotification implements Serializable {
        ...
        public String toString() {
            return "NotificationLite.Subscription[" + this.upstream + Const.jaRight;
        }
    }
    ...
    static final class DisposableNotification implements Serializable {
        ...
        public String toString() {
            return "NotificationLite.Disposable[" + this.upstream + Const.jaRight;
        }
    }
    ...
    public static Throwable getError(Object obj) {
        return ((ErrorNotification) obj).f62060e;
    }
    ...
    public static <T> boolean accept(Object obj, Subscriber<? super T> subscriber) {
        if (obj == COMPLETE) {
            ...
            subscriber.onError(((ErrorNotification) obj).f62060e);
            return true;
        } else {
    ...
    public static <T> boolean accept(Object obj, Observer<? super T> observer) {
        if (obj == COMPLETE) {
            ...
            observer.onError(((ErrorNotification) obj).f62060e);
            return true;
        } else {
            observer.onNext(obj);
            return false;
