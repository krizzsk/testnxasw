...
public final class QueueDrainHelper {
    ...
    /* renamed from: a */
    static final long f62067a = Long.MIN_VALUE;

    /* renamed from: b */
    static final long f62068b = Long.MAX_VALUE;
    ...
    public static <T> boolean postCompleteRequest(long j, Subscriber<? super T> subscriber, Queue<T> queue, AtomicLong atomicLong, BooleanSupplier booleanSupplier) {
        ...
        m45988a(j3 | Long.MIN_VALUE, subscriber, queue, atomicLong, booleanSupplier);
        return true;
    }

    /* renamed from: a */
    static boolean m45989a(BooleanSupplier booleanSupplier) {
        try {
    ...
    /* renamed from: a */
    static <T> boolean m45988a(long j, Subscriber<? super T> subscriber, Queue<T> queue, AtomicLong atomicLong, BooleanSupplier booleanSupplier) {
        long j2 = j & Long.MIN_VALUE;
        while (true) {
            if (j2 != j) {
                if (m45989a(booleanSupplier)) {
                    return true;
                }
                T poll = queue.poll();
                if (poll == null) {
                ...
                j2++;
            } else if (m45989a(booleanSupplier)) {
                return true;
            } else {
                if (queue.isEmpty()) {
                    subscriber.onComplete();
    ...
    public static <T> void postComplete(Subscriber<? super T> subscriber, Queue<T> queue, AtomicLong atomicLong, BooleanSupplier booleanSupplier) {
        ...
        if (queue.isEmpty()) {
            subscriber.onComplete();
        } else if (!m45988a(atomicLong.get(), subscriber, queue, atomicLong, booleanSupplier)) {
            do {
                j = atomicLong.get();
            ...
            if (j != 0) {
                m45988a(j2, subscriber, queue, atomicLong, booleanSupplier);
            }
        }
    }
}
