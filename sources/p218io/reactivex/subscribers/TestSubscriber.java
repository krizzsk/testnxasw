...
import p218io.reactivex.observers.BaseTestConsumer;
...
public class TestSubscriber<T> extends BaseTestConsumer<T, TestSubscriber<T>> implements FlowableSubscriber<T>, Disposable, Subscription {
    ...
    /* renamed from: a */
    private final Subscriber<? super T> f62254a;

    /* renamed from: b */
    private volatile boolean f62255b;

    /* renamed from: c */
    private final AtomicReference<Subscription> f62256c;

    /* renamed from: d */
    private final AtomicLong f62257d;

    /* renamed from: e */
    private QueueSubscription<T> f62258e;
    ...
    public TestSubscriber(Subscriber<? super T> subscriber, long j) {
        if (j >= 0) {
            this.f62254a = subscriber;
            this.f62256c = new AtomicReference<>();
            this.f62257d = new AtomicLong(j);
            return;
        }
    ...
    public void onSubscribe(Subscription subscription) {
        ...
        if (subscription == null) {
        ...
        } else if (!this.f62256c.compareAndSet((Object) null, subscription)) {
            subscription.cancel();
            if (this.f62256c.get() != SubscriptionHelper.CANCELLED) {
            ...
            if (this.initialFusionMode != 0 && (subscription instanceof QueueSubscription)) {
                ...
                this.f62258e = queueSubscription;
            ...
            this.f62254a.onSubscribe(subscription);
            long andSet = this.f62257d.getAndSet(0);
            if (andSet != 0) {
    ...
    public final void request(long j) {
        SubscriptionHelper.deferredRequest(this.f62256c, this.f62257d, j);
    }

    public final void cancel() {
        if (!this.f62255b) {
            this.f62255b = true;
            SubscriptionHelper.cancel(this.f62256c);
        }
    }
    ...
    /* renamed from: a */
    public final TestSubscriber<T> mo185410a(int i) {
    ...
    /* access modifiers changed from: package-private */
    /* renamed from: b */
    public final TestSubscriber<T> mo185413b(int i) {
        int i2 = this.establishedFusionMode;
        if (i2 == i) {
            return this;
        }
        if (this.f62258e != null) {
            throw new AssertionError("Fusion mode different. Expected: " + m46066c(i) + ", actual: " + m46066c(i2));
        }
        throw fail("Upstream is not fuseable");
    }

    /* renamed from: c */
    static String m46066c(int i) {
        if (i == 0) {
    ...
    /* access modifiers changed from: package-private */
    /* renamed from: a */
    public final TestSubscriber<T> mo185409a() {
        if (this.f62258e != null) {
            return this;
        }
    ...
    /* access modifiers changed from: package-private */
    /* renamed from: b */
    public final TestSubscriber<T> mo185412b() {
        if (this.f62258e == null) {
            return this;
        }
