...
import p218io.reactivex.internal.observers.BiConsumerSingleObserver;
import p218io.reactivex.internal.observers.BlockingMultiObserver;
import p218io.reactivex.internal.observers.ConsumerSingleObserver;
import p218io.reactivex.internal.observers.FutureSingleObserver;
import p218io.reactivex.internal.operators.completable.CompletableFromSingle;
import p218io.reactivex.internal.operators.completable.CompletableToFlowable;
import p218io.reactivex.internal.operators.flowable.FlowableConcatMap;
import p218io.reactivex.internal.operators.flowable.FlowableConcatMapPublisher;
import p218io.reactivex.internal.operators.flowable.FlowableFlatMapPublisher;
import p218io.reactivex.internal.operators.flowable.FlowableSingleSingle;
import p218io.reactivex.internal.operators.maybe.MaybeFilterSingle;
import p218io.reactivex.internal.operators.maybe.MaybeFromSingle;
import p218io.reactivex.internal.operators.mixed.SingleFlatMapObservable;
...
import p218io.reactivex.internal.operators.single.SingleAmb;
import p218io.reactivex.internal.operators.single.SingleCache;
import p218io.reactivex.internal.operators.single.SingleContains;
import p218io.reactivex.internal.operators.single.SingleCreate;
import p218io.reactivex.internal.operators.single.SingleDefer;
import p218io.reactivex.internal.operators.single.SingleDelay;
import p218io.reactivex.internal.operators.single.SingleDelayWithCompletable;
import p218io.reactivex.internal.operators.single.SingleDelayWithObservable;
import p218io.reactivex.internal.operators.single.SingleDelayWithPublisher;
import p218io.reactivex.internal.operators.single.SingleDelayWithSingle;
import p218io.reactivex.internal.operators.single.SingleDematerialize;
import p218io.reactivex.internal.operators.single.SingleDetach;
import p218io.reactivex.internal.operators.single.SingleDoAfterSuccess;
import p218io.reactivex.internal.operators.single.SingleDoAfterTerminate;
import p218io.reactivex.internal.operators.single.SingleDoFinally;
import p218io.reactivex.internal.operators.single.SingleDoOnDispose;
import p218io.reactivex.internal.operators.single.SingleDoOnError;
import p218io.reactivex.internal.operators.single.SingleDoOnEvent;
import p218io.reactivex.internal.operators.single.SingleDoOnSubscribe;
import p218io.reactivex.internal.operators.single.SingleDoOnSuccess;
import p218io.reactivex.internal.operators.single.SingleEquals;
import p218io.reactivex.internal.operators.single.SingleError;
import p218io.reactivex.internal.operators.single.SingleFlatMap;
import p218io.reactivex.internal.operators.single.SingleFlatMapCompletable;
import p218io.reactivex.internal.operators.single.SingleFlatMapIterableFlowable;
import p218io.reactivex.internal.operators.single.SingleFlatMapIterableObservable;
import p218io.reactivex.internal.operators.single.SingleFlatMapMaybe;
import p218io.reactivex.internal.operators.single.SingleFlatMapPublisher;
import p218io.reactivex.internal.operators.single.SingleFromCallable;
import p218io.reactivex.internal.operators.single.SingleFromPublisher;
import p218io.reactivex.internal.operators.single.SingleFromUnsafeSource;
import p218io.reactivex.internal.operators.single.SingleHide;
import p218io.reactivex.internal.operators.single.SingleInternalHelper;
import p218io.reactivex.internal.operators.single.SingleJust;
import p218io.reactivex.internal.operators.single.SingleLift;
import p218io.reactivex.internal.operators.single.SingleMap;
import p218io.reactivex.internal.operators.single.SingleMaterialize;
import p218io.reactivex.internal.operators.single.SingleNever;
import p218io.reactivex.internal.operators.single.SingleObserveOn;
import p218io.reactivex.internal.operators.single.SingleOnErrorReturn;
import p218io.reactivex.internal.operators.single.SingleResumeNext;
import p218io.reactivex.internal.operators.single.SingleSubscribeOn;
import p218io.reactivex.internal.operators.single.SingleTakeUntil;
import p218io.reactivex.internal.operators.single.SingleTimeout;
import p218io.reactivex.internal.operators.single.SingleTimer;
import p218io.reactivex.internal.operators.single.SingleToFlowable;
import p218io.reactivex.internal.operators.single.SingleToObservable;
import p218io.reactivex.internal.operators.single.SingleUnsubscribeOn;
import p218io.reactivex.internal.operators.single.SingleUsing;
import p218io.reactivex.internal.operators.single.SingleZipArray;
import p218io.reactivex.internal.operators.single.SingleZipIterable;
...
public abstract class Single<T> implements SingleSource<T> {
    ...
    @SchedulerSupport("none")
    /* renamed from: as */
    public final <R> R mo183822as(SingleConverter<T, ? extends R> singleConverter) {
    ...
    public final Single<T> timeout(long j, TimeUnit timeUnit) {
        return m45914a(j, timeUnit, Schedulers.computation(), (SingleSource) null);
    }

    @CheckReturnValue
    @SchedulerSupport("custom")
    public final Single<T> timeout(long j, TimeUnit timeUnit, Scheduler scheduler) {
        return m45914a(j, timeUnit, scheduler, (SingleSource) null);
    }
    ...
    public final Single<T> timeout(long j, TimeUnit timeUnit, Scheduler scheduler, SingleSource<? extends T> singleSource) {
        ObjectHelper.requireNonNull(singleSource, "other is null");
        return m45914a(j, timeUnit, scheduler, singleSource);
    }
    ...
    public final Single<T> timeout(long j, TimeUnit timeUnit, SingleSource<? extends T> singleSource) {
        ObjectHelper.requireNonNull(singleSource, "other is null");
        return m45914a(j, timeUnit, Schedulers.computation(), singleSource);
    }

    /* renamed from: a */
    private Single<T> m45914a(long j, TimeUnit timeUnit, Scheduler scheduler, SingleSource<? extends T> singleSource) {
        ObjectHelper.requireNonNull(timeUnit, "unit is null");
        ObjectHelper.requireNonNull(scheduler, "scheduler is null");
    ...
    @SchedulerSupport("none")
    /* renamed from: to */
    public final <R> R mo183896to(Function<? super Single<T>, R> function) {
        try {
    ...
    /* renamed from: a */
    private static <T> Single<T> m45915a(Flowable<T> flowable) {
