...
public final class ReplaySubject<T> extends Subject<T> {
    ...
    /* renamed from: c */
    static final ReplayDisposable[] f62215c = new ReplayDisposable[0];

    /* renamed from: d */
    static final ReplayDisposable[] f62216d = new ReplayDisposable[0];

    /* renamed from: f */
    private static final Object[] f62217f = new Object[0];

    /* renamed from: a */
    final ReplayBuffer<T> f62218a;

    /* renamed from: b */
    final AtomicReference<ReplayDisposable<T>[]> f62219b = new AtomicReference<>(f62215c);
    ...
    /* renamed from: a */
    static <T> ReplaySubject<T> m46047a() {
    ...
    public void subscribeActual(Observer<? super T> observer) {
        ...
        if (!mo185357a(replayDisposable) || !replayDisposable.cancelled) {
            this.f62218a.replay(replayDisposable);
        } else {
            mo185360b(replayDisposable);
        }
    }
    ...
    public void onNext(T t) {
        ...
        if (!this.f62220e) {
            ReplayBuffer<T> replayBuffer = this.f62218a;
            replayBuffer.add(t);
            for (ReplayDisposable replay : (ReplayDisposable[]) this.f62219b.get()) {
    ...
    public void onError(Throwable th) {
        ...
        for (ReplayDisposable replay : mo185358a(error)) {
            replayBuffer.replay(replay);
        }
    }
    ...
    public void onComplete() {
        if (!this.f62220e) {
            ...
            for (ReplayDisposable replay : mo185358a(complete)) {
                replayBuffer.replay(replay);
            }
        }
    }
    ...
    public boolean hasObservers() {
        return ((ReplayDisposable[]) this.f62219b.get()).length != 0;
    }

    /* access modifiers changed from: package-private */
    /* renamed from: b */
    public int mo185359b() {
        return ((ReplayDisposable[]) this.f62219b.get()).length;
    }

    public Throwable getThrowable() {
        Object obj = this.f62218a.get();
    ...
    public T getValue() {
        return this.f62218a.getValue();
    }

    public void cleanupBuffer() {
        this.f62218a.trimHead();
    }

    public Object[] getValues() {
        Object[] values = getValues(f62217f);
        return values == f62217f ? new Object[0] : values;
    }

    public T[] getValues(T[] tArr) {
        return this.f62218a.getValues(tArr);
    }

    public boolean hasComplete() {
        return NotificationLite.isComplete(this.f62218a.get());
    }

    public boolean hasThrowable() {
        return NotificationLite.isError(this.f62218a.get());
    }

    public boolean hasValue() {
        return this.f62218a.size() != 0;
    }

    /* access modifiers changed from: package-private */
    /* renamed from: c */
    public int mo185361c() {
        return this.f62218a.size();
    }

    /* access modifiers changed from: package-private */
    /* renamed from: a */
    public boolean mo185357a(ReplayDisposable<T> replayDisposable) {
        ReplayDisposable[] replayDisposableArr;
        ReplayDisposable[] replayDisposableArr2;
        do {
            replayDisposableArr = (ReplayDisposable[]) this.f62219b.get();
            if (replayDisposableArr == f62216d) {
                return false;
            }
        ...
        } while (!this.f62219b.compareAndSet(replayDisposableArr, replayDisposableArr2));
        return true;
    }

    /* access modifiers changed from: package-private */
    /* renamed from: b */
    public void mo185360b(ReplayDisposable<T> replayDisposable) {
        ReplayDisposable<T>[] replayDisposableArr;
        ReplayDisposable[] replayDisposableArr2;
        do {
            replayDisposableArr = (ReplayDisposable[]) this.f62219b.get();
            if (replayDisposableArr != f62216d && replayDisposableArr != f62215c) {
                int length = replayDisposableArr.length;
                int i = -1;
                int i2 = 0;
                while (true) {
    ...
    /* access modifiers changed from: package-private */
    /* renamed from: a */
    public ReplayDisposable<T>[] mo185358a(Object obj) {
        if (this.f62218a.compareAndSet((Object) null, obj)) {
            return (ReplayDisposable[]) this.f62219b.getAndSet(f62216d);
        }
        return f62216d;
    }
