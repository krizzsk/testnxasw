package p218io.flutter.plugin.localization;
...
public class LocalizationPlugin {
    ...
    /* renamed from: a */
    final LocalizationChannel.LocalizationMessageHandler f60609a;

    /* renamed from: b */
    private final LocalizationChannel f60610b;
    /* access modifiers changed from: private */

    /* renamed from: c */
    public final Context f60611c;

    public LocalizationPlugin(Context context, LocalizationChannel localizationChannel) {
        C221121 r0 = new LocalizationChannel.LocalizationMessageHandler() {
            ...
            public java.lang.String getStringResource(java.lang.String r8, java.lang.String r9) {
                /*
                    r7 = this;
                    io.flutter.plugin.localization.LocalizationPlugin r0 = p218io.flutter.plugin.localization.LocalizationPlugin.this
                    android.content.Context r0 = r0.f60611c
                    r1 = 17
                    r2 = 0
                    if (r9 == 0) goto L_0x004a
                    java.util.Locale r3 = p218io.flutter.plugin.localization.LocalizationPlugin.localeFromString(r9)
                    int r4 = android.os.Build.VERSION.SDK_INT
                    if (r4 < r1) goto L_0x0034
                    android.content.res.Configuration r0 = new android.content.res.Configuration
                    io.flutter.plugin.localization.LocalizationPlugin r4 = p218io.flutter.plugin.localization.LocalizationPlugin.this
                    android.content.Context r4 = r4.f60611c
                    android.content.res.Resources r4 = r4.getResources()
                    android.content.res.Configuration r4 = r4.getConfiguration()
                    r0.<init>(r4)
                    r0.setLocale(r3)
                    io.flutter.plugin.localization.LocalizationPlugin r3 = p218io.flutter.plugin.localization.LocalizationPlugin.this
                    android.content.Context r3 = r3.f60611c
                ...
                L_0x006b:
                    ...
                    io.flutter.plugin.localization.LocalizationPlugin r9 = p218io.flutter.plugin.localization.LocalizationPlugin.this
                    android.content.Context r9 = r9.f60611c
                ...
                L_0x0084:
                    return r8
                */
                throw new UnsupportedOperationException("Method not decompiled: p218io.flutter.plugin.localization.LocalizationPlugin.C221121.getStringResource(java.lang.String, java.lang.String):java.lang.String");
            }
        };
        this.f60609a = r0;
        this.f60611c = context;
        this.f60610b = localizationChannel;
        localizationChannel.setLocalizationMessageHandler(r0);
    }
    ...
    public Locale resolveNativeLocale(List<Locale> list) {
        ...
        if (Build.VERSION.SDK_INT >= 26) {
            ...
            LocaleList locales = this.f60611c.getResources().getConfiguration().getLocales();
            ...
            LocaleList locales2 = this.f60611c.getResources().getConfiguration().getLocales();
            ...
            Locale locale3 = this.f60611c.getResources().getConfiguration().locale;
            if (locale3 != null) {
    ...
    public void sendLocalesToFlutter(Configuration configuration) {
        ...
        this.f60610b.sendLocales(arrayList);
    }
