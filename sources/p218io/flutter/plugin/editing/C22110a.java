...
class C22110a {
    ...
    /* renamed from: a */
    public static final int f60588a = 10;

    /* renamed from: b */
    public static final int f60589b = 13;

    /* renamed from: c */
    public static final int f60590c = 8419;

    /* renamed from: d */
    public static final int f60591d = 917631;

    /* renamed from: e */
    public static final int f60592e = 8205;

    /* renamed from: f */
    private final FlutterJNI f60593f;

    /* renamed from: f */
    public boolean mo182600f(int i) {
        return 917536 <= i && i <= 917630;
    }

    /* renamed from: g */
    public boolean mo182601g(int i) {
        return (48 <= i && i <= 57) || i == 35 || i == 42;
    }

    public C22110a(FlutterJNI flutterJNI) {
        this.f60593f = flutterJNI;
    }

    /* renamed from: a */
    public boolean mo182594a(int i) {
        return this.f60593f.isCodePointEmoji(i);
    }

    /* renamed from: b */
    public boolean mo182596b(int i) {
        return this.f60593f.isCodePointEmojiModifier(i);
    }

    /* renamed from: c */
    public boolean mo182597c(int i) {
        return this.f60593f.isCodePointEmojiModifierBase(i);
    }

    /* renamed from: d */
    public boolean mo182598d(int i) {
        return this.f60593f.isCodePointVariantSelector(i);
    }

    /* renamed from: e */
    public boolean mo182599e(int i) {
        return this.f60593f.isCodePointRegionalIndicator(i);
    }
    ...
    public int mo182593a(java.lang.CharSequence r9, int r10) {
        /*
            r8 = this;
            r0 = 0
            r1 = 1
        ...
        L_0x004d:
            ...
            boolean r1 = r8.mo182598d(r0)
            if (r1 == 0) goto L_0x0077
            int r9 = java.lang.Character.codePointBefore(r9, r4)
            boolean r1 = r8.mo182601g(r9)
        ...
        L_0x014c:
            if (r5 == 0) goto L_0x0154
            boolean r7 = r8.mo182594a(r2)
            if (r7 != 0) goto L_0x00d6
        L_0x0154:
            int r10 = r10 - r3
            return r10
        */
        throw new UnsupportedOperationException("Method not decompiled: p218io.flutter.plugin.editing.C22110a.mo182593a(java.lang.CharSequence, int):int");
    }
    ...
    /* renamed from: b */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public int mo182595b(java.lang.CharSequence r10, int r11) {
        /*
            r9 = this;
            int r0 = r10.length()
            int r1 = r0 + -1
        ...
        L_0x0067:
            ...
            boolean r0 = r9.mo182598d(r1)
            if (r0 == 0) goto L_0x0091
            int r10 = java.lang.Character.codePointAt(r10, r4)
            boolean r0 = r9.mo182601g(r10)
        ...
        L_0x013b:
            if (r6 == 0) goto L_0x0143
            boolean r8 = r9.mo182594a(r2)
            if (r8 != 0) goto L_0x00a6
        L_0x0143:
            int r11 = r11 + r3
            return r11
        */
        throw new UnsupportedOperationException("Method not decompiled: p218io.flutter.plugin.editing.C22110a.mo182595b(java.lang.CharSequence, int):int");
    }
}
