...
public final class DialogFragmentNavigator extends Navigator<Destination> {
    ...
    public boolean popBackStack() {
        ...
        if (this.mFragmentManager.isStateSaved()) {
            SystemUtils.log(4, TAG, "Ignoring popBackStack() call: FragmentManager has already saved its state", (Throwable) null, "androidx.navigation.fragment.DialogFragmentNavigator", 80);
            return false;
        }
    ...
    public NavDestination navigate(Destination destination, Bundle bundle, NavOptions navOptions, Navigator.Extras extras) {
        if (this.mFragmentManager.isStateSaved()) {
            SystemUtils.log(4, TAG, "Ignoring navigate() call: FragmentManager has already saved its state", (Throwable) null, "androidx.navigation.fragment.DialogFragmentNavigator", 104);
            return null;
        }
    ...
    public static class Destination extends NavDestination implements FloatingWindow {
        ...
        public void onInflate(Context context, AttributeSet attributeSet) {
            ...
            TypedArray obtainAttributes = context.getResources().obtainAttributes(attributeSet, C0625R.styleable.DialogFragmentNavigator);
            String string = obtainAttributes.getString(C0625R.styleable.DialogFragmentNavigator_android_name);
            if (string != null) {
                setClassName(string);
            }
