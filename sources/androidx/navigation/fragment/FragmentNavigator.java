...
public class FragmentNavigator extends Navigator<Destination> {
    ...
    public boolean popBackStack() {
        ...
        if (this.mFragmentManager.isStateSaved()) {
            SystemUtils.log(4, TAG, "Ignoring popBackStack() call: FragmentManager has already saved its state", (Throwable) null, "androidx.navigation.fragment.FragmentNavigator", 93);
            return false;
        }
    ...
    /* JADX WARNING: Removed duplicated region for block: B:59:0x013a A[RETURN] */
    ...
    public androidx.navigation.NavDestination navigate(androidx.navigation.fragment.FragmentNavigator.Destination r9, android.os.Bundle r10, androidx.navigation.NavOptions r11, androidx.navigation.Navigator.Extras r12) {
        /*
            ...
            java.lang.String r6 = "androidx.navigation.fragment.FragmentNavigator"
    ...
    public static class Destination extends NavDestination {
        ...
        public void onInflate(Context context, AttributeSet attributeSet) {
            ...
            TypedArray obtainAttributes = context.getResources().obtainAttributes(attributeSet, C0625R.styleable.FragmentNavigator);
            String string = obtainAttributes.getString(C0625R.styleable.FragmentNavigator_android_name);
            if (string != null) {
                setClassName(string);
            }
