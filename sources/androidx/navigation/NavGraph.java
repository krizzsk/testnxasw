...
public class NavGraph extends NavDestination implements Iterable<NavDestination> {
    ...
    public void onInflate(Context context, AttributeSet attributeSet) {
        ...
        TypedArray obtainAttributes = context.getResources().obtainAttributes(attributeSet, C0612R.styleable.NavGraphNavigator);
        setStartDestination(obtainAttributes.getResourceId(C0612R.styleable.NavGraphNavigator_startDestination, 0));
