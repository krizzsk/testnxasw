...
public class NavController {
    ...
    public boolean popBackStackInternal(int i, boolean z) {
        ...
        if (!z2) {
            ...
            SystemUtils.log(4, TAG, "Ignoring popBackStack to destination " + displayName + " as it was not found on the current back stack", (Throwable) null, "androidx.navigation.NavController", 317);
            return false;
        }
    ...
    public boolean handleDeepLink(Intent intent) {
        ...
        if (findInvalidDestinationDisplayNameInDeepLink != null) {
            SystemUtils.log(4, TAG, "Could not find destination " + findInvalidDestinationDisplayNameInDeepLink + " in the navigation graph, ignoring the deep link from " + intent, (Throwable) null, "androidx.navigation.NavController", 686);
            return false;
        }
