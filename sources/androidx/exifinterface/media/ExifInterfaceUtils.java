    ...
    static void closeFileDescriptor(FileDescriptor fileDescriptor) {
        if (Build.VERSION.SDK_INT >= 21) {
            try {
                ...
                SystemUtils.log(6, TAG, "Error closing fd.", (Throwable) null, "androidx.exifinterface.media.ExifInterfaceUtils", 156);
            }
        } else {
            SystemUtils.log(6, TAG, "closeFileDescriptor is called in API < 21, which must be wrong.", (Throwable) null, "androidx.exifinterface.media.ExifInterfaceUtils", 159);
        }
    }
