...
public final class ActivityFilter {
    ...
    public String toString() {
        return "ActivityFilter(componentName=" + this.componentName + ", intentAction=" + this.intentAction + VersionRange.RIGHT_OPEN;
    }
}
