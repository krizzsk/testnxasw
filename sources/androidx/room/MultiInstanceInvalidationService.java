    ...
    private final IMultiInstanceInvalidationService.Stub mBinder = new IMultiInstanceInvalidationService.Stub() {
        ...
        public void broadcastInvalidation(int i, String[] strArr) {
            synchronized (MultiInstanceInvalidationService.this.mCallbackList) {
                ...
                if (str == null) {
                    SystemUtils.log(5, "ROOM", "Remote invalidation client ID not registered", (Throwable) null, "androidx.room.MultiInstanceInvalidationService$2", 102);
                    return;
                }
                ...
                for (int i2 = 0; i2 < beginBroadcast; i2++) {
                    try {
                        ...
                        SystemUtils.log(5, "ROOM", "Error invoking a remote callback", e, "androidx.room.MultiInstanceInvalidationService$2", 119);
                    } catch (Throwable th) {
