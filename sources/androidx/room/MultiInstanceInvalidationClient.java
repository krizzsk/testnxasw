    ...
    final Runnable mSetUpRunnable = new Runnable() {
        public void run() {
            try {
                ...
                SystemUtils.log(5, "ROOM", "Cannot register multi-instance invalidation callback", e, "androidx.room.MultiInstanceInvalidationClient$3", 127);
            }
        }
    };
    ...
    private final Runnable mTearDownRunnable = new Runnable() {
        public void run() {
            ...
            try {
                ...
                SystemUtils.log(5, "ROOM", "Cannot unregister multi-instance invalidation callback", e, "androidx.room.MultiInstanceInvalidationClient$5", 151);
            }
            ...
            public void onInvalidated(Set<String> set) {
                if (!MultiInstanceInvalidationClient.this.mStopped.get()) {
                    try {
                        ...
                        SystemUtils.log(5, "ROOM", "Cannot broadcast invalidation", e, "androidx.room.MultiInstanceInvalidationClient$6", 184);
                    }
                }
            }
        };
