...
public class SlidingPaneLayout extends ViewGroup {
    ...
    public void onMeasure(int i, int i2) {
        ...
        int childCount = getChildCount();
        if (childCount > 2) {
            SystemUtils.log(6, TAG, "onMeasure: More than two child views are not supported.", (Throwable) null, "androidx.slidingpanelayout.widget.SlidingPaneLayout", 490);
        }
        ...
        if (Build.VERSION.SDK_INT >= 16) {
            if (!this.mDisplayListReflectionLoaded) {
                try {
                    ...
                    SystemUtils.log(6, TAG, "Couldn't fetch getDisplayList method; dimming won't work right.", e, "androidx.slidingpanelayout.widget.SlidingPaneLayout", 1032);
                }
                try {
                    ...
                    SystemUtils.log(6, TAG, "Couldn't fetch mRecreateDisplayList field; dimming will be slow.", e2, "androidx.slidingpanelayout.widget.SlidingPaneLayout", 1039);
                }
            ...
            try {
                ...
                SystemUtils.log(6, TAG, "Error refreshing display list state", e3, "androidx.slidingpanelayout.widget.SlidingPaneLayout", 1054);
            }
        }
