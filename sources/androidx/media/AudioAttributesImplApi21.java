...
class AudioAttributesImplApi21 implements AudioAttributesImpl {
    ...
    public int getLegacyStreamType() {
        ...
        if (audioAttributesToLegacyStreamTypeMethod == null) {
            SystemUtils.log(5, TAG, "No AudioAttributes#toLegacyStreamType() on API: " + Build.VERSION.SDK_INT, (Throwable) null, "androidx.media.AudioAttributesImplApi21", 96);
            return -1;
        }
        try {
            ...
            Throwable th = e;
            SystemUtils.log(5, TAG, "getLegacyStreamType() failed on API: " + Build.VERSION.SDK_INT, th, "androidx.media.AudioAttributesImplApi21", 104);
            return -1;
        }
    }
