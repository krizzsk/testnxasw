        ...
        public Builder setInternalLegacyStreamType(int i) {
            switch (i) {
                ...
                case 10:
                    ...
                    break;
                default:
                    SystemUtils.log(6, AudioAttributesCompat.TAG, "Invalid stream type " + i + " for AudioAttributesCompat", (Throwable) null, "androidx.media.AudioAttributesCompat$Builder", 597);
                    break;
            }
            this.mContentType = 4;
