...
public abstract class MediaBrowserServiceCompat extends Service {
                ...
                public void run() {
                    ...
                    while (it.hasNext()) {
                        ...
                        try {
                            ...
                            SystemUtils.log(5, MediaBrowserServiceCompat.TAG, "Connection for " + next.pkg + " is no longer valid.", (Throwable) null, "androidx.media.MediaBrowserServiceCompat$MediaBrowserServiceImplBase$1", 223);
                            it.remove();
                        }
                    }
                }
        ...
        public void handleMessage(Message message) {
            ...
            switch (message.what) {
                ...
                case 9:
                    ...
                    return;
                default:
                    SystemUtils.log(5, MediaBrowserServiceCompat.TAG, "Unhandled message: " + message + "\n  Service version: " + 2 + "\n  Client version: " + message.arg1, (Throwable) null, "androidx.media.MediaBrowserServiceCompat$ServiceHandler", 672);
                    return;
            }
        }
                ...
                MediaBrowserServiceCompat.this.mHandler.postOrRun(new Runnable() {
                    public void run() {
                        ...
                        if (connectionRecord.root == null) {
                            SystemUtils.log(4, MediaBrowserServiceCompat.TAG, "No root for client " + str2 + " from service " + getClass().getName(), (Throwable) null, "androidx.media.MediaBrowserServiceCompat$ServiceBinderImpl$1", 905);
                            try {
                                serviceCallbacks2.onConnectFailed();
                            } catch (RemoteException unused) {
                                SystemUtils.log(5, MediaBrowserServiceCompat.TAG, "Calling onConnectFailed() failed. Ignoring. pkg=" + str2, (Throwable) null, "androidx.media.MediaBrowserServiceCompat$ServiceBinderImpl$1", 910);
                            }
                        } else {
                            try {
                                ...
                                SystemUtils.log(5, MediaBrowserServiceCompat.TAG, "Calling onConnect() failed. Dropping client. pkg=" + str2, (Throwable) null, "androidx.media.MediaBrowserServiceCompat$ServiceBinderImpl$1", 922);
                                MediaBrowserServiceCompat.this.mConnections.remove(asBinder);
                            }
                        }
                    }
            ...
            MediaBrowserServiceCompat.this.mHandler.postOrRun(new Runnable() {
                public void run() {
                    ...
                    if (connectionRecord == null) {
                        SystemUtils.log(5, MediaBrowserServiceCompat.TAG, "addSubscription for callback that isn't registered id=" + str2, (Throwable) null, "androidx.media.MediaBrowserServiceCompat$ServiceBinderImpl$3", 957);
                        return;
                    }
        ...
        public void removeSubscription(final String str, final IBinder iBinder, final ServiceCallbacks serviceCallbacks) {
            MediaBrowserServiceCompat.this.mHandler.postOrRun(new Runnable() {
                public void run() {
                    ...
                    if (connectionRecord == null) {
                        SystemUtils.log(5, MediaBrowserServiceCompat.TAG, "removeSubscription for callback that isn't registered id=" + str, (Throwable) null, "androidx.media.MediaBrowserServiceCompat$ServiceBinderImpl$4", 976);
                    } else if (!MediaBrowserServiceCompat.this.removeSubscription(str, connectionRecord, iBinder)) {
                        SystemUtils.log(5, MediaBrowserServiceCompat.TAG, "removeSubscription called for " + str + " which is not subscribed", (Throwable) null, "androidx.media.MediaBrowserServiceCompat$ServiceBinderImpl$4", 982);
                    }
                }
            });
        }
            ...
            if (!TextUtils.isEmpty(str) && resultReceiver != null) {
                MediaBrowserServiceCompat.this.mHandler.postOrRun(new Runnable() {
                    public void run() {
                        ConnectionRecord connectionRecord = MediaBrowserServiceCompat.this.mConnections.get(serviceCallbacks.asBinder());
                        if (connectionRecord == null) {
                            SystemUtils.log(5, MediaBrowserServiceCompat.TAG, "getMediaItem for callback that isn't registered id=" + str, (Throwable) null, "androidx.media.MediaBrowserServiceCompat$ServiceBinderImpl$5", 1002);
                            return;
                        }
            ...
            MediaBrowserServiceCompat.this.mHandler.postOrRun(new Runnable() {
                public void run() {
                    ...
                    try {
                        ...
                        SystemUtils.log(5, MediaBrowserServiceCompat.TAG, "IBinder is already dead.", (Throwable) null, "androidx.media.MediaBrowserServiceCompat$ServiceBinderImpl$6", 1026);
                    }
                }
            });
        }
            ...
            if (!TextUtils.isEmpty(str) && resultReceiver != null) {
                ...
                MediaBrowserServiceCompat.this.mHandler.postOrRun(new Runnable() {
                    public void run() {
                        ConnectionRecord connectionRecord = MediaBrowserServiceCompat.this.mConnections.get(serviceCallbacks2.asBinder());
                        if (connectionRecord == null) {
                            SystemUtils.log(5, MediaBrowserServiceCompat.TAG, "search for callback that isn't registered query=" + str2, (Throwable) null, "androidx.media.MediaBrowserServiceCompat$ServiceBinderImpl$8", 1059);
                            return;
                        }
            ...
            if (!TextUtils.isEmpty(str) && resultReceiver != null) {
                ...
                MediaBrowserServiceCompat.this.mHandler.postOrRun(new Runnable() {
                    public void run() {
                        ConnectionRecord connectionRecord = MediaBrowserServiceCompat.this.mConnections.get(serviceCallbacks2.asBinder());
                        if (connectionRecord == null) {
                            SystemUtils.log(5, MediaBrowserServiceCompat.TAG, "sendCustomAction for callback that isn't registered action=" + str2 + ", extras=" + bundle2, (Throwable) null, "androidx.media.MediaBrowserServiceCompat$ServiceBinderImpl$9", 1080);
                            return;
                        }
    ...
    public void performLoadChildren(String str, ConnectionRecord connectionRecord, Bundle bundle, Bundle bundle2) {
        ...
        C05521 r0 = new Result<List<MediaBrowserCompat.MediaItem>>(str) {
            /* access modifiers changed from: package-private */
            public void onResultSent(List<MediaBrowserCompat.MediaItem> list) {
                if (MediaBrowserServiceCompat.this.mConnections.get(connectionRecord2.callbacks.asBinder()) == connectionRecord2) {
                    ...
                    try {
                        ...
                        SystemUtils.log(5, MediaBrowserServiceCompat.TAG, "Calling onLoadChildren() failed for id=" + str2 + " package=" + connectionRecord2.pkg, (Throwable) null, "androidx.media.MediaBrowserServiceCompat$1", 1592);
                    }
                } else if (MediaBrowserServiceCompat.DEBUG) {
                    SystemUtils.log(3, MediaBrowserServiceCompat.TAG, "Not sending onLoadChildren result for connection that has been disconnected. pkg=" + connectionRecord2.pkg + " id=" + str2, (Throwable) null, "androidx.media.MediaBrowserServiceCompat$1", 1578);
                }
            }
        };
        this.mCurConnection = connectionRecord;
    ...
    public void performLoadItem(String str, ConnectionRecord connectionRecord, final ResultReceiver resultReceiver) {
        C05532 r0 = new Result<MediaBrowserCompat.MediaItem>(str) {
            /* access modifiers changed from: package-private */
            public void onResultSent(MediaBrowserCompat.MediaItem mediaItem) {
                if ((getFlags() & 2) != 0) {
    ...
    public void performSearch(String str, Bundle bundle, ConnectionRecord connectionRecord, final ResultReceiver resultReceiver) {
        C05543 r0 = new Result<List<MediaBrowserCompat.MediaItem>>(str) {
            /* access modifiers changed from: package-private */
            public void onResultSent(List<MediaBrowserCompat.MediaItem> list) {
    ...
    public void performCustomAction(String str, Bundle bundle, ConnectionRecord connectionRecord, final ResultReceiver resultReceiver) {
        C05554 r0 = new Result<Bundle>(str) {
            /* access modifiers changed from: package-private */
