...
public final class WithLifecycleStateKt {
    ...
    public static final <R> Object suspendWithStateAtLeastUnchecked(Lifecycle lifecycle, Lifecycle.State state, boolean z, CoroutineDispatcher coroutineDispatcher, Function0<? extends R> function0, Continuation<? super R> continuation) {
        ...
        C0513x3029b39e withLifecycleStateKt$suspendWithStateAtLeastUnchecked$$inlined$suspendCancellableCoroutine$lambda$1 = new C0513x3029b39e(cancellableContinuation, lifecycle, state, function0, z, coroutineDispatcher);
        if (z) {
            coroutineDispatcher.dispatch(EmptyCoroutineContext.INSTANCE, new C0514x3029b39f(withLifecycleStateKt$suspendWithStateAtLeastUnchecked$$inlined$suspendCancellableCoroutine$lambda$1, lifecycle, state, function0, z, coroutineDispatcher));
        } else {
        ...
        cancellableContinuation.invokeOnCancellation(new C0515x3029b3a0(withLifecycleStateKt$suspendWithStateAtLeastUnchecked$$inlined$suspendCancellableCoroutine$lambda$1, lifecycle, state, function0, z, coroutineDispatcher));
