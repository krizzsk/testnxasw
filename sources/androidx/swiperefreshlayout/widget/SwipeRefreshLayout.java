...
public class SwipeRefreshLayout extends ViewGroup implements NestedScrollingChild, NestedScrollingParent {
        ...
        if (actionMasked != 0) {
            if (actionMasked != 1) {
                if (actionMasked == 2) {
                    ...
                    if (i == -1) {
                        SystemUtils.log(6, LOG_TAG, "Got ACTION_MOVE event but don't have an active pointer id.", (Throwable) null, "androidx.swiperefreshlayout.widget.SwipeRefreshLayout", 722);
                        return false;
                    }
    ...
    public boolean onTouchEvent(MotionEvent motionEvent) {
        ...
        if (actionMasked == 0) {
            ...
            if (findPointerIndex < 0) {
                SystemUtils.log(6, LOG_TAG, "Got ACTION_UP event but don't have an active pointer id.", (Throwable) null, "androidx.swiperefreshlayout.widget.SwipeRefreshLayout", 1059);
                return false;
            }
            ...
            if (findPointerIndex2 < 0) {
                SystemUtils.log(6, LOG_TAG, "Got ACTION_MOVE event but have an invalid active pointer id.", (Throwable) null, "androidx.swiperefreshlayout.widget.SwipeRefreshLayout", 1024);
                return false;
            }
            ...
            if (actionMasked == 5) {
                ...
                if (actionIndex < 0) {
                    SystemUtils.log(6, LOG_TAG, "Got ACTION_POINTER_DOWN event but have an invalid action index.", (Throwable) null, "androidx.swiperefreshlayout.widget.SwipeRefreshLayout", 1044);
                    return false;
                }
