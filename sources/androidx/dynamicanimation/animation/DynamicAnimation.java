...
public abstract class DynamicAnimation<T extends DynamicAnimation<T>> implements AnimationHandler.AnimationFrameCallback {
    ...
    /* renamed from: X */
    public static final ViewProperty f122X = new ViewProperty("x") {
        public void setValue(View view, float f) {
            view.setX(f);
        }
    ...
    /* renamed from: Y */
    public static final ViewProperty f123Y = new ViewProperty(SameLayerRenderingUtil.KEY_COMP_Y) {
        public void setValue(View view, float f) {
            view.setY(f);
        }
    ...
    /* renamed from: Z */
    public static final ViewProperty f124Z = new ViewProperty("z") {
        public void setValue(View view, float f) {
