...
import androidx.recyclerview.C0641R;
...
public class RecyclerView extends ViewGroup implements NestedScrollingChild2, ScrollingView {
    ...
    public RecyclerView(Context context, AttributeSet attributeSet, int i) {
        ...
        if (attributeSet != null) {
            TypedArray obtainStyledAttributes2 = context.obtainStyledAttributes(attributeSet, C0641R.styleable.RecyclerView, i, 0);
            String string = obtainStyledAttributes2.getString(C0641R.styleable.RecyclerView_layoutManager);
            if (obtainStyledAttributes2.getInt(C0641R.styleable.RecyclerView_android_descendantFocusability, -1) == -1) {
                setDescendantFocusability(262144);
            }
            boolean z2 = obtainStyledAttributes2.getBoolean(C0641R.styleable.RecyclerView_fastScrollEnabled, false);
            this.mEnableFastScroller = z2;
            if (z2) {
                initFastScroller((StateListDrawable) obtainStyledAttributes2.getDrawable(C0641R.styleable.RecyclerView_fastScrollVerticalThumbDrawable), obtainStyledAttributes2.getDrawable(C0641R.styleable.RecyclerView_fastScrollVerticalTrackDrawable), (StateListDrawable) obtainStyledAttributes2.getDrawable(C0641R.styleable.RecyclerView_fastScrollHorizontalThumbDrawable), obtainStyledAttributes2.getDrawable(C0641R.styleable.RecyclerView_fastScrollHorizontalTrackDrawable));
            }
    ...
    public void setScrollingTouchSlop(int i) {
        ...
        if (i != 0) {
            if (i != 1) {
                SystemUtils.log(5, TAG, "setScrollingTouchSlop(): bad argument constant " + i + "; using default value", (Throwable) null, "androidx.recyclerview.widget.RecyclerView", 1110);
            } else {
    ...
    public void scrollToPosition(int i) {
        if (!this.mLayoutFrozen) {
            ...
            LayoutManager layoutManager = this.mLayout;
            if (layoutManager == null) {
                SystemUtils.log(6, TAG, "Cannot scroll to position a LayoutManager set. Call setLayoutManager with a non-null argument.", (Throwable) null, "androidx.recyclerview.widget.RecyclerView", 1741);
                return;
            }
    ...
    public void smoothScrollToPosition(int i) {
        if (!this.mLayoutFrozen) {
            LayoutManager layoutManager = this.mLayout;
            if (layoutManager == null) {
                SystemUtils.log(6, TAG, "Cannot smooth scroll without a LayoutManager set. Call setLayoutManager with a non-null argument.", (Throwable) null, "androidx.recyclerview.widget.RecyclerView", 1777);
            } else {
    ...
    public void scrollTo(int i, int i2) {
        SystemUtils.log(5, TAG, "RecyclerView does not support scrolling to an absolute position. Use scrollToPosition instead", (Throwable) null, "androidx.recyclerview.widget.RecyclerView", 1786);
    }

    public void scrollBy(int i, int i2) {
        LayoutManager layoutManager = this.mLayout;
        if (layoutManager == null) {
            SystemUtils.log(6, TAG, "Cannot scroll without a LayoutManager set. Call setLayoutManager with a non-null argument.", (Throwable) null, "androidx.recyclerview.widget.RecyclerView", 1793);
    ...
    public void smoothScrollBy(int i, int i2, Interpolator interpolator) {
        LayoutManager layoutManager = this.mLayout;
        if (layoutManager == null) {
            SystemUtils.log(6, TAG, "Cannot smooth scroll without a LayoutManager set. Call setLayoutManager with a non-null argument.", (Throwable) null, "androidx.recyclerview.widget.RecyclerView", 2243);
        } else if (!this.mLayoutFrozen) {
    ...
    public boolean fling(int i, int i2) {
        ...
        int i3 = 0;
        if (layoutManager == null) {
            SystemUtils.log(6, TAG, "Cannot fling without a LayoutManager set. Call setLayoutManager with a non-null argument.", (Throwable) null, "androidx.recyclerview.widget.RecyclerView", 2276);
            return false;
        } else if (this.mLayoutFrozen) {
            return false;
        } else {
    ...
    public void assertNotInLayoutOrScroll(String str) {
        if (isComputingLayout()) {
            ...
            SystemUtils.log(5, TAG, "Cannot call this method in a scroll callback. Scroll callbacks mightbe run during a measure & layout pass where you cannot change theRecyclerView data. Any method call that might change the structureof the RecyclerView or the adapter contents should be postponed tothe next frame.", new IllegalStateException("" + exceptionLabel()), "androidx.recyclerview.widget.RecyclerView", 2885);
        }
    }
    ...
    public boolean onInterceptTouchEvent(MotionEvent motionEvent) {
        ...
        if (actionMasked == 0) {
            ...
            if (findPointerIndex < 0) {
                SystemUtils.log(6, TAG, "Error processing scroll; pointer index for id " + this.mScrollPointerId + " not found. Did any MotionEvents get skipped?", (Throwable) null, "androidx.recyclerview.widget.RecyclerView", 3034);
                return false;
            }
    ...
    public boolean onTouchEvent(MotionEvent motionEvent) {
        ...
        if (actionMasked == 0) {
            ...
            int findPointerIndex = motionEvent.findPointerIndex(this.mScrollPointerId);
            if (findPointerIndex < 0) {
                SystemUtils.log(6, TAG, "Error processing scroll; pointer index for id " + this.mScrollPointerId + " not found. Did any MotionEvents get skipped?", (Throwable) null, "androidx.recyclerview.widget.RecyclerView", 3141);
                return false;
            }
            int x2 = (int) (motionEvent.getX(findPointerIndex) + 0.5f);
            int y2 = (int) (motionEvent.getY(findPointerIndex) + 0.5f);
    ...
    public void dispatchLayout() {
        if (this.mAdapter == null) {
            SystemUtils.log(6, TAG, "No adapter attached; skipping layout", (Throwable) null, "androidx.recyclerview.widget.RecyclerView", 3628);
        } else if (this.mLayout == null) {
            SystemUtils.log(6, TAG, "No layout manager attached; skipping layout", (Throwable) null, "androidx.recyclerview.widget.RecyclerView", 3633);
        } else {
    ...
    private void handleMissingPreInfoForChangeError(long j, ViewHolder viewHolder, ViewHolder viewHolder2) {
        ...
        SystemUtils.log(6, TAG, "Problem while matching changed view holders with the newones. The pre-layout information for the change holder " + viewHolder2 + " cannot be found but it is necessary for " + viewHolder + exceptionLabel(), (Throwable) null, "androidx.recyclerview.widget.RecyclerView", 4069);
    }
    ...
    public final class Recycler {
        ...
        /* JADX WARNING: Removed duplicated region for block: B:95:0x0207  */
    ...
    public static abstract class LayoutManager {
        ...
        public void onLayoutChildren(Recycler recycler, State state) {
            SystemUtils.log(6, RecyclerView.TAG, "You must override onLayoutChildren(Recycler recycler, State state) ", (Throwable) null, "androidx.recyclerview.widget.RecyclerView$LayoutManager", 8019);
        }
        ...
        public void smoothScrollToPosition(RecyclerView recyclerView, State state, int i) {
            SystemUtils.log(6, RecyclerView.TAG, "You must override smoothScrollToPosition to support smooth scrolling", (Throwable) null, "androidx.recyclerview.widget.RecyclerView$LayoutManager", 8185);
        }
        ...
        public static Properties getProperties(Context context, AttributeSet attributeSet, int i, int i2) {
            ...
            TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C0641R.styleable.RecyclerView, i, i2);
            properties.orientation = obtainStyledAttributes.getInt(C0641R.styleable.RecyclerView_android_orientation, 1);
            properties.spanCount = obtainStyledAttributes.getInt(C0641R.styleable.RecyclerView_spanCount, 1);
            properties.reverseLayout = obtainStyledAttributes.getBoolean(C0641R.styleable.RecyclerView_reverseLayout, false);
            properties.stackFromEnd = obtainStyledAttributes.getBoolean(C0641R.styleable.RecyclerView_stackFromEnd, false);
            obtainStyledAttributes.recycle();
            return properties;
        }
    ...
    public static abstract class ViewHolder {
        ...
        public final void setIsRecyclable(boolean z) {
            ...
            if (i2 < 0) {
                this.mIsRecyclableCount = 0;
                SystemUtils.log(6, Const.BlockNameConst.BLOCK_NAME_DYNAMIC_CONTAINER, "isRecyclable decremented below 0: unmatched pair of setIsRecyable() calls for " + this, (Throwable) null, "androidx.recyclerview.widget.RecyclerView$ViewHolder", 11160);
            } else if (!z && i2 == 1) {
                this.mFlags |= 16;
    ...
    public void initFastScroller(StateListDrawable stateListDrawable, Drawable drawable, StateListDrawable stateListDrawable2, Drawable drawable2) {
        ...
        new FastScroller(this, stateListDrawable, drawable, stateListDrawable2, drawable2, resources.getDimensionPixelSize(C0641R.dimen.fastscroll_default_thickness), resources.getDimensionPixelSize(C0641R.dimen.fastscroll_minimum_range), resources.getDimensionPixelOffset(C0641R.dimen.fastscroll_margin));
    }
    ...
    public static abstract class SmoothScroller {
        ...
        public void start(RecyclerView recyclerView, LayoutManager layoutManager) {
            if (this.mStarted) {
                SystemUtils.log(5, RecyclerView.TAG, "An instance of " + getClass().getSimpleName() + " was started " + "more than once. Each instance of" + getClass().getSimpleName() + " " + "is intended to only be used once. You should create a new instance for " + "each use.", (Throwable) null, "androidx.recyclerview.widget.RecyclerView$SmoothScroller", 11525);
            }
            this.mRecyclerView = recyclerView;
        ...
        public PointF computeScrollVectorForPosition(int i) {
            ...
            SystemUtils.log(5, RecyclerView.TAG, "You should override computeScrollVectorForPosition when the LayoutManager does not implement " + ScrollVectorProvider.class.getCanonicalName(), (Throwable) null, "androidx.recyclerview.widget.RecyclerView$SmoothScroller", 11567);
            return null;
        }
        ...
        public void onAnimation(int i, int i2) {
            ...
            if (view != null) {
                if (getChildPosition(view) == this.mTargetPosition) {
                    ...
                    SystemUtils.log(6, RecyclerView.TAG, "Passed over target position while smooth scrolling.", (Throwable) null, "androidx.recyclerview.widget.RecyclerView$SmoothScroller", 11667);
                    this.mTargetView = null;
                }
            }
            if (this.mRunning) {
        ...
        public static class Action {
            ...
            public void runIfNecessary(RecyclerView recyclerView) {
                ...
                if (i >= 0) {
                    ...
                    if (i2 > 10) {
                        SystemUtils.log(6, RecyclerView.TAG, "Smooth Scroll action is being updated too frequently. Make sure you are not changing it unless necessary", (Throwable) null, "androidx.recyclerview.widget.RecyclerView$SmoothScroller$Action", 11879);
                    }
                    this.mChanged = false;
                } else {
                    this.mConsecutiveUpdates = 0;
