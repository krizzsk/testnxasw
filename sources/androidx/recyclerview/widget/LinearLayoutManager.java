...
public class LinearLayoutManager extends RecyclerView.LayoutManager implements ItemTouchHelper.ViewDropHandler, RecyclerView.SmoothScroller.ScrollVectorProvider {
    ...
    private void logChildren() {
        SystemUtils.log(3, TAG, "internal representation of views on the screen", (Throwable) null, "androidx.recyclerview.widget.LinearLayoutManager", 2024);
        for (int i = 0; i < getChildCount(); i++) {
            View childAt = getChildAt(i);
            SystemUtils.log(3, TAG, "item " + getPosition(childAt) + ", coord:" + this.mOrientationHelper.getDecoratedStart(childAt), (Throwable) null, "androidx.recyclerview.widget.LinearLayoutManager", 2027);
        }
        SystemUtils.log(3, TAG, "==============", (Throwable) null, "androidx.recyclerview.widget.LinearLayoutManager", 2030);
    }

    /* access modifiers changed from: package-private */
    public void validateChildOrder() {
        SystemUtils.log(3, TAG, "validating child count " + getChildCount(), (Throwable) null, "androidx.recyclerview.widget.LinearLayoutManager", 2044);
        boolean z = true;
        if (getChildCount() >= 1) {
            int position = getPosition(getChildAt(0));
    ...
    static class LayoutState {
        ...
        /* access modifiers changed from: package-private */
        public void log() {
            SystemUtils.log(3, TAG, "avail:" + this.mAvailable + ", ind:" + this.mCurrentPosition + ", dir:" + this.mItemDirection + ", offset:" + this.mOffset + ", layoutDir:" + this.mLayoutDirection, (Throwable) null, "androidx.recyclerview.widget.LinearLayoutManager$LayoutState", 2302);
        }
    }
