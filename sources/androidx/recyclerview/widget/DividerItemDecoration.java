...
public class DividerItemDecoration extends RecyclerView.ItemDecoration {
    ...
    public DividerItemDecoration(Context context, int i) {
        ...
        if (drawable == null) {
            SystemUtils.log(5, TAG, "@android:attr/listDivider was not set in the theme used for this DividerItemDecoration. Please set that attribute all call setDrawable()", (Throwable) null, "androidx.recyclerview.widget.DividerItemDecoration", 69);
        }
