...
public class GridLayoutManager extends LinearLayoutManager {
    ...
    private int getSpanGroupIndex(RecyclerView.Recycler recycler, RecyclerView.State state, int i) {
        ...
        SystemUtils.log(5, TAG, "Cannot find span size for pre layout position. " + i, (Throwable) null, "androidx.recyclerview.widget.GridLayoutManager", 460);
        return 0;
    }
    ...
    private int getSpanIndex(RecyclerView.Recycler recycler, RecyclerView.State state, int i) {
        ...
        SystemUtils.log(5, TAG, "Cannot find span size for pre layout position. It is not cached, not in the adapter. Pos:" + i, (Throwable) null, "androidx.recyclerview.widget.GridLayoutManager", 480);
        return 0;
    }
    ...
    private int getSpanSize(RecyclerView.Recycler recycler, RecyclerView.State state, int i) {
        ...
        SystemUtils.log(5, TAG, "Cannot find span size for pre layout position. It is not cached, not in the adapter. Pos:" + i, (Throwable) null, "androidx.recyclerview.widget.GridLayoutManager", 501);
        return 1;
    }
    ...
    public void layoutChunk(RecyclerView.Recycler recycler, RecyclerView.State state, LinearLayoutManager.LayoutState layoutState, LinearLayoutManager.LayoutChunkResult layoutChunkResult) {
        ...
        for (int i20 = 0; i20 < i16; i20++) {
            ...
            if (this.mOrientationHelper.getDecoratedMeasurement(view3) != i17) {
                ...
                if (this.mOrientation == 1) {
                    i10 = getChildMeasureSpec(spaceForSpanRange, 1073741824, i22, layoutParams.width, false);
                    ...
                    i9 = getChildMeasureSpec(spaceForSpanRange, 1073741824, i21, layoutParams.height, false);
                    i10 = makeMeasureSpec;
                }
