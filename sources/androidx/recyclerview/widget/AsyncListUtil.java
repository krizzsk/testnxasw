...
public class AsyncListUtil<T> {
    ...
    private final ThreadUtil.BackgroundCallback<T> mBackgroundCallback = new ThreadUtil.BackgroundCallback<T>() {
        ...
        private void log(String str, Object... objArr) {
            SystemUtils.log(3, AsyncListUtil.TAG, "[BKGR] " + String.format(str, objArr), (Throwable) null, "androidx.recyclerview.widget.AsyncListUtil$2", 441);
        }
    };
    ...
    private final ThreadUtil.MainThreadCallback<T> mMainThreadCallback = new ThreadUtil.MainThreadCallback<T>() {
        ...
        public void addTile(int i, TileList.Tile<T> tile) {
            ...
            if (addOrReplace != null) {
                SystemUtils.log(6, AsyncListUtil.TAG, "duplicate tile @" + addOrReplace.mStartPosition, (Throwable) null, "androidx.recyclerview.widget.AsyncListUtil$1", 242);
        ...
        public void removeTile(int i, int i2) {
            if (isRequestedGeneration(i)) {
                ...
                if (removeAtPos == null) {
                    SystemUtils.log(6, AsyncListUtil.TAG, "tile not found @" + i2, (Throwable) null, "androidx.recyclerview.widget.AsyncListUtil$1", 269);
                    return;
                }
    ...
    public void log(String str, Object... objArr) {
        SystemUtils.log(3, TAG, "[MAIN] " + String.format(str, objArr), (Throwable) null, "androidx.recyclerview.widget.AsyncListUtil", 79);
    }
