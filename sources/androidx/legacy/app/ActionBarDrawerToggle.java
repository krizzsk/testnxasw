        ...
        if (delegate != null) {
            ...
            if (this.mSetIndicatorInfo.mSetHomeAsUpIndicator != null) {
                try {
                    ...
                    SystemUtils.log(5, TAG, "Couldn't set home-as-up indicator via JB-MR2 API", e, "androidx.legacy.app.ActionBarDrawerToggle", 462);
                }
            } else if (this.mSetIndicatorInfo.mUpIndicatorView != null) {
                this.mSetIndicatorInfo.mUpIndicatorView.setImageDrawable(drawable);
            } else {
                SystemUtils.log(5, TAG, "Couldn't set home-as-up indicator", (Throwable) null, "androidx.legacy.app.ActionBarDrawerToggle", 467);
            }
        }
    }
        ...
        if (delegate != null) {
            ...
            if (this.mSetIndicatorInfo.mSetHomeAsUpIndicator != null) {
                try {
                    ...
                    SystemUtils.log(5, TAG, "Couldn't set content description via JB-MR2 API", e, "androidx.legacy.app.ActionBarDrawerToggle", 495);
                }
            }
        }
    }
