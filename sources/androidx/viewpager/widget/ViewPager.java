...
public class ViewPager extends ViewGroup {
    ...
    public void setOffscreenPageLimit(int i) {
        if (i < 1) {
            SystemUtils.log(5, TAG, "Requested offscreen page limit " + i + " too small; defaulting to " + 1, (Throwable) null, "androidx.viewpager.widget.ViewPager", 850);
            i = 1;
        }
    ...
    public boolean arrowScroll(int r12) {
        ...
        L_0x004e:
            ...
            r5 = 6
            r8 = 0
            r10 = 2813(0xafd, float:3.942E-42)
            java.lang.String r6 = "ViewPager"
            java.lang.String r9 = "androidx.viewpager.widget.ViewPager"
            com.didi.sdk.apm.SystemUtils.log(r5, r6, r7, r8, r9, r10)
            goto L_0x0009
        L_0x006f:
            android.view.FocusFinder r3 = android.view.FocusFinder.getInstance()
            android.view.View r3 = r3.findNextFocus(r11, r0, r12)
            r4 = 66
            r5 = 17
            ...
            android.graphics.Rect r1 = r11.getChildRectInPagerCoordinates(r1, r3)
            int r1 = r1.left
            android.graphics.Rect r2 = r11.mTempRect
            android.graphics.Rect r2 = r11.getChildRectInPagerCoordinates(r2, r0)
            int r2 = r2.left
            if (r0 == 0) goto L_0x009a
            if (r1 < r2) goto L_0x009a
            boolean r0 = r11.pageLeft()
            goto L_0x009e
        L_0x009a:
        ...
        L_0x00ca:
            boolean r2 = r11.pageRight()
            goto L_0x00d3
        L_0x00cf:
            boolean r2 = r11.pageLeft()
        L_0x00d3:
            if (r2 == 0) goto L_0x00dc
            int r12 = android.view.SoundEffectConstants.getContantForFocusDirection(r12)
