...
public class MenuPopupWindow extends ListPopupWindow implements MenuItemHoverListener {
    ...
    static {
        try {
            ...
            SystemUtils.log(4, TAG, "Could not find method setTouchModal() on PopupWindow. Oh well.", (Throwable) null, "androidx.appcompat.widget.MenuPopupWindow", 66);
        }
    }
        ...
        if (Build.VERSION.SDK_INT <= 28) {
            ...
            if (method != null) {
                try {
                    ...
                    SystemUtils.log(4, TAG, "Could not invoke setTouchModal() on PopupWindow. Oh well.", (Throwable) null, "androidx.appcompat.widget.MenuPopupWindow", 111);
                }
            }
        } else {
