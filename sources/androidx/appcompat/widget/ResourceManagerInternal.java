...
public final class ResourceManagerInternal {
    ...
    private static void installDefaultInflateDelegates(ResourceManagerInternal resourceManagerInternal) {
        if (Build.VERSION.SDK_INT < 24) {
            ...
            resourceManagerInternal.addDelegate(RConfigConstants.TYPE_DRAWABLE, new DrawableDelegate());
        }
    }
    ...
    private android.graphics.drawable.Drawable loadDrawableFromDelegates(android.content.Context r14, int r15) {
        /*
            r13 = this;
            androidx.collection.SimpleArrayMap<java.lang.String, androidx.appcompat.widget.ResourceManagerInternal$InflateDelegate> r0 = r13.mDelegates
            r1 = 0
            if (r0 == 0) goto L_0x00ba
            boolean r0 = r0.isEmpty()
            if (r0 != 0) goto L_0x00ba
            androidx.collection.SparseArrayCompat<java.lang.String> r0 = r13.mKnownDrawableIdTags
            ...
            androidx.collection.SimpleArrayMap<java.lang.String, androidx.appcompat.widget.ResourceManagerInternal$InflateDelegate> r3 = r13.mDelegates
        ...
        L_0x0028:
            ...
            r0.<init>()
            r13.mKnownDrawableIdTags = r0
        L_0x002f:
            android.util.TypedValue r0 = r13.mTypedValue
        ...
        L_0x003a:
            ...
            r3 = 1
            r1.getValue(r15, r0, r3)
            long r4 = createCacheKey(r0)
            android.graphics.drawable.Drawable r6 = r13.getCachedDrawable(r14, r4)
        ...
        L_0x004f:
            ...
            if (r7 == 0) goto L_0x00b2
            android.content.res.XmlResourceParser r1 = r1.getXml(r15)     // Catch:{ Exception -> 0x00a4 }
        ...
        L_0x0073:
            ...
            androidx.collection.SparseArrayCompat<java.lang.String> r8 = r13.mKnownDrawableIdTags     // Catch:{ Exception -> 0x00a4 }
            r8.append(r15, r3)     // Catch:{ Exception -> 0x00a4 }
            androidx.collection.SimpleArrayMap<java.lang.String, androidx.appcompat.widget.ResourceManagerInternal$InflateDelegate> r8 = r13.mDelegates     // Catch:{ Exception -> 0x00a4 }
            ...
            android.content.res.Resources$Theme r8 = r14.getTheme()     // Catch:{ Exception -> 0x00a4 }
            android.graphics.drawable.Drawable r1 = r3.createFromXmlInner(r14, r1, r7, r8)     // Catch:{ Exception -> 0x00a4 }
            r6 = r1
        L_0x0091:
            if (r6 == 0) goto L_0x00b2
            int r0 = r0.changingConfigurations     // Catch:{ Exception -> 0x00a4 }
            r6.setChangingConfigurations(r0)     // Catch:{ Exception -> 0x00a4 }
            r13.addDrawableToCache(r14, r4, r6)     // Catch:{ Exception -> 0x00a4 }
            goto L_0x00b2
        L_0x009c:
            org.xmlpull.v1.XmlPullParserException r14 = new org.xmlpull.v1.XmlPullParserException     // Catch:{ Exception -> 0x00a4 }
            java.lang.String r0 = "No start tag found"
            r14.<init>(r0)     // Catch:{ Exception -> 0x00a4 }
        ...
        L_0x00a4:
            ...
            java.lang.String r9 = "Exception while inflating drawable"
            java.lang.String r11 = "androidx.appcompat.widget.ResourceManagerInternal"
            com.didi.sdk.apm.SystemUtils.log(r7, r8, r9, r10, r11, r12)
        L_0x00b2:
            if (r6 != 0) goto L_0x00b9
            androidx.collection.SparseArrayCompat<java.lang.String> r14 = r13.mKnownDrawableIdTags
            r14.append(r15, r2)
        L_0x00b9:
            return r6
        L_0x00ba:
    ...
    static void tintDrawable(Drawable drawable, TintInfo tintInfo, int[] iArr) {
        ...
        SystemUtils.log(3, TAG, "Mutated drawable is not the same instance as the input.", (Throwable) null, "androidx.appcompat.widget.ResourceManagerInternal", 441);
    }
    ...
    private void checkVectorDrawableSetup(Context context) {
        if (!this.mHasCheckedVectorDrawableSetup) {
            ...
            Drawable drawable = getDrawable(context, C0126R.C0128drawable.abc_vector_test);
    ...
    private static class VdcInflateDelegate implements InflateDelegate {
        ...
        public Drawable createFromXmlInner(Context context, XmlPullParser xmlPullParser, AttributeSet attributeSet, Resources.Theme theme) {
            try {
                ...
                SystemUtils.log(6, "VdcInflateDelegate", "Exception while inflating <vector>", e, "androidx.appcompat.widget.ResourceManagerInternal$VdcInflateDelegate", 516);
                return null;
            }
        }
    }
    ...
    private static class AvdcInflateDelegate implements InflateDelegate {
        ...
        public Drawable createFromXmlInner(Context context, XmlPullParser xmlPullParser, AttributeSet attributeSet, Resources.Theme theme) {
            try {
                ...
                SystemUtils.log(6, "AvdcInflateDelegate", "Exception while inflating <animated-vector>", e, "androidx.appcompat.widget.ResourceManagerInternal$AvdcInflateDelegate", 533);
                return null;
            }
        }
    }
    ...
    static class AsldcInflateDelegate implements InflateDelegate {
        ...
        public Drawable createFromXmlInner(Context context, XmlPullParser xmlPullParser, AttributeSet attributeSet, Resources.Theme theme) {
            try {
                ...
                SystemUtils.log(6, "AsldcInflateDelegate", "Exception while inflating <animated-selector>", e, "androidx.appcompat.widget.ResourceManagerInternal$AsldcInflateDelegate", 547);
                return null;
            }
        }
    }
        ...
        public Drawable createFromXmlInner(Context context, XmlPullParser xmlPullParser, AttributeSet attributeSet, Resources.Theme theme) {
            ...
            if (classAttribute != null) {
                try {
                    ...
                    SystemUtils.log(6, "DrawableDelegate", "Exception while inflating <drawable>", e, "androidx.appcompat.widget.ResourceManagerInternal$DrawableDelegate", 571);
                }
            }
            return null;
        }
