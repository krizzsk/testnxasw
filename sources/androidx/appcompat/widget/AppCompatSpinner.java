...
public class AppCompatSpinner extends Spinner implements TintableBackgroundView {
    ...
    public AppCompatSpinner(Context context, int i) {
        this(context, (AttributeSet) null, C0087R.attr.spinnerStyle, i);
    }

    public AppCompatSpinner(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, C0087R.attr.spinnerStyle);
    }
    ...
    public AppCompatSpinner(android.content.Context r10, android.util.AttributeSet r11, int r12, int r13, android.content.res.Resources.Theme r14) {
        /*
            ...
            int[] r0 = androidx.appcompat.C0087R.styleable.Spinner
            r1 = 0
            androidx.appcompat.widget.TintTypedArray r0 = androidx.appcompat.widget.TintTypedArray.obtainStyledAttributes(r10, r11, r0, r12, r1)
            androidx.appcompat.widget.AppCompatBackgroundHelper r2 = new androidx.appcompat.widget.AppCompatBackgroundHelper
            r2.<init>(r9)
            r9.mBackgroundTintHelper = r2
            if (r14 == 0) goto L_0x0029
            androidx.appcompat.view.ContextThemeWrapper r2 = new androidx.appcompat.view.ContextThemeWrapper
            r2.<init>((android.content.Context) r10, (android.content.res.Resources.Theme) r14)
            r9.mPopupContext = r2
            goto L_0x003b
        L_0x0029:
            int r14 = androidx.appcompat.C0087R.styleable.Spinner_popupTheme
            int r14 = r0.getResourceId(r14, r1)
            if (r14 == 0) goto L_0x0039
            androidx.appcompat.view.ContextThemeWrapper r2 = new androidx.appcompat.view.ContextThemeWrapper
            r2.<init>((android.content.Context) r10, (int) r14)
            r9.mPopupContext = r2
            goto L_0x003b
        L_0x0039:
        ...
        L_0x003b:
            ...
            int[] r14 = ATTRS_ANDROID_SPINNERMODE     // Catch:{ Exception -> 0x0059, all -> 0x0057 }
            android.content.res.TypedArray r14 = r10.obtainStyledAttributes(r11, r14, r12, r1)     // Catch:{ Exception -> 0x0059, all -> 0x0057 }
            boolean r3 = r14.hasValue(r1)     // Catch:{ Exception -> 0x0055 }
            if (r3 == 0) goto L_0x004f
            int r13 = r14.getInt(r1, r1)     // Catch:{ Exception -> 0x0055 }
        L_0x004f:
        ...
        L_0x005b:
            ...
            r3 = 4
            java.lang.String r7 = "androidx.appcompat.widget.AppCompatSpinner"
            r8 = 238(0xee, float:3.34E-43)
            com.didi.sdk.apm.SystemUtils.log(r3, r4, r5, r6, r7, r8)     // Catch:{ all -> 0x006b }
            if (r14 == 0) goto L_0x0073
            goto L_0x0051
        L_0x006b:
            r10 = move-exception
        ...
        L_0x0079:
            ...
            android.content.Context r3 = r9.mPopupContext
            r13.<init>(r3, r11, r12)
            android.content.Context r3 = r9.mPopupContext
            int[] r4 = androidx.appcompat.C0087R.styleable.Spinner
            androidx.appcompat.widget.TintTypedArray r1 = androidx.appcompat.widget.TintTypedArray.obtainStyledAttributes(r3, r11, r4, r12, r1)
            int r3 = androidx.appcompat.C0087R.styleable.Spinner_android_dropDownWidth
            r4 = -2
            int r3 = r1.getLayoutDimension((int) r3, (int) r4)
            r9.mDropDownWidth = r3
            int r3 = androidx.appcompat.C0087R.styleable.Spinner_android_popupBackground
            android.graphics.drawable.Drawable r3 = r1.getDrawable(r3)
            r13.setBackgroundDrawable(r3)
            int r3 = androidx.appcompat.C0087R.styleable.Spinner_android_prompt
            java.lang.String r3 = r0.getString(r3)
            r13.setPromptText(r3)
            r1.recycle()
            r9.mPopup = r13
        ...
        L_0x00b0:
            ...
            r13.<init>()
            r9.mPopup = r13
            int r1 = androidx.appcompat.C0087R.styleable.Spinner_android_prompt
            java.lang.String r1 = r0.getString(r1)
            r13.setPromptText(r1)
        L_0x00c0:
            int r13 = androidx.appcompat.C0087R.styleable.Spinner_android_entries
            java.lang.CharSequence[] r13 = r0.getTextArray(r13)
            if (r13 == 0) goto L_0x00d8
            android.widget.ArrayAdapter r1 = new android.widget.ArrayAdapter
            r3 = 17367048(0x1090008, float:2.5162948E-38)
            r1.<init>(r10, r3, r13)
            int r10 = androidx.appcompat.C0087R.C0093layout.support_simple_spinner_dropdown_item
        ...
        L_0x00d8:
            ...
            r9.mTempAdapter = r2
        L_0x00e6:
            androidx.appcompat.widget.AppCompatBackgroundHelper r10 = r9.mBackgroundTintHelper
    ...
    class DialogPopup implements DialogInterface.OnClickListener, SpinnerPopup {
        ...
        public void show(int i, int i2) {
            if (this.mListAdapter != null) {
                ...
                SystemUtils.showDialog(this.mPopup);
            }
        }
        ...
        public void setBackgroundDrawable(Drawable drawable) {
            SystemUtils.log(6, AppCompatSpinner.TAG, "Cannot set popup background for MODE_DIALOG, ignoring", (Throwable) null, "androidx.appcompat.widget.AppCompatSpinner$DialogPopup", 922);
        }

        public void setVerticalOffset(int i) {
            SystemUtils.log(6, AppCompatSpinner.TAG, "Cannot set vertical offset for MODE_DIALOG, ignoring", (Throwable) null, "androidx.appcompat.widget.AppCompatSpinner$DialogPopup", 927);
        }

        public void setHorizontalOffset(int i) {
            SystemUtils.log(6, AppCompatSpinner.TAG, "Cannot set horizontal offset for MODE_DIALOG, ignoring", (Throwable) null, "androidx.appcompat.widget.AppCompatSpinner$DialogPopup", 932);
        }

        public void setHorizontalOriginalOffset(int i) {
            SystemUtils.log(6, AppCompatSpinner.TAG, "Cannot set horizontal (original) offset for MODE_DIALOG, ignoring", (Throwable) null, "androidx.appcompat.widget.AppCompatSpinner$DialogPopup", 952);
        }
    }
    ...
    class DropdownPopup extends ListPopupWindow implements SpinnerPopup {
        ...
        public void show(int i, int i2) {
            ...
            if (!isShowing && (viewTreeObserver = AppCompatSpinner.this.getViewTreeObserver()) != null) {
                final C01582 r6 = new ViewTreeObserver.OnGlobalLayoutListener() {
                    public void onGlobalLayout() {
