...
class SuggestionsAdapter extends ResourceCursorAdapter implements View.OnClickListener {
    ...
    public Cursor runQueryOnBackgroundThread(CharSequence charSequence) {
        ...
        if (this.mSearchView.getVisibility() == 0 && this.mSearchView.getWindowVisibility() == 0) {
            try {
                ...
                SystemUtils.log(5, LOG_TAG, "Search suggestions query threw an exception.", e, "androidx.appcompat.widget.SuggestionsAdapter", 163);
            }
        }
        return null;
    }
    ...
    public void changeCursor(Cursor cursor) {
        if (this.mClosed) {
            SystemUtils.log(5, LOG_TAG, "Tried to change cursor after adapter was closed.", (Throwable) null, "androidx.appcompat.widget.SuggestionsAdapter", 216);
            if (cursor != null) {
                cursor.close();
                return;
            }
        ...
        try {
            ...
            SystemUtils.log(6, LOG_TAG, "error changing cursor and caching columns", e, "androidx.appcompat.widget.SuggestionsAdapter", 233);
        }
    }
    ...
    public View newView(Context context, Cursor cursor, ViewGroup viewGroup) {
        ...
        ((ImageView) newView.findViewById(C0087R.C0091id.edit_query)).setImageResource(this.mCommitIconResId);
        return newView;
    }
    ...
    private static final class ChildViewCache {
        ...
        public ChildViewCache(View view) {
            ...
            this.mIconRefine = (ImageView) view.findViewById(C0087R.C0091id.edit_query);
        }
    }
    ...
    private CharSequence formatUrl(CharSequence charSequence) {
        if (this.mUrlColor == null) {
            ...
            this.mProviderContext.getTheme().resolveAttribute(C0087R.attr.textColorSearchUrl, typedValue, true);
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        try {
            ...
            SystemUtils.log(5, LOG_TAG, "Search suggestions cursor threw exception.", e, "androidx.appcompat.widget.SuggestionsAdapter", 451);
    ...
    public View getDropDownView(int i, View view, ViewGroup viewGroup) {
        try {
            ...
            SystemUtils.log(5, LOG_TAG, "Search suggestions cursor threw exception.", e, "androidx.appcompat.widget.SuggestionsAdapter", 474);
    ...
    private Drawable getDrawableFromResourceValue(String str) {
        ...
        try {
            ...
            SystemUtils.log(5, LOG_TAG, "Icon resource not found: " + str, (Throwable) null, "androidx.appcompat.widget.SuggestionsAdapter", 537);
            return null;
        }
    }
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:9:0x002a, code lost:
        throw new java.io.FileNotFoundException("Resource does not exist: " + r11);
     */
    /* JADX WARNING: Missing exception handler attribute for start block: B:7:0x0014 */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    private android.graphics.drawable.Drawable getDrawable(android.net.Uri r11) {
        /*
            r10 = this;
            java.lang.String r0 = "Error closing icon stream for "
            r1 = 0
            java.lang.String r2 = r11.getScheme()     // Catch:{ FileNotFoundException -> 0x0091 }
            java.lang.String r3 = "android.resource"
            boolean r2 = r3.equals(r2)     // Catch:{ FileNotFoundException -> 0x0091 }
            if (r2 == 0) goto L_0x002b
            android.graphics.drawable.Drawable r11 = r10.getDrawableFromResourceUri(r11)     // Catch:{ NotFoundException -> 0x0014 }
            return r11
        L_0x0014:
            java.io.FileNotFoundException r0 = new java.io.FileNotFoundException     // Catch:{ FileNotFoundException -> 0x0091 }
            java.lang.StringBuilder r2 = new java.lang.StringBuilder     // Catch:{ FileNotFoundException -> 0x0091 }
            r2.<init>()     // Catch:{ FileNotFoundException -> 0x0091 }
            java.lang.String r3 = "Resource does not exist: "
            r2.append(r3)     // Catch:{ FileNotFoundException -> 0x0091 }
            r2.append(r11)     // Catch:{ FileNotFoundException -> 0x0091 }
            java.lang.String r2 = r2.toString()     // Catch:{ FileNotFoundException -> 0x0091 }
            r0.<init>(r2)     // Catch:{ FileNotFoundException -> 0x0091 }
            throw r0     // Catch:{ FileNotFoundException -> 0x0091 }
        L_0x002b:
            android.content.Context r2 = r10.mProviderContext     // Catch:{ FileNotFoundException -> 0x0091 }
            android.content.ContentResolver r2 = r2.getContentResolver()     // Catch:{ FileNotFoundException -> 0x0091 }
            java.io.InputStream r2 = r2.openInputStream(r11)     // Catch:{ FileNotFoundException -> 0x0091 }
            if (r2 == 0) goto L_0x007a
            android.graphics.drawable.Drawable r3 = android.graphics.drawable.Drawable.createFromStream(r2, r1)     // Catch:{ all -> 0x005a }
        ...
        L_0x003f:
            ...
            java.lang.StringBuilder r2 = new java.lang.StringBuilder     // Catch:{ FileNotFoundException -> 0x0091 }
            r2.<init>()     // Catch:{ FileNotFoundException -> 0x0091 }
            r2.append(r0)     // Catch:{ FileNotFoundException -> 0x0091 }
            r2.append(r11)     // Catch:{ FileNotFoundException -> 0x0091 }
            java.lang.String r6 = r2.toString()     // Catch:{ FileNotFoundException -> 0x0091 }
            r4 = 6
            java.lang.String r8 = "androidx.appcompat.widget.SuggestionsAdapter"
            r9 = 569(0x239, float:7.97E-43)
            com.didi.sdk.apm.SystemUtils.log(r4, r5, r6, r7, r8, r9)     // Catch:{ FileNotFoundException -> 0x0091 }
        L_0x0059:
            return r3
        L_0x005a:
            r3 = move-exception
        ...
        L_0x005f:
            ...
            com.didi.sdk.apm.SystemUtils.log(r4, r5, r6, r7, r8, r9)     // Catch:{ FileNotFoundException -> 0x0091 }
        L_0x0079:
            throw r3     // Catch:{ FileNotFoundException -> 0x0091 }
        L_0x007a:
            java.io.FileNotFoundException r0 = new java.io.FileNotFoundException     // Catch:{ FileNotFoundException -> 0x0091 }
            java.lang.StringBuilder r2 = new java.lang.StringBuilder     // Catch:{ FileNotFoundException -> 0x0091 }
            r2.<init>()     // Catch:{ FileNotFoundException -> 0x0091 }
        ...
        L_0x0091:
            ...
            java.lang.String r7 = "androidx.appcompat.widget.SuggestionsAdapter"
    ...
    private Drawable getActivityIcon(ComponentName componentName) {
        ...
        try {
            ...
            SystemUtils.log(5, LOG_TAG, "Invalid icon resource " + iconResource + " for " + componentName.flattenToShortString(), (Throwable) null, "androidx.appcompat.widget.SuggestionsAdapter", 658);
            return null;
        } catch (PackageManager.NameNotFoundException e) {
            SystemUtils.log(5, LOG_TAG, e.toString(), (Throwable) null, "androidx.appcompat.widget.SuggestionsAdapter", 650);
            return null;
        }
    }
    ...
    private static String getStringOrNull(Cursor cursor, int i) {
        ...
        try {
            ...
            SystemUtils.log(6, LOG_TAG, "unexpected error retrieving valid column from cursor, did the remote process die?", e, "androidx.appcompat.widget.SuggestionsAdapter", 685);
            return null;
        }
    }
