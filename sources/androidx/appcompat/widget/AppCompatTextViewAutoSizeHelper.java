...
class AppCompatTextViewAutoSizeHelper {
    ...
    public void loadFromAttributes(AttributeSet attributeSet, int i) {
        int resourceId;
        TypedArray obtainStyledAttributes = this.mContext.obtainStyledAttributes(attributeSet, C0087R.styleable.AppCompatTextView, i, 0);
        TextView textView = this.mTextView;
        ViewCompat.saveAttributeDataForStyleable(textView, textView.getContext(), C0087R.styleable.AppCompatTextView, attributeSet, obtainStyledAttributes, i, 0);
        if (obtainStyledAttributes.hasValue(C0087R.styleable.AppCompatTextView_autoSizeTextType)) {
            this.mAutoSizeTextType = obtainStyledAttributes.getInt(C0087R.styleable.AppCompatTextView_autoSizeTextType, 0);
        }
        float dimension = obtainStyledAttributes.hasValue(C0087R.styleable.AppCompatTextView_autoSizeStepGranularity) ? obtainStyledAttributes.getDimension(C0087R.styleable.AppCompatTextView_autoSizeStepGranularity, -1.0f) : -1.0f;
        float dimension2 = obtainStyledAttributes.hasValue(C0087R.styleable.AppCompatTextView_autoSizeMinTextSize) ? obtainStyledAttributes.getDimension(C0087R.styleable.AppCompatTextView_autoSizeMinTextSize, -1.0f) : -1.0f;
        float dimension3 = obtainStyledAttributes.hasValue(C0087R.styleable.AppCompatTextView_autoSizeMaxTextSize) ? obtainStyledAttributes.getDimension(C0087R.styleable.AppCompatTextView_autoSizeMaxTextSize, -1.0f) : -1.0f;
        if (obtainStyledAttributes.hasValue(C0087R.styleable.AppCompatTextView_autoSizePresetSizes) && (resourceId = obtainStyledAttributes.getResourceId(C0087R.styleable.AppCompatTextView_autoSizePresetSizes, 0)) > 0) {
        ...
        if (f != this.mTextView.getPaint().getTextSize()) {
            ...
            if (this.mTextView.getLayout() != null) {
                ...
                try {
                    ...
                    SystemUtils.log(5, TAG, "Failed to invoke TextView#nullLayouts() method", e, "androidx.appcompat.widget.AppCompatTextViewAutoSizeHelper", 678);
                }
                if (!isInLayout) {
    ...
    private StaticLayout createStaticLayoutForMeasuring(CharSequence charSequence, Layout.Alignment alignment, int i, int i2) {
        ...
        try {
            ...
            SystemUtils.log(5, TAG, "Failed to obtain TextDirectionHeuristic, auto size may be incorrect", (Throwable) null, "androidx.appcompat.widget.AppCompatTextViewAutoSizeHelper", 797);
        }
        return obtain.build();
    }
    ...
    static <T> T invokeAndReturnWithDefault(Object obj, String str, T t) {
        ...
        try {
            ...
            Exception exc = e;
            SystemUtils.log(5, TAG, "Failed to invoke TextView#" + str + "() method", exc, "androidx.appcompat.widget.AppCompatTextViewAutoSizeHelper", 850);
            return t;
        } catch (Throwable th2) {
            th = th2;
        }
    ...
    private static <T> T accessAndReturnWithDefault(Object obj, String str, T t) {
        try {
            ...
            SystemUtils.log(5, TAG, "Failed to access TextView#" + str + " member", illegalAccessException, "androidx.appcompat.widget.AppCompatTextViewAutoSizeHelper", 871);
            return t;
        }
    }
    ...
    private static Method getTextViewMethod(String str) {
        try {
            ...
            Exception exc = e;
            SystemUtils.log(5, TAG, "Failed to retrieve TextView#" + str + "() method", exc, "androidx.appcompat.widget.AppCompatTextViewAutoSizeHelper", 891);
            return null;
        }
    }
    ...
    private static Field getTextViewField(String str) {
        try {
            ...
            SystemUtils.log(5, TAG, "Failed to access TextView#" + str + " member", noSuchFieldException, "androidx.appcompat.widget.AppCompatTextViewAutoSizeHelper", 910);
            return null;
        }
    }
