    ...
    public static SetIndicatorInfo setActionBarUpIndicator(Activity activity, Drawable drawable, int i) {
        ...
        if (setIndicatorInfo.setHomeAsUpIndicator != null) {
            try {
                ...
                SystemUtils.log(5, TAG, "Couldn't set home-as-up indicator via JB-MR2 API", e, "androidx.appcompat.app.ActionBarDrawerToggleHoneycomb", 58);
            }
        } else if (setIndicatorInfo.upIndicatorView != null) {
            setIndicatorInfo.upIndicatorView.setImageDrawable(drawable);
        } else {
            SystemUtils.log(5, TAG, "Couldn't set home-as-up indicator", (Throwable) null, "androidx.appcompat.app.ActionBarDrawerToggleHoneycomb", 63);
        }
    ...
    public static SetIndicatorInfo setActionBarDescription(SetIndicatorInfo setIndicatorInfo, Activity activity, int i) {
        ...
        if (setIndicatorInfo.setHomeAsUpIndicator != null) {
            try {
                ...
                SystemUtils.log(5, TAG, "Couldn't set content description via JB-MR2 API", e, "androidx.appcompat.app.ActionBarDrawerToggleHoneycomb", 83);
            }
        }
        return setIndicatorInfo;
    }
