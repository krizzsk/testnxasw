...
class AppCompatDelegateImpl extends AppCompatDelegate implements LayoutInflater.Factory2, MenuBuilder.Callback {
        ...
        if (IS_PRE_LOLLIPOP && !sInstalledExceptionHandler) {
            ...
            Thread.setDefaultUncaughtExceptionHandler(new Thread.UncaughtExceptionHandler() {
                ...
                private boolean shouldWrapException(Throwable th) {
                    ...
                    if (message.contains(RConfigConstants.TYPE_DRAWABLE) || message.contains("Drawable")) {
                        return true;
                    }
                    return false;
                }
    ...
    public Context attachBaseContext2(Context context) {
        ...
        androidx.appcompat.view.ContextThemeWrapper contextThemeWrapper = new androidx.appcompat.view.ContextThemeWrapper(context, C0087R.C0094style.Theme_AppCompat_Empty);
    ...
    private ViewGroup createSubDecor() {
        ViewGroup viewGroup;
        Context context;
        TypedArray obtainStyledAttributes = this.mContext.obtainStyledAttributes(C0087R.styleable.AppCompatTheme);
        if (obtainStyledAttributes.hasValue(C0087R.styleable.AppCompatTheme_windowActionBar)) {
            if (obtainStyledAttributes.getBoolean(C0087R.styleable.AppCompatTheme_windowNoTitle, false)) {
                requestWindowFeature(1);
            } else if (obtainStyledAttributes.getBoolean(C0087R.styleable.AppCompatTheme_windowActionBar, false)) {
                requestWindowFeature(108);
            }
            if (obtainStyledAttributes.getBoolean(C0087R.styleable.AppCompatTheme_windowActionBarOverlay, false)) {
                requestWindowFeature(109);
            }
            if (obtainStyledAttributes.getBoolean(C0087R.styleable.AppCompatTheme_windowActionModeOverlay, false)) {
                requestWindowFeature(10);
            }
            this.mIsFloating = obtainStyledAttributes.getBoolean(C0087R.styleable.AppCompatTheme_android_windowIsFloating, false);
            obtainStyledAttributes.recycle();
            ensureWindow();
            this.mWindow.getDecorView();
            LayoutInflater from = LayoutInflater.from(this.mContext);
            if (this.mWindowNoTitle) {
                viewGroup = this.mOverlayActionMode ? (ViewGroup) from.inflate(C0087R.C0093layout.abc_screen_simple_overlay_action_mode, (ViewGroup) null) : (ViewGroup) from.inflate(C0087R.C0093layout.abc_screen_simple, (ViewGroup) null);
            } else if (this.mIsFloating) {
                viewGroup = (ViewGroup) from.inflate(C0087R.C0093layout.abc_dialog_title_material, (ViewGroup) null);
                this.mOverlayActionBar = false;
                this.mHasActionBar = false;
            } else if (this.mHasActionBar) {
                TypedValue typedValue = new TypedValue();
                this.mContext.getTheme().resolveAttribute(C0087R.attr.actionBarTheme, typedValue, true);
                if (typedValue.resourceId != 0) {
                    context = new androidx.appcompat.view.ContextThemeWrapper(this.mContext, typedValue.resourceId);
                } else {
                    context = this.mContext;
                }
                viewGroup = (ViewGroup) LayoutInflater.from(context).inflate(C0087R.C0093layout.abc_screen_toolbar, (ViewGroup) null);
                DecorContentParent decorContentParent = (DecorContentParent) viewGroup.findViewById(C0087R.C0091id.decor_content_parent);
            ...
            if (viewGroup != null) {
                ...
                if (this.mDecorContentParent == null) {
                    this.mTitleView = (TextView) viewGroup.findViewById(C0087R.C0091id.title);
                }
                ViewUtils.makeOptionalFitsSystemWindows(viewGroup);
                ContentFrameLayout contentFrameLayout = (ContentFrameLayout) viewGroup.findViewById(C0087R.C0091id.action_bar_activity_content);
    ...
    private void applyFixedSizeWindow() {
        ...
        TypedArray obtainStyledAttributes = this.mContext.obtainStyledAttributes(C0087R.styleable.AppCompatTheme);
        obtainStyledAttributes.getValue(C0087R.styleable.AppCompatTheme_windowMinWidthMajor, contentFrameLayout.getMinWidthMajor());
        obtainStyledAttributes.getValue(C0087R.styleable.AppCompatTheme_windowMinWidthMinor, contentFrameLayout.getMinWidthMinor());
        if (obtainStyledAttributes.hasValue(C0087R.styleable.AppCompatTheme_windowFixedWidthMajor)) {
            obtainStyledAttributes.getValue(C0087R.styleable.AppCompatTheme_windowFixedWidthMajor, contentFrameLayout.getFixedWidthMajor());
        }
        if (obtainStyledAttributes.hasValue(C0087R.styleable.AppCompatTheme_windowFixedWidthMinor)) {
            obtainStyledAttributes.getValue(C0087R.styleable.AppCompatTheme_windowFixedWidthMinor, contentFrameLayout.getFixedWidthMinor());
        }
        if (obtainStyledAttributes.hasValue(C0087R.styleable.AppCompatTheme_windowFixedHeightMajor)) {
            obtainStyledAttributes.getValue(C0087R.styleable.AppCompatTheme_windowFixedHeightMajor, contentFrameLayout.getFixedHeightMajor());
        }
        if (obtainStyledAttributes.hasValue(C0087R.styleable.AppCompatTheme_windowFixedHeightMinor)) {
            obtainStyledAttributes.getValue(C0087R.styleable.AppCompatTheme_windowFixedHeightMinor, contentFrameLayout.getFixedHeightMinor());
        }
        obtainStyledAttributes.recycle();
    ...
    public androidx.appcompat.view.ActionMode startSupportActionModeFromWindow(androidx.appcompat.view.ActionMode.Callback r8) {
        ...
        L_0x0029:
            ...
            int r5 = androidx.appcompat.C0087R.attr.actionBarTheme
        ...
        L_0x006a:
            ...
            int r6 = androidx.appcompat.C0087R.attr.actionModePopupWindowStyle
            r5.<init>(r4, r1, r6)
            ...
            int r6 = androidx.appcompat.C0087R.attr.actionBarSize
        ...
        L_0x00b5:
            ...
            int r4 = androidx.appcompat.C0087R.C0091id.action_mode_bar_stub
    ...
    public View createView(View view, String str, Context context, AttributeSet attributeSet) {
        ...
        if (this.mAppCompatViewInflater == null) {
            String string = this.mContext.obtainStyledAttributes(C0087R.styleable.AppCompatTheme).getString(C0087R.styleable.AppCompatTheme_viewInflaterClass);
            if (string == null) {
                ...
                try {
                    ...
                    Throwable th2 = th;
                    SystemUtils.log(4, "AppCompatDelegate", "Failed to instantiate custom view inflater " + string + ". Falling back to default.", th2, "androidx.appcompat.app.AppCompatDelegateImpl", 1538);
                    this.mAppCompatViewInflater = new AppCompatViewInflater();
                }
            }
        }
    ...
    public void installViewFactory() {
        ...
        if (from.getFactory() == null) {
            ...
            SystemUtils.log(4, "AppCompatDelegate", "The Activity's LayoutInflater already has a Factory installed so we can not install AppCompat's", (Throwable) null, "androidx.appcompat.app.AppCompatDelegateImpl", 1602);
        }
    }
            ...
            if (windowCallback == null || windowCallback.onMenuOpened(panelFeatureState.featureId, panelFeatureState.menu)) {
                ...
                if (windowManager != null && preparePanel(panelFeatureState, keyEvent)) {
                    if (panelFeatureState.decorView == null || panelFeatureState.refreshDecorView) {
                        ...
                        WindowManager.LayoutParams layoutParams3 = new WindowManager.LayoutParams(i, -2, panelFeatureState.f56x, panelFeatureState.f57y, 1002, 8519680, -3);
                    ...
                    i = -2;
                    panelFeatureState.isHandled = false;
                    WindowManager.LayoutParams layoutParams32 = new WindowManager.LayoutParams(i, -2, panelFeatureState.f56x, panelFeatureState.f57y, 1002, 8519680, -3);
    ...
    private boolean initializePanelMenu(PanelFeatureState panelFeatureState) {
        ...
        if ((panelFeatureState.featureId == 0 || panelFeatureState.featureId == 108) && this.mDecorContentParent != null) {
            ...
            theme.resolveAttribute(C0087R.attr.actionBarTheme, typedValue, true);
            Resources.Theme theme2 = null;
            if (typedValue.resourceId != 0) {
                theme2 = context.getResources().newTheme();
                theme2.setTo(theme);
                theme2.applyStyle(typedValue.resourceId, true);
                theme2.resolveAttribute(C0087R.attr.actionBarWidgetTheme, typedValue, true);
            } else {
                theme.resolveAttribute(C0087R.attr.actionBarWidgetTheme, typedValue, true);
            }
            if (typedValue.resourceId != 0) {
                if (theme2 == null) {
                    theme2 = context.getResources().newTheme();
    ...
    private boolean onKeyUpPanel(int r9, android.view.KeyEvent r10) {
        ...
        L_0x0006:
            r0 = 1
            androidx.appcompat.app.AppCompatDelegateImpl$PanelFeatureState r2 = r8.getPanelState(r9, r0)
            if (r9 != 0) goto L_0x0043
            androidx.appcompat.widget.DecorContentParent r9 = r8.mDecorContentParent
            if (r9 == 0) goto L_0x0043
            boolean r9 = r9.canShowOverflowMenu()
            if (r9 == 0) goto L_0x0043
            ...
            if (r9 != 0) goto L_0x0043
            androidx.appcompat.widget.DecorContentParent r9 = r8.mDecorContentParent
            boolean r9 = r9.isOverflowMenuShowing()
            if (r9 != 0) goto L_0x003c
            boolean r9 = r8.mIsDestroyed
            if (r9 != 0) goto L_0x0062
            boolean r9 = r8.preparePanel(r2, r10)
            if (r9 == 0) goto L_0x0062
            androidx.appcompat.widget.DecorContentParent r9 = r8.mDecorContentParent
            boolean r0 = r9.showOverflowMenu()
            goto L_0x006a
        L_0x003c:
            androidx.appcompat.widget.DecorContentParent r9 = r8.mDecorContentParent
            boolean r0 = r9.hideOverflowMenu()
            goto L_0x006a
        L_0x0043:
            boolean r9 = r2.isOpen
            if (r9 != 0) goto L_0x0064
            boolean r9 = r2.isHandled
            if (r9 == 0) goto L_0x004c
            goto L_0x0064
        L_0x004c:
            boolean r9 = r2.isPrepared
            if (r9 == 0) goto L_0x0062
            boolean r9 = r2.refreshMenuContent
    ...
    private void updateStatusGuardColor(View view) {
        ...
        if ((ViewCompat.getWindowSystemUiVisibility(view) & 8192) != 0) {
            i = ContextCompat.getColor(this.mContext, C0087R.C0089color.abc_decor_view_status_guard_light);
        } else {
            i = ContextCompat.getColor(this.mContext, C0087R.C0089color.abc_decor_view_status_guard);
        }
    ...
    private int sanitizeWindowFeatureId(int i) {
        if (i == 8) {
            SystemUtils.log(4, "AppCompatDelegate", "You should now use the AppCompatDelegate.FEATURE_SUPPORT_ACTION_BAR id when requesting this feature.", (Throwable) null, "androidx.appcompat.app.AppCompatDelegateImpl", 2328);
            return 108;
        } else if (i != 9) {
            return i;
        } else {
            SystemUtils.log(4, "AppCompatDelegate", "You should now use the AppCompatDelegate.FEATURE_SUPPORT_ACTION_BAR_OVERLAY id when requesting this feature.", (Throwable) null, "androidx.appcompat.app.AppCompatDelegateImpl", 2332);
            return 109;
        }
    }
    ...
    private boolean isActivityManifestHandlingUiMode() {
        ...
        if (!this.mActivityHandlesUiModeChecked && (this.mHost instanceof Activity)) {
            ...
            try {
                ...
                SystemUtils.log(3, "AppCompatDelegate", "Exception while getting ActivityInfo", e, "androidx.appcompat.app.AppCompatDelegateImpl", 2670);
    ...
    protected static final class PanelFeatureState {
        ...
        public void setStyle(Context context) {
            ...
            newTheme.resolveAttribute(C0087R.attr.actionBarPopupTheme, typedValue, true);
            if (typedValue.resourceId != 0) {
                newTheme.applyStyle(typedValue.resourceId, true);
            }
            newTheme.resolveAttribute(C0087R.attr.panelMenuListTheme, typedValue, true);
            if (typedValue.resourceId != 0) {
                newTheme.applyStyle(typedValue.resourceId, true);
            } else {
                newTheme.applyStyle(C0087R.C0094style.Theme_AppCompat_CompactMenu, true);
            }
            androidx.appcompat.view.ContextThemeWrapper contextThemeWrapper = new androidx.appcompat.view.ContextThemeWrapper(context, 0);
            contextThemeWrapper.getTheme().setTo(newTheme);
            this.listPresenterContext = contextThemeWrapper;
            TypedArray obtainStyledAttributes = contextThemeWrapper.obtainStyledAttributes(C0087R.styleable.AppCompatTheme);
            this.background = obtainStyledAttributes.getResourceId(C0087R.styleable.AppCompatTheme_panelBackground, 0);
            this.windowAnimations = obtainStyledAttributes.getResourceId(C0087R.styleable.AppCompatTheme_android_windowAnimationStyle, 0);
            obtainStyledAttributes.recycle();
        }
        ...
        public MenuView getListMenuView(MenuPresenter.Callback callback) {
            ...
            if (this.listMenuPresenter == null) {
                ListMenuPresenter listMenuPresenter2 = new ListMenuPresenter(this.listPresenterContext, C0087R.C0093layout.abc_list_menu_item_layout);
    ...
    private class ActionBarDrawableToggleImpl implements ActionBarDrawerToggle.Delegate {
        ...
        public Drawable getThemeUpIndicator() {
            TintTypedArray obtainStyledAttributes = TintTypedArray.obtainStyledAttributes(getActionBarThemedContext(), (AttributeSet) null, new int[]{C0087R.attr.homeAsUpIndicator});
