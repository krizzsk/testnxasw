...
public class ActionBarDrawerToggle implements DrawerLayout.DrawerListener {
    ...
    public void setActionBarUpIndicator(Drawable drawable, int i) {
        if (!this.mWarnedForDisplayHomeAsUp && !this.mActivityImpl.isNavigationVisible()) {
            SystemUtils.log(5, "ActionBarDrawerToggle", "DrawerToggle may not show up because NavigationIcon is not visible. You may need to call actionbar.setDisplayHomeAsUpEnabled(true);", (Throwable) null, "androidx.appcompat.app.ActionBarDrawerToggle", 490);
