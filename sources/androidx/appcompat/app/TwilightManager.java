...
class TwilightManager {
    ...
    public boolean isNight() {
        ...
        SystemUtils.log(4, TAG, "Could not get last known location. This is probably because the app does not have any location permissions. Falling back to hardcoded sunrise/sunset values.", (Throwable) null, "androidx.appcompat.app.TwilightManager", 94);
    ...
    private Location getLastKnownLocationForProvider(String str) {
        try {
            ...
            SystemUtils.log(3, TAG, "Failed to get last known location", e, "androidx.appcompat.app.TwilightManager", 138);
            return null;
        }
    }
