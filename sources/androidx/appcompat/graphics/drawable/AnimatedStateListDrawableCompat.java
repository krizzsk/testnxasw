...
import androidx.appcompat.resources.C0126R;
...
public class AnimatedStateListDrawableCompat extends StateListDrawable implements TintAwareDrawable {
    ...
    /* JADX WARNING: Removed duplicated region for block: B:10:0x001e A[Catch:{ XmlPullParserException -> 0x0035, IOException -> 0x0026 }] */
    /* JADX WARNING: Removed duplicated region for block: B:8:0x0019 A[Catch:{ XmlPullParserException -> 0x0035, IOException -> 0x0026 }] */
    ...
    public static androidx.appcompat.graphics.drawable.AnimatedStateListDrawableCompat create(android.content.Context r6, int r7, android.content.res.Resources.Theme r8) {
        /*
            android.content.res.Resources r0 = r6.getResources()     // Catch:{ XmlPullParserException -> 0x0035, IOException -> 0x0026 }
            android.content.res.XmlResourceParser r7 = r0.getXml(r7)     // Catch:{ XmlPullParserException -> 0x0035, IOException -> 0x0026 }
            android.util.AttributeSet r1 = android.util.Xml.asAttributeSet(r7)     // Catch:{ XmlPullParserException -> 0x0035, IOException -> 0x0026 }
        L_0x000c:
            int r2 = r7.next()     // Catch:{ XmlPullParserException -> 0x0035, IOException -> 0x0026 }
            r3 = 2
        ...
        L_0x0017:
            ...
            androidx.appcompat.graphics.drawable.AnimatedStateListDrawableCompat r6 = createFromXmlInner(r6, r0, r7, r1, r8)     // Catch:{ XmlPullParserException -> 0x0035, IOException -> 0x0026 }
            return r6
        L_0x001e:
            org.xmlpull.v1.XmlPullParserException r6 = new org.xmlpull.v1.XmlPullParserException     // Catch:{ XmlPullParserException -> 0x0035, IOException -> 0x0026 }
            java.lang.String r7 = "No start tag found"
            r6.<init>(r7)     // Catch:{ XmlPullParserException -> 0x0035, IOException -> 0x0026 }
            throw r6     // Catch:{ XmlPullParserException -> 0x0035, IOException -> 0x0026 }
        L_0x0026:
            r6 = move-exception
            r3 = r6
            ...
            java.lang.String r4 = "androidx.appcompat.graphics.drawable.AnimatedStateListDrawableCompat"
    ...
    public void inflate(Context context, Resources resources, XmlPullParser xmlPullParser, AttributeSet attributeSet, Resources.Theme theme) throws XmlPullParserException, IOException {
        TypedArray obtainAttributes = TypedArrayUtils.obtainAttributes(resources, theme, attributeSet, C0126R.styleable.AnimatedStateListDrawableCompat);
        setVisible(obtainAttributes.getBoolean(C0126R.styleable.AnimatedStateListDrawableCompat_android_visible, true), true);
    ...
    private static class AnimatableTransition extends Transition {
        ...
        /* renamed from: mA */
        private final Animatable f62mA;

        AnimatableTransition(Animatable animatable) {
            super();
            this.f62mA = animatable;
        }
    ...
    private void updateStateFromTypedArray(TypedArray typedArray) {
        ...
        animatedStateListState.setVariablePadding(typedArray.getBoolean(C0126R.styleable.AnimatedStateListDrawableCompat_android_variablePadding, animatedStateListState.mVariablePadding));
        animatedStateListState.setConstantSize(typedArray.getBoolean(C0126R.styleable.AnimatedStateListDrawableCompat_android_constantSize, animatedStateListState.mConstantSize));
        animatedStateListState.setEnterFadeDuration(typedArray.getInt(C0126R.styleable.AnimatedStateListDrawableCompat_android_enterFadeDuration, animatedStateListState.mEnterFadeDuration));
        animatedStateListState.setExitFadeDuration(typedArray.getInt(C0126R.styleable.AnimatedStateListDrawableCompat_android_exitFadeDuration, animatedStateListState.mExitFadeDuration));
        setDither(typedArray.getBoolean(C0126R.styleable.AnimatedStateListDrawableCompat_android_dither, animatedStateListState.mDither));
    }
    ...
    private int parseTransition(Context context, Resources resources, XmlPullParser xmlPullParser, AttributeSet attributeSet, Resources.Theme theme) throws XmlPullParserException, IOException {
        int next;
        TypedArray obtainAttributes = TypedArrayUtils.obtainAttributes(resources, theme, attributeSet, C0126R.styleable.AnimatedStateListDrawableTransition);
        int resourceId = obtainAttributes.getResourceId(C0126R.styleable.AnimatedStateListDrawableTransition_android_fromId, -1);
        int resourceId2 = obtainAttributes.getResourceId(C0126R.styleable.AnimatedStateListDrawableTransition_android_toId, -1);
        int resourceId3 = obtainAttributes.getResourceId(C0126R.styleable.AnimatedStateListDrawableTransition_android_drawable, -1);
        Drawable drawable = resourceId3 > 0 ? ResourceManagerInternal.get().getDrawable(context, resourceId3) : null;
        boolean z = obtainAttributes.getBoolean(C0126R.styleable.AnimatedStateListDrawableTransition_android_reversible, false);
        obtainAttributes.recycle();
        if (drawable == null) {
            do {
    ...
    private int parseItem(Context context, Resources resources, XmlPullParser xmlPullParser, AttributeSet attributeSet, Resources.Theme theme) throws XmlPullParserException, IOException {
        int next;
        TypedArray obtainAttributes = TypedArrayUtils.obtainAttributes(resources, theme, attributeSet, C0126R.styleable.AnimatedStateListDrawableItem);
        int resourceId = obtainAttributes.getResourceId(C0126R.styleable.AnimatedStateListDrawableItem_android_id, 0);
        int resourceId2 = obtainAttributes.getResourceId(C0126R.styleable.AnimatedStateListDrawableItem_android_drawable, -1);
