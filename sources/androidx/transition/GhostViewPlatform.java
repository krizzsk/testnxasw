    ...
    private static void fetchGhostViewClass() {
        if (!sGhostViewClassFetched) {
            try {
                ...
                SystemUtils.log(4, TAG, "Failed to retrieve GhostView class", e, "androidx.transition.GhostViewPlatform", 92);
            }
    ...
    private static void fetchAddGhostMethod() {
        if (!sAddGhostMethodFetched) {
            try {
                ...
                SystemUtils.log(4, TAG, "Failed to retrieve addGhost method", e, "androidx.transition.GhostViewPlatform", 106);
            }
    ...
    private static void fetchRemoveGhostMethod() {
        if (!sRemoveGhostMethodFetched) {
            try {
                ...
                SystemUtils.log(4, TAG, "Failed to retrieve removeGhost method", e, "androidx.transition.GhostViewPlatform", 119);
            }
