...
public class ContextCompat {
    ...
    private static java.io.File createFilesDir(java.io.File r7) {
        /*
            java.lang.Object r0 = sSync
            monitor-enter(r0)
            boolean r1 = r7.exists()     // Catch:{ all -> 0x0033 }
            if (r1 != 0) goto L_0x0031
            boolean r1 = r7.mkdirs()     // Catch:{ all -> 0x0033 }
        ...
        L_0x0011:
            ...
            java.lang.String r3 = r7.getPath()     // Catch:{ all -> 0x0033 }
            r1.append(r3)     // Catch:{ all -> 0x0033 }
            ...
            com.didi.sdk.apm.SystemUtils.log(r1, r2, r3, r4, r5, r6)     // Catch:{ all -> 0x0033 }
        L_0x0031:
            monitor-exit(r0)     // Catch:{ all -> 0x0033 }
            return r7
        L_0x0033:
    ...
    private static final class LegacyServiceMapHolder {
        ...
        static {
            ...
            SERVICES.put(DownloadManager.class, HotpatchStateConst.DOWNLOAD);
            ...
            SERVICES.put(SensorManager.class, ISecurityConf.KEY_SENSOR);
