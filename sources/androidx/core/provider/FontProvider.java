...
class FontProvider {
    private static final Comparator<byte[]> sByteArrayComparator = new Comparator<byte[]>() {
        ...
        public int compare(byte[] r5, byte[] r6) {
            ...
            L_0x001b:
                return r0
            */
            throw new UnsupportedOperationException("Method not decompiled: androidx.core.provider.FontProvider.C03271.compare(byte[], byte[]):int");
        }
    };
    ...
    static ProviderInfo getProvider(PackageManager packageManager, FontRequest fontRequest, Resources resources) throws PackageManager.NameNotFoundException {
        ...
        if (resolveContentProvider == null) {
            ...
            List<byte[]> convertToByteArrayList = convertToByteArrayList(SystemUtils.getPackageInfo(packageManager, resolveContentProvider.packageName, 64).signatures);
    ...
    static FontsContractCompat.FontInfo[] query(Context context, FontRequest fontRequest, String str, CancellationSignal cancellationSignal) {
        ...
        Cursor cursor = null;
        try {
            String[] strArr = {ShareDBHelper.ID_NAME, FontsContractCompat.Columns.FILE_ID, FontsContractCompat.Columns.TTC_INDEX, FontsContractCompat.Columns.VARIATION_SETTINGS, FontsContractCompat.Columns.WEIGHT, FontsContractCompat.Columns.ITALIC, FontsContractCompat.Columns.RESULT_CODE};
            ...
            if (cursor != null && cursor.getCount() > 0) {
                ...
                int columnIndex2 = cursor.getColumnIndex(ShareDBHelper.ID_NAME);
