...
public final class TextViewCompat {
    ...
    private static Field retrieveField(String str) {
        ...
        try {
            ...
            SystemUtils.log(6, LOG_TAG, "Could not retrieve " + str + " field.", (Throwable) null, "androidx.core.widget.TextViewCompat", 119);
            return field;
        }
    }
    ...
    private static int retrieveIntFromField(Field field, TextView textView) {
        try {
            ...
            SystemUtils.log(3, LOG_TAG, "Could not retrieve value of " + field.getName() + " field.", (Throwable) null, "androidx.core.widget.TextViewCompat", 128);
            return -1;
        }
    }
