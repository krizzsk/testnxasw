...
public class NestedScrollView extends FrameLayout implements NestedScrollingChild3, NestedScrollingParent3, ScrollingView {
    ...
    public NestedScrollView(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, C0289R.attr.nestedScrollViewStyle);
    }
                ...
                if (i == 2) {
                    ...
                    if (i2 != -1) {
                        ...
                        if (findPointerIndex == -1) {
                            SystemUtils.log(6, TAG, "Invalid pointerId=" + i2 + " in onInterceptTouchEvent", (Throwable) null, "androidx.core.widget.NestedScrollView", 753);
                        } else {
    ...
    public boolean onTouchEvent(MotionEvent motionEvent) {
        ...
        if (actionMasked != 0) {
            if (actionMasked == 1) {
                ...
                if (findPointerIndex == -1) {
                    SystemUtils.log(6, TAG, "Invalid pointerId=" + this.mActivePointerId + " in onTouchEvent", (Throwable) null, "androidx.core.widget.NestedScrollView", 869);
                } else {
