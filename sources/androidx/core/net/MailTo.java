...
public final class MailTo {
    ...
    /* renamed from: CC */
    private static final String f115CC = "cc";
    private static final String MAILTO = "mailto";
    public static final String MAILTO_SCHEME = "mailto:";
    private static final String SUBJECT = "subject";

    /* renamed from: TO */
    private static final String f116TO = "to";
    ...
    public static MailTo parse(String str) throws ParseException {
        ...
        if (isMailTo(str)) {
            ...
            if (str2 != null) {
                for (String split : str2.split(ParamKeys.SIGN_AND)) {
    ...
    public String getCc() {
        return this.mHeaders.get(f115CC);
    }
