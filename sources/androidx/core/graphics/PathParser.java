...
public class PathParser {
    ...
    private static float[] getFloats(String str) {
        ...
        try {
            ...
            throw new RuntimeException("error in parsing \"" + str + Const.jsQuote, e);
        }
    }
    ...
    public static class PathDataNode {
        ...
        private static void drawArc(Path path, float f, float f2, float f3, float f4, float f5, float f6, float f7, boolean z, boolean z2) {
            ...
            if (d22 == 0.0d) {
                SystemUtils.log(5, PathParser.LOGTAG, " Points are coincident", (Throwable) null, "androidx.core.graphics.PathParser$PathDataNode", 676);
                return;
            }
            double d23 = (1.0d / d22) - 0.25d;
            if (d23 < 0.0d) {
                SystemUtils.log(5, PathParser.LOGTAG, "Points are too far apart " + d22, (Throwable) null, "androidx.core.graphics.PathParser$PathDataNode", 681);
