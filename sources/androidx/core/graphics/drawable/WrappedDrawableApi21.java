    ...
    public boolean isProjected() {
        ...
        if (!(this.mDrawable == null || (method = sIsProjectedDrawableMethod) == null)) {
            try {
                ...
                SystemUtils.log(5, TAG, "Error calling Drawable#isProjected() method", e, "androidx.core.graphics.drawable.WrappedDrawableApi21", 133);
            }
        }
        return false;
    }
    ...
    private void findAndCacheIsProjectedDrawableMethod() {
        if (sIsProjectedDrawableMethod == null) {
            try {
                ...
                SystemUtils.log(5, TAG, "Failed to retrieve Drawable#isProjected() method", e, "androidx.core.graphics.drawable.WrappedDrawableApi21", 145);
            }
        }
    }
}
