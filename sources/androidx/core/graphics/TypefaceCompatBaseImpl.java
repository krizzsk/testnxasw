...
class TypefaceCompatBaseImpl {
    ...
    private static long getUniqueKey(Typeface typeface) {
        ...
        try {
            ...
            SystemUtils.log(6, TAG, "Could not retrieve font from family.", e, "androidx.core.graphics.TypefaceCompatBaseImpl", 91);
            return 0;
        } catch (IllegalAccessException e2) {
            SystemUtils.log(6, TAG, "Could not retrieve font from family.", e2, "androidx.core.graphics.TypefaceCompatBaseImpl", 94);
            return 0;
        }
    }
