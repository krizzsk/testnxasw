...
public class TypefaceCompatApi26Impl extends TypefaceCompatApi21Impl {
    ...
    public TypefaceCompatApi26Impl() {
        ...
        try {
            ...
            Throwable th = e;
            SystemUtils.log(6, TAG, "Unable to collect necessary methods for class " + th.getClass().getName(), th, "androidx.core.graphics.TypefaceCompatApi26Impl", 91);
            method5 = null;
            constructor = null;
            method4 = null;
            method3 = null;
    ...
    private boolean isFontFamilyPrivateAPIAvailable() {
        if (this.mAddFontFromAssetManager == null) {
            SystemUtils.log(5, TAG, "Unable to collect necessary private methods. Fallback to legacy implementation.", (Throwable) null, "androidx.core.graphics.TypefaceCompatApi26Impl", 115);
        }
