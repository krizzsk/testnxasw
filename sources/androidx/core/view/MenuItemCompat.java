...
public final class MenuItemCompat {
    ...
    public static MenuItem setActionProvider(MenuItem menuItem, ActionProvider actionProvider) {
        ...
        SystemUtils.log(5, TAG, "setActionProvider: item does not implement SupportMenuItem; ignoring", (Throwable) null, "androidx.core.view.MenuItemCompat", 211);
        return menuItem;
    }
    ...
    public static ActionProvider getActionProvider(MenuItem menuItem) {
        ...
        SystemUtils.log(5, TAG, "getActionProvider: item does not implement SupportMenuItem; returning null", (Throwable) null, "androidx.core.view.MenuItemCompat", 229);
        return null;
    }
