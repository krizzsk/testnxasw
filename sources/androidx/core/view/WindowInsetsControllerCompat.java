...
public final class WindowInsetsControllerCompat {
    ...
    private static class Impl23 extends Impl20 {
        ...
        public void setAppearanceLightStatusBars(boolean z) {
            if (z) {
                unsetWindowFlag(View.STATUS_BAR_TRANSIENT);
    ...
    private static class Impl26 extends Impl23 {
        ...
        public void setAppearanceLightNavigationBars(boolean z) {
            if (z) {
                unsetWindowFlag(View.NAVIGATION_BAR_TRANSIENT);
                setWindowFlag(Integer.MIN_VALUE);
                setSystemUiFlag(16);
                return;
            }
    ...
    private static class Impl30 extends Impl {
        ...
        public void addOnControllableInsetsChangedListener(final OnControllableInsetsChangedListener onControllableInsetsChangedListener) {
            if (!this.mListeners.containsKey(onControllableInsetsChangedListener)) {
                C03552 r0 = new WindowInsetsController.OnControllableInsetsChangedListener() {
