...
public class WindowInsetsCompat {
    ...
    private static class Impl20 extends Impl {
                ...
                if (i != 2) {
                    if (i == 8) {
                        ...
                        if (systemWindowInsets.bottom > rootStableInsets.bottom) {
                            return Insets.m82of(0, 0, 0, systemWindowInsets.bottom);
                        }
                        ...
                        return Insets.m82of(0, 0, 0, this.mRootViewVisibleInsets.bottom);
                    } else if (i == 16) {
                        ...
                        if (displayCutoutCompat != null) {
                            return Insets.m82of(displayCutoutCompat.getSafeInsetLeft(), displayCutoutCompat.getSafeInsetTop(), displayCutoutCompat.getSafeInsetRight(), displayCutoutCompat.getSafeInsetBottom());
                        }
                        return Insets.NONE;
                    }
                } else if (z) {
                    ...
                    return Insets.m82of(Math.max(rootStableInsets2.left, stableInsets.left), 0, Math.max(rootStableInsets2.right, stableInsets.right), Math.max(rootStableInsets2.bottom, stableInsets.bottom));
                } else {
                    ...
                    return Insets.m82of(systemWindowInsets2.left, 0, systemWindowInsets2.right, i2);
                }
            } else if (z) {
                return Insets.m82of(0, Math.max(getRootStableInsets().top, getSystemWindowInsets().top), 0, 0);
            } else {
                return Insets.m82of(0, getSystemWindowInsets().top, 0, 0);
            }
        }
            ...
            if (Build.VERSION.SDK_INT < 30) {
                ...
                if (!(method == null || sAttachInfoClass == null || sVisibleInsetsField == null)) {
                    try {
                        ...
                        if (invoke == null) {
                            SystemUtils.log(5, WindowInsetsCompat.TAG, "Failed to get visible insets. getViewRootImpl() returned null from the provided view. This means that the view is either not attached or the method has been overridden", new NullPointerException(), "androidx.core.view.WindowInsetsCompat$Impl20", 1143);
                            return null;
                        }
                        ...
                        SystemUtils.log(6, WindowInsetsCompat.TAG, "Failed to get visible insets. (Reflection error). " + reflectiveOperationException.getMessage(), reflectiveOperationException, "androidx.core.view.WindowInsetsCompat$Impl20", 1154);
                    }
                }
                return null;
            }
        ...
        private static void loadReflectionField() {
            try {
                ...
                ReflectiveOperationException reflectiveOperationException = e;
                SystemUtils.log(6, WindowInsetsCompat.TAG, "Failed to get visible insets. (Reflection error). " + reflectiveOperationException.getMessage(), reflectiveOperationException, "androidx.core.view.WindowInsetsCompat$Impl20", 1176);
            }
    ...
    static Insets insetInsets(Insets insets, int i, int i2, int i3, int i4) {
        ...
        return Insets.m82of(max, max2, max3, max4);
    }
        ...
        private static WindowInsets createWindowInsetsInstance() {
            if (!sConsumedFieldFetched) {
                try {
                    ...
                    SystemUtils.log(4, WindowInsetsCompat.TAG, "Could not retrieve WindowInsets.CONSUMED field", e, "androidx.core.view.WindowInsetsCompat$BuilderImpl20", 1762);
                }
            ...
            if (field != null) {
                try {
                    ...
                    SystemUtils.log(4, WindowInsetsCompat.TAG, "Could not get value from WindowInsets.CONSUMED field", e2, "androidx.core.view.WindowInsetsCompat$BuilderImpl20", 1773);
                }
            }
            if (!sConstructorFetched) {
                try {
                    ...
                    SystemUtils.log(4, WindowInsetsCompat.TAG, "Could not retrieve WindowInsets(Rect) constructor", e3, "androidx.core.view.WindowInsetsCompat$BuilderImpl20", 1783);
                }
            ...
            if (constructor != null) {
                try {
                    ...
                    SystemUtils.log(4, WindowInsetsCompat.TAG, "Could not invoke WindowInsets(Rect) constructor", e4, "androidx.core.view.WindowInsetsCompat$BuilderImpl20", 1791);
                }
            }
            return null;
        }
    ...
    static class Api21ReflectionHolder {
        ...
        static {
            try {
                ...
                ReflectiveOperationException reflectiveOperationException = e;
                SystemUtils.log(5, WindowInsetsCompat.TAG, "Failed to get visible insets from AttachInfo " + reflectiveOperationException.getMessage(), reflectiveOperationException, "androidx.core.view.WindowInsetsCompat$Api21ReflectionHolder", 2137);
            }
        }
                ...
                try {
                    ...
                    if (obj != null) {
                        ...
                        if (!(rect == null || rect2 == null)) {
                            WindowInsetsCompat build = new Builder().setStableInsets(Insets.m83of(rect)).setSystemWindowInsets(Insets.m83of(rect2)).build();
                    ...
                    SystemUtils.log(5, WindowInsetsCompat.TAG, "Failed to get insets from AttachInfo. " + illegalAccessException.getMessage(), illegalAccessException, "androidx.core.view.WindowInsetsCompat$Api21ReflectionHolder", 2168);
                }
            }
            return null;
        }
