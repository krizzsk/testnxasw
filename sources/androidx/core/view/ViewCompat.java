...
public class ViewCompat {
    private static final int[] ACCESSIBILITY_ACTIONS_RESOURCE_IDS = {C0289R.C0292id.accessibility_custom_action_0, C0289R.C0292id.accessibility_custom_action_1, C0289R.C0292id.accessibility_custom_action_2, C0289R.C0292id.accessibility_custom_action_3, C0289R.C0292id.accessibility_custom_action_4, C0289R.C0292id.accessibility_custom_action_5, C0289R.C0292id.accessibility_custom_action_6, C0289R.C0292id.accessibility_custom_action_7, C0289R.C0292id.accessibility_custom_action_8, C0289R.C0292id.accessibility_custom_action_9, C0289R.C0292id.accessibility_custom_action_10, C0289R.C0292id.accessibility_custom_action_11, C0289R.C0292id.accessibility_custom_action_12, C0289R.C0292id.accessibility_custom_action_13, C0289R.C0292id.accessibility_custom_action_14, C0289R.C0292id.accessibility_custom_action_15, C0289R.C0292id.accessibility_custom_action_16, C0289R.C0292id.accessibility_custom_action_17, C0289R.C0292id.accessibility_custom_action_18, C0289R.C0292id.accessibility_custom_action_19, C0289R.C0292id.accessibility_custom_action_20, C0289R.C0292id.accessibility_custom_action_21, C0289R.C0292id.accessibility_custom_action_22, C0289R.C0292id.accessibility_custom_action_23, C0289R.C0292id.accessibility_custom_action_24, C0289R.C0292id.accessibility_custom_action_25, C0289R.C0292id.accessibility_custom_action_26, C0289R.C0292id.accessibility_custom_action_27, C0289R.C0292id.accessibility_custom_action_28, C0289R.C0292id.accessibility_custom_action_29, C0289R.C0292id.accessibility_custom_action_30, C0289R.C0292id.accessibility_custom_action_31};
    ...
    private static List<AccessibilityNodeInfoCompat.AccessibilityActionCompat> getActionList(View view) {
        ArrayList arrayList = (ArrayList) view.getTag(C0289R.C0292id.tag_accessibility_actions);
        if (arrayList != null) {
            return arrayList;
        }
        ArrayList arrayList2 = new ArrayList();
        view.setTag(C0289R.C0292id.tag_accessibility_actions, arrayList2);
        return arrayList2;
    }
    ...
    private static void bindTempDetach() {
        try {
            ...
            SystemUtils.log(6, TAG, "Couldn't find method", e, "androidx.core.view.ViewCompat", 1891);
        }
    ...
    public static void dispatchStartTemporaryDetach(View view) {
        ...
        if (method != null) {
            try {
                ...
                SystemUtils.log(3, TAG, "Error calling dispatchStartTemporaryDetach", e, "androidx.core.view.ViewCompat", 1910);
            }
        } else {
    ...
    public static void dispatchFinishTemporaryDetach(View view) {
        ...
        if (method != null) {
            try {
                ...
                SystemUtils.log(3, TAG, "Error calling dispatchFinishTemporaryDetach", e, "androidx.core.view.ViewCompat", 1933);
            }
        } else {
    ...
    public static void setChildrenDrawingOrderEnabled(ViewGroup viewGroup, boolean z) {
        if (sChildrenDrawingOrderMethod == null) {
            ...
            try {
                ...
                SystemUtils.log(6, TAG, "Unable to find childrenDrawingOrderEnabled", e, "androidx.core.view.ViewCompat", 2458);
            }
        ...
        try {
            ...
            SystemUtils.log(6, TAG, "Unable to invoke childrenDrawingOrderEnabled", e2, "androidx.core.view.ViewCompat", 2465);
        } catch (IllegalArgumentException e3) {
            SystemUtils.log(6, TAG, "Unable to invoke childrenDrawingOrderEnabled", e3, "androidx.core.view.ViewCompat", 2467);
        } catch (InvocationTargetException e4) {
            SystemUtils.log(6, TAG, "Unable to invoke childrenDrawingOrderEnabled", e4, "androidx.core.view.ViewCompat", 2469);
        }
    }
    ...
    public static void setOnReceiveContentListener(View view, String[] strArr, OnReceiveContentListener onReceiveContentListener) {
        ...
        view.setTag(C0289R.C0292id.tag_on_receive_content_mime_types, strArr);
        view.setTag(C0289R.C0292id.tag_on_receive_content_listener, onReceiveContentListener);
    }

    public static String[] getOnReceiveContentMimeTypes(View view) {
        return (String[]) view.getTag(C0289R.C0292id.tag_on_receive_content_mime_types);
    }

    public static ContentInfoCompat performReceiveContent(View view, ContentInfoCompat contentInfoCompat) {
        if (Log.isLoggable(TAG, 3)) {
            SystemUtils.log(3, TAG, "performReceiveContent: " + contentInfoCompat + ", view=" + view.getClass().getSimpleName() + Const.jaLeft + view.getId() + Const.jaRight, (Throwable) null, "androidx.core.view.ViewCompat", 2806);
        }
        OnReceiveContentListener onReceiveContentListener = (OnReceiveContentListener) view.getTag(C0289R.C0292id.tag_on_receive_content_listener);
        if (onReceiveContentListener == null) {
    ...
    static class CompatImplApi28 {
        ...
        static void addOnUnhandledKeyEventListener(View view, final OnUnhandledKeyEventListenerCompat onUnhandledKeyEventListenerCompat) {
            SimpleArrayMap simpleArrayMap = (SimpleArrayMap) view.getTag(C0289R.C0292id.tag_unhandled_key_listeners);
            if (simpleArrayMap == null) {
                simpleArrayMap = new SimpleArrayMap();
                view.setTag(C0289R.C0292id.tag_unhandled_key_listeners, simpleArrayMap);
            }
            C03471 r1 = new View.OnUnhandledKeyEventListener() {
    ...
    public static void addOnUnhandledKeyEventListener(View view, OnUnhandledKeyEventListenerCompat onUnhandledKeyEventListenerCompat) {
        ...
        ArrayList arrayList = (ArrayList) view.getTag(C0289R.C0292id.tag_unhandled_key_listeners);
        if (arrayList == null) {
            arrayList = new ArrayList();
            view.setTag(C0289R.C0292id.tag_unhandled_key_listeners, arrayList);
        }
    ...
    private static AccessibilityViewProperty<Boolean> screenReaderFocusableProperty() {
        return new AccessibilityViewProperty<Boolean>(C0289R.C0292id.tag_screen_reader_focusable, Boolean.class, 28) {
    ...
    private static AccessibilityViewProperty<CharSequence> paneTitleProperty() {
        return new AccessibilityViewProperty<CharSequence>(C0289R.C0292id.tag_accessibility_pane_title, CharSequence.class, 8, 28) {
            /* access modifiers changed from: package-private */
    ...
    private static AccessibilityViewProperty<CharSequence> stateDescriptionProperty() {
        return new AccessibilityViewProperty<CharSequence>(C0289R.C0292id.tag_state_description, CharSequence.class, 64, 30) {
            /* access modifiers changed from: package-private */
            public CharSequence frameworkGet(View view) {
    ...
    private static AccessibilityViewProperty<Boolean> accessibilityHeadingProperty() {
        return new AccessibilityViewProperty<Boolean>(C0289R.C0292id.tag_accessibility_heading, Boolean.class, 28) {
            /* access modifiers changed from: package-private */
            public Boolean frameworkGet(View view) {
        ...
        if (accessibilityManager.isEnabled()) {
            ...
            if (getAccessibilityLiveRegion(view) != 0 || z) {
                ...
                try {
                    ...
                    SystemUtils.log(6, TAG, view.getParent().getClass().getSimpleName() + " does not fully implement ViewParent", abstractMethodError, "androidx.core.view.ViewCompat", 4455);
                }
            }
        }
    }
    ...
    static class UnhandledKeyEventManager {
        ...
        /* renamed from: at */
        static UnhandledKeyEventManager m89at(View view) {
            UnhandledKeyEventManager unhandledKeyEventManager = (UnhandledKeyEventManager) view.getTag(C0289R.C0292id.tag_unhandled_key_event_manager);
            if (unhandledKeyEventManager != null) {
                return unhandledKeyEventManager;
            }
            UnhandledKeyEventManager unhandledKeyEventManager2 = new UnhandledKeyEventManager();
            view.setTag(C0289R.C0292id.tag_unhandled_key_event_manager, unhandledKeyEventManager2);
    ...
    private static class Api21Impl {
        ...
        static void setOnApplyWindowInsetsListener(final View view, final OnApplyWindowInsetsListener onApplyWindowInsetsListener) {
            if (Build.VERSION.SDK_INT < 30) {
                view.setTag(C0289R.C0292id.tag_on_apply_window_listener, onApplyWindowInsetsListener);
            }
            if (onApplyWindowInsetsListener == null) {
                view.setOnApplyWindowInsetsListener((View.OnApplyWindowInsetsListener) view.getTag(C0289R.C0292id.tag_window_insets_animation_callback));
            } else {
        ...
        static void callCompatInsetAnimationCallback(WindowInsets windowInsets, View view) {
            View.OnApplyWindowInsetsListener onApplyWindowInsetsListener = (View.OnApplyWindowInsetsListener) view.getTag(C0289R.C0292id.tag_window_insets_animation_callback);
            if (onApplyWindowInsetsListener != null) {
