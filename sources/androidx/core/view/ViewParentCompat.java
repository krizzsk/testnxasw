    ...
    public static boolean onStartNestedScroll(ViewParent viewParent, View view, View view2, int i, int i2) {
        ...
        if (Build.VERSION.SDK_INT >= 21) {
            try {
                ...
                SystemUtils.log(6, TAG, "ViewParent " + viewParent + " does not implement interface method onStartNestedScroll", e, "androidx.core.view.ViewParentCompat", 217);
                return false;
            }
        ...
        if (viewParent instanceof NestedScrollingParent2) {
            ...
            if (Build.VERSION.SDK_INT >= 21) {
                try {
                    ...
                    SystemUtils.log(6, TAG, "ViewParent " + viewParent + " does not implement interface method onNestedScrollAccepted", e, "androidx.core.view.ViewParentCompat", 258);
                }
            } else if (viewParent instanceof NestedScrollingParent) {
        ...
        if (viewParent instanceof NestedScrollingParent2) {
            ...
            if (Build.VERSION.SDK_INT >= 21) {
                try {
                    ...
                    SystemUtils.log(6, TAG, "ViewParent " + viewParent + " does not implement interface method onStopNestedScroll", e, "androidx.core.view.ViewParentCompat", 291);
                }
            } else if (viewParent instanceof NestedScrollingParent) {
        ...
        if (viewParent2 instanceof NestedScrollingParent2) {
            ...
            if (Build.VERSION.SDK_INT >= 21) {
                try {
                    ...
                    SystemUtils.log(6, TAG, "ViewParent " + viewParent + " does not implement interface method onNestedScroll", abstractMethodError, "androidx.core.view.ViewParentCompat", 349);
                }
        ...
        if (viewParent instanceof NestedScrollingParent2) {
            ...
            if (Build.VERSION.SDK_INT >= 21) {
                try {
                    ...
                    SystemUtils.log(6, TAG, "ViewParent " + viewParent + " does not implement interface method onNestedPreScroll", e, "androidx.core.view.ViewParentCompat", 393);
                }
            } else if (viewParent instanceof NestedScrollingParent) {
    ...
    public static boolean onNestedFling(ViewParent viewParent, View view, float f, float f2, boolean z) {
        if (Build.VERSION.SDK_INT >= 21) {
            try {
                ...
                SystemUtils.log(6, TAG, "ViewParent " + viewParent + " does not implement interface method onNestedFling", e, "androidx.core.view.ViewParentCompat", 428);
                return false;
            }
        } else if (viewParent instanceof NestedScrollingParent) {
    ...
    public static boolean onNestedPreFling(ViewParent viewParent, View view, float f, float f2) {
        if (Build.VERSION.SDK_INT >= 21) {
            try {
                ...
                SystemUtils.log(6, TAG, "ViewParent " + viewParent + " does not implement interface method onNestedPreFling", e, "androidx.core.view.ViewParentCompat", 465);
                return false;
            }
        } else if (viewParent instanceof NestedScrollingParent) {
