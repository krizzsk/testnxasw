...
public final class LayoutInflaterCompat {
    ...
    static class Factory2Wrapper implements LayoutInflater.Factory2 {
        ...
        public String toString() {
            return getClass().getName() + Const.joLeft + this.mDelegateFactory + "}";
        }
    }
    ...
    private static void forceSetFactory2(LayoutInflater layoutInflater, LayoutInflater.Factory2 factory2) {
        if (!sCheckedField) {
            try {
                ...
                SystemUtils.log(6, TAG, "forceSetFactory2 Could not find field 'mFactory2' on class " + LayoutInflater.class.getName() + "; inflation may have unexpected results.", noSuchFieldException, "androidx.core.view.LayoutInflaterCompat", 77);
            }
            sCheckedField = true;
        }
        ...
        if (field != null) {
            try {
                ...
                SystemUtils.log(6, TAG, "forceSetFactory2 could not set the Factory2 on LayoutInflater " + layoutInflater + "; inflation may have unexpected results.", e2, "androidx.core.view.LayoutInflaterCompat", 87);
            }
        }
    }
