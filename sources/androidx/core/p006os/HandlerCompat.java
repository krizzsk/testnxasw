    ...
    public static Handler createAsync(Looper looper) {
        ...
        if (Build.VERSION.SDK_INT >= 17) {
            ...
            try {
                ...
                SystemUtils.log(5, TAG, "Unable to invoke Handler(Looper, Callback, boolean) constructor", e, "androidx.core.os.HandlerCompat", 92);
    ...
    public static Handler createAsync(Looper looper, Handler.Callback callback) {
        ...
        if (Build.VERSION.SDK_INT >= 17) {
            ...
            try {
                ...
                SystemUtils.log(5, TAG, "Unable to invoke Handler(Looper, Callback, boolean) constructor", e, "androidx.core.os.HandlerCompat", 151);
            } catch (InvocationTargetException e2) {
                Throwable cause = e2.getCause();
                if (cause instanceof RuntimeException) {
                    throw ((RuntimeException) cause);
