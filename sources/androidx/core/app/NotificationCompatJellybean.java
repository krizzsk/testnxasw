...
class NotificationCompatJellybean {
            ...
            try {
                if (sExtrasField == null) {
                    ...
                    if (!Bundle.class.isAssignableFrom(declaredField.getType())) {
                        SystemUtils.log(6, TAG, "Notification.extras field is not of type Bundle", (Throwable) null, "androidx.core.app.NotificationCompatJellybean", 98);
                ...
                SystemUtils.log(6, TAG, "Unable to access notification extras", e, "androidx.core.app.NotificationCompatJellybean", 112);
                sExtrasFieldAccessFailed = true;
                return null;
            } catch (NoSuchFieldException e2) {
                SystemUtils.log(6, TAG, "Unable to access notification extras", e2, "androidx.core.app.NotificationCompatJellybean", 114);
                sExtrasFieldAccessFailed = true;
                return null;
            }
        }
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:8:0x0012, code lost:
        r8 = r8.getSparseParcelableArray(androidx.core.app.NotificationCompatExtras.EXTRA_ACTION_EXTRAS);
     */
    ...
    public static androidx.core.app.NotificationCompat.Action getAction(android.app.Notification r8, int r9) {
        /*
            ...
            monitor-enter(r0)
            r1 = 0
            java.lang.Object[] r2 = getActionObjectsLocked(r8)     // Catch:{ IllegalAccessException -> 0x0040 }
            if (r2 == 0) goto L_0x0051
            r2 = r2[r9]     // Catch:{ IllegalAccessException -> 0x0040 }
            android.os.Bundle r8 = getExtras(r8)     // Catch:{ IllegalAccessException -> 0x0040 }
            if (r8 == 0) goto L_0x0021
            java.lang.String r3 = "android.support.actionExtras"
            android.util.SparseArray r8 = r8.getSparseParcelableArray(r3)     // Catch:{ IllegalAccessException -> 0x0040 }
            if (r8 == 0) goto L_0x0021
            java.lang.Object r8 = r8.get(r9)     // Catch:{ IllegalAccessException -> 0x0040 }
            android.os.Bundle r8 = (android.os.Bundle) r8     // Catch:{ IllegalAccessException -> 0x0040 }
            goto L_0x0022
        L_0x0021:
            r8 = r1
        L_0x0022:
            java.lang.reflect.Field r9 = sActionIconField     // Catch:{ IllegalAccessException -> 0x0040 }
            int r9 = r9.getInt(r2)     // Catch:{ IllegalAccessException -> 0x0040 }
            ...
            androidx.core.app.NotificationCompat$Action r8 = readAction(r9, r3, r2, r8)     // Catch:{ IllegalAccessException -> 0x0040 }
        ...
        L_0x0040:
            ...
            r2 = 6
            java.lang.String r6 = "androidx.core.app.NotificationCompatJellybean"
            r7 = 188(0xbc, float:2.63E-43)
            com.didi.sdk.apm.SystemUtils.log(r2, r3, r4, r5, r6, r7)     // Catch:{ all -> 0x003e }
            r8 = 1
            sActionsAccessFailed = r8     // Catch:{ all -> 0x003e }
        L_0x0051:
            monitor-exit(r0)     // Catch:{ all -> 0x003e }
            return r1
        L_0x0053:
    ...
    private static Object[] getActionObjectsLocked(Notification notification) {
        synchronized (sActionsLock) {
            ...
            try {
                ...
                SystemUtils.log(6, TAG, "Unable to access notification actions", e, "androidx.core.app.NotificationCompatJellybean", 203);
    ...
    private static boolean ensureActionReflectionReadyLocked() {
        ...
        try {
            ...
            SystemUtils.log(6, TAG, "Unable to access notification actions", e, "androidx.core.app.NotificationCompatJellybean", 225);
            sActionsAccessFailed = true;
        } catch (NoSuchFieldException e2) {
            SystemUtils.log(6, TAG, "Unable to access notification actions", e2, "androidx.core.app.NotificationCompatJellybean", 228);
            sActionsAccessFailed = true;
        }
