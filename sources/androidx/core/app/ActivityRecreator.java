...
final class ActivityRecreator {
    ...
    protected static boolean queueOnStopIfNecessary(Object obj, int i, Activity activity) {
        try {
                    ...
                    mainHandler.postAtFrontOfQueue(new Runnable() {
                        public void run() {
                            try {
                                ...
                                SystemUtils.log(6, ActivityRecreator.LOG_TAG, "Exception while invoking performStopActivity", th, "androidx.core.app.ActivityRecreator$3", 290);
                            }
                        }
                    });
                    return true;
            ...
            SystemUtils.log(6, LOG_TAG, "Exception while fetching field values", th, "androidx.core.app.ActivityRecreator", 296);
            return false;
        }
    }
