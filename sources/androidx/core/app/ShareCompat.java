    ...
    public static class IntentReader {
        ...
        public Drawable getCallingActivityIcon() {
            ...
            try {
                ...
                SystemUtils.log(6, TAG, "Could not retrieve icon for calling activity", e, "androidx.core.app.ShareCompat$IntentReader", 1029);
                return null;
            }
        }
        ...
        public Drawable getCallingApplicationIcon() {
            ...
            try {
                ...
                SystemUtils.log(6, TAG, "Could not retrieve icon for calling application", e, "androidx.core.app.ShareCompat$IntentReader", 1052);
                return null;
            }
        }
        ...
        public CharSequence getCallingApplicationLabel() {
            ...
            try {
                return packageManager.getApplicationLabel(SystemUtils.getApplicationInfo(packageManager, this.mCallingPackage, 0));
            } catch (PackageManager.NameNotFoundException e) {
                SystemUtils.log(6, TAG, "Could not retrieve label for calling application", e, "androidx.core.app.ShareCompat$IntentReader", 1075);
                return null;
            }
        }
    }
