...
class DocumentsContractApi19 {
    ...
    public static boolean exists(Context context, Uri uri) {
        ...
        try {
            ...
            SystemUtils.log(5, TAG, "Failed query: " + e, (Throwable) null, "androidx.documentfile.provider.DocumentsContractApi19", 149);
            return false;
        } finally {
            closeQuietly(cursor);
        }
    ...
    private static String queryForString(Context context, Uri uri, String str, String str2) {
        ...
        try {
            ...
            SystemUtils.log(5, TAG, "Failed query: " + e, (Throwable) null, "androidx.documentfile.provider.DocumentsContractApi19", 170);
            return str2;
        } finally {
            closeQuietly(cursor);
        }
    ...
    private static long queryForLong(Context context, Uri uri, String str, long j) {
        ...
        try {
            ...
            SystemUtils.log(5, TAG, "Failed query: " + e, (Throwable) null, "androidx.documentfile.provider.DocumentsContractApi19", 195);
            return j;
        } finally {
            closeQuietly(cursor);
        }
