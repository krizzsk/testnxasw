...
class RawDocumentFile extends DocumentFile {
    ...
    public DocumentFile createFile(String str, String str2) {
        ...
        try {
            ...
            SystemUtils.log(5, "DocumentFile", "Failed to createFile: " + e, (Throwable) null, "androidx.documentfile.provider.RawDocumentFile", 50);
            return null;
        }
    }
    ...
    private static boolean deleteContents(File file) {
        ...
        if (listFiles != null) {
            for (File file2 : listFiles) {
                ...
                if (!file2.delete()) {
                    SystemUtils.log(5, "DocumentFile", "Failed to delete " + file2, (Throwable) null, "androidx.documentfile.provider.RawDocumentFile", 177);
                    z = false;
                }
            }
        }
