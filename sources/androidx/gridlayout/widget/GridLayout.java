...
import androidx.gridlayout.C0455R;
...
public class GridLayout extends ViewGroup {
    private static final int ALIGNMENT_MODE = C0455R.styleable.GridLayout_alignmentMode;
    ...
    private static final int COLUMN_COUNT = C0455R.styleable.GridLayout_columnCount;
    private static final int COLUMN_ORDER_PRESERVED = C0455R.styleable.GridLayout_columnOrderPreserved;
    ...
    private static final int ORIENTATION = C0455R.styleable.GridLayout_orientation;
    public static final Alignment RIGHT = createSwitchingAlignment(END, START);
    private static final int ROW_COUNT = C0455R.styleable.GridLayout_rowCount;
    private static final int ROW_ORDER_PRESERVED = C0455R.styleable.GridLayout_rowOrderPreserved;
    ...
    private static final int USE_DEFAULT_MARGINS = C0455R.styleable.GridLayout_useDefaultMargins;
    ...
    public GridLayout(Context context, AttributeSet attributeSet, int i) {
        ...
        this.mDefaultGap = context.getResources().getDimensionPixelOffset(C0455R.dimen.default_gap);
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C0455R.styleable.GridLayout);
        try {
    ...
    final class Axis {
        ...
        private PackedMap<Spec, Bounds> createGroupBounds() {
            Assoc<K, V> of = Assoc.m93of(Spec.class, Bounds.class);
            int childCount = GridLayout.this.getChildCount();
        ...
        private PackedMap<Interval, MutableInt> createLinks(boolean z) {
            Assoc<K, V> of = Assoc.m93of(Interval.class, MutableInt.class);
        ...
        private String arcsToString(List<Arc> list) {
            StringBuilder sb;
            String str = this.horizontal ? "x" : SameLayerRenderingUtil.KEY_COMP_Y;
        ...
        private boolean solve(Arc[] arcArr, int[] iArr, boolean z) {
            String str = this.horizontal ? Const.YogaConst.EDGE_HORIZONTAL : Const.YogaConst.EDGE_VERTICAL;
            int count = getCount() + 1;
            boolean[] zArr = null;
            for (int i = 0; i < arcArr.length; i++) {
                init(iArr);
    ...
    public static class LayoutParams extends ViewGroup.MarginLayoutParams {
        private static final int BOTTOM_MARGIN = C0455R.styleable.GridLayout_Layout_android_layout_marginBottom;
        private static final int COLUMN = C0455R.styleable.GridLayout_Layout_layout_column;
        private static final int COLUMN_SPAN = C0455R.styleable.GridLayout_Layout_layout_columnSpan;
        private static final int COLUMN_WEIGHT = C0455R.styleable.GridLayout_Layout_layout_columnWeight;
        ...
        private static final int GRAVITY = C0455R.styleable.GridLayout_Layout_layout_gravity;
        private static final int LEFT_MARGIN = C0455R.styleable.GridLayout_Layout_android_layout_marginLeft;
        private static final int MARGIN = C0455R.styleable.GridLayout_Layout_android_layout_margin;
        private static final int RIGHT_MARGIN = C0455R.styleable.GridLayout_Layout_android_layout_marginRight;
        private static final int ROW = C0455R.styleable.GridLayout_Layout_layout_row;
        private static final int ROW_SPAN = C0455R.styleable.GridLayout_Layout_layout_rowSpan;
        private static final int ROW_WEIGHT = C0455R.styleable.GridLayout_Layout_layout_rowWeight;
        private static final int TOP_MARGIN = C0455R.styleable.GridLayout_Layout_android_layout_marginTop;
        ...
        private void reInitSuper(Context context, AttributeSet attributeSet) {
            TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C0455R.styleable.GridLayout_Layout);
            try {
    ...
    static final class Assoc<K, V> extends ArrayList<Pair<K, V>> {
        ...
        /* renamed from: of */
        public static <K, V> Assoc<K, V> m93of(Class<K> cls, Class<V> cls2) {
    ...
    static final class Interval {
        ...
        public String toString() {
            return com.didichuxing.bigdata.p174dp.locsdk.Const.jaLeft + this.min + ", " + this.max + com.didichuxing.bigdata.p174dp.locsdk.Const.jaRight;
        }
    }
    ...
    private static Alignment createSwitchingAlignment(final Alignment alignment, final Alignment alignment2) {
        return new Alignment() {
            ...
            /* access modifiers changed from: package-private */
            public String getDebugString() {
                return "SWITCHING[L:" + alignment.getDebugString() + ", R:" + alignment2.getDebugString() + com.didichuxing.bigdata.p174dp.locsdk.Const.jaRight;
            }
        };
    }
}
