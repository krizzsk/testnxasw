...
public class MotionLabel extends View implements FloatLayout {
    ...
    private void setUpTheme(Context context, AttributeSet attributeSet) {
        ...
        context.getTheme().resolveAttribute(C0087R.attr.colorPrimary, typedValue, true);
        TextPaint textPaint = this.mPaint;
    ...
    public void buildShape(float f) {
        if (this.mUseOutline || f != 1.0f) {
            ...
            if (f != 1.0f) {
                SystemUtils.log(2, TAG, Debug.getLoc() + " scale " + f, (Throwable) null, "androidx.constraintlayout.utils.widget.MotionLabel", 384);
        ...
        if (f != 0.0f) {
            ...
            if (Build.VERSION.SDK_INT >= 21) {
                if (this.mViewOutlineProvider == null) {
                    C02691 r7 = new ViewOutlineProvider() {
    ...
    public void setRound(float f) {
        ...
        if (f != 0.0f) {
            ...
            if (Build.VERSION.SDK_INT >= 21) {
                if (this.mViewOutlineProvider == null) {
                    C02702 r6 = new ViewOutlineProvider() {
                        public void getOutline(View view, Outline outline) {
    ...
    public void setTextSize(float f) {
        this.mTextSize = f;
        String str = TAG;
        SystemUtils.log(2, str, Debug.getLoc() + "  " + f + " / " + this.mBaseTextSize, (Throwable) null, "androidx.constraintlayout.utils.widget.MotionLabel", 815);
        TextPaint textPaint = this.mPaint;
