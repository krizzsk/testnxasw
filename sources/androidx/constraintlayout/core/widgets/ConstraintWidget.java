...
public class ConstraintWidget {
    ...
    public void setDebugSolverName(LinearSystem linearSystem, String str) {
        ...
        createObjectVariable4.setName(str + TombstoneManager.BOTTOM_SUFFIX);
    ...
    public String toString() {
        ...
        sb.append(str2);
        sb.append("(");
        sb.append(this.f88mX);
        sb.append(", ");
        sb.append(this.f89mY);
        sb.append(") - (");
    ...
    public int getX() {
        ...
        return ((ConstraintWidgetContainer) constraintWidget).mPaddingLeft + this.f88mX;
    }
    ...
    public int getY() {
        ...
        return ((ConstraintWidgetContainer) constraintWidget).mPaddingTop + this.f89mY;
    }
    ...
    /* access modifiers changed from: protected */
    public int getRootX() {
        return this.f88mX + this.mOffsetX;
    }

    /* access modifiers changed from: protected */
    public int getRootY() {
        return this.f89mY + this.mOffsetY;
    }
    ...
    public void setGoneMargin(ConstraintAnchor.Type type, int i) {
        int i2 = C02441.f90x6930e354[type.ordinal()];
        if (i2 == 1) {
    ...
    public ConstraintAnchor getAnchor(ConstraintAnchor.Type type) {
        switch (C02441.f90x6930e354[type.ordinal()]) {
            case 1:
                return this.mLeft;
            case 2:
                return this.mTop;
    ...
    private void applyConstraints(androidx.constraintlayout.core.LinearSystem r36, boolean r37, boolean r38, boolean r39, boolean r40, androidx.constraintlayout.core.SolverVariable r41, androidx.constraintlayout.core.SolverVariable r42, androidx.constraintlayout.core.widgets.ConstraintWidget.DimensionBehaviour r43, boolean r44, androidx.constraintlayout.core.widgets.ConstraintAnchor r45, androidx.constraintlayout.core.widgets.ConstraintAnchor r46, int r47, int r48, int r49, int r50, float r51, boolean r52, boolean r53, boolean r54, boolean r55, boolean r56, int r57, int r58, int r59, int r60, float r61, boolean r62) {
        ...
        L_0x0064:
            r20 = r57
        L_0x0066:
            int[] r21 = androidx.constraintlayout.core.widgets.ConstraintWidget.C02441.f91x6d00e4a2
            int r22 = r43.ordinal()
            r5 = r21[r22]
            r2 = 2
            r14 = 1
    ...
    static /* synthetic */ class C02441 {
        ...
        static {
            ...
            L_0x0012:
                r0 = 2
                int[] r2 = f91x6d00e4a2     // Catch:{ NoSuchFieldError -> 0x001d }
            ...
            L_0x001d:
                r2 = 3
                int[] r3 = f91x6d00e4a2     // Catch:{ NoSuchFieldError -> 0x0028 }
            ...
            L_0x0028:
                r3 = 4
                int[] r4 = f91x6d00e4a2     // Catch:{ NoSuchFieldError -> 0x0033 }
            ...
            L_0x0044:
                int[] r1 = f90x6930e354     // Catch:{ NoSuchFieldError -> 0x004e }
            ...
            L_0x004e:
                int[] r0 = f90x6930e354     // Catch:{ NoSuchFieldError -> 0x0058 }
            ...
            L_0x0058:
                int[] r0 = f90x6930e354     // Catch:{ NoSuchFieldError -> 0x0062 }
            ...
            L_0x0062:
                int[] r0 = f90x6930e354     // Catch:{ NoSuchFieldError -> 0x006d }
            ...
            L_0x006d:
                int[] r0 = f90x6930e354     // Catch:{ NoSuchFieldError -> 0x0078 }
            ...
            L_0x0078:
                int[] r0 = f90x6930e354     // Catch:{ NoSuchFieldError -> 0x0083 }
            ...
            L_0x0083:
                int[] r0 = f90x6930e354     // Catch:{ NoSuchFieldError -> 0x008f }
            ...
            L_0x008f:
                int[] r0 = f90x6930e354     // Catch:{ NoSuchFieldError -> 0x009b }
            ...
            L_0x009b:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: androidx.constraintlayout.core.widgets.ConstraintWidget.C02441.<clinit>():void");
        }
    }
    ...
    public void copy(ConstraintWidget constraintWidget, HashMap<ConstraintWidget, ConstraintWidget> hashMap) {
        ...
        this.f88mX = constraintWidget.f88mX;
        this.f89mY = constraintWidget.f89mY;
    ...
    public void getSceneString(StringBuilder sb) {
        ...
        sb.append("\n");
        sb.append("    actualLeft:" + this.f88mX);
        sb.append("\n");
        sb.append("    actualTop:" + this.f89mY);
        sb.append("\n");
