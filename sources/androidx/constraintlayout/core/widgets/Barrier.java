    ...
    public void addToSolver(LinearSystem linearSystem, boolean z) {
        ...
        if (i4 >= 0 && i4 < 4) {
            ...
            if (this.resolved) {
                ...
                if (i5 == 0 || i5 == 1) {
                    linearSystem.addEquality(this.mLeft.mSolverVariable, this.f88mX);
                    linearSystem.addEquality(this.mRight.mSolverVariable, this.f88mX);
                } else if (i5 == 2 || i5 == 3) {
                    linearSystem.addEquality(this.mTop.mSolverVariable, this.f89mY);
                    linearSystem.addEquality(this.mBottom.mSolverVariable, this.f89mY);
                }
            } else {
                int i6 = 0;
                while (true) {
