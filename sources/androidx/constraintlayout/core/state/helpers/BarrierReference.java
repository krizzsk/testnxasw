...
public class BarrierReference extends HelperReference {
    ...
    public void apply() {
        getHelperWidget();
        int i = C02401.$SwitchMap$androidx$constraintlayout$core$state$State$Direction[this.mDirection.ordinal()];
        int i2 = 3;
        if (i == 3 || i == 4) {
            i2 = 1;
        } else if (i == 5) {
    ...
    static /* synthetic */ class C02401 {
        ...
        static {
            ...
            L_0x0049:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: androidx.constraintlayout.core.state.helpers.BarrierReference.C02401.<clinit>():void");
        }
    }
}
