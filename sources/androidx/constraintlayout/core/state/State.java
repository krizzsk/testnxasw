...
public class State {
    ...
    public HelperReference helper(Object obj, Helper helper) {
        ...
        if (helperReference2 == null) {
            int i = C02391.$SwitchMap$androidx$constraintlayout$core$state$State$Helper[helper.ordinal()];
            if (i == 1) {
    ...
    static /* synthetic */ class C02391 {
        ...
        static {
            ...
            L_0x003e:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: androidx.constraintlayout.core.state.State.C02391.<clinit>():void");
        }
    }
