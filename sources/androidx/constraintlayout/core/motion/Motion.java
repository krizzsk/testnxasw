...
public class Motion implements TypedValues {
    ...
    public MotionKeyPosition getPositionKeyframe(int i, int i2, float f, float f2) {
        ...
        floatRect.left = this.mStartMotionPath.f68x;
        floatRect.top = this.mStartMotionPath.f69y;
        ...
        floatRect2.left = this.mEndMotionPath.f68x;
        floatRect2.top = this.mEndMotionPath.f69y;
    ...
    public float getKeyFrameParameter(int i, float f, float f2) {
        float f3 = this.mEndMotionPath.f68x - this.mStartMotionPath.f68x;
        float f4 = this.mEndMotionPath.f69y - this.mStartMotionPath.f69y;
        float f5 = this.mStartMotionPath.f68x + (this.mStartMotionPath.width / 2.0f);
        float f6 = this.mStartMotionPath.f69y + (this.mStartMotionPath.height / 2.0f);
    ...
    private static DifferentialInterpolator getInterpolator(int i, String str, int i2) {
        ...
        return new DifferentialInterpolator() {
            ...
            public float getVelocity() {
                return (float) interpolator.getDiff((double) this.f65mX);
            }
        };
    }
    ...
    public boolean interpolate(MotionWidget motionWidget, float f, long j, KeyCache keyCache) {
        ...
        if (curveFitArr != null) {
            ...
            float f5 = this.mStartMotionPath.f68x + ((this.mEndMotionPath.f68x - this.mStartMotionPath.f68x) * f4) + 0.5f;
            float f6 = this.mStartMotionPath.f69y + ((this.mEndMotionPath.f69y - this.mStartMotionPath.f69y) * f4) + 0.5f;
    ...
    public void getDpDt(float f, float f2, float f3, float[] fArr) {
        ...
        float f5 = this.mEndMotionPath.f68x - this.mStartMotionPath.f68x;
        float f6 = this.mEndMotionPath.f69y - this.mStartMotionPath.f69y;
    ...
    public void getPostLayoutDvDp(float f, int i, int i2, float f2, float f3, float[] fArr) {
        ...
        if (this.mSpline != null) {
            ...
            float f7 = this.mEndMotionPath.f68x - this.mStartMotionPath.f68x;
            float f8 = this.mEndMotionPath.f69y - this.mStartMotionPath.f69y;
