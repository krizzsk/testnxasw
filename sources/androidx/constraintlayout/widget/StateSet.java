...
public class StateSet {
    ...
    private void load(android.content.Context r10, org.xmlpull.v1.XmlPullParser r11) {
        /*
            ...
            int[] r1 = androidx.constraintlayout.widget.C0273R.styleable.StateSet
        ...
        L_0x0010:
            ...
            int r5 = androidx.constraintlayout.widget.C0273R.styleable.StateSet_defaultState
        ...
        public Variant(Context context, XmlPullParser xmlPullParser) {
            ...
            for (int i = 0; i < indexCount; i++) {
                ...
                if (index == C0273R.styleable.Variant_constraints) {
                    ...
                    SystemUtils.log(2, "ConstraintLayoutStates", "Unknown tag", (Throwable) null, "androidx.constraintlayout.widget.StateSet$Variant", 325);
                }
            }
            obtainStyledAttributes.recycle();
        }
