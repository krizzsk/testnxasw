...
public abstract class ConstraintHelper extends View {
    ...
    public void init(AttributeSet attributeSet) {
        if (attributeSet != null) {
            ...
            for (int i = 0; i < indexCount; i++) {
                ...
                if (index == C0273R.styleable.ConstraintLayout_Layout_constraint_referenced_ids) {
                    String string = obtainStyledAttributes.getString(index);
                    this.mReferenceIds = string;
                    setIds(string);
                } else if (index == C0273R.styleable.ConstraintLayout_Layout_constraint_referenced_tags) {
    ...
    public void addView(View view) {
        if (view != this) {
            if (view.getId() == -1) {
                SystemUtils.log(6, "ConstraintHelper", "Views added to a ConstraintHelper need to have an id", (Throwable) null, "androidx.constraintlayout.widget.ConstraintHelper", 159);
            } else if (view.getParent() == null) {
                SystemUtils.log(6, "ConstraintHelper", "Views added to a ConstraintHelper need to have a parent", (Throwable) null, "androidx.constraintlayout.widget.ConstraintHelper", 163);
            } else {
    ...
    private void addID(String str) {
        if (str != null && str.length() != 0 && this.myContext != null) {
            ...
            SystemUtils.log(5, "ConstraintHelper", "Could not find id of \"" + trim + Const.jsQuote, (Throwable) null, "androidx.constraintlayout.widget.ConstraintHelper", 289);
        }
    }
    ...
    private void addTag(String str) {
        if (str != null && str.length() != 0 && this.myContext != null) {
            ...
            if (constraintLayout == null) {
                SystemUtils.log(5, "ConstraintHelper", "Parent not a ConstraintLayout", (Throwable) null, "androidx.constraintlayout.widget.ConstraintHelper", 311);
                return;
            }
            ...
            for (int i = 0; i < childCount; i++) {
                ...
                if ((layoutParams instanceof ConstraintLayout.LayoutParams) && trim.equals(((ConstraintLayout.LayoutParams) layoutParams).constraintTag)) {
                    if (childAt.getId() == -1) {
                        SystemUtils.log(5, "ConstraintHelper", "to use ConstraintTag view " + childAt.getClass().getSimpleName() + " must have an ID", (Throwable) null, "androidx.constraintlayout.widget.ConstraintHelper", 322);
                    } else {
    ...
    private int findId(String str) {
        ...
        if (i == 0) {
            try {
                i = C0273R.C0277id.class.getField(str).getInt((Object) null);
