...
public class ConstraintSet {
    ...
    static {
        mapToConstant.append(C0273R.styleable.Constraint_layout_constraintLeft_toLeftOf, 25);
        mapToConstant.append(C0273R.styleable.Constraint_layout_constraintLeft_toRightOf, 26);
        mapToConstant.append(C0273R.styleable.Constraint_layout_constraintRight_toLeftOf, 29);
        mapToConstant.append(C0273R.styleable.Constraint_layout_constraintRight_toRightOf, 30);
        mapToConstant.append(C0273R.styleable.Constraint_layout_constraintTop_toTopOf, 36);
        mapToConstant.append(C0273R.styleable.Constraint_layout_constraintTop_toBottomOf, 35);
        mapToConstant.append(C0273R.styleable.Constraint_layout_constraintBottom_toTopOf, 4);
        mapToConstant.append(C0273R.styleable.Constraint_layout_constraintBottom_toBottomOf, 3);
        mapToConstant.append(C0273R.styleable.Constraint_layout_constraintBaseline_toBaselineOf, 1);
        mapToConstant.append(C0273R.styleable.Constraint_layout_constraintBaseline_toTopOf, 91);
        mapToConstant.append(C0273R.styleable.Constraint_layout_constraintBaseline_toBottomOf, 92);
        mapToConstant.append(C0273R.styleable.Constraint_layout_editor_absoluteX, 6);
        mapToConstant.append(C0273R.styleable.Constraint_layout_editor_absoluteY, 7);
        mapToConstant.append(C0273R.styleable.Constraint_layout_constraintGuide_begin, 17);
        mapToConstant.append(C0273R.styleable.Constraint_layout_constraintGuide_end, 18);
        mapToConstant.append(C0273R.styleable.Constraint_layout_constraintGuide_percent, 19);
        mapToConstant.append(C0273R.styleable.Constraint_guidelineUseRtl, 99);
        mapToConstant.append(C0273R.styleable.Constraint_android_orientation, 27);
        mapToConstant.append(C0273R.styleable.Constraint_layout_constraintStart_toEndOf, 32);
        mapToConstant.append(C0273R.styleable.Constraint_layout_constraintStart_toStartOf, 33);
        mapToConstant.append(C0273R.styleable.Constraint_layout_constraintEnd_toStartOf, 10);
        mapToConstant.append(C0273R.styleable.Constraint_layout_constraintEnd_toEndOf, 9);
        mapToConstant.append(C0273R.styleable.Constraint_layout_goneMarginLeft, 13);
        mapToConstant.append(C0273R.styleable.Constraint_layout_goneMarginTop, 16);
        mapToConstant.append(C0273R.styleable.Constraint_layout_goneMarginRight, 14);
        mapToConstant.append(C0273R.styleable.Constraint_layout_goneMarginBottom, 11);
        mapToConstant.append(C0273R.styleable.Constraint_layout_goneMarginStart, 15);
        mapToConstant.append(C0273R.styleable.Constraint_layout_goneMarginEnd, 12);
        mapToConstant.append(C0273R.styleable.Constraint_layout_constraintVertical_weight, 40);
        mapToConstant.append(C0273R.styleable.Constraint_layout_constraintHorizontal_weight, 39);
        mapToConstant.append(C0273R.styleable.Constraint_layout_constraintHorizontal_chainStyle, 41);
        mapToConstant.append(C0273R.styleable.Constraint_layout_constraintVertical_chainStyle, 42);
        mapToConstant.append(C0273R.styleable.Constraint_layout_constraintHorizontal_bias, 20);
        mapToConstant.append(C0273R.styleable.Constraint_layout_constraintVertical_bias, 37);
        mapToConstant.append(C0273R.styleable.Constraint_layout_constraintDimensionRatio, 5);
        mapToConstant.append(C0273R.styleable.Constraint_layout_constraintLeft_creator, 87);
        mapToConstant.append(C0273R.styleable.Constraint_layout_constraintTop_creator, 87);
        mapToConstant.append(C0273R.styleable.Constraint_layout_constraintRight_creator, 87);
        mapToConstant.append(C0273R.styleable.Constraint_layout_constraintBottom_creator, 87);
        mapToConstant.append(C0273R.styleable.Constraint_layout_constraintBaseline_creator, 87);
        mapToConstant.append(C0273R.styleable.Constraint_android_layout_marginLeft, 24);
        mapToConstant.append(C0273R.styleable.Constraint_android_layout_marginRight, 28);
        mapToConstant.append(C0273R.styleable.Constraint_android_layout_marginStart, 31);
        mapToConstant.append(C0273R.styleable.Constraint_android_layout_marginEnd, 8);
        mapToConstant.append(C0273R.styleable.Constraint_android_layout_marginTop, 34);
        mapToConstant.append(C0273R.styleable.Constraint_android_layout_marginBottom, 2);
        mapToConstant.append(C0273R.styleable.Constraint_android_layout_width, 23);
        mapToConstant.append(C0273R.styleable.Constraint_android_layout_height, 21);
        mapToConstant.append(C0273R.styleable.Constraint_layout_constraintWidth, 95);
        mapToConstant.append(C0273R.styleable.Constraint_layout_constraintHeight, 96);
        mapToConstant.append(C0273R.styleable.Constraint_android_visibility, 22);
        mapToConstant.append(C0273R.styleable.Constraint_android_alpha, 43);
        mapToConstant.append(C0273R.styleable.Constraint_android_elevation, 44);
        mapToConstant.append(C0273R.styleable.Constraint_android_rotationX, 45);
        mapToConstant.append(C0273R.styleable.Constraint_android_rotationY, 46);
        mapToConstant.append(C0273R.styleable.Constraint_android_rotation, 60);
        mapToConstant.append(C0273R.styleable.Constraint_android_scaleX, 47);
        mapToConstant.append(C0273R.styleable.Constraint_android_scaleY, 48);
        mapToConstant.append(C0273R.styleable.Constraint_android_transformPivotX, 49);
        mapToConstant.append(C0273R.styleable.Constraint_android_transformPivotY, 50);
        mapToConstant.append(C0273R.styleable.Constraint_android_translationX, 51);
        mapToConstant.append(C0273R.styleable.Constraint_android_translationY, 52);
        mapToConstant.append(C0273R.styleable.Constraint_android_translationZ, 53);
        mapToConstant.append(C0273R.styleable.Constraint_layout_constraintWidth_default, 54);
        mapToConstant.append(C0273R.styleable.Constraint_layout_constraintHeight_default, 55);
        mapToConstant.append(C0273R.styleable.Constraint_layout_constraintWidth_max, 56);
        mapToConstant.append(C0273R.styleable.Constraint_layout_constraintHeight_max, 57);
        mapToConstant.append(C0273R.styleable.Constraint_layout_constraintWidth_min, 58);
        mapToConstant.append(C0273R.styleable.Constraint_layout_constraintHeight_min, 59);
        mapToConstant.append(C0273R.styleable.Constraint_layout_constraintCircle, 61);
        mapToConstant.append(C0273R.styleable.Constraint_layout_constraintCircleRadius, 62);
        mapToConstant.append(C0273R.styleable.Constraint_layout_constraintCircleAngle, 63);
        mapToConstant.append(C0273R.styleable.Constraint_animateRelativeTo, 64);
        mapToConstant.append(C0273R.styleable.Constraint_transitionEasing, 65);
        mapToConstant.append(C0273R.styleable.Constraint_drawPath, 66);
        mapToConstant.append(C0273R.styleable.Constraint_transitionPathRotate, 67);
        mapToConstant.append(C0273R.styleable.Constraint_motionStagger, 79);
        mapToConstant.append(C0273R.styleable.Constraint_android_id, 38);
        mapToConstant.append(C0273R.styleable.Constraint_motionProgress, 68);
        mapToConstant.append(C0273R.styleable.Constraint_layout_constraintWidth_percent, 69);
        mapToConstant.append(C0273R.styleable.Constraint_layout_constraintHeight_percent, 70);
        mapToConstant.append(C0273R.styleable.Constraint_layout_wrapBehaviorInParent, 97);
        mapToConstant.append(C0273R.styleable.Constraint_chainUseRtl, 71);
        mapToConstant.append(C0273R.styleable.Constraint_barrierDirection, 72);
        mapToConstant.append(C0273R.styleable.Constraint_barrierMargin, 73);
        mapToConstant.append(C0273R.styleable.Constraint_constraint_referenced_ids, 74);
        mapToConstant.append(C0273R.styleable.Constraint_barrierAllowsGoneWidgets, 75);
        mapToConstant.append(C0273R.styleable.Constraint_pathMotionArc, 76);
        mapToConstant.append(C0273R.styleable.Constraint_layout_constraintTag, 77);
        mapToConstant.append(C0273R.styleable.Constraint_visibilityMode, 78);
        mapToConstant.append(C0273R.styleable.Constraint_layout_constrainedWidth, 80);
        mapToConstant.append(C0273R.styleable.Constraint_layout_constrainedHeight, 81);
        mapToConstant.append(C0273R.styleable.Constraint_polarRelativeTo, 82);
        mapToConstant.append(C0273R.styleable.Constraint_transformPivotTarget, 83);
        mapToConstant.append(C0273R.styleable.Constraint_quantizeMotionSteps, 84);
        mapToConstant.append(C0273R.styleable.Constraint_quantizeMotionPhase, 85);
        mapToConstant.append(C0273R.styleable.Constraint_quantizeMotionInterpolator, 86);
        overrideMapToConstant.append(C0273R.styleable.ConstraintOverride_layout_editor_absoluteY, 6);
        overrideMapToConstant.append(C0273R.styleable.ConstraintOverride_layout_editor_absoluteY, 7);
        overrideMapToConstant.append(C0273R.styleable.ConstraintOverride_android_orientation, 27);
        overrideMapToConstant.append(C0273R.styleable.ConstraintOverride_layout_goneMarginLeft, 13);
        overrideMapToConstant.append(C0273R.styleable.ConstraintOverride_layout_goneMarginTop, 16);
        overrideMapToConstant.append(C0273R.styleable.ConstraintOverride_layout_goneMarginRight, 14);
        overrideMapToConstant.append(C0273R.styleable.ConstraintOverride_layout_goneMarginBottom, 11);
        overrideMapToConstant.append(C0273R.styleable.ConstraintOverride_layout_goneMarginStart, 15);
        overrideMapToConstant.append(C0273R.styleable.ConstraintOverride_layout_goneMarginEnd, 12);
        overrideMapToConstant.append(C0273R.styleable.ConstraintOverride_layout_constraintVertical_weight, 40);
        overrideMapToConstant.append(C0273R.styleable.ConstraintOverride_layout_constraintHorizontal_weight, 39);
        overrideMapToConstant.append(C0273R.styleable.ConstraintOverride_layout_constraintHorizontal_chainStyle, 41);
        overrideMapToConstant.append(C0273R.styleable.ConstraintOverride_layout_constraintVertical_chainStyle, 42);
        overrideMapToConstant.append(C0273R.styleable.ConstraintOverride_layout_constraintHorizontal_bias, 20);
        overrideMapToConstant.append(C0273R.styleable.ConstraintOverride_layout_constraintVertical_bias, 37);
        overrideMapToConstant.append(C0273R.styleable.ConstraintOverride_layout_constraintDimensionRatio, 5);
        overrideMapToConstant.append(C0273R.styleable.ConstraintOverride_layout_constraintLeft_creator, 87);
        overrideMapToConstant.append(C0273R.styleable.ConstraintOverride_layout_constraintTop_creator, 87);
        overrideMapToConstant.append(C0273R.styleable.ConstraintOverride_layout_constraintRight_creator, 87);
        overrideMapToConstant.append(C0273R.styleable.ConstraintOverride_layout_constraintBottom_creator, 87);
        overrideMapToConstant.append(C0273R.styleable.ConstraintOverride_layout_constraintBaseline_creator, 87);
        overrideMapToConstant.append(C0273R.styleable.ConstraintOverride_android_layout_marginLeft, 24);
        overrideMapToConstant.append(C0273R.styleable.ConstraintOverride_android_layout_marginRight, 28);
        overrideMapToConstant.append(C0273R.styleable.ConstraintOverride_android_layout_marginStart, 31);
        overrideMapToConstant.append(C0273R.styleable.ConstraintOverride_android_layout_marginEnd, 8);
        overrideMapToConstant.append(C0273R.styleable.ConstraintOverride_android_layout_marginTop, 34);
        overrideMapToConstant.append(C0273R.styleable.ConstraintOverride_android_layout_marginBottom, 2);
        overrideMapToConstant.append(C0273R.styleable.ConstraintOverride_android_layout_width, 23);
        overrideMapToConstant.append(C0273R.styleable.ConstraintOverride_android_layout_height, 21);
        overrideMapToConstant.append(C0273R.styleable.ConstraintOverride_layout_constraintWidth, 95);
        overrideMapToConstant.append(C0273R.styleable.ConstraintOverride_layout_constraintHeight, 96);
        overrideMapToConstant.append(C0273R.styleable.ConstraintOverride_android_visibility, 22);
        overrideMapToConstant.append(C0273R.styleable.ConstraintOverride_android_alpha, 43);
        overrideMapToConstant.append(C0273R.styleable.ConstraintOverride_android_elevation, 44);
        overrideMapToConstant.append(C0273R.styleable.ConstraintOverride_android_rotationX, 45);
        overrideMapToConstant.append(C0273R.styleable.ConstraintOverride_android_rotationY, 46);
        overrideMapToConstant.append(C0273R.styleable.ConstraintOverride_android_rotation, 60);
        overrideMapToConstant.append(C0273R.styleable.ConstraintOverride_android_scaleX, 47);
        overrideMapToConstant.append(C0273R.styleable.ConstraintOverride_android_scaleY, 48);
        overrideMapToConstant.append(C0273R.styleable.ConstraintOverride_android_transformPivotX, 49);
        overrideMapToConstant.append(C0273R.styleable.ConstraintOverride_android_transformPivotY, 50);
        overrideMapToConstant.append(C0273R.styleable.ConstraintOverride_android_translationX, 51);
        overrideMapToConstant.append(C0273R.styleable.ConstraintOverride_android_translationY, 52);
        overrideMapToConstant.append(C0273R.styleable.ConstraintOverride_android_translationZ, 53);
        overrideMapToConstant.append(C0273R.styleable.ConstraintOverride_layout_constraintWidth_default, 54);
        overrideMapToConstant.append(C0273R.styleable.ConstraintOverride_layout_constraintHeight_default, 55);
        overrideMapToConstant.append(C0273R.styleable.ConstraintOverride_layout_constraintWidth_max, 56);
        overrideMapToConstant.append(C0273R.styleable.ConstraintOverride_layout_constraintHeight_max, 57);
        overrideMapToConstant.append(C0273R.styleable.ConstraintOverride_layout_constraintWidth_min, 58);
        overrideMapToConstant.append(C0273R.styleable.ConstraintOverride_layout_constraintHeight_min, 59);
        overrideMapToConstant.append(C0273R.styleable.ConstraintOverride_layout_constraintCircleRadius, 62);
        overrideMapToConstant.append(C0273R.styleable.ConstraintOverride_layout_constraintCircleAngle, 63);
        overrideMapToConstant.append(C0273R.styleable.ConstraintOverride_animateRelativeTo, 64);
        overrideMapToConstant.append(C0273R.styleable.ConstraintOverride_transitionEasing, 65);
        overrideMapToConstant.append(C0273R.styleable.ConstraintOverride_drawPath, 66);
        overrideMapToConstant.append(C0273R.styleable.ConstraintOverride_transitionPathRotate, 67);
        overrideMapToConstant.append(C0273R.styleable.ConstraintOverride_motionStagger, 79);
        overrideMapToConstant.append(C0273R.styleable.ConstraintOverride_android_id, 38);
        overrideMapToConstant.append(C0273R.styleable.ConstraintOverride_motionTarget, 98);
        overrideMapToConstant.append(C0273R.styleable.ConstraintOverride_motionProgress, 68);
        overrideMapToConstant.append(C0273R.styleable.ConstraintOverride_layout_constraintWidth_percent, 69);
        overrideMapToConstant.append(C0273R.styleable.ConstraintOverride_layout_constraintHeight_percent, 70);
        overrideMapToConstant.append(C0273R.styleable.ConstraintOverride_chainUseRtl, 71);
        overrideMapToConstant.append(C0273R.styleable.ConstraintOverride_barrierDirection, 72);
        overrideMapToConstant.append(C0273R.styleable.ConstraintOverride_barrierMargin, 73);
        overrideMapToConstant.append(C0273R.styleable.ConstraintOverride_constraint_referenced_ids, 74);
        overrideMapToConstant.append(C0273R.styleable.ConstraintOverride_barrierAllowsGoneWidgets, 75);
        overrideMapToConstant.append(C0273R.styleable.ConstraintOverride_pathMotionArc, 76);
        overrideMapToConstant.append(C0273R.styleable.ConstraintOverride_layout_constraintTag, 77);
        overrideMapToConstant.append(C0273R.styleable.ConstraintOverride_visibilityMode, 78);
        overrideMapToConstant.append(C0273R.styleable.ConstraintOverride_layout_constrainedWidth, 80);
        overrideMapToConstant.append(C0273R.styleable.ConstraintOverride_layout_constrainedHeight, 81);
        overrideMapToConstant.append(C0273R.styleable.ConstraintOverride_polarRelativeTo, 82);
        overrideMapToConstant.append(C0273R.styleable.ConstraintOverride_transformPivotTarget, 83);
        overrideMapToConstant.append(C0273R.styleable.ConstraintOverride_quantizeMotionSteps, 84);
        overrideMapToConstant.append(C0273R.styleable.ConstraintOverride_quantizeMotionPhase, 85);
        overrideMapToConstant.append(C0273R.styleable.ConstraintOverride_quantizeMotionInterpolator, 86);
        overrideMapToConstant.append(C0273R.styleable.ConstraintOverride_layout_wrapBehaviorInParent, 97);
    }
    ...
    public static class Layout {
        ...
        static {
            ...
            sparseIntArray.append(C0273R.styleable.Layout_layout_constraintLeft_toLeftOf, 24);
            mapToConstant.append(C0273R.styleable.Layout_layout_constraintLeft_toRightOf, 25);
            mapToConstant.append(C0273R.styleable.Layout_layout_constraintRight_toLeftOf, 28);
            mapToConstant.append(C0273R.styleable.Layout_layout_constraintRight_toRightOf, 29);
            mapToConstant.append(C0273R.styleable.Layout_layout_constraintTop_toTopOf, 35);
            mapToConstant.append(C0273R.styleable.Layout_layout_constraintTop_toBottomOf, 34);
            mapToConstant.append(C0273R.styleable.Layout_layout_constraintBottom_toTopOf, 4);
            mapToConstant.append(C0273R.styleable.Layout_layout_constraintBottom_toBottomOf, 3);
            mapToConstant.append(C0273R.styleable.Layout_layout_constraintBaseline_toBaselineOf, 1);
            mapToConstant.append(C0273R.styleable.Layout_layout_editor_absoluteX, 6);
            mapToConstant.append(C0273R.styleable.Layout_layout_editor_absoluteY, 7);
            mapToConstant.append(C0273R.styleable.Layout_layout_constraintGuide_begin, 17);
            mapToConstant.append(C0273R.styleable.Layout_layout_constraintGuide_end, 18);
            mapToConstant.append(C0273R.styleable.Layout_layout_constraintGuide_percent, 19);
            mapToConstant.append(C0273R.styleable.Layout_guidelineUseRtl, 90);
            mapToConstant.append(C0273R.styleable.Layout_android_orientation, 26);
            mapToConstant.append(C0273R.styleable.Layout_layout_constraintStart_toEndOf, 31);
            mapToConstant.append(C0273R.styleable.Layout_layout_constraintStart_toStartOf, 32);
            mapToConstant.append(C0273R.styleable.Layout_layout_constraintEnd_toStartOf, 10);
            mapToConstant.append(C0273R.styleable.Layout_layout_constraintEnd_toEndOf, 9);
            mapToConstant.append(C0273R.styleable.Layout_layout_goneMarginLeft, 13);
            mapToConstant.append(C0273R.styleable.Layout_layout_goneMarginTop, 16);
            mapToConstant.append(C0273R.styleable.Layout_layout_goneMarginRight, 14);
            mapToConstant.append(C0273R.styleable.Layout_layout_goneMarginBottom, 11);
            mapToConstant.append(C0273R.styleable.Layout_layout_goneMarginStart, 15);
            mapToConstant.append(C0273R.styleable.Layout_layout_goneMarginEnd, 12);
            mapToConstant.append(C0273R.styleable.Layout_layout_constraintVertical_weight, 38);
            mapToConstant.append(C0273R.styleable.Layout_layout_constraintHorizontal_weight, 37);
            mapToConstant.append(C0273R.styleable.Layout_layout_constraintHorizontal_chainStyle, 39);
            mapToConstant.append(C0273R.styleable.Layout_layout_constraintVertical_chainStyle, 40);
            mapToConstant.append(C0273R.styleable.Layout_layout_constraintHorizontal_bias, 20);
            mapToConstant.append(C0273R.styleable.Layout_layout_constraintVertical_bias, 36);
            mapToConstant.append(C0273R.styleable.Layout_layout_constraintDimensionRatio, 5);
            mapToConstant.append(C0273R.styleable.Layout_layout_constraintLeft_creator, 91);
            mapToConstant.append(C0273R.styleable.Layout_layout_constraintTop_creator, 91);
            mapToConstant.append(C0273R.styleable.Layout_layout_constraintRight_creator, 91);
            mapToConstant.append(C0273R.styleable.Layout_layout_constraintBottom_creator, 91);
            mapToConstant.append(C0273R.styleable.Layout_layout_constraintBaseline_creator, 91);
            mapToConstant.append(C0273R.styleable.Layout_android_layout_marginLeft, 23);
            mapToConstant.append(C0273R.styleable.Layout_android_layout_marginRight, 27);
            mapToConstant.append(C0273R.styleable.Layout_android_layout_marginStart, 30);
            mapToConstant.append(C0273R.styleable.Layout_android_layout_marginEnd, 8);
            mapToConstant.append(C0273R.styleable.Layout_android_layout_marginTop, 33);
            mapToConstant.append(C0273R.styleable.Layout_android_layout_marginBottom, 2);
            mapToConstant.append(C0273R.styleable.Layout_android_layout_width, 22);
            mapToConstant.append(C0273R.styleable.Layout_android_layout_height, 21);
            mapToConstant.append(C0273R.styleable.Layout_layout_constraintWidth, 41);
            mapToConstant.append(C0273R.styleable.Layout_layout_constraintHeight, 42);
            mapToConstant.append(C0273R.styleable.Layout_layout_constrainedWidth, 41);
            mapToConstant.append(C0273R.styleable.Layout_layout_constrainedHeight, 42);
            mapToConstant.append(C0273R.styleable.Layout_layout_wrapBehaviorInParent, 76);
            mapToConstant.append(C0273R.styleable.Layout_layout_constraintCircle, 61);
            mapToConstant.append(C0273R.styleable.Layout_layout_constraintCircleRadius, 62);
            mapToConstant.append(C0273R.styleable.Layout_layout_constraintCircleAngle, 63);
            mapToConstant.append(C0273R.styleable.Layout_layout_constraintWidth_percent, 69);
            mapToConstant.append(C0273R.styleable.Layout_layout_constraintHeight_percent, 70);
            mapToConstant.append(C0273R.styleable.Layout_chainUseRtl, 71);
            mapToConstant.append(C0273R.styleable.Layout_barrierDirection, 72);
            mapToConstant.append(C0273R.styleable.Layout_barrierMargin, 73);
            mapToConstant.append(C0273R.styleable.Layout_constraint_referenced_ids, 74);
            mapToConstant.append(C0273R.styleable.Layout_barrierAllowsGoneWidgets, 75);
        }

        /* access modifiers changed from: package-private */
        public void fillFromAttributeList(Context context, AttributeSet attributeSet) {
            TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C0273R.styleable.Layout);
            this.mApply = true;
                            ...
                            default:
                                switch (i2) {
                                    ...
                                    case 70:
                                        ...
                                        break;
                                    case 71:
                                        SystemUtils.log(6, ConstraintSet.TAG, "CURRENTLY UNSUPPORTED", (Throwable) null, "androidx.constraintlayout.widget.ConstraintSet$Layout", 1457);
                                        break;
                                    case 72:
                                    ...
                                    case 90:
                                        ...
                                        break;
                                    case 91:
                                        SystemUtils.log(5, ConstraintSet.TAG, "unused attribute 0x" + Integer.toHexString(index) + "   " + mapToConstant.get(index), (Throwable) null, "androidx.constraintlayout.widget.ConstraintSet$Layout", 1479);
                                        break;
                                    default:
                                        SystemUtils.log(5, ConstraintSet.TAG, "Unknown attribute 0x" + Integer.toHexString(index) + "   " + mapToConstant.get(index), (Throwable) null, "androidx.constraintlayout.widget.ConstraintSet$Layout", 1483);
                                        break;
                                }
                        }
                }
    ...
    public static class Transform {
        ...
        static {
            SparseIntArray sparseIntArray = new SparseIntArray();
            mapToConstant = sparseIntArray;
            sparseIntArray.append(C0273R.styleable.Transform_android_rotation, 1);
            mapToConstant.append(C0273R.styleable.Transform_android_rotationX, 2);
            mapToConstant.append(C0273R.styleable.Transform_android_rotationY, 3);
            mapToConstant.append(C0273R.styleable.Transform_android_scaleX, 4);
            mapToConstant.append(C0273R.styleable.Transform_android_scaleY, 5);
            mapToConstant.append(C0273R.styleable.Transform_android_transformPivotX, 6);
            mapToConstant.append(C0273R.styleable.Transform_android_transformPivotY, 7);
            mapToConstant.append(C0273R.styleable.Transform_android_translationX, 8);
            mapToConstant.append(C0273R.styleable.Transform_android_translationY, 9);
            mapToConstant.append(C0273R.styleable.Transform_android_translationZ, 10);
            mapToConstant.append(C0273R.styleable.Transform_android_elevation, 11);
            mapToConstant.append(C0273R.styleable.Transform_transformPivotTarget, 12);
        }

        /* access modifiers changed from: package-private */
        public void fillFromAttributeList(Context context, AttributeSet attributeSet) {
            TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C0273R.styleable.Transform);
            this.mApply = true;
            int indexCount = obtainStyledAttributes.getIndexCount();
            for (int i = 0; i < indexCount; i++) {
                int index = obtainStyledAttributes.getIndex(i);
    ...
    public static class PropertySet {
        ...
        /* access modifiers changed from: package-private */
        public void fillFromAttributeList(Context context, AttributeSet attributeSet) {
            TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C0273R.styleable.PropertySet);
            this.mApply = true;
            int indexCount = obtainStyledAttributes.getIndexCount();
            for (int i = 0; i < indexCount; i++) {
                int index = obtainStyledAttributes.getIndex(i);
                if (index == C0273R.styleable.PropertySet_android_alpha) {
                    this.alpha = obtainStyledAttributes.getFloat(index, this.alpha);
                } else if (index == C0273R.styleable.PropertySet_android_visibility) {
                    this.visibility = obtainStyledAttributes.getInt(index, this.visibility);
                    this.visibility = ConstraintSet.VISIBILITY_FLAGS[this.visibility];
                } else if (index == C0273R.styleable.PropertySet_visibilityMode) {
                    this.mVisibilityMode = obtainStyledAttributes.getInt(index, this.mVisibilityMode);
                } else if (index == C0273R.styleable.PropertySet_motionProgress) {
    ...
    public static class Motion {
        ...
        static {
            SparseIntArray sparseIntArray = new SparseIntArray();
            mapToConstant = sparseIntArray;
            sparseIntArray.append(C0273R.styleable.Motion_motionPathRotate, 1);
            mapToConstant.append(C0273R.styleable.Motion_pathMotionArc, 2);
            mapToConstant.append(C0273R.styleable.Motion_transitionEasing, 3);
            mapToConstant.append(C0273R.styleable.Motion_drawPath, 4);
            mapToConstant.append(C0273R.styleable.Motion_animateRelativeTo, 5);
            mapToConstant.append(C0273R.styleable.Motion_animateCircleAngleTo, 6);
            mapToConstant.append(C0273R.styleable.Motion_motionStagger, 7);
            mapToConstant.append(C0273R.styleable.Motion_quantizeMotionSteps, 8);
            mapToConstant.append(C0273R.styleable.Motion_quantizeMotionPhase, 9);
            mapToConstant.append(C0273R.styleable.Motion_quantizeMotionInterpolator, 10);
        }

        /* access modifiers changed from: package-private */
        public void fillFromAttributeList(Context context, AttributeSet attributeSet) {
            TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C0273R.styleable.Motion);
            this.mApply = true;
            int indexCount = obtainStyledAttributes.getIndexCount();
            for (int i = 0; i < indexCount; i++) {
                int index = obtainStyledAttributes.getIndex(i);
    ...
    public static class Constraint {
        ...
        static class Delta {
            ...
            public void printDelta(String str) {
                SystemUtils.log(2, str, "int", (Throwable) null, "androidx.constraintlayout.widget.ConstraintSet$Constraint$Delta", 1911);
                for (int i = 0; i < this.mCountInt; i++) {
                    SystemUtils.log(2, str, this.mTypeInt[i] + " = " + this.mValueInt[i], (Throwable) null, "androidx.constraintlayout.widget.ConstraintSet$Constraint$Delta", 1914);
                }
                SystemUtils.log(2, str, "float", (Throwable) null, "androidx.constraintlayout.widget.ConstraintSet$Constraint$Delta", 1916);
                for (int i2 = 0; i2 < this.mCountFloat; i2++) {
                    SystemUtils.log(2, str, this.mTypeFloat[i2] + " = " + this.mValueFloat[i2], (Throwable) null, "androidx.constraintlayout.widget.ConstraintSet$Constraint$Delta", 1919);
                }
                SystemUtils.log(2, str, "strings", (Throwable) null, "androidx.constraintlayout.widget.ConstraintSet$Constraint$Delta", 1921);
                for (int i3 = 0; i3 < this.mCountString; i3++) {
                    SystemUtils.log(2, str, this.mTypeString[i3] + " = " + this.mValueString[i3], (Throwable) null, "androidx.constraintlayout.widget.ConstraintSet$Constraint$Delta", 1924);
                }
                SystemUtils.log(2, str, TypedValues.Custom.S_BOOLEAN, (Throwable) null, "androidx.constraintlayout.widget.ConstraintSet$Constraint$Delta", 1926);
                for (int i4 = 0; i4 < this.mCountBoolean; i4++) {
                    SystemUtils.log(2, str, this.mTypeBoolean[i4] + " = " + this.mValueBoolean[i4], (Throwable) null, "androidx.constraintlayout.widget.ConstraintSet$Constraint$Delta", 1928);
                }
            }
        }
        ...
        public void printDelta(String str) {
            ...
            if (delta != null) {
                ...
                SystemUtils.log(2, str, "DELTA IS NULL", (Throwable) null, "androidx.constraintlayout.widget.ConstraintSet$Constraint", 1943);
            }
        }
    ...
    public void applyCustomAttributes(ConstraintLayout constraintLayout) {
        ...
        for (int i = 0; i < childCount; i++) {
            ...
            int id = childAt.getId();
            if (!this.mConstraints.containsKey(Integer.valueOf(id))) {
                SystemUtils.log(5, TAG, "id unknown " + Debug.getName(childAt), (Throwable) null, "androidx.constraintlayout.widget.ConstraintSet", 2312);
    ...
    public void applyToInternal(ConstraintLayout constraintLayout, boolean z) {
        ...
        for (int i = 0; i < childCount; i++) {
            ...
            int id = childAt.getId();
            if (!this.mConstraints.containsKey(Integer.valueOf(id))) {
                SystemUtils.log(5, TAG, "id unknown " + Debug.getName(childAt), (Throwable) null, "androidx.constraintlayout.widget.ConstraintSet", 2373);
            } else if (this.mForceId && id == -1) {
                throw new RuntimeException("All children of ConstraintLayout must have ids to use ConstraintSet");
            } else if (id != -1) {
                if (this.mConstraints.containsKey(Integer.valueOf(id))) {
                    ...
                    SystemUtils.log(2, TAG, "WARNING NO CONSTRAINTS for view " + id, (Throwable) null, "androidx.constraintlayout.widget.ConstraintSet", 2456);
                }
            }
        }
    ...
    public void parseIntAttributes(Constraint constraint, String str) {
        ...
        for (int i = 0; i < split.length; i++) {
            ...
            if (split2.length != 2) {
                SystemUtils.log(5, TAG, " Unable to parse " + split[i], (Throwable) null, "androidx.constraintlayout.widget.ConstraintSet", 3979);
            } else {
    ...
    public void parseColorAttributes(Constraint constraint, String str) {
        ...
        for (int i = 0; i < split.length; i++) {
            String[] split2 = split[i].split("=");
            if (split2.length != 2) {
                SystemUtils.log(5, TAG, " Unable to parse " + split[i], (Throwable) null, "androidx.constraintlayout.widget.ConstraintSet", 3991);
            } else {
    ...
    public void parseFloatAttributes(Constraint constraint, String str) {
        ...
        for (int i = 0; i < split.length; i++) {
            String[] split2 = split[i].split("=");
            if (split2.length != 2) {
                SystemUtils.log(5, TAG, " Unable to parse " + split[i], (Throwable) null, "androidx.constraintlayout.widget.ConstraintSet", 4003);
            } else {
    ...
    public void parseStringAttributes(Constraint constraint, String str) {
        ...
        for (int i = 0; i < splitString.length; i++) {
            ...
            SystemUtils.log(5, TAG, " Unable to parse " + splitString[i], (Throwable) null, "androidx.constraintlayout.widget.ConstraintSet", 4014);
    ...
    private Constraint fillFromAttributeList(Context context, AttributeSet attributeSet, boolean z) {
        Constraint constraint = new Constraint();
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, z ? C0273R.styleable.ConstraintOverride : C0273R.styleable.Constraint);
    ...
    public static Constraint buildDelta(Context context, XmlPullParser xmlPullParser) {
        ...
        Constraint constraint = new Constraint();
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(asAttributeSet, C0273R.styleable.ConstraintOverride);
        ...
        for (int i = 0; i < indexCount; i++) {
            ...
            switch (overrideMapToConstant.get(index)) {
                ...
                case 70:
                    ...
                    break;
                case 71:
                    SystemUtils.log(6, TAG, "CURRENTLY UNSUPPORTED", (Throwable) null, "androidx.constraintlayout.widget.ConstraintSet", 4556);
                    break;
                case 72:
                ...
                case 87:
                    SystemUtils.log(5, TAG, "unused attribute 0x" + Integer.toHexString(index) + "   " + mapToConstant.get(index), (Throwable) null, "androidx.constraintlayout.widget.ConstraintSet", 4575);
                    break;
                case 93:
                ...
                case 99:
                    ...
                    break;
                default:
                    SystemUtils.log(5, TAG, "Unknown attribute 0x" + Integer.toHexString(index) + "   " + mapToConstant.get(index), (Throwable) null, "androidx.constraintlayout.widget.ConstraintSet", 4579);
                    break;
            }
        }
    }
                    ...
                    default:
                        switch (i) {
                            ...
                            case 70:
                                ...
                                return;
                            default:
                                SystemUtils.log(5, TAG, "Unknown attribute 0x", (Throwable) null, "androidx.constraintlayout.widget.ConstraintSet", 4663);
                                return;
                        }
                }
            } else {
                                        ...
                                        default:
                                            switch (i) {
                                                ...
                                                case 89:
                                                    ...
                                                    return;
                                                default:
                                                    SystemUtils.log(5, TAG, "Unknown attribute 0x", (Throwable) null, "androidx.constraintlayout.widget.ConstraintSet", 4808);
                                                    return;
                                            }
                                    }
                            }
    ...
    public static void setDeltaValue(Constraint constraint, int i, String str) {
        if (i == 5) {
            ...
            if (i != 90) {
                SystemUtils.log(5, TAG, "Unknown attribute 0x", (Throwable) null, "androidx.constraintlayout.widget.ConstraintSet", 4835);
            } else {
    ...
    public static void setDeltaValue(Constraint constraint, int i, boolean z) {
        if (i == 44) {
            ...
            if (i == 80) {
                ...
                SystemUtils.log(5, TAG, "Unknown attribute 0x", (Throwable) null, "androidx.constraintlayout.widget.ConstraintSet", 4857);
            } else {
    ...
    private void populateConstraint(Context context, Constraint constraint, TypedArray typedArray, boolean z) {
        ...
        for (int i = 0; i < indexCount; i++) {
            int index = typedArray.getIndex(i);
            if (!(index == C0273R.styleable.Constraint_android_id || C0273R.styleable.Constraint_android_layout_marginStart == index || C0273R.styleable.Constraint_android_layout_marginEnd == index)) {
            ...
            switch (mapToConstant.get(index)) {
                ...
                case 70:
                    ...
                    break;
                case 71:
                    SystemUtils.log(6, TAG, "CURRENTLY UNSUPPORTED", (Throwable) null, "androidx.constraintlayout.widget.ConstraintSet", 5221);
                    break;
                case 72:
                ...
                case 87:
                    SystemUtils.log(5, TAG, "unused attribute 0x" + Integer.toHexString(index) + "   " + mapToConstant.get(index), (Throwable) null, "androidx.constraintlayout.widget.ConstraintSet", 5240);
                    break;
                case 91:
                ...
                case 97:
                    ...
                    break;
                default:
                    SystemUtils.log(5, TAG, "Unknown attribute 0x" + Integer.toHexString(index) + "   " + mapToConstant.get(index), (Throwable) null, "androidx.constraintlayout.widget.ConstraintSet", 5244);
                    break;
            }
        }
    ...
    private int[] convertReferenceString(View view, String str) {
        ...
        while (i2 < split.length) {
            ...
            try {
                i = C0273R.C0277id.class.getField(trim).getInt((Object) null);
    ...
    static String getLine(Context context, int i, XmlPullParser xmlPullParser) {
        return ".(" + Debug.getName(context, i) + ".xml:" + xmlPullParser.getLineNumber() + ") \"" + xmlPullParser.getName() + Const.jsQuote;
    }
    ...
    class WriteXmlEngine {
        ...
        private void writeEnum(String str, int i, String[] strArr, int i2) throws IOException {
            if (i != i2) {
                Writer writer2 = this.writer;
                writer2.write(SPACE + str + "=\"" + strArr[i] + Const.jsQuote);
            }
        }
        ...
        public void writeXmlConstraint(String str, int i) throws IOException {
            if (i != -1) {
                ...
                Writer writer3 = this.writer;
                writer3.write("=\"" + getName(i) + Const.jsQuote);
            }
        }
        ...
        public void writeCircle(int i, float f, int i2) throws IOException {
            if (i != -1) {
                ...
                writer2.write(", " + f);
                Writer writer3 = this.writer;
                writer3.write(i2 + Const.jaRight);
            }
        }
        ...
        public void writeVariable(String str, String str2, String str3) throws IOException {
            if (str2 != null && !str2.equals(str3)) {
                ...
                writer2.write(SPACE + str);
                Writer writer3 = this.writer;
                writer3.write("=\"" + str2 + Const.jsQuote);
            }
        }
