    ...
    public void updateItems() {
        ...
        if (adapter != null && this.mMotionLayout != null && adapter.count() != 0) {
            ...
            if (this.backwardTransition == -1 || this.forwardTransition == -1) {
                SystemUtils.log(5, TAG, "No backward or forward transitions defined for Carousel!", (Throwable) null, "androidx.constraintlayout.helper.widget.Carousel", 435);
