...
public class MotionEffect extends MotionHelper {
    ...
    private void init(Context context, AttributeSet attributeSet) {
        if (attributeSet != null) {
            TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C0273R.styleable.MotionEffect);
            int indexCount = obtainStyledAttributes.getIndexCount();
            for (int i = 0; i < indexCount; i++) {
                int index = obtainStyledAttributes.getIndex(i);
                if (index == C0273R.styleable.MotionEffect_motionEffect_start) {
                ...
                } else if (index == C0273R.styleable.MotionEffect_motionEffect_end) {
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:51:0x018f, code lost:
        if (r14 == 0.0f) goto L_0x0191;
     */
    ...
    public void onPreSetup(androidx.constraintlayout.motion.widget.MotionLayout r22, java.util.HashMap<android.view.View, androidx.constraintlayout.motion.widget.MotionController> r23) {
        /*
            ...
            java.lang.String r7 = "androidx.constraintlayout.helper.widget.MotionEffect"
