...
public class MotionLayout extends ConstraintLayout implements NestedScrollingParent3 {
    ...
    public void setState(TransitionState transitionState) {
        if (transitionState != TransitionState.FINISHED || this.mCurrentState != -1) {
            ...
            int i = C02575.f102xabc7e4ac[transitionState2.ordinal()];
            if (i == 1 || i == 2) {
    ...
    static /* synthetic */ class C02575 {
        ...
        static {
            ...
            L_0x0012:
                int[] r0 = f102xabc7e4ac     // Catch:{ NoSuchFieldError -> 0x001d }
            ...
            L_0x001d:
                int[] r0 = f102xabc7e4ac     // Catch:{ NoSuchFieldError -> 0x0028 }
            ...
            L_0x0028:
                int[] r0 = f102xabc7e4ac     // Catch:{ NoSuchFieldError -> 0x0033 }
            ...
            L_0x0033:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: androidx.constraintlayout.motion.widget.MotionLayout.C02575.<clinit>():void");
        }
    }
    ...
    private static class MyTracker implements MotionTracker {
        ...
        /* renamed from: me */
        private static MyTracker f103me = new MyTracker();
        ...
        public static MyTracker obtain() {
            f103me.tracker = VelocityTracker.obtain();
            return f103me;
        }
    ...
    public void setTransition(int i) {
        if (this.mScene != null) {
            ...
            if (Float.isNaN(f)) {
                SystemUtils.log(2, TAG, Debug.getLocation() + " transitionToStart ", (Throwable) null, "androidx.constraintlayout.motion.widget.MotionLayout", 1409);
                transitionToStart();
                return;
            }
            setProgress(f);
    ...
    public void setProgress(float f) {
        ...
        if (i < 0 || f > 1.0f) {
            SystemUtils.log(5, TAG, "Warning! Progress is defined for values between 0.0 and 1.0 inclusive", (Throwable) null, "androidx.constraintlayout.motion.widget.MotionLayout", 1707);
        }
        if (!isAttachedToWindow()) {
            if (this.mStateCache == null) {
                this.mStateCache = new StateCache();
    ...
    class Model {
        ...
        private void debugLayoutParam(String str, ConstraintLayout.LayoutParams layoutParams) {
            ...
            sb.append(" ");
            sb.append(layoutParams.startToStart != -1 ? "SS" : qqqqyq.bb006200620062bb);
            ...
            SystemUtils.log(2, MotionLayout.TAG, str + sb24, (Throwable) null, "androidx.constraintlayout.motion.widget.MotionLayout$Model", 2686);
        }
        ...
        private void debugWidget(String str, ConstraintWidget constraintWidget) {
            ...
            String str5 = "B";
            String str6 = qqqqyq.bb006200620062bb;
            ...
            SystemUtils.log(2, MotionLayout.TAG, str + sb12 + " ---  " + constraintWidget, (Throwable) null, "androidx.constraintlayout.motion.widget.MotionLayout$Model", 2696);
        }

        private void debugLayout(String str, ConstraintWidgetContainer constraintWidgetContainer) {
            String str2 = str + " " + Debug.getName((View) constraintWidgetContainer.getCompanionWidget());
            SystemUtils.log(2, MotionLayout.TAG, str2 + "  ========= " + constraintWidgetContainer, (Throwable) null, "androidx.constraintlayout.motion.widget.MotionLayout$Model", 2703);
            int size = constraintWidgetContainer.getChildren().size();
            for (int i = 0; i < size; i++) {
                String str3 = str2 + Const.jaLeft + i + "] ";
                ...
                SystemUtils.log(2, MotionLayout.TAG, str3 + "  " + name + " " + constraintWidget + " " + sb8, (Throwable) null, "androidx.constraintlayout.motion.widget.MotionLayout$Model", 2718);
            }
            SystemUtils.log(2, MotionLayout.TAG, str2 + " done. ", (Throwable) null, "androidx.constraintlayout.motion.widget.MotionLayout$Model", 2720);
        }
        ...
        /* JADX WARNING: Removed duplicated region for block: B:38:0x0145 A[SYNTHETIC] */
        /* Code decompiled incorrectly, please refer to instructions dump. */
        public void build() {
            /*
                r22 = this;
            ...
            L_0x0079:
                ...
                java.lang.String r17 = "MotionLayout"
                java.lang.String r20 = "androidx.constraintlayout.motion.widget.MotionLayout$Model"
            ...
            L_0x0109:
                ...
                r8 = 6
                r11 = 0
                r13 = 2843(0xb1b, float:3.984E-42)
                java.lang.String r9 = "MotionLayout"
                java.lang.String r12 = "androidx.constraintlayout.motion.widget.MotionLayout$Model"
    ...
    private void debugPos() {
        for (int i = 0; i < getChildCount(); i++) {
            View childAt = getChildAt(i);
            SystemUtils.log(2, TAG, " " + Debug.getLocation() + " " + Debug.getName(this) + " " + Debug.getName(getContext(), this.mCurrentState) + " " + Debug.getName(childAt) + childAt.getLeft() + " " + childAt.getTop(), (Throwable) null, "androidx.constraintlayout.motion.widget.MotionLayout", 3449);
        }
    }
    ...
    private void init(AttributeSet attributeSet) {
        ...
        if (attributeSet != null) {
            TypedArray obtainStyledAttributes = getContext().obtainStyledAttributes(attributeSet, C0273R.styleable.MotionLayout);
            int indexCount = obtainStyledAttributes.getIndexCount();
            boolean z = true;
            for (int i = 0; i < indexCount; i++) {
                int index = obtainStyledAttributes.getIndex(i);
                if (index == C0273R.styleable.MotionLayout_layoutDescription) {
                    this.mScene = new MotionScene(getContext(), this, obtainStyledAttributes.getResourceId(index, -1));
                } else if (index == C0273R.styleable.MotionLayout_currentState) {
                    this.mCurrentState = obtainStyledAttributes.getResourceId(index, -1);
                } else if (index == C0273R.styleable.MotionLayout_motionProgress) {
                    this.mTransitionGoalPosition = obtainStyledAttributes.getFloat(index, 0.0f);
                    this.mInTransition = true;
                } else if (index == C0273R.styleable.MotionLayout_applyMotionScene) {
                    z = obtainStyledAttributes.getBoolean(index, z);
                } else if (index == C0273R.styleable.MotionLayout_showPaths) {
                    if (this.mDebugPath == 0) {
                        this.mDebugPath = obtainStyledAttributes.getBoolean(index, false) ? 2 : 0;
                    }
                } else if (index == C0273R.styleable.MotionLayout_motionDebug) {
                    this.mDebugPath = obtainStyledAttributes.getInt(index, 0);
                }
            }
            obtainStyledAttributes.recycle();
            if (this.mScene == null) {
                SystemUtils.log(6, TAG, "WARNING NO app:layoutDescription tag", (Throwable) null, "androidx.constraintlayout.motion.widget.MotionLayout", 3857);
            }
            if (!z) {
                this.mScene = null;
            }
    ...
    private void checkStructure() {
        MotionScene motionScene = this.mScene;
        if (motionScene == null) {
            SystemUtils.log(6, TAG, "CHECK: motion scene not set! set \"app:layoutDescription=\"@xml/file\"", (Throwable) null, "androidx.constraintlayout.motion.widget.MotionLayout", 3901);
            return;
        }
        ...
        while (it.hasNext()) {
            ...
            if (next == this.mScene.mCurrentTransition) {
                SystemUtils.log(2, TAG, "CHECK: CURRENT", (Throwable) null, "androidx.constraintlayout.motion.widget.MotionLayout", 3910);
            }
            checkStructure(next);
            ...
            if (sparseIntArray.get(startConstraintSetId) == endConstraintSetId) {
                SystemUtils.log(6, TAG, "CHECK: two transitions with the same start and end " + name + "->" + name2, (Throwable) null, "androidx.constraintlayout.motion.widget.MotionLayout", 3919);
            }
            if (sparseIntArray2.get(endConstraintSetId) == startConstraintSetId) {
                SystemUtils.log(6, TAG, "CHECK: you can't have reverse transitions" + name + "->" + name2, (Throwable) null, "androidx.constraintlayout.motion.widget.MotionLayout", 3924);
            }
            sparseIntArray.put(startConstraintSetId, endConstraintSetId);
            sparseIntArray2.put(endConstraintSetId, startConstraintSetId);
            if (this.mScene.getConstraintSet(startConstraintSetId) == null) {
                SystemUtils.log(6, TAG, " no such constraintSetStart " + name, (Throwable) null, "androidx.constraintlayout.motion.widget.MotionLayout", 3930);
            }
            if (this.mScene.getConstraintSet(endConstraintSetId) == null) {
                SystemUtils.log(6, TAG, " no such constraintSetEnd " + name, (Throwable) null, "androidx.constraintlayout.motion.widget.MotionLayout", 3934);
            }
        }
    }
    ...
    private void checkStructure(int i, ConstraintSet constraintSet) {
        ...
        for (int i2 = 0; i2 < childCount; i2++) {
            ...
            if (id == -1) {
                SystemUtils.log(5, TAG, "CHECK: " + name + " ALL VIEWS SHOULD HAVE ID's " + childAt.getClass().getName() + " does not!", (Throwable) null, "androidx.constraintlayout.motion.widget.MotionLayout", 3946);
            }
            if (constraintSet2.getConstraint(id) == null) {
                SystemUtils.log(5, TAG, "CHECK: " + name + " NO CONSTRAINTS for " + Debug.getName(childAt), (Throwable) null, "androidx.constraintlayout.motion.widget.MotionLayout", 3951);
            }
        }
        ...
        for (int i3 = 0; i3 < knownIds.length; i3++) {
            ...
            if (findViewById(knownIds[i3]) == null) {
                SystemUtils.log(5, TAG, "CHECK: " + name + " NO View matches id " + name2, (Throwable) null, "androidx.constraintlayout.motion.widget.MotionLayout", 3959);
            }
            if (constraintSet2.getHeight(i4) == -1) {
                SystemUtils.log(5, TAG, "CHECK: " + name + "(" + name2 + ") no LAYOUT_HEIGHT", (Throwable) null, "androidx.constraintlayout.motion.widget.MotionLayout", 3962);
            }
            if (constraintSet2.getWidth(i4) == -1) {
                SystemUtils.log(5, TAG, "CHECK: " + name + "(" + name2 + ") no LAYOUT_HEIGHT", (Throwable) null, "androidx.constraintlayout.motion.widget.MotionLayout", 3965);
            }
        }
    }
    ...
    private void checkStructure(MotionScene.Transition transition) {
        if (transition.getStartConstraintSetId() == transition.getEndConstraintSetId()) {
            SystemUtils.log(6, TAG, "CHECK: start and end constraint set should not be the same!", (Throwable) null, "androidx.constraintlayout.motion.widget.MotionLayout", 3976);
        }
    }
    ...
    public void getAnchorDpDt(int i, float f, float f2, float f3, float[] fArr) {
        ...
        SystemUtils.log(5, TAG, "WARNING could not find view id " + str, (Throwable) null, "androidx.constraintlayout.motion.widget.MotionLayout", 4266);
    }
    ...
    public void rebuildMotion() {
        SystemUtils.log(6, TAG, "This method is deprecated. Please call rebuildScene() instead.", (Throwable) null, "androidx.constraintlayout.motion.widget.MotionLayout", 4594);
        rebuildScene();
    }
    ...
    public void updateStateAnimate(int i, ConstraintSet constraintSet, int i2) {
        if (this.mScene != null && this.mCurrentState == i) {
            updateState(C0273R.C0277id.view_transition, getConstraintSet(i));
            setState(C0273R.C0277id.view_transition, -1, -1);
            updateState(i, constraintSet);
            MotionScene.Transition transition = new MotionScene.Transition(-1, this.mScene, C0273R.C0277id.view_transition, i);
    ...
    public void setTransitionDuration(int i) {
        MotionScene motionScene = this.mScene;
        if (motionScene == null) {
            SystemUtils.log(6, TAG, "MotionScene not defined", (Throwable) null, "androidx.constraintlayout.motion.widget.MotionLayout", 4722);
        } else {
    ...
    public void viewTransition(int i, View... viewArr) {
        ...
        if (motionScene != null) {
            ...
            SystemUtils.log(6, TAG, " no motionScene", (Throwable) null, "androidx.constraintlayout.motion.widget.MotionLayout", 4821);
        }
    }
