...
public class ViewTransitionController {
    ...
    private void viewTransition(ViewTransition viewTransition, View... viewArr) {
        ...
        if (viewTransition.mViewTransitionMode == 2) {
            ...
            String str = this.TAG;
            SystemUtils.log(5, str, "No support for ViewTransition within transition yet. Currently: " + this.mMotionLayout.toString(), (Throwable) null, "androidx.constraintlayout.motion.widget.ViewTransitionController", 74);
        } else {
    ...
    public void viewTransition(int i, View... viewArr) {
        ...
        if (viewTransition == null) {
            SystemUtils.log(6, this.TAG, " Could not find ViewTransition", (Throwable) null, "androidx.constraintlayout.motion.widget.ViewTransitionController", 130);
        }
    }
