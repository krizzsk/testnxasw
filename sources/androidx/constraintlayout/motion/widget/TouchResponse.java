...
class TouchResponse {
    ...
    private void fillFromAttributeList(Context context, AttributeSet attributeSet) {
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C0273R.styleable.OnSwipe);
    ...
    private void fill(TypedArray typedArray) {
        ...
        for (int i = 0; i < indexCount; i++) {
            ...
            if (index == C0273R.styleable.OnSwipe_touchAnchorId) {
                this.mTouchAnchorId = typedArray.getResourceId(index, this.mTouchAnchorId);
            } else if (index == C0273R.styleable.OnSwipe_touchAnchorSide) {
            ...
            } else if (index == C0273R.styleable.OnSwipe_dragDirection) {
    ...
    /* JADX WARNING: Removed duplicated region for block: B:58:0x02bc  */
    /* JADX WARNING: Removed duplicated region for block: B:59:0x02c9  */
    /* JADX WARNING: Removed duplicated region for block: B:66:0x02da  */
    ...
    public void processTouchRotateEvent(android.view.MotionEvent r24, androidx.constraintlayout.motion.widget.MotionLayout.MotionTracker r25, int r26, androidx.constraintlayout.motion.widget.MotionScene r27) {
        ...
        L_0x006c:
            ...
            r13 = 6
            r16 = 0
            r18 = 280(0x118, float:3.92E-43)
            java.lang.String r14 = "TouchResponse"
            java.lang.String r15 = "could not find view to animate to"
            java.lang.String r17 = "androidx.constraintlayout.motion.widget.TouchResponse"
    ...
    public void setupTouch() {
        ...
        if (i != -1) {
            ...
            if (view == null) {
                SystemUtils.log(6, TAG, "cannot find TouchAnchorId @id/" + Debug.getName(this.mMotionLayout.getContext(), this.mTouchAnchorId), (Throwable) null, "androidx.constraintlayout.motion.widget.TouchResponse", 666);
            }
        } else {
            view = null;
        }
