...
class MotionConstrainedPoint implements Comparable<MotionConstrainedPoint> {
    ...
    public void different(MotionConstrainedPoint motionConstrainedPoint, boolean[] zArr, String[] strArr) {
        ...
        zArr[1] = zArr[1] | diff(this.f100x, motionConstrainedPoint.f100x);
        zArr[2] = zArr[2] | diff(this.f101y, motionConstrainedPoint.f101y);
    ...
    public void fillStandard(double[] dArr, int[] iArr) {
        float[] fArr = {this.position, this.f100x, this.f101y, this.width, this.height, this.alpha, this.elevation, this.rotation, this.rotationX, this.rotationY, this.scaleX, this.scaleY, this.mPivotX, this.mPivotY, this.translationX, this.translationY, this.translationZ, this.mPathRotate};
        int i = 0;
            ...
            switch (c) {
                ...
                default:
                    if (!next.startsWith("CUSTOM")) {
                        SystemUtils.log(6, "MotionPaths", "UNKNOWN spline " + next, (Throwable) null, "androidx.constraintlayout.motion.widget.MotionConstrainedPoint", 323);
                        break;
                    } else {
                        ...
                        if (!this.attributes.containsKey(str)) {
                            ...
                            if (!(viewSpline instanceof ViewSpline.CustomSet)) {
                                SystemUtils.log(6, "MotionPaths", next + " ViewSpline not a CustomSet frame = " + i + ", value" + constraintAttribute.getValueToInterpolate() + viewSpline, (Throwable) null, "androidx.constraintlayout.motion.widget.MotionConstrainedPoint", 315);
                                break;
                            } else {
