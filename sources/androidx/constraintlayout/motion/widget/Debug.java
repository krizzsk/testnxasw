...
public class Debug {
    public static void logStack(String str, String str2, int i) {
        ...
        for (int i2 = 1; i2 <= min; i2++) {
            ...
            str3 = str3 + " ";
            SystemUtils.log(2, str, str2 + str3 + (".(" + stackTrace[i2].getFileName() + ":" + stackTrace[i2].getLineNumber() + ") " + stackTrace[i2].getMethodName()) + str3, (Throwable) null, "androidx.constraintlayout.motion.widget.Debug", 55);
        }
    }
    ...
    public static java.lang.String getName(android.content.Context r6, int[] r7) {
        /*
            ...
            int r1 = r7.length     // Catch:{ Exception -> 0x0072 }
            ...
            r1 = 0
        L_0x0013:
            int r2 = r7.length     // Catch:{ Exception -> 0x0072 }
        ...
        L_0x0026:
            ...
            android.content.res.Resources r3 = r6.getResources()     // Catch:{ NotFoundException -> 0x0038 }
            r4 = r7[r1]     // Catch:{ NotFoundException -> 0x0038 }
        ...
        L_0x0038:
            ...
            r4 = r7[r1]     // Catch:{ Exception -> 0x0072 }
            r3.append(r4)     // Catch:{ Exception -> 0x0072 }
        ...
        L_0x0060:
            ...
            r6.append(r0)     // Catch:{ Exception -> 0x0072 }
            java.lang.String r7 = "]"
            r6.append(r7)     // Catch:{ Exception -> 0x0072 }
            java.lang.String r6 = r6.toString()     // Catch:{ Exception -> 0x0072 }
            return r6
        L_0x0072:
            r6 = move-exception
            ...
            java.lang.String r4 = "androidx.constraintlayout.motion.widget.Debug"
