...
public class MotionController {
    ...
    public float getStartX() {
        return this.mStartMotionPath.f104x;
    }

    public float getStartY() {
        return this.mStartMotionPath.f105y;
    }

    public float getFinalX() {
        return this.mEndMotionPath.f104x;
    }

    public float getFinalY() {
        return this.mEndMotionPath.f105y;
    }
    ...
    public KeyPositionBase getPositionKeyframe(int i, int i2, float f, float f2) {
        ...
        rectF.left = this.mStartMotionPath.f104x;
        rectF.top = this.mStartMotionPath.f105y;
        rectF.right = rectF.left + this.mStartMotionPath.width;
        rectF.bottom = rectF.top + this.mStartMotionPath.height;
        RectF rectF2 = new RectF();
        rectF2.left = this.mEndMotionPath.f104x;
        rectF2.top = this.mEndMotionPath.f105y;
    ...
    public float getKeyFrameParameter(int i, float f, float f2) {
        float f3 = this.mEndMotionPath.f104x - this.mStartMotionPath.f104x;
        float f4 = this.mEndMotionPath.f105y - this.mStartMotionPath.f105y;
        float f5 = this.mStartMotionPath.f104x + (this.mStartMotionPath.width / 2.0f);
        float f6 = this.mStartMotionPath.f105y + (this.mStartMotionPath.height / 2.0f);
    ...
    private void insertKey(MotionPaths motionPaths) {
        ...
        if (binarySearch == 0) {
            SystemUtils.log(6, TAG, " KeyPath position \"" + motionPaths.position + "\" outside of range", (Throwable) null, "androidx.constraintlayout.motion.widget.MotionController", 604);
        }
    ...
    public String toString() {
        return " start: x: " + this.mStartMotionPath.f104x + " y: " + this.mStartMotionPath.f105y + " end: x: " + this.mEndMotionPath.f104x + " y: " + this.mEndMotionPath.f105y;
    }
    ...
    public void endTrigger(boolean z) {
        if (CarServerParam.PARAM_BUTTON.equals(Debug.getName(this.mView)) && this.mKeyTriggers != null) {
            int i = 0;
            while (true) {
    ...
    public void getDpDt(float f, float f2, float f3, float[] fArr) {
        ...
        float f5 = this.mEndMotionPath.f104x - this.mStartMotionPath.f104x;
        float f6 = this.mEndMotionPath.f105y - this.mStartMotionPath.f105y;
    ...
    public void getPostLayoutDvDp(float f, int i, int i2, float f2, float f3, float[] fArr) {
        ...
        if (this.mSpline != null) {
            ...
            float f7 = this.mEndMotionPath.f104x - this.mStartMotionPath.f104x;
            float f8 = this.mEndMotionPath.f105y - this.mStartMotionPath.f105y;
