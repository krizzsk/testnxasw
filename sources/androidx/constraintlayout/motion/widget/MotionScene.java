...
public class MotionScene {
    ...
    public static class Transition {
        ...
        public static class TransitionOnClick implements View.OnClickListener {
            ...
            public TransitionOnClick(Context context, Transition transition, XmlPullParser xmlPullParser) {
                ...
                TypedArray obtainStyledAttributes = context.obtainStyledAttributes(Xml.asAttributeSet(xmlPullParser), C0273R.styleable.OnClick);
                int indexCount = obtainStyledAttributes.getIndexCount();
                for (int i = 0; i < indexCount; i++) {
                    int index = obtainStyledAttributes.getIndex(i);
                    if (index == C0273R.styleable.OnClick_targetId) {
                        this.mTargetId = obtainStyledAttributes.getResourceId(index, this.mTargetId);
                    } else if (index == C0273R.styleable.OnClick_clickAction) {
            ...
            public void addOnClickListeners(MotionLayout motionLayout, int i, Transition transition) {
                ...
                if (view == null) {
                    SystemUtils.log(6, TypedValues.MotionScene.NAME, "OnClick could not find id " + this.mTargetId, (Throwable) null, "androidx.constraintlayout.motion.widget.MotionScene$Transition$TransitionOnClick", 779);
                    return;
                }
            ...
            public void removeOnClickListeners(MotionLayout motionLayout) {
                ...
                if (i != -1) {
                    ...
                    if (findViewById == null) {
                        SystemUtils.log(6, TypedValues.MotionScene.NAME, " (*)  could not find id " + this.mTargetId, (Throwable) null, "androidx.constraintlayout.motion.widget.MotionScene$Transition$TransitionOnClick", 806);
                        return;
                    }
        ...
        private void fillFromAttributeList(MotionScene motionScene, Context context, AttributeSet attributeSet) {
            TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C0273R.styleable.Transition);
        ...
        private void fill(MotionScene motionScene, Context context, TypedArray typedArray) {
            ...
            for (int i = 0; i < indexCount; i++) {
                ...
                if (index == C0273R.styleable.Transition_constraintSetEnd) {
                ...
                } else if (index == C0273R.styleable.Transition_constraintSetStart) {
                ...
                } else if (index == C0273R.styleable.Transition_motionInterpolator) {
                ...
                } else if (index == C0273R.styleable.Transition_duration) {
                    int i2 = typedArray.getInt(index, this.mDuration);
                    this.mDuration = i2;
                    if (i2 < 8) {
                        this.mDuration = 8;
                    }
                } else if (index == C0273R.styleable.Transition_staggered) {
                    this.mStagger = typedArray.getFloat(index, this.mStagger);
                } else if (index == C0273R.styleable.Transition_autoTransition) {
                    this.mAutoTransition = typedArray.getInteger(index, this.mAutoTransition);
                } else if (index == C0273R.styleable.Transition_android_id) {
                    this.mId = typedArray.getResourceId(index, this.mId);
                } else if (index == C0273R.styleable.Transition_transitionDisable) {
                    this.mDisable = typedArray.getBoolean(index, this.mDisable);
                } else if (index == C0273R.styleable.Transition_pathMotionArc) {
                    this.mPathMotionArc = typedArray.getInteger(index, -1);
                } else if (index == C0273R.styleable.Transition_layoutDuringTransition) {
                    this.mLayoutDuringTransition = typedArray.getInteger(index, 0);
                } else if (index == C0273R.styleable.Transition_transitionFlags) {
    ...
    MotionScene(Context context, MotionLayout motionLayout, int i) {
        ...
        this.mViewTransitionController = new ViewTransitionController(motionLayout);
        load(context, i);
        this.mConstraintSetMap.put(C0273R.C0277id.motion_base, new ConstraintSet());
        this.mConstraintSetIdMap.put("motion_base", Integer.valueOf(C0273R.C0277id.motion_base));
    }
    ...
    private void load(android.content.Context r11, int r12) {
        /*
            ...
            android.content.res.XmlResourceParser r0 = r0.getXml(r12)
            r1 = 0
            int r2 = r0.getEventType()     // Catch:{ XmlPullParserException -> 0x017a, IOException -> 0x0175 }
        L_0x000d:
            r3 = 1
            ...
            goto L_0x016f
        L_0x0017:
            java.lang.String r2 = r0.getName()     // Catch:{ XmlPullParserException -> 0x017a, IOException -> 0x0175 }
            boolean r5 = r10.DEBUG_DESKTOP     // Catch:{ XmlPullParserException -> 0x017a, IOException -> 0x0175 }
            if (r5 == 0) goto L_0x0035
            java.io.PrintStream r5 = java.lang.System.out     // Catch:{ XmlPullParserException -> 0x017a, IOException -> 0x0175 }
            java.lang.StringBuilder r6 = new java.lang.StringBuilder     // Catch:{ XmlPullParserException -> 0x017a, IOException -> 0x0175 }
            r6.<init>()     // Catch:{ XmlPullParserException -> 0x017a, IOException -> 0x0175 }
            java.lang.String r7 = "parsing = "
            r6.append(r7)     // Catch:{ XmlPullParserException -> 0x017a, IOException -> 0x0175 }
            r6.append(r2)     // Catch:{ XmlPullParserException -> 0x017a, IOException -> 0x0175 }
            java.lang.String r6 = r6.toString()     // Catch:{ XmlPullParserException -> 0x017a, IOException -> 0x0175 }
            r5.println(r6)     // Catch:{ XmlPullParserException -> 0x017a, IOException -> 0x0175 }
        L_0x0035:
            int r5 = r2.hashCode()     // Catch:{ XmlPullParserException -> 0x017a, IOException -> 0x0175 }
            r6 = -1
            switch(r5) {
        ...
        L_0x003f:
            ...
            boolean r2 = r2.equals(r3)     // Catch:{ XmlPullParserException -> 0x017a, IOException -> 0x0175 }
        ...
        L_0x0071:
            ...
            boolean r2 = r2.equals(r4)     // Catch:{ XmlPullParserException -> 0x017a, IOException -> 0x0175 }
            if (r2 == 0) goto L_0x00a4
            goto L_0x00a5
        L_0x007a:
        ...
        L_0x00a8:
            goto L_0x016f
        L_0x00aa:
            androidx.constraintlayout.motion.widget.ViewTransition r2 = new androidx.constraintlayout.motion.widget.ViewTransition     // Catch:{ XmlPullParserException -> 0x017a, IOException -> 0x0175 }
            r2.<init>(r11, r0)     // Catch:{ XmlPullParserException -> 0x017a, IOException -> 0x0175 }
            androidx.constraintlayout.motion.widget.ViewTransitionController r3 = r10.mViewTransitionController     // Catch:{ XmlPullParserException -> 0x017a, IOException -> 0x0175 }
            r3.add(r2)     // Catch:{ XmlPullParserException -> 0x017a, IOException -> 0x0175 }
            goto L_0x016f
        L_0x00b6:
            androidx.constraintlayout.motion.widget.KeyFrames r2 = new androidx.constraintlayout.motion.widget.KeyFrames     // Catch:{ XmlPullParserException -> 0x017a, IOException -> 0x0175 }
            r2.<init>(r11, r0)     // Catch:{ XmlPullParserException -> 0x017a, IOException -> 0x0175 }
            if (r1 == 0) goto L_0x016f
            java.util.ArrayList r3 = r1.mKeyFramesList     // Catch:{ XmlPullParserException -> 0x017a, IOException -> 0x0175 }
            r3.add(r2)     // Catch:{ XmlPullParserException -> 0x017a, IOException -> 0x0175 }
            goto L_0x016f
        L_0x00c6:
            r10.parseInclude((android.content.Context) r11, (org.xmlpull.v1.XmlPullParser) r0)     // Catch:{ XmlPullParserException -> 0x017a, IOException -> 0x0175 }
            goto L_0x016f
        L_0x00cb:
            r10.parseConstraintSet(r11, r0)     // Catch:{ XmlPullParserException -> 0x017a, IOException -> 0x0175 }
            goto L_0x016f
        L_0x00d0:
            androidx.constraintlayout.widget.StateSet r2 = new androidx.constraintlayout.widget.StateSet     // Catch:{ XmlPullParserException -> 0x017a, IOException -> 0x0175 }
            r2.<init>(r11, r0)     // Catch:{ XmlPullParserException -> 0x017a, IOException -> 0x0175 }
            r10.mStateSet = r2     // Catch:{ XmlPullParserException -> 0x017a, IOException -> 0x0175 }
            goto L_0x016f
        L_0x00d9:
            if (r1 == 0) goto L_0x016f
            r1.addOnClick((android.content.Context) r11, (org.xmlpull.v1.XmlPullParser) r0)     // Catch:{ XmlPullParserException -> 0x017a, IOException -> 0x0175 }
            goto L_0x016f
        L_0x00e0:
            if (r1 != 0) goto L_0x0117
            android.content.res.Resources r2 = r11.getResources()     // Catch:{ XmlPullParserException -> 0x017a, IOException -> 0x0175 }
            java.lang.String r2 = r2.getResourceEntryName(r12)     // Catch:{ XmlPullParserException -> 0x017a, IOException -> 0x0175 }
            int r3 = r0.getLineNumber()     // Catch:{ XmlPullParserException -> 0x017a, IOException -> 0x0175 }
            java.lang.String r5 = "MotionScene"
            java.lang.StringBuilder r4 = new java.lang.StringBuilder     // Catch:{ XmlPullParserException -> 0x017a, IOException -> 0x0175 }
            r4.<init>()     // Catch:{ XmlPullParserException -> 0x017a, IOException -> 0x0175 }
            java.lang.String r6 = " OnSwipe ("
            r4.append(r6)     // Catch:{ XmlPullParserException -> 0x017a, IOException -> 0x0175 }
            r4.append(r2)     // Catch:{ XmlPullParserException -> 0x017a, IOException -> 0x0175 }
            java.lang.String r2 = ".xml:"
            r4.append(r2)     // Catch:{ XmlPullParserException -> 0x017a, IOException -> 0x0175 }
            r4.append(r3)     // Catch:{ XmlPullParserException -> 0x017a, IOException -> 0x0175 }
            java.lang.String r2 = ")"
            r4.append(r2)     // Catch:{ XmlPullParserException -> 0x017a, IOException -> 0x0175 }
            java.lang.String r6 = r4.toString()     // Catch:{ XmlPullParserException -> 0x017a, IOException -> 0x0175 }
            r4 = 2
            r7 = 0
            java.lang.String r8 = "androidx.constraintlayout.motion.widget.MotionScene"
            r9 = 1084(0x43c, float:1.519E-42)
            com.didi.sdk.apm.SystemUtils.log(r4, r5, r6, r7, r8, r9)     // Catch:{ XmlPullParserException -> 0x017a, IOException -> 0x0175 }
        L_0x0117:
            if (r1 == 0) goto L_0x016f
            androidx.constraintlayout.motion.widget.TouchResponse r2 = new androidx.constraintlayout.motion.widget.TouchResponse     // Catch:{ XmlPullParserException -> 0x017a, IOException -> 0x0175 }
            androidx.constraintlayout.motion.widget.MotionLayout r3 = r10.mMotionLayout     // Catch:{ XmlPullParserException -> 0x017a, IOException -> 0x0175 }
            r2.<init>(r11, r3, r0)     // Catch:{ XmlPullParserException -> 0x017a, IOException -> 0x0175 }
            androidx.constraintlayout.motion.widget.TouchResponse unused = r1.mTouchResponse = r2     // Catch:{ XmlPullParserException -> 0x017a, IOException -> 0x0175 }
            goto L_0x016f
        L_0x0124:
            java.util.ArrayList<androidx.constraintlayout.motion.widget.MotionScene$Transition> r1 = r10.mTransitionList     // Catch:{ XmlPullParserException -> 0x017a, IOException -> 0x0175 }
            androidx.constraintlayout.motion.widget.MotionScene$Transition r2 = new androidx.constraintlayout.motion.widget.MotionScene$Transition     // Catch:{ XmlPullParserException -> 0x017a, IOException -> 0x0175 }
            r2.<init>(r10, r11, r0)     // Catch:{ XmlPullParserException -> 0x017a, IOException -> 0x0175 }
            r1.add(r2)     // Catch:{ XmlPullParserException -> 0x017a, IOException -> 0x0175 }
            androidx.constraintlayout.motion.widget.MotionScene$Transition r1 = r10.mCurrentTransition     // Catch:{ XmlPullParserException -> 0x017a, IOException -> 0x0175 }
            if (r1 != 0) goto L_0x014d
            boolean r1 = r2.mIsAbstract     // Catch:{ XmlPullParserException -> 0x017a, IOException -> 0x0175 }
            if (r1 != 0) goto L_0x014d
            r10.mCurrentTransition = r2     // Catch:{ XmlPullParserException -> 0x017a, IOException -> 0x0175 }
            if (r2 == 0) goto L_0x014d
            androidx.constraintlayout.motion.widget.TouchResponse r1 = r2.mTouchResponse     // Catch:{ XmlPullParserException -> 0x017a, IOException -> 0x0175 }
            if (r1 == 0) goto L_0x014d
            androidx.constraintlayout.motion.widget.MotionScene$Transition r1 = r10.mCurrentTransition     // Catch:{ XmlPullParserException -> 0x017a, IOException -> 0x0175 }
            androidx.constraintlayout.motion.widget.TouchResponse r1 = r1.mTouchResponse     // Catch:{ XmlPullParserException -> 0x017a, IOException -> 0x0175 }
            boolean r3 = r10.mRtl     // Catch:{ XmlPullParserException -> 0x017a, IOException -> 0x0175 }
            r1.setRTL(r3)     // Catch:{ XmlPullParserException -> 0x017a, IOException -> 0x0175 }
        L_0x014d:
            boolean r1 = r2.mIsAbstract     // Catch:{ XmlPullParserException -> 0x017a, IOException -> 0x0175 }
            if (r1 == 0) goto L_0x0166
            int r1 = r2.mConstraintSetEnd     // Catch:{ XmlPullParserException -> 0x017a, IOException -> 0x0175 }
            if (r1 != r6) goto L_0x015c
            r10.mDefaultTransition = r2     // Catch:{ XmlPullParserException -> 0x017a, IOException -> 0x0175 }
            goto L_0x0161
        L_0x015c:
            java.util.ArrayList<androidx.constraintlayout.motion.widget.MotionScene$Transition> r1 = r10.mAbstractTransitionList     // Catch:{ XmlPullParserException -> 0x017a, IOException -> 0x0175 }
            r1.add(r2)     // Catch:{ XmlPullParserException -> 0x017a, IOException -> 0x0175 }
        L_0x0161:
            java.util.ArrayList<androidx.constraintlayout.motion.widget.MotionScene$Transition> r1 = r10.mTransitionList     // Catch:{ XmlPullParserException -> 0x017a, IOException -> 0x0175 }
            r1.remove(r2)     // Catch:{ XmlPullParserException -> 0x017a, IOException -> 0x0175 }
        L_0x0166:
            r1 = r2
            goto L_0x016f
        L_0x0168:
            r10.parseMotionSceneTags(r11, r0)     // Catch:{ XmlPullParserException -> 0x017a, IOException -> 0x0175 }
            goto L_0x016f
        L_0x016c:
            r0.getName()     // Catch:{ XmlPullParserException -> 0x017a, IOException -> 0x0175 }
        L_0x016f:
            int r2 = r0.next()     // Catch:{ XmlPullParserException -> 0x017a, IOException -> 0x0175 }
            goto L_0x000d
        L_0x0175:
            r11 = move-exception
            r11.printStackTrace()
    ...
    private void parseMotionSceneTags(Context context, XmlPullParser xmlPullParser) {
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(Xml.asAttributeSet(xmlPullParser), C0273R.styleable.MotionScene);
        int indexCount = obtainStyledAttributes.getIndexCount();
        for (int i = 0; i < indexCount; i++) {
            int index = obtainStyledAttributes.getIndex(i);
            if (index == C0273R.styleable.MotionScene_defaultDuration) {
                int i2 = obtainStyledAttributes.getInt(index, this.mDefaultDuration);
                this.mDefaultDuration = i2;
                if (i2 < 8) {
                    this.mDefaultDuration = 8;
                }
            } else if (index == C0273R.styleable.MotionScene_layoutDuringTransition) {
    ...
    private int getId(Context context, String str) {
        ...
        SystemUtils.log(6, TypedValues.MotionScene.NAME, "error in parsing id", (Throwable) null, "androidx.constraintlayout.motion.widget.MotionScene", 1174);
        return i;
    }

    private void parseInclude(Context context, XmlPullParser xmlPullParser) {
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(Xml.asAttributeSet(xmlPullParser), C0273R.styleable.include);
        int indexCount = obtainStyledAttributes.getIndexCount();
        for (int i = 0; i < indexCount; i++) {
            int index = obtainStyledAttributes.getIndex(i);
            if (index == C0273R.styleable.include_constraintSet) {
    ...
    public ConstraintSet getConstraintSet(Context context, String str) {
        ...
        for (int i = 0; i < this.mConstraintSetMap.size(); i++) {
            ...
            if (this.DEBUG_DESKTOP) {
                ...
                printStream3.println("Id for <" + i + "> is <" + resourceName + "> looking for <" + str + IMTextUtils.STREET_IMAGE_TAG_END);
            }
    ...
    public ConstraintSet getConstraintSet(int i, int i2, int i3) {
        ...
        SystemUtils.log(6, TypedValues.MotionScene.NAME, "Warning could not find ConstraintSet id/" + Debug.getName(this.mMotionLayout.getContext(), i) + " In MotionScene", (Throwable) null, "androidx.constraintlayout.motion.widget.MotionScene", 1318);
    ...
    public void readFallback(MotionLayout motionLayout) {
        ...
        while (i < this.mConstraintSetMap.size()) {
            ...
            if (hasCycleDependency(keyAt)) {
                SystemUtils.log(6, TypedValues.MotionScene.NAME, "Cannot be derived from yourself", (Throwable) null, "androidx.constraintlayout.motion.widget.MotionScene", 1768);
                return;
            } else {
    ...
    private void readConstraintChain(int i, MotionLayout motionLayout) {
        ...
        if (i2 > 0) {
            ...
            if (constraintSet2 == null) {
                SystemUtils.log(6, TypedValues.MotionScene.NAME, "ERROR! invalid deriveConstraintsFrom: @id/" + Debug.getName(this.mMotionLayout.getContext(), i2), (Throwable) null, "androidx.constraintlayout.motion.widget.MotionScene", 1810);
                return;
            }
