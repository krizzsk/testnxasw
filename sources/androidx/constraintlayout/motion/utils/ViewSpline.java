            ...
            if (view instanceof MotionLayout) {
                ...
                if (method != null) {
                    try {
                        ...
                        SystemUtils.log(6, ViewSpline.TAG, "unable to setProgress", e, "androidx.constraintlayout.motion.utils.ViewSpline$ProgressSet", 247);
                    } catch (InvocationTargetException e2) {
                        SystemUtils.log(6, ViewSpline.TAG, "unable to setProgress", e2, "androidx.constraintlayout.motion.utils.ViewSpline$ProgressSet", 249);
                    }
                }
            }
        }
