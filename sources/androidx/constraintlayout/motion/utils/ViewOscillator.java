            ...
            if (view instanceof MotionLayout) {
                ...
                if (method != null) {
                    try {
                        ...
                        SystemUtils.log(6, ViewOscillator.TAG, "unable to setProgress", e, "androidx.constraintlayout.motion.utils.ViewOscillator$ProgressSet", 199);
                    } catch (InvocationTargetException e2) {
                        SystemUtils.log(6, ViewOscillator.TAG, "unable to setProgress", e2, "androidx.constraintlayout.motion.utils.ViewOscillator$ProgressSet", 201);
                    }
                }
            }
        }
