...
public class CustomSupport {
    ...
    public static void setInterpolatedValue(ConstraintAttribute constraintAttribute, View view, float[] fArr) {
        ...
        String str = GuideParamModel.ACTION_SET + constraintAttribute.getName();
        try {
            boolean z = true;
            switch (C02511.f99x66adad53[constraintAttribute.getType().ordinal()]) {
                case 1:
            ...
            SystemUtils.log(6, TAG, "no method " + str + " on View \"" + Debug.getName(view) + Const.jsQuote, (Throwable) null, "androidx.constraintlayout.motion.utils.CustomSupport", 66);
            e.printStackTrace();
        } catch (IllegalAccessException e2) {
            SystemUtils.log(6, TAG, "cannot access method " + str + " on View \"" + Debug.getName(view) + Const.jsQuote, (Throwable) null, "androidx.constraintlayout.motion.utils.CustomSupport", 69);
            e2.printStackTrace();
    ...
    static /* synthetic */ class C02511 {
        ...
        static final /* synthetic */ int[] f99x66adad53;
        ...
        static {
            ...
            L_0x0012:
                int[] r0 = f99x66adad53     // Catch:{ NoSuchFieldError -> 0x001d }
            ...
            L_0x001d:
                int[] r0 = f99x66adad53     // Catch:{ NoSuchFieldError -> 0x0028 }
            ...
            L_0x0028:
                int[] r0 = f99x66adad53     // Catch:{ NoSuchFieldError -> 0x0033 }
            ...
            L_0x0033:
                int[] r0 = f99x66adad53     // Catch:{ NoSuchFieldError -> 0x003e }
            ...
            L_0x003e:
                int[] r0 = f99x66adad53     // Catch:{ NoSuchFieldError -> 0x0049 }
            ...
            L_0x0049:
                int[] r0 = f99x66adad53     // Catch:{ NoSuchFieldError -> 0x0054 }
            ...
            L_0x0054:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: androidx.constraintlayout.motion.utils.CustomSupport.C02511.<clinit>():void");
        }
    }
}
