            ...
            if (view instanceof MotionLayout) {
                ...
                if (method != null) {
                    try {
                        ...
                        SystemUtils.log(6, ViewTimeCycle.TAG, "unable to setProgress", e, "androidx.constraintlayout.motion.utils.ViewTimeCycle$ProgressSet", 309);
                    } catch (InvocationTargetException e2) {
                        SystemUtils.log(6, ViewTimeCycle.TAG, "unable to setProgress", e2, "androidx.constraintlayout.motion.utils.ViewTimeCycle$ProgressSet", 311);
                    }
                }
            }
            return this.mContinue;
