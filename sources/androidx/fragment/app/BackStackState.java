...
final class BackStackState implements Parcelable {
    ...
    public BackStackState(BackStackRecord backStackRecord) {
        ...
        if (backStackRecord.mAddToBackStack) {
            ...
            int i2 = 0;
            while (i < size) {
                FragmentTransaction.C0435Op op = (FragmentTransaction.C0435Op) backStackRecord.mOps.get(i);
                int i3 = i2 + 1;
    ...
    public BackStackRecord instantiate(FragmentManagerImpl fragmentManagerImpl) {
        ...
        while (i < this.mOps.length) {
            FragmentTransaction.C0435Op op = new FragmentTransaction.C0435Op();
            int i3 = i + 1;
            op.mCmd = this.mOps[i];
            if (FragmentManagerImpl.DEBUG) {
                SystemUtils.log(2, "FragmentManager", "Instantiate " + backStackRecord + " op #" + i2 + " base fragment #" + this.mOps[i3], (Throwable) null, "androidx.fragment.app.BackStackState", 108);
            }
