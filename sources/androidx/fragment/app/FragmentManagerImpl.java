...
final class FragmentManagerImpl extends FragmentManager implements LayoutInflater.Factory2 {
    ...
    private void throwException(RuntimeException runtimeException) {
        SystemUtils.log(6, TAG, runtimeException.getMessage(), (Throwable) null, "androidx.fragment.app.FragmentManagerImpl", 155);
        SystemUtils.log(6, TAG, "Activity state:", (Throwable) null, "androidx.fragment.app.FragmentManagerImpl", 156);
        ...
        if (fragmentHostCallback != null) {
            try {
                ...
                SystemUtils.log(6, TAG, "Failed dumping state", e, "androidx.fragment.app.FragmentManagerImpl", 163);
            }
        } else {
            try {
                dump("  ", (FileDescriptor) null, printWriter, new String[0]);
            } catch (Exception e2) {
                SystemUtils.log(6, TAG, "Failed dumping state", e2, "androidx.fragment.app.FragmentManagerImpl", 169);
            }
        }
    ...
    public void addRetainedFragment(Fragment fragment) {
        if (isStateSaved()) {
            if (DEBUG) {
                SystemUtils.log(2, TAG, "Ignoring addRetainedFragment as the state is already saved", (Throwable) null, "androidx.fragment.app.FragmentManagerImpl", 395);
            }
        } else if (this.mNonConfig.addRetainedFragment(fragment) && DEBUG) {
            SystemUtils.log(2, TAG, "Updating retained Fragments: Added " + fragment, (Throwable) null, "androidx.fragment.app.FragmentManagerImpl", 401);
        }
    }
    ...
    public void removeRetainedFragment(Fragment fragment) {
        if (isStateSaved()) {
            if (DEBUG) {
                SystemUtils.log(2, TAG, "Ignoring removeRetainedFragment as the state is already saved", (Throwable) null, "androidx.fragment.app.FragmentManagerImpl", 408);
            }
        } else if (this.mNonConfig.removeRetainedFragment(fragment) && DEBUG) {
            SystemUtils.log(2, TAG, "Updating retained Fragments: Removed " + fragment, (Throwable) null, "androidx.fragment.app.FragmentManagerImpl", 414);
        }
    }
    ...
    /* JADX WARNING: Removed duplicated region for block: B:260:0x0539  */
    /* JADX WARNING: Removed duplicated region for block: B:262:? A[RETURN, SYNTHETIC] */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public void moveToState(androidx.fragment.app.Fragment r21, int r22, int r23, int r24, boolean r25) {
        /*
            r20 = this;
            r6 = r20
            r7 = r21
        ...
        L_0x004e:
            ...
            return
        L_0x005e:
            android.view.View r0 = r21.getAnimatingAway()
            if (r0 != 0) goto L_0x006a
            android.animation.Animator r0 = r21.getAnimator()
            if (r0 == 0) goto L_0x007e
        L_0x006a:
            r7.setAnimatingAway(r13)
            r7.setAnimator(r13)
            int r2 = r21.getStateAfterAnimating()
            r3 = 0
            r4 = 0
            r5 = 1
            r0 = r20
        ...
        L_0x008d:
            ...
            java.lang.String r18 = "androidx.fragment.app.FragmentManagerImpl"
        ...
        L_0x01fa:
            ...
            r20.ensureInflatedFragmentView(r21)
        L_0x01ff:
        ...
        L_0x024d:
            ...
            android.content.res.Resources r1 = r21.getResources()     // Catch:{ NotFoundException -> 0x0268 }
            int r2 = r7.mContainerId     // Catch:{ NotFoundException -> 0x0268 }
            java.lang.String r1 = r1.getResourceName(r2)     // Catch:{ NotFoundException -> 0x0268 }
            goto L_0x026a
        L_0x0268:
        ...
        L_0x03f2:
            ...
            android.view.View r0 = r7.mView
            r0.clearAnimation()
            androidx.fragment.app.Fragment r0 = r21.getParentFragment()
        ...
        L_0x0535:
            ...
            java.lang.String r13 = "androidx.fragment.app.FragmentManagerImpl"
    ...
    public void moveFragmentToExpectedState(androidx.fragment.app.Fragment r11) {
        ...
        L_0x0003:
            ...
            java.lang.String r5 = "androidx.fragment.app.FragmentManagerImpl"
    ...
    public void makeActive(Fragment fragment) {
        if (this.mActive.get(fragment.mWho) == null) {
            ...
            if (DEBUG) {
                SystemUtils.log(2, TAG, "Added fragment to active set " + fragment, (Throwable) null, "androidx.fragment.app.FragmentManagerImpl", 1344);
            }
        }
    }
    ...
    public void makeInactive(Fragment fragment) {
        if (this.mActive.get(fragment.mWho) != null) {
            if (DEBUG) {
                SystemUtils.log(2, TAG, "Removed fragment from active set " + fragment, (Throwable) null, "androidx.fragment.app.FragmentManagerImpl", 1352);
            }
            for (Fragment next : this.mActive.values()) {
    ...
    public void addFragment(Fragment fragment, boolean z) {
        if (DEBUG) {
            SystemUtils.log(2, TAG, "add: " + fragment, (Throwable) null, "androidx.fragment.app.FragmentManagerImpl", 1375);
        }
        makeActive(fragment);
    ...
    public void removeFragment(Fragment fragment) {
        if (DEBUG) {
            SystemUtils.log(2, TAG, "remove: " + fragment + " nesting=" + fragment.mBackStackNesting, (Throwable) null, "androidx.fragment.app.FragmentManagerImpl", 1399);
        }
    ...
    public void hideFragment(Fragment fragment) {
        if (DEBUG) {
            SystemUtils.log(2, TAG, "hide: " + fragment, (Throwable) null, "androidx.fragment.app.FragmentManagerImpl", 1420);
        }
        if (!fragment.mHidden) {
    ...
    public void showFragment(Fragment fragment) {
        if (DEBUG) {
            SystemUtils.log(2, TAG, "show: " + fragment, (Throwable) null, "androidx.fragment.app.FragmentManagerImpl", 1436);
        }
        if (fragment.mHidden) {
    ...
    public void detachFragment(Fragment fragment) {
        if (DEBUG) {
            SystemUtils.log(2, TAG, "detach: " + fragment, (Throwable) null, "androidx.fragment.app.FragmentManagerImpl", 1446);
        }
        if (!fragment.mDetached) {
            fragment.mDetached = true;
            if (fragment.mAdded) {
                if (DEBUG) {
                    SystemUtils.log(2, TAG, "remove from detach: " + fragment, (Throwable) null, "androidx.fragment.app.FragmentManagerImpl", 1451);
                }
                synchronized (this.mAdded) {
                    this.mAdded.remove(fragment);
                }
    ...
    public void attachFragment(Fragment fragment) {
        if (DEBUG) {
            SystemUtils.log(2, TAG, "attach: " + fragment, (Throwable) null, "androidx.fragment.app.FragmentManagerImpl", 1464);
        }
        if (fragment.mDetached) {
            ...
            if (!this.mAdded.contains(fragment)) {
                if (DEBUG) {
                    SystemUtils.log(2, TAG, "add from attach: " + fragment, (Throwable) null, "androidx.fragment.app.FragmentManagerImpl", 1471);
                }
                synchronized (this.mAdded) {
                    this.mAdded.add(fragment);
                }
        ...
        synchronized (this) {
            if (this.mAvailBackStackIndices != null) {
                if (this.mAvailBackStackIndices.size() > 0) {
                    ...
                    if (DEBUG) {
                        SystemUtils.log(2, TAG, "Adding back stack index " + intValue + " with " + backStackRecord, (Throwable) null, "androidx.fragment.app.FragmentManagerImpl", 1609);
                    }
            ...
            if (DEBUG) {
                SystemUtils.log(2, TAG, "Setting back stack index " + size + " to " + backStackRecord, (Throwable) null, "androidx.fragment.app.FragmentManagerImpl", 1603);
            }
    ...
    public void setBackStackIndex(int i, BackStackRecord backStackRecord) {
        synchronized (this) {
            ...
            if (i < size) {
                if (DEBUG) {
                    SystemUtils.log(2, TAG, "Setting back stack index " + i + " to " + backStackRecord, (Throwable) null, "androidx.fragment.app.FragmentManagerImpl", 1623);
                }
                ...
                while (size < i) {
                    ...
                    if (DEBUG) {
                        SystemUtils.log(2, TAG, "Adding available back stack index " + size, (Throwable) null, "androidx.fragment.app.FragmentManagerImpl", 1631);
                    }
                    this.mAvailBackStackIndices.add(Integer.valueOf(size));
                    size++;
                }
                if (DEBUG) {
                    SystemUtils.log(2, TAG, "Adding back stack index " + i + " with " + backStackRecord, (Throwable) null, "androidx.fragment.app.FragmentManagerImpl", 1635);
                }
                this.mBackStackIndices.add(backStackRecord);
            }
        }
    ...
    public void freeBackStackIndex(int i) {
        synchronized (this) {
            ...
            if (DEBUG) {
                SystemUtils.log(2, TAG, "Freeing back stack index " + i, (Throwable) null, "androidx.fragment.app.FragmentManagerImpl", 1647);
            }
    ...
    public Parcelable saveAllState() {
        ...
        for (Fragment next : this.mActive.values()) {
            if (next != null) {
                ...
                if (DEBUG) {
                    SystemUtils.log(2, TAG, "Saved state of " + next + ": " + fragmentState.mSavedFragmentState, (Throwable) null, "androidx.fragment.app.FragmentManagerImpl", 2374);
                }
                z = true;
            }
        }
        if (!z) {
            if (DEBUG) {
                SystemUtils.log(2, TAG, "saveAllState: no fragments!", (Throwable) null, "androidx.fragment.app.FragmentManagerImpl", 2380);
            }
            return null;
        }
        ...
        if (size2 > 0) {
            ...
            while (it.hasNext()) {
                ...
                if (DEBUG) {
                    SystemUtils.log(2, TAG, "saveAllState: adding fragment (" + next2.mWho + "): " + next2, (Throwable) null, "androidx.fragment.app.FragmentManagerImpl", 2399);
                }
            }
        } else {
            arrayList = null;
        ...
        if (arrayList3 != null && (size = arrayList3.size()) > 0) {
            ...
            for (int i = 0; i < size; i++) {
                ...
                if (DEBUG) {
                    SystemUtils.log(2, TAG, "saveAllState: adding back stack #" + i + ": " + this.mBackStack.get(i), (Throwable) null, "androidx.fragment.app.FragmentManagerImpl", 2412);
                }
            }
        }
        ...
        if (parcelable != null) {
            ...
            if (fragmentManagerState.mActive != null) {
                for (Fragment next : this.mNonConfig.getRetainedFragments()) {
                    if (DEBUG) {
                        SystemUtils.log(2, TAG, "restoreSaveState: re-attaching retained " + next, (Throwable) null, "androidx.fragment.app.FragmentManagerImpl", 2447);
                    }
                    ...
                    if (fragmentState == null) {
                        if (DEBUG) {
                            SystemUtils.log(2, TAG, "Discarding retained Fragment " + next + " that was not found in the set of active Fragments " + fragmentManagerState.mActive, (Throwable) null, "androidx.fragment.app.FragmentManagerImpl", 2457);
                        }
                ...
                while (it2.hasNext()) {
                    ...
                    if (next2 != null) {
                        ...
                        if (DEBUG) {
                            SystemUtils.log(2, TAG, "restoreSaveState: active (" + instantiate.mWho + "): " + instantiate, (Throwable) null, "androidx.fragment.app.FragmentManagerImpl", 2491);
                        }
                ...
                if (fragmentManagerState.mAdded != null) {
                    ...
                    while (it3.hasNext()) {
                        ...
                        if (DEBUG) {
                            SystemUtils.log(2, TAG, "restoreSaveState: added (" + next3 + "): " + fragment2, (Throwable) null, "androidx.fragment.app.FragmentManagerImpl", 2510);
                        }
                ...
                if (fragmentManagerState.mBackStack != null) {
                    ...
                    for (int i = 0; i < fragmentManagerState.mBackStack.length; i++) {
                        ...
                        if (DEBUG) {
                            SystemUtils.log(2, TAG, "restoreAllState: back stack #" + i + " (index " + instantiate2.mIndex + "): " + instantiate2, (Throwable) null, "androidx.fragment.app.FragmentManagerImpl", 2526);
                            PrintWriter printWriter = new PrintWriter(new LogWriter(TAG));
    ...
    public View onCreateView(View view, String str, Context context, AttributeSet attributeSet) {
        ...
        if (DEBUG) {
            SystemUtils.log(2, TAG, "onCreateView: id=0x" + Integer.toHexString(resourceId) + " fname=" + str2 + " existing=" + fragment, (Throwable) null, "androidx.fragment.app.FragmentManagerImpl", 3192);
        }
        if (fragment == null) {
