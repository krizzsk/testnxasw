...
class FragmentManagerViewModel extends ViewModel {
    ...
    public void onCleared() {
        if (FragmentManagerImpl.DEBUG) {
            SystemUtils.log(3, "FragmentManager", "onCleared called for " + this, (Throwable) null, "androidx.fragment.app.FragmentManagerViewModel", 89);
        }
    ...
    public void clearNonConfigState(Fragment fragment) {
        if (FragmentManagerImpl.DEBUG) {
            SystemUtils.log(3, "FragmentManager", "Clearing non-config state for " + fragment, (Throwable) null, "androidx.fragment.app.FragmentManagerViewModel", 149);
        }
        FragmentManagerViewModel fragmentManagerViewModel = this.mChildNonConfigs.get(fragment.mWho);
        if (fragmentManagerViewModel != null) {
