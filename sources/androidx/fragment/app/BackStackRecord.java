...
final class BackStackRecord extends FragmentTransaction implements FragmentManager.BackStackEntry, FragmentManagerImpl.OpGenerator {
    ...
    public void dump(String str, PrintWriter printWriter, boolean z) {
        ...
        if (!this.mOps.isEmpty()) {
            ...
            for (int i = 0; i < size; i++) {
                FragmentTransaction.C0435Op op = (FragmentTransaction.C0435Op) this.mOps.get(i);
                switch (op.mCmd) {
                    case 0:
                        str2 = "NULL";
                        break;
    ...
    public void bumpBackStackNesting(int i) {
        if (this.mAddToBackStack) {
            if (FragmentManagerImpl.DEBUG) {
                SystemUtils.log(2, TAG, "Bump nesting in " + this + " by " + i, (Throwable) null, "androidx.fragment.app.BackStackRecord", 258);
            }
            int size = this.mOps.size();
            for (int i2 = 0; i2 < size; i2++) {
                FragmentTransaction.C0435Op op = (FragmentTransaction.C0435Op) this.mOps.get(i2);
                if (op.mFragment != null) {
                    op.mFragment.mBackStackNesting += i;
                    if (FragmentManagerImpl.DEBUG) {
                        SystemUtils.log(2, TAG, "Bump nesting of " + op.mFragment + " to " + op.mFragment.mBackStackNesting, (Throwable) null, "androidx.fragment.app.BackStackRecord", 265);
                    }
                }
            }
        }
    ...
    public int commitInternal(boolean z) {
        if (!this.mCommitted) {
            if (FragmentManagerImpl.DEBUG) {
                SystemUtils.log(2, TAG, "Commit: " + this, (Throwable) null, "androidx.fragment.app.BackStackRecord", 305);
    ...
    public boolean generateOps(ArrayList<BackStackRecord> arrayList, ArrayList<Boolean> arrayList2) {
        if (FragmentManagerImpl.DEBUG) {
            SystemUtils.log(2, TAG, "Run: " + this, (Throwable) null, "androidx.fragment.app.BackStackRecord", 333);
        }
        arrayList.add(this);
    ...
    public boolean interactsWith(ArrayList<BackStackRecord> arrayList, int i, int i2) {
        ...
        for (int i4 = 0; i4 < size; i4++) {
            FragmentTransaction.C0435Op op = (FragmentTransaction.C0435Op) this.mOps.get(i4);
            ...
            if (!(i5 == 0 || i5 == i3)) {
                for (int i6 = i; i6 < i2; i6++) {
                    ...
                    for (int i7 = 0; i7 < size2; i7++) {
                        FragmentTransaction.C0435Op op2 = (FragmentTransaction.C0435Op) backStackRecord.mOps.get(i7);
    ...
    public void executePopOps(boolean z) {
        for (int size = this.mOps.size() - 1; size >= 0; size--) {
            FragmentTransaction.C0435Op op = (FragmentTransaction.C0435Op) this.mOps.get(size);
            Fragment fragment = op.mFragment;
            if (fragment != null) {
            ...
            if (i2 != 1) {
                if (i2 == 2) {
                        ...
                        if (fragment4.mContainerId == i3) {
                            if (fragment4 == fragment3) {
                                ...
                                if (fragment4 == fragment2) {
                                    this.mOps.add(i, new FragmentTransaction.C0435Op(9, fragment4));
                                    i++;
                                    fragment2 = null;
                                }
                                FragmentTransaction.C0435Op op2 = new FragmentTransaction.C0435Op(3, fragment4);
                    ...
                    if (op.mFragment == fragment2) {
                        this.mOps.add(i, new FragmentTransaction.C0435Op(9, op.mFragment));
                        i++;
                        fragment2 = null;
                    }
                } else if (i2 != 7) {
                    if (i2 == 8) {
                        this.mOps.add(i, new FragmentTransaction.C0435Op(9, fragment2));
                        i++;
    ...
    public boolean isPostponed() {
        for (int i = 0; i < this.mOps.size(); i++) {
            if (isFragmentPostponed((FragmentTransaction.C0435Op) this.mOps.get(i))) {
                return true;
            }
        }
        return false;
    ...
    private static boolean isFragmentPostponed(FragmentTransaction.C0435Op op) {
        Fragment fragment = op.mFragment;
