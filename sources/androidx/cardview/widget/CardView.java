...
import androidx.cardview.C0223R;
...
public class CardView extends FrameLayout {
    ...
    public CardView(Context context, AttributeSet attributeSet, int i) {
        ...
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C0223R.styleable.CardView, i, C0223R.C0225style.CardView);
        if (obtainStyledAttributes.hasValue(C0223R.styleable.CardView_cardBackgroundColor)) {
            valueOf = obtainStyledAttributes.getColorStateList(C0223R.styleable.CardView_cardBackgroundColor);
        } else {
            ...
            if (fArr[2] > 0.5f) {
                i2 = getResources().getColor(C0223R.C0224color.cardview_light_background);
            } else {
                i2 = getResources().getColor(C0223R.C0224color.cardview_dark_background);
            }
        ...
        int dimensionPixelSize = obtainStyledAttributes.getDimensionPixelSize(C0223R.styleable.CardView_contentPadding, 0);
        this.mContentPadding.left = obtainStyledAttributes.getDimensionPixelSize(C0223R.styleable.CardView_contentPaddingLeft, dimensionPixelSize);
        this.mContentPadding.top = obtainStyledAttributes.getDimensionPixelSize(C0223R.styleable.CardView_contentPaddingTop, dimensionPixelSize);
        this.mContentPadding.right = obtainStyledAttributes.getDimensionPixelSize(C0223R.styleable.CardView_contentPaddingRight, dimensionPixelSize);
        this.mContentPadding.bottom = obtainStyledAttributes.getDimensionPixelSize(C0223R.styleable.CardView_contentPaddingBottom, dimensionPixelSize);
