...
import androidx.coordinatorlayout.C0281R;
...
public class CoordinatorLayout extends ViewGroup implements NestedScrollingParent2, NestedScrollingParent3 {
    ...
    public CoordinatorLayout(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, C0281R.attr.coordinatorLayoutStyle);
    }
    ...
    public CoordinatorLayout(Context context, AttributeSet attributeSet, int i) {
        ...
        if (i == 0) {
            typedArray = context.obtainStyledAttributes(attributeSet, C0281R.styleable.CoordinatorLayout, 0, C0281R.C0286style.Widget_Support_CoordinatorLayout);
        } else {
            typedArray = context.obtainStyledAttributes(attributeSet, C0281R.styleable.CoordinatorLayout, i, 0);
        }
        if (Build.VERSION.SDK_INT >= 29) {
            if (i == 0) {
                saveAttributeDataForStyleable(context, C0281R.styleable.CoordinatorLayout, attributeSet, typedArray, 0, C0281R.C0286style.Widget_Support_CoordinatorLayout);
            } else {
                saveAttributeDataForStyleable(context, C0281R.styleable.CoordinatorLayout, attributeSet, typedArray, i, 0);
            }
        }
        int resourceId = typedArray.getResourceId(C0281R.styleable.CoordinatorLayout_keylines, 0);
        if (resourceId != 0) {
        ...
        this.mStatusBarBackground = typedArray.getDrawable(C0281R.styleable.CoordinatorLayout_statusBarBackground);
        typedArray.recycle();
        setupForInsets();
    ...
    private int getKeyline(int i) {
        int[] iArr = this.mKeylines;
        if (iArr == null) {
            SystemUtils.log(6, TAG, "No keylines defined for " + this + " - attempted index lookup " + i, (Throwable) null, "androidx.coordinatorlayout.widget.CoordinatorLayout", 601);
            return 0;
        } else if (i >= 0 && i < iArr.length) {
            return iArr[i];
        } else {
            SystemUtils.log(6, TAG, "Keyline index " + i + " out of range for " + this, (Throwable) null, "androidx.coordinatorlayout.widget.CoordinatorLayout", 606);
            return 0;
        }
    }
    ...
    public LayoutParams getResolvedLayoutParams(View view) {
        ...
        if (!layoutParams.mBehaviorResolved) {
            if (view instanceof AttachedBehavior) {
                ...
                if (behavior == null) {
                    SystemUtils.log(6, TAG, "Attached behavior class is null", (Throwable) null, "androidx.coordinatorlayout.widget.CoordinatorLayout", 659);
                }
                ...
                if (defaultBehavior != null) {
                    try {
                        ...
                        Exception exc = e;
                        SystemUtils.log(6, TAG, "Default behavior class " + defaultBehavior.value().getName() + " could not be instantiated. Did you forget a default constructor?", exc, "androidx.coordinatorlayout.widget.CoordinatorLayout", 677);
                    }
                }
                layoutParams.mBehaviorResolved = true;
            }
    ...
    public static class LayoutParams extends ViewGroup.MarginLayoutParams {
        ...
        LayoutParams(Context context, AttributeSet attributeSet) {
            ...
            TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C0281R.styleable.CoordinatorLayout_Layout);
            this.gravity = obtainStyledAttributes.getInteger(C0281R.styleable.CoordinatorLayout_Layout_android_layout_gravity, 0);
            this.mAnchorId = obtainStyledAttributes.getResourceId(C0281R.styleable.CoordinatorLayout_Layout_layout_anchor, -1);
            this.anchorGravity = obtainStyledAttributes.getInteger(C0281R.styleable.CoordinatorLayout_Layout_layout_anchorGravity, 0);
            this.keyline = obtainStyledAttributes.getInteger(C0281R.styleable.CoordinatorLayout_Layout_layout_keyline, -1);
            this.insetEdge = obtainStyledAttributes.getInt(C0281R.styleable.CoordinatorLayout_Layout_layout_insetEdge, 0);
            this.dodgeInsetEdges = obtainStyledAttributes.getInt(C0281R.styleable.CoordinatorLayout_Layout_layout_dodgeInsetEdges, 0);
            boolean hasValue = obtainStyledAttributes.hasValue(C0281R.styleable.CoordinatorLayout_Layout_layout_behavior);
            this.mBehaviorResolved = hasValue;
            if (hasValue) {
                this.mBehavior = CoordinatorLayout.parseBehavior(context, attributeSet, obtainStyledAttributes.getString(C0281R.styleable.CoordinatorLayout_Layout_layout_behavior));
            }
