...
public class AnimatorInflaterCompat {
    ...
    private static void dumpKeyframes(Object[] objArr, String str) {
        if (objArr != null && objArr.length != 0) {
            SystemUtils.log(3, TAG, str, (Throwable) null, "androidx.vectordrawable.graphics.drawable.AnimatorInflaterCompat", 676);
            ...
            for (int i = 0; i < length; i++) {
                ...
                sb.append(obj);
                SystemUtils.log(3, TAG, sb.toString(), (Throwable) null, "androidx.vectordrawable.graphics.drawable.AnimatorInflaterCompat", 680);
            }
        }
    }
