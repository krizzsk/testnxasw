...
public class AnimatedVectorDrawableCompat extends VectorDrawableCommon implements Animatable2Compat {
    ...
    /* JADX WARNING: Removed duplicated region for block: B:13:0x0047 A[Catch:{ XmlPullParserException -> 0x006b, IOException -> 0x005c }] */
    /* JADX WARNING: Removed duplicated region for block: B:15:0x0054 A[Catch:{ XmlPullParserException -> 0x006b, IOException -> 0x005c }] */
    ...
    public static androidx.vectordrawable.graphics.drawable.AnimatedVectorDrawableCompat create(android.content.Context r6, int r7) {
        ...
        L_0x002e:
            ...
            android.content.res.XmlResourceParser r7 = r0.getXml(r7)     // Catch:{ XmlPullParserException -> 0x006b, IOException -> 0x005c }
            android.util.AttributeSet r0 = android.util.Xml.asAttributeSet(r7)     // Catch:{ XmlPullParserException -> 0x006b, IOException -> 0x005c }
        L_0x003a:
            int r1 = r7.next()     // Catch:{ XmlPullParserException -> 0x006b, IOException -> 0x005c }
            r2 = 2
        ...
        L_0x0045:
            ...
            android.content.res.Resources r1 = r6.getResources()     // Catch:{ XmlPullParserException -> 0x006b, IOException -> 0x005c }
            android.content.res.Resources$Theme r2 = r6.getTheme()     // Catch:{ XmlPullParserException -> 0x006b, IOException -> 0x005c }
            androidx.vectordrawable.graphics.drawable.AnimatedVectorDrawableCompat r6 = createFromXmlInner(r6, r1, r7, r0, r2)     // Catch:{ XmlPullParserException -> 0x006b, IOException -> 0x005c }
            return r6
        L_0x0054:
            org.xmlpull.v1.XmlPullParserException r6 = new org.xmlpull.v1.XmlPullParserException     // Catch:{ XmlPullParserException -> 0x006b, IOException -> 0x005c }
            java.lang.String r7 = "No start tag found"
            r6.<init>(r7)     // Catch:{ XmlPullParserException -> 0x006b, IOException -> 0x005c }
            throw r6     // Catch:{ XmlPullParserException -> 0x006b, IOException -> 0x005c }
        L_0x005c:
            r6 = move-exception
            r3 = r6
            r0 = 6
            ...
            java.lang.String r4 = "androidx.vectordrawable.graphics.drawable.AnimatedVectorDrawableCompat"
