...
public class VectorDrawableCompat extends VectorDrawableCommon {
    ...
    /* JADX WARNING: Removed duplicated region for block: B:12:0x0034 A[Catch:{ XmlPullParserException -> 0x0050, IOException -> 0x0041 }] */
    /* JADX WARNING: Removed duplicated region for block: B:14:0x0039 A[Catch:{ XmlPullParserException -> 0x0050, IOException -> 0x0041 }] */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public static androidx.vectordrawable.graphics.drawable.VectorDrawableCompat create(android.content.res.Resources r6, int r7, android.content.res.Resources.Theme r8) {
        /*
            ...
            return r0
        L_0x001f:
            android.content.res.XmlResourceParser r7 = r6.getXml(r7)     // Catch:{ XmlPullParserException -> 0x0050, IOException -> 0x0041 }
            android.util.AttributeSet r0 = android.util.Xml.asAttributeSet(r7)     // Catch:{ XmlPullParserException -> 0x0050, IOException -> 0x0041 }
        L_0x0027:
            int r1 = r7.next()     // Catch:{ XmlPullParserException -> 0x0050, IOException -> 0x0041 }
            r2 = 2
        ...
        L_0x0032:
            ...
            androidx.vectordrawable.graphics.drawable.VectorDrawableCompat r6 = createFromXmlInner(r6, r7, r0, r8)     // Catch:{ XmlPullParserException -> 0x0050, IOException -> 0x0041 }
            return r6
        L_0x0039:
            org.xmlpull.v1.XmlPullParserException r6 = new org.xmlpull.v1.XmlPullParserException     // Catch:{ XmlPullParserException -> 0x0050, IOException -> 0x0041 }
            java.lang.String r7 = "No start tag found"
            r6.<init>(r7)     // Catch:{ XmlPullParserException -> 0x0050, IOException -> 0x0041 }
            throw r6     // Catch:{ XmlPullParserException -> 0x0050, IOException -> 0x0041 }
        L_0x0041:
            r6 = move-exception
            r3 = r6
            r0 = 6
            ...
            java.lang.String r4 = "androidx.vectordrawable.graphics.drawable.VectorDrawableCompat"
    ...
    private void printGroupTree(VGroup vGroup, int i) {
        ...
        SystemUtils.log(2, LOGTAG, str + "current group is :" + vGroup.getGroupName() + " rotation is " + vGroup.mRotate, (Throwable) null, "androidx.vectordrawable.graphics.drawable.VectorDrawableCompat", 887);
        StringBuilder sb = new StringBuilder();
        sb.append(str);
        sb.append("matrix is :");
        sb.append(vGroup.getLocalMatrix().toString());
        SystemUtils.log(2, LOGTAG, sb.toString(), (Throwable) null, "androidx.vectordrawable.graphics.drawable.VectorDrawableCompat", 889);
    ...
    private static abstract class VPath extends VObject {
        ...
        public void printVPath(int i) {
            ...
            SystemUtils.log(2, VectorDrawableCompat.LOGTAG, str + "current path is :" + this.mPathName + " pathData is " + nodesToString(this.mNodes), (Throwable) null, "androidx.vectordrawable.graphics.drawable.VectorDrawableCompat$VPath", 1702);
        }
