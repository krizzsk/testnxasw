...
public class WorkDatabaseMigrations {
    ...
    public static class RescheduleMigration extends Migration {
        ...
        public void migrate(SupportSQLiteDatabase supportSQLiteDatabase) {
            ...
            SystemUtils.getSharedPreferences(this.mContext, PreferenceUtils.PREFERENCES_FILE_NAME, 0).edit().putBoolean(PreferenceUtils.KEY_RESCHEDULE_NEEDED, true).apply();
        }
    }
