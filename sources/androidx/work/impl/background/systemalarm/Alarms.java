...
class Alarms {
    ...
    private static void cancelExactAlarm(Context context, String str, int i) {
        ...
        PendingIntent service = PendingIntent.getService(context, i, CommandHandler.createDelayMetIntent(context, str), Build.VERSION.SDK_INT >= 23 ? 603979776 : View.NAVIGATION_BAR_UNHIDE);
    ...
    private static void setExactAlarm(Context context, String str, int i, long j) {
        AlarmManager alarmManager = (AlarmManager) context.getSystemService(NotificationCompat.CATEGORY_ALARM);
        PendingIntent service = PendingIntent.getService(context, i, CommandHandler.createDelayMetIntent(context, str), Build.VERSION.SDK_INT >= 23 ? 201326592 : View.NAVIGATION_BAR_TRANSIENT);
