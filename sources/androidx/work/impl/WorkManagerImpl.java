...
public class WorkManagerImpl extends WorkManager {
    ...
    public WorkManagerImpl(Context context, Configuration configuration, TaskExecutor taskExecutor) {
        this(context, configuration, taskExecutor, context.getResources().getBoolean(C0861R.bool.workmanager_test_configuration));
    }
    ...
    public PendingIntent createCancelPendingIntent(UUID uuid) {
        return PendingIntent.getService(this.mContext, 0, SystemForegroundDispatcher.createCancelWorkIntent(this.mContext, uuid.toString()), BuildCompat.isAtLeastS() ? 167772160 : View.NAVIGATION_BAR_TRANSIENT);
    }
    ...
    public void onForceStopRunnableCompleted() {
        synchronized (sLock) {
            ...
            if (this.mRescheduleReceiverResult != null) {
                SystemUtils.pendingResultFinish(this.mRescheduleReceiverResult);
