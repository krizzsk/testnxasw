...
public final class WorkSpec {
    ...
    public int hashCode() {
        int hashCode = ((((this.f149id.hashCode() * 31) + this.state.hashCode()) * 31) + this.workerClassName.hashCode()) * 31;
        String str = this.inputMergerClassName;
    ...
    public static class IdAndState {
        ...
        public boolean equals(Object obj) {
            ...
            return this.f150id.equals(idAndState.f150id);
        }

        public int hashCode() {
            return (this.f150id.hashCode() * 31) + this.state.hashCode();
        }
    }
    ...
    public static class WorkInfoPojo {
        ...
        public WorkInfo toWorkInfo() {
            ...
            return new WorkInfo(UUID.fromString(this.f151id), this.state, this.output, this.tags, data, this.runAttemptCount);
        }
        ...
        public boolean equals(Object obj) {
            ...
            if (str == null ? workInfoPojo.f151id != null : !str.equals(workInfoPojo.f151id)) {
                return false;
            }
