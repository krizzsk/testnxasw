...
public class ForceStopRunnable implements Runnable {
    ...
    public boolean isForceStopped() {
        int i = View.NAVIGATION_BAR_UNHIDE;
        try {
        ...
        try {
            ...
            if (z) {
                for (WorkSpec next : runningWork) {
                    workSpecDao.setState(WorkInfo.State.ENQUEUED, next.f149id);
                    workSpecDao.markWorkSpecScheduled(next.f149id, -1);
                }
            }
    ...
    static void setAlarm(Context context) {
        ...
        PendingIntent pendingIntent = getPendingIntent(context, BuildCompat.isAtLeastS() ? 167772160 : View.NAVIGATION_BAR_TRANSIENT);
