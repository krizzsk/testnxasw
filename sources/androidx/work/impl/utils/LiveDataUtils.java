                ...
                TaskExecutor.this.executeOnBackgroundThread(new Runnable() {
                    public void run() {
                        synchronized (obj) {
                            ...
                            if (C09191.this.mCurrentOutput == null && apply != null) {
                                C09191.this.mCurrentOutput = apply;
                                mediatorLiveData.postValue(apply);
                            } else if (C09191.this.mCurrentOutput != null && !C09191.this.mCurrentOutput.equals(apply)) {
                                C09191.this.mCurrentOutput = apply;
                                mediatorLiveData.postValue(apply);
                            }
                        }
