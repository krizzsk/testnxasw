...
public class NewGlobalPaymentChannelView extends LinearLayout {
    ...
    public NewGlobalPaymentChannelView(Context context) {
        this(context, (AttributeSet) null);
    }

    public NewGlobalPaymentChannelView(Context context, AttributeSet attributeSet) {
        super(context, attributeSet);
        init();
    }

    private void init() {
        LayoutInflater.from(getContext()).inflate(R.layout.new_g_payment_paytype, this);
