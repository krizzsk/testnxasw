...
public final class BufferKt {
    ...
    public static final int commonReadUtf8CodePoint(Buffer buffer) {
        ...
        if (buffer.size() != 0) {
            ...
            throw new EOFException("size < " + i + ": " + buffer.size() + " (to read code point prefixed 0x" + Util.toHexString(b3) + VersionRange.RIGHT_OPEN);
        }
        throw new EOFException();
    }
