    ...
    public ByteString substring(int i, int i2) {
        ...
        if (i >= 0) {
            if (i2 <= size()) {
                ...
                throw new IllegalArgumentException(("endIndex=" + i2 + " > length(" + size() + VersionRange.RIGHT_OPEN).toString());
            }
        } else {
